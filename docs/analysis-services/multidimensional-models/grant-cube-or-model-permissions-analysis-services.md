...
helpviewer_keywords: 
  - "direitos de acesso do usuário [Analysis Services], cubos"
  - "cubos [Analysis Services], segurança"
  - "permissões de leitura/gravação"
  - "permissões [Analysis Services], cubos"
...
#### Etapa 3: Definir as permissões do cubo  
