...
|CommandTimeOut|Integer|O número de segundos antes de um comando expirar. Um valor de 0 indica que nunca expirará.<br /><br /> Observação: Essa propriedade não está disponível na **Editor de origem OLE DB**, mas pode ser definida usando o **Editor Avançado**.|  
