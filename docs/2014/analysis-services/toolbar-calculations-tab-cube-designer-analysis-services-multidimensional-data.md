...
|**La**|Clique para exibir a caixa de diálogo **Fonte** e inserir um conjunto válido de valores de propriedades de células relacionados à fonte no ponto de seleção do script de cubo. Esta opção é habilitada apenas na exibição de script.|  
