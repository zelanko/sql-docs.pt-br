...
---
# Processamento remoto (Analysis Services)
...
## O processamento remoto sob demanda  
...
## Agendar processamento remoto usando o serviço SQL Server Agent  
...
#### Conceda a permissão de administrador de conta do SQL Server Agent no SSAS  
