...
description: Saiba mais sobre os aprimoramentos de data e hora do OLE DB em relação aos conjuntos de linhas de COLUNAS e PROCEDURE_PARAMETERS no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
