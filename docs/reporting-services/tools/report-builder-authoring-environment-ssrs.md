---
title: Ambiente de criação do Construtor de Relatórios | Microsoft Docs
description: Conheça o Construtor de Relatórios, um ambiente de criação autônomo para a criação de relatórios paginados do Reporting Services fora do Visual Studio.
ms.date: 03/01/2017
