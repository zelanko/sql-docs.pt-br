...
description: O Driver do OLE DB para SQL Server dá suporte a tipos definido pelo usuário como tipos binários com informações de metadados, o que permite gerenciá-los como objetos.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
