título: "Classe de evento Auto Stats | Microsoft Docs" ms.custom: "" ms.date: "14/03/2017" ms.prod: "sql" ms.prod_service: "database-engine, sql-database" ms.service: "" ms.component: "event-classes" ms.reviewer: "" ms.suite: "sql" ms.technology: 
