...
ms.locfileid: "75240516"
---
# <a name="save-as"></a>Salvar como
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
Usada para salvar uma instância do item atual em um local específico em um formato de arquivo específico. Clique em **Salvar** *<file>* **como** no menu **Arquivo** (em que *<file>* está o nome do item atual) ou pressione ALT+F e A no Editor de Códigos.  
