...
|4|Bayesiano Dirichlet Equivalente (BDE) com uniforme a priori<br /><br /> (padrão)|  
 ...
 Para obter uma explicação desses métodos de pontuação, consulte [Feature Selection](../Topic/Feature%20Selection.md).  
