...
description: Você pode acessar a funcionalidade UDT no SQL Server da linguagem Transact-SQL usando a sintaxe de consulta regular. Defina tabelas e colunas UDT e manipule dados UDT.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
