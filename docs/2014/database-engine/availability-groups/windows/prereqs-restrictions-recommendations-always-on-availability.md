...
3.  Use o `Get-ClusterResource` cmdlet para localizar o recurso de nome de rede e, em seguida, use `Set-ClusterParameter` para definir o `HostRecordTTL` de valor, da seguinte maneira:  
...
|![Caixa de seleção](../../media/checkboxemptycenterxtraspacetopandright.gif "Checkbox")|Se qualquer banco de dados independente for adicionado a um grupo de disponibilidade, certifique-se de que o `contained database authentication` opção de servidor é definida como `1` em cada instância de servidor que hospedará uma réplica de disponibilidade para o grupo de disponibilidade.|[Opção de configuração do servidor contained database authentication](../../configure-windows/contained-database-authentication-server-configuration-option.md)<br /><br /> [Opções de configuração do servidor &#40;SQL Server&#41;](../../configure-windows/server-configuration-options-sql-server.md)|  
...
-   [Guia de arquitetura do AlwaysOn: Criando uma alta disponibilidade e solução de recuperação de desastres usando instâncias de Cluster de Failover e grupos de disponibilidade](http://technet.microsoft.com/library/jj215886.aspx)  
...
|![Caixa de seleção](../../media/checkboxemptycenterxtraspacetopandright.gif "Checkbox")|Antes de adicionar um banco de dados independente a um grupo de disponibilidade, certifique-se de que o `contained database authentication` opção de servidor é definida como `1` em todos os servidores de instância que hospeda ou hospedará uma réplica de disponibilidade para o grupo de disponibilidade.|[Opção de configuração do servidor contained database authentication](../../configure-windows/contained-database-authentication-server-configuration-option.md)<br /><br /> [Opções de configuração do servidor &#40;SQL Server&#41;](../../configure-windows/server-configuration-options-sql-server.md)|  
