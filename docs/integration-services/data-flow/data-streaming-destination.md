...
## Componentes de publicação de feed de dados  
...
## Publicar um pacote do SSIS como uma exibição SQL  
...
## Expor dados de saída de um pacote do SSIS como um feed OData usando o Centro de Administração do Power BI  
