...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Este tópico descreve como fechar a janela de rastreamentos que estão em execução ou de rastreamentos salvos que estão sendo exibidos, usando o [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
