...
ms.topic: "article"
helpviewer_keywords: 
  - "processamento de relatório [Reporting Services], relatórios grandes"
  - "quebras de página [Reporting Services]"
  - "relatórios grandes"
  - "tamanho [SQL Server], relatórios"
  - "distribuindo relatórios [Reporting Services], relatórios grandes"
...
## Recomendações de implantação e distribuição  
