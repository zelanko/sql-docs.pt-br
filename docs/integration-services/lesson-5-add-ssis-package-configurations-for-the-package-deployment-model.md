...
-   [Etapa 1: Copiando o pacote da Lição 4](../integration-services/step-1-copying-the-lesson-4-package.md)  
  
-   [Etapa 2: Configurando e habilitando configurações de pacote](../integration-services/step-2-enabling-and-configuring-package-configurations.md)  
  
-   [Etapa 3: Modificando o valor de configuração da propriedade de diretório](../integration-services/step-3-modifying-the-directory-property-configuration-value.md)  
