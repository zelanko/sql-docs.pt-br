 ...
 *SRID*  
 É uma expressão **int** que representa a [ID de referência espacial](../../relational-databases/spatial/spatial-reference-identifiers-srids.md) da instância de **geography** que você deseja retornar.  
