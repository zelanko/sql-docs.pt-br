---
title: Recursos preteridos do Mecanismo de Banco de Dados no SQL Server 2016 | Microsoft Docs
ms.custom: ''
ms.date: 05/09/2018
ms.prod: sql
...
ms.author: mikeray
manager: jroth
ms.openlocfilehash: daa81e2aa367c96c44b1b43f0b660e6b94fc4d66
ms.sourcegitcommit: 3026c22b7fba19059a769ea5f367c4f51efaf286
ms.translationtype: HT
ms.contentlocale: pt-BR
ms.lasthandoff: 06/15/2019
ms.locfileid: "66795078"
---
...
|[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]|Integração com o Gerenciador de Soluções no [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]||None|None|  
