...
description: Referência de Transact-SQL para tipos de dados int, bigint, smallint e tinyint. Esses tipos de dados são usados para representar dados inteiros.
ms.date: 09/08/2017
ms.prod: sql
