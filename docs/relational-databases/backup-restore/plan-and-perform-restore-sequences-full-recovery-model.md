...
ms.topic: "article"
helpviewer_keywords: 
  - "sequências de restauração [SQL Server], planejando para"
  - "modelo de recuperação completa [SQL Server], planejando sequências de restauração"
...
## Para planejar uma sequência de restauração  
...
3.  Determine o tipo de restauração que você deseja executar. Para obter mais informações, confira [Visão geral da restauração e recuperação &#40;SQL Server&#41;](../../relational-databases/backup-restore/restore-and-recovery-overview-sql-server.md).  
...
## Para executar uma sequência de restauração  
...
## Reinicializando uma sequência de restauração  
