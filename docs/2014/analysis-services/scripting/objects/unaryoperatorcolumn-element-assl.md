...
## <a name="remarks"></a>Comentários  
 ...
 O elemento que corresponde ao pai de `UnaryOperatorColumn` no objeto Analysis Management Objects (AMO) o modelo é <xref:Microsoft.AnalysisServices.DimensionAttribute>.  
