...
Este artigo descreve como instalar um runtime personalizado para executar scripts de R com o SQL Server. O runtime personalizado para R pode ser utilizado nos seguintes cenários:
...
Baixe o arquivo zip que contém a extensão da linguagem R [R-lang-extension.zip](https://go.microsoft.com/fwlink/?linkid=2143953).
...
Baixe o arquivo zip que contém a extensão da linguagem R [R-lang-extension.zip](https://go.microsoft.com/fwlink/?linkid=2143954).
