---
title: "Anexar dom&#237;nio ou dom&#237;nio composto para dados de refer&#234;ncia | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Anexar dom&#237;nio ou dom&#237;nio composto para dados de refer&#234;ncia
...
8.  Caixa de diálogo **Catálogo de Provedores de Dados de Referência Online** :  
    ...
    3.  Clique em **OK** para salvar as alterações e fechar a caixa de diálogo **Catálogo de Provedores de Dados de Referência Online** .  
        ...
        > [!NOTE]  
        >  -   Na caixa de diálogo **Catálogo de Provedores de Dados de Referência Online** , o nó **DataMarket Data Quality Services** exibe todos os provedores de serviço de dados de referência que você assinou no Windows Azure Marketplace. Se você tiver configurado provedores de serviço de dados de referência terceirizado online direto no DQS, eles serão exibidos em outro nó chamado **3ª parte de provedores Online diretos** (não disponível agora como nenhum direto provedores de serviço de dados de referência de terceiros online são configurados no DQS).  
  
9. Você retornará à guia **Dados de Referência** . Na área **Configurações de Provedor** , altere os valores nas seguintes caixas, se necessário:  
