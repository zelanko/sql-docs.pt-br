...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Use essa caixa de diálogo para especificar os tipos de objeto que aparecem na caixa de diálogo **Selecionar Objetos**.  
