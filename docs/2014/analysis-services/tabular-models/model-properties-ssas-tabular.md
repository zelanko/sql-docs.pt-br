...
|**Copiar para diretório de saída**|Não copiar|Esta propriedade especifica o arquivo de origem que será copiado no diretório de saída. Essa configuração de propriedade tem as seguintes opções:<br /><br /> Não **copiar** – nenhuma cópia é criada no diretório de saída.<br /><br /> **Copy Always** -uma cópia sempre é criada no diretório de saída.<br /><br /> **Copiar se mais recente** -uma cópia é criada no diretório de saída somente se houver alterações no arquivo Model. BIM.|  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Propriedades do projeto &#40;SSAS tabular&#41;](project-properties-ssas-tabular.md)  
