...
description: Saiba como criar e aplicar o instantâneo inicial no SQL Server usando o SQL Server Management Studio, o Transact-SQL ou o Replication Management Objects.
ms.custom: ''
ms.date: 11/20/2018
ms.prod: sql
