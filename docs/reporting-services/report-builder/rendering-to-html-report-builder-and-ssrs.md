...
---
# Renderizando para HTML (Construtor de Relat&#243;rios e SSRS)
...
### Hyperlinks e detalhamento  
 Os hyperlinks e links de drillthrough são renderizados como hyperlinks em itens de relatórios usando as marcas de âncora HTML (\<a>) ao redor do item no qual elas estão definidas.  
