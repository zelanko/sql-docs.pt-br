---
description: Exemplo das propriedades DateCreated e DateModified (VC++)
title: Exemplo das propriedades DateCreated e DateModified (VC + +) | Microsoft Docs
ms.prod: sql
