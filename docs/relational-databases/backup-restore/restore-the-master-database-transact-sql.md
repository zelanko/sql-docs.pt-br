...
description: Este artigo mostra como restaurar o banco de dados mestre no SQL Server de um backup de banco de dados completo usando o Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
