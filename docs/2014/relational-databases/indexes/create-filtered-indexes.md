...
-   Os índices filtrados têm as seguintes vantagens em relação às exibições indexadas:  
    ...
    -   Recriações de índice online. É possível recriar índices filtrados enquanto estão disponíveis para consultas. As recriações de índices online não têm suporte para exibições indexadas. Para obter mais informações, veja a opção REBUILD de [ALTER INDEX &#40;Transact-SQL&#41;](/sql/t-sql/statements/alter-index-transact-sql).  
...
3.  Copie e cole o exemplo a seguir na janela de consulta e clique em **Executar**.  
 ...
 Para obter mais informações, veja [CREATE INDEX &#40;Transact-SQL&#41;](/sql/t-sql/statements/create-index-transact-sql).  
