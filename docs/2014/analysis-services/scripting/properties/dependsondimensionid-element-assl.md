...
## <a name="remarks"></a>Remarks  
 ...
 O elemento que corresponde ao pai de `DependsOnDimensionID` no objeto Analysis Management Objects (AMO) o modelo é <xref:Microsoft.AnalysisServices.Dimension>.  
