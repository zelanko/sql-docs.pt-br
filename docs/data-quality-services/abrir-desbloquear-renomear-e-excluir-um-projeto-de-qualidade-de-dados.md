...
helpviewer_keywords: 
  ...
  - "projeto de qualidade de dados, abrir"
...
manager: "jhubbard"
---
# Abrir, desbloquear, renomear e excluir um projeto de qualidade de dados
...
4.  O projeto de qualidade de dados é aberto no mesmo estado da atividade quando foi fechado pela última vez. Um projeto de qualidade de dados tem os seguintes estados:  
    ...
    -   Para o **correspondência** atividade, um projeto de qualidade de dados pode ter os seguintes estados: **correspondência - mapa**, **de correspondência -**, **correspondência – sobrevivência**, e **correspondência – exportar**.  
...
3.  No **Abrir projeto** tela, clique em um projeto de qualidade de dados bloqueado criado por você e, em seguida, clique em **Unlock** no menu de atalho. Uma marca de seleção verde é exibida para o projeto, indicando que ele está desbloqueado.  
...
3.  No **Abrir projeto** tela, clique em um projeto de qualidade de dados criado por você e, em seguida, clique em **Renomear** no menu de atalho.  
...
3.  No **Abrir projeto** tela, clique em um projeto de qualidade de dados desbloqueado criado por você e, em seguida, clique em **Excluir** no menu de atalho.  
