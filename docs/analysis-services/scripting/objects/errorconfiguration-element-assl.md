...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Especifica as configurações de manipulação de erros que podem ocorrer quando o elemento pai é processado.  
