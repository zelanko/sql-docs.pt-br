...
## <a name="remarks"></a>Remarks  
 O elemento que corresponde ao pai de **texto** no objeto Analysis Management Objects (AMO) o modelo é <xref:Microsoft.AnalysisServices.Command>.  
