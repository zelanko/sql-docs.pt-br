...
helpviewer_keywords: 
  ...
  - "dimensões [Analysis Services], time"
  - "períodos de tempo [Analysis Services]"
  - "dimensões de tempo baseadas em intervalos [Analysis Services]"
  - "dimensões de tempo do servidor [Analysis Services]"
  - "calendários [Analysis Services]"
  - "dimensões de tempo baseadas em tabelas [Analysis Services]"
...
---
# Criar uma dimens&#227;o de tempo ao gerar uma tabela de tempo
...
## Consulte também  
 ...
 [Criar uma dimensão de tipo de data](../../analysis-services/multidimensional-models/create-a-date-type-dimension.md)   
