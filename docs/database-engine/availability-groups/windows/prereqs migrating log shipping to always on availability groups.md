...
ms.topic: "article"
helpviewer_keywords: 
  - "envio de logs [SQL Server], Grupos de Disponibilidade AlwaysOn"
...
manager: "jhubbard"
---
# Pr&#233;-requisitos para migrar de envio de logs para grupos de disponibilidade AlwaysOn (SQL Server)
 ...
 **Para obter mais informações, consulte:**  
 ...
 [Convertendo uma configuração para envio de logs para Grupo de Disponibilidade](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx) (um blog do SQL Server)  
...
-   **Blogs:**  
     ...
     [Convertendo uma configuração para envio de logs para Grupo de Disponibilidade](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx)  
  
     [Adicione um banco de dados primário de envio de logs e bancos de dados secundários a um grupo de disponibilidade existente](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/01/use-log-shipping-to-prepare-secondary-databases-for-an-existing-availability-group.aspx)  
