...
ms.topic: "article"
helpviewer_keywords: 
  - "SSAS, interfaces de acesso a dados"
  - "objetos [Analysis Services], interfaces de acesso a dados"
  - "interfaces de acesso a dados do Analysis Services"
  - "recuperação de dados [Analysis Services]"
  - "recuperando dados"
  - "metadados [Analysis Services]"
  - "interfaces de acesso a dados [Analysis Services]"
  - "manipulando objetos [Analysis Services]"
  - "Interfaces de acesso a dados do Analysis Services, sobre as interfaces de acesso a dados"
