 ...
 * A autenticação pode ser usada somente se todos os computadores estão no mesmo domínio ou em vários domínios com relações de confiança entre si.  
