...
# [Dados do Relatório](report-data-ssrs.md)
...
# [Tipo de conexão Analysis Services para MDX](analysis-services-connection-type-for-mdx-ssrs.md)
...
# [Painel de Dados do Relatório](report-data-pane.md)
...
# [Tipo de conexão Power Pivot](power-pivot-connection-type-ssrs.md)
...
# [O tipo de conexão do SQL Server](sql-server-connection-type-ssrs.md)
...
# [Tipo de conexão Analysis Services para DMX](analysis-services-connection-type-for-dmx-ssrs.md)
...
# [Conexões de conexão de lista do SharePoint](sharepoint-list-connection-type-ssrs.md)
