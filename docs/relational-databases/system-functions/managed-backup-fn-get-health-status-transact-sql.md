...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
 ...
 A função é usada para relatar o status de integridade dos serviços no administrador inteligente.  No momento [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] tem suporte sob o guarda-chuva do Smart Admin. Portanto, os erros retornados são relacionados a [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
