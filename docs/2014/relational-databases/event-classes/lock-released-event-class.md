...
## <a name="lock-released-event-class-data-columns"></a>Bloqueio:Colunas de dados de classe de evento Released  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Classe de evento Lock: adquirida](lock-acquired-event-class.md)   
