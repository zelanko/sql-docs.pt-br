...
|[getPooledConnection (Java, Java)](../../../connect/jdbc/reference/getpooledconnection-method-java-lang-string-java-lang-string.md)|Tenta estabelecer uma conexão de banco de dados física que pode ser usada como uma conexão em pool com base no nome de usuário e senha fornecidos.|  
