---
title: Localizando mais informações do SQL Server Native Client | Microsoft Docs
ms.custom: ''
ms.date: 03/09/2017
...
# <a name="finding-more-sql-server-native-client-information"></a>Localizando mais informações sobre o SQL Server Native Client
 ...
 Informações adicionais sobre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client podem ser encontrada pesquisando os [da Base de dados de Conhecimento Microsoft](http://go.microsoft.com/fwlink?linkid=5757).  
