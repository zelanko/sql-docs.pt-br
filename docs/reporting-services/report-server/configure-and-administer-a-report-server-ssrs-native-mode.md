...
description: Saiba mais sobre abordagens que você pode usar para configurar o Reporting Services e encontre artigos sobre como configurar componentes, recursos ou funcionalidades de servidor.
ms.date: 05/15/2019
...
-   Usar o Gerenciador de Configurações do Servidor de Relatório. Muitos dos tópicos nesta seção contêm informações sobre como configurar recursos específicos com essa ferramenta.  
