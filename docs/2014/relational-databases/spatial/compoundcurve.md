...
```  
 ...
 `@g3` é válido porque a instância `CircularString` é válida. Para obter mais informações sobre a validade da instância de `CircularString`, consulte [circularstring](circularstring.md).  
