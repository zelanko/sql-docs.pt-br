---
title: Terminal integrado no SQL Operations Studio (preview) | Microsoft Docs
description: Saiba mais sobre o terminal integrado no SQL Operations Studio (preview).
ms.custom: tools|sos
ms.date: 11/15/2017
