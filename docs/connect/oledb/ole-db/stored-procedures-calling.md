...
description: Saiba como chamar um procedimento armazenado no Driver do OLE DB para SQL Server, inclusive como passar valores de parâmetro.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
