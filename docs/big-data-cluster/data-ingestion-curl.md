---
title: Use o curl para carregar dados no HDFS no SQL Server de 2019 CTP 2.0 | Microsoft Docs
description: ''
author: rothja
ms.author: jroth
manager: craigg
...
ms.locfileid: "48795839"
---
# <a name="use-curl-to-load-data-into-hdfs-on-sql-server-2019-ctp-20"></a>Use o curl para carregar dados no HDFS no SQL Server de 2019 CTP 2.0

Este artigo explica como usar **curl** para carregar dados no HDFS no SQL Server de 2019 CTP 2.0.
