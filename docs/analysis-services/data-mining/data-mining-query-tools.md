...
helpviewer_keywords: 
  ...
  - "previsões [DMX]"
  - "DMX [Analysis Services], consultas de previsão"
  - "consultas de previsão [DMX]"
  - "previsões [Analysis Services]"
...
-   [Construtor de consulta de previsão](#bkmk_Builder)  
...
##  <a name="bkmk_Builder"></a> Construtor de consulta de previsão  
