...
Todos os meses, é aconselhável [instalar a atualização mais recente do SSMS](../../ssms/download-sql-server-management-studio-ssms.md), para evitar falhas inesperadas.
