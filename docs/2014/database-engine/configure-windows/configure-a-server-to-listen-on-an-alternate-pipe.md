...
5.  No painel de detalhes, clique com o botão direito do mouse em **SQL Server (**\<nome da instância>**)** e clique em [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **reiniciar**para parar e reiniciar.  
