...
ms.topic: "article"
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], exibindo rastreamentos"
  - "SQL Server Profiler, exibindo rastreamentos"
  - "rastreamentos [SQL Server], exibindo"
  - "SQL Server Profiler, solução de problemas"
  - "solução de problemas [SQL Server], rastreamentos"
  - "eventos [SQL Server], localizando dentro do rastreamento"
  - "Profiler [SQL Server Profiler], solução de problemas"
