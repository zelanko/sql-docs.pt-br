...
## <a name="related-tasks"></a>Related Tasks  
 Para obter instruções sobre como adicionar um destino e um gerenciador de conexões por meio do Assistente de Origem, consulte [Add a Destination using Destination Assistant](../add-a-destination-using-destination-assistant.md).  
