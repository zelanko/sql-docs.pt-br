# [Visão geral](system-functions-for-transact-sql.md)  
...
# [Controle de alterações](change-tracking-functions-transact-sql.md)  
...
# [Segurança do sistema](system-security-functions.md)  
