...
description: Ver estratégias para reduzir o ruído e violações indesejadas nos resultados do Utilitário do SQL Server. Veja quais opções de política afetam os relatórios de utilização do processador.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
