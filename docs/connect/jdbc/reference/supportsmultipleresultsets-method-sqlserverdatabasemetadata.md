...
## <a name="remarks"></a>Remarks  
 Esse método supportsMultipleResultSets é especificado pelo método supportsMultipleResultSets na interface java. Sql. DatabaseMetaData.  
