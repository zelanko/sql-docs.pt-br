...
manager: "erikre"
---
# M&#233;todo InitializeReportServer (WMI MSReportServer_ConfigurationSetting)
...
## Comentários  
 ...
 Se a propriedade [IsInitialized](../../reporting-services/wmi-provider-library-reference/isinitialized-property-wmi-msreportserver-configurationsetting.md) do servidor de relatório for definida como **true** quando o método InitializeReportServer for chamado, o método terá êxito sem tentar criptografar a chave de criptografia.  
