...
ms.topic: "article"
helpviewer_keywords: 
  - "erros [SQL Server], sobre erros"
  - "erros [SQL Server], Mecanismo de Banco de Dados"
  - "erros [SQL Server]"
  - "Mecanismo de Banco de Dados [SQL Server], erros"
...
```  
 ...
 Para obter mais informações, consulte [sys.messages &#40;Transact-SQL&#41;](../Topic/sys.messages%20\(Transact-SQL\).md).  
