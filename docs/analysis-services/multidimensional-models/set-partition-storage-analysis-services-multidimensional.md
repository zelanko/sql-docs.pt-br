...
helpviewer_keywords: 
  ...
  - "armazenamento padrão [Analysis Services]"
  - "OLAP híbrido"
  - "MOLAP automático"
  - "OLAP relacional"
  - "OLAP multidimensional"
  - "MOLAP agendado [Analysis Services]"
  - "partições [Analysis Services], armazenamento"
  - "HOLAP"
  - "MOLAP"
  - "ROLAP em tempo real"
  - "HOLAP em tempo real"
...
---
# Definir armazenamento de parti&#231;&#227;o (Analysis Services – Multidimensional)
