---
description: Objetos de configuração do Database Mail
...
-   Uma coluna de bits indicando se a conexão com o servidor de email SMTP é feita usando o protocolo TSL, conhecido anteriormente como protocolo SSL.  
