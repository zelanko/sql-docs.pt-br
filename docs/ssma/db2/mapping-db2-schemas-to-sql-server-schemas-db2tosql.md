...
No SSMA, você pode mapear um esquema do DB2 para alguma disponível [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] esquema.  
...
2.  No painel direito, clique no **esquema de mapeamento** guia.  
    ...
    Você verá uma lista de todos os esquemas do DB2, seguido por um valor de destino. Este destino é indicado em uma notação de duas partes (*database.schema*) no [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] onde seus objetos e dados serão migrados.  
...
Se você deseja analisar a conversão de DB2 objetos em [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] objetos, você pode [relatório de migração de dados (SSMA comuns)](http://msdn.microsoft.com/bbfb9d88-5a98-4980-8d19-c5d78bd0d241).  
