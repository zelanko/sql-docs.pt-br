...
Se você estiver usando o driver PDO_SQLSRV, você pode encontrar mais informações sobre erros e tratamento de erros no [PDO](http://php.net/manual/book.pdo.php) site.  
