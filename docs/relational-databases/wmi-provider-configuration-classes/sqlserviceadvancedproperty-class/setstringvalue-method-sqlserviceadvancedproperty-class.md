...
## <a name="remarks"></a>Remarks  
 O tipo de valor de propriedade deve ser **cadeia de caracteres** para poder definir a propriedade como um valor de cadeia de caracteres.  
