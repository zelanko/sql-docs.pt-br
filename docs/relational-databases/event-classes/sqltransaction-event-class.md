...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Use a classe de evento SQLTransaction para monitorar quando transações começam e são concluídas, especialmente ao testar aplicativos, gatilhos ou procedimentos armazenados.  
