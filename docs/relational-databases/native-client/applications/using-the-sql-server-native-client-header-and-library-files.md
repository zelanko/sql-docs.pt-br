...
description: Saiba como usar o cabeçalho de SQL Server Native Client e os arquivos de biblioteca para desenvolver um aplicativo. Copie os arquivos necessários para o ambiente de desenvolvimento.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
