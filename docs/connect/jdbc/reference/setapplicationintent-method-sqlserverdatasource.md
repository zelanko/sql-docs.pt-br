...
## <a name="remarks"></a>Comentários  
 Para mais informações sobre a propriedade de conexão **applicationIntent**, confira [Definir as propriedades de conexão](../../../connect/jdbc/setting-the-connection-properties.md).  
