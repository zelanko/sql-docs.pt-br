...
## Criar um gráfico de ganho  
 ...
 Se você não tiver o modelo de exemplo, poderá criá-lo usando o [Tutorial de mineração de dados básico](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
...
## Entendendo o gráfico de ganho  
 ...
 ![um gráfico de lucros que compara três modelos](../../analysis-services/data-mining/media/dm14-profitchartupdated.gif "um gráfico de lucros que compara três modelos")  
...
## Consulte também  
 ...
 [Testando a precisão com gráficos de comparação de precisão &#40;Tutorial de mineração de dados básica&#41;](../Topic/Testing%20Accuracy%20with%20Lift%20Charts%20\(Basic%20Data%20Mining%20Tutorial\).md)  
