...
description: Exiba grupo de linhas e de colunas para uma região de dados tablix selecionada no momento. Saiba mais sobre o painel de agrupamento no Construtor de Relatórios.
ms.date: 08/17/2018
