---
title: "Implementar uma Transforma&#231;&#227;o Pesquisa em modo cache cheio usando o Gerenciador de Conex&#245;es do Cache | Microsoft Docs"
ms.custom: ""
ms.date: "12/29/2016"
...
manager: "jhubbard"
---
# Implementar uma Transforma&#231;&#227;o Pesquisa em modo cache cheio usando o Gerenciador de Conex&#245;es do Cache
...
### Para implementar uma transformação Pesquisa em modo cache cheio em um pacote usando o gerenciador de conexões de cache e uma fonte de dados no fluxo de dados  
...
### Para implementar uma transformação Pesquisa em modo cache cheio em dois pacotes usando o gerenciador de conexões de cache e uma fonte de dados no fluxo de dados  
...
13. Abra o pacote pai, adicione uma tarefa Executar Pacote ao fluxo de controle e, então, configure a tarefa para chamar o pacote filho. Para obter mais informações, consulte [Execute Package Task](../../../integration-services/control-flow/execute-package-task.md).  
  
14. Execute os pacotes.  
  
### Para implementar uma transformação Pesquisa em modo cache cheio usando o gerenciador de conexões de cache e um arquivo de cache existente  
