...
|Fechar um menu ou uma caixa de diálogo, cancelando a ação|ESC|ESC|  
  
## <a name="windows-management-and-toolbar-keyboard-shortcuts"></a>Gerenciamento do Windows e atalhos de teclado da barra de ferramentas  
...
|Exibir o navegador IDE com a primeira janela do documento selecionada|CTRL+TAB|Sem equivalente|  
|Alternar as janelas filho MDI anteriores|CTRL+SHIFT+TAB|CTRL+SHIFT+TAB|  
...
## <a name="bookmark-keyboard-shortcuts"></a>Atalhos de teclado de indicadores  
  
|Ação|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Definir ou remover um indicador na linha atual|CTRL+K, CTRL+K|CTRL+K, CTRL+K|  
|Próximo indicador|CTRL+K, CTRL+N|CTRL+K, CTRL+N|  
|Se o indicador atual estiver em uma pasta, moverá para o próximo indicador na pasta. Os indicadores fora da pasta são ignorados.<br /><br /> Se o indicador não estiver em uma pasta, moverá para o próximo indicador no mesmo nível.<br /><br /> Se a janela Indicadores contiver uma pasta, os indicadores em pastas serão ignorados.|CTRL+SHIFT+K, CTRL+SHIFT+N|Sem equivalente|  
|Indicador anterior|CTRL+K, CTRL+P|CTRL+K, CTRL+P|  
|Se o indicador atual estiver em uma pasta, moverá para o próximo indicador na pasta. Os indicadores fora da pasta são ignorados.<br /><br /> Se o indicador não estiver em uma pasta, moverá para o próximo indicador no mesmo nível.<br /><br /> Se a janela Indicadores contiver uma pasta, os indicadores em pastas serão ignorados.|CTRL+SHIFT+K, CTRL+SHIFT+P|Sem equivalente|  
|Limpar indicadores|CTRL+K, CTRL+L|CTRL+K, CTRL+L|  
  
## <a name="tree-control-keyboard-shortcuts"></a>Atalhos de teclado de controle de árvore  
  
|Ação|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Recolher nós de árvore|- (no teclado numérico)|- (no teclado numérico)|  
|Expandir todos os nós de árvore|* (no teclado numérico))|* (no teclado numérico)|  
|Rolar o controle de árvore para cima na janela|CTRL+SETA PARA CIMA|CTRL+SETA PARA CIMA|  
|Rolar o controle de árvore para baixo na janela|CTRL+SETA PARA BAIXO|CTRL+SETA PARA BAIXO|  
  
## <a name="code-editor-keyboard-shortcuts"></a>Atalhos de teclado do editor de códigos  
 Nenhum atalho é implementado em nenhum tipo de editor de códigos.  
...
|Exibir a caixa de diálogo **Navegar para** .|CTRL+SINAL DE ADIÇÃO (+)|Sem equivalente|  
...
## <a name="text-manipulation-in-code-editor-keyboard-shortcuts"></a>Manipulação de texto nos atalhos de teclado do editor de códigos  
...
|Excluir a palavra à direita do cursor|CTRL+DELETE|CTRL+DELETE|  
|Excluir a palavra à esquerda do cursor|CTRL+BACKSPACE|CTRL+BACKSPACE|  
|Transpor as palavras em qualquer lado do cursor (não se aplica ao Editor SQL)|CTRL+SHIFT+T|CTRL+SHIFT+T|  
|Move a linha que contém o cursor abaixo da linha seguinte|SHIFT+ALT+T|Sem equivalente|  
|Aplica o recuo e formatação de espaço ao idioma especificado no painel **Formatação** do idioma na seção **Editor de Texto** da caixa de diálogo **Opções** . Disponível somente no editor de texto.|CTRL+K, CTRL+D|Sem equivalente|  
|Recua corretamente as linhas de código selecionadas com base nas linhas de código ao redor|CTRL+K, CTRL+F|Sem equivalente|  
|Definir ou remover um atalho na linha atual|CTRL+K, CTRL+H|Sem equivalente|  
|Remover a sintaxe de comentário da linha atual|CTRL+K, CTRL+U|Sem equivalente|  
|Mostra ou oculta espaços e guias|CTRL+R, CTRL+W|Sem equivalente|  
|Habilita ou desabilita a quebra automática de linha em um editor|Alt+F, CTRL+W|Sem equivalente|  
|Recolhe todas as regiões de estrutura de tópicos para mostrar apenas os grupos externos na hierarquia|CTRL+M, CTRL+A|Sem equivalente|  
|Recolhe a região de estrutura de tópicos atualmente selecionada|CTRL+M, CTRL+S|Sem equivalente|  
|Expande todas as regiões de estrutura de tópicos na página|CTRL+M, CTRL+X|Sem equivalente|  
|Expande a região de estrutura de tópicos atualmente selecionada|CTRL+M, CTRL+E|Sem equivalente|  
|Recolhe as regiões de estrutura de tópicos existentes|CTRL+M, CTRL+O||  
|Oculta o texto selecionado. Um ícone de sinal marca o local do texto oculto|CTRL+M, CTRL+H|Sem equivalente|  
|Alterna todas as seções de texto anteriormente marcadas como ocultas entre os estados ocultas e exibidas.|CTRL+M, CTRL+L|Sem equivalente|  
|Alterna a seção de texto oculta selecionada atualmente entre os estados oculta e exibida|CTRL+M, CTRL+M|Sem equivalente|  
|Remove todas as informações de estrutura de tópicos no documento|CTRL+M, CTRL+P|Sem equivalente|  
|Remove as informações de estrutura de tópicos da região atualmente selecionada|CTRL+M, CTRL+U|Sem equivalente|  
  
## <a name="transact-sql-debugger-keyboard-shortcuts"></a>Atalhos do teclado do depurador Transact-SQL  
...
## <a name="microsoft-intellisense-keyboard-shortcuts"></a>Atalhos de teclado do Microsoft IntelliSense  
...
|Role para cima ou para baixo no Monitor de Atividade|CTRL+ALT+UP/DOWN|CTRL+ALT+UP/DOWN|  
