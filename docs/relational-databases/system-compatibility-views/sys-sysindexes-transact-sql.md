...
ms.author: jroth
manager: craigg
ms.openlocfilehash: a63c9917852a0c2f1f0a4260b7d79ea8d46614bb
...
|**first**|**binary(6)**|Ponteiro para a primeira página, ou página-raiz.<br /><br /> Não utilizado quando **indid** = 0.<br /><br /> NULL = o índice é particionado quando **indid** > 1.<br /><br /> NULL = a tabela é particionada quando **indid** é 0 ou 1.|  
