...
## <a name="managed-properties-data-source-type-connection-strings-and-credentials"></a>Propriedades gerenciadas: Tipo de fonte de dados, cadeias de caracteres de Conexão e credenciais  
