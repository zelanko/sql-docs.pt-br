...
|-------------------|-----------|  
|`OnError`|O manipulador de eventos para o `OnError` evento. Esse evento é gerado por um executável quando ocorre um erro.|  
