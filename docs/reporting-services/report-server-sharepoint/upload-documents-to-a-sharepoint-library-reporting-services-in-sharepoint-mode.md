...
helpviewer_keywords: 
  ...
  - "Integração do SharePoint [Reporting Services], gerenciamento de conteúdo"
...
---
# Carregar documentos em uma biblioteca do SharePoint (Reporting Services no modo do SharePoint)
...
### Para adicionar uma definição de relatório ou modelo de relatório a uma biblioteca  
