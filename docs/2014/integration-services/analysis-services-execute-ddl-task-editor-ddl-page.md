 ...
 **Conexão**  
 Selecione um [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] projeto ou um [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Gerenciador de conexões na lista ou clique \<**New connection...**> e use a caixa de diálogo **Adicionar Analysis Services Gerenciador de conexões** para criar uma nova conexão.  
 ...
 **Origem**  
 Selecione uma conexão de arquivo na lista ou clique \<**New connection...**> e use a caixa de diálogo **Gerenciador de conexões de arquivos** para criar uma nova conexão.  
 ...
 **Origem**  
 Selecione uma variável na lista ou clique \<**New variable...**> e use a caixa de diálogo **Adicionar variável** para criar uma nova variável.  
