...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] Agent é um serviço Microsoft Windows que executa tarefas administrativas agendadas, que são chamadas de *trabalho* no [!INCLUDE[ssCurrent](../../includes/sscurrent_md.md)].  
