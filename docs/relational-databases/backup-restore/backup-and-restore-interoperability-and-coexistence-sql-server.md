...
description: Este artigo descreve os recursos de backup e restauração do SQL Server, incluindo a inicialização do banco de dados, a restauração online, os índices desabilitados e o espelhamento de banco de dados.
