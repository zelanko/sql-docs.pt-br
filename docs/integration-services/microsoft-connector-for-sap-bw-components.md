---
title: Microsoft Connector for SAP BW componentes | Microsoft Docs
ms.custom: 
ms.date: 03/14/2017
...
## <a name="in-this-section"></a>Nesta seção  
 [Gerenciador de Conexão do SAP BW](../integration-services/connection-manager/sap-bw-connection-manager.md)  
 ...
 [Origem do SAP BW](../integration-services/data-flow/sap-bw-source.md)  
