...
description: O coletor de dados fornece um relatório para cada um dos conjuntos de coleta de dados do sistema para monitorar a capacidade e o desempenho do sistema no SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
