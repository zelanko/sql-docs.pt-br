...
-   No momento da configuração do rastreamento, usando a guia **configurações de extração de eventos** . Observe que essa guia não aparece até que você selecione um dos eventos Showplan na guia **seleção de eventos** .  
