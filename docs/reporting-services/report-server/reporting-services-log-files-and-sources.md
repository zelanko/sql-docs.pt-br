...
ms.topic: "article"
helpviewer_keywords: 
  - "solucionando problemas [Reporting Services], arquivos de log"
  - "logs [Reporting Services]"
  - "logs [Reporting Services], sobre os arquivos de log"
  - "servidores de relatório [Reporting Services], arquivos de log"
  - "arquivos de log de servidor de relatório"
  - "arquivos [Reporting Services], arquivos de log"
