...
ms.topic: "article"
helpviewer_keywords: 
  - "conexões [SQL Server], criptografadas"
  - "SSL [SQL Server]"
  - "protocolo SSL"
  - "criptografia [SQL Server], conexões"
  - "criptografia [SQL Server], conexões"
  - "certificados [SQL Server], instalando"
  - "solicitando conexões criptografadas"
...
> [!NOTE]  
>  Para usar critografia com um cluster de failover, você deve instalar o certificado de servidor com o nome DNS completamente qualificado do servidor virtual em todos os nós no cluster de failover. Por exemplo, se tiver um cluster de dois nós, com os nomes test1.*\<your company>*.com and test2.*\<your company>*.com, e um servidor virtual chamado "virtsql", será necessário instalar um certificado para virtsql.*\<your company>*.com em ambos os nós. Você pode definir o valor da opção **ForceEncryption**como **Sim**.  
...
2.  Na caixa de diálogo **Protocolos para Propriedades de ***\<instance name>* ****, na guia **Certificado**, selecione o certificado desejado na lista suspensa da caixa **Certificado** e clique em **OK**.  
