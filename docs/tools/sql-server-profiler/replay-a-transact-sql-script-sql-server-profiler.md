...
description: Saiba como usar SQL Server Profiler para repetir scripts Transact-SQL, permitindo a você comparar diferentes soluções possíveis para um problema de desempenho.
ms.prod: sql
