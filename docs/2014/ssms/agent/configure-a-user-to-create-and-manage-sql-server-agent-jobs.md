 ...
 **Para adicionar um logon do SQL ou uma função msdb a uma SQL Server Agent função de banco de dados fixa**  
 ...
 **Para configurar uma conta proxy para criar e gerenciar SQL Server Agent etapas de trabalho**  
