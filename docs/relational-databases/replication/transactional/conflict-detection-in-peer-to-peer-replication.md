...
helpviewer_keywords: 
  ...
  - "replicação transacional ponto a ponto, detecção de conflitos"
...
> [!NOTE]  
>  A coluna oculta pode ser acessada somente por um usuário registrado pela conexão de administrador dedicada (DAC). Para obter informações sobre DAC, consulte [conexão de diagnóstico para administradores de banco de dados](../../../database-engine/configure-windows/diagnostic-connection-for-database-administrators.md).  
...
-   Você pode habilitar e desabilitar a detecção de [!INCLUDE[ssManStudio](../../../includes/ssmanstudio-md.md)] usando o **Opções de assinatura** página o **Propriedades de publicação** caixa de diálogo ou o **Configurar topologia** página do Assistente para configurar topologia ponto a ponto. Para obter mais informações, consulte [detecção de conflitos em replicação ponto a ponto](../../../relational-databases/replication/transactional/conflict-detection-in-peer-to-peer-replication.md).  
...
-   Tente sincronizar o nó novamente permitindo que o Agente de Distribuição continue a aplicar as alterações:  
    ...
    1.  Executar [sp_changepublication](../../../relational-databases/system-stored-procedures/sp-changepublication-transact-sql.md): especificar 'p2p_continue_onconflict' para o parâmetro @property e **true** para o parâmetro @value.  
    ...
    4.  Execute a validação para garantir que as linhas de conflito se encontraram corretamente. Para obter mais informações, consulte [Validar dados replicados](../../../relational-databases/replication/validate-replicated-data.md).  
    ...
    5.  Executar [sp_changepublication](../../../relational-databases/system-stored-procedures/sp-changepublication-transact-sql.md): especificar 'p2p_continue_onconflict' para o parâmetro @property e **false** para o parâmetro @value.  
