...
|**ClientProcessID**|**Inteiro**|ID atribuída pelo computador host ao processo em que o aplicativo cliente está sendo executado. Essa coluna de dados será populada se a ID do processo do cliente for fornecida pelo cliente.|9|Sim|  
...
|**Nome do arquivo**|**nvarchar**|Nome lógico do arquivo que está sendo reduzido.|36|Sim|  
