...
3.  No **nome** , altere o nome do novo conjunto nomeado para `[Core Products]`.  
...
4.  No **metadados** guia o **ferramentas de cálculo** painel, expanda **produto**, expanda **categoria**, expanda `Members`e, em seguida, Expanda **todos os produtos**.  
...
1.  Clique com botão direito `[Core Products]` no **organizador de Script** painel e clique **novo conjunto nomeado**.  
  
2.  No **nome** , altere o nome desse conjunto nomeado para `[Large Resellers]`.  
  
3.  No **expressão** , digite `Exists()`.  
...
9. Na janela Propriedades, altere o `DiscretizationMethod` propriedade **automático**e, em seguida, altere o `DiscretizationBucketCount` propriedade `5`. Para obter mais informações, consulte [Agrupar membros de atributo &#40;Diferenciação&#41;](multidimensional-models/attribute-properties-group-attribute-members.md).  
...
12. No **metadados** guia o **ferramentas de cálculo** painel, expanda **número de funcionários** no **revendedor** dimensão, expanda `Members`e, em seguida, expanda **todos os revendedores**.  
     ...
     Os membros dessa hierarquia de atributo estão agrupados porque a propriedade DiscretizationBucketCount está definida como `5` e a propriedade DiscretizationMethod está definida como **automática**.  
...
13. Na caixa **Expressão** , adicione uma vírgula na expressão de conjunto Exists após a função Members e antes do parêntese de fechamento; em seguida, arraste **83 – 100** do painel **Metadados** e coloque-o após a vírgula.  
     ...
     A imagem a seguir mostra o **expressões de cálculo** painel para o `[Large Resellers]` conjunto nomeado.  
...
5.  Expanda a dimensão Produto e adicione Categoria e Subcategoria à área de linha, conforme mostrado na imagem a seguir.  
     ...
     ![Os membros do atributo subcategoria](../../2014/tutorials/media/l6-named-set-03.gif "membros do atributo subcategoria")  
...
6.  No painel **Metadados** , na dimensão **Produto** , arraste **Produtos Principais** para a área de filtro.  
     ...
     ![Conjunto nomeado de membros de produto principal](../../2014/tutorials/media/l6-named-set-04.gif "conjunto nomeado de membros de produto principal")  
...
7.  No painel **Metadados** , expanda **Revendedor**, adicione **Grandes Revendedores** à área de filtro.  
     ...
     ![Painel de filtro que contém dois denominado define](../../2014/tutorials/media/l6-named-set-05.gif "define um painel de filtro que contém dois denominado")  
