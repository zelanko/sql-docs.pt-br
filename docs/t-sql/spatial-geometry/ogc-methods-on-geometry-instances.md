---
description: Métodos do OGC em instâncias geometry
title: Métodos do OGC em instâncias de geometria | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97474147"
---
# <a name="ogc-methods-on-geometry-instances"></a>Métodos do OGC em instâncias geometry
[!INCLUDE [sql-asdb-asdbmi-asa-pdw](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] dá suporte aos métodos do OGC (Open Geospatial Consortium) em instâncias de geometria.  
