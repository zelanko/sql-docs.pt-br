...
ms.locfileid: "62698923"
---
# <a name="audit-database-object-gdr-event-class"></a>Classe de evento Audit Database Object GDR
  A classe de evento **Audit Database Object GDR** ocorre quando uma concessão, revogação ou negação é emitida para objetos de banco de dados, como assemblies e esquemas.  
