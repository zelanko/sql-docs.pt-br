...
description: 'Saiba como usar as anotações sql: Identity e SQL: GUID em um esquema XSD para definir o comportamento de um XML updategram.'
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
