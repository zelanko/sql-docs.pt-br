...
|Cmdlets do PowerShell||Apenas SharePoint|Para obter uma lista dos cmdlets do powershell, consulte [cmdlets do PowerShell para o Reporting Services SharePoint Mode](../powershell-cmdlets-for-reporting-services-sharepoint-mode.md).|  
