...
description: Descubra como usar instruções Transact-SQL para importar dados em massa de um arquivo para uma tabela do SQL Server ou do Banco de Dados SQL do Azure, incluindo considerações sobre segurança.
ms.prod: sql
