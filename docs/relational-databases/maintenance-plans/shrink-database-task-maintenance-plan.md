...
description: Saiba como usar criar uma tarefa que tenta reduzir o tamanho dos bancos de dados do SQL Server selecionados usando a Tarefa Reduzir Banco de Dados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
