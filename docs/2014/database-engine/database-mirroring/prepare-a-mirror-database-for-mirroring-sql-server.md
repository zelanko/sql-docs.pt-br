...
-   Você não pode espelhar um banco de dados que pertence a um [grupos de disponibilidade do AlwaysOn (SQL Server)](../availability-groups/windows/always-on-availability-groups-sql-server.md).  
