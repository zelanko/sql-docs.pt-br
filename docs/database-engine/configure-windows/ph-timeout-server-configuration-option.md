...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "tempo para espera de manipulador de protocolo [SQL Server]"
  - "opções de tempo limite [SQL Server], opção de tempo limite ph"
  - "protocolos [SQL Server], atingindo tempo limite"
  - "opção ph timeout"
...
---
# Op&#231;&#227;o de configura&#231;&#227;o de servidor PH timeout
