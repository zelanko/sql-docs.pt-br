...
|[getSubString](../../../connect/jdbc/reference/getsubstring-method-sqlservernclob.md)|Recupera uma cópia da subcadeia de caracteres especificada no valor **NClob** designado pelo objeto **Java. Sql. NClob** .|  
...
|[setString](../../../connect/jdbc/reference/setstring-method-sqlservernclob.md)|Grava a **cadeia de caracteres** especificada para o **NClob** começando na posição especificada.|  
