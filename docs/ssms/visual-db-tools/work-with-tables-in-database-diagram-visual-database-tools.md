---
description: Trabalhar com tabelas no diagrama de banco de dados (Visual Database Tools)
title: Trabalhar com tabelas no diagrama de banco de dados
ms.prod: sql
