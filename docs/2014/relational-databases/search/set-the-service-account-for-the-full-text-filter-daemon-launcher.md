...
2.  Em **SQL Server Configuration Manager**, clique em **SQL Server Services**, clique com botão direito **iniciador do Daemon de filtro de texto completo SQL (*`instance name`*)** e, em seguida, clique em **propriedades**.  
