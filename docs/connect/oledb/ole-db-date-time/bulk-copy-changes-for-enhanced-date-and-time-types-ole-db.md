...
description: Saiba mais sobre as melhorias de data/hora para dar suporte à funcionalidade de cópia em massa no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
