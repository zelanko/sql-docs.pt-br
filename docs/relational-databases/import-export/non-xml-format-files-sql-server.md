...
description: O SQL Server 2019 dá suporte a arquivos de formato XML e não XML para exportação e importação em massa. Saiba mais sobre os arquivos de formato não XML e os benefícios deles.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
