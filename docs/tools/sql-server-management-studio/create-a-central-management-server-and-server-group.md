---
title: "Criar um servidor de gerenciamento central e um grupo de servidores (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
#### Criar um servidor central de gerenciamento  
...
5.  Na guia de **Propriedades da Conexão** , revise ou modifique as propriedades da rede e da conexão. Para obter mais informações, consulte [Conectar ao Servidor &#40;página Propriedades da Conexão&#41; Mecanismo de Banco de Dados](../../ssms/f1-help/connect-to-server-connection-properties-page-database-engine.md)  
...
#### Criar um novo grupo de servidores e adicionar servidores ao grupo  
...
#### Para executar consultas em vários destinos de configuração ao mesmo tempo  
