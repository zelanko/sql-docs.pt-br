...
ms.openlocfilehash: 3b31e1af8ede15f7b923ebbf8d51de8005d9235a
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  ...
  O Database Mail possui as exibições a seguir que mostram conteúdo de email, status de emails e qualquer mensagem recebida, como os erros registrados por ele. Esses modos de exibição de **msdb** banco de dados.  
  
|||  
|-|-|  
|[sysmail_allitems &#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/sysmail-allitems-transact-sql.md)|[sysmail_mailattachments &#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/sysmail-mailattachments-transact-sql.md)|  
