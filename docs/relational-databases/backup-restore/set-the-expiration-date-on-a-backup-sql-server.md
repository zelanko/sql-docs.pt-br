---
title: "Definir a data de validade em um backup (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "fazendo backup de bancos de dados [SQL Server], datas de validade"
  - "validade [SQL Server]"
  - "backups de bancos de dados [SQL Server], datas de validade"
...
---
# Definir a data de validade em um backup (SQL Server)
...
#### Para definir a data de validade em um backup  
