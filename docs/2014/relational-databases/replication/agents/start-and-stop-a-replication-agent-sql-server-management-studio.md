...
3.  Clique com o botão direito no trabalho para o agente e, então, clique em **Iniciar Trabalho** ou **Parar Trabalho**. O nome do trabalho para a Queue Reader Agent está no formato **[ \<Distributor> ]. \<integer> **.  
