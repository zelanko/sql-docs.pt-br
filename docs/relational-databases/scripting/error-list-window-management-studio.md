...
helpviewer_keywords: 
  ...
  - "SQL Server Management Studio [SQL Server], janela lista de erros"
...
manager: "jhubbard"
---
# Janela Lista de Erros (Management Studio)
...
## Trabalhando com a Lista de Erros  
...
## Erros de Transact-SQL no Management Studio  
