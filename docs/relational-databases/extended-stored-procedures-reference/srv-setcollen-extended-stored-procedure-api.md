...
description: Saiba como srv_setcollen especifica o comprimento de dados atual em bytes de uma coluna de comprimento variável ou uma coluna que permite valores nulos.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
