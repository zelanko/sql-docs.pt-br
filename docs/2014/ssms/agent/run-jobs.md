...
|-|-|  
|**Descrição**|**Tópico**|  
|Descreve como iniciar a execução de um trabalho do [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent.|[Start a Job](start-a-job.md)|  
|Descreve como interromper um trabalho do [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent.|[Stop a Job](stop-a-job.md)|  
|Descreve como desabilitar ou habilitar um trabalho do [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent.|[Desabilitar ou habilitar um trabalho](disable-or-enable-a-job.md)|  
