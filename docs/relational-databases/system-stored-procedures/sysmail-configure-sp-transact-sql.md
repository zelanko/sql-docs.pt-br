...
ms.locfileid: "68017724"
---
# <a name="sysmail_configure_sp-transact-sql"></a>sysmail_configure_sp (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  Altera definições de configuração do Database Mail. As definições de configuração especificadas com **sysmail_configure_sp** se aplicam [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] à instância inteira.  
