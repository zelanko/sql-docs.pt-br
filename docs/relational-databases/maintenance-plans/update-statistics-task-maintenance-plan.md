...
description: Saiba como atualizar as informações do SQL Server sobre os dados nas tabelas e índices usando Usar a Tarefa Atualização de Estatísticas.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
