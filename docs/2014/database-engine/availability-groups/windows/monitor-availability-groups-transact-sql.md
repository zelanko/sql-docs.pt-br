...
##  <a name="monitoring-the-alwayson-availability-groups-feature-on-a-server-instance"></a><a name="AoAgFeatureOnSI"></a>Monitorando o recurso Grupos de Disponibilidade AlwaysOn em uma instância de servidor  
...
##  <a name="monitoring-availability-group-listeners"></a><a name="AGlisteners"></a>Monitorando ouvintes do grupo de disponibilidade  
