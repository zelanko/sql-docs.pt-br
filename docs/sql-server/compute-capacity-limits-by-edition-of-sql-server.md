...
description: Este artigo discute os limites de capacidade de computação para o SQL Server 2019 e como eles diferem em ambientes físicos e virtuais com processadores com hyperthreading.
ms.custom: ''
ms.date: 11/07/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>Confira também  
 ...
 [Instalação de Início Rápido do SQL Server 2016](../database-engine/install-windows/install-sql-server.md)  
