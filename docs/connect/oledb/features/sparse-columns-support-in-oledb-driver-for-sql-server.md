...
description: Saiba como o Driver do OLE DB para SQL Server dá suporte a colunas esparsas e confira informações sobre esse tipo de coluna no SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
