...
helpviewer_keywords: 
  ...
  - "Servidores registrados [SQL Server], ajuda"
  - "Ajuda do SQL Server Management Studio [SQL Server], servidores registrados"
...
---
# Ajuda F1 dos Servidores Registrados
 ...
 ## Novo Registro ou Editar Registro de Servidor (guia Geral) do Reporting Services 
 ...
 **Teste**  
 ...
 ## Novo Registro ou Editar Registro de Servidor (guia Geral) do Analysis Services – Dados Multidimensionais
 ...
 **Teste**  
 ...
 ## Novo Registro ou Editar Registro de Servidor (guia Geral) do SSIS 
