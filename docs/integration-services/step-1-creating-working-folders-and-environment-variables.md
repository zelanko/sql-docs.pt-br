...
manager: "jhubbard"
---
# Etapa 1: Criando pastas de trabalho e vari&#225;veis de ambiente
...
### Para criar a pasta de trabalho local  
...
### Para criar variáveis locais do ambiente  
...
### Para criar variáveis de ambiente de destino  
