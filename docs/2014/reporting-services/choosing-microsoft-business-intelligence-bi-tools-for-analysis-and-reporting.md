...
# <a name="choosing-microsoft-reporting-and-analysis-tools"></a>Escolhendo ferramentas de análise e emissão de relatórios da Microsoft
 ...
 Se você estiver procurando uma visão geral breve dessas ferramentas para ajudá-lo a decidir quais ferramentas são certas para você, consulte [ferramentas de Introdução ao Microsoft Business Intelligence (BI)](http://msdn.microsoft.com/en-us/library/dn655131.aspx).  
...
|Execute análise de previsão de autoatendimento||||||[Mineração de dados suplementos para Excel](http://msdn.microsoft.com/library/dn282385\(v=sql.120\).aspx)|  
|Visualize e explore dados||[O Power View](http://go.microsoft.com/fwlink/p/?LinkId=391847)<br /><br /> [Mapa de energia](http://go.microsoft.com/fwlink/p/?LinkId=391848)|||||  
...
|Crie visualizações de dados ad-hoc|||[O Power View para SharePoint](http://go.microsoft.com/fwlink/p/?LinkId=391858)||||  
...
|Use os algoritmos de mineração de dados||||||[Mineração de dados no Analysis Services](http://technet.microsoft.com/library/bb510516\(v=sql.120\).aspx)|  
 ...
 <sup>1</sup> reporting Services tem vários recursos que dão suporte à entrega de relatórios operacionais e relatórios personalizados, como assinaturas e alertas de dados.  
