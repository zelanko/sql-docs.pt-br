---
title: As propriedades do objeto, métodos e eventos da chave | Microsoft Docs
ms.prod: sql
...
## <a name="propertiescollections"></a>Propriedades/coleções  
 ...
 [Propriedade Type (Key)](../../../ado/reference/adox-api/type-property-key-adox.md)  
