---
title: Exemplos SELECT (Transact-SQL) | Microsoft Docs
ms.custom: 
ms.date: 03/16/2017
...
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)]
  ...
  Este tópico fornece exemplos de como usar o [selecione](../../t-sql/queries/select-transact-sql.md) instrução.  
...
## <a name="a-using-select-to-retrieve-rows-and-columns"></a>A. Usando SELECT para recuperar linhas e colunas  
 ...
 [!code-sql[Selecione #SelectExamples1](../../t-sql/queries/codesnippet/tsql/select-examples-transact_1.sql)]  
 ...
 [!code-sql[Selecione #SelectExamples2](../../t-sql/queries/codesnippet/tsql/select-examples-transact_2.sql)]  
 ...
 [!code-sql[Selecione #SelectExamples3](../../t-sql/queries/codesnippet/tsql/select-examples-transact_3.sql)]  
...
## <a name="b-using-select-with-column-headings-and-calculations"></a>B. Usando SELECT com títulos de coluna e cálculos  
 ...
 [!code-sql[Selecione #SelectExamples4](../../t-sql/queries/codesnippet/tsql/select-examples-transact_4.sql)]  
  
 Esta é a consulta que calcula a receita para cada produto em cada ordem de vendas.  
  
 [!code-sql[Selecione #SelectExamples5](../../t-sql/queries/codesnippet/tsql/select-examples-transact_5.sql)]  
...
## <a name="c-using-distinct-with-select"></a>C. Usando DISTINCT com SELECT  
 ...
 [!code-sql[Selecione #SelectExamples6](../../t-sql/queries/codesnippet/tsql/select-examples-transact_6.sql)]  
...
## <a name="d-creating-tables-with-select-into"></a>D. Criando tabelas com SELECT INTO  
 ...
 [!code-sql[Selecione #SelectExamples7](../../t-sql/queries/codesnippet/tsql/select-examples-transact_7.sql)]  
  
 Este segundo exemplo cria a tabela permanente `NewProducts`.  
  
 [!code-sql[Selecione #SelectExamples8](../../t-sql/queries/codesnippet/tsql/select-examples-transact_8.sql)]  
...
## <a name="e-using-correlated-subqueries"></a>E. Usando subconsultas correlacionadas  
 ...
 [!code-sql[Selecione #SelectExamples9](../../t-sql/queries/codesnippet/tsql/select-examples-transact_9.sql)]  
 ...
 [!code-sql[Selecione #SelectExamples10](../../t-sql/queries/codesnippet/tsql/select-examples-transact_10.sql)]  
 ...
 [!code-sql[Selecione #SelectExamples11](../../t-sql/queries/codesnippet/tsql/select-examples-transact_11.sql)]  
  
 Este exemplo usa duas subconsultas correlatas para localizar os nomes de funcionários que venderam um produto específico.  
  
 [!code-sql[Selecione #SelectExamples12](../../t-sql/queries/codesnippet/tsql/select-examples-transact_12.sql)]  
  
## <a name="f-using-group-by"></a>F. Usando GROUP BY  
 O exemplo a seguir localiza o total de cada ordem de vendas no banco de dados.  
  
 [!code-sql[Selecione #SelectExamples13](../../t-sql/queries/codesnippet/tsql/select-examples-transact_13.sql)]  
...
## <a name="g-using-group-by-with-multiple-groups"></a>G. Usando GROUP BY com vários grupos  
 ...
 [!code-sql[Selecione #SelectExamples14](../../t-sql/queries/codesnippet/tsql/select-examples-transact_14.sql)]  
...
## <a name="h-using-group-by-and-where"></a>H. Usando GROUP BY e WHERE  
 ...
 [!code-sql[Selecione #SelectExamples15](../../t-sql/queries/codesnippet/tsql/select-examples-transact_15.sql)]  
...
## <a name="i-using-group-by-with-an-expression"></a>I. Usando GROUP BY com uma expressão  
 ...
 [!code-sql[Selecione #SelectExamples16](../../t-sql/queries/codesnippet/tsql/select-examples-transact_16.sql)]  
...
## <a name="j-using-group-by-with-order-by"></a>J. Usando GROUP BY com ORDER BY  
 ...
 [!code-sql[Selecione #SelectExamples18](../../t-sql/queries/codesnippet/tsql/select-examples-transact_17.sql)]  
...
## <a name="k-using-the-having-clause"></a>K. Usando a cláusula HAVING  
 ...
 [!code-sql[Selecione #SelectExamples19](../../t-sql/queries/codesnippet/tsql/select-examples-transact_18.sql)]  
...
## <a name="l-using-having-and-group-by"></a>L. Usando HAVING e GROUP BY  
 ...
 [!code-sql[Selecione #SelectExamples21](../../t-sql/queries/codesnippet/tsql/select-examples-transact_19.sql)]  
...
## <a name="m-using-having-with-sum-and-avg"></a>M. Usando HAVING com SUM e AVG  
 ...
 [!code-sql[Selecione #SelectExamples22](../../t-sql/queries/codesnippet/tsql/select-examples-transact_20.sql)]  
  
 Para consultar os produtos que tiveram vendas totais maiores que `$2000000.00`, use esta consulta:  
  
 [!code-sql[Selecione #SelectExamples23](../../t-sql/queries/codesnippet/tsql/select-examples-transact_21.sql)]  
 ...
 [!code-sql[Selecione #SelectExamples24](../../t-sql/queries/codesnippet/tsql/select-examples-transact_22.sql)]  
...
## <a name="n-using-the-index-optimizer-hint"></a>N. Usando a dica de otimização INDEX  
 ...
 [!code-sql[Selecione #SelectExamples45](../../t-sql/queries/codesnippet/tsql/select-examples-transact_23.sql)]  
...
## <a name="m-using-option-and-the-group-hints"></a>M. Usando OPTION e as dicas de GROUP  
 ...
 [!code-sql[Selecione #SelectExamples46](../../t-sql/queries/codesnippet/tsql/select-examples-transact_24.sql)]  
...
## <a name="o-using-the-union-query-hint"></a>O. Usando a dica de consulta UNION  
 ...
 [!code-sql[Selecione #SelectExamples47](../../t-sql/queries/codesnippet/tsql/select-examples-transact_25.sql)]  
...
## <a name="p-using-a-simple-union"></a>P. Usando uma UNION simples  
 ...
 [!code-sql[Selecione #SelectExamples48](../../t-sql/queries/codesnippet/tsql/select-examples-transact_26.sql)]  
...
## <a name="q-using-select-into-with-union"></a>Q. Usando SELECT INTO com UNION  
 ...
 [!code-sql[Selecione #SelectExamples49](../../t-sql/queries/codesnippet/tsql/select-examples-transact_27.sql)]  
...
## <a name="r-using-union-of-two-select-statements-with-order-by"></a>R. Usando UNION de duas instruções SELECT com ORDER BY  
 ...
 [!code-sql[Selecione #SelectExamples50](../../t-sql/queries/codesnippet/tsql/select-examples-transact_28.sql)]  
...
## <a name="s-using-union-of-three-select-statements-to-show-the-effects-of-all-and-parentheses"></a>S. Usando UNION de três instruções SELECT para mostrar os efeitos de ALL e parênteses  
 ...
 [!code-sql[Selecione #SelectExamples51](../../t-sql/queries/codesnippet/tsql/select-examples-transact_29.sql)]  
...
## <a name="see-also"></a>Consulte também  
 ...
 [União &#40; Transact-SQL &#41;](../../t-sql/language-elements/set-operators-union-transact-sql.md)   
 ...
 [NA cláusula &#40; Transact-SQL &#41;](../../t-sql/queries/select-into-clause-transact-sql.md)  
