---
description: Métodos estendidos em instâncias geometry
title: Métodos estendidos em instâncias de geometria | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88458988"
---
# <a name="extended-methods-on-geometry-instances"></a>Métodos estendidos em instâncias geometry
[!INCLUDE [SQL Server Azure SQL Database ](../../includes/applies-to-version/sql-asdb.md)]

  O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] dá suporte a vários métodos estendidos em instâncias de geometria do OGC (Open Geospatial Consortium).  
...
-   [Filter &#40;tipo de dados geometry&#41;](../../t-sql/spatial-geometry/filter-geometry-data-type.md)  
