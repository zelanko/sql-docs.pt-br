...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Você pode criar um novo atributo em uma dimensão usando a edição arrastar-e-soltar no Designer de dimensão.  
