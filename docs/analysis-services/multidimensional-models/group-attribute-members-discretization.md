...
ms.topic: "article"
helpviewer_keywords: 
  - "propriedade NameColumn"
  - "discretização [Analysis Services]"
  - "grupos de membros [Analysis Services]"
  - "agrupando membros"
  - "propriedade DiscretizationNumber"
  - "ordens de classificação [Analysis Services]"
  - "propriedade DiscretizationMethod"
  - "adicionando membros ao grupo de membros"
  - "número de grupos de membros"
  - "membros [Analysis Services], grupos"
  - "nomes [Analysis Services], grupos de membros"
...
manager: "erikre"
---
# Agrupar membros de atributo (diferencia&#231;&#227;o)
...
## Atualizando uma dimensão com atributos de diferenciação  
