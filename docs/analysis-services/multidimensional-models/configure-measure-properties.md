...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]As medidas têm propriedades que permitem definir como elas funcionam e controlar como as medidas aparecem para os usuários.  
