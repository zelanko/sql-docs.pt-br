...
ms.topic: "article"
helpviewer_keywords: 
  - "segurança [Reporting Services], padrões"
  - "segurança padrão"
  - "segurança com base em função [Reporting Services], padrões"
...
### Personalizando a função Gerenciador de Conteúdo  
...
### Personalizando a função Navegador  
