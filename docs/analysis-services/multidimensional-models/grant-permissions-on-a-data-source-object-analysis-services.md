...
helpviewer_keywords: 
  ...
  - "direitos de acesso do usuário [Analysis Services], fontes de dados"
  - "security [Analysis Services], data sources"
  - "cadeias de caracteres de conexão [Analysis Services]"
  - "fontes de dados [Analysis Services], segurança"
