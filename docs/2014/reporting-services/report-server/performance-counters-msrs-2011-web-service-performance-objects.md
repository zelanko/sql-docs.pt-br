...
-   [Contadores de desempenho do Serviço Web MSRS 2014](#bkmk_webservice)

-   [Contadores de Desempenho do Serviço Windows MSRS 2014](#bkmk_windowsservice)

-   [Use cmdlets do PowerShell para retornar listas](#bkmk_powershell)

##  <a name="bkmk_webservice"></a>Contadores de desempenho do serviço Web MSRS 2014
...
|`Memory Cache Hits/Sec`|Número de vezes por segundo que os relatórios são recuperados do cache na memória. O *cache na memória* é uma parte do cache que armazena relatórios na memória da CPU. Quando o cache na memória é usado, o servidor de relatório não consulta o [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] para obter o conteúdo armazenado em cache.|
...
|`Total Memory Cache Hits`|Número total de relatórios armazenados em cache retornados do cache na memória depois que o serviço foi iniciado. Este contador é zerado sempre que [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] para o serviço Web Servidor de Relatórios. O *cache na memória* é uma parte do cache que armazena relatórios na memória da CPU. Quando o cache na memória é usado, o servidor de relatório não consulta o [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] para obter o conteúdo armazenado em cache.|
...
##  <a name="bkmk_windowsservice"></a>Contadores de desempenho do serviço Windows MSRS 2014
...
|**Total de liberações de cache**|Número total de atualizações do cache do servidor de relatórios depois que o serviço é iniciado. Esse contador é zerado quando o domínio de aplicativo é reciclado. Consulte `Cache Flushes/Sec`.|
...
## <a name="see-also"></a>Consulte Também
 [Monitorando](monitoring-report-server-performance.md) [contadores de desempenho de desempenho do servidor de relatório para o modo do SharePoint do serviço Web MSRS 2014 e objetos de desempenho do modo do SharePoint do serviço Windows MSRS 2014 &#40;modo do SharePoint&#41;](../report-server/performance-counters-msrs-2011-web-service-performance-objects.md) [contadores de desempenho para os objetos de desempenho ReportServer: Service e ReportServerSharePoint: Service](performance-counters-reportserver-service-performance-objects.md)
