...
> [!TIP]
> Examine o [requisitos de sistema](sql-server-linux-setup.md#system) para SQL Server no Linux.
...
## <a name="how-to-install-cumulative-updates"></a>Como instalar atualizações cumulativas
