 ...
 **SQLNumResultCols** pode retornar qualquer SQLSTATE que possa ser retornado por **SQLPrepare** ou **SQLExecute** quando chamado após **SQLPrepare** e before **SQLExecute**, dependendo de quando a fonte de dados avaliar a instrução SQL associado à instrução.  
