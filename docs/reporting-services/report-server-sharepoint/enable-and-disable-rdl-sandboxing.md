...
---
# Habilitar e desabilitar o RDL Sandboxing
...
|**Membros**|Para a lista de tipos que estão incluídos no elemento **\<Types>**, a lista de nomes de membros que não são permitidos em expressões RDL.|  
...
-   O método **New** do [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)].  
...
-   Acrescente aquela nova classe à lista de permissões.  
 ...
 Para acrescentar palavras-chave de tipo do [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET Framework à lista de permissões, acrescente o tipo CLR correspondente à lista de permissões. Por exemplo, para usar a palavra-chave **Integer** do [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET Framework, acrescente o seguinte fragmento XML ao elemento **\<RDLSandboxing>**:  
...
#### Mantendo a lista de membros \<Deny>  
...
### Trabalhando com operadores e novo  
