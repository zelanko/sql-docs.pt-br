---
title: Atualizado - DMX para documentos do SQL Server | Microsoft Docs
description: Trechos de código de exibição de conteúdo atualizado para alterados recentemente na documentação, para extensões DMX (Data Mining) para o Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "35312745"
---
# <a name="new-and-recently-updated-data-mining-extensions-dmx-for-sql-server"></a>Novos e atualizados recentemente: Data Mining Extensions (DMX) para o SQL Server
...
- *Área de assunto:* &nbsp; **extensões DMX (Data Mining) para o SQL Server**.
