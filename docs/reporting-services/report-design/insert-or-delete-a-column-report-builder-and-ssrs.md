...
description: Adicione ou exclua colunas em uma região de dados tablix em um relatório paginado. No Construtor de Relatórios, a região de dados tablix pode ser uma tabela, uma matriz ou uma lista.
ms.date: 03/01/2017
