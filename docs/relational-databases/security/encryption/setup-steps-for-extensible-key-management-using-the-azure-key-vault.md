...
1.  No painel esquerdo, selecione a guia **Selecionar entidade de segurança** e faça o seguinte:
    ...
    ![Captura de tela do botão Adicionar no painel "Adicionar política de acesso"](../../../relational-databases/security/encryption/media/ekm/ekm-part2-add-principal.png)
...
> [!NOTE] 
> As versões 1.0.0.440 e anteriores foram substituídas e não têm mais suporte em ambientes de produção. Atualize para a versão 1.0.1.0 ou posterior visitando o [Centro de Download da Microsoft](https://www.microsoft.com/download/details.aspx?id=45344). Use as instruções na página [Manutenção e solução de problemas do conector do SQL Server](../../../relational-databases/security/encryption/sql-server-connector-maintenance-troubleshooting.md), em "Atualização de Conector do SQL Server".

> [!NOTE]
> Há uma alteração da falha na versão 1.0.5.0, em termos do algoritmo de impressão digital. Você pode enfrentar falhas de restauração do banco de dados após a atualização para a versão 1.0.5.0. Para saber mais, confira o [artigo da base de dados de conhecimento 447099](https://support.microsoft.com/help/4470999/db-backup-problems-to-sql-server-connector-for-azure-1-0-5-0).
