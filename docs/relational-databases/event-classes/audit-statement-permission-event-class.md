...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Statement Permission** ocorre sempre que uma permissão de instrução (como CREATE TABLE) é usada.  
