---
title: Caixa de diálogo Propriedades da Faceta, página Geral
description: Descreve a 'Página Geral' da caixa de diálogo 'Propriedades da Faceta' para o gerenciamento baseado em políticas no SSMS (SQL Server Management Studio).
