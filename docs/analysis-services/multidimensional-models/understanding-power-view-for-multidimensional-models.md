...
---
# No&#231;&#245;es b&#225;sicas sobre o Power View para modelos multidimensionais
 ...
 **Grupos de medidas na Lista de Campos do Power View**  
 ...
 ![Lista de Campos no Power View](../../analysis-services/multidimensional-models/media/daxmd-powerviewfieldlist.gif "Lista de Campos no Power View")  
 ...
 **Tipos de geografia de atributo de dimensão no SSDT e Lista de Campos do Power View**  
 ...
 ![Tipo de geografia do atributo de dimensão](../../analysis-services/multidimensional-models/media/daxmd-ssdt-attribute-geog-types.gif "Tipo de geografia do atributo de dimensão")  
 ...
 **Relatório do Power View com membros calculados**  
 ...
 ![Membros calculados no Power View](../../analysis-services/multidimensional-models/media/daxmd-calcmembersinpowerview.gif "Membros calculados no Power View")  
 ...
 **Tipo de atributo de dimensão ImageURL no SSDT**  
 ...
 ![Propriedades do atributo de dimensão](../../analysis-services/multidimensional-models/media/daxmd-dimattribute-properties.gif "Propriedades do atributo de dimensão")  
 ...
 **Filtros Fixados**  
 ...
 ![Filtro Fixado](../../analysis-services/multidimensional-models/media/daxmd-pinnedfilterinpowerview.gif "Filtro Fixado")  
...
## Ajuda do cliente no Office.com  
