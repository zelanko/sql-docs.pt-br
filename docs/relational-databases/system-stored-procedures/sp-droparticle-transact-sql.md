...
## <a name="arguments"></a>Argumentos  
 ...
 É o nome da publicação que contém o artigo a ser removido. *publicação* está **sysname**, sem padrão.  
  
 [  **@article=**] **'***artigo***'**  
 É o nome do artigo a ser removido. *artigo* está **sysname**, sem padrão.  
