...
description: Use este artigo de referência para entender os comandos SQL na ferramenta azdata, especificamente o comando bdc spark session.
author: MikeRayMSFT
ms.author: mikeray
