---
title: "Conceder acesso a um servidor de relatório | Microsoft Docs"
ms.custom: 
ms.date: 05/15/2017
...
---
# <a name="grant-user-access-to-a-report-server"></a>Conceder acesso a um servidor de relatório
 ...
 **Servidores de relatório do modo nativo:** neste tópico se concentra em um servidor de relatório está configurado para modo nativo e o uso do portal da web para atribuir usuários a uma função. Existem dois tipos de funções:
...
- No [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)], exiba as funções predefinidas para Funções do Sistema e Funções de Usuários para se familiarizar com os tipos de tarefas de cada função. As descrições de tarefas não são visíveis no portal da web, portanto você deve estar familiarizado com as funções antes de começar a adicionar usuários.
...
1. Iniciar o [portal da web](../web-portal-ssrs-native-mode.md).
...
6. Em **grupo ou usuário**, insira um usuário de domínio do Windows ou grupo a conta neste formato: \<domínio >\\< conta\>. 
...
7. Selecione uma função de sistema e, em seguida, selecione **Okey**.
...
1. Iniciar o **portal da web** e localize o item de relatório para o qual você deseja adicionar um usuário ou grupo.

2. Selecione o **...**  (reticências) em um item.
...
5. Selecione **adicionar grupo ou usuário**.
    ...
    > [!NOTE]
    > Se um item atualmente herda a segurança de um item pai, selecione **personalizar segurança** na barra de ferramentas para alterar as configurações de segurança. Em seguida, selecione **adicionar grupo ou usuário**.

6. Em **grupo ou usuário**, insira um usuário de domínio do Windows ou grupo a conta neste formato: \<domínio >\\< conta\>. Se estiver usando a autenticação de formulários ou a segurança personalizada, especifique a conta de usuário ou grupo no formato correto de sua implantação.

7. Selecione uma ou mais definições de função que descrevem como o usuário ou grupo deve acessar o item e, em seguida, selecione **Okey**.
...
[Nova atribuição de função: Editar página de atribuição de função &#40; Gerenciador de relatórios &#41;](http://msdn.microsoft.com/library/3319ced0-4b86-42af-b18d-da41a625113c)   
[Página de propriedades de segurança, itens &#40; Gerenciador de relatórios &#41;](http://msdn.microsoft.com/library/351b8503-354f-4b1b-a7ac-f1245d978da0)   
