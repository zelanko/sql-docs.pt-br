...
ms.topic: "article"
helpviewer_keywords: 
  - "membros [Analysis Services], personalizados"
  - "fórmulas de acúmulo personalizado [Analysis Services]"
  - "MDX [Analysis Services], fórmulas de rollup personalizado"
...
manager: "erikre"
---
# Definir f&#243;rmulas de membro personalizado
...
## Consulte também  
 ...
 [Definir fórmulas de membro personalizado para os atributos em uma dimensão](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)  
