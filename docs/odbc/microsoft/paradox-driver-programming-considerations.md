---
title: Considerações sobre programação de driver do Paradox | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
> [!NOTE]  
>  Acessar arquivos do Paradox ISAM por meio dos drivers de banco de dados da área de trabalho ODBC requer a instalação do mecanismo de banco de dados Borland
