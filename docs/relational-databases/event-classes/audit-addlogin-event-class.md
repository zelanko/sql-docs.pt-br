...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: Audit Addlogin event class
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Addlogin** ocorre quando um logon do [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] é adicionado ou removido.  
...
|**TargetLoginSid**|**image**|O número de identificação de segurança (SID) do logon de destino (se transmitido como um parâmetro).|43|Sim|  
