...
ms.topic: "article"
helpviewer_keywords: 
  - "atributos [Master Data Services], criando atributos de link"
  - "criando atributos de link [Master Data Services]"
...
---
# Criar um atributo de link (Master Data Services)
...
### Para criar um atributo de link  
