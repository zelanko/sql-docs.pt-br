---
title: Tipos de cursor (Driver PDO_SQLSRV)
description: Saiba mais sobre vários cursores do lado do servidor e do cliente e como os usuários podem especificar o tipo de cursor ao usar o Driver PDO_SQLSRV da Microsoft para PHP para SQL Server.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
