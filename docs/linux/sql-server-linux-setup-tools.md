...
description: Saiba como instalar as ferramentas de linha de comando do SQL Server, os drivers ODBC da Microsoft e as dependências deles no Linux.
author: VanMSFT
ms.author: vanto
ms.date: 06/30/2020
ms.topic: conceptual
...
## <a name="install-tools-on-ubuntu-1604"></a><a id="ubuntu"></a>Instalar ferramentas no Ubuntu 16.04

Use as etapas a seguir para instalar o **mssql-tools** no Ubuntu.

> [!NOTE]
> Há suporte para o Ubuntu 18.04 do SQL Server 2019 CU3 em diante. Se você estiver usando o Ubuntu 18.04, altere o caminho do repositório de `/ubuntu/16.04` para `/ubuntu/18.04`.
...
## <a name="install-tools-on-sles-12"></a><a id="SLES"></a>Instalar ferramentas no SLES 12
...
## <a name="install-tools-on-macos"></a><a id="macos"></a> Instalar ferramentas no macOS
