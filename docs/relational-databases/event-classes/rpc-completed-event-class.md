...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento RPC:Completed indica que uma chamada de procedimento remoto foi concluída.  
