---
title: Recuperando informações de erro | Microsoft Docs
description: Recuperando informações de erro usando o Driver do OLE DB para SQL Server
ms.custom: ''
ms.date: 03/26/2018
...
ms.openlocfilehash: 9df481b3e7ac67ef9a063dbe1c022a14c4448342
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  Este exemplo obtém informações de várias interfaces de erro expostas pelo Driver OLE DB para SQL Server.  
