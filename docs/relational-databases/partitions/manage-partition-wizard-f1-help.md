---
title: "Ajuda de F1 do Assistente para Gerenciar Parti&#231;&#227;o | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "assistentes [SQL Server Management Studio] - Consulte Assistente para Gerenciar Partição"
...
---
# Ajuda de F1 do Assistente para Gerenciar Parti&#231;&#227;o
...
### Para iniciar o Assistente para Gerenciar Partição  
...
### Criar uma tabela de preparação  
 ...
 **Criar uma tabela de preparação para alternar partições**  
 ...
 **Gerenciar dados particionados em um cenário de janela deslizante**  
 ...
 ![Ícone de seta usado com o link Voltar ao Início](../../analysis-services/instances/media/uparrow16x16.png "Ícone de seta usado com o link Voltar ao Início") [Nesta seção](#Top)  
...
### Opções de tipos de agenda recorrentes  
...
### Opções de tipos de agendas que ocorrem apenas uma vez  
