...
`[ @log_id = ] log_id` É o identificador exclusivo para a coleção de log do conjunto. *log_id* está **int**.  
  
`[ @from_collection_set = ] from_collection_set` É o identificador para o conjunto de coleta. *from_collection_set* está **bits = 1**.  
