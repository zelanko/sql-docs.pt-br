...
A **Tarefa de Upload do Azure SQL DW** habilita um pacote do SSIS a copiar dados de tabela para o Azure Synapse Analytics do sistema de arquivos ou do Armazenamento de Blobs do Azure.
