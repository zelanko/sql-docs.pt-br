...
ms.topic: "article"
helpviewer_keywords: 
  - "utilitários de prompt de comando [SQL Server], SQLdiag"
  - "interrompendo coleção de diagnóstico"
  - "armazenando informações de diagnóstico"
  - "desempenho [SQL Server], coleta de diagnósticos"
  - "registros de diagnóstico [SQL Server]"
  - "scripts [SQL Server], coleta de diagnósticos"
  - "logs [SQL Server], coleta de diagnósticos"
  - "iniciando coleção de diagnóstico"
  - "instância clusterizada do SQL Server"
  - "desempenho de monitoramento [SQL Server], coleta de diagnósticos"
  - "segurança [SQL Server], coleta de diagnósticos"
  - "Serviço SQLDIAG"
  - "espaço [SQL Server], coleta de diagnósticos"
  - "Utilitário SQLdiag"
  - "espaço em disco [SQL Server], coleta de diagnósticos"
  - "arquivos de configuração [SQL Server]"
  - "coleção de diagnóstico automática"
  - "clusters [SQL Server], coleta de diagnósticos"
...
> [!NOTE]  
> O  **SQLdiag** ignorar o argumento **/L** se uma hora de início ou de término não for especificada usando os argumentos de linha de comando **/B** e **/E**.  
...
## Requisitos de segurança  
 A não ser que o **SQLdiag** seja executado no modo genérico (especificando o argumento de linha de comando **/G**), o usuário que está executando o **SQLdiag** deverá ser membro do grupo **Administradores** do Windows e membro da função de servidor fixa **sysadmin** do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. Por padrão, o **SQLdiag** conecta-se ao [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] usando a Autenticação do Windows, mas também tem suporte para a Autenticação do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
