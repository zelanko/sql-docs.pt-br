...
helpviewer_keywords: 
  ...
  - "parâmetro CLUSTER_SEED"
  - "parâmetro MODELLING_CARDINALITY"
  - "parâmetro MINIMUM_SUPPORT"
  - "parâmetro STOPPING_TOLERANCE"
  - "parâmetro MAXIMUM_STATES"
  - "parâmetro SAMPLE_SIZE"
  - "parâmetro CLUSTERING_METHOD"
  - "clustering flexível [Mineração de Dados]"
