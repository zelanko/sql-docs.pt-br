---
title: Exibir informações e realizar tarefas para uma assinatura (Replication Monitor) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "48049516"
---
# <a name="view-information-and-perform-tasks-for-a-subscription-replication-monitor"></a>Exibir informações e realizar tarefas para uma assinatura (Replication Monitor)
...
### <a name="to-view-information-and-perform-tasks-for-subscriptions-in-the-all-subscriptions-tab"></a>Para exibir informações e realizar tarefas para as assinaturas na guia Todas as Assinaturas  
