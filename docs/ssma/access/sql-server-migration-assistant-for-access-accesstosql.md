...
|Seção|Description|  
|-----------|---------------|  
|[Novidades do SSMA para Access](http://msdn.microsoft.com/a24d3fc0-6911-4bfa-828a-197abf222e02)|Lista as alterações para as versões SSMA.|  
...
|[Trabalhar com o console do SSMA para Access](working-with-ssma-for-access-console-accesstosql.md)|Documentação sobre o aplicativo de Console do SSMA|  
