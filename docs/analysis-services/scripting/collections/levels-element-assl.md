...
|Relação|Elemento|  
|------------------|-------------|  
|Elementos pai|[Hierarquia](../../../analysis-services/scripting/objects/hierarchy-element-assl.md)|  
|Elementos filho|[Nível](../../../analysis-services/scripting/objects/level-element-assl.md)|  
