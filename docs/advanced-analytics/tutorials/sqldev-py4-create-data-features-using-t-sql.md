---
title: Criar recursos de dados usando funções T-SQL e Python, aprendizado de máquina do SQL Server
...
### <a name="save-the-features-using-fnengineerfeatures"></a>Salvar os recursos usando _fnEngineerFeatures_
