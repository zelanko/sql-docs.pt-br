...
### <a name="a-using-stdev"></a>R: usando STDEV  
...
### <a name="c-using-stdev-with-over"></a>C. Usando STDEV com failover  
 O exemplo a seguir retorna o desvio padrão dos valores de cota de vendas para cada trimestre em um ano calendário. Observe que ORDER BY na cláusula OVER ordena o STDEV e ORDER BY da instrução SELECT ordena o conjunto de resultados.  
