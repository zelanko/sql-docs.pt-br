...
ms.locfileid: "66097536"
---
# <a name="senderemailaddress-property-wmi-msreportserver_configurationsetting"></a>Propriedade SenderEmailAddress (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>Valores da propriedade  
 Um objeto `String` somente leitura que representa o endereço de email usado pelo servidor de relatório.  
