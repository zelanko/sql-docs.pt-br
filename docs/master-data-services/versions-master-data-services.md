---
title: Versões
description: Você pode criar várias versões dos dados mestres dentro de um modelo no Master Data Services. Saiba mais sobre as versões e quando usá-las.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
