...
---
# <a name="annotation-interpretation---sqllimit-field-and-sqllimit-value"></a>Interpretação de anotação - SQL: limit-campo e SQL: limit-valor
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]XML Bulk Load processa o **SQL: limit-campo** e **SQL: limit-valor** anotações por suas definições. Para obter mais informações, consulte [Filtrando valores usando SQL: limit-campo e SQL: limit-valor &#40; SQLXML 4.0 &#41; ](../../../relational-databases/sqlxml-annotated-xsd-schemas-using/filtering-values-using-sql-limit-field-and-sql-limit-value-sqlxml-4-0.md).  
