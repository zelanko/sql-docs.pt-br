...
description: Saiba como se conectar a qualquer servidor na família do SQL Server e navegar graficamente no conteúdo usando o Pesquisador de Objetos no SQL Server Management Studio.
ms.date: 05/07/2019
