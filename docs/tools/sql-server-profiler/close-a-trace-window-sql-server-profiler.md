...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Este tópico descreve como fechar a janela de rastreamento para rastreamentos que estiverem em execução ou de rastreamentos salvos que você estão exibindo usando [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
