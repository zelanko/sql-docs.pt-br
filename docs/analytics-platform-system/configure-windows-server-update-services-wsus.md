...
9. Escolha classificações.  
    ...
    ![Escolha classificações](./media/configure-windows-server-update-services-wsus/sql-server-pdw-wsus-choose-classifications.png "SQL-Server-PDW-WSUS-escolher-classificações")  
