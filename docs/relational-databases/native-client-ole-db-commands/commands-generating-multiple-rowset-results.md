...
## <a name="batches"></a>Lotes  
 O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provedor Native Client OLE DB reconhece o caractere ponto e vírgula como um delimitador de lote para instruções SQL:  
