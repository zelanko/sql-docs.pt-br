---
title: Entendendo diferenças de tipo de dados
description: Aprenda as diferenças entre os tipos de dados do SQL Server e da linguagem de programação Java e como o JDBC Driver para SQL Server ajuda em conversões.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
