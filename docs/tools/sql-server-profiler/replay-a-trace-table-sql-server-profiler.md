...
description: Obtenha ajuda para solucionar problemas repetindo tabelas de rastreamento no SQL Server Profiler. Saiba mais sobre as opções e funcionalidades de repetição.
ms.prod: sql
