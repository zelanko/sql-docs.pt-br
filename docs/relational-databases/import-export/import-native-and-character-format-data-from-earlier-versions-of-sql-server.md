...
description: No SQL Server 2019, você pode usar o bcp para importar dados de formato de caractere e nativo de outras versões do SQL Server usando a opção -V com um qualificador.
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Compatibilidade com versões anteriores do Mecanismo de Banco de Dados do SQL Server](../../database-engine/discontinued-database-engine-functionality-in-sql-server.md)   
