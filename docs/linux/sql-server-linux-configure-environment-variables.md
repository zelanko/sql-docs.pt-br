...
Você pode usar diversas variáveis de ambiente diferentes para configurar o SQL Server 2019 (versão prévia) em Linux. Essas variáveis são usadas em dois cenários:
