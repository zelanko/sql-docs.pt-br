...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contém um sinalizador de modelagem para uma coluna em uma estrutura de mineração ou um modelo de mineração.  
