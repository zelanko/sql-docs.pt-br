...
description: SQL Server programação CLR não permite um tipo ou membro com alguns valores para a enumeração HostProtectionResource. Este artigo lista os valores de System. Core. dll não permitidos.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
