---
title: "Criptografia de Dados Transparente (TDE) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/09/2017"
...
helpviewer_keywords: 
  ...
  - "chave de criptografia de banco de dados, sobre"
  - "TDE"
  - "chave de criptografia de banco de dados"
  - "TDE, sobre"
  - "Criptografia de Dados Transparente (TDE), sobre"
  - "criptografia [SQL Server], criptografia de dados transparente"
...
|[Opções ALTER DATABASE SET &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md)|Explica a opção **ALTER DATABASE** usada para habilitar a TDE.|  
...
## <a name="transparent-data-encryption-and-inmemory-oltp"></a>Transparent Data Encryption e OLTP na memória  
