---
title: Gerenciar sessões de evento no Pesquisador de Objetos
description: Você pode executar ações no Pesquisador de Objetos que afetam eventos estendidos, como criar, iniciar ou parar, exportar, importar, editar ou excluir sessões de eventos estendidos.
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="create-an-extended-events-session"></a>Criar uma sessão de Eventos Estendidos  
 Para obter mais informações sobre como criar uma sessão de Eventos Estendidos, consulte [Criar uma sessão de Eventos Estendidos](/previous-versions/sql/sql-server-2016/hh213147(v=sql.130)).  
...
5.  Clique em **\<File From ...>Abrir** e procure a sessão (arquivo XML) a ser importada.  
