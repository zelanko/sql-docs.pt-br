...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Esta seção fornece informações detalhadas sobre a sintaxe para filtros de modelo, junto com exemplos de expressões.  
  
 [Sintaxe de Filtro](#bkmk_Syntax)  
  
 [Filtros em atributos de caso](#bkmk_Ex1)  
  
 [Filtros em atributos de tabela aninhada](#bkmk_Ex2)  
  
 [Filtros em vários atributos de tabela aninhada](#bkmk_Ex3)  
  
 [Atributos de filtros não encontrados em tabela aninhada](#bkmk_Ex4)  
  
 [Filtros em vários valores de tabela aninhada](#bkmk_Ex5)  
  
 [Filtros em atributos de tabela aninhada e EXISTS](#bkmk_Ex6)  
  
 [Combinações de filtro](#bkmk_Ex7)  
  
 [Filtros em datas](#bkmk_Ex8)  
...
##  <a name="bkmk_Syntax"></a> Filter Syntax  
 ...
 Uma condição **NOT EXISTS** será avaliada como **true** se a condição especificada na subconsulta não existir. Um exemplo é quando você deseja restringir o modelo a clientes que nunca compraram um determinado item.  
...
###  <a name="bkmk_Ex8"></a> Exemplo 8: filtrando por datas  
 ...
 Por exemplo, a expressão a seguir representa um filtro em uma coluna de data do tipo **Contínuo** que foi adicionado ao modelo de previsão.  
