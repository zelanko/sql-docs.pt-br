...
helpviewer_keywords: 
  - "assistente [DAC], registro"
  - "Como [DAC], registro"
  - "registrar DAC"
  - "aplicativo da camada de dados [SQL Server], registrar"
