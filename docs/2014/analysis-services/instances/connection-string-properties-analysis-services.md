...
|`Optimize Response`|Um bitmask que indica quais das otimizações de resposta de consulta a seguir são habilitadas.<br /><br /> 0x01: padrão. Usar o NormalTupleSet <br />0x02: usar quando as segmentações estiverem vazias|  
