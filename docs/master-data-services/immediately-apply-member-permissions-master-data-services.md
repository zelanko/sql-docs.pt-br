...
ms.topic: "article"
helpviewer_keywords: 
  - "membros [Master Data Services], aplicando permissões imediatamente"
  - "permissões [Master Data Services], aplicando permissões de membro imediatamente"
...
### Para aplicar permissões de membro da hierarquia imediatamente  
