...
##  <a name="encryption"></a><a name="encryption"></a>Encripta  
...
##  <a name="database-snapshots"></a><a name="DatabaseSnapshot"></a>Instantâneos do banco de dados  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]não oferece suporte a [instantâneos de banco de dados](../databases/database-snapshots-sql-server.md) para grupos de filefilestream. Se um grupo de arquivos FILESTREAM for incluído em uma cláusula CREATE DATABASE ON, a instrução falhará e um erro será gerado.  
...
##  <a name="log-shipping"></a><a name="LogShipping"></a> Envio de logs  
