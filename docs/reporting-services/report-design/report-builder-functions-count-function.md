...
description: Saiba mais sobre a função Count, que retorna uma contagem de valores não nulos especificados por uma expressão, que é avaliada no contexto de um escopo especificado.
ms.date: 03/07/2017
