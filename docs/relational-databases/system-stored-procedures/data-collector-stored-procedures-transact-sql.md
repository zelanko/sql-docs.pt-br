---
title: Coletor de dados procedimentos armazenados (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.author: sstein
manager: craigg
ms.openlocfilehash: 2d701245585645d6e4d75a4f7b244aa8549e441a
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  SQL Server suporta os seguintes procedimentos armazenados do sistema que são usados para trabalhar com o coletor de dados e os seguintes componentes: conjuntos de coleta, itens de coleta e tipos de coleção.  
