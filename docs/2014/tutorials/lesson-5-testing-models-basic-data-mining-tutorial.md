...
1.  Você fará previsões no conjunto de testes para verificar a exatidão do modelo em resultados conhecidos. Você usará um *gráfico de comparação de precisão* para medir a eficácia.  
     ...
     [Testando a precisão com gráficos de comparação de precisão &#40;Tutorial de mineração de dados básicos&#41;](../../2014/tutorials/testing-accuracy-with-lift-charts-basic-data-mining-tutorial.md)  
...
2.  Você testará seus modelos em um subconjunto filtrado dos dados. Você pode comparar vários modelos no mesmo gráfico de comparação de precisão.  
 ...
 Para obter mais informações sobre como modelo de validação em geral, consulte [conceitos de mineração de dados](../../2014/analysis-services/data-mining/data-mining-concepts.md).  
