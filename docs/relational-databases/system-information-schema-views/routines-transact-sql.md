...
|MODULE_CATALOG|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|MODULE_SCHEMA|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|MODULE_NAME|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|UDT_CATALOG|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|UDT_SCHEMA|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|UDT_NAME|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
...
|INTERVAL_TYPE|**nvarchar (** 30 **)**|NULO. Reservado para uso futuro.|  
|INTERVAL_PRECISION|**smallint**|NULO. Reservado para uso futuro.|  
|TYPE_UDT_CATALOG|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|TYPE_UDT_SCHEMA|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|TYPE_UDT_NAME|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|SCOPE_CATALOG|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|SCOPE_SCHEMA|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|SCOPE_NAME|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|MAXIMUM_CARDINALITY|**bigint**|NULO. Reservado para uso futuro.|  
|DTD_IDENTIFIER|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
...
|EXTERNAL_NAME|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
|EXTERNAL_LANGUAGE|**nvarchar (** 30 **)**|NULO. Reservado para uso futuro.|  
|PARAMETER_STYLE|**nvarchar (** 30 **)**|NULO. Reservado para uso futuro.|  
...
|SQL_PATH|**nvarchar (** 128 **)**|NULO. Reservado para uso futuro.|  
