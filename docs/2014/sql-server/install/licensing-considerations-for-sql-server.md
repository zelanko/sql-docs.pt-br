...
ms.locfileid: "36019045"
---
# <a name="licensing-considerations-for-sql-server"></a>Considerações sobre licenciamento do SQL Server
  Para obter mais informações sobre opções de licenciamento do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , acesse [este site do Microsoft SQL Server](http://www.microsoft.com/sqlserver/sql-server-2014.aspx).  
