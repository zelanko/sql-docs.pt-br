...
description: Você quer ter um cabeçalho ou rodapé na primeira ou na última página do seu relatório? Caso contrário, saiba como desligar a exibição do cabeçalho ou rodapé no Construtor de Relatórios.
ms.date: 03/01/2017
