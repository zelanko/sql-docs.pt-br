...
description: Saiba como criar um alerta que é acionado quando um contador do Monitor do Sistema atinge um valor limite. Em resposta, o Monitor do Sistema pode iniciar um aplicativo.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
