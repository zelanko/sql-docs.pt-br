...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Uma **CompoundCurve** é uma coleção de zero ou mais instâncias de **CircularString** ou **LineString** contínuas dos tipos geometry ou geography.  
  
> [!IMPORTANT]  
>  Para obter uma descrição detalhada e exemplos dos novos recursos espaciais nesta versão, incluindo o subtipo **CompoundCurve** , baixe o white paper sobre [Novos recursos espaciais no SQL Server 2012](http://go.microsoft.com/fwlink/?LinkId=226407).  
