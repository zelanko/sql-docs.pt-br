...
ms.topic: "article"
helpviewer_keywords: 
  - "Service Broker, relatórios de tempo de execução"
  - "Service Broker, utilitários de prompt de comando"
  - "solucionando problemas [Service Broker], conversas"
  - "solucionando problemas [Service Broker], configurações"
  - "utilitários de prompt de comando [Service Broker]"
  - "Service Broker, solucionando problemas"
  - "Service Broker, relatórios de configuração"
  - "Service Broker, ferramentas"
  - "solucionando problemas [Service Broker], tempo de execução"
  - "conversas [Service Broker], solucionando problemas"
  - "solucionando problemas [Service Broker], utilitário ssbdiagnose"
  - "ferramentas [Service Broker], ssbdiagnose"
  - "Service Broker, utilitário ssbdiagnose"
  - "ssbdiagnose"
