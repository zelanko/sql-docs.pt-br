---
title: UTF8 Tipo de dados definido pelo usuário (UDT) da cadeia de caracteres | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
3.  Em c:\MySample, crie `Utf8String.vb` (para o exemplo do Visual Basic) ou `Utf8String.cs` (para o exemplo do C#) e copie o código de exemplo adequado do Visual Basic ou do C# (a seguir) no arquivo.  
...
```  
 ...
 Esse é o script de instalação [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`) que implanta o assembly e cria o UDT no banco de dados.  
...
```  
 ...
 Esse é o `test.sql`, que testa o exemplo por meio da execução do tipo.  
...
```  
 ...
 O [!INCLUDE[tsql](../../includes/tsql-md.md)] a seguir remove o assembly e o tipo do banco de dados.  
