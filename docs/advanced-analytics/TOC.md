...
## [Modelos previamente treinados](r/install-pretrained-models-sql-server.md)
## SQL Server 2016
...
### [R: análise no banco de dados para desenvolvedores de SQL](tutorials/sqldev-in-database-r-for-sql-developers.md)
...
### [Python: análise no banco de dados para desenvolvedores de SQL](tutorials/sqldev-in-database-python-for-sql-developers.md)
...
## [Gerenciamento de pacote](r/r-package-management-for-sql-server-r-services.md)
...
#### [Soluções alternativas para "bibliotecas de usuário" do R](r/packages-installed-in-user-libraries.md)
