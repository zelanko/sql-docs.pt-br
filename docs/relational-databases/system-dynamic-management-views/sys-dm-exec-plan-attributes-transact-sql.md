...
> [!NOTE]  
>  Algumas das informações retornadas por essa função é mapeado para o [syscacheobjects](../../relational-databases/system-compatibility-views/sys-syscacheobjects-transact-sql.md) exibição de compatibilidade com versões anteriores.
 ...
 *plan_handle*  
 Identifica exclusivamente um plano de consulta de um lote que foi executado e cujo plano reside no cache de plano. *plan_handle* é **varbinary(64)**. O identificador de plano pode ser obtido o [exec_cached_plans](../../relational-databases/system-dynamic-management-views/sys-dm-exec-cached-plans-transact-sql.md) exibição de gerenciamento dinâmico.  
