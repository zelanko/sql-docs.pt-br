---
title: Referência para a criação e à configuração de grupos de disponibilidade
description: Uma referência aos links que ajudam você a criar e configurar grupos de disponibilidade Always On.
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
