...
|**tNão**|**int**|ID do procedimento armazenado que contém verificações de integridade para este tipo de dados.|  
...
|**escala**|**tinyint**|Escala para esse tipo de dados, com base na precisão.<br /><br /> NULL = Tipo de dados é não numérico.|  
