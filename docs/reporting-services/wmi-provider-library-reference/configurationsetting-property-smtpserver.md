---
description: Propriedade SMTPServer (WMI MSReportServer_ConfigurationSetting)
...
ms.locfileid: "88454436"
---
# <a name="configurationsetting-property---smtpserver"></a>Propriedade de ConfigurationSetting – SMTPServer
