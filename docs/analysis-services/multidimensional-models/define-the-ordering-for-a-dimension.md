...
helpviewer_keywords: 
  - "propriedade OrderBy"
  - "dimensões, [Analysis Services], ordenando"
  - "melhorias do Business Intelligence [Analysis Services], ordenando"
  - "dimensões [Analysis Services], melhorias de Business Intelligence"
  - "dimensões de ordenação [Analysis Services]"
  - "propriedade OrderByAttributeID"
...
manager: "erikre"
---
# Definir a ordena&#231;&#227;o para uma dimens&#227;o
...
## Especificando a ordenação  
 ...
 Na coluna **Atributo de Ordenação** , você pode alterar o atributo usado para fazer a ordenação. Se o atributo que deseja usar para ordenar os membros não estiver na lista, role a lista para baixo e selecione **\<Novo atributo...>** para a abrir a caixa de diálogo **Selecionar uma Coluna**, que permite selecionar uma coluna em uma tabela de dimensões. Com a seleção de uma coluna pela caixa de diálogo **Selecionar uma Coluna** , é criado um atributo adicional que será usado para ordenar os membros de um atributo.  
