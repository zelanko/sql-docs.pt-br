...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contém o nome do servidor no qual residem os bancos de dados que você deseja ajustar.  
