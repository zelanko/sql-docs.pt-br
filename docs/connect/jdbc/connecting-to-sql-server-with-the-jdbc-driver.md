...
description: Ao se conectar ao banco de dados usando o Microsoft JDBC Driver for SQL Server, toda a interação com o banco de dados passa pelo objeto SQLServerConnection.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
|[Conectando-se a um banco de dados SQL do Azure](../../connect/jdbc/connecting-to-an-azure-sql-database.md)|Discute problemas de conectividade em bancos de dados no SQL do Azure.|  
