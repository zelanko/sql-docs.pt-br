---
title: "Associar extens&#245;es de arquivo a um Editor de C&#243;digos | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "extensões de arquivo [SQL Server]"
  - "associando extensões de arquivo [SQL Server]"
  - "Editor de Consulta [SQL Server Management Studio], associando extensões de arquivo"
...
---
# Associar extens&#245;es de arquivo a um Editor de C&#243;digos
...
### Para associar uma nova extensão de arquivo ao SQL Server Management Studio  
...
### Para associar uma nova extensão de arquivo a um editor de código em SQL Server Management Studio  
