...
description: Este exemplo mostra uma restauração por etapas no SQL Server de um banco de dados usando o modelo de recuperação completa, começando com um backup da parte final do log.
