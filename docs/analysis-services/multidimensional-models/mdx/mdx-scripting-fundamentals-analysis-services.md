---
title: "Conceitos b&#225;sicos de gera&#231;&#227;o de scripts MDX (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Expressões Multidimensionais [Analysis Services], scripts"
...
|[Gerenciando escopo e contexto &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/managing-scope-and-context-mdx.md)|Descreve como usar a instrução [CALCULATE](../Topic/CALCULATE%20Statement%20\(MDX\).md), a instrução [SCOPE](../Topic/SCOPE%20Statement%20\(MDX\).md) e a função [This](../../../mdx/this-mdx.md) para gerenciar contexto e escopo dentro de um script MDX.|  
