...
description: Saiba como a interface ISequentialStream dá suporte ao acesso do consumidor aos tipos de dados do SQL Server como objetos binários grandes no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 05/25/2020
ms.prod: sql
