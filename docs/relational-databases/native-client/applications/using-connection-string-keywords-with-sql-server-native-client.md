...
|**Banco**|DBPROP_INIT_CATALOG|Nome do banco de dados.|  
...
|**FailoverPartner foi**|SSPROP_INIT_FAILOVERPARTNER|O nome do servidor de failover usado no espelhamento de banco de dados.|  
...
|**Cedido**|DBPROP_INIT_TIMEOUT|O tempo (em segundos) para aguardar a conclusão da inicialização da fonte de dados.|  
...
|**Parceiro de failover**|SSPROP_INIT_FAILOVERPARTNER|O nome do servidor de failover usado no espelhamento de banco de dados.|  
