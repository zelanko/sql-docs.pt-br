...
description: Saiba como excluir, ou soltar, um guia de plano no SQL Server usando o SQL Server Management Studio ou o Transact-SQL. Use o Transact-SQL para excluir todos os guias em um banco de dados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
