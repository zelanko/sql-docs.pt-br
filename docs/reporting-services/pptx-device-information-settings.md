...
description: Saiba detalhes sobre as configurações de informações do dispositivo para a renderização de relatórios do Reporting Services em formato PPTX.
ms.date: 09/11/2015
