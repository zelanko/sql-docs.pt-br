---
title: Configuração de conta de serviço do Launchpad confiável do SQL Server | Microsoft Docs
description: Como modificar a conta de serviço do Launchpad confiável do SQL Server usada para a execução do script externo no SQL Server.
ms.prod: sql
