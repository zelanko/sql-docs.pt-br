...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Use estes tópicos para entender melhor [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] bancos de dados multidimensionais e planejar a implementação de bancos de dados multidimensionais em sua solução de business intelligence.  
