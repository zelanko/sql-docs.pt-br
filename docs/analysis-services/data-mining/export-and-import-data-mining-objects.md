...
helpviewer_keywords: 
  ...
  - "exportando modelos de mineração"
  - "exportando estruturas de mineração"
  - "estruturas de mineração [Analysis Services], criando"
  - "estruturas de mineração [DMX], exportando"
  - "modelos de mineração [Analysis Services], migração"
...
## Exportando estruturas de mineração de dados  
...
### Exportando modelos de mineração de dados  
...
## Importando estruturas e modelos de mineração de dados  
