...
ms.topic: "article"
helpviewer_keywords: 
  - "Previsão do modelo de mineração [Analysis Services], selecionando modelos de mineração"
...
1.  Se você não tiver um modelo de clustering disponível para criar esta consulta de exemplo, crie o modelo [TM_Clustering] usando o [Tutorial Básico de Data Mining](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
