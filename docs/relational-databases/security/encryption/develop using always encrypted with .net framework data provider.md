---
title: "Desenvolver aplicativos usando o Always Encrypted com o Provedor de Dados .NET Framework para SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
manager: "jhubbard"
---
# Desenvolver aplicativos usando o Always Encrypted com o Provedor de Dados .NET Framework para SQL Server
...
### Recuperando um exemplo de dados de texto sem formatação
...
### Recuperando um exemplo de dados criptografados
...
## Trabalhando com repositórios de chaves mestras de coluna
...
### Usando o provedor do Cofre de Chaves do Azure
...
### Configurando o Sempre Criptografado no nível da consulta
...
## Habilitando proteção adicional para um SQL Server comprometido
...
### Configurando caminhos confiáveis de chave mestra de coluna 
...
## Referência de API do Always Encrypted
...
|[Classe SqlColumnEncryptionKeyStoreProvider](https://msdn.microsoft.com/library/system.data.sqlclient.sqlcolumnencryptionkeystoreprovider.aspx)|Classe base dos provedores de repositório de chaves.|  4.6
