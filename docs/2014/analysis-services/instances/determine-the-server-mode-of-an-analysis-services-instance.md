...
## <a name="server-icons-in-object-explorer"></a>Ícones de servidor no Pesquisador de Objetos  
 ...
 ![Ícones do Pesquisador de Objetos para cada modo de servidor](../media/ssas-ssms-servermodes.gif "Ícones do Pesquisador de Objetos para cada modo de servidor")  
