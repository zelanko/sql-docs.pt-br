...
## [sp_cdc_enable_table](sys-sp-cdc-enable-table-transact-sql.md)  
...
## [sp_cdc_start_job](sys-sp-cdc-start-job-transact-sql.md)  
...
## [sp_execute_remote (banco de dados do SQL Azure)](sp-execute-remote-azure-sql-database.md)  
...
# [O Stretch Database estendido](stretch-database-extended-stored-procedures-transact-sql.md)  
