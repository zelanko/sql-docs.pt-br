 ...
 **tabela de banco de dados**  
 No Visual FoxPro, uma tabela que está associado um banco de dados. Contraste **tabela livre**.  
  
 **tabela livre**  
 No Visual FoxPro, uma tabela que não está associada um banco de dados.  
  
 Um arquivo. dbf criado FoxPro versão 2. x é uma tabela livre a menos que ele é convertido em uma tabela do Visual FoxPro e adicionado a um banco de dados do Visual FoxPro. Contraste **tabela de banco de dados**.  
