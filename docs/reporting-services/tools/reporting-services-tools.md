...
helpviewer_keywords: 
  ...
  - "componentes [Reporting Services]"
  - "componentes [Reporting Services], sobre componentes"
  - "Reporting Services, componentes"
  - "SSRS, componentes"
  - "relatórios [Reporting Services], ferramentas"
  - "SQL Server Reporting Services, componentes"
  - "SQL Server Reporting Services, ferramentas"
  - "arquitetura [Reporting Services]"
...
---
# Ferramentas do Reporting Services
...
## Ferramentas para administração do servidor de relatório  
...
## Ferramentas para gerenciamento de conteúdo de relatório  
