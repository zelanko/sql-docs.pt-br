 ...
 **@cleartext**  
 Uma variável do tipo **nvarchar**, **char**, **varchar**, **binary**, **varbinary** ou **nchar** que contém os dados que serão criptografados com a chave pública do certificado.  
