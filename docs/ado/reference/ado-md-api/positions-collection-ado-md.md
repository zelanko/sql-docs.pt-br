---
title: Posiciona a coleção (ADO MD) | Microsoft Docs
ms.prod: sql
 ...
 **Posições** é uma coleção padrão de ADO. Com as propriedades e métodos de uma coleção, você pode fazer o seguinte:  
