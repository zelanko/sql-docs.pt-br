...
ms.topic: "article"
helpviewer_keywords: 
  - "ordem de avaliação [MDX]"
  - "ordem de cálculo [MDX]"
  - "propriedade SOLVE_ORDER"
  - "consultas [MDX], ordens de resolução"
  - "ordens de resolução [MDX]"
  - "ordens de passagem [MDX]"
  - "expressões [MDX], ordens de resolução"
...
### Consulta 2 – Porcentagem de receita menos despesas  
