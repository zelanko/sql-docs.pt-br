...
###  <a name="create-a-resource-pool-and-configure-memory"></a><a name="bkmk_CreateResourcePool"></a> Criar um pool de recursos e configurar a memória  
 ...
 Confira [Melhores práticas: usar OLTP in-memory em um ambiente de VM](/previous-versions/sql/sql-server-2016/dn529286(v=sql.130)) para obter mais informações ao trabalhar em um ambiente de VM.  
