...
-   Enumerador de arquivo do ADLS de foreach para enumerar arquivos em um diretório ADLS.
 ...
 ![Um contêiner de Foreach Loop que enumera uma pasta](../../integration-services/control-flow/media/ssis-foreachloop.gif "contêiner de um Loop de Foreach que enumera uma pasta")  
...
### <a name="add-and-configure-a-foreach-loop-container"></a>Adicionar e configurar um contêiner Foreach Loop
 ...
 **Conexão**  
 Selecione um Gerenciador de conexão ADO.NET na lista ou clique em \< **nova conexão...** > para criar uma nova conexão de ADO.NET Gerenciador.  
 ...
 **DocumentSource**  
 ...
 Se **DocumentSourceType** é definido como **conexão de arquivo**, selecione um Gerenciador de conexão de arquivo ou clique em \< **nova conexão...** > para criar uma nova conexão Gerenciador.  
 ...
 **Tópicos relacionados:** [File Connection Manager](../../integration-services/connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../integration-services/connection-manager/file-connection-manager-editor.md)  
 ...
 Se **DocumentSourceType** é definido como **variável**, selecione uma variável existente ou clique em \< **nova variável...** > para criar uma nova variável.  
...
|**Texto**|Enumere nós de texto retornados por uma operação XPath.|  
 ...
 **OuterXPathString**  
 ...
 Se **OuterXPathStringSourceType** é definido como **conexão de arquivo**, selecione um Gerenciador de conexão de arquivo ou clique em \< **nova conexão...** > para criar uma nova conexão Gerenciador.  
  
 **Tópicos relacionados:** [File Connection Manager](../../integration-services/connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../integration-services/connection-manager/file-connection-manager-editor.md)  
  
 Se **OuterXPathStringSourceType** é definido como **variável**, selecione uma variável existente ou clique em \< **nova variável...** > para criar uma nova variável.  
 ...
 **InnerXPathString**  
 ...
 Se **InnerXPathStringSourceType** é definido como **conexão de arquivo**, selecione um Gerenciador de conexão de arquivo ou clique em \< **nova conexão...** > para criar uma nova conexão Gerenciador.  
  
 **Tópicos relacionados:** [File Connection Manager](../../integration-services/connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../integration-services/connection-manager/file-connection-manager-editor.md)  
  
 Se **InnerXPathStringSourceType** é definido como **variável**, selecione uma variável existente ou clique em \< **nova variável...** > para criar uma nova variável.  
...
####  <a name="ForeachHDFSFile"></a>Enumerador = enumerador de arquivos Foreach HDFS  
 ...
 **Gerenciador de conexão de armazenamento do Azure**  
...
## <a name="use-property-expressions-with-foreach-loop-containers"></a>Usar expressões de propriedade com contêineres Foreach Loop  
