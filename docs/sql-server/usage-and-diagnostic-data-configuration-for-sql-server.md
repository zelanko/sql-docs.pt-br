---
title: Configurar a coleta de dados de diagnóstico e uso do SQL Server | Microsoft Docs
description: ''
author: MikeRayMSFT
ms.author: mikeray
manager: craigg
...
ms.locfileid: "59243550"
---
# <a name="configure-usage-and-diagnostic-data-collection-for-sql-server"></a>Configurar a coleta de dados de diagnóstico e uso do SQL Server
...
- Windows Server 2016 e Windows 10
    ...
    [Configurar os dados de diagnóstico do Windows na sua organização](https://docs.microsoft.com/en-us/windows/privacy/configure-windows-diagnostic-data-in-your-organization)
