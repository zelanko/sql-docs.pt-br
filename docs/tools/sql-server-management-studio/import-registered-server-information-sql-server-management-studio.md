...
helpviewer_keywords: 
  - "transferindo informações de servidor registrado"
  - "Servidores Registrados [SQL Server], importando"
  - "importando informações de servidor registrado"
...
---
# Importar informa&#231;&#245;es de servidor registrado (SQL Server Management Studio)
...
#### Para importar informações de servidor registrado  
