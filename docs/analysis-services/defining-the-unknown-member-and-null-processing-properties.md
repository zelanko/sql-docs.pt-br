...
6.  Expanda **Componentes** e expanda o membro não rotulado do nível **Nome do Modelo**.  
    ...
    ![Componentes de assembly usados para criar outros componentes](../analysis-services/media/l4-productdimensionerrorconfig-2.gif "Componentes de assembly usados para criar outros componentes")  
