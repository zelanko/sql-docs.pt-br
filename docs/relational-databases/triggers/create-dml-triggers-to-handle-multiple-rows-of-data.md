---
title: "Crie gatilhos DML para tratar v&#225;rias linhas de dados | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "gatilhos DML de várias linhas"
  - "instrução UPDATE [SQL Server], gatilhos DML"
  - "instrução DELETE [SQL Server], gatilhos DML"
  - "gatilhos DML multilinha [SQL Server]"
  - "instrução INSERT [SQL Server], gatilhos DML"
  - "gatilhos DML, multilinha"
