...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Profiler, reproduzindo rastreamentos"
  - "opção Executar até o Cursor"
  - "opção Alternar Ponto de Interrupção"
  - "rastreamentos [SQL Server], reproduzindo"
  - "repetindo rastreamentos"
  - "mecanismo de repetição [SQL Server Profiler]"
  - "eventos [SQL Server], reproduzindo rastreamentos"
  - "Profiler [SQL Server Profiler], reproduzindo rastreamentos"
...
# Repetir rastreamentos
 ...
 A repetição de rastreamentos dá suporte à depuração por meio das opções **Alternar Ponto de Interrupção** e **Executar até o Cursor** do menu **Repetir** do [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]. Essas opções melhoram, em especial, a análise de scripts longos, pois elas podem dividir a repetição do rastreamento em segmentos curtos que podem ser analisados incrementalmente.  
