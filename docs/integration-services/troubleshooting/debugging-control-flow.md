...
helpviewer_keywords: 
  ...
  - "depurando [Integration Services], fluxo de controle"
  - "fluxo de controle [Integration Services], depurando"
  - "relatório de progresso codificado por cor [Integration Services]"
...
-   [Depurar um pacote por meio da definição de pontos de interrupção em uma tarefa ou contêiner](../../integration-services/troubleshooting/debug-a-package-by-setting-breakpoints-on-a-task-or-a-container.md)  
...
>  Para habilitar ou desabilitar a exibição de mensagens na guia **Progresso** , marque ou desmarque a opção **Depurar Relatório do Progresso** no menu **SSIS** .  
 ...
 ![Guia Progresso do Designer SSIS](../../integration-services/troubleshooting/media/mw-dtsflow04.gif "Guia Progresso do Designer SSIS")  
