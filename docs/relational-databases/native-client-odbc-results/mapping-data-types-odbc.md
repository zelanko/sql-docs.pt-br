...
### <a name="retrieving-data-from-the-server"></a>Recuperando dados do servidor  
 ...
 Se nenhuma associação for especificada, o [SQLGetData](../../relational-databases/native-client-odbc-api/sqlgetdata.md) função pode ser usada para determinar o tipo de dados de uma instância na **sql_variant** coluna.  
...
3.  Chame [SQLColAttribute](../../relational-databases/native-client-odbc-api/sqlcolattribute.md) especificando **SQL_CA_SS_VARIANT_TYPE** como seu valor de atributo. Esta função retornará o tipo de dados C da instância na **sql_variant** coluna para o cliente.  
