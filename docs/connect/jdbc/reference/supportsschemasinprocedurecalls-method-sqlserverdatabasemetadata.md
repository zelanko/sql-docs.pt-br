...
## <a name="remarks"></a>Comentários  
 Esse método supportsSchemasInProcedureCalls é especificado pelo método supportsSchemasInProcedureCalls na interface java.sql.DatabaseMetaData.  
