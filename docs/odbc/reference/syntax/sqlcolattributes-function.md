 ...
 **Resumo**  
 No ODBC 3. *x*, a função **SQLColAttributes** do ODBC 2,0 foi substituída por **SQLColAttribute**. Para obter mais informações, consulte [função SQLColAttribute](../../../odbc/reference/syntax/sqlcolattribute-function.md).  
