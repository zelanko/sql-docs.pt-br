---
description: Criar ou editar um grupo de servidores (SQL Server Management Studio)
...
5. Na caixa **Selecionar um local para o novo grupo de servidores** , clique em um local para o grupo de servidores e então clique em **Salvar**.  
   ...
   > [!NOTE]
   >  Você também pode criar um novo grupo de servidores enquanto registra um servidor clicando em **Novo Grupo**e completando a caixa de diálogo **Novo Grupo** .  
