---
title: Visualizações do catálogo de segurança (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 02/27/2017
ms.prod: sql
...
## <a name="see-also"></a>Consulte Também  
 [Centro de Segurança para o mecanismo de banco de dados do servidor SQL e o banco de dados SQL do Azure](../../relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database.md)   
