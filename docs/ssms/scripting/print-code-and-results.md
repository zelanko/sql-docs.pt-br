...
description: Saiba como especificar a coloração do texto quando impresso. As cores podem ser diferentes das usadas para exibição. Saiba também como controlar se os números de linha são exibidos na listagem.
ms.prod: sql
ms.technology: ssms
ms.topic: conceptual
helpviewer_keywords:
