...
-   [Designer de consulta de modelo de relatório](#Model)  
  
-   [Designer de consulta MDX](#MDX)  
  
-   [Designer de consulta DMX](#DMX)  
  
-   [Designer de consulta do SapNetWeaver BI](#SAPBW)  
...
##  <a name="Model"></a>Designer de consulta de modelo de relatório  
 ...
 ![Interface do usuário do Designer de Consulta do Modelo Semântico](../media/rsqd-dsawmodel-smql.gif "Interface do usuário do Designer de Consulta do Modelo Semântico")  
...
##  <a name="SAPBW"></a>Designer de consulta do SAP NetWeaver BI  
