...
-   Análise aprimorada de funções na cláusula de parâmetro.
...
* Suporte para adição de conversão para instrução GET DIAGNOSTICS com ROW_NUMBER.
