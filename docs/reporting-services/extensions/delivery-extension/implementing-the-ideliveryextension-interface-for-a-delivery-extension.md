...
description: Saiba como implementar a interface IDeliveryExtension em uma extensão de entrega para que os clientes possam validar os dados do usuário e recuperar as configurações de entrega.
ms.date: 03/14/2017
