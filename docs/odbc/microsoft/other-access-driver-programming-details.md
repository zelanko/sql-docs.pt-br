---
title: Outros detalhes de programação do Driver de acesso | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32902691"
---
# <a name="other-access-driver-programming-details"></a>Outros detalhes de programação do Driver de acesso
> [!NOTE]  
>  Esta seção fornece informações específicas de Driver de acesso sobre funções ODBC e outros detalhes de programação. Para obter informações gerais sobre uma função, consulte o tópico apropriado em [referência da API ODBC](../../odbc/reference/syntax/odbc-api-reference.md).  
