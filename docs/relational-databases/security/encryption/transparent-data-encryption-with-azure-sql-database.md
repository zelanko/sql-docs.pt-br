...
ms.topic: "article"
helpviewer_keywords: 
  - "TDE, Banco de dados SQL"
  - "criptografia (banco de dados SQL), TDE"
  - "Criptografia Transparente de Dados, Banco de dados SQL"
...
## Tópico do SQL Server relacionado  
