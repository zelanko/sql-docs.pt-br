---
title: Usar o PowerShell para fazer Backup de vários bancos de dados para o serviço de armazenamento de BLOBs do Azure do Windows | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="overview-of-powershell-cmdlets-for-backup-and-restore"></a>Visão geral de cmdlets do PowerShell para backup e restauração  
 ...
 New-SqlCredential  
 Este cmdlet é usado para criar uma Credencial SQL a ser usada para o backup do SQL Server no armazenamento do Windows Azure. Para obter mais informações sobre credenciais e seu uso no backup e na restauração do SQL Server, consulte [SQL Server Backup and Restore with Windows Azure Blob Storage Service](sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md).  
...
## <a name="see-also"></a>Consulte também  
 [SQL Server Backup e restauração com o serviço de armazenamento de BLOBs do Azure do Windows](sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md)   
