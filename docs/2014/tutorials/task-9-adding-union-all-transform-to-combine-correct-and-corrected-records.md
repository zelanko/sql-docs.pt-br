...
1.  Arraste e solte **Union All** transformar de **comuns** seção o **caixa de ferramentas do SSIS** para o **de fluxo de dados** guia e coloque-o sob **Escolher registros corretos e corrigidos**.  
  
2.  Clique com botão direito **Union All** transformar no **de fluxo de dados** guia e, em seguida, clique em **Renomear**. Tipo **combinar registros corretos e corrigidos**e pressione **ENTER**.  
...
3.  Conecte-se **escolher registros corretos e corrigidos** para **combinar registros corretos e corrigidos** no **de fluxo de dados** guia usando o conector azul. Você deve ver o **seleção de saída e entrada** caixa de diálogo.  
...
5.  Mova o conector chamado **correto** para a esquerda arrastando e soltando o ponto no final do conector para a esquerda.  
...
6.  Se você selecionar **escolher registros corretos e corrigidos** transformação, você deverá visualizar outro conector azul. Arraste o conector azul para **combinar registros corretos e corrigidos**.  
...
7.  Isso **conector** deve ser chamado **corrigido**. Como você tem apenas duas condições **correto** e **corrigido**, e uma condição já foi usada, o **seleção de saída e entrada** caixa de diálogo não é exibida no momento. Se os conectores se sobrepuserem, mova um deles para esquerda e o outro para direita arrastando o conector para a esquerda ou direita.  
