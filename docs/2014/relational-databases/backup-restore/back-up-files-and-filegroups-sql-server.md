...
1.  Use o cmdlet `Backup-SqlDatabase` e especifique `Files` para o valor do parâmetro `-BackupAction`. Além disso, especifique um dos seguintes parâmetros:  
  
    -   Para fazer backup de um arquivo específico, especifique o `-DatabaseFile` *cadeia de caracteres* parâmetro, onde *cadeia de caracteres* é um ou mais arquivos de banco de dados de backup.  
  
    -   Para fazer backup de todos os arquivos de um determinado grupo de arquivos, especifique o `-DatabaseFileGroup` *cadeia de caracteres* parâmetro, onde *cadeia de caracteres* é um ou mais grupos de arquivos de banco de dados de backup.  
