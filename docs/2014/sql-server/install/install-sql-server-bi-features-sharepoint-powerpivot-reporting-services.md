---
title: Instale recursos de BI do SQL Server com o SharePoint (PowerPivot e Reporting Services) | Microsoft Docs
ms.custom: ''
ms.date: 03/09/2017
...
|**[!INCLUDE[applies](../../includes/applies-md.md)]** SharePoint 2013 &#124; SharePoint 2010|
 ...
 ![nota](../../../2014/reporting-services/media/rs-fyinote.png "observação") Para obter as notas de versão atuais, consulte [Notas de versão do servidor SQL 2014](https://go.microsoft.com/fwlink/?LinkID=296445).
...
##  <a name="sql-server-bi-scenarios-and-sharepoint-2013"></a><a name="bkmk_bi_scenarios"></a>Cenários de BI do Servidor SQL e SharePoint 2013
...
|**3**|O SharePoint com Reporting Services no modo do SharePoint|Power View|Instalar o [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] no modo do SharePoint.<br /><br /> Instale [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] o add-in **(rsSharePoint.msi)** no SharePoint. Para obter mais informações, consulte [Instalar ou desinstalar o complemento dos serviços de relatórios para o SharePoint &#40;SharePoint 2010 e o SharePoint 2013&#41;](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)|
|**4**|Todos os recursos do PowerPivot|Acesso a pastas de trabalho como uma fonte de dados fora do farm.<br /><br /> Agendar atualização de dados.<br /><br /> Galeria PowerPivot.<br /><br /> Painel de Gerenciamento.<br /><br /> Tipo de conteúdo do arquivo de vínculo do BISM.|Implantar powerpivot para add-in SharePoint 2013 **(spPowerPivot.msi)**. Para saber mais, consulte o seguinte:<br /><br /> [Instale ou desinstale o PowerPivot para SharePoint Add-in &#40;SharePoint 2013&#41;](https://docs.microsoft.com/analysis-services/instances/install-windows/install-or-uninstall-the-power-pivot-for-sharepoint-add-in-sharepoint-2013)<br /><br /> Para obter informações sobre como baixar o **spPowerPivot.msi**, consulte [Baixe o SQL Server 2014 PowerPivot para SharePoint](https://go.microsoft.com/fwlink/?LinkID=296473).|

 Para obter informações [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] adicionais sobre como habilitar recursos, consulte [O SQL Server BI Light-Up Story para sharePoint 2013](https://blogs.msdn.com/b/analysisservices/archive/2012/07/27/introducing-the-bi-light-up-story-for-sharepoint-2013.aspx) ( .https://blogs.msdn.com/b/analysisservices/archive/2012/07/27/introducing-the-bi-light-up-story-for-sharepoint-2013.aspx)

##  <a name="overview-of-installation"></a><a name="bkmk_install_sharepoint2013_overview"></a>Visão geral da instalação
 Se você quiser usar o [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] e o [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], execute o assistente de instalação do SQL Server duas vezes. [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]e [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] são escolhas separadas na página **Função de configuração** do assistente de configuração do SQL Server.
...
5.  Configure os Serviços do Excel no SharePoint Server 2013 para usar a instância do [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] . Para obter mais informações, consulte a seção "Configurar integração sharePoint de serviços básicos de análise" no [PowerPivot for SharePoint 2013 Instalação](https://docs.microsoft.com/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode).e [Gerenciar configurações do modelo de dados do Excel Services (SharePoint Server 2013)](https://technet.microsoft.com/library/jj219780.aspx) (https://technet.microsoft.com/library/jj219780.aspx). .
...
1.  A instalação do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] no modo de SharePoint não foi alterada em relação à versão anterior.
    ...
    -   Consulte as combinações com suporte do seguinte:
        ...
        -   A versão do produto do SharePoint.
         ...
         [Combinações suportadas de servidor de serviços de sharepoint e relatórios e complemento &#40;SQL Server 2014&#41;](../../reporting-services/install-windows/supported-combinations-of-sharepoint-and-reporting-services-server.md)

    -   O [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] no SharePoint 2010 exige o SharePoint 2010 Service Pack 2 (SP2).

    1.  Instalar o [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] no modo do SharePoint. [Serviços de relatórios Compartilhamento Modo SharePoint Instalação &#40;SharePoint 2010 e SharePoint 2013&#41;](../../reporting-services/install-windows/install-reporting-services-sharepoint-mode.md) e [instalar serviços de relatórios SharePoint Mode para SharePoint 2010](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md).

    2.  Instale o Suplemento do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] para produtos SharePoint (rsSharePoint.msi). Consulte [Instalar ou desinstalar o add-in de serviços de relatórios para sharePoint &#40;SharePoint 2010 e SharePoint 2013&#41;](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md). Para obter a [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] versão atual do complemento para SharePoint, consulte [Onde encontrar o complemento de Serviços de Relatórios para Produtos SharePoint](../../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md).

    3.  Configure o serviço [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint e pelo menos um aplicativo de serviço do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] . Para obter mais informações, consulte a seção "Criar um aplicativo de serviço sumido de serviços de relatórios" no [modo Install Reporting Services SharePoint para SharePoint 2013](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2013.md).

##  <a name="overview-of-database-attach-upgrade-and-sharepoint-2013"></a><a name="bkm_database_attach"></a>Visão geral da atualização de attach database e do SharePoint 2013
...
## <a name="see-also"></a>Consulte Também
 [Onde encontrar o complemento dos serviços de relatórios para produtos SharePoint](../../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md) [Combinações suportadas de SharePoint e Serviços de Relatórios Servidor e Complemento &#40;SQL Server 2014&#41;](../../reporting-services/install-windows/supported-combinations-of-sharepoint-and-reporting-services-server.md) instalar ou [desinstalar o complemento de serviços de relatórios para sharePoint &#40;SharePoint 2010 e SharePoint 2013&#41;](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)
