...
description: Saiba como implementar a interface IRenderingExtension, que transforma dados de relatório em formatos de saída que visualizadores, impressoras e outros destinos consomem.
ms.date: 03/16/2017
