...
## <a name="arguments"></a>Argumentos  
 ...
 É a ID do perfil do [MSagent_parameters &#40; Transact-SQL &#41; ](../../relational-databases/system-tables/msagent-parameters-transact-sql.md) tabela. *profile_id* é **int**, com um padrão de **-1**, que retorna todos os parâmetros.  
