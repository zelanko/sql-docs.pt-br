...
## <a name="remarks"></a>Remarks  
 Esse método supportsOpenStatementsAcrossRollback é especificado pelo método supportsOpenStatementsAcrossRollback na interface java. Sql. DatabaseMetaData.  
