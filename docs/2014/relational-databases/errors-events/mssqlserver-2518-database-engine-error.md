...
|Texto da mensagem|ID de objeto O_ID (objeto "O_NAME"): Colunas computadas e tipos definidos pelo usuário não podem ser verificados para este objeto porque o common language runtime (CLR) está desabilitado.|  
