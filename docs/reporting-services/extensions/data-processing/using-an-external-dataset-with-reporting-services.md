...
description: Crie extensões de processamento de dados personalizadas no Reporting Services para poder integrar objetos DataSet personalizados criados por aplicativos externos.
ms.date: 03/06/2017
