...
helpviewer_keywords: 
  ...
  - "XMLA, scripts"
  - "scripts [Analysis Services], bancos de dados"
  - "documentando bancos de dados"
  - "bancos de dados [Analysis Services], documentando"
  - "bancos de dados [Analysis Services], scripts"
...
---
# Documentar e gerar scripts de um banco de dados do Analysis Services
