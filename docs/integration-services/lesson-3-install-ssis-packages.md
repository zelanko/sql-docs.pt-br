...
-   [Etapa 1: Copiando o pacote de implantação](../integration-services/step-1-copying-the-deployment-bundle.md)  
  
-   [Etapa 2: Executando o Assistente de Instalação de Pacotes](../integration-services/step-2-running-the-package-installation-wizard.md)  
  
-   [Etapa 3: Testando os pacotes implantados](../integration-services/step-3-testing-the-deployed-packages.md)  
