...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Uma consulta pode ser executada em vários servidores ou bancos de dados diferentes alterando a conexão usada pela consulta.  
