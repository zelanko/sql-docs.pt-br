---
title: Exemplos de conversão de dados sql a c | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
...
|SQL_TYPE_TIMESTAMP|1992-12-31 23:45:55.12|SQL_C_CHAR|18|----|22003|  
 ...
 [a] "\0" representa um byte de rescisão nula. O motorista sempre termina SQL_C_CHAR dados.  
  
 [b] Os números desta lista são os números armazenados nos campos da estrutura TIMESTAMP_STRUCT.
