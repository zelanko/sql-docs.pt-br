...
|**valores de dynamic_filter_login**|**sysname**|Valor usado para avaliar o [SUSER_SNAME](../../t-sql/functions/suser-sname-transact-sql.md) função em um filtro de linha com parâmetros definido para a publicação.|  
