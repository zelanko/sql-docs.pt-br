...
# <a name="schedule-properties-reports-page"></a>Propriedades da Agenda (página Relatórios)
 ...
 Para abrir essa página, inicie [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], conecte-se a um servidor de relatório, abra o **agendas compartilhadas** pasta, clique duas vezes uma agenda compartilhada, selecione **propriedades**e, em seguida, clique em **relatórios** .  
