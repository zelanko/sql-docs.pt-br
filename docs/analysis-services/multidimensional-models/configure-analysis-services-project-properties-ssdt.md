---
title: "Configurar propriedades do projeto do Analysis Services (SSDT) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "projetos [Analysis Services], propriedades"
...
|Depuração / Objeto Inicial|\<Objeto ativo no momento>|Determina o objeto que será iniciado quando você começar a depuração.|  
