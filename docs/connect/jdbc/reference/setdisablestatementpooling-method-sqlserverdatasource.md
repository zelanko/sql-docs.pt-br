...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Define o valor da propriedade de conexão **disableStatementPooling** . Se for false, habilitará o pool de instruções a ser usado no acoplamento com o valor de statementPoolingCacheSize > 0.  
