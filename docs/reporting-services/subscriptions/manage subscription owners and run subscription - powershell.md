...
-   Listar assinaturas: [Enumeração ReportOperation](../Topic/ReportOperation%20Enumeration.md) no relatório E o usuário é o proprietário da assinatura OU ReadAnySubscription.  
...
-   Listar assinaturas: ManageAlerts OU [CreateAlerts](https://technet.microsoft.com/library/microsoft.sharepoint.spbasepermissions.aspx) no relatório E o usuário é o proprietário da assinatura e a assinatura é cronometrada.  
