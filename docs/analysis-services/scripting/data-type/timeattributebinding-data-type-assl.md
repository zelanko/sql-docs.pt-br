...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Define um tipo de dados derivado que representa uma associação "espaço reservado" para itens de dados gerados, como as colunas de chave de um atributo, em uma dimensão de tempo do servidor.  
