...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Identifica um grupo de medidas em um elemento pai que contém uma referência de objeto.  
