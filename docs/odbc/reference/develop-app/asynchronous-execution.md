...
ms.author: genemi
manager: craigg
ms.openlocfilehash: a69b00bb23930c31dc85618dcf0fb4597c877659
...
ODBC dá suporte a operações assíncronas para operações de conexão e instrução. Há duas maneiras de determinar quando uma operação assíncrona é concluída:  
