...
description: Permita que os usuários alterem a ordem de classificação de linhas e colunas em tabelas e matrizes usando botões de classificação interativos no Construtor de Relatórios.
ms.date: 03/01/2017
...
7.  Repita as etapas 1 a 6 para cada coluna para a qual você deseja adicionar um botão de classificação interativa.  
 ...
 ![Ícone de seta usado com o link Voltar ao Início](/analysis-services/analysis-services/instances/media/uparrow16x16.gif "Ícone de seta usado com o link Voltar ao Início") [Voltar ao Início](#BackToTop)  
