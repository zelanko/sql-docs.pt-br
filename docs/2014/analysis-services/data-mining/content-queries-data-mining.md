...
-   [Consultas sobre estrutura e dados de caso](#bkmk_Structure)  
...
```  
 ...
 A consulta a seguir é criada com base nestas informações. A consulta retorna três colunas: a ID do nó, a regra completa e o produto no lado direito do conjunto-ou seja, o produto que é previsto para ser associado a outros produtos como parte de um conjunto.  
