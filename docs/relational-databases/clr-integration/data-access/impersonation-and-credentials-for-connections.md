...
description: No SQL Server integração CLR, talvez você queira representar o chamador na autenticação do Windows usando a propriedade SqlContext. WindowsIdentity.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
