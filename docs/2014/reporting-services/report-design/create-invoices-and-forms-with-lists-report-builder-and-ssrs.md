...
##  <a name="DisplayingLayout"></a>Exibindo dados em um layout de forma livre  
 ...
 ![Visualização de lista com 4 campos e uma imagem](../media/rs-basiclistformpreview.gif "Visualização de lista com 4 campos e uma imagem")  
...
##  <a name="DisplayingGrouping"></a>Exibindo dados com um nível de agrupamento  
 ...
 ![Uma lista com 2 tabelas, uma com gráfico aninhado](../media/rs-basiclistgroupdesign.gif "Uma lista com 2 tabelas, uma com gráfico aninhado")  
 ...
 ![Visualização, 2 tabelas, uma com gráfico aninhado](../media/rs-basiclistgrouppreview.gif "Visualização, 2 tabelas, uma com gráfico aninhado")  
