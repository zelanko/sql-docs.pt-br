...
`[ @active_end_date = ] active_end_date` a data em que a execução de um trabalho pode ser interrompida. *active_end_date* é **int**, com um padrão de **99991231**, que indica 31 de dezembro de 9999. Formatada como AAAAMMDD.  
