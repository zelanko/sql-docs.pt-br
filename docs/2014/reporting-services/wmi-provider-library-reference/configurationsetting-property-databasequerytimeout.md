...
ms.locfileid: "66097748"
---
# <a name="databasequerytimeout-property-wmi-msreportserver_configurationsetting"></a>Propriedade DatabaseQueryTimeout (WMI MSReportServer_ConfigurationSetting)
