...
helpviewer_keywords: 
  - "modo de acesso a dados de carregamento rápido [Integration Services]"
  - "destino OLE DB [Integration Services]"
  - "opções de carregamento rápido [Integration Services]"
  - "opções de carregamento rápido [Integration Services]"
...
-   [Editor de Destino OLE DB &#40;Página Gerenciador de Conexões&#41;](../../integration-services/data-flow/ole-db-destination-editor-connection-manager-page.md)  
  
-   [Editor de Destino de OLE DB &#40;Página Mapeamentos&#41;](../../integration-services/data-flow/ole-db-destination-editor-mappings-page.md)  
  
-   [Editor de Destino OLE DB &#40;Página Saída de Erro&#41;](../../integration-services/data-flow/ole-db-destination-editor-error-output-page.md)  
