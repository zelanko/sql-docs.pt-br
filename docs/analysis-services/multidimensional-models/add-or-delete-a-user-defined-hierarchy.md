...
ms.topic: "article"
helpviewer_keywords: 
  - "hierarquias [Analysis Services], adicionando"
  - "removendo hierarquias"
  - "adicionando hierarquias"
  - "excluindo hierarquias"
  - "hierarquias [Analysis Services], removendo"
...
manager: "erikre"
---
# Adicionar ou excluir uma hierarquia definida pelo usu&#225;rio
...
### Para adicionar uma hierarquia definida pelo usuário em uma dimensão  
...
### Para remover uma hierarquia definida pelo usuário de uma dimensão  
