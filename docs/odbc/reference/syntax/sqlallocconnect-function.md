...
ms.openlocfilehash: f2c2ab7aef0feeb46a65b12868c6ff92c0da245e
 ...
 **Resumo**  
 Em ODBC 3. *x*, o ODBC 2. *x* função **SQLAllocConnect** foi substituído pelo **SQLAllocHandle**. Para obter mais informações, consulte [função SQLAllocHandle](../../../odbc/reference/syntax/sqlallochandle-function.md).  
