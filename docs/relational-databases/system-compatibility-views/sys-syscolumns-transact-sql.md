...
|**deslocamento x**|**smallint**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
...
|**domínio**|**int**|ID da regra ou restrição CHECK para essa coluna.|  
|**número**|**smallint**|Número de subprocedimentos quando o procedimento é agrupado.<br /><br /> 0 = Nenhuma entrada de procedimento|  
...
|**tipo**|**tinyint**|Tipo de armazenamento físico de **sys**. **tipos de**.|  
...
|**escala**|**int**|Tamanho dessa coluna.<br /><br /> NULL = Tipo de dados é não numérico.|  
