...
description: Saiba como usar o Native Compilation Advisor para migrar um procedimento armazenado interpretado para compilação nativa como parte da migração para o OLTP in-memory.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
