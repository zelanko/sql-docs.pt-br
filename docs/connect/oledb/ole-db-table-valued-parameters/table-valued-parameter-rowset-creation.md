---
title: Criação de conjunto de linhas de parâmetro com valor de tabela (Driver do OLE DB)
description: Saiba mais sobre o conjunto de linhas de parâmetro com valor de tabela, um objeto na memória que o Driver do OLE DB para SQL Server permite que os consumidores criem.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
