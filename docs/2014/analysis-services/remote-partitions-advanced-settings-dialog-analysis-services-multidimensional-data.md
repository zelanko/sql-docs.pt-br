...
|**Arquivo de backup**|Exibe o nome do arquivo de backup remoto que contém os dados a serem restaurados das partições remotas listadas.<br /><br /> Observação: Nenhum arquivo de backup será exibido se um arquivo de backup remoto foi especificado no **arquivo de Backup** coluna o **partições** página do **restaurar banco de dados** caixa de diálogo.|  
