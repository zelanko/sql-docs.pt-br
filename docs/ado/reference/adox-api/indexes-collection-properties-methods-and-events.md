---
title: Indexa a coleção de propriedades, métodos e eventos | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "63213455"
---
# <a name="indexes-collection-properties-methods-and-events"></a>Propriedades, Métodos e Eventos da coleção Indexes
