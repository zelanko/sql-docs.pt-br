---
title: "Agente de Instant&#226;neo (Assistente para Nova Publica&#231;&#227;o) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Agente de Instant&#226;neo (Assistente para Nova Publica&#231;&#227;o)
...
## Opções  
 **Criar um instantâneo imediatamente** (replicação de mesclagem) ou **criar um instantâneo imediatamente e mantê-lo disponível para inicializar assinaturas** (replicação transacional)  
 ...
 **Agendar o Agente de Instantâneo para execução nos seguintes horários**  
 Aceite o agendamento padrão para executar o Snapshot Agent, ou clique em **alteração** para especificar um agendamento.  
