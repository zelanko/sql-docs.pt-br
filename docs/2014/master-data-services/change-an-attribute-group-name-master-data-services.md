...
5.  Clique no sinal de adição para expandir **grupos de folha**, **grupos consolidados**, ou **grupos de coleção**, dependendo do tipo de grupo que você deseja atualizar.  
  
6.  Clique no nome do grupo de atributos que você deseja alterar.  
  
7.  Clique em **Editar item selecionado**.  
  
8.  No **nome do grupo folha** caixa de **nome do grupo consolidado** caixa, ou **nome do grupo de coleção** , digite o nome atualizado do grupo de atributos.  
