...
## <a name="configuring-db2-console-settings"></a>Configurar as configurações do Console DB2  
...
7.  **Operação de interrupção:** durante a operação intermediária, se o usuário deseja parar a operação, em seguida, **'Ctrl + C'** tecla de acesso pode ser usada. SSMA para DB2 Console aguardará a conclusão da operação e termina a execução do console.  
...
Lista completa de comandos de script pode ser encontrada em [executando o Console SSMA &#40;DB2ToSQL&#41;](../../ssma/db2/executing-the-ssma-console-db2tosql.md)  
