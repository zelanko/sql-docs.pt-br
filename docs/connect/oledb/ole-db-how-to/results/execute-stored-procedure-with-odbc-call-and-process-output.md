...
description: Saiba como processar códigos de retorno e parâmetros de saída no Driver do OLE DB para SQL Server, que são recebidos no pacote final após o lançamento do conjunto de linhas.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
3.  Crie um acessador para os parâmetros definidos usando o método **IAccessor::CreateAccessor**. **CreateAccessor** cria um acessador com base em um conjunto de associações.  
