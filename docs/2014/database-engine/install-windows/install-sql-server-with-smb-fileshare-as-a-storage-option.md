...
# <a name="install-sql-server-with-smb-fileshare-as-a-storage-option"></a>Instalar o SQL Server com o compartilhamento de arquivos SMB como uma opção de armazenamento
  A [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]partir de, os bancos de dados do sistema (Mestre, modelo, msdb e tempdb [!INCLUDE[ssDE](../../includes/ssde-md.md)] ) e os bancos de dados de usuário podem ser instalados com o servidor de arquivos do protocolo SMB como uma opção de armazenamento. Isso se aplica a instalações autônomas do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] e a FCI (instalações de cluster de failover) do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
...
-   \\\ServerName\ShareName  
 ...
 Para obter mais informações sobre Convenção de nomenclatura universal [UNC](https://go.microsoft.com/fwlink/?LinkId=245534) , consultehttps://go.microsoft.com/fwlink/?LinkId=245534)UNC (.  
...
-   Na instalação do prompt de comando, especifique "/INSTALLSQLDATADIR" como "\\\fileserver1\share1\\".  
    ...
    ```  
     ...
     Para obter mais informações sobre o uso de várias opções de parâmetro de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]linha de comando no, consulte [instalar SQL Server 2014 no prompt de comando](../../database-engine/install-windows/install-sql-server-from-the-command-prompt.md).  
  
## <a name="operating-system-considerations-smb-protocol-vs-ssnoversion"></a>Considerações sobre o sistema operacional (protocolo SMB vs. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)])  
...
-   Ao desanexar um banco de dados do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] que reside no armazenamento anexado por rede, você poderá ter um problema de permissão de banco de dados ao tentar reanexar o banco de dados do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . O problema é definido neste [artigo da base](https://go.microsoft.com/fwlink/?LinkId=237321) dehttps://go.microsoft.com/fwlink/?LinkId=237321)conhecimento (. Para resolver este problema, consulte a seção **Mais Informações** no artigo da Base de Dados de Conhecimento.  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Tópicos de instruções sobre a instalação](../../../2014/sql-server/install/installation-how-to-topics.md)   
