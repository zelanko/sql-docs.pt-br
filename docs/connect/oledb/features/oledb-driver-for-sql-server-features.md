---
title: Recursos do OLE DB Driver for SQL Server
description: Conheça sobre os recursos compatíveis com o Driver do OLE DB para SQL Server como espelhamento de banco de dados, operação assíncrona, Azure Active Directory e outros.
ms.custom: ''
ms.date: 02/11/2019
ms.prod: sql
...
Discute novos métodos de autenticação introduzidos no Driver do OLE DB 18.2.1 que têm configurações padrão mais seguras e permitem a conexão a uma instância do Banco de Dados SQL do Azure usando uma identidade federada.
 ...
 [Como usar a resolução IP de rede transparente](../../oledb/features/using-transparent-network-ip-resolution.md)  
 Aborda como o Driver do OLE DB para SQL Server dá suporte à resolução de IP de rede transparente em um cluster de failover.  
