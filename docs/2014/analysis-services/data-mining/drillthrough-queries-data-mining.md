...
##  <a name="using-drillthrough-in-data-mining-designer"></a><a name="bkmk_Designer"></a>Usando o detalhamento no designer de mineração de dados  
...
##  <a name="creating-drillthrough-queries-using-dmx"></a><a name="bkmk_DMX"></a>Criando consultas de detalhamento usando DMX  
...
##  <a name="considerations-when-using-drillthrough"></a><a name="bkmk_Considerations"></a>Considerações ao usar o detalhamento  
...
###  <a name="limitations-on-drillthrough"></a><a name="bkmk_Limits"></a>Limitações no detalhamento  
