...
# <a name="perspectivehierarchy-data-type-assl"></a>Tipo de dados PerspectiveHierarchy (ASSL)
  Define um tipo de dados primitivo que representa informações sobre uma hierarquia em uma [PerspectiveDimension](../../../analysis-services/scripting/data-type/perspectivedimension-data-type-assl.md) elemento.  
