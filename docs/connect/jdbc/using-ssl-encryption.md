...
ms.locfileid: "39662338"
---
# <a name="using-ssl-encryption"></a>Usando criptografia SSL

[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

A criptografia do protocolo SSL permite a transmissão de dados criptografados pela rede entre uma instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] e um aplicativo cliente.  
