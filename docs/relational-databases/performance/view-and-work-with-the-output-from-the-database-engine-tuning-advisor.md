---
title: Saída do DTA
description: Saiba mais sobre como usar os resumos, as recomendações, os relatórios e os logs de ajuste que o Orientador de Otimização do Mecanismo de Banco de Dados cria em sua instalação do SQL Server.
