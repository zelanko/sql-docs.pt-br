---
title: Definir propriedades do domínio
ms.date: 11/08/2011
ms.prod: sql
...
##  <a name="FollowUp"></a>Acompanhamento: depois de definir propriedades de domínio  
...
###  <a name="Name"></a>Nome e descrição do domínio  
...
###  <a name="Normalize"></a>Normalizar cadeia de caracteres  
...
###  <a name="Format"></a>Formatar saída para  
