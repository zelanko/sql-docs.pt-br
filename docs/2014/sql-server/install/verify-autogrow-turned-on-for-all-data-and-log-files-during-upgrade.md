...
-   Resulta das classificações temporárias quando você cria ou recria índices, se SORT_IN_TEMPDB for especificado.  
 ...
 Objetos adicionais também usam o banco de dados **tempdb** . A tabela a seguir lista as alterações ou [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] adições aos recursos que resultam em requisitos de espaço em disco adicionais para arquivos de log e dados do **tempdb** .  
