---
title: "Especificar se uma opera&#231;&#227;o de backup ou restaura&#231;&#227;o para ou continua depois de encontrar um erro (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/29/2017"
...
helpviewer_keywords: 
  ...
  - "fazendo backup de bancos de dados [SQL Server], erros"
  - "backups [SQL Server], erros"
  - "backups de bancos de dados [SQL Server], erros"
...
3.  Na instrução [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md), especifique a opção CONTINUE_AFTER ERROR para continuar ou a opção STOP_ON_ERROR para parar. O comportamento padrão é parar depois de encontrar um erro. Este exemplo instrui a operação de restauração a continuar apesar de encontrar um erro.  
