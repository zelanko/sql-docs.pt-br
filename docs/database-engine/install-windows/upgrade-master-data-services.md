---
title: "Atualizar o Master Data Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Atualizar o Master Data Services
  A seguir, cenários para atualizar para o Microsoft [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)].  
...
> -   Depois de atualizar o Data Quality Services e o Master Data Services para [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], uma versão anterior do suplemento Master Data Services para Excel deixará de funcionar. Você pode baixar o suplemento Master Data Services para Excel do [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] no [Centro de Download da Microsoft](http://www.microsoft.com/en-us/download/details.aspx?id=47343).  
  
##  <a name="fileLocation"></a> Local do arquivo  
  
-   No [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], por padrão, os arquivos são instalados em *unidade*:\Arquivos de Programas\Microsoft SQL Server\130\Master Data Services.  
...
##  <a name="noengine"></a> Atualize sem a atualização do Mecanismo de Banco de Dados  
 Neste cenário, você continua usando o [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] para hospedar seu banco de dados MDS. Entretanto, você precisa atualizar o esquema do banco de dados MDS e, depois, criar um aplicativo Web [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] para acessar o banco de dados MDS. O banco de dados MDS não pode mais ser acessado pelo aplicativo Web [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] .  
  
 Você pode instalar o [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] e uma versão anterior do SQL Server ([!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]) no mesmo computador. Os arquivos são instalados em locais diferentes, conforme mostrado no [Local do arquivo](#fileLocation).  
...
2.  Atualize o esquema de banco de dados de MDS.  
    ...
    1.  Abra a versão [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] do [!INCLUDE[ssMDScfgmgr](../../includes/ssmdscfgmgr-md.md)].  
    ...
    3.  No painel direito, clique em **Selecionar Banco de Dados** e especifique as informações para sua instância de banco de dados do [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] .  
  
    4.  Clique em **Atualizar Banco de Dados** para iniciar o **Assistente para Atualizar Banco de Dados**. Para obter mais informações, veja [Assistente para Atualização Banco de Dados &#40;Master Data Services Configuration Manager&#41;](../../master-data-services/upgrade-database-wizard-master-data-services-configuration-manager.md).  
...
3.  Crie um aplicativo Web.  
    ...
    3.  No painel direito, na lista **Site** , selecione uma das seguintes opções:  
        ...
        > [!IMPORTANT]  
        >  Seu aplicativo Web do MDS existente de uma versão anterior do SQL Server ([!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]) está disponível para seleção na versão [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] do Master Data Services Configuration Manager. Você não deve selecionar o aplicativo Web existente e, em vez disso, deve criar um aplicativo Web do [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] para o MDS. Caso contrário, você receberá um erro ao tentar associar o aplicativo Web com o banco de dados do MDS atualizado que indica que a página solicitada não pode ser acessada porque os dados de configuração relacionados à página são inválidos.  
        >   
        >  Se você quiser usar o mesmo nome (alias) para o aplicativo Web do MDS que seu aplicativo Web existente ([!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]), primeiro você deverá excluir o aplicativo Web e o pool de aplicativos associado do IIS e criar um aplicativo Web com o mesmo nome usando a versão [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] do Master Data Services Configuration Manager. Para obter mais informações sobre como remover o aplicativo Web e os pools de aplicativos do IIS, veja [Remover um aplicativo (IIS)](http://go.microsoft.com/fwlink/?LinkId=323537) e [Remover um pool de aplicativos (IIS)](http://go.microsoft.com/fwlink/?LinkId=323538).  
...
##  <a name="engine"></a> Atualize com a atualização do Mecanismo de Banco de Dados  
 Neste cenário, você atualizará o mecanismo de banco de dados e o aplicativo [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)] do [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] para [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)].  
...
2.  Atualizar o mecanismo de banco de dados para o [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]. Para obter mais informações, consulte [Choose a Database Engine Upgrade Method](../../database-engine/install-windows/choose-a-database-engine-upgrade-method.md).  
...
##  <a name="twocomputer"></a> Atualizar em Cenário de Dois Computadores  
 Neste cenário, você atualiza um sistema no qual o SQL Server está instalado em dois computadores: um com o [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]e o outro com [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)].  
  
 Se o [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] estiver instalado, você continuará usando o [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] respectivamente para hospedar seu banco de dados MDS em um computador. Entretanto, você precisa atualizar o esquema do banco de dados MDS e, depois, usar o aplicativo Web [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] para acessar o banco de dados MDS. O banco de dados MDS não pode mais ser acessado pelo aplicativo Web [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] .  
...
##  <a name="restore"></a> Atualizar com Restaurar um banco de dados do backup  
 Neste cenário, o [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] é instalado junto com o [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] no mesmo computador ou em dois computadores diferentes. Um banco de dados foi armazenado em backup em uma versão anterior ao [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] , antes da atualização, e o banco de dados deve ser restaurado.  
 ...
 **Problema:** quando você abre o aplicativo Web [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)][!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] , aparece uma mensagem de erro “a versão de cliente não é compatível com a versão de banco de dados”.  
  
 **Solução:** esse problema ocorre quando um aplicativo Web do Master Data Manager do [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] tenta acessar um banco de dados que foi atualizado para o Master Data Services do [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] . Você deve usar um aplicativo Web SQL [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] .  
