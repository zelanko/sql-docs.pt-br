...
ms.topic: "article"
helpviewer_keywords: 
  - "modelos [Analysis Services]"
  - "modelos [Analysis Services], projetos"
  - "projetos [Analysis Services], criando"
  - "projetos [Analysis Services], Business Intelligence Development Studio"
  - "Business Intelligence Development Studio, definindo projetos [Analysis Services]"
