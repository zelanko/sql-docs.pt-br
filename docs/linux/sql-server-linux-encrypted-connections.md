---
title: Criptografar conexões ao SQL Server no Linux
...
## <a name="configuring-the-openssl-libraries-for-use-optional"></a>Configurando as bibliotecas OpenSSL para uso (opcional)
