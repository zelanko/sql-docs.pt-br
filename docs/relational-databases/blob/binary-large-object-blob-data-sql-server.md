...
description: Com o FILESTREAM, FileTables e RBS (Remote BLOB Store), o SQL Server pode armazenar blobs no banco de dados ou no armazenamento remoto. Compare as opções de armazenamento de blobs.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
