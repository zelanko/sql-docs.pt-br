...
ms.topic: "article"
helpviewer_keywords: 
  - "Serviço compartilhado do Reporting Services"
  - "Modo do SharePoint [Reporting Services]"
  - "Modo do SharePoint"
  - "Aplicativo de serviço Reporting Services"
  - "Aplicativo de serviço do SSRS"
...
---
# Provisionar Assinaturas e Alertas para aplicativos de servi&#231;o SSRS
...
### Para atualizar permissões usando a página de provisão  
...
### Para gerar a instrução Transact-SQL com o PowerShell  
...
#### Para carregar o script Transact-SQL no SQL Server Management Studio  
