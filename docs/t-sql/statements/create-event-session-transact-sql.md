...
No SQL Server, requer a permissão `ALTER ANY EVENT SESSION`. No Banco de Dados SQL, requer a permissão `ALTER ANY DATABASE EVENT SESSION` no banco de dados.
