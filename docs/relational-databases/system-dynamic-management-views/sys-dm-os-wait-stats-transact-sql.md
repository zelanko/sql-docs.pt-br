...
|EXTERNAL_SCRIPT_NETWORK_IO |TBD <br /> **Aplica-se ao**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] até a versão atual.| 
...
|FOREIGN_REDO |TBD <br /> **Aplica-se ao**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] até a versão atual.| 
...
|METADATA_LAZYCACHE_RWLOCK |TBD <br /> **Aplica-se ao**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] apenas. |  
