...
As tarefas a seguir descrevem a abertura de um prompt de comando, a inicialização do utilitário de prompt de comando **dta**, a exibição da Ajuda sobre a sintaxe e o ajuste de uma carga de trabalho simples, MyScript.sql, que você criou em [Ajustando uma carga de trabalho](../../tools/dta/tuning-a-workload.md).  
  
### Para iniciar o utilitário de prompt de comando dta e exibir a Ajuda  
...
### Para ajustar uma carga de trabalho simples usando o utilitário de prompt de comando dta  
