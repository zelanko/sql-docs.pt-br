...
ms.topic: "article"
helpviewer_keywords: 
  - "logs [Integration Services], contadores de desempenho"
  ...
  - "mecanismo de fluxo de dados [Integration Services]"
...
## Consulte também  
 [Execução de projetos e pacotes](https://msdn.microsoft.com/library/ms141708.aspx)  
