...
description: Se você desinstalar o Data Quality Server de uma instância do SQL Server, alguns objetos do Data Quality Server, incluindo os bancos de dados do DQS, precisarão ser excluídos manualmente.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
