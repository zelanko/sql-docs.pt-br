...
ms.topic: "article"
helpviewer_keywords: 
  - "classe de evento User Error Message"
...
## Colunas de dados da classe de evento User Error Message  
...
|EventClass|**int**|Tipo de evento = 162.|27|Não|  
...
|Severity|**int**|Nível de severidade do erro ou exceção.|20|Sim|  
|SPID|**int**|Identificação da sessão em que ocorreu o evento.|12|Sim|  
|StartTime|**datetime**|Hora de início do evento, se disponível.|14|Sim|  
|Estado|**int**|Equivalente a um código de estado de erro.|30|Sim|  
|TextData|**ntext**|Texto da mensagem de erro ou exceção.|1|Sim|  
