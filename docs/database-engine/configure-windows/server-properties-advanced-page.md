...
description: Familiarize-se com as configurações avançadas de servidor do SQL Server. Saiba mais sobre as opções de FILESTREAM, vários limites, alternativas de atualização de texto completo e outras configurações.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
