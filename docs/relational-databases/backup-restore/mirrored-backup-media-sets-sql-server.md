...
description: O SQL Server dá suporte ao espelhamento de conjuntos de mídias, o que aumenta a confiabilidade do backup reduzindo o impacto do mau funcionamento do dispositivo de backup.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
