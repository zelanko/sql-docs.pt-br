...
description: Saiba como acessar o provedor WMI do Reporting Services que expõe duas classes WMI para administração de instâncias de servidor de relatório do modo nativo por meio de scripts.
ms.date: 11/02/2016
