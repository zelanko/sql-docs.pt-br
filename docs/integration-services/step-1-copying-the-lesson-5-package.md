...
manager: "jhubbard"
---
# Etapa 1: Copiando o pacote da Li&#231;&#227;o 5
...
### Para copiar o pacote da Lição 5  
...
### Para adicionar o pacote concluído da lição 5  
...
[Etapa 2: Convertendo o projeto para o modelo de implantação de projetos](../integration-services/step-2-converting-the-project-to-the-project-deployment-model.md)  
