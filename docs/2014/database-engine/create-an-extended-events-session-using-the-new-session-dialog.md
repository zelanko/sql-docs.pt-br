...
6.  Na seção **Rastreamento de causalidade** , marque a caixa de seleção **Controlar como os eventos estão relacionados uns aos outros** para controlar o trabalho entre várias tarefas.  
     ...
     Para obter mais informações sobre o rastreamento de causalidade, consulte “Conteúdo e Características da Sessão” em [SQL Server Extended Events Sessions](../relational-databases/extended-events/sql-server-extended-events-sessions.md) .  
...
4.  Estas são as propriedades que você pode especificar, sujeitas aos destinos selecionados:  
    ...
    |Target (destino)|Propriedades de destino|  
    |------------|-----------------------|  
