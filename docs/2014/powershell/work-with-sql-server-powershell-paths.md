...
```  
 ...
 Este exemplo usa o SMO **Script** método para gerar um script que contém o `CREATE VIEW` instruções que você deve ter para recriar as exibições em AdventureWorks2012:  
