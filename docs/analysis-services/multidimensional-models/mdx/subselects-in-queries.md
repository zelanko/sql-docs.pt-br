...
-   A cláusula NON EMPTY não é permitida em uma cláusula de eixo. Em vez disso, use uma expressão de função [NonEmpty &#40;MDX&#41;](../../../mdx/nonempty-mdx.md).  
