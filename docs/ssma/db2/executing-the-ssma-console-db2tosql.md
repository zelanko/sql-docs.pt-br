...
Para obter informações sobre arquivos de script do console de exemplo, consulte [trabalhando com arquivos de Script do Console do exemplo &#40; DB2ToSQL &#41;](../../ssma/db2/working-with-the-sample-console-script-files-db2tosql.md)  
