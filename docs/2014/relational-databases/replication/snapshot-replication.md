...
##  <a name="HowWorks"></a> Como a replicação de instantâneo funciona  
 ...
 ![Componentes e fluxo de dados da replicação de instantâneo](media/snapshot.gif "Componentes e fluxo de dados da replicação de instantâneo")  
