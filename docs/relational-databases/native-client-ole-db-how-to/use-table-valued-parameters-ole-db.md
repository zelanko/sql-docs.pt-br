---
description: Usar parâmetros de Table-Valued no SQL Server Native Client (OLE DB)
...
ms.locfileid: "97419488"
---
# <a name="use-table-valued-parameters-in-sql-server-native-client-ole-db"></a>Usar parâmetros de Table-Valued no SQL Server Native Client (OLE DB)
