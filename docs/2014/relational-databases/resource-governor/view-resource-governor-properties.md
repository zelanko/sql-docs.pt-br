...
##  <a name="view-the-resource-governor-properties-page"></a><a name="ViewRGProp"></a>Exibir a página de propriedades de Resource Governor  
...
##  <a name="resource-governor-properties"></a><a name="RGProp"></a>Propriedades de Resource Governor  
