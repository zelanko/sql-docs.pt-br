...
Este tópico faz parte de um tutorial de modelo de tabela, que deve ser concluído na ordem. Antes de executar as tarefas nesta lição, você deve ter concluído a lição anterior: [Lição 9: Criar hierarquias](lesson-9-create-hierarchies.md).  
...
Vá para a próxima lição: [Lição 11: Criar funções](lesson-11-create-roles.md). 
