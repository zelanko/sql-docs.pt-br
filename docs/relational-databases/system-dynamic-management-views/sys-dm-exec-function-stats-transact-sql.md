---
title: sys.DM exec_function_stats (Transact-SQL) | Microsoft Docs
ms.custom: 
ms.date: 03/16/2017
...
---
# <a name="sysdmexecfunctionstats-transact-sql"></a>sys.DM exec_function_stats (Transact-SQL)
...
|**tipo**|**char(2)**|Tipo de objeto: FN = funções com valor escalar|  
