...
-   [bcp_setcolfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-setcolfmt.md)  
 ...
 [bcp_control](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md) tem uma nova *opção para* controlar o comportamento do bcp_readfmt: **BCPDELAYREADFMT**.  
