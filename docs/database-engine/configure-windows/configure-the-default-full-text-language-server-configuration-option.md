...
description: Saiba mais sobre a opção default full-text language. Confira como configurá-la para especificar o idioma padrão que o SQL Server usa para índices de texto completo.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
