...
ms.locfileid: "33004573"
---
# <a name="msdbms-transact-sql"></a>MSdbms (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  O **MSdbms** tabela contém uma lista mestre de todas as versões de sistemas de gerenciamento de banco de dados (DBMS) com suporte para replicação de banco de dados heterogênea. Essa tabela é armazenada no **msdb** banco de dados.  
