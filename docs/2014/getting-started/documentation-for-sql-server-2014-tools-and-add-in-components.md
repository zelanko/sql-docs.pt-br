...
|[Instalação de serviço do SQL Server](https://go.microsoft.com/fwlink/?LinkId=299176)|Documentação para auxiliar na aplicação de atualizações em componentes do SQL Server.|  
