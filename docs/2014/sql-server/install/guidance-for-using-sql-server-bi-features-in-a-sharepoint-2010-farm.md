...
-   **Conclua a atualização com psconfig:** Execute o comando `psconfig -upgrade` para concluir a atualização do SP1  
 ...
 Para obter mais informações, consulte a seção "atualização" do [(SharePoint Server 2010)](https://technet.microsoft.com/library/cc263093.aspx) @no__t e o 1Resource Center: Atualizações para produtos do SharePoint 2010 @ no__t-0  
