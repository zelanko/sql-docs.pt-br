...
### <a name="events"></a>Eventos  
 Para obter mais informações sobre eventos ADO/WFC, consulte [a instanciação do evento ADO por idioma](../../../ado/guide/data/ado-event-instantiation-by-language.md).  
