...
description: O Driver do OLE DB para SQL Server expõe a função IIndexDefinition::CreateIndex, o que permite que os consumidores definam novos índices em tabelas do SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
