...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Add Login to Server Role** ocorre sempre que um logon é adicionado ou removido de uma função de servidor fixa. Esta classe de evento é usada para os procedimentos armazenados **sp_addsrvrolemember** e **sp_dropsrvrolemember** .  
