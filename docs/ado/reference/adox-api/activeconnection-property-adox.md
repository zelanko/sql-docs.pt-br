---
title: Propriedade ActiveConnection (ADOX) | Microsoft Docs
ms.prod: sql
...
## <a name="settings-and-return-values"></a>As configurações e valores de retorno  
 Define uma **Conexão** objeto ou uma **cadeia de caracteres** contendo a definição para uma conexão. Retorna o Active Directory **Conexão** objeto.  
