---
title: 'Lição 1: Avalie práticas recomendadas em uma base de demanda | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
-   [Realizar uma avaliação sob demanda por usando o Pesquisador de objetos](../ssms/object/object-explorer.md) (para uma única instância)  
  
-   [Realizar uma avaliação sob demanda por usando servidores registrados](../../2014/tutorials/perform-an-on-demand-evaluation-by-using-registered-servers.md) (para uma ou mais instâncias)  
