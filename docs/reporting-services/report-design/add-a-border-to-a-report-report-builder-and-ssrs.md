...
description: Defina áreas de um relatório paginado adicionando bordas aos cabeçalhos, aos rodapés e ao corpo do relatório no Construtor de Relatórios.
ms.date: 03/01/2017
...
1.  Clique com o botão direito do mouse no cabeçalho fora de qualquer item no cabeçalho e clique em **Cabeçalho Propriedades**. Na guia **Borda** , adicione uma borda esquerda, superior e direita com o estilo que você deseja.    
    ...
    > [!NOTE]    
    >  Se seu relatório não tiver cabeçalhos, você poderá colocar bordas apenas em torno do corpo do relatório ou adicionar cabeçalhos da guia **Inserir** .    
