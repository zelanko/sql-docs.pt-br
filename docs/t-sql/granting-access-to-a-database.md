...
manager: "jhubbard"
---
# concedendo acesso a um banco de dados
...
### Para criar um usuário em um banco de dados  
...
[criando exibições e procedimentos armazenados](../t-sql/creating-views-and-stored-procedures.md)  
