...
helpviewer_keywords: 
  ...
  - "conexões de intenção de leitura [grupos de disponibilidade AlwaysOn]"
...
```  
 ...
 Para obter mais informações sobre o registro manual de um SPN para SQL Server, consulte [Register a Service Principal Name for Kerberos Connections](../../../database-engine/configure-windows/register-a-service-principal-name-for-kerberos-connections.md).  
...
-   [Introdução ao ouvinte do grupo de disponibilidade](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/16/introduction-to-the-availability-group-listener.aspx) (um blog da equipe do AlwaysOn do SQL Server)  
