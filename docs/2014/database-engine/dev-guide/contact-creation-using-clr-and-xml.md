---
title: Criação de Contact usando CLR e XML | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.author: jhubbard
manager: jhubbard
ms.openlocfilehash: dc0921ce6d6c4107df80e84c3623ead2fc209911
ms.sourcegitcommit: 5dd5cad0c1bbd308471d6c885f516948ad67dfcf
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 06/19/2018
ms.locfileid: "36119395"
---
# <a name="contact-creation-using-clr-and-xml"></a>Criação de Contact usando CLR e XML
...
-   Para habilitar a integração CLR, execute as etapas a seguir:  
    ...
    > [!NOTE]  
    >  Para habilitar o CLR, é necessário ter a permissão `ALTER SETTINGS` em nível de servidor, que é mantida implicitamente por membros das funções de servidor fixas `sysadmin` e `serveradmin`  
...
3.  Em c:\MySample, crie `Contacts.vb` (para o exemplo do Visual Basic) ou `Contacts.cs` (para o exemplo do C#) e copie o código de exemplo adequado do Visual Basic ou do C# (a seguir) no arquivo.  
...
7.  Copie o código de instalação [!INCLUDE[tsql](../../includes/tsql-md.md)] em um arquivo e salve-o como `Install.sql` no diretório de exemplo.  
  
8.  Se o exemplo tiver sido instalado em um diretório diferente de `C:\MySample\`, edite o arquivo `Install.sql` conforme indicado para apontar para esse local.  
  
9. Implante o assembly e o procedimento armazenado executando o seguinte  
  
    -   `sqlcmd -E -I -i install.sql`  
  
10. Copie o script de comando de teste do [!INCLUDE[tsql](../../includes/tsql-md.md)] em um arquivo e salve-o como `test.sql` no diretório de exemplo.  
  
11. Execute o script de teste com o seguinte comando  
...
```  
 ...
 O [!INCLUDE[tsql](../../includes/tsql-md.md)] a seguir remove o assembly, o procedimento armazenado e os dados inseridos do banco de dados.  
