...
# <a name="datasource-data-type-assl"></a>Tipo de dados DataSource (ASSL)
  Define um tipo de dados primitivo abstrato que representa uma fonte de dados em um [banco de dados](../../../analysis-services/scripting/objects/database-element-assl.md) elemento.  
