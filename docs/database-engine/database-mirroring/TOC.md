...
# [Exemplo: Configurando espelhamento de banco de dados usando certificados (Transact-SQL)](example-setting-up-database-mirroring-using-certificates-transact-sql.md)
# [Configurando o espelhamento de banco de dados](setting-up-database-mirroring-sql-server.md)
...
# [Pausando e retomando o espelhamento de banco de dados](pausing-and-resuming-database-mirroring-sql-server.md)
...
# [Monitorando o espelhamento de banco de dados](monitoring-database-mirroring-sql-server.md)
...
# [Registrar banco de dados espelho](register-mirrored-database.md)
...
# [Removendo o espelhamento de banco de dados](removing-database-mirroring-sql-server.md)
...
# [Estabelecer uma sessão de espelhamento de banco de dados com a Autenticação do Windows (Transact-SQL)](establish-database-mirroring-session-windows-authentication.md)
