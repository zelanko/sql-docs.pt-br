---
description: Criar os arquivos de Conexão de servidor (MySQLToSQL)
...
[Executando o console do SSMA (MySQL)](./executing-the-ssma-console-mysqltosql.md)  
