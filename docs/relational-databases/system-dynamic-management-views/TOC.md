# [Visão geral](system-dynamic-management-views.md)  
...
## [cdc_log_scan_sessions](change-data-capture-sys-dm-cdc-log-scan-sessions.md)  
...
## [sys.DM db_objects_impacted_on_version_change (banco de dados do SQL Azure)](sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)  
## [sys.DM db_partition_stats](sys-dm-db-partition-stats-transact-sql.md)  
## [sys.DM db_persisted_sku_features](sys-dm-db-persisted-sku-features-transact-sql.md)  
...
## [sys.DM db_wait_stats (banco de dados do SQL Azure)](sys-dm-db-wait-stats-azure-sql-database.md)  
## [sys.DM operation_status (banco de dados do SQL Azure)](sys-dm-operation-status-azure-sql-database.md)  
## [sys.DM database_copies (banco de dados do SQL Azure)](sys-dm-database-copies-azure-sql-database.md)  
## [sys.DM db_resource_stats (banco de dados do SQL Azure)](sys-dm-db-resource-stats-azure-sql-database.md)  
...
## [exec_background_job_queue](sys-dm-exec-background-job-queue-transact-sql.md)  
...
## [exec_cached_plans](sys-dm-exec-cached-plans-transact-sql.md)  
...
## [exec_requests](sys-dm-exec-requests-transact-sql.md)  
## [sys.DM exec_session_wait_stats](sys-dm-exec-session-wait-stats-transact-sql.md)  
## [sys.DM exec_sessions](sys-dm-exec-sessions-transact-sql.md)  
...
## [exec_trigger_stats](sys-dm-exec-trigger-stats-transact-sql.md)  
...
## [sys.DM xe_database_sessions (banco de dados do SQL Azure)](sys-dm-xe-database-sessions-azure-sql-database.md)  
## [sys.dm_xe_database_session_targets (banco de dados do SQL Azure)](sys-dm-xe-database-session-targets-azure-sql-database.md)  
## [sys.dm_xe_database_session_object_columns (banco de dados do SQL Azure)](sys-dm-xe-database-session-object-columns-azure-sql-database.md)  
## [sys.dm_xe_database_session_events (banco de dados do SQL Azure)](sys-dm-xe-database-session-events-azure-sql-database.md)  
## [sys.dm_xe_database_session_event_actions (banco de dados do SQL Azure)](sys-dm-xe-database-session-event-actions-azure-sql-database.md)  
## [sys.DM xe_map_values](sys-dm-xe-map-values-transact-sql.md)  
## [xe_object_columns](sys-dm-xe-object-columns-transact-sql.md)  
## [xe_objects](sys-dm-xe-objects-transact-sql.md)  
## [sys.DM xe_packages](sys-dm-xe-packages-transact-sql.md)  
## [sys.DM xe_session_event_actions](sys-dm-xe-session-event-actions-transact-sql.md)  
## [sys.DM xe_session_events](sys-dm-xe-session-events-transact-sql.md)  
...
## [xe_sessions](sys-dm-xe-sessions-transact-sql.md)  
...
## [sys.DM fts_index_keywords_by_property](sys-dm-fts-index-keywords-by-property-transact-sql.md)  
...
## [fts_memory_buffers](sys-dm-fts-memory-buffers-transact-sql.md)  
## [sys.DM fts_memory_pools](sys-dm-fts-memory-pools-transact-sql.md)  
## [sys.DM fts_outstanding_batches](sys-dm-fts-outstanding-batches-transact-sql.md)  
## [sys.DM fts_parser](sys-dm-fts-parser-transact-sql.md)  
## [sys.DM fts_population_ranges](sys-dm-fts-population-ranges-transact-sql.md)  
## [sys.DM fts_semantic_similarity_population](sys-dm-fts-semantic-similarity-population-transact-sql.md)  

# [Replicação geográfica (banco de dados do SQL Azure)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
## [sys.geo_replication_links (banco de dados do SQL Azure)](sys-geo-replication-links-azure-sql-database.md)  
## [sys.dm_geo_replication_link_status (banco de dados do SQL Azure)](sys-dm-geo-replication-link-status-azure-sql-database.md)  
## [sys.DM continuous_copy_status (banco de dados do SQL Azure)](sys-dm-continuous-copy-status-azure-sql-database.md)  
...
## [sys.DM db_column_store_row_group_physical_stats](sys-dm-db-column-store-row-group-physical-stats-transact-sql.md)  
...
## [db_missing_index_groups](sys-dm-db-missing-index-groups-transact-sql.md)  
## [db_missing_index_group_stats](sys-dm-db-missing-index-group-stats-transact-sql.md)

# [EU O](i-o-related-dynamic-management-views-and-functions-transact-sql.md)  
...
## [sys.DM db_xtp_checkpoint_stats](sys-dm-db-xtp-checkpoint-stats-transact-sql.md)  
...
## [sys.DM db_xtp_index_stats](sys-dm-db-xtp-index-stats-transact-sql.md)  
...
## [xtp_gc_queue_stats](sys-dm-xtp-gc-queue-stats-transact-sql.md)  
## [sys.DM xtp_gc_stats](sys-dm-xtp-gc-stats-transact-sql.md)  
## [sys.DM xtp_system_memory_consumers](sys-dm-xtp-system-memory-consumers-transact-sql.md)  
## [sys.DM xtp_transaction_stats](sys-dm-xtp-transaction-stats-transact-sql.md)  
...
# [Relacionadas à segurança](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
## [sys.DM cryptographic_provider_algorithms](sys-dm-cryptographic-provider-algorithms-transact-sql.md)  
## [sys.DM cryptographic_provider_keys](sys-dm-cryptographic-provider-keys-transact-sql.md)  
## [sys.DM cryptographic_provider_properties](sys-dm-cryptographic-provider-properties-transact-sql.md)  
...
# [Relacionados a servidor](server-related-dynamic-management-views-and-functions-transact-sql.md)  
## [sys.DM server_memory_dumps](sys-dm-server-memory-dumps-transact-sql.md)  
## [sys.DM server_services](sys-dm-server-services-transact-sql.md)  
## [sys.DM server_registry](sys-dm-server-registry-transact-sql.md)  

# [Service Broker](service-broker-related-dynamic-management-views-transact-sql.md)  
## [. dm_broker_activated_tasks](sys-dm-broker-activated-tasks-transact-sql.md)  
...
# [SQL Data Warehouse e o Parallel Data Warehouse](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
...
# [Sistema operacional SQL Server](sql-server-operating-system-related-dynamic-management-views-transact-sql.md)  
## [sys.DM os_buffer_descriptors](sys-dm-os-buffer-descriptors-transact-sql.md)  
## [sys.DM os_buffer_pool_extension_configuration](sys-dm-os-buffer-pool-extension-configuration-transact-sql.md)  
## [sys.DM os_child_instances](sys-dm-os-child-instances-transact-sql.md)  
## [sys.DM os_cluster_nodes](sys-dm-os-cluster-nodes-transact-sql.md)  
...
## [sys.DM os_host](sys-dm-os-hosts-transact-sql.md)  
...
## [sys.DM os_stacks](sys-dm-os-stacks-transact-sql.md)  
## [sys.DM os_sys_info](sys-dm-os-sys-info-transact-sql.md)  
## [sys.DM os_sys_memory](sys-dm-os-sys-memory-transact-sql.md)  
## [os_tasks](sys-dm-os-tasks-transact-sql.md)  
## [os_threads](sys-dm-os-threads-transact-sql.md)  
...
## [sys.DM os_windows_info](sys-dm-os-windows-info-transact-sql.md)  
## [sys.DM os_workers](sys-dm-os-workers-transact-sql.md)  
...
## [sys.DM tran_current_transaction](sys-dm-tran-current-transaction-transact-sql.md)  
...
## [sys.DM tran_session_transactions](sys-dm-tran-session-transactions-transact-sql.md)  
## [sys.DM tran_top_version_generators](sys-dm-tran-top-version-generators-transact-sql.md)  
## [tran_transactions_snapshot](sys-dm-tran-transactions-snapshot-transact-sql.md)  
## [tran_version_store](sys-dm-tran-version-store-transact-sql.md)
