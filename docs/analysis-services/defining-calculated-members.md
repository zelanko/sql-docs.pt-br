...
## Definindo cálculos para agregar medidas físicas  
...
9. Na lista **Comportamento Não Vazio**, marque as caixas de seleção **Vendas pela Internet/Valor das Vendas** e **Vendas do Revendedor/Valor das Vendas** e clique em **OK**.  
    ...
    ![Painel Expressões de Cálculo populado](../analysis-services/media/l6-calculatedmembers-03.gif "Painel Expressões de Cálculo populado")  
...
## Definindo cálculos de margem de lucro bruto  
...
## Definindo o percentual de cálculos totais  
...
8.  Adicione as medidas **MLB Total**, **MLB pela Internet**e **MLB do Revendedor** à área de Valores e analise os resultados.  
    ...
    ![Painel Dados que mostra as vendas do revendedor](../analysis-services/media/l6-calculatedmembers-7b.gif "Painel Dados que mostra as vendas do revendedor")  
