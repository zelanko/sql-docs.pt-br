# [Referência de Erros e Eventos](errors-and-events-reference-database-engine.md)
# [Referência de operadores físicos e lógicos de plano de execução](../showplan-logical-and-physical-operators-reference.md)
# [Referência de classe de evento do SQL Server +](../event-classes/sql-server-event-class-reference.md)
