...
helpviewer_keywords: 
  - "republicando dados"
  - "publicação [replicação do SQL Server], assinantes"
  - "Assinantes [replicação do SQL Server], republicando dados"
...
> [!NOTE]  
>  Se você usar replicação de mesclagem em uma topologia de republicação, todos os Assinantes de republicação deverão usar assinatura de servidor. Para obter mais informações sobre tipos de assinatura, consulte [assinar publicações](../../relational-databases/replication/subscribe-to-publications.md).  
 ...
 ![Republicando dados](../../relational-databases/replication/media/repl-06a.gif "Republicando dados")  
