...
description: Saiba como criar Web Parts personalizadas que fornecem o caminho e os parâmetros do relatório à Web Part do Visualizador de Relatórios que usa conexões do Web Part.
ms.date: 03/04/2017
