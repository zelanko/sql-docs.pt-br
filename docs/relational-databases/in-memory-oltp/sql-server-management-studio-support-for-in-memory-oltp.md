...
description: Use o SQL Server Management Studio para gerenciar tabelas com otimização de memória, índices em tabelas, procedimentos armazenados compilados nativamente e tipos de tabela definidos pelo usuário.
