...
###  <a name="sample-powershell-script-to-disable-registerallprovidersip-and-reduce-ttl"></a><a name="SampleScript"></a>Exemplo de script do PowerShell para desabilitar RegisterAllProvidersIP e reduzir TTL  
