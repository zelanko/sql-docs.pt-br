...
> [!NOTE]  
>  Ao especificar uma tarefa de restauração usando o [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], é possível gerar o script [!INCLUDE[tsql](../../includes/tsql-md.md)][RESTORE](/sql/t-sql/statements/restore-statements-transact-sql) correspondente clicando em **Script** e, em seguida, selecionando um destino para o script.  
