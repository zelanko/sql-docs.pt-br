...
description: Saiba como criar um plano de manutenção de servidor único ou multisservidor no SQL Server usando o SQL Server Management Studio ou o Transact-SQL.
ms.custom: ''
ms.date: 08/01/2016
ms.prod: sql
