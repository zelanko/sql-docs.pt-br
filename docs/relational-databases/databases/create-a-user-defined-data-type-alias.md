...
description: Saiba como criar um alias de tipo de dados definido pelo usuário no SQL Server 2019 usando o SQL Server Management Studio ou Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
