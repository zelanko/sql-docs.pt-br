...
|`LEVEL_VISIBILITY`|`DBTYPE_UI2`|(Opcional) Um bitmap com um dos seguintes valores:<br /><br /> -1 visível<br />-2 não visível<br /><br /> A restrição padrão tem valor 1.|  
