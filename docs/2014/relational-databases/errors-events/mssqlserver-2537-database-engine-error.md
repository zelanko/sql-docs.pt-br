...
|Texto da mensagem|Erro de tabela: ID de objeto O_ID, ID de índice I_ID, ID PN_ID, unidade de alocação A_ID ID (tipo TYPE), página P_ID, linha ROW_ID de partição. Falha na verificação de registro (CHECK_TEXT). Os valores são VALUE1 e VALUE2.|  
