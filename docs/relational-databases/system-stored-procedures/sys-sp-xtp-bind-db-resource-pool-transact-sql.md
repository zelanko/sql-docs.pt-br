...
**Banco de dados é um banco de dados do sistema**  
 [!INCLUDE[hek_2](../../includes/hek-2-md.md)] não não possível criar tabelas em bancos de dados do sistema.  Portanto, isso é inválido para criar uma associação de memória do [!INCLUDE[hek_2](../../includes/hek-2-md.md)] para esse banco de dados.  O seguinte erro é retornado.  
