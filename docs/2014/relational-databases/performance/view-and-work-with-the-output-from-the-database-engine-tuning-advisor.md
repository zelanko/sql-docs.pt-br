...
1.  Crie uma carga de trabalho de ajuste. Para obter mais informações sobre como executar essa tarefa, consulte [Start and Use the Database Engine Tuning Advisor](database-engine-tuning-advisor.md).  
