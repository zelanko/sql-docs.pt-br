---
title: "Monitorar envio de logs (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "envio de logs [SQL Server Agent], status"
  - "tabelas de histórico [SQL Server]"
  - "informações de histórico [SQL Server], envio de logs"
  - "envio de logs [SQL Server], monitoramento"
  - "alertas [SQL Server], envio de logs"
  - "informações de status [SQL Server], envio de logs"
  - "monitorando envio de logs [SQL Server]"
