...
description: Saiba como usar as ferramentas de depuração do Microsoft .NET Framework, que ajudam você a analisar o código de seu assembly personalizado e localizar erros nele.
ms.date: 03/14/2017
