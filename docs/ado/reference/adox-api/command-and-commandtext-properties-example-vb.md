---
title: Comando e exemplo de propriedades CommandText (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35285315"
---
# <a name="command-and-commandtext-properties-example-vb"></a>Exemplo de propriedades de CommandText (VB) e comando
