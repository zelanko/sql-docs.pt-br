...
>  A decomposição de espaço para um índice espacial depende da unidade de medida usada pelos dados do aplicativo.  
 ...
 ![Polígonos e linhas colocados em uma grade de nível 1 4 x 4](../../relational-databases/spatial/media/spndx-level-1-objects.png "Polígonos e linhas colocados em uma grade de nível 1 4 x 4")  
...
>  Essas coordenadas são especificadas pela cláusula BOUNDING_BOX da instrução [CREATE SPATIAL INDEX](../../t-sql/statements/create-spatial-index-transact-sql.md)[!INCLUDE[tsql](../../includes/tsql-md.md)].  
 ...
 ![Caixa delimitadores mostrando coordenadas e a célula 0.](../../relational-databases/spatial/media/spndx-bb-4x4-objects.gif "Caixa delimitadores mostrando coordenadas e a célula 0.")  
...
3.  Une as pirâmides achatadas para formar um plano não euclidiano.  
 ...
 ![Projeção do elipsoide em um plano](../../relational-databases/spatial/media/spndx-geodetic-projection.png "Projeção do elipsoide em um plano")  
