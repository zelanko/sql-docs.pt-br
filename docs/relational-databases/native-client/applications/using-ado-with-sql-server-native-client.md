---
title: Usando ADO
description: Para usar os novos recursos introduzidos no SQL Server 2005, os aplicativos existentes que usam ADO devem usar o provedor de OLE DB de SQL Server Native Client.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
