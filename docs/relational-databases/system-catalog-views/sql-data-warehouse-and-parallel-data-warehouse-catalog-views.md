---
title: Exibições do catálogo de data warehouse SQL Data Warehouse e paralela | Microsoft Docs
ms.custom: ''
ms.date: 10/29/2019
...
ms.locfileid: "73632973"
---
# <a name="sql-data-warehouse-and-parallel-data-warehouse-catalog-views"></a>Exibições do catálogo de data warehouse SQL Data Warehouse e paralelas

[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]

 Este tópico lista as exibições de catálogo [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] e [!INCLUDE[ssPDW](../../includes/sspdw-md.md)].  
  
## <a name="includesssdwincludessssdw-mdmd-and-includesspdwincludessspdw-mdmd-catalog-views"></a>Exibições de catálogo [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] e [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
 As exibições de catálogo a seguir se aplicam ao [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] e [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]:  
...
## <a name="includesssdwincludessssdw-mdmd-catalog-views"></a>Exibições do catálogo [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]

 As exibições de catálogo a seguir se aplicam somente a [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]:
...
## <a name="includesspdwincludessspdw-mdmd-catalog-views"></a>Exibições do catálogo [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]

 As exibições de catálogo a seguir se aplicam somente a [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]:
