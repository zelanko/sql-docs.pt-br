---
title: Atualização de dados do PowerPivot com o SharePoint 2013 | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
###  <a name="bkmk_windows_auth_interactive_data_refresh"></a> Autenticação do Windows com conexões de dados da pasta de trabalho e atualização de dados interativa  
 ...
 Experiência típica do usuário: quando um cliente seleciona “Atualizar Todas as Conexões” em uma pasta de trabalho do Excel 2013 que contém um modelo do PowerPivot, ele recebe uma mensagem de erro semelhante à seguinte:  
...
-   **Pastas de trabalho com suporte:** pastas de trabalho criadas usando o [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] suplemento do PowerPivot para Excel 2010 ou usando o Excel 2013. Pastas de trabalho criadas no Excel 2010 com o [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] suplemento do PowerPivot não têm suporte. Atualizar a pasta de trabalho para pelo menos o [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] formato do PowerPivot. Para obter mais informações, consulte [Atualizar pastas de trabalho e atualização de dados agendada &#40;SharePoint 2013&#41;](../instances/install-windows/upgrade-workbooks-and-scheduled-data-refresh-sharepoint-2013.md).  
...
4.  No momento especificado, o Serviço do Sistema PowerPivot envia uma solicitação aos Serviços do Excel para:  
 ...
 ![gerenciar o menu de contexto de atualização de dados](../media/as-manage-datarefresh-sharepoint2013.gif "gerenciar o menu de contexto de atualização de dados")  
...
3.  Para obter mais informações sobre dados de uso e como habilitá-lo, consulte [PowerPivot Management Dashboard and Usage Data](power-pivot-management-dashboard-and-usage-data.md).  
  
 **Dados de log de diagnóstico:** É possível exibir os dados do log de diagnóstico do SharePoint relacionados à atualização de dados. Primeiro, verifique a configuração de log de diagnóstico do **Serviço PowerPivot** na página **Monitoramento** da Administração Central do SharePoint. Talvez seja necessário aumentar o nível de log para “evento menos crítico” no log. Por exemplo, defina o valor temporariamente como **Detalhado** e execute as operações de atualização de dados novamente.  
...
4.  Na caixa de diálogo **Propriedades de conexão** , clique em **Definição**e no botão **Configurações de Autenticação…** .  
 ...
 ![configurações de autenticação de serviços do Excel](../media/as-authentication-settings-4-ecs-in-excel2013.gif "configurações de autenticação de serviços do excel")  
  
 Para obter mais informações sobre autenticação de atualização de dados e uso de credenciais, consulte a postagem de blog [Atualizando dados PowerPivot no SharePoint 2013](http://blogs.msdn.com/b/analysisservices/archive/2012/12/21/refreshing-powerpivot-data-in-sharepoint-2013.aspx).  
