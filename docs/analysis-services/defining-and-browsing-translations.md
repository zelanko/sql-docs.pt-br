...
8.  Na lista **Colunas de tradução**, selecione **SpanishMonthName**, conforme mostrado na imagem a seguir.  
    ...
    ![Caixa de diálogo Tradução de Dados de Atributo](../analysis-services/media/l9-translations-4.gif "Caixa de diálogo Tradução de Dados de Atributo")  
...
1.  Alterne para o Designer do cubo do Tutorial do [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] e mude para a guia **Traduções**.  
    ...
    ![Idioma padrão na guia Traduções](../analysis-services/media/l9-translations-5.gif "Idioma padrão na guia Traduções")  
...
5.  Na barra de ferramentas, selecione **Espanhol (Espanha)** na lista **Idioma**.  
    ...
    ![Painel de metadados populado novamente](../analysis-services/media/l9-translations-6.png "Painel de metadados populado novamente")  
...
9. No painel de metadados, clique com o botão direito do mouse em **Mes del Ano** e selecione **Adicionar à Consulta**.  
    ...
    ![Nomes de meses em espanhol no painel Dados](../analysis-services/media/l9-translations-7.gif "Nomes de meses em espanhol no painel Dados")  
