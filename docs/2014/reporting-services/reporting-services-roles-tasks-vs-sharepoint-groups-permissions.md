 ...
 **Modo do SharePoint:** [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] modo do SharePoint utiliza os recursos de permissão do SharePoint. Os grupos e as permissões do SharePoint são gerenciados da página **Configurações de Site** a seguir.  
...
|Modo nativo do [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]|SharePoint|  
|---------------------------------------------|----------------|  
