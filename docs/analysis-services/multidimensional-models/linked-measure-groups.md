...
ms.topic: "article"
helpviewer_keywords: 
  - "grupos de medidas vinculados [Analysis Services]"
  - "referenciando grupos de medidas"
  - "Assistente do grupo de medidas vinculado"
  - "grupos de medidas [Analysis Services], vinculados"
  - "dimensões vinculadas [Analysis Services]"
...
## Criar ou modificar uma medida vinculada  
