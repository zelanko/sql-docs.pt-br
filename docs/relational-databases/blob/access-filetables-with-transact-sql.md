...
description: Saiba como os comandos de DML (linguagem de manipulação de dados) do Transact-SQL funcionam com FileTables. Veja quais restrições definidas pelo sistema são impostas durante as operações de DML.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
