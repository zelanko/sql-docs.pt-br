...
ms.topic: "article"
helpviewer_keywords: 
  - "nomes [Analysis Services], atributos"
  - "renomeando atributos"
  - "atributos [Analysis Services], renomeando"
  - "propriedade Name"
...
# Renomear um atributo
 ...
 Para obter mais informações sobre como renomear um atributo, consulte [Associar um atributo a uma coluna de chave](../../analysis-services/multidimensional-models/bind-an-attribute-to-a-key-column.md).  
