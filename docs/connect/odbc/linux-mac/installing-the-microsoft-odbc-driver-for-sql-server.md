...
---
# <a name="installing-the-microsoft-odbc-driver-for-sql-server-on-linux-and-macos"></a>Instalando o Microsoft ODBC Driver for SQL Server no Linux e macOS
...
- Red Hat: glibc, e2fsprogs, krb5 bibliotecas, openssl, unixODBC
...
#### <a name="redhat-linux-enterprise-server-7"></a>RedHat Linux Enterprise Server 7
  - Baixar a mais recente. de rpm salvou aqui: http://packages.microsoft.com/rhel/7/prod/
...
#### <a name="ubuntu-1604"></a>Ubuntu 16.04
- Baixar a mais recente. de DEB salvou aqui: http://packages.microsoft.com/ubuntu/16.04/prod/pool/main/m/msodbcsql/ 
- Instalar o driver e dependências 
...
#### <a name="suse-linux-enterprise-server-12"></a>SUSE Linux Enterprise Server 12
- Baixar a mais recente. de rpm salvou aqui: http://packages.microsoft.com/sles/12/prod/
...
Para verificar se o Microsoft ODBC Driver do Linux foi registrado com êxito, execute o seguinte comando: **odbcinst -q -d -n "ODBC Driver 11 for SQL Server"**.  
