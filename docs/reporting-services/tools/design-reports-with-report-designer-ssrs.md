...
ms.topic: "article"
helpviewer_keywords: 
  - "Report Designer [Reporting Services], criação de relatórios"
...
O Designer de Relatórios é um recurso do [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)], um ambiente do Microsoft Visual Studio para criação de soluções de business intelligence. [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] não é incluído com [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]. Baixar o [SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714). 
...
##  <a name="a-namebkmkshareddatasourcesa-shared-data-sources"></a><a name="bkmk_SharedDataSources"></a> Fontes de dados compartilhadas  
 ...
 Para obter mais informações, consulte [Data Connections, Data Sources, and Connection Strings &#40;Report Builder and SSRS&#41;](../../reporting-services/report-data/data-connections-data-sources-and-connection-strings-report-builder-and-ssrs.md).  
   
##  <a name="a-namebkmkshareddatasetsa-shared-datasets"></a><a name="bkmk_SharedDatasets"></a> Conjuntos de dados compartilhados  
...
##  <a name="a-namebkmkreportsa-paginated-reports"></a><a name="bkmk_Reports"></a> Relatórios paginados  
...
##  <a name="a-namebkmkreportpartsa-report-parts"></a><a name="bkmk_ReportParts"></a> Partes de relatório  
...
##  <a name="a-namebkmkresourcesa-resources"></a><a name="bkmk_Resources"></a> Recursos  
...
##  <a name="a-namebkmkreportlayouta-paginated-report-layout"></a><a name="bkmk_ReportLayout"></a> Layout de relatório paginado  
...
##  <a name="a-namebkmkpreviewa-preview-a-paginated-report"></a><a name="bkmk_Preview"></a> Visualizar um relatório paginado  
...
##  <a name="a-namebkmksaveanddeploya-save-and-deploy-paginated-reports"></a><a name="bkmk_SaveandDeploy"></a> Salvar e implantar relatórios paginados  
...
>  Para depurar erros de expressões e de implantação, exiba a definição de relatório na pasta de compilação. Não use **Exibir Código-Fonte**. A opção**Exibir Código-Fonte** exibe a origem da definição de relatório na pasta do projeto.  
 ...
 Para obter mais informações, consulte [Deployment and Version Support in SQL Server Data Tools &#40;SSRS&#41;](../../reporting-services/tools/deployment-and-version-support-in-sql-server-data-tools-ssrs.md).  
...
##  <a name="a-namebkmkreportvalidationanderrorlevelsa-report-validation-and-error-levels"></a><a name="bkmk_ReportValidationandErrorLevels"></a> Validação de relatórios e níveis de erro  
...
*  [Baixe o SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714) [Reporting Services no SQL Server Data Tools &#40;SSDT&#41;](../../reporting-services/tools/reporting-services-in-sql-server-data-tools-ssdt.md)   
