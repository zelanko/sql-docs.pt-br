...
- [Novidades no SQL Server em Linux](sql-server-linux-whats-new.md)

Para obter uma lista dos recursos de SQL Server não disponíveis no Linux, confira [Recursos e serviços sem suporte](sql-server-linux-release-notes.md#Unsupported).
