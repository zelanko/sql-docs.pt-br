...
description: Identifique a causa de um deadlock repetindo e exibindo eventos de deadlock para análise no SQL Server Profiler e gerando grafos de espera.
ms.prod: sql
