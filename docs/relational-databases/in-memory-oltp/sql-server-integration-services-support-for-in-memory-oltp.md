...
description: Saiba como usar procedimentos armazenados compilados nativamente como componentes de origem e de destino em um pacote do SQL Server Integration Services.
