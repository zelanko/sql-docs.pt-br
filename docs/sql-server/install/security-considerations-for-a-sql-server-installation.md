...
description: Este artigo discute algumas práticas recomendadas de segurança que você deve considerar antes e depois de instalar o SQL Server.
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
ms.reviewer: ''
