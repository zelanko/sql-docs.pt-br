...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]O formato DiffGram foi introduzido no **DataSet** componente do [!INCLUDE[msCoName](../../../includes/msconame-md.md)] do .NET Framework. No .NET Framework, você pode criar DiffGrams e usá-los para modificar dados em tabelas de um banco de dados Microsoft [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Executando um DiffGram usando ADO &#40; SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/diffgram/executing-a-diffgram-by-using-ado-sqlxml-4-0.md)  
