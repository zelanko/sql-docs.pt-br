...
description: Um servidor pode ser configurado para monitorar vários protocolos de rede. É possível alterar a configuração usando o SQL Server Configuration Manager.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
