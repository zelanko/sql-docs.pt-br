...
ms.topic: "article"
helpviewer_keywords: 
  - "scripts [Integration Services], tarefas"
  - "arquivos [Integration Services], opções de tarefa"
  - "tarefas de fluxo de trabalho [Integration Services]"
  - "Integration Services, tarefas"
  - "adicionando tarefas de pacote"
  - "tarefas [Integration Services], listadas"
  - "Tarefas de SSIS"
  - "SSIS, tarefas"
  - "fluxo de controle [Integration Services], tarefas"
  - "tarefas [Integration Services]"
  - "agrupando tarefas"
  - "tarefas [Integration Services], sobre tarefas"
  - "Tarefas do SQL Server Integration Services"
  - "tarefas de preparação de dados [Integration Services]"
  - "operações de diretório [Integration Services]"
