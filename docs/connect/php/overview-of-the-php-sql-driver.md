...
|Tópico|Description|  
|---------|---------------|  
| ![Um círculo seta download](../../ssdt/media/download.png)[para baixar drivers de PHP para SQL Server](download-drivers-php-sql-server.md) | Links para baixar Drivers da Microsoft para PHP para SQL Server. |
