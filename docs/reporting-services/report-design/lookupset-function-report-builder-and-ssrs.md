...
manager: "erikre"
---
# Fun&#231;&#227;o LookupSet (Construtor de Relat&#243;rios e SSRS)
...
## Exemplo  
 ...
 Use a função **Join** do [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] e crie uma cadeia delimitada por meio de um conjunto de objetos. Use vírgula como separador combinar os objetos em uma única linha. Em alguns renderizadores, você pode usar uma alimentação de linha (`vbCrLF`) do [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] como um separador para listar cada valor em uma nova linha.  
