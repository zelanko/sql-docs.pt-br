...
description: Saiba como adicionar várias regiões de dados a um relatório paginado para fornecer diferentes exibições de dados do mesmo conjunto de dados de relatório no Construtor de Relatórios.
ms.date: 05/30/2017
