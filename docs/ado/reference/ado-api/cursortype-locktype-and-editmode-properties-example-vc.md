---
description: Exemplo das propriedades CursorType, LockType e EditMode (VC + +)
title: Exemplo das propriedades CursorType, LockType e EditMode (VC + +) | Microsoft Docs
ms.prod: sql
