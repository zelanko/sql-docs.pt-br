---
title: Exemplo de execução assíncrona (método de notificação)
description: Exemplo de código que demonstra como usar a execução assíncrona (usando o método de notificação) no Microsoft ODBC Driver for SQL Server.
ms.custom: ''
ms.date: 09/01/2020
ms.prod: sql
...
[!INCLUDE[Driver_ODBC_Download](../../../includes/driver_odbc_download.md)]
  ...
  As amostras de código neste tópico demonstram como usar a [Execução Assíncrona (Método de Notificação)](../../../odbc/reference/develop-app/asynchronous-execution-notification-method.md).  
