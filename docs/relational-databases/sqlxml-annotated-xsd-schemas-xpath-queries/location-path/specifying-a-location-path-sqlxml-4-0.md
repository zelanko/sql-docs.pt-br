...
description: Saiba como especificar um caminho de local em uma consulta XPath do SQLXML 4,0 para selecionar um conjunto de nós relativos ao nó de contexto e gerar um conjunto de nós.
ms.date: 03/17/2017
ms.prod: sql
