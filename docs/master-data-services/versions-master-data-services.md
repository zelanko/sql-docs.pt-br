...
ms.topic: "article"
helpviewer_keywords: 
  - "sinalizadores de versão [Master Data Services], sobre sinalizadores de versão"
  - "versões [Master Data Services]"
  - "sinalizadores de versões [Master Data Services]"
  - "versões [Master Data Services], sinalizadores de versão"
