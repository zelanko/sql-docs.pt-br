...
## <a name="see-also"></a>Consulte também  
 ...
 [Como configurar o SQL Server 2008 Analysis Services e o SQL Server 2005 Analysis Services para usar a autenticação Kerberos](https://support.microsoft.com/kb/917409)   
 [Sintaxe SetSPN (Setspn.exe) de SPNs (nomes de entidade de serviço)](https://social.technet.microsoft.com/wiki/contents/articles/717.service-principal-names-spns-setspn-syntax-setspn-exe.aspx)   
 [Que SPN eu utilizo e como ele é colocado lá?](https://social.technet.microsoft.com/wiki/contents/articles/717.service-principal-names-spns-setspn-syntax-setspn-exe.aspx)   
 [SetSPN](https://technet.microsoft.com/library/cc731241\(WS.10\).aspx)   
 [Guia passo a passo de contas de serviço](https://technet.microsoft.com/library/dd548356\(WS.10\).aspx)   
 ...
 [Como usar os SPNs quando você configura aplicativos Web hospedados em Serviços de Informações da Internet](https://support.microsoft.com/kb/929650)   
