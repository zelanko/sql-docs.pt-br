...
## <a name="see-also"></a>Consulte Também  
 [Definir configurações de propriedade HealthCheckTimeout](configure-healthchecktimeout-property-settings.md)   
 [Definir configurações de propriedade FailureConditionLevel](configure-failureconditionlevel-property-settings.md)   
