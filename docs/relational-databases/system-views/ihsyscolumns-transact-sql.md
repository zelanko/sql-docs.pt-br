...
|**Comprimento**|**bigint**|O comprimento máximo de armazenamento físico da [sys. systypes &#40;Transact-SQL&#41;](../../relational-databases/system-compatibility-views/sys-systypes-transact-sql.md).|  
