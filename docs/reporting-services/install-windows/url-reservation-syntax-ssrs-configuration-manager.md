---
description: Sintaxe de reserva de URL (Gerenciador de Configurações do Servidor de Relatório)
...
ms.locfileid: "91934130"
---
# <a name="url-reservation-syntax--report-server-configuration-manager"></a>Sintaxe de reserva de URL (Gerenciador de Configurações do Servidor de Relatório)
