---
description: Caixa de diálogo Criar perfil e conta do Database Mail
...
|**Esse servidor requer uma conexão segura (SSL)**|Criptografa a comunicação usando TLS (segurança de camada de transporte), anteriormente conhecido como protocolo SSL (SSL).|  
