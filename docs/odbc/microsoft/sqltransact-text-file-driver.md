---
title: SQLTransact (Driver do arquivo de texto) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32905001"
---
# <a name="sqltransact-text-file-driver"></a>SQLTransact (Driver do arquivo de texto)
> [!NOTE]  
