...
helpviewer_keywords: 
  ...
  - "passo a passo [replicação do SQL Server]"
...
[Replicando dados entre servidores conectados continuamente](../../relational-databases/replication/tutorial-replicating-data-between-continuously-connected-servers.md)  
