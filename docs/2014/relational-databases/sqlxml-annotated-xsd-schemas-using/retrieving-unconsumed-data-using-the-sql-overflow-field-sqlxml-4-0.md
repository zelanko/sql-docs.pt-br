...
```  
 ...
 Além disso, você deve criar um diretório virtual para o banco de dados tempdb-e um nome virtual de modelo do `template` tipo chamado "template".  
