...
ms.tgt_pltfrm: 
ms.topic: reference
apiname: InstanceName Property (ServerNetworkProtocol Class)
...
ms.openlocfilehash: dec0195929de154ead21eac484ea07aef8e69a3f
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Obtém o nome da instância do [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] que é referenciado pelo protocolo de rede do servidor.  
