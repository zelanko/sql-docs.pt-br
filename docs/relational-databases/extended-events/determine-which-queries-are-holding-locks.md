---
title: Determinar quais consultas estão mantendo bloqueios
description: Este artigo mostra um método para localizar qual consulta mantém um bloqueio. Os administradores de banco de dados podem precisar localizar a origem dos bloqueios que prejudicam o desempenho do banco de dados.
ms.date: 10/18/2019
ms.prod: sql
