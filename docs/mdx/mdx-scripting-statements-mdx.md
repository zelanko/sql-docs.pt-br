---
title: Instruções de script MDX (MDX) | Microsoft Docs
ms.date: 06/04/2018
ms.prod: sql
...
|[Palavra-chave EXISTING &#40;MDX&#41;](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-query-existing-keyword)|Força a avaliação de um conjunto especificado no contexto atual.|  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Conceitos básicos do script MDX &#40;Analysis Services&#41;](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-scripting-fundamentals-analysis-services)  
