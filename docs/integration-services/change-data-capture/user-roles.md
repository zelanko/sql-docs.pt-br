...
### Conta de serviço: Serviço Oracle CDC  
...
## Funções de usuário do SQL Server  
...
### Administrador do Serviço Oracle CDC  
...
### Consumidor de Alteração Oracle CDC  
