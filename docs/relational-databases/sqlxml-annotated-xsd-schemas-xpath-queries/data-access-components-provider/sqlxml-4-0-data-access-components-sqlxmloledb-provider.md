...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)] O SQLXML 4.0 inclui três provedores de dados que podem inserir dados XML e recuperar dados XML de um banco de dados [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]:  
