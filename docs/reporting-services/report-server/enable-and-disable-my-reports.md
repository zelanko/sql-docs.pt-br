...
ms.topic: "article"
helpviewer_keywords: 
  - "pasta Meus Relatórios desativada"
  - "pastas [Reporting Services], Meus Relatórios"
  - "pasta Meus Relatórios ativada"
  - "pasta Meus Relatórios [Reporting Services]"
  - "desabilitando a pasta Meus Relatórios"
...
## Como habilitar e desabilitar Meus Relatórios  
...
### Quando Meus Relatórios está ativado  
...
### Quando Meus Relatórios está desativado  
...
## Optando por usar Meus Relatórios  
