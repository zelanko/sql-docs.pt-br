---
title: Configurações de email - Gerenciador de configuração (modo nativo do SSRS) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Método de entrega SMTP atual**  
 ...
 No arquivo de configuração, o método de entrega é definido por meio de `SendUsing` configuração. Para obter mais informações sobre como especificar o `SendUsing` configuração, consulte [configurar um servidor de relatório para entrega de email &#40;SSRS Configuration Manager&#41;](../../sql-server/install/configure-a-report-server-for-e-mail-delivery-ssrs-configuration-manager.md).  
