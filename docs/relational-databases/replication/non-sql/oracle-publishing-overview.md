...
ms.topic: "article"
helpviewer_keywords: 
  - "publicação [replicação do SQL Server], publicação Oracle"
  - "replicação de instantâneo [SQL Server], publicação Oracle"
  - "publicação Oracle [replicação do SQL Server]"
  - "replicação transacional, publicação Oracle"
  - "publicação Oracle [replicação do SQL Server], sobre a publicação Oracle"
