...
|**GRANTEE**|**sysname**|Nome de usuário do banco de dados ao qual foram concedidas permissões neste **table_name** pelo **concessor**listado. Esse campo sempre retorna um valor.|  
