...
description: Adicione totais em uma região de dados tablix de um relatório paginado no Construtor de Relatórios para um grupo ou para toda a região de dados.
ms.date: 12/16/2019
