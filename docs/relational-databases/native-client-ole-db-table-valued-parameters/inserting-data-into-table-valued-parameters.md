---
title: Inserir dados em parâmetros com valor de tabela (provedor de OLE DB de cliente nativo) | Microsoft Docs
description: Saiba mais sobre os dois modelos aos quais o provedor de OLE DB SQL Server Native Client dá suporte para que o consumidor especifique dados para linhas de parâmetro com valor de tabela.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87246747"
---
# <a name="inserting-data-into-table-valued-parameters-native-client-ole-db-provider"></a>Inserindo dados em parâmetros com valor de tabela (provedor de OLE DB de cliente nativo)
...
## <a name="push-model-loads-all-table-valued-parameter-data-in-memory"></a>Modelo de push (carrega todos os dados de parâmetro com valor de tabela na memória)  
