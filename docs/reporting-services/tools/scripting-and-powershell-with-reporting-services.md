...
helpviewer_keywords: 
  ...
  - "Reporting Services, script"
  - "Geração de scripts [Reporting Services]"
...
---
# Script e PowerShell com o Reporting Services
...
## Exemplos e cmdlets do PowerShell do modo SharePoint do Reporting Services  
...
-   [Como administrar SSRS usando o PowerShell](http://curah.microsoft.com/13107/how-to-administer-ssrs-using-powershell).  
  
## Exemplos de script RS.exe  
