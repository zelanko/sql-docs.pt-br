...
helpviewer_keywords: 
  - "caixa de diálogo Todas as Assinaturas"
...
# Validar Todas as Assinaturas
 ...
 Também é possível validar uma única assinatura clicando em uma assinatura no [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] e clicando em **Validar assinatura**.  
