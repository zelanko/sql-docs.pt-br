...
Com a introdução de [grupos de cargas de trabalho](/azure/sql-data-warehouse/sql-data-warehouse-workload-isolation), os slots de simultaneidade não são mais aplicáveis.  Use a consulta abaixo e a `resources_requested` coluna para entender os recursos necessários para executar a solicitação.
