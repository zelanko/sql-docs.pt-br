...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento Exec Prepare SQL indica que o SqlClient, ODBC, OLE DB ou DB-Library executou uma ou mais instruções preparadas do [!INCLUDE[tsql](../../includes/tsql-md.md)].  
...
|EventSequence|**int**|Sequência de um determinado evento na solicitação.|51||  
|GroupID|**int**|ID do grupo de carga de trabalho no qual o evento de Rastreamento do SQL dispara.|66|Sim|  
|Handle|**int**|Manuseio da instrução SQL preparada.|33|Sim|  
