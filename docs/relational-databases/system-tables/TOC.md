...
# [Tabelas de eventos estendidas – trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Tabelas de eventos estendidas – trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
...
# [Tabelas de Change Data Capture](change-data-capture-tables-transact-sql.md)  
...
# [Tabelas de Plano de Manutenção do Banco de Dados](database-maintenance-plan-tables-transact-sql.md)  
...
# [Tabelas do envio de logs](log-shipping-tables-transact-sql.md)  
