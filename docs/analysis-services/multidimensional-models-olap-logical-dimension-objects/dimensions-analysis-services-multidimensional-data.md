...
|Tópico|Description|  
|-----------|-----------------|  
|[Introdução às dimensões &#40; Analysis Services - dados multidimensionais &#41;](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/dimensions-introduction.md)|Fornece uma visão geral de conceitos de dimensão.|  
|[Atributos e hierarquias de atributo](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/attributes-and-attribute-hierarchies.md)|Descreve atributos e hierarquias de atributo.|  
