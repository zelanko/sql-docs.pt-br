---
title: Executar uma função definida pelo usuário e o processo de código de retorno (OLE DB) | Microsoft Docs
description: Executar um definido pelo usuário função e o processo de código de retorno usando o Driver do OLE DB para SQL Server
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
## <a name="see-also"></a>Consulte também  
 [Tópicos de instruções de resultados do processamento & #40; OLE DB & #41;](../../../oledb/ole-db-how-to/results/processing-results-how-to-topics-ole-db.md)  
