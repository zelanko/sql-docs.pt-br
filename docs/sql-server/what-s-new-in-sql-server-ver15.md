...
- [Mecanismo de Banco de Dados](#databaseengine)
  - O processamento de consulta inteligente adiciona inlining do UDF escalar
  - Mensagem de erro de truncamento aprimorada para incluir nomes de tabela e coluna e o valor truncado
  - Suporte a agrupamentos UTF-8 na instalação do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]
  - Usar aliases de exibição ou tabela derivada em consultas de correspondência de gráfico
  - Dados de diagnóstico aprimorados para bloqueio de estatísticas
...
O [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] apresenta ou aprimora os seguintes recursos novos para o Mecanismo de Banco de Dados
...
Para obter mais informações, confira [Inlining do UDF escalar](../relational-databases/user-defined-functions/scalar-udf-inlining.md)
...
A nova mensagem de erro 2628 fornece mais contexto para o problema de truncamento de dados, simplificando o processo de solução de problemas. Para o CTP 2.1, essa é uma mensagem de erro para aceitação e requer que o [sinalizador de rastreamento](../t-sql/database-console-commands/dbcc-traceon-trace-flags-transact-sql.md) 460 esteja habilitado.

### <a name="utf-8-support-ctp-21"></a>Suporte a UTF-8 (CTP 2.1)

Foi adicionado suporte para selecionar o agrupamento de UTF-8 como padrão durante a instalação do [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)].
...
O mascaramento de dados é o processo de aplicação de uma máscara a um banco de dados para ocultar informações confidenciais e substituí-la por dados novos ou dados limpos. A Microsoft oferece duas opções de mascaramento: o mascaramento de dados estáticos e o mascaramento de dados dinâmicos. O mascaramento de dados dinâmicos foi introduzido no SQL Server 2017. A seguinte tabela compara essas duas soluções:
...
### <a name="utf-8-support-ctp-20"></a>Suporte a UTF-8 (CTP 2.0)
...
- [**Azure Data Studio**](../azure-data-studio/what-is.md): lançado anteriormente com nome da versão prévia SQL Operations Studio, o Azure Data Studio é uma ferramenta de área de trabalho leve, moderna, de software livre e multiplataforma comuns usada para as tarefas mais comuns no desenvolvimento e administração de dados. Com o Azure Data Studio, você pode se conectar ao SQL Server local e na nuvem do Windows, macOS e Linux. O Azure Data Studio permite:
  ...
  - suporte para cenários que usam um Cluster de Big Data do SQL Server. (CTP 2.0)
...
- [**SSMS (SQL Server Management Studio) 18.0 (versão prévia)**](../ssms/sql-server-management-studio-ssms.md)
  ...
  - Para obter uma lista completa, confira o [Log de mudanças do SSMS](../ssms/sql-server-management-studio-changelog-ssms.md). (CTP 2.0)

## <a name="other-services"></a>Outros serviços

No CTP 2.1, o [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] não introduz novos recursos para os seguintes serviços:
