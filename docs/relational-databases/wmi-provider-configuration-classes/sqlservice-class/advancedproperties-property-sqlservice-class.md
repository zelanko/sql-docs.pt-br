...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Obtém uma matriz de referências de objeto que contém as propriedades avançadas para o **SqlService** objeto.  
