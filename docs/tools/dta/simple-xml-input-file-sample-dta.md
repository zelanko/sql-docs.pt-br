---
title: Exemplo de arquivo (DTA) de entrada XML simples | Microsoft Docs
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>Consulte também  
 ...
 [Referência do arquivo de entrada XML &#40; otimização Advisor &#41; do mecanismo de banco de dados](../../tools/dta/xml-input-file-reference-database-engine-tuning-advisor.md)  
