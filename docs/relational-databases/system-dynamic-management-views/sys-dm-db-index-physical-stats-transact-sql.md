 ...
 *modo* | NULO | PADRÃO  
 É o nome do modo. *modo* Especifica o nível de verificação que é usado para obter estatísticas. *modo* está **sysname**. Entradas válidas são DEFAULT, NULL, LIMITED, SAMPLED ou DETAILED. O padrão (NULL) é LIMITED.  
