...
Você também pode obter ajuda pesquisando e postando perguntas no [P e R da Microsoft](/answers/products/sql-server).
...
- [Equipe do SQL Tiger](/archive/blogs/sql_server_team/)
