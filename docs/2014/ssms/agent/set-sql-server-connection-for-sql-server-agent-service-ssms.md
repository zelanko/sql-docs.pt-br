---
title: Definir a Conexão de servidor SQL para o serviço do SQL Server Agent (SQL Server Management Studio) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
3.  No **propriedades do SQL Server Agent** caixa de diálogo **selecionar uma página**, clique em **Conexão**.  
