...
> [!NOTE]
> Às vezes, é possível instalar e executar o SQL Server em outras plataformas Linux intimamente relacionado, mas o SQL Server somente é testado e suportado em plataformas listadas na tabela anterior.
