...
manager: "erikre"
---
# Li&#231;&#227;o 8: Criar indicadores chave de desempenho
...
## Pré-requisitos  
Este tópico faz parte de um tutorial de modelo de tabela, que deve ser concluído na ordem. Antes de executar as tarefas desta lição, você deverá ter concluído a lição anterior: [Lição 7: Criar medidas](../analysis-services/lesson-7-create-measures.md).  
  
## Criar indicadores chave de desempenho  
  
#### Para criar um KPI de Desempenho de Vendas do Trimestre Atual da Internet  
...
3.  Na barra de fórmulas acima da tabela, digite a fórmula a seguir:  
    ...
    **Desempenho de Vendas do Trimestre Atual da Internet :=IFERROR([Vendas do Trimestre Atual da Internet]/[Proporção de Vendas do Trimestre Anterior até QTD],BLANK())**  
...
5.  Na caixa de diálogo **KPI (Indicador Chave de Desempenho)**, em **Destino**, selecione a opção **Valor Absoluto**.  
...
#### Para criar um KPI de Desempenho de Margem do Trimestre Atual da Internet  
...
2.  Na barra de fórmulas acima da tabela, digite a fórmula a seguir:  
    ...
    **Desempenho de Margem do Trimestre Atual da Internet :=IF([Proporção da Margem do Trimestre Anterior da Internet até QTD]<>0,([Margem do Trimestre Atual da Internet]-[Proporção da Margem do Trimestre Anterior da Internet até QTD])/[Proporção da Margem do Trimestre Anterior da Internet até QTD],BLANK())**  
...
## Próxima etapa  
Para continuar este tutorial, vá para a próxima lição: [Lição 9: Criar perspectivas](../Topic/Lesson%209:%20Create%20Perspectives.md).  
