...
# <a name="sql-server-agent"></a>SQL Server Agent
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]O Agent é um serviço do Microsoft Windows que executa tarefas administrativas agendadas, que *jobs* são chamadas [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]de trabalhos no.  
