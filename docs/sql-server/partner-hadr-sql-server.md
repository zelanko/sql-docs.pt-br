...
description: Listas de parceiros terceirizados com soluções para fornecer alta disponibilidade e recuperação de desastre a seus serviços do SQL Server.
ms.topic: conceptual
