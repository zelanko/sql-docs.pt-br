---
title: Provedor WMI para conceitos de eventos de servidor
description: Use estes recursos para saber mais sobre como o provedor WMI para eventos de servidor usa Instrumentação de Gerenciamento do Windows para monitorar eventos em uma instância do SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
