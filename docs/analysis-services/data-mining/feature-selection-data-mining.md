...
ms.topic: "article"
helpviewer_keywords: 
  - "modelos de mineração [Analysis Services], seleções de recurso"
  - "atributos [mineração de dados]"
  - "algoritmos seleção de recurso [Analysis Services]"
  - "mineração de dados [Analysis Services], seleções de recurso"
