---
title: Exemplo de propriedades de CommandText (VC + +) e comando | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35285385"
---
# <a name="command-and-commandtext-properties-example-vc"></a>Exemplo de propriedades de CommandText (VC + +) e comando
