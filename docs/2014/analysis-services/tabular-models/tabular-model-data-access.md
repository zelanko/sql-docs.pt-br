...
### <a name="csdl"></a>CSDL  
 ...
 Para obter informações sobre como o CSDL é usado em modelos de tabela, consulte [CSDL Annotations for Business Intelligence &#40;CSDLBI&#41;](../tabular-model-programming-compatibility-levels-1050-1103/csdl-annotations-for-business-intelligence-csdlbi.md).  
...
-   [Conjunto de linhas DISCOVER_CALC_DEPENDENCY](../schema-rowsets/xml/discover-calc-dependency-rowset.md)  
...
-   [Conjunto de linhas DISCOVER_CSDL_METADATA](../schema-rowsets/xml/discover-csdl-metadata-rowset.md)  
...
-   [Conjunto de linhas DISCOVER_TRACES](../schema-rowsets/xml/discover-traces-rowset.md)  
...
-   [Conjunto de linhas MDSCHEMA_HIERARCHIES](../schema-rowsets/ole-db-olap/mdschema-hierarchies-rowset.md)  
  
     Novo `STRUCTURE_TYPE` enumeração dá suporte à identificação de hierarquias definidas pelo usuário criadas em modelos de tabela. Para obter mais informações, consulte [Hierarquias &#40;SSAS Tabular&#41;](hierarchies-ssas-tabular.md).  
