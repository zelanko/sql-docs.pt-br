...
##  <a name="VisualElement"></a>Relação de objeto de configuração Database Mail  
...
##  <a name="DBAccount"></a>Conta de Database Mail  
...
-   O tipo de servidor de email. Para [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]o, esse é sempre o protocolo SMTP.  
...
##  <a name="DBProfile"></a>Perfil de Database Mail  
...
##  <a name="RelatedTasks"></a>Database Mail tarefas de configuração  
...
##  <a name="Add_Tasks"></a>Tarefas de configuração de banco de dados adicionais (procedimentos armazenados do sistema)  
...
|Nome|DESCRIÇÃO|  
|----------|-----------------|  
|[&#41;&#40;Transact-SQL de sysmail_start_sp](/sql/relational-databases/system-stored-procedures/sysmail-start-sp-transact-sql)|Inicia o programa externo do Database Mail e a fila associada do SQL Service Broker.|  
|[&#41;&#40;Transact-SQL de sysmail_stop_sp](/sql/relational-databases/system-stored-procedures/sysmail-stop-sp-transact-sql)|Interrompe o programa externo do Database Mail e a fila associada do SQL Service Broker.|  
