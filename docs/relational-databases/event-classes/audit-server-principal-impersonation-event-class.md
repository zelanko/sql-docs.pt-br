...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Server Principal Impersonation** ocorre quando há uma representação no escopo do servidor, como EXECUTE AS \<*logon*>.  
