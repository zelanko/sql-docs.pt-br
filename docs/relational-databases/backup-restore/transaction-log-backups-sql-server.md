...
description: Independentemente dos backups de banco de dados, você pode fazer backup do log de transações do SQL Server com frequência. A sequência dos backups do log de transações é uma cadeia de logs.
ms.custom: ''
ms.date: 01/05/2018
ms.prod: sql
