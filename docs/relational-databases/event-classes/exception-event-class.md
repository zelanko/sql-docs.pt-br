...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento Exception indica que uma exceção ocorreu em [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
