# [Visão geral](system-tables-transact-sql.md)  
# [Estendido tabelas de eventos - trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Estendido tabelas de eventos - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tabelas de aplicativo da camada de dados - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tabelas de aplicativo da camada de dados - sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Mapeando tabelas do sistema para exibições do sistema](mapping-system-tables-to-system-views-transact-sql.md)  
# [Tabelas Base do sistema](system-base-tables.md)  
# [Tabelas de backup e restauração](backup-and-restore-tables-transact-sql.md)  
...
# [Tabelas Change Data Capture](change-data-capture-tables-transact-sql.md)  
## [CDC. < capture_instance > _CT](cdc-capture-instance-ct-transact-sql.md)  
## [captured_columns](cdc-captured-columns-transact-sql.md)  
## [change_tables](cdc-change-tables-transact-sql.md)  
...
# [Tabelas de plano de manutenção de banco de dados](database-maintenance-plan-tables-transact-sql.md)  
...
# [Tabelas do Integration Services](integration-services-tables-transact-sql.md)  
...
# [Tabelas de envio de logs](log-shipping-tables-transact-sql.md)  
...
# [Tabelas do SQL Server Agent](sql-server-agent-tables-transact-sql.md)  
...
# [Tabelas de replicação](replication-tables-transact-sql.md)  
## [Conflict _<schema>_<table>](conflict-schema-table-transact-sql.md)  
...
## [Msmerge_conflict _<publication>_<article>](msmerge-conflict-publication-article-transact-sql.md)  
