...
description: Saiba mais sobre como criar um relatório de detalhamento (RDLC) com parâmetros e uma consulta nos relatórios em modo local.
ms.date: 05/18/2016
...
Este passo a passo pressupõe que você esteja familiarizado com as consultas Transaction-SQL e os objetos [DataSet](/dotnet/api/system.data.dataset) e [DataTable](/dotnet/api/system.data.datatable) do ADO.NET.  
...
[Lição 1: Criar um site](../reporting-services/lesson-1-create-a-new-web-site.md)  
