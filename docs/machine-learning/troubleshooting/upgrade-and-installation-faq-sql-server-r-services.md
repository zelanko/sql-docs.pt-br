---
title: Perguntas frequentes sobre instalação e atualização
description: Respostas para algumas perguntas comuns sobre a instalação ou a atualização de recursos de machine learning no SQL Server.
ms.prod: sql
...
ms.locfileid: "87253624"
---
# <a name="installation-and-upgrade-faq-for-sql-server-machine-learning-or-r-server"></a>Perguntas frequentes sobre a instalação e a atualização do machine learning do SQL Server ou do R Server
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

Este artigo fornece respostas para algumas perguntas comuns sobre a instalação de recursos de machine learning no SQL Server. Ele também aborda perguntas comuns sobre atualizações.
