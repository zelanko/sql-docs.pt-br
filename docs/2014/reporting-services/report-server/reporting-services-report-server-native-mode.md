...
##  <a name="securing-and-managing-a-resource"></a><a name="bkmk_manageresources"></a>Protegendo e gerenciando um recurso  
...
##  <a name="referencing-an-image-resource-from-a-report"></a><a name="bkmk_referenceimage"></a>Fazendo referência a um recurso de imagem de um relatório  
