...
description: Um backup parcial no SQL Server contém os dados do grupo de arquivos primário, todos os grupos de arquivos de leitura/gravação e, opcionalmente, um ou mais arquivos somente leitura.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
