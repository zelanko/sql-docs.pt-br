...
|**SONDAGEM DE CONJUNTO**|Operação de servidor que define o intervalo, em segundos, para que os servidores de destino sondem o domínio multisservidor. Se especificado, *valor* é interpretado como o valor de intervalo necessário, e pode ser um valor de **10** para **28.800**.|  
|**INICIAR**|Operação de trabalho que solicita o início da execução do trabalho.|  
|**PARAR**|Operação de trabalho que solicita a parada da execução do trabalho.|  
