...
description: Saiba como usar parâmetros em uma expressão para personalizar a aparência e os dados de relatório com base nas opções de usuário no Construtor de Relatórios.
ms.date: 03/07/2017
