...
helpviewer_keywords: 
  ...
  - "gerenciadores de conexões [Integration Services], vários arquivos"
  - "conexões [Integration Services], arquivos"
  - "conexões de vários arquivos"
...
## Tipos de uso do gerenciador de conexões de vários arquivos  
...
## Configuração do gerenciador de conexões de vários arquivos  
