...
description: Você pode usar a web part do Visualizador de Relatórios para exibir relatórios executados em um servidor do SQL Server Reporting Services configurado para integração do SharePoint.
ms.date: 11/26/2018
