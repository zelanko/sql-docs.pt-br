---
title: Visão geral da Integração CLR | Microsoft Docs
description: O Microsoft SQL Server que hospeda clr é chamado de integração CLR. A autoria em código gerenciado pode melhorar o desempenho. O SQL Server usa o CAS para ajudar a proteger o código gerenciado.
ms.custom: ''
ms.date: 04/19/2017
ms.prod: sql
ms.reviewer: ''
