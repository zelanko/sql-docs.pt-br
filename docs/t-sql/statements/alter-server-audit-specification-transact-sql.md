...
## <a name="examples"></a>Exemplos  
 O exemplo a seguir cria uma especificação de auditoria de servidor chamada `HIPPA_Audit_Specification`. Ela descarta o grupo de ação de auditoria para logons com falha e adiciona um grupo de ação de auditoria de acesso do objeto de banco de dados para um [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] auditoria denominada `HIPPA_Audit`.  
