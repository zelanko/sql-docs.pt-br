---
title: Extensões
description: Saiba mais sobre as extensões que estão prontamente disponíveis no Reporting Services e como ele usa as extensões para modularizar os tipos de entrada ou saída que aceita.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: ''
