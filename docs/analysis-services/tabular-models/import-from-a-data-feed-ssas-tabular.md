...
manager: "erikre"
---
# Importar de um feed de dados (SSAS tabular)
...
#### Para importar os dados de um conjunto de dados do Azure DataMarket  
...
#### Para importar dados de feeds de dados públicos ou corporativos  
...
#### Para importar feeds de dados de uma lista do SharePoint  
...
4.  Em URL do Feed de Dados, digite um endereço para o serviço de dados da lista, substituindo \<server-name> pelo nome real do seu servidor do SharePoint:  
...
#### Para importar dados de relatórios de um relatório publicado do Reporting Services  
