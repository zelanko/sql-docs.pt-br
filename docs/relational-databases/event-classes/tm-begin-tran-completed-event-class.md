---
title: 'TM: Classe de evento TM: Begin Tran Completed | Microsoft Docs'
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="tm-begin-tran-completed-event-class-data-columns"></a>TM: Colunas de dados de classe de evento TM: Begin Tran Completed  
