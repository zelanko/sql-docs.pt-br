...
description: A replicação de instantâneo distribui os dados conforme eles aparecem em um momento no tempo. Ela não monitora atualizações. Um instantâneo é gerado e enviado aos Assinantes.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
