...
ms.locfileid: "85015457"
---
# <a name="using-diffgrams-to-modify-data-in-sqlxml-40"></a>Usando DiffGrams para modificar dados no SQLXML 4.0
  O formato DiffGram é introduzido no componente **DataSet** do [!INCLUDE[msCoName](../../../includes/msconame-md.md)] .NET Framework. No .NET Framework, você pode criar DiffGrams e usá-los para modificar dados em tabelas de um banco de dados Microsoft [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
