...
description: Saiba como desabilitar e habilitar guias de plano usando o SQL Server Management Studio ou o Transact-SQL. Desabilite ou habilite um ou todos os guias de plano de um banco de dados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
