...
| Exibir e usar os recursos básicos do Editor de Consultas MDX. | [Criar Scripts do Analysis Services](https://docs.microsoft.com/analysis-services/instances/create-analysis-services-scripts-in-management-studio?view=asallproducts-allversions) |
| Exibir e usar os recursos básicos do Editor de Consultas DMX. | [Criar uma Consulta DMX](https://docs.microsoft.com/analysis-services/data-mining/create-a-dmx-query-in-sql-server-management-studio?view=asallproducts-allversions) |
