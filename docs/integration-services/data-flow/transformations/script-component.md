 ...
 **Gerenciador de Conexões**  
 Selecione na lista de gerenciadores de conexão disponíveis ou selecione  **\<nova conexão >** para abrir o **adicionar Gerenciador de Conexão SSIS** caixa de diálogo.  
