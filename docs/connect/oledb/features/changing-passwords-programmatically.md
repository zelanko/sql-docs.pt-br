...
description: O Driver do OLE DB para SQL Server dá suporte ao tratamento de expiração de senha programaticamente por meio de caixas de diálogo de entrada do Driver do OLE DB e do SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
