 ...
 **\@originating_server** existe no **sp_add_job,** mas não está listado em argumentos. **\@originating_server** está reservado para uso interno.  
  
 Depois que **sp_add_job** tiver sido executado para adicionar um trabalho, **sp_add_jobstep** poderá ser usado para adicionar etapas que executam as atividades do trabalho. **sp_add_jobschedule** pode ser usado para criar o agendamento que o serviço [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent usa para executar o trabalho. Use **sp_add_jobserver** para definir a instância de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] onde o trabalho é executado e **sp_delete_jobserver** para remover o trabalho da instância de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
## <a name="permissions"></a>Permissões  
 Para executar esse procedimento armazenado, os usuários devem ser membros da função de servidor fixa **sysadmin** ou receber um dos seguintes [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] funções de banco de dados fixas de agente, que residem no banco de dados **msdb** :  
