...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Você pode renomear um diagrama de banco de dados no Pesquisador de Objetos. Requer a permissão ALTER no banco de dados.  
