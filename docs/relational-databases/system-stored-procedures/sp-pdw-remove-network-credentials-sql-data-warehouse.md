...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]
  ...
  Isso remove as credenciais de rede armazenadas em [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] para acessar um compartilhamento de arquivos de rede. Por exemplo, use esse procedimento armazenado para remover a permissão para [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] executar operações de backup e restauração em um servidor que reside em sua própria rede.  
