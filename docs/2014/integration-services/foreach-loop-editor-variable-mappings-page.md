 ...
 **Tópicos relacionados**: [executar um loop por meio de arquivos e tabelas do Excel usando um contêiner Loop Foreach](control-flow/loop-through-excel-files-and-tables-by-using-a-foreach-loop-container.md)  
