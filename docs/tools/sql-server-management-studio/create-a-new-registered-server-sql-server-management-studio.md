...
helpviewer_keywords: 
  - "Servidores Registrados [SQL Server], criando novos servidores registrados"
...
---
# Criar um novo servidor registrado (SQL Server Management Studio)
...
#### Para registrar as instâncias de servidor local automaticamente  
...
#### Para criar um novo servidor registrado  
