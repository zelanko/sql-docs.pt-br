...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]A categoria de evento eventos de bloqueios tem as classes de evento descritas na tabela a seguir.  
