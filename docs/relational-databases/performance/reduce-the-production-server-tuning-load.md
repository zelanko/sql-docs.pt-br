...
description: Saiba como o Orientador de Otimização do Mecanismo de Banco de Dados usa o otimizador de consulta para analisar uma carga de trabalho e fazer recomendações de ajuste no SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
