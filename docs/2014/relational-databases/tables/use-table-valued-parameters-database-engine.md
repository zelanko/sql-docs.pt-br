...
##  <a name="table-valued-parameters-vs-bulk-insert-operations"></a><a name="BulkInsert"></a>Parâmetros com valor de tabela versus operações de BULK INSERT  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [os tipos sys. Types &#40;Transact-SQL&#41;](/sql/relational-databases/system-catalog-views/sys-types-transact-sql)   
