...
|**threshold**|**bigint**|Memória próxima do limite em bytes.  A consulta é necessária para obter um acesso a este gateway se seu consumo de memória atingir esse limite.  "-1" se a consulta não é necessário para acessar a este gateway.|
