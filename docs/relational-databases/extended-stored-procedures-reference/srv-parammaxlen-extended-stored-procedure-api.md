...
## <a name="returns"></a>Retorna  
 O comprimento máximo, em bytes, dos dados do parâmetro. Se não existir o *n*º parâmetro ou se não houver nenhum procedimento armazenado remoto, -1 será retornado.  
