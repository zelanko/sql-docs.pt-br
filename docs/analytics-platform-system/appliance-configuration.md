---
title: "Configuração de dispositivo (Analytics Platform System)"
author: barbkess
ms.author: barbkess
manager: jhubbard
...
|----------------------|---------------|  
|Familiarize-se com os nomes de componente físico|[PDW e componentes da malha física do dispositivo &#40; Analytics Platform System &#41;](pdw-and-appliance-fabric-physical-components.md)|  
...
|Iniciar e parar o utilitário do SQL Server PDW|Interrompe ou inicia o utilitário do SQL Server PDW. Para obter mais informações, consulte [PDW serviços Status &#40; Analytics Platform System &#41; ](pdw-services-status.md).|  
...
|Configurar o dispositivo para receber atualizações de software<br /><br />(Recomendado)|O dispositivo precisa ser configurado para receber atualizações para o software subjacente e o SQL Server PDW.<br /><br />Para obter mais informações, consulte [configurar o Windows Server Update Services &#40; O WSUS &#41; &#40; Analytics Platform System &#41; ](configure-windows-server-update-services-wsus.md). Para obter informações sobre o WSUS, consulte [Software manutenção &#40; Analytics Platform System &#41; ](software-servicing.md).|  
