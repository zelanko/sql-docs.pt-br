...
Para a solução de problemas de tempdb, veja [Solução de problemas de espaço em disco insuficiente em tempdb](http://docs.microsoft.com/previous-versions/sql/sql-server-2008-r2/ms176029(v=sql.105)). 
