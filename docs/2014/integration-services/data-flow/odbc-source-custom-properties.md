...
|DefaultCodePage|Integer|A página de código a ser usada para colunas de saída de cadeia de caracteres.<br /><br /> **Observação**: Essa propriedade não está disponível na **Editor de origem ODBC**, mas pode ser definida usando o **Editor Avançado**.|  
