...
|compress_snapshot|**bit**|Especifica que o instantâneo gravado no local de *alt_snapshot_folder* deve ser compactado no formato CAB [!INCLUDE[msCoName](../../includes/msconame-md.md)]. **0** especifica que o instantâneo não será compactado.|  
