...
---
# Adicionar medidores a relat&#243;rios m&#243;veis | Reporting Services
...
No [!INCLUDE[PRODUCT_NAME](../../includes/product-name.md)], todos os medidores têm pelo menos uma propriedade em comum: um valor principal, definido como um campo numérico em uma das tabelas de dados no relatório móvel.  
...
## Definir os valores de comparação e principal para um medidor
...
## Definir propriedades visuais para um medidor
...
### Definir a direção de valor: alto ou baixo é melhor
...
### Definir interrupções de intervalo para um medidor
...
### Formatar os números no medidor  
