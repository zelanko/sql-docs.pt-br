---
title: Conectando a dados de um fonte ou Driver | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
-   [Alocando o identificador de ambiente](../../../odbc/reference/develop-app/allocating-the-environment-handle.md)  
...
-   [Estabelecendo uma conexão](../../../odbc/reference/develop-app/establishing-a-connection.md)  
