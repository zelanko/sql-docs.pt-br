---
title: Parâmetros de comando (Driver do OLE DB) | Microsoft Docs
description: Saiba mais sobre parâmetros de comando, incluindo a quais tipos o Driver do OLE DB para SQL Server dá suporte em comandos de chamada de procedimento e instrução SQL.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
