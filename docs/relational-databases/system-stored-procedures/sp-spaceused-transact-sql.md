 ...
 **database_size** é sempre maior que a soma do **** + **espaço** reservado não alocado porque inclui o tamanho dos arquivos de log, mas **reservada** e **unallocated_space** considerar apenas as páginas de dados.  
