...
## <a name="returns"></a>Retorna  
 O comprimento máximo, em bytes, dos dados do parâmetro. Se não houver nenhum *n*º parâmetro ou se não houver nenhum procedimento armazenado remoto, retornará -1.  
