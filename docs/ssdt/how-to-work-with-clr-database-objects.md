...
Para saber mais sobre os requisitos de compilação de objetos de banco de dados CLR, consulte [Criar objetos de banco de dados com a integração CLR (Common Language Runtime)](http://msdn.microsoft.com/library/ms131046.aspx).  
...
[Vantagens de usar código gerenciado para criar objetos de banco de dados](http://msdn.microsoft.com/library/k2e1fb36.aspx)  
[Criando objetos de banco de dados com a integração CLR (Common Language Runtime)](http://msdn.microsoft.com/library/ms131046.aspx)  
