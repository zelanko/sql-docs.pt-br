...
```  
 ...
 ![Plano de consulta para a junção de tabelas com base em disco.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-1.gif "Plano de consulta para a junção de tabelas com base em disco.")  
...
```  
 ...
 ![Plano de consulta para uma junção hash de tabelas com base em disco.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-2.gif "Plano de consulta para uma junção hash de tabelas com base em disco.")  
...
## [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Processamento de consulta para tabelas baseadas em disco  
 ...
 ![Pipeline do processamento de consulta do SQL Server.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-3.gif "Pipeline do processamento de consulta do SQL Server.")  
...
## Acesso do [!INCLUDE[tsql](../../includes/tsql-md.md)] interpretado a tabelas com otimização de memória  
 ...
 ![Pipeline de processamento da consulta para tsql interpretado.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-4.gif "Pipeline de processamento da consulta para tsql interpretado.")  
...
```  
 ...
 ![Plano de consulta para a junção de tabelas com otimização de memória.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-5.gif "Plano de consulta para a junção de tabelas com otimização de memória.")  
...
### Processamento de compilação e consulta  
 ...
 ![Compilação original dos procedimentos armazenados.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-6.gif "Compilação original dos procedimentos armazenados.")  
...
## Junções e estatísticas de coluna  
