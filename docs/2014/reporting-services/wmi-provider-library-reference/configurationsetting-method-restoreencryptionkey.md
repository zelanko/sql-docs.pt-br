...
## <a name="remarks"></a>Remarks  
 ...
 O método é mais eficaz quando chamado depois de [DeleteEncryptionKey](configurationsetting-method-deleteencryptionkey.md) método, que limpa a lista de chaves de criptografia.  
