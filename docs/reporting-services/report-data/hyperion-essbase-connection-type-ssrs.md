---
title: Tipo de conexão Hyperion Essbase | Microsoft Docs
description: Saiba como recuperar dados multidimensionais de uma fonte de dados externa do Hyperion Essbase para incluí-los em seu relatório.
ms.date: 03/17/2017
