...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Os exemplos neste tópico consistem em DiffGrams que executam a inserção, atualização e operações de exclusão no banco de dados. Antes de usar os exemplos, observe o seguinte:  
