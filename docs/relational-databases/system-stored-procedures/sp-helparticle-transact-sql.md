...
|**partição vertical**|**bit**|Se o particionamento vertical está habilitado para o artigo; em que um valor de **1** significa que o particionamento vertical está habilitado.|  
...
|**schema_option**|**binary(8)**|Bitmap da opção de geração de esquema para o artigo determinado. Para obter uma lista completa de valores de **schema_option** , consulte [Transact &#40;-&#41;SQL sp_addarticle](../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md).|  
...
## <a name="permissions"></a>Permissões  
 Somente os membros da função de servidor fixa **sysadmin** , a função de banco de dados fixa **db_owner** ou a lista de acesso à publicação para a publicação atual podem executar **sp_helparticle**.  
