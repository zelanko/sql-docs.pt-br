...
description: Veja várias maneiras de usar o Gerenciador do Utilitário para gerenciar instâncias do SQL Server, como ajustar as definições de política e exibir a utilização da CPU e do volume de armazenamento.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
O PowerShell não tem a ajuda F1, mas inclui um cmdlet **Get-Help** que fornece informações sobre como usá-lo. Para obter mais informações sobre como usar Get-Help, veja [Get Help SQL Server PowerShell](../../powershell/sql-server-powershell.md).  
