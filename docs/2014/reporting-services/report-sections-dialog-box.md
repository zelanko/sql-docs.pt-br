...
ms.locfileid: "66104304"
---
# <a name="report-sections-dialog-box"></a>Caixa de diálogo Seções do Relatório
  Quando você abre um relatório, Report Designer verifica se o relatório contém apenas um elemento de ** \<>de seção** RDL (linguagem de definição de relatório). Não há suporte para a ** \<** abertura de um relatório com vários elementos de>de seção.  
