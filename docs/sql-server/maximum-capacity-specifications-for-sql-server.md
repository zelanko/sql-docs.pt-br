...
helpviewer_keywords: 
  - "objetos [SQL Server]"
  - "especificações de capacidade de número [SQL Server]"
  - "tamanho [SQL Server], especificações de capacidade"
  - "número de objetos"
  - "especificações de capacidade [SQL Server]"
  - "especificações de capacidade máxima [SQL Server]"
  - "tamanho [SQL Server]"
  - "especificações de capacidade de replicação [SQL Server]"
  - "objetos [SQL Server], especificações de capacidade"
  - "Mecanismo de banco de dados [SQL Server], especificações de capacidade"
...
|Referências de tabela de chave estrangeira por tabela||Saída = 253. Entrada= 10.000.|Para restrições, consulte [Create Foreign Key Relationships](../relational-databases/tables/criar-relações-de-chaves-estrangeiras.md).|  
