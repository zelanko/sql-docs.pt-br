...
helpviewer_keywords: 
  ...
  - "rastreamentos [SQL Server], SQL Server Profiler"
  - "monitoramento de banco de dados [SQL Server], SQL Server Profiler"
  - "ajustando bancos de dados [SQL Server], SQL Server Profiler"
  - "SQL Server Profiler"
  - "desempenho do servidor [SQL Server], SQL Server Profiler"
  - "Profiler [SQL Server Profiler]"
  - "rastreamento [SQL Server]"
  - "monitorando o desempenho [SQL Server], SQL Server Profiler"
  - "eventos [SQL Server], SQL Server Profiler"
  - "SQL Server Profiler, sobre o SQL Server Profiler"
  - "ferramentas [SQL Server], SQL Server Profiler"
  - "desempenho do banco de dados [SQL Server], SQL Server Profiler"
  - "trace [SQL Server]"
...
> Envie seus comentários e perguntas em nossa **[página Conectar.](https://connect.microsoft.com/SQLServer/Feedback)**
 ...
 Você pode iniciar o Profiler de várias maneiras no SSMS. [Veja um tópico que lista as maneiras de iniciar o Profiler.](https://msdn.microsoft.com/library/ms173799.aspx)
...
|**Captura de rastreamento**|Interface gráfica do usuário[Eventos Estendidos](https://msdn.microsoft.com/library/bb630282.aspx) no SQL Server Management Studio|SQL Server Profiler|  
|**Reprodução de rastreamento**|[Distributed Replay](https://msdn.microsoft.com/library/ff878183.aspx)|SQL Server Profiler|  
...
-   Correlacionar contadores de desempenho para diagnosticar problemas.  
 ...
 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] também oferece suporte à execução de auditoria das ações executadas em instâncias do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. As auditorias registram ações relacionadas à segurança para análise posterior por um administrador de segurança.  
...
|Lista os tópicos de ajuda sensível a contexto do SQL Server Profiler.|[Ajuda de F1 do SQL Server Profiler](../../tools/sql-server-profiler/ajuda-de-f1-do-sql-server-profiler.md)|  
...
## Consulte também  
 ...
 [Categoria de evento dos procedimentos armazenados](../../relational-databases/event-classes/stored-procedures-event-category.md)   
