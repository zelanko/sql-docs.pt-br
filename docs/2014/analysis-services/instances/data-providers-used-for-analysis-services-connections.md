...
# <a name="data-providers-used-for-analysis-services-connections"></a>Provedores de dados usados para conexões do Analysis Services
 ...
 [Como determinar a versão do Analysis Services provedores de dados](#bkmk_LibUpdate)  
  
 [Onde obter provedores de dados de versão mais recentes](#bkmk_downloadsite)  
...
##  <a name="bkmk_LibUpdate"></a>Como determinar a versão do Analysis Services provedores de dados  
...
##  <a name="bkmk_downloadsite"></a>Onde obter provedores de dados de versão mais recentes  
...
##  <a name="bkmk_OLE"></a>Provedor Analysis Services OLE DB  
