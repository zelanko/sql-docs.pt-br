...
O exemplo a seguir está importando um certificado de SSL do Azure no formato PKCS12 com BouncyCastle provedor. O certificado é importado no diretório de trabalho chamado _MyTrustStore\_PKCS12_ usando o trecho a seguir:
