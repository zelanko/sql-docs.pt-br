...
ms.openlocfilehash: 9e1a855ab7a2d8fffed3de8fc531c5ad118d61f2
...
Use essa página para exibir ou alterar os principais que podem usar uma conta proxy do [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] Agent em etapas de trabalho.  
