...
helpviewer_keywords: 
  ...
  - "tempo de execução [Integration Services]"
  - "pacotes do SQL Server Integration Services, eventos"
  - "manipuladores de eventos [Integration Services], sobre manipuladores de eventos"
  - "eventos [Integration Services]"
  - "pacotes [Integration Services], eventos"
  - "manipuladores de eventos [Integration Services]"
  - "pacotes do SSIS, eventos"
  - "contêineres [Integration Services], eventos"
  - "eventos [Integration Services], sobre eventos"
...
## Configuração de um manipulador de eventos  
 ...
 Para obter informações sobre como definir essas propriedades no [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)], consulte [Definir as propriedades de uma tarefa ou de um contêiner](../Topic/Set%20the%20Properties%20of%20a%20Task%20or%20Container.md).  
...
## Tarefas relacionadas  
 Para obter informações sobre como adicionar um manipulador de eventos a um pacote, consulte [Adicionar um manipulador de eventos a um pacote](../Topic/Add%20an%20Event%20Handler%20to%20a%20Package.md).  
