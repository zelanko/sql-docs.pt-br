...
# [Início Rápido 1: tecnologias do OLTP in-memory para um desempenho mais rápido do Transact-SQL](survey-of-initial-areas-in-in-memory-oltp.md)  
...
## [Melhores práticas para chamar procedimentos armazenados compilados nativamente](best-practices-for-calling-natively-compiled-stored-procedures.md)  
...
## [Suporte do SQL Server Management Objects para OLTP in-memory](sql-server-management-objects-support-for-in-memory-oltp.md)  
## [Suporte do SQL Server Integration Services para OLTP in-memory](sql-server-integration-services-support-for-in-memory-oltp.md)  
## [Suporte do SQL Server Management Studio para OLTP in-memory](sql-server-management-studio-support-for-in-memory-oltp.md)  
...
### [Simulando uma instrução IF-WHILE EXISTS em um módulo compilado nativamente](simulating-an-if-while-exists-statement-in-a-natively-compiled-module.md)  
### [Implementando a funcionalidade MERGE em um procedimento armazenado compilado nativamente](implementing-merge-functionality-in-a-natively-compiled-stored-procedure.md)  
