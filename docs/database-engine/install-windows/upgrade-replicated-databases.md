...
## <a name="see-also"></a>Consulte Também  
 ...
 [Atualizando uma topologia de replicação para o SQL Server 2016](/archive/blogs/sql_server_team/upgrading-a-replication-topology-to-sql-server-2016)