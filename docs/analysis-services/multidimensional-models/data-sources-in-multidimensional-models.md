...
helpviewer_keywords: 
  ...
  - "Objetos do Analysis Services, fontes de dados"
  - "armazenando dados [Analysis Services], fontes de dados"
  - "fontes de dados [Analysis Services], sobre as fontes de dados"
  - "segurança [Analysis Services ], fontes de dados"
  - "fontes de dados [Analysis Services]"
  - "armazenamento [Analysis Services], fontes de dados"
...
## Consulte também  
 ...
 [Arquitetura lógica &#40;Analysis Services – Dados Multidimensionais&#41;](../Topic/Logical%20Architecture%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
