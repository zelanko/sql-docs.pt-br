...
|**crypt_type**|**char(4)**|Tipo de criptografia.<br /><br /> SPVC = assinada pela chave privada do certificado<br /><br /> SPVA = assinada pela chave privada assimétrica<br /><br /> CPVC = Assinatura do contador pela chave privada de certificado<br /><br /> CPVA = Assinatura do contador pela chave assimétrica|  
