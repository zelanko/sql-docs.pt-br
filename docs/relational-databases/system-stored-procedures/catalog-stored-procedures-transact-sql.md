---
description: procedimentos armazenados do catálogo (Transact-SQL)
title: Procedimentos armazenados de catálogo (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88419340"
---
# <a name="catalog-stored-procedures-transact-sql"></a>procedimentos armazenados do catálogo (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] oferece suporte aos procedimentos armazenados do sistema a seguir que implementam funções de dicionário de dados ODBC e isolam os aplicativos ODBC para não serem alterados em tabelas subjacentes do sistema.  
