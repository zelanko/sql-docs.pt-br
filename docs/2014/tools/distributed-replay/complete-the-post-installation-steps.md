...
1.  **Criar regras de firewall**: No controlador e os computadores cliente, você deve permitir o tráfego de entrada por meio do firewall para o serviço correspondente. Especifique as regras de firewall para os executáveis de serviço, localizados nas pastas de instalação.  
...
2.  **Conceder permissões no servidor de destino de cada cliente**: Depois de concluir a instalação do serviço de cliente nos computadores cliente, adicione manualmente as contas de serviço do cliente à função sysadmin na instância de destino de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
