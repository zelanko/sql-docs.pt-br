...
manager: "erikre"
---
# Instalar os recursos do Business Intelligence do SQL Server 2016
...
> [!NOTE] SQL Server Data Tools (SSDT) não está incluso com o SQL Server 2016. [Baixar o SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714).
  
## Consulte também  
 [Novidades no Reporting Services &#40;SSRS&#41;](http://msdn.microsoft.com/pt-br/bc909063-6b84-4b3a-80d2-e93fc04b4b9d)   
 [Novidades do Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md)   
 [Novidades do Integration Services](../Topic/What's%20New%20in%20Integration%20Services.md)   
