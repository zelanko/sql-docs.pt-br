...
# <a name="http-connection-manager"></a>Gerenciador de conexões HTTP
 ...
 O `ConnectionManagerType` propriedade do Gerenciador de conexão está definida como `HTTP.`  
...
-   [Editor do Gerenciador de Conexão HTTP &#40;página de servidor&#41;](../http-connection-manager-editor-server-page.md)  
  
-   [Editor do Gerenciador de Conexão HTTP &#40;página Proxy&#41;](../http-connection-manager-editor-proxy-page.md)  
