...
|**process_physical_affinity**|**nvarchar(3072)** |**Aplica-se a:** começando com [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)].<br /><br />Informações ainda no futuro. |
