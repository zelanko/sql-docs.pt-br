...
##  <a name="validating-lsn-boundaries"></a><a name="LSN"></a> Validando limites de LSN  
...
##  <a name="query-function-scenarios"></a><a name="Scenarios"></a> Cenários de funções de consulta  
