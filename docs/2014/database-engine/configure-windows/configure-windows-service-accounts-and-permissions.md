...
-   [Propriedades e configuração do serviço](#Serv_Prop)  
    ...
    -   [Contas de serviço padrão](#Default_Accts)  
        ...
        -   [Alterando as propriedades da conta](#Changing_Accounts)  
...
-   [Permissões de serviço](#Serv_Perm)  
    ...
    -   [Permissões do sistema de arquivos concedidas a SIDs por serviço do SQL Server ou a grupos locais do Windows](#Reviewing_ACLs)  
...
-   [Atualizando a partir de versões anteriores](#Upgrade)  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Gravador VSS|[LOCAL SYSTEM](#Local_System)|[LOCAL SYSTEM](#Local_System)|  
...
####  <a name="changing-account-properties"></a><a name="Changing_Accounts"></a>Alterando propriedades da conta  
...
-   <a name="VA_Desc"></a> **Virtual Accounts**  
    ...
    |[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Serviço do Agent em uma instância [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] do nome da **folha de pagamento**|**NT SERVICE\SQLAGENT$PAYROLL**|  
...
###  <a name="windows-privileges-and-rights"></a><a name="Windows"></a>Direitos e privilégios do Windows  
...
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Controlador de Distributed Replay:**|**Fazer logon como um serviço** (SeServiceLogonRight)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Distributed Replay cliente:**|**Fazer logon como um serviço** (SeServiceLogonRight)|  
...
###  <a name="file-system-permissions-granted-to-sql-server-per-service-sids-or-local-windows-groups"></a><a name="Reviewing_ACLs"></a>Permissões do sistema de arquivos concedidas a SQL Server SIDs por serviço ou grupos locais do Windows  
...
||Conta do serviço Servidor de Relatório do Windows|instalar>\Reporting Services\ReportServer * \< *|Ler|  
||Conta do serviço Servidor de Relatório do Windows|instalar>\Reporting Services\ReportServer\global.asax * \< *|Completo|  
...
###  <a name="registry-permissions"></a><a name="Registry"></a> Permissões de Registro  
 O hive do registro é criado em **HKLM\Software\Microsoft\Microsoft\\ SQL Server** _<Instance_ID>_ para componentes com reconhecimento de instância. Por exemplo  
...
###  <a name="wmi"></a><a name="WMI"></a>ESSES  
...
###  <a name="database-engine-provisioning"></a><a name="DE_Prov"></a>Provisionamento de Mecanismo de Banco de Dados  
...
####  <a name="sql-server-per-service-sid-login-and-privileges"></a><a name="Logins"></a>SQL Serverndo logon e privilégios de SID por serviço  
...
####  <a name="sql-server-agent-login-and-privileges"></a><a name="Agent"></a>SQL Server Agent logon e privilégios  
...
###  <a name="ssas-provisioning"></a><a name="SSAS"></a>Provisionamento do SSAS  
...
##  <a name="upgrading-from-previous-versions"></a><a name="Upgrade"></a>Atualizando de versões anteriores  
...
##  <a name="appendix"></a><a name="Appendix"></a>Anexo  
...
|--------------|----------------------------|------------------------------|---------------------------|--------------------------|  
|Inglês<br /><br /> Chinês simplificado<br /><br /> Chinês tradicional<br /><br /> Coreano<br /><br /> Japonês|NT AUTHORITY\LOCAL SERVICE|NT AUTHORITY\NETWORK SERVICE|NT AUTHORITY\SYSTEM|BUILTIN\Administrators|  
|Alemão|NT-AUTORITÄT\LOKALER DIENST|NT-AUTORITÄT\NETZWERKDIENST|NT-AUTORITÄT\SYSTEM|VORDEFINIERT\Administratoren|  
|Francês|AUTORITE NT\SERVICE LOCAL|AUTORITE NT\SERVICE RÉSEAU|AUTORITE NT\SYSTEM|BUILTIN\Administrators|  
