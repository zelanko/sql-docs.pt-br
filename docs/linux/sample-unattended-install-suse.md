...
description: Use um script Bash de exemplo para instalar o SQL Server 2017 no SLES (SUSE Linux Enterprise Server) v12 SP2 sem entrada interativa.
author: VanMSFT
ms.author: vanto
ms.date: 11/04/2019
ms.topic: conceptual
