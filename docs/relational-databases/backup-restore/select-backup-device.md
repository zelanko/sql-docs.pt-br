...
description: Para a restauração do SQL Server, use a caixa de diálogo Selecionar Dispositivo de Backup para selecionar um dispositivo de backup lógico para a operação de restauração.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
