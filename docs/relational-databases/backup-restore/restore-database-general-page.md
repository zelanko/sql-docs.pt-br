...
> [!NOTE]  
>  Ao especificar uma tarefa de restauração usando [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], é possível gerar o script [!INCLUDE[tsql](../../includes/tsql-md.md)] [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) correspondente clicando em **Script** e selecionando um destino para o script.  
...
## Restaurando a partir de um backup criptografado  
...
## Restaurando por meio do Armazenamento do Microsoft Azure  
