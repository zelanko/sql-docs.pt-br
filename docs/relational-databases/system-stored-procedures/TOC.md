# [Visão geral](system-stored-procedures-transact-sql.md)  
...
## [Filestream e FileTable – sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
...
## [sp_execute_remote (Banco de Dados SQL do Azure)](sp-execute-remote-azure-sql-database.md)  
...
# [Plano de manutenção do banco de dados](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [Consultas distribuídas](distributed-queries-stored-procedures-transact-sql.md)  
...
# [Regras de firewall (Banco de dados SQL do Azure)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (Banco de Dados SQL do Azure)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (Banco de Dados SQL do Azure)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (Banco de Dados SQL do Azure)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (Banco de Dados SQL do Azure)](sp-delete-database-firewall-rule-azure-sql-database.md)  
...
# [Stretch Database estendido](stretch-database-extended-stored-procedures-transact-sql.md)  
