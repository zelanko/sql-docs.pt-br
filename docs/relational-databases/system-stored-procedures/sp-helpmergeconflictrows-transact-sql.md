...
## <a name="see-also"></a>Consulte Também  
 [Exibir informações de conflito para publicações de mesclagem &#40;Programação Transact-SQL de replicação&#41;](../replication/view-and-resolve-data-conflicts-for-merge-publications.md)   
