...
## <a name="permissions"></a>Permissões  
 Somente os membros da função de servidor fixa **sysadmin** , da função de banco de dados fixa **db_owner** ou do criador da assinatura podem executar **sp_changesubstatus**.  
