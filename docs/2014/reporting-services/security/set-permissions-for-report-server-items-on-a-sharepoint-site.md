...
## <a name="see-also"></a>Consulte também  
 ...
 [Referência de permissão de lista de itens do servidor de relatório e sites do SharePoint](sharepoint-site-and-list-permission-reference-for-report-server-items.md)   
