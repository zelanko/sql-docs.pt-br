---
title: Considerações sobre segurança (replicação compacta)
description: Descreve algumas considerações sobre segurança da replicação compacta do SQL Server.
