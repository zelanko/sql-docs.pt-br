...
ms.locfileid: "37245826"
---
# <a name="connect-to-existing-secondary-replicas-page-add-replica-wizard-and-add-databases-wizard"></a>Conectar-se à página réplicas secundárias existentes (Assistente para adicionar réplica e adicionar Assistente de bancos de dados)
