---
description: Exibir informações sobre um operador
...
Para obter mais informações, consulte [sp_help_operator (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-help-operator-transact-sql.md).  
