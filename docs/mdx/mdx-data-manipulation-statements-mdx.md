...
|Tópico|Description|  
|-----------|-----------------|  
|[Instrução CALL &#40;MDX&#41;](../mdx/mdx-data-manipulation-call.md)|Executa um procedimento armazenado que retorna um nulo no escopo atual ou opcionalmente em um cubo especificado.|  
