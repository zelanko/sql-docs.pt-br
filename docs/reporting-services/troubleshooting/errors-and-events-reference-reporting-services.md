...
|[107](../../reporting-services/troubleshooting/report-server-windows-service-mssqlserver-107.md)|Erro|Inicialização/desligamento|Servidor de relatório<br /><br /> Processador de agendamento e entrega|*\<Fonte >* não pode se conectar ao banco de dados de servidor de relatório. Para obter mais informações, consulte [Serviço Windows do Servidor de Relatório &#40;MSSQLServer&#41; 107](../../reporting-services/troubleshooting/report-server-windows-service-mssqlserver-107.md).|  
|108|Erro|Extensão|Servidor de relatório<br /><br /> Gerenciador de Relatórios|*\<Fonte >* não é possível carregar uma entrega, processamento de dados ou extensão de renderização.<br /><br /> Provavelmente, esse é o resultado de uma implantação incompleta ou remoção de uma extensão. Para obter mais informações, consulte [Implantando uma extensão de processamento de dados](../../reporting-services/extensions/data-processing/deploying-a-data-processing-extension.md) e [Implantando uma extensão de entrega](../../reporting-services/extensions/delivery-extension/deploying-a-delivery-extension.md).|  
...
|111|Erro|Log|Servidor de relatório<br /><br /> Gerenciador de Relatórios|*\<Fonte >* não é possível criar o log de rastreamento. Para obter mais informações, consulte [Report Server Service Trace Log](../../reporting-services/report-server/report-server-service-trace-log.md).|  
