 ...
 **Para obter mais informações:** [mineração estruturas &#40; Analysis Services – mineração de dados &#41;](../analysis-services/data-mining/mining-structures-analysis-services-data-mining.md)  
...
-   Remover completamente um modelo de mineração de um banco de dados usando o [DROP MINING MODEL](../dmx/drop-mining-model-dmx.md) instrução. Remover completamente uma estrutura de mineração e todos os seus modelos de mineração associados do banco de dados usando o [DROP MINING STRUCTURE](../dmx/drop-mining-structure-dmx.md) instrução.  
 ...
 Para saber mais sobre as tarefas de mineração de dados que você pode executar usando instruções DMX, consulte [extensões de mineração de dados &#40; DMX &#41; Referência de instrução](../dmx/data-mining-extensions-dmx-statements.md).  
