...
|[Suporte de alta disponibilidade para bancos de dados OLTP in-memory](high-availability-support-for-in-memory-oltp-databases.md)|Discute grupos de disponibilidade e clustering de failover no [!INCLUDE[hek_2](../../../includes/hek-2-md.md)].|
