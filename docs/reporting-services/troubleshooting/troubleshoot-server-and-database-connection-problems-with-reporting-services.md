---
title: "Solucionar problemas de conex&#227;o de banco de dados e servidor com o Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "02/28/2016"
...
---
# Solucionar problemas de conex&#227;o de banco de dados e servidor com o Reporting Services
...
Não é possível se conectar ao \<nome do servidor>. O provedor WMI do Reporting Services não está instalado ou está instalado incorretamente (Microsoft.SqlServer.Management.UI.RSClient).  
...
## O servidor de relatório não pode abrir uma conexão com o banco de dados do servidor de relatório. (rsReportServerDatabaseUnavailable).  
