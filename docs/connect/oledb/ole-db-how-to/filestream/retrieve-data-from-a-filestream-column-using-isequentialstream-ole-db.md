...
description: Saiba como usar uma interface ISequentialStream em uma interface ICommandText para recuperar um registro de uma coluna Filestream no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../../includes/driver_oledb_download.md)]
 ...
 Para obter mais informações sobre o recurso de fluxo de arquivos, confira [Suporte ao FILESTREAM](../../../oledb/features/filestream-support.md).  
...
-   [Enviar dados para uma coluna FILESTREAM usando ISequentialStream associado ao parâmetro ICommandText &#40;OLE DB&#41;](../../../oledb/ole-db-how-to/filestream/send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [Enviar dados para uma coluna FILESTREAM usando IRowsetFastUpload &#40;OLE DB&#41;](../../../oledb/ole-db-how-to/filestream/send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Copie a terceira listagem de código e cole em um arquivo denominado ICommandDownload.cpp.  
  
 Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.  
