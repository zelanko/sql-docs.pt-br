...
description: Saiba como mover dados entre os quadros de dados na memória, o contexto do SQL Server e os arquivos locais usando o rxDataStep.
ms.prod: sql
...
> [Executar análise de agrupamento usando rxDataStep](../../machine-learning/tutorials/deepdive-perform-chunking-analysis-using-rxdatastep.md)