...
helpviewer_keywords: 
  - "segurança [SQL Server], negando acesso"
  - "hierarquias [SQL Server], permissões"
  - "protegíveis [SQL Server]"
  - "segurança [SQL Server], permissões"
  - "permissões [SQL Server], hierarquia"
  - "segurança [SQL Server], concedendo acesso"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![Diagrama de hierarquias de permissões de Mecanismo de Banco de Dados](../../relational-databases/security/media/wj-security-layers.gif "Diagrama de hierarquias de permissões de Mecanismo de Banco de Dados")  
