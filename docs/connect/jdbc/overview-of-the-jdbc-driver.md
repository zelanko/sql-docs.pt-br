...
ms.locfileid: "42784849"
---
# <a name="overview-of-the-jdbc-driver"></a>Visão geral do JDBC Driver
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  O Microsoft JDBC Driver 4 (visualização) para o SQL Server é um driver compatível com tipo 4de  conectividade do banco de dados java (JDBC) 2017 que fornece acesso eficiente a dados para o SQL Server 2016 (visualização), SQL Server 2014, SQL Server 2012, SQL Server 2008 R2, SQL Server 2008 e Banco de Dados SQL do Azure.  
