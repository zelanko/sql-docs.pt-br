...
> [!TIP]
> Se você acidentalmente usa NORECOVERY mas não tem backups de arquivos de log adicionais, execute o comando `RESTORE DATABASE demodb` sem parâmetros adicionais. Isso irá concluir a restauração e deixar o banco de dados operacional.
