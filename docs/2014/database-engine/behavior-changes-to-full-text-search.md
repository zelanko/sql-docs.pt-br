...
|**Termo**|**Resultados com separador de palavras anterior e lematizador**|**Resultados com novo separador de palavras e lematizadores**|  
|--------------|--------------------------------------------------------|---------------------------------------------------|  
...
|**Termo**|**Resultados com separador de palavras anterior e lematizador**|**Resultados com novo separador de palavras e lematizadores**|  
|--------------|--------------------------------------------------------|---------------------------------------------------|  
|jěˊÿqℭžl<br /><br /> *(onde os termos não são caracteres válidos em inglês)*|‘jěˊÿｑℭžl’|je yq zl|  
...
-   Armazenamento e gerenciamento integrados — agora, pesquisa de texto completo está integrada diretamente com os recursos de armazenamento e gerenciamento inerentes de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], e o serviço MSFTESQL não existe mais.  
