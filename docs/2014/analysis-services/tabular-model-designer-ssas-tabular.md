...
##  <a name="project-templates"></a>Modelos de projeto de <a name="bkmk_proj_temp"></a>  
...
##  <a name="windows-and-menus"></a><a name="bkmk_wind_men"></a> Janelas e menus  
...
##  <a name="visual-studio-integration"></a>Integração com <a name="bkmk_vsint"></a> Visual Studio  
