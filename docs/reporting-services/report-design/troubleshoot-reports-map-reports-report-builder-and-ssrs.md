...
---
# Solu&#231;&#227;o de problemas de relat&#243;rios: relat&#243;rios de mapa (Construtor de Relat&#243;rios e SSRS)
...
## Como eu reduzo o tamanho da definição de relatório?  
...
## Na superfície de design, eu vejo dados espaciais de exemplo  
...
## Quando eu defino um deslocamento para um elemento do mapa individual, um cluster de elementos do mapa é movido  
...
## Minha camada que usa dados espaciais de um Arquivo de Forma ESRI sempre tem dados inseridos.  
...
## Eu renomeei uma fonte de dados ou um conjunto de dados com um nome amigável e agora nenhum dado aparece no meu mapa.  
...
## Meus dados espaciais contêm cadeias de caracteres nulas e vazias.  
...
## Meu mapa excede o número máximo de elementos espaciais  
...
## Eu não posso centralizar e exibir em um elemento de mapa inserido.  
...
## Eu defini o centro e a exibição do mapa em meu relatório. Quando reabro o relatório, por que a exibição do mapa não é igual?  
...
## O centro e a exibição de uma opção de camada do mapa não funcionam.  
...
## Não vejo uma ou mais camadas no meu mapa.  
...
## Eu defini um filtro na camada do mapa e ele não tem nenhum efeito.  
...
## Como eu controlo os valores na legenda do mapa?  
...
## As regras que eu defini não dão os resultados esperados.  
...
## O que é o valor NaN na escala de cores?  
...
## Minha escala de cores não aparece quando eu executo o relatório.  
...
## Eu não consigo visualizar o plano de fundo de mapas do Bing lado a lado.  
...
## Como eu controlo o texto em uma camada de peças?  
...
## Eu recebo um erro de expressão sobre o escopo do conjunto de dados quando defino um rótulo ou Dica de Ferramenta como uma expressão.  
...
## Consulte também  
 ...
 [Solução de problemas do Construtor de Relatórios](http://msdn.microsoft.com/pt-br/3806fc48-56f8-44d1-a3c1-df8c33cce0a3)  
