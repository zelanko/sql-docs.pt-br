...
|**tipo**|**nvarchar (60)**|Tipo de objeto de memória.<br /><br /> Isso indica algum componente à qual pertence este objeto de memória ou a função do objeto de memória. Permite valor nulo.|  
...
## <a name="see-also"></a>Consulte também  
 ...
 [sys.DM os_memory_clerks &#40; Transact-SQL &#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-memory-clerks-transact-sql.md)  
