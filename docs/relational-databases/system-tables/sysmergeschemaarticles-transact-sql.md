...
|**type**|**tinyint**|Indica o tipo de artigo somente esquema que pode ser um dos seguintes:<br /><br /> **0x20** = o artigo de somente esquema de procedimento armazenado.<br /><br /> **0x40** = artigo somente esquema de exibição ou artigo somente esquema de exibição indexada.|  
