...
description: Tutorial explicativo sobre como executar o script R personalizado no SQL Server usando as funções do RevoScaleR.
ms.prod: sql
...
ms.locfileid: "73726550"
---
# <a name="run-custom-r-functions-on-sql-server-using-rxexec"></a>Executar funções do R personalizadas no SQL Server usando a rxExec
