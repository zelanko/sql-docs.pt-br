...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Este exemplo ilustra como dados na coluna de estouro são resolvidos usando a diretiva **XMLTEXT** em uma instrução `SELECT` usando o modo EXPLICIT.  
