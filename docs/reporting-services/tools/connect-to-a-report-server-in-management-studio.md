...
helpviewer_keywords: 
  ...
  - "registrando servidores de relatório"
  - "servidores de relatório [Reporting Services], registrando"
...
### Para conectar-se a um servidor de relatório no modo nativo  
...
3.  Na caixa de diálogo **Conectar-se ao Servidor**, digite o nome da instância do servidor de relatório. Os nomes das instâncias do servidor de relatório baseiam-se nos nomes das instâncias do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . Por padrão, o nome da instância de um servidor de relatório local é apenas o nome do computador. Se você tiver instalado o servidor de relatório como uma instância nomeada, use essa sintaxe para especificar o servidor: *\<nomedoservidor>[\\<nomedainstância\>]*.  
...
### Para conectar-se a um servidor de relatório no modo integrado do SharePoint   
...
### Para registrar um servidor de relatório  
...
## Sintaxe de conexão e permissões  
...
|----------------|-----------|-----------------|  
|Servidor de relatório de modo nativo, conectado como o padrão ou instância nomeada:<br /><br /> \<nome do servidor><nome da instância><br /><br /> A conexão com o servidor de relatório é feita pelo provedor WMI do servidor de relatório.|Exibir e definir propriedades e padrões do servidor.<br /><br /> Exibir e cancelar trabalhos.<br /><br /> Criar e gerenciar agendas compartilhadas.<br /><br /> Criar, modificar ou excluir definições de funções.|Atribuído à função Administrador do Sistema.|  
