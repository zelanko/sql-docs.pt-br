...
## <a name="remarks"></a>Remarks  
 Para **Backup** comandos, o **local** elemento fornece informações sobre como criar um arquivo de backup remoto para uma instância remota do Analysis Services.  
