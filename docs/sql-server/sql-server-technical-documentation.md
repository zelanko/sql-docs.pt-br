...
|---------|---------|
|[Novidades no SQL Server 2019](../sql-server/what-s-new-in-sql-server-ver15.md)     | [Notas de versão do SQL Server 2019](../sql-server/sql-server-ver15-release-notes.md)        |
