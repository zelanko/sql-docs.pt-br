---
title: Recursos de pesquisa de texto completo no SQL Server 2014 descontinuados | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="see-also"></a>Consulte também  
 [Alterações significativas para pesquisa de texto completo](breaking-changes-to-full-text-search.md)   
