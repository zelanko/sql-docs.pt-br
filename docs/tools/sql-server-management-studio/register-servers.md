...
helpviewer_keywords: 
  - "conexões [SQL Server], servidores registrados"
  - "registrando servidores "
  - "servidores [SQL Server], registrando"
  - "gerenciamento de servidor [SQL Server], registrando servidores"
...
## Benefícios dos Servidores Registrados  
