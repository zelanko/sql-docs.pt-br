---
description: Dados JSON no SQL Server
title: Trabalhar com os dados JSON
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: quickstart
...
![Visão geral do suporte interno ao JSON](../../relational-databases/json/media/jsonslides1overview.png "Visão geral do suporte interno ao JSON")  
...
Para obter o banco de dados de exemplo AdventureWorks, baixe pelo menos o arquivo de banco de dados e o arquivo de exemplos e scripts do [GitHub](https://github.com/microsoft/sql-server-samples/releases/tag/adventureworks).
