---
title: ISSAsynchStatus::GetStatus (Driver do OLE DB) | Microsoft Docs
description: Saiba como o método ISSAsynchStatus::GetStatus retorna o status de uma operação de execução assíncrona no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
