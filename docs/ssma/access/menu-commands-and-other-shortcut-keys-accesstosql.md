...
ms.author: Shamikg
manager: craigg
ms.openlocfilehash: 51c567d2e9d025c06376004eed92f33a8053ae17
...
|Exiba a caixa de diálogo Assistente para localizar bancos de dados.|ALT + F E T|  
|Exibir a converter, carregar e migrar a caixa de diálogo do assistente.|ALT + T + V|  
|Vincular tabelas ou vincular a uma tabela.|ALT + T + L|  
...
|PARA FAZER ISSO|PRESSIONE|  
|--------------|---------|  
|Exibir sobre SSMA para a caixa de diálogo de acesso.|ALT + H + A|  
