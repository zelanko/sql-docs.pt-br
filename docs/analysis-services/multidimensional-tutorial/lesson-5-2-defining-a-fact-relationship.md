...
2.  Clique no botão Procurar ( **...** ) na **descrição do Item** célula na interseção da **vendas pela Internet** grupo de medidas e o **Internet Sales Order Details** de dimensões, como Examine as propriedades de relação de fatos.  
    ...
    ![Caixa de diálogo Definir relação](../media/l5-factrelationship-2.gif "caixa de diálogo Definir relação")  
...
5.  Adicione a hierarquia definida pelo usuário **Pedidos de Vendas pela Internet** da dimensão **Detalhes do Pedido de Vendas pela Internet** à área de linhas do painel de dados.  
    ...
    ![Dimensionamento de Internet Sales-Sales Amount](../media/l5-factrelationship-3.gif "dimensionamento do volume de vendas pela Internet")  
...
[Definir uma relação de fatos e as propriedades da relação fatos](../multidimensional-models/define-a-fact-relationship-and-fact-relationship-properties.md)  
