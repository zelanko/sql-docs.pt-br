---
title: Configuração avançada de serviços de aprendizado de máquina do SQL Server | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "31203088"
---
# <a name="advanced-configuration-options-for-sql-server-machine-learning-services"></a>Opções de configuração avançadas para serviços de aprendizado de máquina do SQL Server
