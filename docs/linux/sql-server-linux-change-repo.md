...
::: zone pivot="ld2-rhel"
Este artigo descreve como configurar o repositório correto para atualizações e instalações do SQL Server 2017 e 2019 do SQL Server no Linux. Na parte superior, é sua seleção atual **tinha RHEL (Red)**.
::: zone-end
