...
## <a name="see-also"></a>Consulte também  
 ...
 [Estender um conjunto de dados usando a transformação mesclar junção](../../../integration-services/data-flow/transformations/extend-a-dataset-by-using-the-merge-join-transformation.md)   
