...
## <a name="arguments"></a>Argumentos  
 ...
 O [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ID de trabalho do agente de trabalho de alerta de envio de logs.  
