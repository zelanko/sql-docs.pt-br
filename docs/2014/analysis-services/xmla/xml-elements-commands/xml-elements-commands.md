...
|[Elemento Create](create-element-xmla.md)|Contém elementos do Analysis Services Scripting Language (ASSL) usados pelos [Execute](../xml-elements-methods-execute.md) método para criar objetos em uma instância do Analysis Services.|  
...
|[Elemento Statement](statement-element-xmla.md)|Contém uma consulta ou instrução a ser enviada usando o [Execute](../xml-elements-methods-execute.md) método a uma instância do Analysis Services.|  
