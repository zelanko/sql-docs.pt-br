---
title: Comandos de menu e outras teclas de atalho (Oracletosql) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|Exibir o conectar-se ou reconectar-se a caixa de diálogo do Oracle.|ALT + F + T|  
...
## <a name="edit-menu-commands"></a>Comandos do menu Editar  
...
|Exibição adicionar tabelas ao backup para a caixa de diálogo do Oracle.|ALT + S + B + B|  
...
|PARA FAZER ISSO|PRESSIONE|  
|--------------|---------|  
|Exibir sobre SSMA para caixa de diálogo do Oracle.|ALT + H + A|  
...
[Teclas de atalho do&#40;Oracle para SQL&#41;](../../ssma/oracle/shortcut-keys-oracle-to-sql.md)  
