 ...
 *objeto*  
 Um **ServerSettings** que representa as configurações do servidor em uma instância do objeto [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
