---
title: "Refer&#234;ncia de par&#226;metro de acesso de URL | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "09/09/2015"
...
ms.topic: "article"
helpviewer_keywords: 
  - "relatórios [Reporting Services], opções de exibição"
  - "Acesso à URL [Reporting Services], parâmetros de exibição de relatório"
...
-   *Formato*:  
    ...
    -   **XML**  
     ...
     Para obter uma lista completa, consulte a seção referente à extensão **\<Render>** do arquivo rsreportserver.config do servidor de relatório.  Para obter informações sobre onde encontrar o arquivo, consulte [Arquivo de configuração RsReportServer.config](../reporting-services/report-server/rsreportserver-config-configuration-file.md).  
