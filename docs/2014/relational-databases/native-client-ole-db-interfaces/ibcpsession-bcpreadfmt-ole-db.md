...
## <a name="remarks"></a>Comentários  
 ...
 Depois que o método **BCPReadFmt** ler os valores de formato, fará as chamadas apropriadas aos métodos [IBCPSession::BCPColumns](ibcpsession-bcpcolumns-ole-db.md) e [IBCPSession::BCPColFmt](ibcpsession-bcpcolfmt-ole-db.md) . Não há necessidade de o usuário analisar um arquivo de formato e fazer essas chamadas.  
