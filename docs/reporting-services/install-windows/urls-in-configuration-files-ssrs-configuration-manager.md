...
ms.topic: "article"
helpviewer_keywords: 
  - "configuração de URL [Reporting Services]"
...
#### URLs conectando o [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] e Web Parts ao serviço Web Servidor de Relatórios  
