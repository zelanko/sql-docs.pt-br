...
|**is_encrypted**|**bit**|Indica se o banco de dados está criptografado (reflete o último estado definido usando a cláusula ALTER DATABASE SET ENCRYPTION). Pode ser um dos seguintes valores:<br /> 1 = Criptografado<br /> 0 = Não criptografado<br /> Para obter mais informações sobre a criptografia do banco de dados, confira [Transparent Data Encryption &#40;TDE&#41;](../../relational-databases/security/encryption/transparent-data-encryption.md).<br /> Se o banco de dados está no processo de ser descriptografado, **is_encrypted** mostra um valor de 0. Você pode ver o estado do processo de criptografia usando o [sys.DM database_encryption_keys](../../relational-databases/system-dynamic-management-views/sys-dm-database-encryption-keys-transact-sql.md) exibição de gerenciamento dinâmico.|  
