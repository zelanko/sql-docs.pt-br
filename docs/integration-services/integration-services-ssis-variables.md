...
helpviewer_keywords: 
  ...
  - "variáveis definidas pelo usuário [Integration Services]"
  - "escopo [Integration Services]"
  - "variáveis do sistema [Integration Services]"
  - "variáveis [Integration Services]"
  - "variáveis [Integration Services], sobre variáveis"
  - "valores [Integration Services]"
...
-   Especifique o valor e o tipo de dados da variável.  
 ...
 Para obter mais informações sobre situações reais de uso de variáveis, consulte [Usar variáveis em pacotes](../Topic/Use%20Variables%20in%20Packages.md).  
...
## Configurando variáveis  
 ...
 Para obter mais informações sobre as propriedades que podem ser definidas no Designer do [!INCLUDE[ssIS](../includes/ssis-md.md)], consulte [Janela de Variáveis](../integration-services/variables-window.md).  
...
## Tarefas relacionadas  
 ...
 [Definir as propriedades de uma variável definida pelo usuário](../Topic/Set%20the%20Properties%20of%20a%20User-Defined%20Variable.md)  
  
 [Usar os valores de variáveis e parâmetros em um pacote filho](../integration-services/packages/use-the-values-of-variables-and-parameters-in-a-child-package.md)  
