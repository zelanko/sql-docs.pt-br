---
title: Alterações de comportamento no gerenciamento de recursos das ferramentas do SQL Server 2014 | Microsoft Docs
ms.custom: ''
ms.date: 11/27/2018
...
## <a name="previous-versions"></a> Documentação arquivada para versões muito antigas do SQL Server
