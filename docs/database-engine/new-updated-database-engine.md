...
ms.openlocfilehash: 819b9b1d014bc751df7a14b57f88d2410c92f51e
...
1. [Propagação automática para réplicas secundárias](availability-groups/windows/automatic-seeding-secondary-replicas.md)
2. [Configurar um grupo de disponibilidade para transações distribuídas](availability-groups/windows/configure-availability-group-for-distributed-transactions.md)
3. [Configurar um grupo de disponibilidade distribuído](availability-groups/windows/configure-distributed-availability-groups.md)
4. [Grupos de disponibilidade distribuída](availability-groups/windows/distributed-availability-groups.md)
5. [Grupos de disponibilidade independentes de domínio](availability-groups/windows/domain-independent-availability-groups.md)
6. [Recursos preteridos do Mecanismo de Banco de Dados no SQL Server 2017](deprecated-database-engine-features-in-sql-server-2017.md)
