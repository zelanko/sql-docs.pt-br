...
> **Observação:** Para chamá-lo [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] de [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]ou, use o nome **Sys. dm_pdw_nodes_os_sys_info**.  
...
|**visible_target_kb**|**int**|**Aplica-se a:** [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e posterior.<br /><br /> É o mesmo que **committed_target_kb**. Não permite valor nulo.|  
...
|**sqlserver_start_time_ms_ticks**|**bigint**|Representa o **ms_tick** número de ms_tick [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] quando foi iniciado pela última vez. Compare com a coluna ms_ticks atual. Não permite valor nulo.|  
