...
f1_keywords: 
  - "Security [SQL Server]"
helpviewer_keywords: 
  - "objetos de banco de dados [SQL Server], segurança"
  - "SQL Server, segurança"
  - "sistemas operacionais [SQL Server], segurança"
  - "segurança [SQL Server], planejamento"
  - "aplicativos [SQL Server], segurança"
...
|Configurando um firewall para trabalhar com [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|[Configurar um Firewall do Windows para acesso ao serviço SSIS](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)|  
...
|Para obter informações sobre|Consulte|  
|---------------------------|---------|  
|Conexão, configuração e controle [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|[Usar o SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md)|  
