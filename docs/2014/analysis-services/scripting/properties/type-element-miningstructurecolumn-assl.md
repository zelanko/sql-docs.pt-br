...
|*Double*|Um número de ponto flutuante de precisão dupla dentro do intervalo de -1.79E +308 a 1.79E +308. Este tipo de dados mapeia para o tipo de dados `Double` no .NET Framework e o tipo de dados DBTYPE_R8 no OLE DB.|  
