...
description: Saiba como limitar a saída de rastreamento no SQL Server Profiler aplicando um filtro na SPID (ID de processo do servidor).
ms.prod: sql
