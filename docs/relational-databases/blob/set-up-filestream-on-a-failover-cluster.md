...
description: Descubra como configurar o FILESTREAM em um cluster de failover no SQL Server e saiba o que deve ser habilitado antes de configurá-lo.
ms.custom: ''
ms.date: 08/26/2016
ms.prod: sql
