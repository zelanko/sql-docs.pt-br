...
|[Exemplo de ActualSize](../../../ado/reference/ado-api/actualsize-property-ado.md)|Indica o comprimento real de um valor de campo.|  
...
|[Fonte de dados](../../../ado/reference/ado-api/datasource-property-ado.md)|Indica um objeto que contém dados a ser representado como uma **Recordset** objeto.|  
