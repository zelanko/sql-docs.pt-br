---
title: O banco de dados ignora a instrução de definição de dado na transação | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **true** se as instruções DDL forem ignoradas nas transações. Caso contrário, **false**.  
