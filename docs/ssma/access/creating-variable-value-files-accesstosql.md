---
description: Criando arquivos de valor de variável (AccessToSQL)
...
[Criando os arquivos de conexão do servidor (Access)](./creating-the-server-connection-files-accesstosql.md)  
