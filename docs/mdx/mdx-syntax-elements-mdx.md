...
|[Expressões &#40;MDX&#41;](../mdx/expressions-mdx.md)|As expressões são unidades de sintaxe que podem ser resolvidas para valores únicos de (escalares) ou objetos do Analysis Services. As expressões incluem funções que retornam um único valor, uma expressão fixa e assim por diante.|  
