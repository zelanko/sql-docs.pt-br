---
description: Adicionar um nó raiz à saída JSON com a opção ROOT (SQL Server)
title: Adicionar um nó raiz à saída JSON com a opção ROOT
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
