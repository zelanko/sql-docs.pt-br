...
> [!NOTE]  
>  O *audit_record_offset* argumento deve conter entradas válidas ou deve conter um padrão | Valor nulo. O tipo é **bitint**.  
...
|sequence_group_id |**nvarbinary** | Apenas o SQL Server (começando com 2016) |  
