...
`[ @database_name = ] database_name` Especifica o nome do banco de dados envolvido em operações de backup e restauração. *Database_Name* está **sysname**, sem padrão.  
