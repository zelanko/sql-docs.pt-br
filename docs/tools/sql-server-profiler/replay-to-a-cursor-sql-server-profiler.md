...
description: Saiba como usar um cursor no SQL Server Profiler para pausar uma repetição de rastreamento em um ponto específico. Facilite a depuração repetindo até um cursor.
ms.prod: sql
