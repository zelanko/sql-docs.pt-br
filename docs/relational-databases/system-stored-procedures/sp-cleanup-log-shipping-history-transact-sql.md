...
`[ @agent_type = ] 'agent_type'` O tipo de trabalho de envio de log. 0 = Backup, 1 = Copiar, 2 = Restaurar. *agent_type* está **tinyint** e não pode ser NULL.  
