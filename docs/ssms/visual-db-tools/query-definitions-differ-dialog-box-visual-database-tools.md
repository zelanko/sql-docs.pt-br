---
description: Caixa de diálogo Definições de Consulta Diferem (Visual Database Tools)
title: Caixa de diálogo Definições de Consulta Diferem
