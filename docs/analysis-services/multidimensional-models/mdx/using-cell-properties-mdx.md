...
ms.topic: "article"
helpviewer_keywords: 
  - "propriedades intrínsecas da célula [MDX]"
  - "células [MDX]"
  - "propriedades da célula [MDX]"
  - "palavra-chave CELL PROPERTIES"
...
|**BACK_COLOR**|A cor da tela de fundo para exibir a propriedade **VALUE** ou **FORMATTED_VALUE**. Para obter mais informações, consulte [Conteúdo de FORE_COLOR e BACK_COLOR &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/fore-color-and-back-color-contents-mdx.md).|  
...
|**FORE_COLOR**|A cor de primeiro plano para exibir a propriedade **VALUE** ou **FORMATTED_VALUE**. Para obter mais informações, consulte [Conteúdo de FORE_COLOR e BACK_COLOR &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/fore-color-and-back-color-contents-mdx.md).|  
|**FORMAT**|Mesmo que **FORMAT_STRING**.|  
|**FORMAT_STRING**|A cadeia de caracteres de formato usada para criar o valor da propriedade **FORMATTED_VALUE**. Para obter mais informações, consulte [Conteúdo de FORMAT_STRING &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/format-string-contents-mdx.md).|  
