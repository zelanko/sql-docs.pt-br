...
## <a name="return-code-values"></a>Valores do código de retorno  
 ...
 E_UNEXPECTED  
 A chamada para o método era inesperada. Por exemplo, o [ibcpsession:: BCPInit](../../relational-databases/native-client-ole-db-interfaces/ibcpsession-bcpinit-ole-db.md) método não foi chamado antes de chamar essa função.  
