---
title: "Agrupamentos de banco de dados contidos | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "banco de dados independente, agrupamentos"
...
```  
 ...
 Essa é uma função bastante peculiar. Em um agrupamento com diferenciação de maiúsculas e minúsculas, o sinal de @i na cláusula de retorno não pode ser associado a @I ou @İ. Em um agrupamento Latin1_General sem diferenciação de maiúsculas e minúsculas, @i é associado a @I, e a função retorna 1. Mas em um agrupamento turco sem diferenciação de maiúsculas e minúsculas, @i é associado a @, e a função retorna 2. Isso pode causar confusão em um banco de dados que se move entre instâncias com agrupamentos diferentes.  
