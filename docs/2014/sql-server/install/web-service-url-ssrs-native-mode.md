...
# <a name="web-service-url-ssrs-native-mode"></a>URL do serviço Web (modo nativo do SSRS)
 ...
 Se você tiver reinstalado [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] e descobrir que você obtiver erros ao tentar usar o valor do endereço IP padrão todos atribuídos e a porta 80, normalmente poderá resolver o erro, recriando a URL depois de reiniciar o serviço.  
