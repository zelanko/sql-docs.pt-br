...
ms.locfileid: "67834470"
---
# <a name="sample-unattended-sql-server-installation-script-for-ubuntu"></a>Amostra: Script de instalação autônoma do SQL Server para Ubuntu
