...
ms.locfileid: "36006933"
---
# <a name="datasources-element-assl"></a>Elemento DataSources (ASSL)
  Contém a coleção de [DataSource](../objects/datasource-element-assl.md) elementos associados a um [banco de dados](../objects/database-element-assl.md) elemento.  
