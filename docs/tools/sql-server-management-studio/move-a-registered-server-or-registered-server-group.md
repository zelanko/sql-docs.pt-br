---
title: "Mover um servidor registrado ou um grupo de Servidores Registrados (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "movendo servidor registrado ou grupo de servidores"
  - "Servidores registrados [SQL Server], grupos de servidores"
  - "grupos de servidores [SQL Server]"
  - "Servidores registrados [SQL Server], movendo o servidor ou grupo de servidores"
...
---
# Mover um servidor registrado ou um grupo de Servidores Registrados (SQL Server Management Studio)
...
#### Para mover um servidor registrado ou grupo de servidores  
