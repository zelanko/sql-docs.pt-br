...
ms.topic: "article"
helpviewer_keywords: 
  - "Depurador Transact-SQL, Janela Locais"
  - "Depurador Transact-SQL, Janela Inspeção"
  - "Depurador Transact-SQL, Janela Threads"
  - "Depurador Transact-SQL, Janela Pilha de Chamadas"
  - "Depurador Transact-SQL, Janela QuickWatch"
  - "Depurador Transact-SQL, exibindo informações"
...
## Consulte também  
 ...
 [Janela Pontos de Interrupção](../../relational-databases/scripting/breakpoints-window.md)   
 [Janela Pilha de Chamadas](../../relational-databases/scripting/call-stack-window.md)   
 [Janela Threads](../../relational-databases/scripting/threads-window.md)   
 [Janela Saída](../../relational-databases/scripting/output-window.md)   
