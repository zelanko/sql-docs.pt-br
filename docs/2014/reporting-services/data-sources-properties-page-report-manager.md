 ...
 **Uma fonte de dados compartilhada**  
 Especifique uma fonte de dados compartilhada a ser usada com o relatório. Para obter mais informações sobre como criar uma nova fonte de dados, consulte [criar, excluir ou modificar uma fonte de dados compartilhada &#40;Gerenciador de relatórios&#41;](../../2014/reporting-services/create-delete-or-modify-a-shared-data-source-report-manager.md).  
