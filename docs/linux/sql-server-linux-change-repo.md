...
1. Configure o novo repositório.
   ...
   | Ubuntu | CU | ' sudo ondulação https://packages.microsoft.com/keys/microsoft.asc \| sudo apt-chave add - & & sudo adicionar apt-repositório "$(ondulação https://packages.microsoft.com/config/ubuntu/16.04/mssql-server-2017.list)" ' |
   | Ubuntu | GDR | ' sudo ondulação https://packages.microsoft.com/keys/microsoft.asc \| sudo apt-chave add - & & sudo adicionar apt-repositório "$(ondulação https://packages.microsoft.com/config/ubuntu/16.04/mssql-server-2017-gdr.list)" ' |

1. Atualize o sistema.

   | Plataforma | Comando de atualização |
   |-----|-----|
