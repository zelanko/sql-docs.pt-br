...
ms.topic: "article"
helpviewer_keywords: 
  - "FileTables [SQL Server], pré-requisitos"
...
-   Ao **restaurar um banco de dados**, chame a instrução [RESTORE &#40;Transact-SQL&#41;](../Topic/RESTORE%20\(Transact-SQL\).md) com a opção FILESTREAM **DIRECTORY_NAME**.  
