---
title: "Recursos preteridos do Master Data Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Hierarquias explícitas, coleções e componentes relacionados  
...
## Tipo de log de transações da entidade Atributo  
...
## Recursos externos  
 Postagem do blog, [Deprecated: Explicit Hierarchies and Collections](http://go.microsoft.com/fwlink/p/?LinkId=615373) (Preterido: hierarquias explícitas e coleções), no msdn.com.  
