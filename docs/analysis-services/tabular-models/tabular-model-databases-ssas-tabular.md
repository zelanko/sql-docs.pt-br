...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Um banco de dados de modelo de tabela é um banco de dados do Analysis Services que você cria no [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] usando o modelo de projeto de modelo Tabular do Analysis Services, onde tabelas e relações são as estruturas primárias para representar dados.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Conectar-se a um modelo de banco de dados de tabela](../../analysis-services/tabular-models/connect-to-a-tabular-model-database-ssas.md)  
