...
-   [Etapa 4: Desinstalar o suplemento PowerPivot para SharePoint](#bkmk_addin)  
...
##  <a name="bkmk_addin"></a> Etapa 4: Desinstalar o suplemento PowerPivot para SharePoint  
