---
title: "Cont&#234;iner Sequ&#234;ncia | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "agrupando fluxos de controle"
  - "contêineres [Integration Services], Sequência"
  - "fluxo de controle de subconjunto [Integration Services]"
...
## Tarefas relacionadas  
 Para obter informações sobre como definir as propriedades do componente no [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)], consulte [Definir as propriedades de um componente de fluxo de dados](../Topic/Set%20the%20Properties%20of%20a%20Task%20or%20Container.md).  
