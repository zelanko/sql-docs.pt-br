...
helpviewer_keywords: 
  ...
  - "considerações internacionais [pesquisa de texto completo]"
  - "lematizadores [pesquisa de texto completo]"
  - "considerações gerais [pesquisa de texto completo]"
  - "pesquisa de texto completo [SQL Server], considerações internacionais"
