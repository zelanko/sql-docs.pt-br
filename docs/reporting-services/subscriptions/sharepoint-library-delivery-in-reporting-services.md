...
ms.topic: "article"
helpviewer_keywords: 
  - "integração com o SharePoint [Reporting Services], entrega de relatórios"
  - "entregando relatórios [Reporting Services]"
  - "assinaturas [Reporting Services], entrega de biblioteca do SharePoint"
