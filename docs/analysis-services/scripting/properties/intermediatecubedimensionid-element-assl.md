...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contém o identificador (ID) da dimensão que relaciona uma dimensão de referência a um grupo de medidas.  
