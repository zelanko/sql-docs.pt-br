...
Para ver perguntas de suporte relacionadas ao [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)], entre em contato com o [Suporte da Microsoft](https://support.microsoft.com/contactus/) ou faça uma pergunta na [Página do projeto do Github](https://github.com/Microsoft/msphpsql/issues).  
