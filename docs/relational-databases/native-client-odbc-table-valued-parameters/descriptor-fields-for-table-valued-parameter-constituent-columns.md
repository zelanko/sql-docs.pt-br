---
description: Campos descritores para colunas constituintes do parâmetro com valor de tabela
title: Campo de descritor para o parâmetro Table-Valued
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
