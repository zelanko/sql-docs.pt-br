...
ms.topic: "article"
helpviewer_keywords: 
  - "Classes de evento do SQL Server, Categoria de evento de desempenho"
  - "Categoria de evento de desempenho [o SQL Server]"
  - "classes de evento [SQL Server], Categoria de evento de desempenho"
...
---
# Categoria de evento de desempenho
