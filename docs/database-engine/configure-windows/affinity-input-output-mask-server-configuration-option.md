---
title: "Op&#231;&#227;o de configura&#231;&#227;o do servidor de m&#225;scara de Entrada-Sa&#237;da de afinidade | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
-   Para abranger mais de 32 CPUs, configure uma **affinity I/O mask** de quatro bytes para as primeiras 32 CPUs e uma **affinity64 I/O mask** de até quatro bytes para as CPUs restantes.  
 ...
 Como definir a opção **affinity I/O mask** do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] é uma operação especializada, só deveria ser usada quando necessário. Na maioria dos casos, a afinidade padrão de Windows 2000 ou Windows Server 2003 provê o melhor desempenho.  
