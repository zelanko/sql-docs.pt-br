...
|[MDX &#40;de expressões&#41;](../mdx/expressions-mdx.md)|As expressões são unidades de sintaxe que Analysis Services podem ser resolvidas para valores ou objetos únicos (escalares). As expressões incluem funções que retornam um único valor, uma expressão fixa e assim por diante.|  
