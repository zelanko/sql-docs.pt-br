---
title: Método updateInt (lang, int) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Esse método updateInt é especificado pelo método updateInt na interface do resultset.  
