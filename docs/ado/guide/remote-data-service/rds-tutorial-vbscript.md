...
## <a name="step-1--specify-a-server-program"></a>Etapa 1 — Especifique um programa de servidor  
...
## <a name="step-2a--invoke-the-server-program-with-rdsdatacontrol"></a>Etapa 2a — invocar o programa de servidor com o RDS. DataControl  
