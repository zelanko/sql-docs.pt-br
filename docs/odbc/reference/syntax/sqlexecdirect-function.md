---
description: Função SQLExecDirect
...
|22018|Valor de caractere inválido para especificação de conversão|* \* StatementText* continha um tipo C que era exato ou aproximado, um DateTime ou um tipo de dados Interval; o tipo SQL da coluna era um tipo de dados character; e o valor na coluna não era um literal válido do tipo ligado C.<br /><br /> Quando um parâmetro de entrada/saída ou saída foi retornado, o tipo SQL era um tipo de dados numérico ou exato aproximado, um DateTime ou um intervalo; o tipo C foi SQL_C_CHAR; e o valor na coluna não era um literal válido do tipo SQL associado.|  
