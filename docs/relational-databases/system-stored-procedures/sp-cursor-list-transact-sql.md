...
ms.author: edmaca
manager: craigg
ms.openlocfilehash: d33caa8cb7d385e1ead7c41c7da59acb51b71d85
...
|cursor_name|**sysname**|O nome do cursor de uma instrução DECLARE CURSOR. Em [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], se o cursor foi criado, definindo uma variável de cursor para um cursor, **cursor_name** retorna o nome da variável do cursor.  Em versões anteriores, essa coluna de saída retorna um nome gerado pelo sistema.|  
...
|modelo|**smallint**|1 = Insensível (ou estático)<br /><br /> 2 = o conjunto de chaves<br /><br /> 3 = dinâmico<br /><br /> 4 = De avanço rápido|  
