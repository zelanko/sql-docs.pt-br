...
---
# Classificar dados em uma tabela (SSAS tabular)
...
### Para classificar os dados em uma tabela com base em uma coluna de texto  
...
### Para classificar os dados em uma tabela com base em uma coluna numérica  
