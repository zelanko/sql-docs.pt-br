---
title: Desconectando-se de uma fonte de dados | Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  Quando um aplicativo é concluído usando uma fonte de dados, ele chama **SQLDisconnect**. **O SQLDisconnect** libera quaisquer instruções que estejam alocadas na conexão e desconecta o driver da fonte de dados. Após a desconexão, o aplicativo pode chamar [sqlfreehandle](../../relational-databases/native-client-odbc-api/sqlfreehandle.md) para liberar a alça de conexão. Antes de sair, um aplicativo também chama **sqlfreehandle** para liberar o cabo do ambiente.  
