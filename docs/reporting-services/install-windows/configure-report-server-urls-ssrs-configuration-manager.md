---
title: "Configurar as URLs do servidor de relat&#243;rio (Configuration Manager do SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "05/18/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Serviço servidor de relatório do Windows, diretórios virtuais"
  - "servidores de relatório [Reporting Services], diretórios virtuais"
  - "diretórios virtuais [Reporting Services]"
  - "Gerenciador de Relatórios [Reporting Services], diretórios virtuais"
...
---
# Configurar as URLs do servidor de relat&#243;rio (Configuration Manager do SSRS)
...
## Definindo uma URL do servidor de relatório  
...
## Permissões do lado do servidor em uma URL de servidor de relatório  
...
## Autenticando solicitações de cliente enviadas a uma URL de servidor de relatório  
