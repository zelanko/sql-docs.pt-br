---
description: Como usar Always Encrypted com enclaves seguros com o JDBC Driver
title: Como usar Always Encrypted com enclaves seguros com o JDBC Driver | Microsoft Docs
ms.custom: ''
ms.date: 03/02/2020
ms.prod: sql
...
ms.locfileid: "88487917"
---
# <a name="using-always-encrypted-with-secure-enclaves-with-the-jdbc-driver"></a>Como usar Always Encrypted com enclaves seguros com o JDBC Driver
...
- Verifique se as dependências de ambiente, como DLLs, repositórios de chaves etc. estão nos caminhos corretos. Always Encrypted com enclaves seguros é um complemento para o recurso [Always Encrypted](../../connect/jdbc/using-always-encrypted-with-the-jdbc-driver.md) existente e eles compartilham pré-requisitos semelhantes.
