...
description: O Agente de Leitor de Log de Replicação monitora os bancos de dados do SQL Server configurados para replicação transacional e copia transações para o banco de dados de distribuição.
ms.custom: ''
ms.date: 10/29/2018
ms.prod: sql
