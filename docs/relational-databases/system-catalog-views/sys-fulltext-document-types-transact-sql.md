...
|**caminho**|**nvarchar (260)**|O caminho da DLL de IFilter. O caminho está visível somente para membros da função de servidor fixa **serveradmin** .|  
|**version**|**sysname**|Versão da DLL do IFilter.|  
|**fabricante**|**sysname**|Nome do fabricante do IFilter.<br /><br /> Observação: Apenas documentos com fabricante como [!INCLUDE[msCoName](../../includes/msconame-md.md)] têm suporte em [!INCLUDE[ssSDS](../../includes/sssds-md.md)].|  
