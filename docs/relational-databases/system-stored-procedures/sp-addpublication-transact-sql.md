...
`[ \@taskid = ] taskid`Com suporte somente para compatibilidade com versões anteriores; Use [o &#40;Transact-SQL&#41;sp_addpublication_snapshot](../../relational-databases/system-stored-procedures/sp-addpublication-snapshot-transact-sql.md).  
...
|**character**|Produz saída de programa de cópia em massa em modo de caractere de todas as tabelas. _Para um editor Oracle,_ **caractere** de _é válido somente para replicação de instantâneo_.|  
|**concurrent**|Produz saída de programa de cópia em massa em modo nativo de todas as tabelas, mas não bloqueia as tabelas durante o instantâneo. Com suporte somente para publicações transacionais. *Não há suporte para Publicadores Oracle*.|  
...
|**instantâneo do banco de dados**|Produz saída de programa de cópia em massa em modo nativo de todas as tabelas de um instantâneo do banco de dados. Os instantâneos do banco de dados não estão disponíveis [!INCLUDE[msCoName](../../includes/msconame-md.md)]em todas as edições do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Para obter uma lista de recursos com suporte nas edições do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], consulte [Recursos com suporte nas edições do SQL Server 2016](~/sql-server/editions-and-supported-features-for-sql-server-2016.md).|  
|**caractere de instantâneo do banco de dados**|Produz saída de programa de cópia em massa em modo de caractere de todas as tabelas de um instantâneo de banco de dados. Os instantâneos do banco de dados não estão disponíveis [!INCLUDE[msCoName](../../includes/msconame-md.md)]em todas as edições do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Para obter uma lista de recursos com suporte nas edições do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], consulte [Recursos com suporte nas edições do SQL Server 2016](~/sql-server/editions-and-supported-features-for-sql-server-2016.md).|  
...
|Valor|Descrição|  
|-----------|-----------------|  
|**contínuo** os|O Publicador fornece saída de todas as transações com base em log. Para não[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] publicadores, isso requer que o *sync_method* seja definido como **concurrent_c**.|  
|**instantânea**|O Publicador só produz eventos de sincronização agendados. Para não[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] publicadores, isso requer que o *sync_method* seja definido como **caractere**.|  
...
|**inativo** os|Os dados da publicação não estão disponíveis aos Assinantes quando a publicação é criada pela primeira vez (eles podem assinar, mas as assinaturas não são processadas).|  
...
|**sub-inicialização**|Reinicialize a assinatura.|  
...
> [!NOTE]  
>  o Publicador não deve ser usado ao adicionar uma publicação [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] a um Publicador.  
 ...
 **sp_addpublication** é usado na replicação de instantâneo e na replicação transacional.  
 ...
 Com a replicação DDL habilitada (*replicate_ddl* = **1**) para uma publicação, a fim de fazer alterações de DDL não replicadas na publicação, [sp_changepublication](../../relational-databases/system-stored-procedures/sp-changepublication-transact-sql.md) deve primeiro ser executado para definir *replicate_ddl* para  **0**. Depois que as instruções DDL de não replicação forem emitidas, o [sp_changepublication](../../relational-databases/system-stored-procedures/sp-changepublication-transact-sql.md) poderá ser executado novamente para ativar novamente a replicação DDL.  
  
## <a name="example"></a>Exemplo  
 [!code-sql[HowTo#sp_AddTranPub](../../relational-databases/replication/codesnippet/tsql/sp-addpublication-transa_1.sql)]  
  
## <a name="permissions"></a>Permissões  
 Somente os membros da função de servidor fixa **sysadmin** ou da função de banco de dados fixa **db_owner** podem executar **sp_addpublication**. Os logons de autenticação do Windows devem ter uma conta de usuário no banco de dados que representa a conta de usuário do Windows. Uma conta de usuário que representa um grupo do Windows não é suficiente.  
