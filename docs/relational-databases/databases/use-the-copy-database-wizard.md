...
### **A.  Mova o banco de dados usando o método desanexar e anexar para uma instância em um servidor físico diferente.  Um logon e um trabalho do SQL Server Agent também serão movidos.**  
