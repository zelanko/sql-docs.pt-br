---
description: Enviar dados para uma coluna FILESTREAM usando IRowsetFastUpload SQL Server Native Client (OLE DB)
...
ms.locfileid: "97464877"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-sql-server-native-client-ole-db"></a>Enviar dados para uma coluna FILESTREAM usando IRowsetFastUpload SQL Server Native Client (OLE DB)
