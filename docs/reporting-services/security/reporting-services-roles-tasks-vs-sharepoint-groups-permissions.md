...
|**Tarefas:** por exemplo "Gerenciar Relatórios".|**Permissões:** por exemplo, dentro do grupo "Exibir Apenas", há permissões relacionadas à lista de exibir itens, exibir versões e exibir páginas de aplicativo.|  
 ...
 Para obter mais informações sobre as permissões do SharePoint, consulte [Níveis de permissão e permissões](https://support.office.com/en-us/article/Understand-groups-and-permissions-on-a-SharePoint-site-258E5F33-1B5A-4766-A503-D86655CF950D) e [Determinar níveis de permissão e grupos no SharePoint 2013](https://technet.microsoft.com/library/cc262690.aspx).  
