 ...
 **sp_add_log_shipping_primary_secondary** deve ser executado do banco de dados **mestre** no servidor primário.  
  
## <a name="permissions"></a>Permissões  
 Somente os membros da função de servidor fixa **sysadmin** podem executar esse procedimento.  
  
## <a name="examples"></a>Exemplos  
 Este exemplo ilustra o uso de **sp_add_log_shipping_primary_secondary** para adicionar uma entrada para o banco de dados secundário **LogShipAdventureWorks** para o servidor secundário FLATIRON.  
