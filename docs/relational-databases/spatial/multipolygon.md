...
ms.topic: "article"
helpviewer_keywords: 
  - "subtipo de geometria MultiPolygon [SQL Server]"
...
## Instâncias de polígono  
 ...
 ![Exemplos das instâncias geométricas MultiPolygon](../../relational-databases/spatial/media/multipolygon.png "Exemplos das instâncias geométricas MultiPolygon")  
