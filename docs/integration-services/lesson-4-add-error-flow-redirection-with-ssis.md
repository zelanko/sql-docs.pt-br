...
-   [Etapa 1: Copiando o pacote da Lição 3](../integration-services/step-1-copying-the-lesson-3-package.md)  
  
-   [Etapa 2: Criando um arquivo corrompido](../integration-services/step-2-creating-a-corrupted-file.md)  
  
-   [Etapa 3: Adicionando redirecionamento de fluxo de erro](../integration-services/step-3-adding-error-flow-redirection.md)  
  
-   [Etapa 4: Adicionando um destino de arquivo simples](../integration-services/step-4-adding-a-flat-file-destination.md)  
  
-   [Etapa 5: Testando o pacote de tutorial da Lição 4](../integration-services/step-5-testing-the-lesson-4-tutorial-package.md)  
