...
## <a name="sql-server-native-client-ole-db-provider"></a>Provedor OLE DB do SQL Server Native Client  
 ...
 Para obter detalhes sobre [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] suporte do provedor OLE DB Native Client para o espelhamento de banco de dados, consulte [propriedades de inicialização e autorização](../../native-client-ole-db-data-source-objects/initialization-and-authorization-properties.md).  
