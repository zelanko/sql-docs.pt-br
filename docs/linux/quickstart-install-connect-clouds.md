...
description: Saiba como instalar o SQL Server no RHEL (Red Hat Enterprise Linux), no SLES (SUSE Linux Enterprise Server) ou no Ubuntu na nuvem de sua escolha.
author: VanMSFT
ms.author: vanto
ms.date: 11/04/2019
ms.topic: conceptual
