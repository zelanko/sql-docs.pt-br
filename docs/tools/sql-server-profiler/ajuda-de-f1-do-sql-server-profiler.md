...
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], ajuda"
  - "SQL Server Profiler, ajuda"
  - "caixa de diálogo Propriedades do Rastreamento"
  - "Caixa de diálogo propriedades do modelo de rastreamento"
  - "Caixa de diálogo Propriedades do Arquivo de Rastreamento"
  - "Caixa de diálogo Lista de Contadores de Desempenho"
  - "Caixa de diálogo opções gerais"
  - "Caixa de diálogo Selecionar Tabela de Carga de Trabalho"
  - "Caixa de diálogo tabela de destino"
...
# Ajuda de F1 do SQL Server Profiler
 ...
 ## Propriedades do Rastreamento (Geral)
 ...
 **Habilitar horário de parada do rastreamento**  
 Defina a data e hora para o rastreamento ser concluído e se fechar. Use a guia **Seleção de Eventos** da caixa de diálogo **Propriedades do Rastreamento** para exibir ou especificar eventos do rastreamento e colunas de dados.  
  
 ## Propriedades do Rastreamento (guia Seleção de Eventos)
...
## Propriedades do modelo de rastreamento (guia Geral)
...
## Editar propriedades do modelo de rastreamento (guia Geral)
 ...
 **Usar como modelo padrão para o tipo de servidor selecionado**  
 ...
 ## Propriedades do Modelo de Rastreamento (guia Seleção de Eventos)
 ...
 **Organizar Colunas**  
 ...
 ## Propriedades do Arquivo de Rastreamento (guia Geral) 
...
#### Opções  
 **Nome do arquivo**  
 O caminho e o nome do arquivo de rastreamento exibido.  
  
 **Nome do provedor de rastreamento**  
 Exibe o nome da instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que foi rastreada.  
 ...
 **Tamanho do arquivo (KB)**  
 O tamanho do arquivo de rastreamento em kilobyte (KB).  
  
 **Criado**  
 A data e hora em que o arquivo de rastreamento foi criado.  
  
 **Modificado**  
 A data e hora em que o arquivo de rastreamento foi modificado.  

 ## Propriedades do Arquivo de Rastreamento(Guia Seleção de Eventos)
 ...
 **Organizar Colunas**  
 ...
 ## Propriedades da Tabela de Rastreamento (Guia Seleção de Eventos)
 ...
 **Organizar Colunas**  
 Depois de selecionar **Eventos** e colunas de dados a serem rastreados, clique em **Organizar Colunas** para forçar a grade a reclassificar a coluna na janela de resultados do rastreamento.  
  ...
  ## SQL Server Profiler – Limite de Contadores de Desempenho
...
### Para selecionar objetos e contadores de desempenho a correlacionar com um rastreamento  
...
2.  Verifique os contadores que você deseja correlacionar com o arquivo de rastreamento do [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] .  
 ...
 ## SQL Server Profiler - ferramentas/opções (página Opções Gerais)
...
> **OBSERVAÇÃO:** A ativação/desativação desta caixa de seleção altera o formato de exibição das colunas de hora como **StartTime** e **EndTime**. Porém, não altera os parâmetros de valores **DateTime** dentro dos eventos de idioma ou RPCs (chamadas de procedimento remoto).  
...
### Opções de substituição de arquivos  
 ...
 **Intervalo de sondagem padrão do monitor de integridade (s)**  
 ...
 ## SQL Server Profiler – Tabela de Origem/Orientador de Otimização do Mecanismo do Banco de Dados - Selecionar Tabela de Carga de Trabalho
...
#### Opções  
 **SQL Server**  
 Especifica a instância do SQL Server conectada atualmente. Esse campo é populado automaticamente e não pode ser atualizado.  
 ...
 **Table**  
 ...
 ## SQL Server Profiler - tabela de destino
 ...
 **Table**  
 ...
 ## SQL Server Profiler – Configuração de repetição (Opções de repetição básicas)
 ...
 **Exibir resultados da repetição**  
 ...
 ## SQL Server Profiler - configuração de repetição (Opções de Repetição Avançadas)
 ...
 **Intervalo de espera do monitor de processos bloqueados (s)**  
 ...
 ## SQL Server Profiler - Caixa de diálogo Localizar
 ...
 **Localizar Anterior**  
 ...
 ## SQL Server Profiler – Organizar Colunas
...
> **OBSERVAÇÃO:** para colunas de dados do tipo cadeia de caracteres, os critérios de filtro serão mostrados como um valor de cadeia de caracteres LIKE ou NOT LIKE.  
