...
helpviewer_keywords: 
  ...
  - "implantando [Reporting Services], opções de componente"
  - "servidores de relatório [Reporting Services], opções de componente"
  - "opções de configuração [Reporting Services]"
  - "administering Reporting Services"
  - "componentes [Reporting Services], configurando"
