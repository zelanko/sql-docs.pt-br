...
# <a name="planning-for-reporting-services"></a>Planejamento para o Reporting Services
 ...
 ![Pequeno ícone de pasta de arquivos](https://docs.microsoft.com/analysis-services/analysis-services/media/filefolder-small.png "Pequeno ícone de pasta de arquivos") **Planejamento e arquitetura de recursos gerais do Reporting Services**  
