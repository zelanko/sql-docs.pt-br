...
layout: HubPage
hide_bc: true
title: SQL Server – carregar e mover dados
description: Explore os recursos que ajudam você a carregar, mover e migrar bancos de dados e dados com o SQL Server.
ms.topic: hub-page
ms.prod: sql
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Migrar, carregar e mover dados</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                            <li class="fullSpan">
                                ...
                                <h2>Migrar bancos de dados para o SQL</h2>
                            </li>
                                                         <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>Copie dados em massa entre um arquivo de dados, em um formato que você especifica, e o banco de dados SQL.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistente Importar Arquivo Simples</h3>
                                                    <p>Use o assistente como uma maneira simples de copiar dados de um arquivo simples (.csv, .txt) para seu banco de dados SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistente de Importação e Exportação</h3>
                                                    <p>Use o assistente como uma maneira simples de copiar dados de uma ampla variedade de fontes para seu banco de dados SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Extraia e transforme dados de uma ampla variedade de fontes, como arquivos simples e fontes de dados relacionais, e carregue os dados no seu banco de dados SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Replicação</h3>
                                                    <p> Um conjunto de tecnologias para copiar e distribuir dados e objetos de um banco de dados para outro e, em seguida, sincronizar entre os bancos de dados para manter a consistência.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
