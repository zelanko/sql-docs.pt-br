---
title: "Guia de programação para o Driver SQL de PHP | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="programming-guide-for-php-sql-driver"></a>Guia de programação para o driver SQL de PHP
...
|[Considerações de segurança para o driver SQL do PHP](../../connect/php/security-considerations-for-php-sql-driver.md)|Descreve as considerações de segurança para desenvolver, implantar e executar aplicativos.|  
