...
helpviewer_keywords: 
  ...
  - "classes de evento do SQL Server, categoria de eventos de erros e de avisos"
  - "classes de evento [SQL Server], categoria de eventos de erros e de avisos"
...
---
# Categoria de eventos de erros e de avisos (Mecanismo de Banco de Dados)
