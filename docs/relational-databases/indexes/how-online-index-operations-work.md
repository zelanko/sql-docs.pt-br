...
helpviewer_keywords: 
  ...
  - "índices de origem [SQL Server]"
  - "índices preexistentes [SQL Server]"
  - "índices de destino [SQL Server]"
  - "índice de mapeamento temporário [SQL Server]"
  - "mapeamentos temporários de índice [SQL Server]"
...
## Atividades do índice online  
 ...
 ![Atividades executadas durante a operação de indexação online](../../relational-databases/indexes/media/online-index.gif "Atividades executadas durante a operação de indexação online")  
