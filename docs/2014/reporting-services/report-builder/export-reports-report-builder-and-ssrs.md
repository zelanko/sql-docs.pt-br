...
-   **Extensões de processador de dados** As extensões de renderização de dados distribuem todas as informações de formatação e layout do relatório e exibem apenas os dados. O arquivo resultante pode ser usado para importar os dados brutos do relatório em outro tipo de arquivo, como o Excel, outro banco de dados, uma mensagem de dados XML, ou um aplicativo personalizado. Processadores de dados não oferecem suporte a quebras de páginas.  
  
     As seguintes extensões de renderização de dados são suportadas: CSV, XML e Atom.  
  
-   **Extensões do renderizador de quebra de página flexível** Extensões de renderização de quebra de página flexível mantêm o layout e a formatação do relatório. O arquivo resultante é otimizado para exibição com base em tela e entrega, como em uma página da Web ou nos controles do **ReportViewer** .  
...
-   **Extensões de renderização de quebra de página física** As extensões do processador de quebra de página não fixa mantêm o layout e a formatação do relatório. O arquivo resultante é otimizado para uma experiência consistente de impressão, ou para exibir o relatório online em formato de um livro.  
...
##  <a name="GeneratingDataFeedsFromReport"></a>Gerando feeds de dados de um relatório  
...
-   [Exportando para um arquivo CSV &#40;Construtor de Relatórios e SSRS&#41;](exporting-to-a-csv-file-report-builder-and-ssrs.md)  
...
-   [Exportando para um arquivo PDF &#40;Construtor de Relatórios e SSRS&#41;](exporting-to-a-pdf-file-report-builder-and-ssrs.md)  
...
-   [Exportando para XML &#40;Construtor de Relatórios e SSRS&#41;](exporting-to-xml-report-builder-and-ssrs.md)  
...
##  <a name="OtherWaysExportingReports"></a>Outras maneiras de exportar relatórios  
