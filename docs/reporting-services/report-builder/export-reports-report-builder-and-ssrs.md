...
---
# Exportar relat&#243;rios (Construtor de Relat&#243;rios e SSRS)
...
-   [Para exportar um relatório do Construtor de Relatórios](#bkmk_export_from_rb)  
  
-   [Para exportar um relatório do portal da Web do Reporting Services](#bkmk_export_from_rm)  
  
-   [Para exportar o relatório de uma biblioteca do SharePoint](#bkmk_export_from_sharepoint)  
  
-   [Tipos de extensão de renderização](#RendererTypes)  
  
-   [Formatos para os quais você pode exportar enquanto exibe relatórios](#ExportFormats)  
  
-   [Gerando feeds de dados a partir do relatório](#GeneratingDataFeedsFromReport)  
  
-   [Solucionando problemas de relatórios exportados](#Troubleshooting)  
  
-   [Outros modos de exportar relatórios](#OtherWaysExportingReports)  
...
1.  Na **página inicial** do portal da Web do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], navegue até o relatório que deseja exportar.  
