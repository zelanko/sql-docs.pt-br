...
# <a name="monitor-performance-with-replication-monitor"></a>Monitorar o desempenho com o Replication Monitor
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] O Replication Monitor permite que você monitore o desempenho da replicação transacional e da replicação de mesclagem das seguintes maneiras:  
