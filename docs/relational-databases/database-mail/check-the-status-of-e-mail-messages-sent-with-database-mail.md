---
title: "Verificar o status de mensagens de email enviadas por Database Mail | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "email [SQL Server], informações de status"
  - "email [SQL Server], informações de status"
  - "Database Mail [SQL Server], status de mensagem"
  - "informação de status [Database Mail]"
...
---
# Verificar o status de mensagens de email enviadas por Database Mail
