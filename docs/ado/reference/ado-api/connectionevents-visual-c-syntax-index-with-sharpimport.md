---
title: 'ConnectionEvents (índice Visual C++ sintaxe com #import) | Microsoft Docs'
ms.prod: sql
...
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (índice Visual C++ sintaxe com #import)
