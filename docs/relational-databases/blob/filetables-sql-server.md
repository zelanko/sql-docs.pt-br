...
description: Explore os benefícios e a funcionalidade de FileTables, o recurso do SQL Server que usa uma estrutura de diretório para armazenar arquivos. Saiba como trabalhar com FileTables.
ms.custom: ''
ms.date: 10/24/2016
ms.prod: sql
