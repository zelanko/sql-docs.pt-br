...
description: Saiba mais sobre srv_paramdata. srv_paramdata retorna o valor de um parâmetro de chamada de procedimento armazenado remoto.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
