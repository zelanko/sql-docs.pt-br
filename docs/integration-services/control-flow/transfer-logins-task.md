...
helpviewer_keywords: 
  - "Tarefa Transferir Logons [Integration Services]"
...
## Transfer logons entre instâncias do SQL Server  
...
## Configuração da tarefa Transferir Logons  
...
## Configuração programática da tarefa Transferir Logons  
