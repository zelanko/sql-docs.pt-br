...
helpviewer_keywords: 
  ...
  - "propriedades de execução [Integration Services]"
  - "pacotes [Integration Services], propriedades"
  - "propriedades de identificação [Integration Services]"
  - "senhas [Integration Services]"
  - "Pacotes do SSIS, propriedades"
  - "propriedades de transação [Integration Services]"
  - "atualizando propriedades de pacote"
  - "propriedades do valor de execução forçada [Integration Services]"
  - "propriedades de segurança [Integration Services]"
  - "propriedades de versão [Integration Services]"
...
-   [Definir as propriedades de um pacote](../Topic/Set%20the%20Properties%20of%20a%20Package.md)  
...
###  <a name="Security"></a> Segurança  
 As propriedades nesta categoria são usadas para definir o nível de proteção do pacote. Para obter mais informações, consulte [Access Control for Sensitive Data in Packages](../integration-services/packages/access-control-for-sensitive-data-in-packages.md).  
