---
description: Enviar dados para FILESTREAM no SQL Server Native Client-ISequentialStream associado a ICommandText
title: Dados FILESTREAM, ISequentialStream ICommandText
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97481107"
---
# <a name="send-data-to-filestream-in-sql-server-native-client---isequentialstream-bound-to-icommandtext"></a>Enviar dados para FILESTREAM no SQL Server Native Client-ISequentialStream associado a ICommandText
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  Este exemplo usa uma interface de ISequentialStream associada a um parâmetro de ICommandText para enviar de 4 MB a 4 GB de dados a uma coluna de filestream.  
...
## <a name="example"></a>Exemplo  
 ...
 Copie a terceira listagem de código e cole em um arquivo denominado ICommandUpload.cpp.  
  
 Compile ICommandUpload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.  
