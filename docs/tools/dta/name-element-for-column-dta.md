...
description: No utilitário dta, o elemento Name para Column especifica o nome de uma coluna de índice em uma configuração especificada pelo usuário.
ms.prod: sql
