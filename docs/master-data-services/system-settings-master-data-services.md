...
description: Saiba como definir as configurações do sistema para todos os aplicativos Web e serviços Web associados a um banco de dados Master Data Services.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
##  <a name="version-management-settings"></a><a name="Versions"></a> Configurações de gerenciamento de versão  
...
##  <a name="staging-settings"></a><a name="Staging"></a> Configurações de preparo  
...
##  <a name="explorer-settings"></a><a name="Explorer"></a> Configurações do Gerenciador  
...
##  <a name="add-in-for-excel-settings"></a><a name="xls"></a> Configurações do suplemento para Excel  
...
##  <a name="business-rule-settings"></a><a name="BusinessRules"></a> Configurações de regra de negócio  
...
##  <a name="notification-settings"></a><a name="Notifications"></a> Configurações de notificação  
...
##  <a name="security-settings"></a><a name="Security"></a> Configurações de segurança  
...
##  <a name="performance-settings"></a><a name="Performance"></a> Configurações de Desempenho  
