...
## <a name="remarks"></a>Comentários  
 Se a função **DISTINCT** localizar tuplas duplicadas no conjunto especificado, a função manterá apenas a primeira instância da tupla duplicada enquanto deixa a ordem do conjunto intacta.  
