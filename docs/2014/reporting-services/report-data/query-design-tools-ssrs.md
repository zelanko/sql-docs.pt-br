...
##  <a name="text-based-query-designer"></a><a name="Textbased"></a> Designer de Consulta baseado em texto
 O designer de consulta baseado em texto é a ferramenta de construção [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]de consulta padrão para as fontes de dados relacionais mais suportadas, incluindo , Oracle, Teradata, OLE DB, XML e ODBC. Em comparação com o designer de consultas gráficas, essa ferramenta de design de consulta não valida a sintaxe de consulta durante o design da consulta. A imagem a seguir fornece uma ilustração do designer de consulta com base no texto.
...
##  <a name="graphical-query-designer"></a><a name="Graphical"></a>Designer de consulta gráfica
...
##  <a name="hyperion-essbase-query-designer"></a><a name="Hyperion"></a>Designer de consulta hyperion Essbase
...
## <a name="see-also"></a>Consulte Também
 [Ferramentas de relatórios](../tools/reporting-services-tools.md) [adicionam dados a um relatório &#40;relatório construtor e SSRS&#41;](report-datasets-ssrs.md) [conexões de dados, fontes de dados e cadeias de conexão em serviços de relatórios](../data-connections-data-sources-and-connection-strings-in-reporting-services.md) [de serviços tutoriais &#40;SSRS&#41;](../reporting-services-tutorials-ssrs.md) Fontes de dados [suportadas por serviços de relatórios &#40;SSRS&#41;](../create-deploy-and-manage-mobile-and-paginated-reports.md) criar uma fonte de dados incorporada ou compartilhada &#40;[SSRS&#41;](../create-an-embedded-or-shared-data-source-ssrs.md)
