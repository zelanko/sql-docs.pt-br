...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Em modelos de tabela uma hierarquia é o caminho de navegação de um atributo para outro com base em valores selecionados pelo usuário.  
