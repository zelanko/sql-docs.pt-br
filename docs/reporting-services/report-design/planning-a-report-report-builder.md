...
description: Planeje e crie relatórios com texto formatado de maneira avançada que mostra dados de vendas, tendências de marketing, relatórios operacionais ou painéis no Construtor de Relatórios.
ms.date: 03/03/2017
