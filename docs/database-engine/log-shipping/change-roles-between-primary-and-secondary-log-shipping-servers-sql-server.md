---
title: "Alterar fun&#231;&#245;es entre servidores de envio de log prim&#225;rios e secund&#225;rios (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "envio de logs [SQL Server], alterações de funções"
  - "arquivos de dados secundários [SQL Server], alterações de funções entre"
  - "bancos de dados primários [SQL Server]"
  - "alterações de função incial [SQL Server]"
