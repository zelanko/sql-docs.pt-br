...
manager: "jhubbard"
---
# Criar a pol&#237;tica desativada por padr&#227;o
...
### Para criar a condição Correio Desativado   
...
### Para criar a política Desativada por Padrão  
...
[Configurar um servidor para executar a política desativada por padrão](../../relational-databases/policy-based-management/configure-a-server-to-run-the-off-by-default-policy.md)  
