...
-   [Guia Geral](../../integration-services/connection-manager/cache-connection-manager-editor.md#generaltab)  
  
-   [Guia colunas](../../integration-services/connection-manager/cache-connection-manager-editor.md#columnstab)  
  
 Para obter mais informações sobre o Gerenciador de Conexões de Cache, consulte [Cache Connection Manager](../../integration-services/connection-manager/cache-connection-manager.md).  
