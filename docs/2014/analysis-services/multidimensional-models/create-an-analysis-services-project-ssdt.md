...
# <a name="create-an-analysis-services-project-ssdt"></a>Criar um Projeto de Analysis Services (SSDT)
 ...
 [Criar um novo projeto usando um banco de dados de Analysis Services existente](#bkmk_NewUsingWizard)  
  
 [Adicionar um projeto de Analysis Services a uma solução existente](#bkmk_AddtoExistingSolution)  
  
 [Criar e implantar a solução](#bkmk_buildDeploy)  
  
 [Pastas do projeto do Analysis Services](#bkmk_ProjectFolders)  
  
 [Analysis Services tipos de arquivo](#bkmk_FileTypes)  
  
 [Modelos de item do Analysis Services](#bkmk_ItemTemplates)  
  
##  <a name="create-a-new-project-using-the-analysis-services-project-template"></a><a name="bkmk_NewUsingTemplate"></a>Criar um novo projeto usando o modelo de projeto Analysis Services  
...
##  <a name="create-a-new-project-using-an-existing-analysis-services-database"></a><a name="bkmk_NewUsingWizard"></a> Criar um novo projeto usando um banco de dados existente do Analysis Services  
...
##  <a name="add-an-analysis-services-project-to-an-existing-solution"></a><a name="bkmk_AddtoExistingSolution"></a> Adicionar um projeto do Analysis Services a uma solução existente  
...
##  <a name="build-and-deploy-the-solution"></a><a name="bkmk_buildDeploy"></a> Criar e implantar a solução  
...
##  <a name="analysis-services-file-types"></a><a name="bkmk_FileTypes"></a> Tipos de arquivo do Analysis Services  
...
##  <a name="analysis-services-item-templates"></a><a name="bkmk_ItemTemplates"></a>Modelos de item de Analysis Services  
