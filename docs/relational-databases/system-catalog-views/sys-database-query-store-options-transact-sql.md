...
|**wait_stats_capture_mode**|**smallint**|Controla se o repositório de consultas executa captura de estatísticas de espera: <br /><br /> 0 = OFF <br /><br /> 1 = ON|
|**wait_stats_mode_capture_desc**|**nvarchar (60)**|Descrição textual do modo de captura de estatísticas de espera real: <br /><br /> OFF <br /><br /> ON (padrão)| 
