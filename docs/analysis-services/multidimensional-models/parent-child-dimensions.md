...
ms.topic: "article"
helpviewer_keywords: 
  - "hierarquias [Analysis Services], pai-filho"
  - "dimensões [Analysis Services], pai-filho"
  - "atributos pai [Analysis Services]"
  - "membros de dados [Analysis Services]"
  - "hierarquias [Analysis Services], multinível"
  - "autojunções"
  - "relações autorreferenciáveis"
  - "membros [Analysis Services], dados"
...
## Esquema de dimensão  
 ...
 ![Junção autorreferenciável na tabela DimOrganization](../../analysis-services/multidimensional-models/media/dimorganization.png "Junção autorreferenciável na tabela DimOrganization")  
