...
description: O conjunto de linhas LINKEDSERVERS enumera fontes de dados da organização que podem participar de consultas distribuídas no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
