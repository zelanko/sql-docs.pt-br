...
description: 'Saiba como selecionar o protocolo usado pelo sqlcmd para se comunicar com o SQL Server. As opções são: TCP/IP, pipes nomeados e memória compartilhada.'
