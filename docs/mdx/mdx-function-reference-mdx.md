...
|[Firstsibling=2==retorna &#40;MDX&#41;](../mdx/firstsibling-mdx.md)|Retorna o primeiro filho do pai de um membro.|  
...
|[Médio &#40;MDX&#41;](../mdx/avg-mdx.md)|Retorna o valor médio de medidas ou o valor médio de uma expressão numérica opcional, avaliado sobre um conjunto especificado.|  
...
|[Função LinRegIntercept &#40;MDX&#41;](../mdx/linregintercept-mdx.md)|Calcula a regressão linear de um conjunto e retorna o valor da interceptação na linha de regressão, y = ax + b.|  
...
|[Função VarianceP &#40;MDX&#41;](../mdx/variancep-mdx.md)|Alias da [VarP &#40;MDX&#41;](../mdx/varp-mdx.md).|  
...
|[Currentordinal=2==retorna &#40;MDX&#41;](../mdx/currentordinal-mdx.md)|Retorna o número de iteração atual dentro de um conjunto durante a iteração.|  
...
|[Nametoset=1=«nome &#40;MDX&#41;](../mdx/nametoset-mdx.md)|Retorna um conjunto que contém o membro especificado por uma cadeia de caracteres formatada para MDX.|  
...
|[Stripcalculatedmembers=1=«conjunto»=retorna &#40;MDX&#41;](../mdx/stripcalculatedmembers-mdx.md)|Retorna um conjunto gerado, removendo membros calculados de um conjunto especificado.|  
...
|[Acumulado no ano &#40;MDX&#41;](../mdx/ytd-mdx.md)|Retorna os membros de um conjunto de irmãos do mesmo nível de um determinado membro, começando com o primeiro irmão e terminando com um determinado membro, restringido pelo *ano* nível na dimensão de tempo.|  
...
|[Nome exclusivo do &#40;MDX&#41;](../mdx/uniquename-mdx.md)|Retorna o nome exclusivo de uma dimensão, hierarquia, nível ou membro especificado.|  
