...
description: Saiba como usar os recursos de implantação no SSDT (SQL Server Data Tools) para publicar os relatórios em um servidor de relatório.
ms.date: 06/01/2016
