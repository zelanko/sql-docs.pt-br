...
|**primário\_função\_permitir\_conexões\_desc**|**nvarchar(60)**|Descrição da **primário\_função\_permitir\_conexões**, um de:<br /><br /> ALL<br /><br /> LER\_GRAVAR|  
