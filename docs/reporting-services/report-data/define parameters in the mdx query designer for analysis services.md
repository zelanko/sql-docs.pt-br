...
ms.topic: "article"
helpviewer_keywords: 
  - "parâmetros [Reporting Services], MDX"
  - "Expressões Multidimensionais [Reporting Services]"
  - "Previsão de Mineração de Dados [Reporting Services]"
  - "MDX [Reporting Services], definindo parâmetros"
...
3.  Na barra de ferramentas do designer de consulta MDX, clique em **Parâmetros de Consulta** \(![Ícone da caixa de diálogo Parâmetros de Consulta](../../reporting-services/report-data/media/iconqueryparameter.png "Ícone da caixa de diálogo Parâmetros de Consulta")). A caixa de diálogo Parâmetros de Consulta é exibida.  
