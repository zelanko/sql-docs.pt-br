...
# <a name="filestream-support-ole-db"></a>Suporte a FILESTREAM (OLE DB)
  Começando com [!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)] e [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 10.0, o OLE DB dá suporte ao recurso FILESTREAM aprimorado. Para obter mais informações sobre esse recurso, consulte [suporte a FILESTREAM](../features/filestream-support.md). Para obter exemplos, consulte [Filestream e BD OLE](../../native-client-ole-db-how-to/filestream/filestream-and-ole-db.md).  
