...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento Missing Join Predicate indica que uma consulta está sendo executada sem nenhum predicado de junção. Isso pode resultar em uma consulta de longa execução. Para obter mais informações sobre predicados de junção, consulte [Predicados &#40;Transact-SQL&#41;](~/t-sql/queries/predicates.md).  
