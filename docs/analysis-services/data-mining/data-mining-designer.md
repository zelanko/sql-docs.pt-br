...
helpviewer_keywords: 
  ...
  - "estruturas de mineração [Analysis Services], modificando"
  - "editor de mineração de dados [Analysis Services]"
  - "Designer de Mineração de Dados"
  - "mineração de dados [Analysis Services], modificando"
...
## Guia Visualizador do Modelo de Mineração  
...
## Guia Gráfico de Precisão de Mineração  
...
## Guia Previsão do Modelo de Mineração  
