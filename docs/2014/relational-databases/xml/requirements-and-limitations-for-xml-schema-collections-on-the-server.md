...
|Informações de fuso horário|Na [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versões posteriores, informações de fuso horário é totalmente compatível com `xs:date`, `xs:time`, e `xs:dateTime` valores para validação de esquema XML. Com o modo de compatibilidade com versões anteriores do [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] , as informações de fuso horário sempre são normalizadas para o Tempo Universal Coordenado (Hora de Greenwich). Para elementos de tipo `dateTime`, o servidor converte a hora fornecida para GMT usando o valor de deslocamento ("-05:00") e retornando a hora GMT correspondente.|  
