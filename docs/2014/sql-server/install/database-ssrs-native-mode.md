...
ms.locfileid: "36010847"
---
# <a name="database-ssrs-native-mode"></a>Banco de dados (modo nativo do SSRS)
  Use a página Banco de Dados para criar e configurar os bancos de dados do servidor de relatório que fornecem armazenamento interno para uma ou mais instâncias do servidor de relatório. Se você estiver configurando um servidor de relatório para usar um banco de dados do servidor de relatório remoto, você deve usar o [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] do Configuration Manager para criar o banco de dados.  
 ...
 **Tipo de credencial**  
 Especifica credenciais que o servidor de relatório usa para conectar-se ao banco de dados do servidor de relatório. Tipos de credencial, você pode especificar incluem a conta de serviço, um usuário de domínio do Windows, o usuário do Windows local, ou [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] logon de banco de dados. Para obter mais informações sobre como selecionar credenciais, consulte [configurar uma Conexão de banco de dados do servidor de relatório &#40;SSRS Configuration Manager&#41;](../../../2014/sql-server/install/configure-a-report-server-database-connection-ssrs-configuration-manager.md).  
  
 **Nome do Usuário**  
 Especifica uma conta de usuário de domínio, se você estiver usando credenciais do Windows ou um [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] logon se você estiver usando [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] credenciais. Se você estiver usando credenciais do Windows, especifique-los neste formato:  *\<domínio >\\< conta\>*.  
