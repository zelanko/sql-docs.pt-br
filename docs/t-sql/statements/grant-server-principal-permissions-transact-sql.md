 ...
 *permission*  
 ...
 TO \<server_principal> Especifica o logon ou função de servidor [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ao qual a permissão está sendo concedida.  
