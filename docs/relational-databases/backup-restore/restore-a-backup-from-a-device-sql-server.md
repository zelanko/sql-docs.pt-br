...
description: Este artigo descreve como restaurar um backup de um dispositivo no SQL Server usando o SQL Server Management Studio ou o Transact-SQL.
ms.custom: ''
ms.date: 08/01/2016
ms.prod: sql
