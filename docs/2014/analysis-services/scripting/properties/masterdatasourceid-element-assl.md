...
## <a name="remarks"></a>Remarks  
 ...
 O elemento que corresponde ao pai de `MasterDatasourceID` no objeto Analysis Management Objects (AMO) o modelo é <xref:Microsoft.AnalysisServices.Database>.  
