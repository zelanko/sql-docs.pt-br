...
description: Descubra relatórios de detalhamento, que são abertos quando você seleciona um link em um relatório para obter detalhes sobre um item em um relatório de resumo original no Construtor de Relatórios.
ms.date: 03/07/2017
