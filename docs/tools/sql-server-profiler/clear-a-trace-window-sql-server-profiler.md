...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Este tópico descreve como limpar a janela de rastreamento de um rastreamento que está sendo executado usando [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
