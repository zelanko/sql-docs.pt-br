...
## <a name="remarks"></a>Remarks  
 Esse método supportsCatalogsInPrivilegeDefinitions é especificado pelo método supportsCatalogsInPrivilegeDefinitions na interface DatabaseMetadata.  
