...
[!INCLUDE [SQL Server Azure SQL Database ](../includes/applies-to-version/sqlserver.md)]
 ...
 A XQuery é uma linguagem que pode consultar dados XML estruturados ou semiestruturados. Com o suporte ao tipo de dados **XML** fornecido no [!INCLUDE[ssDE](../includes/ssde-md.md)] , os documentos podem ser armazenados em um banco de dado e consultados usando o XQuery.  
