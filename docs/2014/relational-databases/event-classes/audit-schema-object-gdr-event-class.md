...
# <a name="audit-schema-object-gdr-event-class"></a>Classe de evento Audit Schema Object GDR
  A classe de evento **Audit Schema Object GDR** ocorre sempre que uma concessão, revogação ou negação é emitida para uma permissão de objeto [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de esquema por qualquer usuário no.  
