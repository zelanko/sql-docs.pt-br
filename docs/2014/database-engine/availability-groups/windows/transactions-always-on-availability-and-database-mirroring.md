---
title: Transações entre bancos de dados não tem suporte para espelhamento de banco de dados ou AlwaysOn grupos de disponibilidade (SQL Server) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
