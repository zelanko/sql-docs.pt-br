...
ms.author: douglasl
manager: jhubbard
ms.openlocfilehash: c1ebe163af6adfc2bd59c95ac6d2ab76b9f886df
...
|InsertMethod|Inteiro (enumeração)|O método usado para inserir os dados. Os valores possíveis são Linha a linha (0) e Lote (1). O valor padrão é Lote (1).<br /><br /> Para obter mais informações sobre essas opções, consulte “Opções de carregamento” em [ODBC Destination](odbc-destination.md).|  
