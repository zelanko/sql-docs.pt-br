...
||||
|---|---|---|
|[SQL Server](create-workload-group-transact-sql.md?view=sql-server-2017)|**_Instância gerenciada do \*Banco de Dados SQL<br /> \*_** &nbsp;|[Azure Synapse<br />Analytics](create-workload-group-transact-sql.md?view=azure-sqldw-latest)|
||||
