...
4.  Na janela Propriedades, defina o valor da propriedade **AttributeHierarchyEnabled** como **False** para os atributos selecionados.  
    ...
    ![Propriedade AttributeHierarchyEnabled definida como falsa](../media/l4-hierarchyenabled-1.gif "propriedade AttributeHierarchyEnabled definida como False")  
...
4.  Na janela Propriedades, defina o valor da propriedade **AttributeHierarchyVisible** como **False** para os atributos selecionados.  
    ...
    ![A propriedade AttributeHierarchyVisible definida como falsa](../media/l4-hierarchyvisible-1.gif "a propriedade AttributeHierarchyVisible definida como False")  
