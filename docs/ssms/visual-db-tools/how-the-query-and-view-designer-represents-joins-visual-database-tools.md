...
|----------------------|-------------------|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbih.gif":::|Junção interna (criada usando um sinal de igual).|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbii.gif":::|Junção interna baseada no operador "maior que".|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbij.gif":::|A junção externa em que todas as linhas da tabela representada à esquerda serão incluídas, mesmo se não tiverem correspondências na tabela relacionada.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbik.gif":::|A junção externa em que todas as linhas da tabela representada à direita serão incluídas, mesmo se não tiverem correspondências na tabela relacionada.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbil.gif":::|Junção externa completa na qual serão incluídas todas as linhas de ambas as tabelas, mesmo se elas não tiverem correspondências com a tabela relacionada.|  
...
|---------------------------------|--------------------|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbim.gif":::|Junção uma a uma.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbin.gif":::|Junção uma para muitas.|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbio.gif":::|O Designer de Consulta e Exibição não pode determinar o tipo de junção. Essa situação ocorre com mas frequência quando você cria uma junção manualmente.|  
