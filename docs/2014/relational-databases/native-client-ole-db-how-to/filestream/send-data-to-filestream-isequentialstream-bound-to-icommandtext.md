---
title: Enviar dados para uma coluna FILESTREAM usando ISequentialStream associado ao parâmetro ICommandText (OLE DB) | Microsoft Docs
ms.custom: ''
ms.date: 03/08/2017
...
## <a name="example"></a>Exemplo  
 Antes de compilar e executar esse exemplo, habilitar o suporte a FILESTREAM ([Enable and Configure FILESTREAM](../../blob/enable-and-configure-filestream.md)).  
