...
## <a name="remarks"></a>Remarks  
 Nenhuma outra operação pode ser chamada no [IBCPSession](ibcpsession-ole-db.md) interface depois de chamar o **BCPDone** método. A única possibilidade é chamar o [ibcpsession:: BCPInit](ibcpsession-bcpinit-ole-db.md) método para iniciar uma nova operação de cópia em massa. Isso é semelhante a chamar o [IRowsetFastLoad:: Commit](irowsetfastload-commit-ole-db.md) método.  
...
## <a name="return-code-values"></a>Valores do código de retorno  
 ...
 E_UNEXPECTED  
 A chamada para o método era inesperada. Por exemplo, o método **BCPInit** não foi chamado antes da chamada desse método.  
  
## <a name="example"></a>Exemplo  
 Este exemplo mostra como usar a interface **IBCPSession** .  
  
 O [!INCLUDE[tsql](../../includes/tsql-md.md)] a seguir deve ser executado antes de executar este exemplo:  
...
```  
 ...
 O exemplo conecta-se ao banco de dados mestre.  
  
 Quando o exemplo é executado, ele cria outfile.dat no diretório do projeto. O outfile.dat contém os dados copiados da tabela em modo nativo (binário).  
