---
title: Fazer backup e restaurar um banco de dados usando o SQL Operations Studio (preview) | Microsoft Docs
description: Saiba como fazer backup e restaurar um banco de dados usando o SQL Operations Studio (preview)
ms.custom: tools|sos
ms.date: 11/15/2017
...
5. Para exibir o status da operação de restauração, clique em **CTRL + T** para abrir o **histórico de tarefa** barra lateral.
