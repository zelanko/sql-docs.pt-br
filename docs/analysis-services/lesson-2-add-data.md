...
Para saber mais sobre como importar dados e os diferentes tipos de fontes de dados das quais você pode importar dados, consulte [Fontes de dados &#40;SSAS Tabular&#41;](../analysis-services/tabular-models/data-sources-ssas-tabular.md).  
...
6.  Na página **Informações sobre Representação** , é necessário especificar as credenciais que o Analysis Services usará para se conectar à fonte de dados ao importar e processar dados. Verifique se a opção **Nome de usuário e senha específicos do Windows** está selecionada e, em **Nome de Usuário** e **Senha**, insira suas credenciais de logon do Windows e clique em **Avançar**.  
    ...
    > [!NOTE]  
    > O uso de uma conta de usuário e senha do Windows é o método mais seguro de conexão a uma fonte de dados. Para obter mais informações, consulte [Representação &#40;SSAS de Tabela&#41;](../analysis-services/tabular-models/impersonation-ssas-tabular.md).  
...
## Próxima etapa  
Para continuar este tutorial, vá para a próxima lição: [Lição 3: Renomear colunas](../analysis-services/lesson-3-rename-columns.md).  
