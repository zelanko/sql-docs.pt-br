...
---
# Tipos de replica&#231;&#227;o
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fornece os seguintes tipos de replicação para uso em aplicativos distribuídos:  
...
-   Replicação de instantâneo Para obter mais informações, consulte [a replicação de instantâneo](../../relational-databases/replication/snapshot-replication.md).  
