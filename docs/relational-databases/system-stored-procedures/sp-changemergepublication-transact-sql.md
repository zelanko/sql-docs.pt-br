...
|**conflict_retention**||Uma **int** que especifica o período de retenção em dias, para o qual os conflitos são retidos. Definindo *conflict_retention* à **0** significa que nenhuma limpeza de conflito é necessária.|  
 ...
 **sp_changemergepublication** é usado em replicação de mesclagem.  
 ...
 Alterar as propriedades a seguir requer que um instantâneo novo seja gerado. Você especifique um valor de **1** para o *force_invalidate_snapshot* parâmetro.  
