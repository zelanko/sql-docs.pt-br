...
helpviewer_keywords: 
  ...
  - "Editor de Códigos [SQL Server Management Studio], sobre o Editor de Consultas"
  - "Editor de Consultas [SQL Server Management Studio], modo de tela inteira"
  - "Editor de Consultas [Mecanismo de Banco de Dados], modelos"
  - "modo de tela inteira [SQL Server Management Studio]"
  - "SQL Server Management Studio [SQL Server], modelos"
  - "gravando scripts"
  - "modificando scripts"
  - "SQL Server Management Studio [SQL Server], editor de consultas"
  - "Editor de Consultas [SQL Server Management Studio], sobre o Editor de Consultas"
  - "gravando consultas"
 ...
 **Modo SQLCMD**  
 Executa scripts [!INCLUDE[tsql](../../includes/tsql-md.md)] que incluem o conjunto de comandos com suporte no utilitário sqlcmd. Para saber mais, confira [Tópicos de instruções do sqlcmd](../Topic/sqlcmd%20How-to%20Topics.md).  
...
|Descreve como exibir e usar os recursos básicos do Editor de Consultas MDX.|[Editor de Consultas MDX &#40;Analysis Services - Dados Multidimensionais&#41;](../Topic/MDX%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)|  
|Descreve como exibir e usar os recursos básicos do Editor de Consultas DMX.|[Editor de Consultas DMX &#40;Analysis Services – Mineração de Dados&#41;](../Topic/DMX%20Query%20Editor%20\(Analysis%20Services%20-%20Data%20Mining\).md)|  
