...
description: Saiba mais detalhes sobre as diversas configurações de informações de dispositivo que você pode usar para renderizar em formato XML.
ms.date: 03/16/2017
