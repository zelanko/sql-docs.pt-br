...
-   [Etapa 1: Copiando o pacote da Lição 1](../integration-services/step-1-copying-the-lesson-1-package.md)  
  
-   [Etapa 2: adicionando e configurando o contêiner Loop Foreach](../integration-services/step-2-adding-and-configuring-the-foreach-loop-container.md)  
...
-   [Etapa 4: Testando o pacote de tutorial da Lição 2](../integration-services/step-4-testing-the-lesson-2-tutorial-package.md)  
