...
2.  Iniciar a coleta de contadores de desempenho para o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **: Gerenciador de buffer**, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **: Gerenciador de memória**.  
