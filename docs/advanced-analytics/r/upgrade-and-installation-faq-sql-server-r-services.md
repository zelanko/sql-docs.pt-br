...
+ Atualize para a versão mais atual ou versão de serviço assim que possível, resolver quaisquer problemas que foram corrigidos em versões recentes.
