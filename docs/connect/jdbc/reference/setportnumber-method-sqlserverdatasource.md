...
> [!NOTE]  
>  O método setPortNumber não faz nenhuma verificação de intervalo no valor de porta passado. Você pode passar um número de porta que não é válido, como 99999, sem disparar um erro.  
