...
description: Saiba mais sobre a função CountRows, que retorna o número de linhas em um escopo especificado, incluindo linhas com valores nulos.
ms.date: 03/07/2017
