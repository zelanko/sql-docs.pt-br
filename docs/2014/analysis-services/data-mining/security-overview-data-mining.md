...
##  <a name="security-architecture"></a><a name="bkmk_Architecture"></a>Arquitetura de segurança  
...
##  <a name="configuring-the-logon-account-for-analysis-services"></a><a name="bkmk_Logon"></a> Configurando a conta de logon do Analysis Services  
...
##  <a name="securing-an-analysis-services-instance"></a><a name="bkmk_Instance"></a> Protegendo uma instância do Analysis Services  
...
##  <a name="configuring-access-to-analysis-services"></a><a name="bkmk_Access"></a> Configurando o acesso ao Analysis Services  
...
##  <a name="special-considerations-for-data-mining"></a><a name="bkmk_DMspecial"></a> Considerações especiais para mineração de dados  
