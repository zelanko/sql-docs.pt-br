---
title: "Propriedades para estruturas de minera&#231;&#227;o e colunas de estrutura | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "estruturas de mineração [Analysis Services], propriedades da coluna"
  - "mineração de dados [Analysis Services], propriedades"
  - "colunas [mineração de dados], propriedades"
...
## Propriedades de estruturas de mineração e colunas de estrutura de mineração  
...
### Propriedades da Estrutura de Mineração  
...
### Propriedades das colunas da estrutura de mineração  
