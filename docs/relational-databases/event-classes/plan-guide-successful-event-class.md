...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: Plan Guide Successful event class
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento Plan Guide Successful indica que o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] produziu com êxito um plano de execução para uma consulta ou lote que continha uma guia de plano. O evento dispara quando as seguintes condições forem verdadeiras:  
