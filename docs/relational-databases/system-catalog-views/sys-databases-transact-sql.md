...
|**contenção**|**tinyint não nulo**|Indica o status de contenção do banco de dados.<br />  0 = a contenção do banco de dados está desativada. **Aplica-se a**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e posterior) e [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br /> 1 = o banco de dados está em confinamento parcial **aplica-se a**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e posterior|  
...
|**physical_database_name**|**nvarchar(128)**|Por SQL Server, o nome físico do banco de dados. Para o banco de dados SQL do Azure, uma ID comum para os bancos de dados em um servidor. <br />**Aplica-se a**: SQL Server 2019 (15. x) e posterior e banco de dados SQL do Azure|
