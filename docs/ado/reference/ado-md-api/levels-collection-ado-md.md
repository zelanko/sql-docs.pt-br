---
title: Os níveis de coleção (ADO MD) | Microsoft Docs
ms.prod: sql
 ...
 **Níveis** é uma coleção padrão de ADO. Usando as propriedades e métodos de uma coleção, você pode fazer o seguinte:  
