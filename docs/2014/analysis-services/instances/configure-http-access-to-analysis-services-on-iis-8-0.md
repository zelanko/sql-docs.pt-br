...
##  <a name="step-1-copy-the-msmdpump-files-to-a-folder-on-the-web-server"></a><a name="bkmk_copy"></a>Etapa 1: copiar os arquivos MSMDPUMP para uma pasta no servidor Web  
