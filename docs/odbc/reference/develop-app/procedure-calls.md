 ...
 **{**[**? =**]**chamar** *nome do procedimento*[**(**[*parâmetro*] [**,**[*parâmetro*]]... **)**]**}**  
 ...
 Para obter mais informações sobre a sequência de escape da chamada de procedimento, consulte [sequência de Escape Call do procedimento](../../../odbc/reference/appendixes/procedure-call-escape-sequence.md) na gramática do apêndice c: SQL.  
