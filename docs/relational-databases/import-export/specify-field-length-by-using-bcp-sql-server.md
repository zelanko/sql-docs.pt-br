...
description: No SQL Server, se necessário, o bcp solicita o tamanho do campo, os tamanhos de campo padrão e o impacto do tamanho do campo no armazenamento de dados em arquivos que contêm dados char.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
