...
description: Saiba mais sobre a opção "remote proc trans". Veja como ele ajuda a proteger as ações de um procedimento de servidor para servidor por meio de uma transação do MS DTC.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
