---
title: Propriedades da fonte de dados (Driver do OLE DB) | Microsoft Docs
description: Saiba como o Driver do OLE DB para SQL Server implementa propriedades da fonte de dados, incluindo um conjunto de propriedades específicas do provedor com propriedades de fonte de dados adicionais.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
