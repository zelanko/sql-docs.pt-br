---
description: Enviar e receber dados de forma incremental com FILESTREAM (ODBC)
...
## <a name="example"></a>Exemplo  
 ...
 A primeira [!INCLUDE[tsql](../../includes/tsql-md.md)] listagem de código () cria um banco de dados usado por este exemplo. Sua instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] deve ter acesso de gravação para executar este script (por exemplo, faça logon como uma conta de sistema local).  
 ...
 A terceira [!INCLUDE[tsql](../../includes/tsql-md.md)] listagem de código () exclui o banco de dados usado por este exemplo.  
