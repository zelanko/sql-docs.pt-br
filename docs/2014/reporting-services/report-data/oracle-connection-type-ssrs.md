...
-   [Usando o .NET Framework provedor de dados para Oracle](https://go.microsoft.com/fwlink/?LinkId=112314) no msdn.Microsoft.com  
  
-   [Como usar Reporting Services para configurar e acessar uma fonte de dados Oracle](https://support.microsoft.com/kb/834305)  
  
-   [Como adicionar permissões para a entidade de segurança do serviço de rede](https://support.microsoft.com/kb/870668)  
