---
title: Caixa de diálogo de modelo (Analysis Services - dados multidimensionais) de nomeação de nível | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
