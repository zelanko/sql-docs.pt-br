 ...
 *object*  
 Um objeto de [classe ServerSettings](../../../relational-databases/wmi-provider-configuration-classes/serversettings-class/serversettings-class.md) que representa uma instância de cliente [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
