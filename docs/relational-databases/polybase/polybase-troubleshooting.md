...
[!INCLUDE[appliesto-ss-xxxx-asdw-pdw-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Para solucionar problemas do PolyBase, use as técnicas encontradas neste tópico.  
