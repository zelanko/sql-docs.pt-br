...
description: Saiba mais sobre como atualizar uma condição de teste personalizada do Visual Studio 2010 para uso no SQL Server Data Tools. Veja quais alterações fazer e como instalar a condição.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
