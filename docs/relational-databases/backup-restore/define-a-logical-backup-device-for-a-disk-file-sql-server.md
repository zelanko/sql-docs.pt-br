...
ms.topic: "article"
helpviewer_keywords: 
  - "dispositivos de backup [SQL Server], definindo"
...
#### Para definir um dispositivo de backup lógico para um arquivo de disco  
...
#### Para definir um backup lógico para um arquivo de disco  
