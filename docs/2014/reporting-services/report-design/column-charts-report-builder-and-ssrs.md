...
-   Exclusivo para gráficos de colunas é a habilidade de mostrar seu gráfico como um histograma ou gráfico de Pareto. Para fazer isso, defina a propriedade de propriedades como `Histogram` ou `Pareto` no janela Propriedades como. `true`  
