...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] A maioria das opções do [!INCLUDE[msCoName](../../includes/msconame-md.md)] IntelliSense estão ativadas por padrão. Você pode desativar a uma opção IntelliSense e no lugar dela invocar por meio de um comando de menu ou combinação de teclas.  
