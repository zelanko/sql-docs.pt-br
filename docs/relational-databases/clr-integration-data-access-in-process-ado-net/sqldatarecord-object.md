...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]O **SqlDataRecord** objeto representa uma única linha de dados, juntamente com seus metadados relacionados.  
