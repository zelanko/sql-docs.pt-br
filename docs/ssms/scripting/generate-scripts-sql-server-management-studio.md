...
Para obter um Tutorial detalhado sobre a criação de script de vários objetos usando o SSMS (SQL Server Management Studio), confira o [Tutorial: criando scripts no SSMS](../tutorials/scripting-ssms.md).
