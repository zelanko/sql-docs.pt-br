...
description: Saiba mais sobre srv_sendrow na API de procedimento armazenado estendido. srv_sendrow transmite uma linha de dados para o cliente.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
