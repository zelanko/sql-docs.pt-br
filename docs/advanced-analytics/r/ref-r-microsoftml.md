...
description: Introdução à biblioteca de funções do MicrosoftML no SQL Server 2016 R Services e SQL Server Serviços de Machine Learning com R.
ms.prod: sql
