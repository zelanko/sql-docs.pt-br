...
description: Saiba como ler uma coluna FILESTREAM em um arquivo usando a interface IBCPSession no Driver do OLE DB para SQL Server e gravar um arquivo de formato com este exemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
