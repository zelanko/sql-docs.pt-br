...
ms.openlocfilehash: 30c61d092b511138366d6fc1312b12a6c8207d35
...
|Nome|Description|  
|----------|-----------------|  
|público byte [] decryptColumnEncryptionKey (cadeia de caracteres masterKeyPath, encryptionAlgorithm de cadeia de caracteres, byte [] encryptedColumnEncryptionKey)|Descriptografa o valor criptografado especificado de uma coluna da chave de criptografia. O valor criptografado deve ser criptografado usando o certificado com o caminho da chave especificado e o algoritmo especificado.<br /><br /> **O formato do caminho da chave deve ser um dos seguintes:**<br /><br /> Impressão digital: < certificate_thumbprint ><br /><br /> Alias: < certificate_alias ><br /><br /> (Substitui o SQLServerColumnEncryptionKeyStoreProvider. decryptColumnEncryptionKey (cadeia de caracteres, cadeia de caracteres, Byte[]).)|  
|público byte [] encryptColumnEncryptionKey (cadeia de caracteres masterKeyPath, encryptionAlgorithm de cadeia de caracteres, byte [] plainTextColumnEncryptionKey)|Criptografa uma chave de criptografia de coluna usando o certificado com o caminho da chave especificado e o algoritmo especificado.<br /><br /> **O formato do caminho da chave deve ser um dos seguintes:**<br /><br /> Impressão digital: < certificate_thumbprint ><br /><br /> Alias: < certificate_alias ><br /><br /> (Substitui o SQLServerColumnEncryptionKeyStoreProvider. encryptColumnEncryptionKey (cadeia de caracteres, cadeia de caracteres, Byte[]).)|  
...
|Nome|Description|  
|----------|-----------------|  
|SQLServerColumnEncryptionAzureKeyVaultProvider pública (SQLServerKeyVaultAuthenticationCallback authenticationCallback, ExecutorService executorService)|Provedor de repositório de chaves para o Cofre de chaves do Azure.  Você precisa fornecer uma implementação da interface SQLServerKeyVaultAuthenticationCallback recuperar um token de acesso para a chave no cofre de chaves do Azure.|  
  
 Métodos  
  
|Nome|Description|  
|----------|-----------------|  
|público byte [] decryptColumnEncryptionKey (cadeia de caracteres masterKeyPath, encryptionAlgorithm de cadeia de caracteres, byte [] encryptedColumnEncryptionKey)|Descriptografa o valor criptografado especificado de uma coluna da chave de criptografia. O valor criptografado deve ser criptografada usando a chave da coluna especificada IDmaster chave e o algoritmo especificado. <br />(Substitui o SQLServerColumnEncryptionKeyStoreProvider. decryptColumnEncryptionKey (cadeia de caracteres, cadeia de caracteres, Byte[]).)|  
|público byte [] encryptColumnEncryptionKey (cadeia de caracteres masterKeyPath, encryptionAlgorithm de cadeia de caracteres, byte [] columnEncryptionKey)|Criptografa uma chave de criptografia de coluna usando a chave mestra de coluna especificada e o algoritmo especificado. <br />(Substitui o SQLServerColumnEncryptionKeyStoreProvider. encryptColumnEncryptionKey (cadeia de caracteres, cadeia de caracteres, Byte[]).)|  
|setName public void (nome de cadeia de caracteres)|Define o nome desse provedor de repositório de chaves.|
|público () getName de cadeia de caracteres|Obtém o nome desse provedor de repositório de chaves.|  
 ...
 **Enumeração SQLServerStatementColumnEncryptionSetting**  
