...
1. [Guia de solução de problemas e monitoramento dos Grupos de Disponibilidade Always On](availability-groups/windows/always-on-availability-groups-troubleshooting-and-monitoring-guide.md)
2. [Eventos estendidos de Grupos de Disponibilidade Always On](availability-groups/windows/always-on-extended-events.md)
3. [Log de diagnóstico de integridade de Grupos de Disponibilidade Always On](availability-groups/windows/always-on-health-diagnostics-log.md)
4. [Políticas de Grupos de Disponibilidade Always On](availability-groups/windows/always-on-policies.md)
5. [Buffers de anéis de Grupos de Disponibilidade Always On](availability-groups/windows/always-on-ring-buffers.md)
6. [Tipos de espera de Grupos de Disponibilidade Always On](availability-groups/windows/always-on-wait-types.md)
7. [CLUSTER.LOG (Grupos de Disponibilidade Always On)](availability-groups/windows/cluster-log-always-on-availability-groups.md)
8. [Exibições de gerenciamento dinâmico e exibições de catálogo do sistema (Grupos de Disponibilidade Always On)](availability-groups/windows/dynamic-management-views-and-system-catalog-views-always-on-availability-groups.md)
9. [Monitorar o desempenho de Grupos de Disponibilidade Always On](availability-groups/windows/monitor-performance-for-always-on-availability-groups.md)
10. [Log de erros do SQL Server (Grupos de Disponibilidade Always On)](availability-groups/windows/sql-server-error-log-always-on-availability-groups.md)
11. [Solução de problemas: o grupo de disponibilidade excedeu o RPO](availability-groups/windows/troubleshoot-availability-group-exceeded-rpo.md)
12. [Solução de problemas: o grupo de disponibilidade excedeu o RTO](availability-groups/windows/troubleshoot-availability-group-exceeded-rto.md)
13. [Solução de problema: as alterações na réplica primária não são refletidas na réplica secundária](availability-groups/windows/troubleshoot-primary-changes-not-reflected-on-secondary.md)
14. [Ferramentas úteis para solução de problemas](availability-groups/windows/useful-tools-for-troubleshooting.md)
