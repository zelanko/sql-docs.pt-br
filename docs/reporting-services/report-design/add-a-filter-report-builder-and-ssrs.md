...
description: Saiba como adicionar um filtro a um conjunto de dados, região de dados ou grupo quando quiser incluir ou excluir valores específicos para cálculos ou exibição.
ms.date: 03/07/2017
