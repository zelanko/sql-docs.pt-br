...
|Descreve como usar Informações de Parâmetro para obter informações sobre o número, nomes e tamanhos de parâmetros para uma função ou procedimento armazenado.|[Informações de parâmetro &#40;IntelliSense&#41;](parameter-info-intellisense.md)|  
...
|Descreve como levar o IntelliSense a concluir o resto de um identificador depois que você digita uma parte suficiente do nome para obter uma lista breve de objetos cujos nomes iniciam com a mesma cadeia de caracteres.|[Complete Word &#40;IntelliSense&#41;](complete-word-intellisense.md)|  
...
|Descreve as condições sob as quais o IntelliSense pode não funcionar.|[Solução de problemas do IntelliSense (SQL Server Management Studio)](troubleshooting-intellisense.md)|  
