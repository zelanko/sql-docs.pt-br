...
description: Exibições do sistema para o sistema de plataforma analítica (APS) SQL Server data warehouse paralelo (PDW).
author: mzaman1
ms.prod: sql
...
ms.locfileid: "74399807"
---
# <a name="system-views-for-analytics-platform-system-parallel-data-warehouse"></a>Exibições do sistema para o data warehouse paralelo do sistema de plataforma de análise
Exibições do sistema para o sistema de plataforma analítica (APS) SQL Server data warehouse paralelo (PDW).

## <a name="parallel-data-warehouse-catalog-views"></a>Exibições do catálogo de data warehouse paralelo
...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>DMVs (exibições de gerenciamento dinâmico) data warehouse paralelas
...
## <a name="sql-server-dmvs-applicable-to-parallel-data-warehouse"></a>SQL Server DMVs aplicáveis a data warehouse paralelos
As DMVs a seguir são aplicáveis a data warehouse paralelas, mas devem ser executadas conectando-se ao banco de dados **mestre** .
...
* [grupos de sys.](https://msdn.microsoft.com/library/ms187782.aspx)
...
## <a name="sql-server-dmvs-available-in-parallel-data-warehouse"></a>SQL Server DMVs disponíveis em paralelo data warehouse
O data warehouse paralelo expõe muitas das DMVs (exibições de gerenciamento dinâmico) SQL Server. Essas exibições, quando consultadas em paralelo data warehouse, estão relatando o estado de SQL Server bancos de dados em execução nas distribuições.

Cada uma dessas DMV tem uma coluna específica chamada pdw_node_id. Este é o identificador para o nó de computação. 

> [!NOTE]
> Para usar essas exibições, insira ' pdw_nodes_ ' no nome, conforme mostrado na tabela a seguir.
> 
> 

| Nome da DMV em paralelo data warehouse | Link para SQL Server tópico T-SQL |
|:--- |:--- |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-parallel-data-warehouse"></a>SQL Server DMVs do polybase 2016 disponíveis em paralelo data warehouse
...
## <a name="sql-server-information_schema-views"></a>Exibições INFORMATION_SCHEMA do SQL Server
...
* [PARÂMETROS](../relational-databases/system-information-schema-views/parameters-transact-sql.md)
* [ROTINAS](../relational-databases/system-information-schema-views/routines-transact-sql.md)
* [SCHEMATA](../relational-databases/system-information-schema-views/schemata-transact-sql.md)
* [TABELAS](../relational-databases/system-information-schema-views/tables-transact-sql.md)
...
* [Modos de exibição](../relational-databases/system-information-schema-views/views-transact-sql.md)

## <a name="next-steps"></a>Próximas etapas
Para obter mais informações de referência, consulte [elementos de linguagem t-SQL](tsql-language-elements.md) e [instruções T-SQL](tsql-statements.md).
