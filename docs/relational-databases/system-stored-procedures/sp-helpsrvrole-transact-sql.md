...
`[ @srvrolename = ] 'role'` É o nome da função de servidor fixa. *função* está **sysname**, com um padrão NULL. *função* pode ser um dos valores a seguir.  
...
|Descrição|**sysname**|Descrição do ServerRole|  
