...
description: Saiba mais sobre o processo de autorização no Reporting Services. Saiba como desenvolver extensões de segurança usando a interface IAuthorizationExtension2.
ms.date: 03/06/2017
