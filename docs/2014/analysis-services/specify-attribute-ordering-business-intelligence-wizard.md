 ...
 **Atributo de Ordenação**  
 ...
 Para criar um novo atributo de ordenação, selecione ** \<novo atributo>** e, na caixa de diálogo **selecionar uma coluna** , selecione a coluna na qual o novo atributo deve ser baseado.  
