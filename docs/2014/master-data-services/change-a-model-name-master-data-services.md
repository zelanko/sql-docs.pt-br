...
3.  Na página **manutenção do modelo** , na grade, clique na linha do modelo com o nome que você deseja alterar.  
  
    > [!NOTE]  
    >  Não é possível alterar o nome do modelo Metadata.  
  
4.  Clique em **Editar modelo selecionado**.  
  
5.  Na caixa **nome do modelo** , digite o nome atualizado do modelo.  
