...
description: Aprenda sobre as alterações feitas no OLE DB no Driver do OLE DB para SQL Server para dar suporte aos tipos definidos pelo usuário grandes no common language runtime.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
