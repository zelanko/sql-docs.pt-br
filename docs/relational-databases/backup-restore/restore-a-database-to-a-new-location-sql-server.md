...
description: Este artigo mostra como restaurar um banco de dados do SQL Server para um novo local e renomeá-lo usando o SQL Server Management Studio ou o Transact-SQL.
ms.custom: ''
ms.date: 08/05/2016
ms.prod: sql
