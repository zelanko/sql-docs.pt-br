...
description: Descubra como habilitar consultas distribuídas ad hoc no SQL Server. Em seguida, você pode usar OPENROWSET e OPENDATASOURCE para se conectar a fontes de dados OLE DB remotas.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
