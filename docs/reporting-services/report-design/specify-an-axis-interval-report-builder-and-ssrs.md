...
---
# Especificar um intervalo do eixo (Construtor de Relat&#243;rios e SSRS)
...
Para tentar definir o intervalo do eixo com dados de exemplo, consulte [Tutorial: Adicionar um gráfico de barras ao relatório (Construtor de Relatórios)](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md).
...
## Para mostrar todos os rótulos de categorias no eixo x  
...
## Alterar o intervalo de rótulo no painel Propriedades
...
## Para habilitar um cálculo do intervalo de variáveis em um eixo  
