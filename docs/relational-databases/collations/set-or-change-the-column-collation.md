...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] É possível substituir o agrupamento de banco de dados para dados **char**, **varchar**, **text**, **nchar**, **nvarchar** e **ntext** especificando um agrupamento diferente para uma coluna específica de uma tabela e usando uma das seguintes opções:  
