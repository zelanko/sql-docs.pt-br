...
###  <a name="HowToMigrateFiles"></a>Exemplo: migrar arquivos do sistema de arquivos para uma Filetable  
...
###  <a name="disabling"></a>Como desabilitar as restrições de Filetable para carregamento em massa  
