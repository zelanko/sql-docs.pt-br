...
ms.openlocfilehash: cf7be28b850e7b10f209c6d6194450d3ab8aecaf
ms.sourcegitcommit: f8ce92a2f935616339965d140e00298b1f8355d7
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 07/03/2018
ms.locfileid: "37426845"
---
...
|**Data e hora** valor trunca segundos fracionários e não de ida e volta se o arredondamento alterar o dia.|Anteriores ao [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 10.0, o comportamento do cliente para **datetime** valores enviados para o servidor é arredondá-los para o mais próximo 1/300º de segundo. A partir do [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 10.0, esse cenário provocará um truncamento de segundos fracionários, se o arredondamento alterar o dia.|  
...
|Inserindo uma cadeia de caracteres vazia em uma **sql_variant** associado como um tipo de data/hora gera um erro.|Na [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 9.0, inserindo uma cadeia de caracteres vazia em uma **sql_variant** vinculados como um tipo de data/hora não gerou um erro. O [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 10.0 (e posterior) gera corretamente um erro nessa situação.|  
