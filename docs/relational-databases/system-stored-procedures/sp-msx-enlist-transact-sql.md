...
## <a name="arguments"></a>Argumentos  
 ...
 O nome do servidor de administração multisservidor (mestre). *msx_server* está **sysname**, sem padrão.  
  
 [  **@location =**] **'***local***'**  
 O local do servidor de destino a ser adicionado. *local* está **nvarchar(100)**, com um padrão NULL.  
