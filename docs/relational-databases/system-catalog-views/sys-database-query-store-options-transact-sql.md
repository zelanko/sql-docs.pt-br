...
|**size_based_cleanup_mode_desc**|**nvarchar(60)**|Descrição textual do modo de limpeza de baseado no tamanho real da consulta Store:<br /><br /> OFF <br /><br /> AUTOMÁTICO (padrão)|  
...
|**wait_stats_capture_mode_desc**|**nvarchar(60)**|Descrição textual do modo de captura de estatísticas de espera real: <br /><br /> OFF <br /><br /> ATIVADO (padrão)<br /> **Aplica-se a**: do [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] ao [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].| 
