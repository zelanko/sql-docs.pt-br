...
description: Saiba como usar a guia Geral na caixa de diálogo Propriedades do Banco de Dados para ver ou modificar as propriedades de um banco de dados.
ms.custom: ''
ms.date: 10/27/2015
ms.prod: sql
ms.reviewer: ''
