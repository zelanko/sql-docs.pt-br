...
8.  Na página Segurança do Agente de Mesclagem, clique no botão de reticências (**…**), insira \<*Machine_Name>***\repl_merge** na caixa **Conta de processo**, forneça a senha dessa conta, clique em **OK**, em **Avançar** e em **Avançar** novamente.  
...
2.  Na página **Geral**, insira \<*Machine_Name>***\repl_merge** na caixa **Nome de usuário**, clique no botão de reticências (**…**); clique em **Procurar**, selecione \<*Machine_Name>***\repl_merge**, clique em **OK**, em **Verificar Nomes** e em **OK**.  
