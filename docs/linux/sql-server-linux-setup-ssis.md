...
5.  Após a instalação, execute `ssis-conf`. Para obter mais informações, consulte [configurar SSIS no Linux com o ssis conf](sql-server-linux-configure-ssis.md).
