...
description: Saiba mais sobre as políticas de segurança do Reporting Services, que especificam permissões para assemblies, extensões e expressões de relatório baseados em grupos de códigos.
ms.date: 03/14/2017
