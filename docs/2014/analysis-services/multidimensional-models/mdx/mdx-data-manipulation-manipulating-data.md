...
ms.locfileid: "55044442"
---
# <a name="manipulating-data-mdx"></a>Manipulando dados (MDX)

As expressões multidimensionais (MDX) podem ser usadas para manipular os dados de várias formas. O artigo listados no rosto neste artigo alguns dos conceitos mais avançados de manipulação de dados na linguagem MDX.
