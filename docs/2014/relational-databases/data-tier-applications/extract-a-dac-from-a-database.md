...
###  <a name="select-data-page"></a><a name="SelectData"></a>Página selecionar dados  
...
###  <a name="set-properties-page"></a><a name="SetProperties"></a>Página definir propriedades  
 ...
 **Descrição:** – Opcional. Descreve o DAC. Ao implantar um DAC, a descrição é armazenada no `msdb` banco de dados e, posteriormente, pode ser exibida no nó **aplicativos da camada data** no [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] .  
...
###  <a name="validation-and-summary-page"></a><a name="ValidateSummary"></a>Página validação e Resumo  
...
###  <a name="build-package-page"></a><a name="BuildPackage"></a>Página Criar pacote  
