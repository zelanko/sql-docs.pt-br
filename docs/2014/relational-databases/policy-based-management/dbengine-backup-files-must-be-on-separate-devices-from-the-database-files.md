...
Consulte [os arquivos de backup devem estar em dispositivos separados dos arquivos de banco de dados](../../database-engine/backup-files-must-be-on-separate-devices-from-the-database-files.md).
