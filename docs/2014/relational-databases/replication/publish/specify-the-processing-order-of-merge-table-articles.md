---
title: Especifique a ordem de processamento de artigos de tabela de mesclagem (programação Transact-SQL de replicação) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
