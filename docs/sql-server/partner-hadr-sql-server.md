...
|![hpe][4] |**HPE Serviceguard**<br>Proteja suas cargas críticas de trabalho do SQL Server 2017 no Linux®, de tempo de inatividade planejado ou não até uma grande quantidade de falhas de infraestrutura e de aplicativos em ambientes físicos e virtuais, em qualquer distância, com o HPE Serviceguard para Linux (SGLX). Como parte do programa Beta, X SGL HPE oferece opções sensíveis ao contexto de monitoramento e recuperação para a instância de Cluster de Failover e cargas de trabalho dos Grupos de Disponibilidade AlwaysOn do SQL Server. Maximize o tempo de atividade com HPE SGLX sem comprometer a integridade de dados e o desempenho.<br><br>SQL Server 2017 no Linux – RedHat 7.3, 7.4, SuSE 12 SP2, SP3|[Site][hpe_website]<br>[Folha de dados][hpe]<br>[Download][hpe_download]<br>[Twitter][hpe_twitter]
...
Para saber mais sobre alguns dos nossos outros parceiros, consulte [monitoramento][mon_partners], [parceiros de gerenciamento][management_partners] e [parceiros de desenvolvimento][dev_partners].
