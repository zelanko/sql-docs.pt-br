...
# <a name="create-an-embedded-or-shared-data-source-ssrs"></a>Criar uma fonte de dados inserida ou compartilhada (SSRS)
 ...
 No Designer de Relatórios, é possível criar fontes de dados compartilhadas ou inseridas. No painel dados do relatório, começar a criar uma referência de fonte de dados e, em seguida, selecione o **novo** opção. Depois de criar a referência de fonte de dados, uma nova fonte de dados compartilhada será automaticamente adicionada ao Gerenciador de Soluções sob a pasta de Fontes de dados Compartilhadas.  
...
3.  Para uma fonte de dados inserida, verifique se **inseridos conexão** está selecionado.  
    ...
    -   Digite a cadeia de conexão diretamente na caixa de texto **Cadeia de conexão** . Para obter uma lista de exemplos de cadeias de conexão, consulte [cadeias de caracteres de Conexão no construtor de relatórios, fontes de dados e conexões de dados](../../2014/reporting-services/data-connections-data-sources-and-connection-strings-in-report-builder.md) ou [conexões de dados, fontes de dados e cadeias de caracteres de Conexão no Reporting Services](../../2014/reporting-services/data-connections-data-sources-and-connection-strings-in-reporting-services.md).  
...
4.  Para uma fonte de dados compartilhada, verifique se **usar referência da fonte de dados compartilhada** está selecionado.  
...
-   No painel de dados do relatório, clique com botão direito a fonte de dados e, em seguida, clique em **converter em fonte de dados compartilhada**.  
...
-   No painel de dados do relatório, clique a fonte de dados e abra **propriedades da fonte de dados**.  
  
-   Clique em **Conexão inserida** e terminar de criar a fonte de dados inserida conforme descrito em um procedimento anterior.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Converter uma fonte de dados inserida em compartilhada &#40;SSRS e construtor de relatórios&#41;](report-data/convert-data-sources-report-builder-and-ssrs.md)   
