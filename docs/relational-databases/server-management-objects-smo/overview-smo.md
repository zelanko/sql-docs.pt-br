...
-   Servidores registrados dão suporte para registrar informações de conexão. Para obter mais informações, consulte [Register Servers](../../ssms/register-servers/register-servers.md).  
