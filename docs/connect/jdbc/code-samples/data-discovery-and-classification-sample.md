...
O arquivo de código desta amostra chama-se DataDiscoveryAndClassification.java e pode ser encontrado no seguinte local:  
...
Para executar este aplicativo de exemplo, é necessário definir o classpath para incluir o arquivo mssql-jdbc.jar. Para obter mais informações sobre como definir o classpath, confira [Usar o JDBC Driver](../../jdbc/using-the-jdbc-driver.md).
