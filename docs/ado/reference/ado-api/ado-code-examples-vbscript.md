...
ms.locfileid: "35275355"
---
# <a name="ado-code-examples-vbscript"></a>Exemplos de código ADO VBScript
Use os exemplos de código a seguir para saber mais sobre como usar os métodos de ADO ao gravar no Microsoft® Visual Basic® Scripting Edition (VBScript).  
...
-   [Execute, repetir e limpar o exemplo de métodos](../../../ado/reference/ado-api/execute-requery-and-clear-methods-example-vbscript.md)  
  
-   [Exemplo do método Move](../../../ado/reference/ado-api/move-method-example-vbscript.md)  
  
-   [MoveFirst, MoveLast, MoveNext e MovePrevious métodos exemplo](../../../ado/reference/ado-api/movefirst-movelast-movenext-and-moveprevious-methods-example-vbscript.md)  
