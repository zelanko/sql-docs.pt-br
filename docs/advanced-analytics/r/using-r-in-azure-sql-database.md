...
Enquanto isso, recomendamos que você use uma das máquinas virtuais 2017 do SQL Server que estão disponíveis no Azure Marketplace: 
...
+ [Profundidade aprendizado de máquina Virtual](https://docs.microsoft.com/azure/machine-learning/data-science-virtual-machine/deep-learning-dsvm-overview), 
