 ...
 *start_time*  
 ...
 Somente as linhas em CDC. < capture_instance > _CT tabela de alteração que tenha uma hora de confirmação associada maior que *start_time* são incluídas no conjunto de resultados.  
...
-   @closed_high_end_point = 1  
     ...
     Somente as linhas em CDC. < capture_instance > _CT tabela de alteração que tenha uma hora de confirmação associada menor ou igual a end_time estão incluídas no conjunto de resultados.  
