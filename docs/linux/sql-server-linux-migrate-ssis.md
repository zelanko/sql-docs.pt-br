...
Para começar a usar o SSIS, baixe a versão mais recente do [SQL Server Data Tools (SSDT)](/sql-docs/docs/integration-services/ssis-how-to-create-an-etl-package).

## <a name="see-also"></a>Consulte também
- [Saiba mais sobre o SQL Server Integration Services](/sql-docs/docs/integration-services/sql-server-integration-services)
- [Ferramentas de gerenciamento e desenvolvimento do SQL Server Integration Services (SSIS)](/sql-docs/docs/integration-services/integration-services-ssis-development-and-management-tools)
- [Tutoriais do SQL Server Integration Services](/sql-docs/docs/integration-services/integration-services-tutorials)
