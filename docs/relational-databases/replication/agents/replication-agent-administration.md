...
ms.topic: "article"
helpviewer_keywords: 
  - "Agente de Instantâneo, administrando"
  - "Log Reader Agent, administrando"
  - "Queue Reader Agent, administrando"
  - "agentes compartilhados [replicação do SQL Server]"
  - "Agente de Mesclagem, administrando"
  - "Agente de Distribuição, administrando"
  - "agentes [replicação do SQL Server], administrando"
  - "trabalhos de limpeza de replicação [SQL Server]"
  - "administrando a replicação, agentes"
  - "replicação [SQL Server], administrando"
  - "agentes independentes [replicação do SQL Server]"
...
|[Agente de Distribuição de Replicação](../../../relational-databases/replication/agents/replication-distribution-agent.md)|distrib.exe|  
|[Replication Agente de Leitor de Log](../../../relational-databases/replication/agents/replication-log-reader-agent.md)|logread.exe|  
...
-   [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] e Replication Monitor: [Iniciar e parar um agente de replicação e 40; SQL Server Management Studio e 41;](../../../relational-databases/replication/agents/start-and-stop-a-replication-agent-sql-server-management-studio.md)  
...
|Verificação dos agentes de replicação|Detecta agentes de replicação que não estão ativamente fazendo log no histórico. Grava o [!INCLUDE[msCoName](../../../includes/msconame-md.md)] log de eventos do Windows se uma etapa de trabalho falhar.|Executa a cada dez minutos.|  
