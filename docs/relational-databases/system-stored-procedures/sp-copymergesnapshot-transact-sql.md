...
[!INCLUDE[appliesto-ss-asdbmi-xxxx-xxx-md](../../includes/appliesto-ss-asdbmi-xxxx-xxx-md.md)]
  ...
  Copia a pasta de instantâneo da publicação especificada para a pasta listada no **destination_folder de\@** . Esse procedimento armazenado é executado no Publicador, no banco de dados publicador.  
 ...
 **sp_copymergesnapshot** é usado na replicação de mesclagem. Os assinantes que executam o [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] versão 7,0 e anteriores não podem usar o local de instantâneo alternativo.  
