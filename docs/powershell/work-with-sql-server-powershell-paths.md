...
description: Saiba como processar e recuperar informações usando os cmdlets ou os métodos e as propriedades do objeto identificado pelo caminho do provedor.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
##  <a name="using-methods-and-properties"></a><a name="UsePropMeth"></a> Usando métodos e propriedades  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Converter URNs em caminhos de provedor SQL Server](/powershell/module/sqlserver/Convert-UrnToPath)   
