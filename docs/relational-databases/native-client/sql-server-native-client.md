---
title: Cliente nativo do servidor SQL | Microsoft Docs
ms.date: 04/14/2017
ms.prod: sql
ms.reviewer: ''
ms.custom: ''
...
ms.locfileid: "81305012"
---
# <a name="sql-server-native-client"></a>SQL Server Native Client
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

SNAC, ou SQL Server Native Client, é um termo que tem sido usado de forma intercambiável para se referir aos drivers ODBC e OLE DB para SQL Server.
...
> [!NOTE]
> Para obter mais informações e baixar os drivers SNAC ou ODBC, consulte o [ciclo de vida explicado pelo SNAC.](https://blogs.msdn.microsoft.com/sqlreleaseservices/snac-lifecycle-explained/)
> Para obter mais informações sobre o Driver ODBC para SQL Server, consulte [Microsoft ODBC Driver for SQL Server](../../connect/odbc/microsoft-odbc-driver-for-sql-server.md).  
 ...
 Informações sobre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] os recursos [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]do Cliente Nativo lançados com , a última versão disponível do Cliente nativo do SQL Server:
...
O ODBC no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client suporta três recursos que foram adicionados ao ODBC padrão no SDK do Windows 7:  
...
-   Extensibilidade do tipo de dados C. Para obter mais informações, consulte [Tipos de dados C em ODBC](https://go.microsoft.com/fwlink/?LinkID=191495).  
     ...
     Para suportar esse [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] recurso no Cliente Nativo, o SQLGetDescField pode retornar **SQL_C_SS_TIME2** (para tipos **de tempo)** ou **SQL_C_SS_TIMESTAMPOFFSET** (para **datetimeoffset)** em vez de **SQL_C_BINARY**, se o aplicativo usar ODBC 3.8. Para obter mais informações, consulte [o suporte ao tipo de dados para melhorias de data e hora do ODBC](../../relational-databases/native-client-odbc-date-time/data-type-support-for-odbc-date-and-time-improvements.md).  
...
[Instale o cliente nativo do sql server](../../relational-databases/native-client/applications/installing-sql-server-native-client.md)  
