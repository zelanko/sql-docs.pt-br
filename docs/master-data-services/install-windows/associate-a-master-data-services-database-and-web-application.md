---
title: Associar um banco de dados do Master Data Services e o aplicativo Web | Microsoft Docs
ms.custom: 
ms.date: 03/17/2017
...
-   [!INCLUDE[ssMDScfgmgr](../../includes/ssmdscfgmgr-md.md)]deve ser instalado no computador local. Para obter mais informações, confira [Instalar o Master Data Services](../../master-data-services/install-windows/install-master-data-services.md).  
