...
|**Gravado**|A tarefa irá substituir logons de mesmo nome no servidor de destino.|  
|**Saltar**|A tarefa irá ignorar os logons de mesmo nome que existem no servidor de destino.|  
