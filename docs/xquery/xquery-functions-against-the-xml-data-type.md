...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  Este tópico e seus subtópicos descrevem as funções que você pode usar ao especificar XQuery em relação a **xml** tipo de dados. Para as especificações de W3C, consulte [ http://www.w3.org/TR/2004/WD-xpath-functions-20040723 ](https://go.microsoft.com/fwlink/?LinkId=4873).  
...
|[Funções do Acessador de Dados](../xquery/data-accessor-functions.md)|[string](../xquery/data-accessor-functions-string-xquery.md)|  
