...
description: Saiba como especificar tipos de parâmetros e associar dados de parâmetros na execução de um comando com parâmetros com valor de tabela no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
