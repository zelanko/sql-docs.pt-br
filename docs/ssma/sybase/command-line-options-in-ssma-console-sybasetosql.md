...
ms.author: Shamikg
manager: craigg
ms.openlocfilehash: 7a5ae295409758d1dc2babb40f81b5dc7ff54d26
...
Você não pode inserir qualquer outra opção ou senha como o parâmetro de linha de comando. Caso contrário, isso resulta em erro. Para obter mais informações, consulte o [gerenciar senhas](http://msdn.microsoft.com/en-us/9b6a70f9-6840-4140-a059-bb7bd7ccc67c) seção.  
