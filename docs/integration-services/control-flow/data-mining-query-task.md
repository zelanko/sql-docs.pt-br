...
helpviewer_keywords: 
  ...
  - "Tarefa Consulta de Mineração de Dados [Integration Services]"
...
## Configuração da tarefa Consulta de Mineração de Dados  
...
## Configuração programática da tarefa Consulta de Mineração de Dados  
