---
title: "Configurar a pol&#237;tica de failover flex&#237;vel para controlar condi&#231;&#245;es de failover autom&#225;tico (grupos de disponibilidade AlwaysOn) | Microsoft Docs"
ms.custom: ""
ms.date: "03/29/2017"
...
2.  Ao adicionar uma réplica de disponibilidade a um grupo de disponibilidade, use o cmdlet **New-SqlAvailabilityGroup**. Ao modificar uma réplica de disponibilidade existente, use o cmdlet **Set-SqlAvailabilityGroup**.  
    ...
    -   Para definir o tempo limite de verificação de integridade, use o parâmetro **HealthCheckTimeout***n*, em que *n* é um número inteiro de 15000 milissegundos (15 segundos) a 4294967295 milissegundos. O valor padrão é 30000 milissegundos (30 segundos).  
