---
title: sys.DM fts_index_keywords (Transact-SQL) | Microsoft Docs
ms.custom: 
ms.date: 03/14/2017
...
## <a name="arguments"></a>Argumentos  
 db_id ('*database_name*')  
 Uma chamada para o [db_id](../../t-sql/functions/db-id-transact-sql.md) função. Essa função aceita um nome de banco de dados e retorna a ID de banco de dados, que **sys.DM fts_index_keywords** usa para localizar o banco de dados especificado. Se *database_name* for omitido, a ID do banco de dados atual será retornada.  
...
|-----------------|---------------|-----------------|  
|**palavra-chave**|**nvarchar(4000)**|A representação hexadecimal da palavra-chave armazenada dentro do índice de texto completo.<br /><br /> Observação: OxFF representa o caractere especial que indica o final de um arquivo ou conjunto de dados.|  
