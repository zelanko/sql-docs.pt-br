...
description: A Função Previous no Construtor de Relatórios retorna o valor ou o valor de agregação especificado para a instância anterior de um item.
ms.date: 03/07/2017
