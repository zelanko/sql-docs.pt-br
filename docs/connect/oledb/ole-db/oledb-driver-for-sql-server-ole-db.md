---
title: Driver do OLE DB para SQL Server (OLE DB) | Microsoft Docs
description: Driver do OLE DB para SQL Server (OLE DB)
ms.custom: ''
ms.date: 03/26/2018
...
---
# <a name="ole-db-driver-for-sql-server-ole-db"></a>Driver do OLE DB para SQL Server (OLE DB)
