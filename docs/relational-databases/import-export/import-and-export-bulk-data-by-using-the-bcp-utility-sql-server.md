...
description: Use o bcp para exportar dados de qualquer lugar em um banco de dados do SQL Server no qual a instrução SELECT funcione. Exporte dados em massa de uma tabela ou de uma consulta e importe dados em massa de um arquivo.
ms.prod: sql
