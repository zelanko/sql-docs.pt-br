...
## <a name="remarks"></a>Remarks  
 Esse método storesMixedCaseQuotedIdentifiers é especificado pelo método storesMixedCaseQuotedIdentifiers na interface DatabaseMetadata.  
