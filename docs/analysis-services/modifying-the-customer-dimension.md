...
manager: "erikre"
---
# Modificando a dimens&#227;o Cliente
...
3.  Altere os nomes dos seguintes atributos da mesma maneira:  
    ...
    -   Atributo **Nome do Estado ou da Província** – altere para **Estado/Província**  
...
[Modificando a dimensão Produto](../analysis-services/modifying-the-product-dimension.md)  
...
[Remover um atributo de uma dimensão](../analysis-services/multidimensional-models/remove-an-attribute-from-a-dimension.md)  
[Renomear um atributo](../analysis-services/multidimensional-models/rename-an-attribute.md)  
