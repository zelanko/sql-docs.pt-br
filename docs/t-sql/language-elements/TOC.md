...
# [Comentário de barra de estrela](slash-star-comment-transact-sql.md)  
...
# [Barra invertida](sql-server-utilities-statements-backslash.md)  
...
### [+ (Somar)](add-transact-sql.md)  
### [+= (Adicionar EQUALS)](add-equals-transact-sql.md)  
### [- (Subtrair)](subtract-transact-sql.md)  
### [-= (Subtrair EQUALS)](subtract-equals-transact-sql.md)  
...
### [+= (Concatenação de cadeias de caracteres)](string-concatenation-equal-transact-sql.md)  
### [Caractere de percentagem (Curinga – Caracteres para corresponder)](percent-character-wildcard-character-s-to-match-transact-sql.md)  
