---
title: "Atualiza&#231;&#227;o do Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, atualizando"
  - "SSIS, atualizando"
  - "SQL Server Integration Services, atualizando"
...
>   
>  Para obter informações sobre outros recursos descontinuados, consulte [Funcionalidade do Integration Services descontinuada no SQL Server 2016](../Topic/Discontinued%20Integration%20Services%20Functionality%20in%20SQL%20Server%202016.md).  
...
## Atualizando o Integration Services e o Mecanismo de Banco de Dados para o [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
## Atualizando somente o Mecanismo de Banco de Dados para o [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 Esta seção descreve os efeitos da execução de uma atualização que tem os seguintes critérios:  
