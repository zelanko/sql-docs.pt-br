...
|Valor|Description|  
|-----------|-----------------|  
|**Adicionar**|Adiciona *column_name* de *qualified_table_name* para índice de texto completo inativo da tabela. Esta ação habilita a coluna para indexação de texto completo.|  
