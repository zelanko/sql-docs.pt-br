---
title: IBCPSession::BCPDone (driver do OLE DB) | Microsoft Docs
description: Saiba como o método IBCPSession::BCPDone confirma as linhas restantes a serem enviadas ao SQL Server no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
