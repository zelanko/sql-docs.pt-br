...
|[Filhos](../../../ado/reference/ado-md-api/children-property-ado-md.md)|Retorna uma coleção de **Membros** para os quais o **membro** atual é o pai na hierarquia.|  
|[Count](../../../ado/reference/ado-api/count-property-ado.md)|Indica o número de objetos em uma coleção.|  
|[Depth](../../../ado/reference/ado-md-api/depth-property-ado-md.md)|Indica o número de níveis entre o **nível** e a raiz do nível da hierarquia.|  
