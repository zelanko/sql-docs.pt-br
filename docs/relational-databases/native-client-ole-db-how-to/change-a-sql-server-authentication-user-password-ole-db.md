---
description: Alterar uma senha de usuário de autenticação do SQL Server Native Client (OLE DB)
...
ms.locfileid: "97476127"
---
# <a name="change-a-sql-server-native-client-authentication-user-password-ole-db"></a>Alterar uma senha de usuário de autenticação do SQL Server Native Client (OLE DB)
...
## <a name="example"></a>Exemplo  
 ...
 Para compilar este exemplo, você precisa de uma conta de usuário da Autenticação do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cuja senha você conhece. Para permitir logons sob a Autenticação do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], abra o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Management Studio, clique com o botão direito do mouse no nó Servidor no Pesquisador de Objetos e selecione Propriedades. Selecione Segurança e habilite o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] e o modo de Autenticação do Windows. Para adicionar uma conta de usuário sob a Autenticação do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], clique com o botão direito do mouse no nó no Pesquisador de Objetos e selecione Adicionar.  
