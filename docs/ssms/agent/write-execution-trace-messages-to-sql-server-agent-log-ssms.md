...
3.  Na caixa de diálogo **Propriedades do SQL Server Agent Properties –**_server\_name_, em **Log de erros** na página **Geral**, marque a caixa de seleção **Incluir mensagens de rastreamento de execução**.  
