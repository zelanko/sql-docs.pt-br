...
|**(3)**|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]aplicativo de serviço.|  
...
|**05**|Execute o **spPowerPivot.msi** para instalar provedores de dados, a ferramenta de configuração do [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] , a Galeria [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] e a atualização de dados da agenda.|  
...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a>Implantação do PowerPivot para SharePoint Server 2013 2  
 ...
 ![Implantação de servidor de modo 2 do SSAS PowerPivot](https://docs.microsoft.com/analysis-services/analysis-services/media/as-powerpivot-mode-2server-deployment.gif "Implantação de servidor de modo 2 do SSAS PowerPivot")  
  
|||  
|-|-|  
|**uma**|Aplicativo de Serviços do Excel. O aplicativo de serviço é criado como parte da instalação do SharePoint.|  
|**2**|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]Aplicativo de serviço. O nome padrão é **Aplicativo de Serviço PowerPivot Padrão**.|  
|**(3)**|Execute o próprio **PowerPivot. msi** para instalar provedores de dados, [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] a ferramenta de [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] configuração, a galeria e a atualização de dados de agendamento.|  
|**(4)**|Um servidor do [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] em modo SharePoint. Defina as **Configurações de Modelo de Dados** do Aplicativo de Serviços do Excel para usar este servidor.|  
