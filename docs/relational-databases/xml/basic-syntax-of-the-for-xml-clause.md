...
ms.topic: "article"
helpviewer_keywords: 
  - "diretiva BINARY BASE64"
  - "diretiva ROOT"
  - "cláusula FOR XML, diretiva BINARY BASE64"
  - "cláusula FOR XML, sintaxe"
  - "Cláusula FOR XML, diretiva ROOT"
...
>  A diretiva XMLDATA para a opção FOR XML foi preterida. Use geração de XSD no caso dos modos RAW e AUTO. Não há substituição para a diretiva XMLDATA no modo EXPLICIT. [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]  
 ...
 Esta é a sintaxe básica descrita na [Cláusula FOR (Transact-SQL)](../Topic/FOR%20Clause%20\(Transact-SQL\).md):  
