...
description: Saiba como renderizar um relatório com base em um instantâneo de histórico de relatório fornecendo o parâmetro rs:Snapshot e definindo seu valor como uma ID de instantâneo válida.
ms.date: 03/01/2017
