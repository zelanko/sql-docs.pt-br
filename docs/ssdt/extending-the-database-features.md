---
title: Estender os recursos de banco de dados
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
...
ms.locfileid: "75241659"
---
# <a name="extending-the-database-features"></a>Estender os recursos de banco de dados

Você pode criar extensões de recurso que lhe permitem estender os recursos de teste de unidade e análise de código do banco de dados. Para obter mais informações, consulte estes tópicos:  
