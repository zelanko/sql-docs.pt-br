...
# <a name="perspectiveaction-data-type-assl"></a>Tipo de dados PerspectiveAction (ASSL)
  Define um tipo de dados primitivo que representa informações sobre uma ação em um [perspectiva](../../../analysis-services/scripting/objects/perspective-element-assl.md) elemento.  
