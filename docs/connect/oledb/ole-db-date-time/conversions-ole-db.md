...
description: Saiba como o Driver do OLE DB para SQL Server faz a conversão entre os valores datetime e datatimeoffset. Há várias regras gerais de conversão.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
