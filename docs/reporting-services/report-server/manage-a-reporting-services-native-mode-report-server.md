...
description: Veja estes artigos ao configurar um servidor de relatório de modo nativo ou ao configurar um serviço de relatório para ser executado no modo integrado do SharePoint.
ms.date: 05/14/2019
...
### <a name="advanced-or-optional-configuration"></a>Configuração avançada ou opcional  
 ...
 [Ativar ou desativar recursos do Reporting Services](../../reporting-services/report-server/turn-reporting-services-features-on-or-off.md)  
