...
|Texto da mensagem|Erro de tabela: Diretório de FileStream para a ID de coluna C_ID da ID de objeto O_ID, ID de índice I_ID, ID de partição PN_ID não foi encontrado.|  
