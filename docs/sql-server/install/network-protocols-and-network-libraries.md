...
helpviewer_keywords: 
  ...
  - "opções de configuração [SQL Server], protocolos"
  - "bibliotecas de rede [SQL Server]"
  - "protocolos [SQL Server], sobre protocolos de rede"
  - "pipes [SQL Server]"
  - "protocolos de rede [SQL Server]"
  - "configurações padrão do SQL Server"
  - "biblioteca [SQL Server]"
  - "protocolos de rede [SQL Server], sobre protocolos de rede"
  - "opções de configuração [SQL Server], bibliotecas"
...
-   [!INCLUDE[tsql](../../includes/tsql-md.md)] TCP padrão  
 ...
 Para obter mais informações sobre configurações de rede do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], consulte os seguintes tópicos nos Manuais Online do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]:  
