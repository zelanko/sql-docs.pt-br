...
É recomendável que você configure o portal da web para que você possa conceder acesso de usuário para o servidor de relatório e gerenciar o conteúdo do servidor de relatório. Se você implantar um servidor de relatório no modo integrado do SharePoint, use o front-end da Web de um servidor SharePoint para conceder acesso.  
...
## <a name="next-steps"></a>Next Steps  
 Para concluir a implantação, configure o portal da Web ou a integração com o SharePoint. Para obter mais informações, consulte [configurar o portal da web](../../reporting-services/report-server/configure-web-portal.md).  
