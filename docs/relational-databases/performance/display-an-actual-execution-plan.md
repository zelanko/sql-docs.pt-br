...
description: Saiba como gerar planos de execução gráfica reais usando o SQL Server Management Studio. Um plano de execução gráfica real contém informações sobre o runtime.
ms.custom: ''
ms.date: 11/21/2018
ms.prod: sql
