...
|O design de tabela impede um cursor KEYSET ou DYNAMIC|A tabela subjacente não tem chave exclusiva para permitir que o [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] identifique uma linha exclusivamente.|Acrescente chaves exclusivas à tabela para fornecer identificação exclusiva de cada linha.|  
