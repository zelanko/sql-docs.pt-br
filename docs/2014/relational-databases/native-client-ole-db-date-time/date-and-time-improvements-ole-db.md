...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Suporte da API do OLE DB para melhorias de data e hora](ole-db-api-support-for-date-and-time-enhancements.md)  
