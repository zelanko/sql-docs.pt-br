...
- **Introdução:**
  ...
  - [Introdução às tabelas temporais no Banco de Dados SQL do Azure](/azure/azure-sql/temporal-tables)
...
![Diagrama que mostra como funciona a Consulta Temporal.](../../relational-databases/tables/media/temporal-querying.PNG "Temporal-Querying")
