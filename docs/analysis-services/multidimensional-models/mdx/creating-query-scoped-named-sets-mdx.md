...
ms.topic: "article"
helpviewer_keywords: 
  - "conjuntos nomeados no escopo da consulta [MDX]"
  - "palavra-chave WITH"
...
manager: "erikre"
---
# Criando conjuntos nomeados no escopo da consulta (MDX)
...
### Usando funções com a palavra-chave WITH  
...
## Consulte também  
 ...
 [Criando conjuntos nomeados no escopo da sessão &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/creating-session-scoped-named-sets-mdx.md)  
