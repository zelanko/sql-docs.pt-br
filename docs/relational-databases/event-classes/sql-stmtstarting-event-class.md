...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento SQL:StmtStarting indica que uma instrução [!INCLUDE[tsql](../../includes/tsql-md.md)] foi iniciada.  
