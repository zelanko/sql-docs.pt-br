---
title: Append e CreateParameter métodos (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "63248162"
---
# <a name="append-and-createparameter-methods-example-vc"></a>Append e CreateParameter métodos (VC + +)
