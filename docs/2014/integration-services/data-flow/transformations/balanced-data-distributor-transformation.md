...
# <a name="balanced-data-distributor-transformation"></a>Transformação de BDD (Balanced Data Distributor)
 ...
 ![Distribuidor de Dados Equilibrado](../../media/balanceddatadistributor.JPG "Balanced Data Distributor")  
