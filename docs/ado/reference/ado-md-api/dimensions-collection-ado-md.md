---
title: "Dimensões de coleção (ADO MD) | Microsoft Docs"
...
---
# <a name="dimensions-collection-ado-md"></a>Coleção de dimensões (ADO MD)
Contém o [dimensão](../../../ado/reference/ado-md-api/dimension-object-ado-md.md) objetos que compõem um cubo.  
  
## <a name="remarks"></a>Comentários  
 **Dimensões** é uma coleção padrão do ADO. Com as propriedades e métodos de uma coleção, você pode fazer o seguinte:  
...
-   [Propriedades, métodos e eventos](../../../ado/reference/ado-md-api/dimensions-collection-properties-methods-and-events.md)  
