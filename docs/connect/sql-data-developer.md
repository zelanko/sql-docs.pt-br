...
* [O SQL Compact](https://www.microsoft.com/download/details.aspx?id=17876): SQL Server Compact para compilar aplicativos ocasionalmente conectados para dispositivos móveis, desktops e independente e clientes Web.
* [LocalDB](../database-engine/configure-windows/sql-server-2016-express-localdb.md): LocalDB de uso durante o desenvolvimento para escrever e testar o código Transact-SQL sem a necessidade de gerenciar uma instância de servidor completo do SQL Server.
...
* [Ferramentas de gerenciamento do SQL Server](../ssms/download-sql-server-management-studio-ssms.md): usar SSMS configurar, monitorar e administrar instâncias do SQL Server.

## <a name="sql-data-access"></a>Acesso a dados do SQL
* [Drivers de cliente SQL](sql-connection-libraries.md): drivers SQL Use para se conectar, consultar, atualizar, inserir ou excluir dados de um banco de dados SQL.
* [Entity Framework](https://msdn.microsoft.com/library/gg696172.aspx): usar o Entity Framework para acessar facilmente os bancos de dados usando LINQ, com acesso direto ao SQL Server e a opção para controlar o mapeamento entre um modelo de dados de entidade (EDM) e estruturas relacionais brutas. 
