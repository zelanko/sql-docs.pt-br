...
|Texto da mensagem|Erro de tabela: O arquivo órfão 'FILE' foi encontrado no diretório Filestream da ID de objeto O_ID, ID de índice I_ID, ID de partição PN_ID, ID de coluna C_ID.|  
