---
title: ISSAsynchStatus (Driver do OLE DB) | Microsoft Docs
description: Saiba como o Driver do OLE DB para SQL Server usa a interface ISSAsynchStatus para dar suporte a operações assíncronas do SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
