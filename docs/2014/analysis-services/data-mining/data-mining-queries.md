...
-   Treinar novamente um modelo adicionando novos dados ou executar previsão cruzada.  
 ...
 [Noções básicas sobre consultas de mineração de dados](#bkmk_Understand)  
...
##  <a name="bkmk_Understand"></a>Noções básicas sobre consultas de mineração de dados  
...
##  <a name="bkmk_Interfaces"></a>Ferramentas e interfaces de consulta  
...
##  <a name="bkmk_ModelTypes"></a>Consultas para diferentes tipos de modelo  
...
-   **Funções de previsão personalizadas:** Cada tipo de modelo fornece um conjunto de funções de previsão projetadas para trabalhar com os padrões criados por esse algoritmo.  
    ...
    |||  
    |-|-|  
    |[Exemplos de consulta de um modelo de associação](association-model-query-examples.md)|[Algoritmo Naïve Bayes da Microsoft](microsoft-naive-bayes-algorithm.md)|  
...
-   **Estatísticas personalizadas:** Funções de suporte adicionais são fornecidas para cada tipo de modelo, para gerar estatísticas que são relevantes para a tarefa analítica específica.  
...
-   **Funções de conteúdo de modelo:** O *conteúdo* de todos os modelos é representado em um formato padronizado que permite recuperar informações com uma consulta simples. Você cria consultas no conteúdo do modelo usando o DMX. Você também pode obter um tipo de conteúdo do modelo de mineração usando os conjuntos de linhas de esquema de mineração de dados.  
