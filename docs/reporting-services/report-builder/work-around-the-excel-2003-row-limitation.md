...
### Para criar uma quebra de página explícita  
...
5.  Clique com o botão direito do mouse em **Grupo 1** na seção **Grupos de Linhas** e clique em **Propriedades do Grupo**.  
     ...
     ![Exibir propriedades da grupo](../../reporting-services/report-builder/media/groupproperties-updated.png "Exibir propriedades da grupo")  
