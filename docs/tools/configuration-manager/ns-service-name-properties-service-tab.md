---
title: Propriedades do NS$&lt;nome do serviço&gt; (guia Serviço)
description: Saiba mais sobre as opções na guia Serviço na caixa de diálogo Propriedades do Notification Services, como o caminho binário, o nome do host e o modo de início.
