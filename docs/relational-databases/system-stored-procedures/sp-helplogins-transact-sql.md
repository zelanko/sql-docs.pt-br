...
## <a name="arguments"></a>Argumentos  
 ...
 É o nome de um logon. *logon* é **sysname**, com um padrão NULL. *logon* deve existir se especificado. Se *login* não é especificado, serão retornadas informações sobre todos os logons.  
