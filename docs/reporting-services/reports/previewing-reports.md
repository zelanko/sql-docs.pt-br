...
ms.topic: "article"
helpviewer_keywords: 
  - "Report Designer [Reporting Services], visualizando relatórios"
  - "visualizando relatórios [Reporting Services]"
  - "imprimindo visualizações"
  - "servidores de teste [Reporting Services]"
...
-   Clicando no botão **Iniciar** da barra de ferramentas padrão do [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ![ssrs_ssdt_startdebug](../../reporting-services/reports/media/ssrs-ssdt-startdebug.png "ssrs_ssdt_startdebug").  
...
## Publicando em um servidor de teste  
