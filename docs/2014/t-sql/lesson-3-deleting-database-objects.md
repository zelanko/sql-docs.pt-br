...
---
# <a name="lesson-3-deleting-database-objects"></a>Lição 3: Excluindo objetos de bancos de dados
...
-   [Excluir objetos de bancos de dados](lesson-3-1-deleting-database-objects.md)  
