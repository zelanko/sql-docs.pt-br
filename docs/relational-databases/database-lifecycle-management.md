...
description: Saiba como usar o gerenciamento de ciclo de vida do banco de dados no SQL Server para gerenciar os bancos de dados e os ativos de dados para desempenho, proteção, disponibilidade e custo.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
[!INCLUDE [SQL Server Azure SQL Database](../includes/applies-to-version/sql-asdb.md)]
 ...
 Para ler o tópico completo, veja [DLM (Gerenciamento de Ciclo de Vida de Banco de Dados)](/previous-versions/sql/sql-server-guides/jj907294(v=sql.110)).  
