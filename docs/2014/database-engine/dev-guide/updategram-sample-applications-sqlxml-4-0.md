...
# <a name="updategram-sample-applications-sqlxml-40"></a>Aplicativos de exemplo de diagramas de atualização (SQLXML 4.0)
 ...
 Todos os exemplos nesta seção usam o banco de dados de exemplo [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]AdventureWorks no. Todas as atualizações são aplicadas às tabelas do banco de dados AdventureWorks.  
