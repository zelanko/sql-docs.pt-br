...
layout: HubPage
hide_bc: true
title: SQL Server – instalação e atualização
description: Encontre o conteúdo que ajudará você a instalar ou atualizar do SQL Server e serviços relacionados.
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Instalar ou atualizar</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/install-sql.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Instalar o SQL Server</h3>
                                                    <p>Uma visão geral de opções de instalação diferentes que temos para instalar o SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/install-ssas.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Instalar o SSAS (SQL Server Analysis Services)</h3>
                                                    <p>Um mecanismo de dados analíticos que fornece modelos de dados semânticos de nível empresarial para relatórios de negócios e aplicativos cliente, como o Power BI, o Excel, o Reporting Services e outros relatórios de visualização de dados. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/install-ssis.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Instalar o SSIS (SQL Server Integration Services)</h3>
                                                    <p> Use o Integration Services para solucionar problemas empresariais complexos copiando ou baixando arquivos, carregando data warehouses, limpando e minerando dados e gerenciando objetos e dados do SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/install-ssrs.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Instalar o SSRS (SQL Server Reporting Services)</h3>
                                                    <p>Uma solução para criar, publicar e gerenciar relatórios e entregá-los aos usuários corretos de diferentes maneiras: exibindo-os em um navegador da Web, em seus dispositivos móveis ou como um email em suas caixas de entrada. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/upgrade-sql.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Atualizar o SQL Server</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/upgrade-ssas.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Atualizar o SSAS (SQL Server Analysis Services)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/upgrade-ssis.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Atualizar o SSIS (SQL Server Integration Services)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/install-sql-and-services/upgrade-ssrs.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Atualizar o SSRS (SQL Server Reporting Services)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                             ...
                             <li class="fullSpan">
                                <div class="container intro">
                                <h2>Migrar para o SQL Server</h2> 
                            </li>
                             <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviço de Migração de Banco de Dados do Azure</h3>
                                                    <p>Habilita migrações contínuas de várias fontes de banco de dados para plataformas de dados do Azure com o tempo de inatividade mínimo.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>AMD (Assistente de Migração de Banco de Dados)</h3>
                                                    <p>Detecta problemas de compatibilidade, recomenda melhorias para o seu ambiente de destino e move o banco de dados e os dados.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
