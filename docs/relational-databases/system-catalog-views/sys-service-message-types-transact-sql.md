...
|**validação**|**char(2)**|Validação feita pelo Broker antes de enviar mensagens desse tipo. Não é NULLABLE. Um dos seguintes:<br /><br /> N = Nenhum<br /><br /> X = XML<br /><br /> E = vazio|  
