...
description: No utilitário dta, o elemento Name para Índice especifica um nome para um índice na configuração especificada pelo usuário.
ms.prod: sql
