...
|**freq_relative_interval**|**Int**|Quando **freq_interval** ocorre em cada mês, se **freq_interval** é **32** (mensal relativo). Pode ser um dos seguintes valores:<br /><br /> **0** = **freq_relative_interval** é usado<br /><br /> **1** = primeiro<br /><br /> **2** = Second<br /><br /> **4** = terceiro<br /><br /> **8** = quarto<br /><br /> **16** = último|  
