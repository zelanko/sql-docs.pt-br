...
ms.openlocfilehash: 137ece668d5ec017341a03888aa8b147fb66b28d
ms.contentlocale: pt-br
ms.lasthandoff: 09/01/2017

---
# <a name="olapdatasource-data-type-assl"></a>Tipo de dados OlapDataSource (ASSL)
  Define um tipo de dados derivado que representa um multidimensionais [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) elemento.  
