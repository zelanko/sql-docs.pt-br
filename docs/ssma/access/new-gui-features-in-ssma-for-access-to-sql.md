---
title: Novos recursos de GUI no SSMA para Access to SQL | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "68083627"
---
# <a name="new-gui-features-in-ssma-for-access-to-sql"></a>Novos recursos de GUI no SSMA para Access to SQL
