...
`[ @alert_name = ] 'alert'` O nome do alerta. *alerta* está **sysname**, sem padrão.  
  
`[ @operator_name = ] 'operator'` O nome do operador. *operador* está **sysname**, sem padrão.  
