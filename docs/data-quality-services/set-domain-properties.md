---
title: "Definir propriedades do dom&#237;nio | Microsoft Docs"
ms.custom: ""
ms.date: "11/08/2011"
...
1.  Definir propriedades em um domínio existente abrindo uma base de dados de Conhecimento na atividade de gerenciamento de domínio (consulte [Abrir uma Base de dados de Conhecimento](../data-quality-services/open-a-knowledge-base.md)) e, em seguida, selecione o domínio apropriado no **domínio** lista. A página Propriedades de Domínio será exibida por padrão.  
...
> [!TIP]  
>  Se o idioma não estiver listado no **idioma** lista suspensa, selecione **outros**. Isso garante que o DQS limpe e elimine duplicatas para os dados de idiomas não listados com base no conhecimento disponível (regras de domínio, valores de domínio, TBRs, regra de correspondência) no domínio.  
