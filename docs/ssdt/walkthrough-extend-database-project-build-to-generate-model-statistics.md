...
description: Saiba como criar, instalar e testar um colaborador de build que gera estatísticas do modelo de Banco de Dados SQL quando você cria um projeto de banco de dados.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
...
-   Definir uma classe denominada ModelStatistics que herda de [BuildContributor](/dotnet/api/microsoft.sqlserver.dac.deployment.buildcontributor).  
