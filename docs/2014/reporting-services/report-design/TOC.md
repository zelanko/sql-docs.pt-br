...
### [Função CountRows](report-builder-functions-countrows-function.md)
...
### [Referências de coleções de parâmetros](built-in-collections-parameters-collection-references-report-builder.md)
