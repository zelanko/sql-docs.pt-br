...
description: Use este artigo de referência para entender os comandos SQL na ferramenta azdata, especificamente os vários comandos de aplicativo.
author: MikeRayMSFT
ms.author: mikeray
