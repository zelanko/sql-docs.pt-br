---
title: "Iniciar, parar, pausar, retomar, reiniciar o mecanismo de banco de dados, o SQL Server Agent ou o servi&#231;o SQL Server Browser | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Configuration Manager, iniciar e interromper serviços"
  - "parando o SQL Server Agent"
  - "parâmetros [SQL Server], opções de inicialização"
  - "SQL Server, opções de inicialização"
  - "Mecanismo de Banco de Dados [SQL Server], iniciando e interrompendo serviços"
  - "pausando o SQL Server"
  - "PowerShell [SQL Server], iniciando e parando serviços"
  - "modo de usuário único [SQL Server], iniciando em"
  - "SQL Server Management Studio [SQL Server], iniciando ou interrompendo serviços"
  - "parando o serviço SQL Server Browser"
  - "iniciando o SQL Server Agent"
  - "instâncias padrão [SQL Server], iniciando e interrompendo"
  - "iniciando e parando serviços do SQL Server Agent"
  - "prompt de comando [SQL Server], iniciando e parando serviços do SQL Server"
  - "continuando o SQL Server"
  - "iniciando o Mecanismo de Banco de Dados do SQL Server"
  - "comandos net stop [SQL Server]"
  - "prompt de comando [SQL Server], serviço do SQL Browser"
  - "Configuration Manager, iniciar e parar serviços"
  - "continuando o SQL Server"
  - "opções de inicialização [SQL Server]"
  - "instâncias nomeadas [SQL Server], iniciando e parando"
  - "comandos net start [SQL Server]"
  - "SQL Server, iniciando e parando"
  - "parando o SQL Server"
  - "iniciando o serviço SQL Server Browser"
  - "Opções de inicialização do Mecanismo de Banco de Dados do SQL Server"
  - "Administrando o SQL Server, iniciando e parando serviços"
  - "Management Studio [SQL Server], iniciando ou parando serviços"
...
#### Iniciando o Gerenciador de Configurações [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Para iniciar, parar, pausar, retomar ou reiniciar a instância do [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  Para iniciar uma instância do [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] com opções de inicialização, consulte [Configurar opções de inicialização do servidor &#40;SQL Server Configuration Manager&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
  
#### Para iniciar, parar, pausar, retomar ou reiniciar a instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser ou uma instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent  
...
#### Para iniciar, parar ou reiniciar uma instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent  
...
#### Para parar o [!INCLUDE[ssDE](../../includes/ssde-md.md)] usando [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### Para iniciar e parar os serviços [!INCLUDE[ssDE](../../includes/ssde-md.md)]  
...
## Consulte também  
 [Visão geral da documentação de instalação do SQL Server](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
