...
helpviewer_keywords: 
  ...
  - "Assinantes Oracle [replicação do SQL Server]"
  - "assinantes não SQL Server, Oracle"
  - "Assinantes heterogêneos, Oracle"
...
## Configurando um Assinante Oracle  
...
### Testando a conectividade entre o SQL Server Distributor e o Publicador Oracle  
...
## Considerações sobre os Assinantes Oracle  
 Além das considerações abordados neste tópico [assinantes não-SQL Server](../../../relational-databases/replication/non-sql/non-sql-server-subscribers.md), considere as seguintes questões ao replicar para assinantes Oracle:  
...
-   O Oracle trata as cadeias de caracteres vazias e os valores NULOS como NULOS. Isto é importante se for definir uma coluna [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] como NÃO NULA e estiver replicando a coluna para um Assinante Oracle. Para evitar falhas quando for aplicar alterações ao Assinante Oracle, você deve fazer um dos seguintes:  
    ...
    -   Usar o parâmetro **–SkipErrors** para o Agente de Distribuição caso seja aceitável ser notificado das falhas no log do histórico do Agente de Distribuição e continuar com o processamento. Especificar o código de erro Oracle 1400 (**-SkipErrors1400**).  
  
    -   Modificar o script gerado de criação de tabela, removendo o atributo NOT NULL das colunas de caracteres que podem estar associados de cadeias de caracteres vazias e forneça o script modificado como um script de criação personalizado para o artigo usando o parâmetro @creation_script de [sp_addarticle](../../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md).  
  
-   Os Assinantes Oracle têm suporte para uma opção de esquemas de 0x4071. Para obter mais informações sobre opções de esquema, consulte [sp_addarticle & #40. O Transact-SQL e 41;](../../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md).  
  
## Mapeando os tipos de dados do SQL Server para o Oracle  
...
|**ntext**|NCLOB|  
|**numérico (1-38, 0-38)**|NUMBER(1-38, 0-38)|  
