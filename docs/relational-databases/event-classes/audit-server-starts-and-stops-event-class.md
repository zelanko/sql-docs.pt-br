...
ms.topic: "article"
helpviewer_keywords: 
  - "Classe de evento Audit Server Starts and Stops"
...
---
# Classe de evento Audit Server Starts and Stops
  A classe de evento **Audit Server Starts and Stops** ocorre quando o estado do serviço [!INCLUDE[msCoName](../../includes/msconame-md.md)] do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] é modificado.  
  
## Colunas de dados da classe de evento Audit Server Starts and Stops  
