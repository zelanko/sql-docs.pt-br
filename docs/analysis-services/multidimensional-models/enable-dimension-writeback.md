---
title: "Habilitar o write-back de dimens&#227;o | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  ...
  - "write-back [Analysis Services], configuração"
  - "dimensões [Analysis Services], melhorias de Business Intelligence"
  - "melhorias do Business Intelligence [Analysis Services], write-back"
  - "dimensões [Analysis Services], write-back"
  - "write-back [Analysis Services]"
  - "dimensões [Analysis Services], modificando"
  - "modificações manuais da estrutura da dimensão"
...
manager: "erikre"
---
# Habilitar o write-back de dimens&#227;o
...
## Definindo a capacidade de write-back de dimensão  
