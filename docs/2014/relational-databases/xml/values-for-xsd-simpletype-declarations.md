...
# <a name="values-for-ltxsdsimpletypegt-declarations"></a>Valores para declarações &lt;xsd:simpleType&gt;
 ...
 Além disso, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o não oferece suporte ao valor Nan em **\<xsd:simpleType>** declarações. Esquemas que incluem valores NaN são rejeitados pelo servidor.  
