---
title: Classe de evento Broker:Message Drop | Microsoft Docs
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="brokermessage-drop-event-class"></a>classe de evento Broker:Message Drop
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] gera um evento **Broker:Message Drop** quando o Service Broker não pode reter uma mensagem recebida que deveria ter sido entregue a um serviço nessa instância. Para mensagens que deveriam ter sido encaminhadas, veja [Classe de evento Broker:Forwarded Message Dropped](../../relational-databases/event-classes/broker-forwarded-message-dropped-event-class.md).  
  
## <a name="brokermessage-drop-event-class-data-columns"></a>Colunas de dados da classe de evento Broker:Message Drop  
...
|**BigintData1**|**bigint**|O número de sequência da mensagem descartada.|52|Não|  
...
|**EventClass**|**int**|O tipo de classe de evento capturado. Sempre **160** for **Broker:MessageDrop**.|27|Não|  
|**EventSequence**|**int**|Número de sequência para esse evento.|51|Não|  
|**EventSubClass**|**nvarchar**|Indica se a mensagem descartada era uma mensagem sequenciada. Um de dois valores:<br /><br /> **Mensagem Sequenciada**. A mensagem descartada era uma mensagem sequenciada.<br /><br /> **Mensagem Não Sequenciada**. A mensagem descartada não era uma mensagem sequenciada.|21|Sim|  
|**GUID**|**uniqueidentifier**|A ID da conversa a que pertence a mensagem descartada. Esse identificador é transmitido como parte da mensagem e é compartilhado por ambos os lados da conversa.|54|Não|  
|**HostName**|**nvarchar**|O nome do computador no qual o cliente está sendo executado. Essa coluna de dados será populada se o nome do host for fornecido pelo cliente. Para determinar o nome do host, use a função HOST_NAME.|8|Sim|  
|**IntegerData**|**int**|O número de fragmento da mensagem descartada.|25|Não|  
|**IntegerData2**|**int**|O número de fragmento de mensagem que a mensagem descartada estava reconhecendo.|55|Não|  
...
|**TextData**|**ntext**|O motivo pelo qual o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] descartou a mensagem.|1|Sim|  
