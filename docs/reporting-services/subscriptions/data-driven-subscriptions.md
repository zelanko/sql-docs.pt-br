...
description: Saiba mais sobre as assinaturas controladas por dados, que fornecem uma maneira de usar dados dinâmicos de assinatura recuperados de uma fonte de dados externa em tempo de execução.
ms.date: 05/20/2019
