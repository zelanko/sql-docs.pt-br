---
description: DDL, funções, procedimentos armazenados e exibições de pesquisa de texto completo
...
##  <a name="system-predicates-and-functions"></a><a name="func"></a> Predicados de sistema e funções  
