...
ms.topic: "article"
helpviewer_keywords: 
  - "itens [Reporting Services], excluindo"
  - "excluindo itens do relatório"
  - "itens de relatório [Reporting Services], excluindo"
...
---
# Excluir um item (Management Studio)
...
### Para excluir um item no namespace de pasta do servidor de relatório  
