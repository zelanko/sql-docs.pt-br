...
|Ordenação|Nome da ordenação padrão para o servidor.<br /><br /> NULL = Entrada inválida ou um erro.<br /><br /> Tipo de dados base: **nvarchar(128)**|  
