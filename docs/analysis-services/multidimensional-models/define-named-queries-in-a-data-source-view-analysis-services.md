...
ms.topic: "article"
helpviewer_keywords: 
  - "consultas nomeadas [Analysis Services], criando"
  - "modificando consultas nomeadas"
  - "exibições da fonte de dados [Analysis Services], consultas nomeadas"
