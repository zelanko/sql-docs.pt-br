...
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]
 ...
 Para um aplicativo de exemplo que demonstra este recurso, consulte [usando IRowsetFastLoad de dados de cópia em massa &#40; OLE DB &#41;](../../../relational-databases/native-client-ole-db-how-to/bulk-copy-data-using-irowsetfastload-ole-db.md).  
