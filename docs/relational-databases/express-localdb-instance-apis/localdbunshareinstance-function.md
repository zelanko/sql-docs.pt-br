...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Interrompe o compartilhamento da instância especificada do SQL Server Express LocalDB.  
