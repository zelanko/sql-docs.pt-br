...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
 ...
 Para especificar um esquema de mapeamento, use o atributo **Mapping-Schema** do elemento ** \<Sync>** . Os exemplos a seguir mostram dois diagramas de atualização: um que usa um esquema de mapeamento simples e outro que usa um esquema mais complexo.  
...
## <a name="dealing-with-data-types"></a>Lidando com tipos de dados  
 ...
 Se o esquema especificar o tipo de dados **DateTime**, **Date**ou **time** XSD, você também deverá especificar o tipo [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] de dados correspondente usando **SQL: datatype = "DateTime"**.  
...
### <a name="a-creating-an-updategram-with-a-simple-mapping-schema"></a>R. Criando um diagrama de atualização com um esquema de mapeamento simples  
...
```  
 ...
 O updategram a seguir usa esse esquema XSD para adicionar um novo registro de detalhes do pedido (um ** \<elemento OD>** no bloco ** \<After>** ) para a ordem 43860. O atributo **Mapping-Schema** é usado para especificar o esquema de mapeamento no updategram.  
...
```  
 ...
 Para instruir a lógica do updategram a reverter a relação pai-filho durante a operação de atualização, a anotação **inversa** é especificada no elemento de ** \<>de relação** . Como resultado, os registros são adicionados primeiro na tabela Cust e, depois, na tabela Ord, e a operação é bem-sucedida.  
