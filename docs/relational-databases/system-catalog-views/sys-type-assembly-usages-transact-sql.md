...
|-----------------|---------------|-----------------|  
|**user_type_id**|**Int**|ID do tipo<br /><br /> Para retornar o nome do tipo, unir o [Types](../../relational-databases/system-catalog-views/sys-types-transact-sql.md) essa coluna de exibição do catálogo.|  
