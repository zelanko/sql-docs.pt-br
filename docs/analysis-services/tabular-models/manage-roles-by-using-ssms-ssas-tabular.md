...
8.  Na janela de filtros de linha, selecione uma tabela, clique no campo **Filtro DAX** e, no campo **Filtro DAX – \<tablename>**, digite uma fórmula DAX.  
  
    > [!NOTE]  
    >  O campo Filtro de DAX – \<tablename> não contém um editor de consulta de Preenchimento Automático ou o recurso de inserir função. Para usar o Preenchimento Automático ao escrever uma fórmula DAX, você deverá usar um editor de fórmula DAX no [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)].  
