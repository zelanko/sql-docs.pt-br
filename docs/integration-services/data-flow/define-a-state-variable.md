---
description: Definir uma variável de estado
...
|TFSTART|Este é o estado em uma execução não inicial do pacote de atualização de feed de fluxo depois que a operação **GetProcessingRange** chama a tarefa Controle de CDC.<br /><br /> Isto indica que uma execução de CDC regular foi iniciada, mas não foi concluída ou ainda não foi concluída por completo (**MarkProcessedRange**).|  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Editor da Tarefa Controle de CDC](../control-flow/cdc-control-task.md)  
