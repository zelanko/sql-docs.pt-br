---
description: Criar uma categoria de trabalho
...
Para obter mais informações, consulte [sp_add_category (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-add-category-transact-sql.md).  
