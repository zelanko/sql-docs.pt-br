---
title: "Arquivos e grupos de arquivos do banco de dados | Microsoft Docs"
ms.custom: ""
ms.date: "10/11/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "bancos de dados [SQL Server], arquivos"
  - "grupos de arquivos [SQL Server]"
  - "logs de transação [SQL Server], sobre"
  - "logs de transação [SQL Server], arquivos"
  - "arquivos mdf"
  - "arquivos de dados [SQL Server]"
  - "grupos de arquivos padrão"
  - "arquivos [SQL Server], sobre arquivos e grupos de arquivos"
  - "arquivos secundários [SQL Server]"
  - "arquivos de log [SQL Server]"
  - "arquivos ndf"
  - "arquivos [SQL Server]"
  - "arquivos ldf"
  - "arquivos de banco de dados [SQL Server]"
  - "bancos de dados [SQL Server], grupos de arquivos"
  - "grupos de arquivos [SQL Server], tipos"
  - "grupos de arquivos primários [SQL Server]"
  - "grupos de arquivos definidos pelo usuário [SQL Server]"
  - "grupos de arquivos [SQL Server], sobre os grupos de arquivos"
  - "arquivos primários [SQL Server]"
  - "tipos de arquivo [SQL Server]"
