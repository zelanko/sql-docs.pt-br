...
helpviewer_keywords: 
  - "Servidores registrados [SQL Server], exportando"
  - "exportando informações de servidor registrado"
...
---
# Exportar informa&#231;&#245;es de servidor registrado (SQL Server Management Studio)
...
#### Para exportar informações de servidor registrado  
