...
## <a name="includessdriverphpincludesssdriverphp_mdmd-support-resources"></a>[!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)] Recursos de suporte  
...
Para perguntas de suporte relacionadas ao [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)], você pode contatar o [suporte da Microsoft](https://support.microsoft.com/contactus/)ou perguntar na [página do projeto do GitHub](https://github.com/Microsoft/msphpsql/issues).  
