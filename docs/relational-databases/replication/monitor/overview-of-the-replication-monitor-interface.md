---
description: Visão geral da interface do Replication Monitor
...
-   Guia**Agentes**  
 ...
 Para obter mais informações, consulte [Exibir informações e executar tarefas para um Publicador &#40;Replication Monitor&#41;](../../../relational-databases/replication/monitor/view-information-and-perform-tasks-replication-monitor.md).  
...
-   Janelas de detalhes para agentes associados a uma publicação. Os seguintes agentes são associados a publicações:  
 ...
 Para obter mais informações, confira [Exibir informações e executar tarefas usando o Replication Monitor](../../../relational-databases/replication/monitor/view-information-and-perform-tasks-replication-monitor.md).  
