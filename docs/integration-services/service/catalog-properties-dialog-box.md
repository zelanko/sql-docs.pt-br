...
# Caixa de di&#225;logo Propriedades do Cat&#225;logo
 ...
 Para obter informações sobre como criar o catálogo do SSISDB, consulte [Criar o catálogo do SSIS](../../integration-services/service/create-the-ssis-catalog.md).  
