...
description: No SQL Server, use a página Geral para especificar ou exibir as propriedades gerais de um dispositivo de backup lógico, incluindo a especificação do nome do dispositivo.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
