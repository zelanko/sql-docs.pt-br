...
ms.topic: "article"
helpviewer_keywords: 
  - "utilitário sqlcmd, conexões do Mecanismo de Banco de Dados"
  - "Pipes Nomeados [SQL Server], utilitário sqlcmd"
  - "TCP/IP [SQL Server], protocolos de cliente"
  - "protocolos de rede [SQL Server], utilitário sqlcmd"
  - "protocolos [SQL Server], utilitário sqlcmd"
  - "VIA"
