...
`[ @original_publisher = ] 'original_publisher'` O nome da instância do SQL Server que o banco de dados publicado originalmente. *original_publisher* está **sysname**, sem padrão.
