---
title: "Conectar ao Servidor SSIS (Propriedades da Conexão) | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
Use esta guia para exibir ou especificar opções ao se conectar com o [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion_md.md)] ou ao registrar o [!INCLUDE[ssIS](../../includes/ssis_md.md)] nos **Servidores Registrados**. **Conectar** e **Opções** são exibidas apenas nessa caixa de diálogo durante a conexão. **Testar** e **Salvar** só aparecem nesta caixa de diálogo durante o registro no [!INCLUDE[ssIS](../../includes/ssis_md.md)].  
  
## <a name="options"></a>Opções  
**Número da porta**  
Insira o número da porta usada pelo [!INCLUDE[ssIS](../../includes/ssis_md.md)].  
...
**Testarar**  
Ao registrar o [!INCLUDE[ssIS](../../includes/ssis_md.md)] em **Servidores Registrados**, clique para testar a conexão.  
