...
description: Explica como usar o polybase em um data warehouse paralelo (APS) para consultar dados externos no armazenamento de BLOBs do Azure.
author: mzaman1
ms.prod: sql
