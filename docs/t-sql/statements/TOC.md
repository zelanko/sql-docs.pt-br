# [Visão geral](statements.md)

# ADD

## [CLASSIFICAÇÃO DE SENSIBILIDADE](add-sensitivity-classification-transact-sql.md)
...
## [DATABASE (Banco de Dados SQL do Azure)](alter-database-azure-sql-database.md)  
## [DATABASE (SQL Data Warehouse do Azure)](alter-database-azure-sql-data-warehouse.md)  
...
## [Nível de compatibilidade do DATABASE](alter-database-transact-sql-compatibility-level.md)  
## [Espelhamento do DATABASE](alter-database-transact-sql-database-mirroring.md)  
## [DATABASE ENCRYPTION KEY](alter-database-encryption-key-transact-sql.md)
## [Opções do grupo de arquivos e do arquivo DATABASE](alter-database-transact-sql-file-and-filegroup-options.md)  
...
## [Opções do DATABASE SET](alter-database-transact-sql-set-options.md)  
...
## [INDEX (Índices XML seletivos)](alter-index-selective-xml-indexes.md)  
...
## [Instruções RESTORE](restore-statements-for-restoring-recovering-and-managing-backups-transact-sql.md)  
## [RESTORE DATABASE (Parallel Data Warehouse)](restore-database-parallel-data-warehouse.md)

## [Argumentos RESTORE](restore-statements-arguments-transact-sql.md)  
...
## [DATABASE (Banco de Dados SQL do Azure)](create-database-azure-sql-database.md)  
## [DATABASE (SQL Data Warehouse do Azure)](create-database-azure-sql-data-warehouse.md)  
...
## [TABLE (SQL Data Warehouse do Azure)](create-table-azure-sql-data-warehouse.md)  
## [TABLE (SQL Graph)](create-table-sql-graph.md)  
## [TABLE AS SELECT (SQL Data Warehouse do Azure)](create-table-as-select-azure-sql-data-warehouse.md)
## [TABLE IDENTITY (Propriedade)](create-table-transact-sql-identity-property.md)
...
## [XML INDEX (Índices XML seletivos)](create-xml-index-selective-xml-indexes.md)  
## [XML SCHEMA COLLECTION](create-xml-schema-collection-transact-sql.md)  

# Agrupamentos
## [Cláusula COLLATE](collations.md)  
## [Nome do agrupamento do SQL Server](sql-server-collation-name-transact-sql.md)  
## [Nome do agrupamento do Windows](windows-collation-name-transact-sql.md)  
## [Precedência de agrupamento](collation-precedence-transact-sql.md)  
...
## [INDEX (Índices XML seletivos)](drop-index-selective-xml-indexes.md)  
...
## [CLASSIFICAÇÃO DE SENSIBILIDADE](drop-sensitivity-classification-transact-sql.md)
...
## [Permissões de assembly DENY](deny-assembly-permissions-transact-sql.md)  
## [Permissões de chave assimétrica DENY](deny-asymmetric-key-permissions-transact-sql.md)  
## [Permissões de grupo de disponibilidade DENY](deny-availability-group-permissions-transact-sql.md)  
## [Permissões de certificado DENY](deny-certificate-permissions-transact-sql.md)  
## [Permissões de banco de dados DENY](deny-database-permissions-transact-sql.md)  
## [Permissões de entidade de segurança de banco de dados DENY](deny-database-principal-permissions-transact-sql.md)  
## [Credencial com escopo do banco de dados DENY](deny-database-scoped-credential-transact-sql.md)  
## [Permissões de ponto de extremidade DENY](deny-endpoint-permissions-transact-sql.md)  
## [Permissões de texto completo DENY](deny-full-text-permissions-transact-sql.md)  
## [Permissões de objeto DENY](deny-object-permissions-transact-sql.md)  
## [Permissões de esquema DENY](deny-schema-permissions-transact-sql.md)  
## [Permissões de lista de propriedades de pesquisa DENY](deny-search-property-list-permissions-transact-sql.md)  
## [Permissões de servidor DENY](deny-server-permissions-transact-sql.md)  
## [Permissões de entidade de segurança do servidor DENY](deny-server-principal-permissions-transact-sql.md)  
## [Permissões do Service Broker DENY](deny-service-broker-permissions-transact-sql.md)  
## [Permissões de chave simétrica DENY](deny-symmetric-key-permissions-transact-sql.md)  
## [Permissões de objeto do sistema DENY](deny-system-object-permissions-transact-sql.md)  
## [Permissões de tipo DENY](deny-type-permissions-transact-sql.md)  
## [Permissões de coleção de esquema XML DENY](deny-xml-schema-collection-permissions-transact-sql.md)  
## [EXECUTE AS](execute-as-transact-sql.md)  
## [Cláusula EXECUTE AS](execute-as-clause-transact-sql.md)  
## [GRANT](grant-transact-sql.md)  
## [Permissões de assembly GRANT](grant-assembly-permissions-transact-sql.md)  
## [Permissões de chave assimétrica GRANT](grant-asymmetric-key-permissions-transact-sql.md)  
## [Permissões de grupo de disponibilidade GRANT](grant-availability-group-permissions-transact-sql.md)  
## [Permissões de certificado GRANT](grant-certificate-permissions-transact-sql.md)  
## [Permissões de banco de dados GRANT](grant-database-permissions-transact-sql.md)  
## [Permissões de entidade de segurança de banco de dados GRANT](grant-database-principal-permissions-transact-sql.md)  
## [Credencial com escopo do banco de dados GRANT](grant-database-scoped-credential-transact-sql.md)  
## [Permissões de ponto de extremidade GRANT](grant-endpoint-permissions-transact-sql.md)  
## [Permissões de texto completo GRANT](grant-full-text-permissions-transact-sql.md)  
## [Permissões de objeto GRANT](grant-object-permissions-transact-sql.md)  
## [Permissões de esquema GRANT](grant-schema-permissions-transact-sql.md)  
## [Permissões de lista de propriedades de pesquisa GRANT](grant-search-property-list-permissions-transact-sql.md)  
## [Permissões de servidor GRANT](grant-server-permissions-transact-sql.md)  
## [Permissões de entidade de segurança do servidor GRANT](grant-server-principal-permissions-transact-sql.md)  
## [Permissões do Service Broker GRANT](grant-service-broker-permissions-transact-sql.md)  
## [Permissões de chave simétrica GRANT](grant-symmetric-key-permissions-transact-sql.md)  
## [Permissões de objeto do sistema GRANT](grant-system-object-permissions-transact-sql.md)  
## [Permissões de tipo GRANT](grant-type-permissions-transact-sql.md)  
## [Permissões de coleção de esquema XML GRANT](grant-xml-schema-collection-permissions-transact-sql.md)  
## [OPEN MASTER KEY](open-master-key-transact-sql.md)  
## [OPEN SYMMETRIC KEY](open-symmetric-key-transact-sql.md)  
## [Permissões: GRANT, DENY, REVOKE (SQL Data Warehouse do Azure, Parallel Data Warehouse)](permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
## [REVERT](revert-transact-sql.md)  
## [REVOKE](revoke-transact-sql.md)  
## [Permissões de assembly REVOKE](revoke-assembly-permissions-transact-sql.md)  
## [Permissões de chave assimétrica REVOKE](revoke-asymmetric-key-permissions-transact-sql.md)  
## [Permissões de grupo de disponibilidade REVOKE](revoke-availability-group-permissions-transact-sql.md)  
## [Permissões de certificado REVOKE](revoke-certificate-permissions-transact-sql.md)  
## [Permissões de banco de dados REVOKE](revoke-database-permissions-transact-sql.md)  
## [Permissões de entidade de segurança de banco de dados REVOKE](revoke-database-principal-permissions-transact-sql.md)  
## [Credencial com escopo de banco de dados REVOKE](revoke-database-scoped-credential-transact-sql.md)  
## [Permissões de ponto de extremidade REVOKE](revoke-endpoint-permissions-transact-sql.md)  
## [Permissões de texto completo REVOKE](revoke-full-text-permissions-transact-sql.md)  
## [Permissões de objeto REVOKE](revoke-object-permissions-transact-sql.md)  
## [Permissões de esquema REVOKE](revoke-schema-permissions-transact-sql.md)  
## [Permissões da lista de propriedades de pesquisa REVOKE](revoke-search-property-list-permissions-transact-sql.md)  
## [Permissões de servidor REVOKE](revoke-server-permissions-transact-sql.md)  
## [Permissões de entidade de segurança do servidor REVOKE](revoke-server-principal-permissions-transact-sql.md)  
## [Permissões do Service Broker REVOKE](revoke-service-broker-permissions-transact-sql.md)  
## [Permissões de chave simétrica REVOKE](revoke-symmetric-key-permissions-transact-sql.md)  
## [Permissões de objeto do sistema REVOKE](revoke-system-object-permissions-transact-sql.md)  
## [Permissões de tipo REVOKE](revoke-type-permissions-transact-sql.md)  
## [Permissões de coleção de esquema XML REVOKE](revoke-xml-schema-collection-permissions-transact-sql.md)  
...
# SET
## [Visão geral](set-statements-transact-sql.md)
