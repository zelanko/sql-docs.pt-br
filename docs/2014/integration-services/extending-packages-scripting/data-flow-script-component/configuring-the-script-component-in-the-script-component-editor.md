...
```  
 ...
 Para obter mais informações, consulte [conexão a fontes de dados no Component]((connecting-to-data-sources-in-the-script-component.md) Script.  
