---
title: Configurar IIS para os Drivers para PHP
description: Saiba como configurar o IIS para hospedar aplicativos PHP que usam os Drivers para PHP para SQL Server. Os recursos listados aqui são específicos para usar o FastCGI com o IIS.
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
-   [FastCGI com PHP](/iis/web-hosting/web-server-for-shared-hosting/fastcgi-with-php)  
-   [Uso de FastCGI para hospedar aplicativos PHP no IIS 7.0](/iis/application-frameworks/install-and-configure-php-applications-on-iis/using-fastcgi-to-host-php-applications-on-iis)  
-   [Uso de FastCGI para hospedar aplicativos PHP no IIS 6.0](/iis/application-frameworks/install-and-configure-php-applications-on-iis/using-fastcgi-to-host-php-applications-on-iis-60)  
-   [Configuração da Extensão FastCGI para IIS 6.0](/iis/application-frameworks/install-and-configure-php-on-iis/configuring-the-fastcgi-extension-for-iis-60)  
...
-   [Configuração do FastCGI para PHP](/iis/application-frameworks/running-php-applications-on-iis/set-up-fastcgi-for-php)  
-   [Celebrando com PHP nos Serviços de Informações da Internet da Microsoft 7](/iis/application-frameworks/running-php-applications-on-iis/mix08-partying-with-php-on-microsoft-internet-information-services-7-and-above)  
