---
description: Exemplos de código do ADOX no Microsoft Visual Basic
...
-   [Exemplo das propriedades método, tipo de chave, RelatedColumn, RELATEDTABLE e UpdateRule de anexação de chaves (VB)](./keys-append-method-key-type-relatedcolumn-relatedtable-example-vb.md)  
...
-   [Exemplo da propriedade CommandText, coleção views (VB)](./views-collection-commandtext-property-example-vb.md)  
...
-   [Tipo de chave, RelatedColumn, propriedades relacionadas e UpdateRule, exemplo do método de acréscimo de chaves (VB)](./keys-append-method-key-type-relatedcolumn-relatedtable-example-vb.md)  
  
-   [Exemplo das propriedades Name, Columns e Tables Append (VB)](./columns-and-tables-append-methods-name-property-example-vb.md)  
  
-   [Exemplo das propriedades NumericScale e Precision (VB)](./adox-code-example-numericscale-and-precision-properties-example-vb.md)  
...
-   [Propriedade de tipo de tabela, método Connection Close, exemplo (VB)](./connection-close-method-table-type-property-example-vb.md)  
