---
title: Estabelecer conexão com a fonte de dados (driver do OLE DB) | Microsoft Docs
description: Saiba como um consumidor estabelece uma conexão com uma fonte de dados usando o Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
