---
title: Definir o comportamento de parametrização de consulta usando guias de plano
description: Conheça as opções de parametrização, em que os parâmetros são substituídos por valores literais em uma consulta no SQL Server.
