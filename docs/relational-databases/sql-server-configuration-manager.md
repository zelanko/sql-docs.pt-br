...
ms.topic: "article"
helpviewer_keywords: 
  - "protocolos [SQL Server], gerenciando"
  - "protocolos de rede [SQL Server], gerenciando"
  - "Utilitário de rede do cliente"
  - "contas [SQL Server]"
  - "SQL Server Configuration Manager"
  - "Utilitário de rede do servidor"
  - "contas [SQL Server], serviços"
  - "serviços [SQL Server], gerenciando"
  - "ferramentas [SQL Server], SQL Server Configuration Manager"
...
## Gerenciando serviços  
 ...
 Use o [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Configuration Manager para iniciar o [!INCLUDE[ssDE](../includes/ssde-md.md)] usando parâmetros de inicialização.  Para obter mais informações, veja [Configurar opções de inicialização do servidor &#40;SQL Server Configuration Manager&#41;](../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
  
## Alterando as contas usadas pelos serviços  
