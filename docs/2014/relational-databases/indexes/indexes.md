...
|XML|Uma representação fragmentada e persistente de XML binários objetos grandes (BLOBs) no `xml` coluna de tipo de dados.|[Índices XML &#40;SQL Server&#41;](../xml/xml-indexes-sql-server.md)|  
