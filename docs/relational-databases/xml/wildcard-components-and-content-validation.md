...
description: Saiba como os componentes curinga de Atributo e Elemento XML são usados para aumentar a flexibilidade quanto ao que pode aparecer em um modelo de conteúdo.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
