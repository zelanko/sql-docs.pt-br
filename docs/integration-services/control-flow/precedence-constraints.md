...
helpviewer_keywords: 
  - "tarefas [Integration Services], restrições de precedência"
  - "fluxo de controle [Integration Services], restrições de precedência"
  - "restrições de precedência [Integration Services]"
  - "restrições [Integration Services]"
  - "opções de execução de sequência [Integration Services]"
  - "contêineres [Integration Services], restrições de precedência"
...
## Configuração da restrição de precedência  
 ...
 Para obter mais informações sobre as propriedades que podem ser definidas no [!INCLUDE[ssIS](../../includes/ssis-md.md)] Designer, consulte [Editor de Restrição de Precedência](../Topic/Precedence%20Constraint%20Editor.md).  
...
-   [Definir as propriedades de uma restrição de precedência](../Topic/Set%20the%20Properties%20of%20a%20Precedence%20Constraint.md)  
  
-   [Definir o valor de uma restrição de precedência por meio do menu de atalho](../Topic/Set%20the%20Value%20of%20a%20Precedence%20Constraint%20by%20Using%20the%20Shortcut%20Menu.md)  
...
## Consulte também  
 [Adicionar expressões a restrições de precedência](../Topic/Add%20Expressions%20to%20Precedence%20Constraints.md)   
 [Várias restrições de precedência](../Topic/Multiple%20Precedence%20Constraints.md)  
