...
description: Este artigo mostra como criar um backup criptografado no SQL Server usando o Transact-SQL. Você pode fazer backup no disco ou no Armazenamento do Azure.
ms.custom: ''
ms.date: 08/04/2016
ms.prod: sql
