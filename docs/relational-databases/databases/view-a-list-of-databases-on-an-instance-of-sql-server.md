...
helpviewer_keywords: 
  ...
  - "bancos de dados atualmente no servidor [SQL Server]"
  - "Lista de bancos de dados [SQL Server]"
  - "exibindo listas de banco de dados"
  - "exibindo listas de bancos de dados"
  - "bancos de dados [SQL Server], exibindo"
  - "servidores [SQL Server], bancos de dados listados em"
