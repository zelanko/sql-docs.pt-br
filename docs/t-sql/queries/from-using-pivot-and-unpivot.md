...
description: Referência de Transact-SQL para os operadores relacionais PIVOT e UNPIVOT. Use esses operadores em instruções SELECT para alterar uma expressão com valor de tabela para outra tabela.
ms.date: 10/14/2019
ms.prod: sql
