...
description: Saiba mais sobre as propriedades e os conjuntos de propriedades do OLE DB associados a objetos de conjunto de linhas de parâmetro com valor de tabela no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
