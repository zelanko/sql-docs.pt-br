...
helpviewer_keywords: 
  ...
  - "tamanhos dos campos padrão"
  - "tamanho do campo [SQL Server]"
  - "formatos de dados [SQL Server], comprimento de campo"
  - "utilitário bcp [SQL Server], comprimento de campo"
...
|XML|0|  
 ...
 \*Para obter mais informações sobre os tipos de dados **decimal** e **numeric**, consulte [decimal e numeric &#40;Transact-SQL&#41;](../../t-sql/data-types/decimal-and-numeric-transact-sql.md).  
