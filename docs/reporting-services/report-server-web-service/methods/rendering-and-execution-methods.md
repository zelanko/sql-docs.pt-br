...
description: No Reporting Services, você pode usar estes métodos para gerenciar a execução e o cache de itens e a renderização de relatórios.
ms.date: 03/06/2017
