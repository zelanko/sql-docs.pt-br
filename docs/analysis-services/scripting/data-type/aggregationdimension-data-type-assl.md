...
# <a name="aggregationdimension-data-type-assl"></a>Tipo de dados AggregationDimension (ASSL)
  Define um tipo de dados primitivo que representa a relação entre uma dimensão e um [agregação](../../../analysis-services/scripting/objects/aggregation-element-assl.md) elemento.  
