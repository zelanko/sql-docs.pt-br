...
description: Saiba como usar a diretiva TYPE com a cláusula FOR XML para solicitar que o resultado de uma consulta seja retornado como dados XML.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
