...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contém a expressão MDX (Multidimensional Expressions) que define como os valores de medida pai são obtidos.  
