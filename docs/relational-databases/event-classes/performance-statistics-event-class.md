...
## <a name="performance-statistics-event-class-data-columns"></a>Colunas de dados da classe de evento Performance Statistics  
 As seguintes tabelas descrevem as colunas de dados de classe de evento associadas a cada uma destas subclasses de evento: EventSubClass 0, EventSubClass 1,EventSubClass 2,EventSubClass 3, EventSubClass 4 e EventSubClass 5.  
