...
description: Saiba como exibir um log de auditoria do SQL Server no SQL Server usando o SQL Server Management Studio. A exibição requer a permissão CONTROL SERVER.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
