...
|INSTABILITY_SENSITIVITY|Algoritmo MTS|Controla o ponto no qual a variância de previsão excede certo limite e o algoritmo ARTxp suprime previsões. O valor padrão é 1.<br /><br /> Observação: Este parâmetro se aplica apenas aos modelos combinados ou que usam o algoritmo ARTxp.|  
