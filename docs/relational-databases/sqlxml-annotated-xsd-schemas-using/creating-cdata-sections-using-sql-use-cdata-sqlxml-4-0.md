...
description: 'Saiba como criar seções CDATA no SQLXML 4,0 usando a anotação sql: use-cdata para escapar blocos de texto que contêm caracteres de marcação.'
ms.date: 01/11/2019
ms.prod: sql
