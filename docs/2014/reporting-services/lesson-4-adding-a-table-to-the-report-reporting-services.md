...
2.  No **dados de relatório** painel, expanda o **AdventureWorksDataset** para exibir os campos do conjunto de dados.  
  
3.  Arraste o campo de data do **dados de relatório** painel para a primeira coluna na tabela.  
...
5.  Arraste o campo produto do **dados de relatório** painel para a terceira coluna na tabela.  
