---
title: "Diagn&#243;stico e solu&#231;&#227;o de problemas do cluster de failover | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "10/21/2015"
...
ms.topic: "article"
helpviewer_keywords: 
  - "solução de problemas, clustering de failover"
  - "clustering de failover, solução de problemas"
 ...
 **Problema 1:** as contas de serviço [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] não conseguem fazer contato com um controlador de domínio.  
 ...
 **Problema 2:** as contas de serviço [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] não são idênticas em todos os nós do cluster, ou o nó não reinicia um serviço [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] migrado de um nó com falha.  
 ...
 **Problema 3:** o [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] não está se conectando usando os Pipes Nomeados.  
