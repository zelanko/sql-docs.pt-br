...
description: Saiba mais sobre a interface IDBProperties do Driver do OLE DB para SQL Server, incluindo o método IDBProperties::GetPropertyInfo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
