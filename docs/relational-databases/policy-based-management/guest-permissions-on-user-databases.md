...
description: Determine se o usuário convidado tem permissão para acessar bancos de dados de usuário no SQL Server. Revogue a permissão do usuário convidado se ela não for necessária.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
