---
title: PrimaryKey e exemplo de propriedades exclusivas (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35286765"
---
# <a name="primarykey-and-unique-properties-example-vc"></a>PrimaryKey e exemplo de propriedades exclusivas (VC + +)
