---
description: Exemplo das propriedades ActiveConnection, CommandText, CommandTimeout, CommandType, size e Direction (VC + +)
title: Exemplo de propriedades de procedimento armazenado (VC + +) | Microsoft Docs
ms.prod: sql
