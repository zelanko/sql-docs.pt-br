...
1. [Configurar o SQL Server Integration Services no Linux com conf ssis](sql-server-linux-configure-ssis.md)
2. [Edições e recursos com suporte do SQL Server 2017 no Linux](sql-server-linux-editions-and-components-2017.md)
3. [A execução no Linux com cron do pacote de agendamento SQL Server Integration Services](sql-server-linux-schedule-ssis-packages.md)
