...
ms.author: jhubbard
manager: jhubbard
ms.openlocfilehash: 1339e256e1adc6aa38cf46d93b4e1937a6d47e90
 ...
 *eOption*  
 ...
 BCPDELAYREADFMT  
 Um booliano, se definido como verdadeiro, fará com que [bcp_readfmt](bcp-readfmt.md) Leia na execução. Se false (padrão), bcp_readfmt imediatamente irá ler o arquivo de formato. Um erro de sequência ocorrerá se BCPDELAYREADFMT for true e você chamar bcp_columns ou bcp_setcolfmt.  
 ...
 Para obter mais informações, consulte [descoberta de metadados](../native-client/features/metadata-discovery.md).  
