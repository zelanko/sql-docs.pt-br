...
|**length**|**bigint**|O comprimento máximo do armazenamento físico de [Sys. systypes &#40;&#41;Transact-SQL ](../../relational-databases/system-compatibility-views/sys-systypes-transact-sql.md).|  
