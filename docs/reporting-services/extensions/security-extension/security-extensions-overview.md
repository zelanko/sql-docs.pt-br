...
description: Saiba mais sobre as extensões de segurança no Reporting Services. Veja as situações em que a autenticação personalizada e a autorização são apropriadas.
ms.date: 05/24/2018
