 ...
 **Pesquisar na coluna**  
 Clique em uma coluna de dados para pesquisar ou clique em ** \<todas as colunas>** para pesquisar todas as colunas de dados no rastreamento.  
