...
|importância|**sysname**|Valor de configuração atual para a importância relativa de uma solicitação neste grupo de carga de trabalho. A importância é um dos seguintes, sendo que médio é o padrão: baixo, médio ou alto.<br /><br /> Não permite valor nulo.|  
