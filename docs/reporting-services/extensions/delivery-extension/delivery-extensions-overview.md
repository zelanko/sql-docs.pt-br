...
description: Leia uma visão geral das extensões de entrega, que você pode usar para entregar relatórios do Reporting Services de várias maneiras, como por meio de email ou compartilhamento de arquivos.
ms.date: 03/14/2017
