...
description: No SQL Server, o recurso FileTables usa uma estrutura de diretório para armazenar arquivos. Aprenda a criar uma FileTable ou então alterar ou remover uma FileTable existente.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
ms.reviewer: ''
