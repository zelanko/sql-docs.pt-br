...
|**failover\_mode\_desc**|**nvarchar(60)**|Descrição do **failover\_modo**, um de:<br /><br /> MANUAL<br /><br /> AUTOMATIC<br /><br /> Para alterar o modo de failover, use o FAILOVER\_opção de modo de [ALTER AVAILABILITY GROUP](../../t-sql/statements/alter-availability-group-transact-sql.md) [!INCLUDE[tsql](../../includes/tsql-md.md)] instrução.|  
