...
```  
 ...
 Para discussões detalhadas sobre o processamento de transações [, consulte Atualizando e persistindo dados](./updating-and-persisting-data.md).