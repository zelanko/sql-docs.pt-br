...
---
# Propriedades do banco de dados (p&#225;gina Grupos de Arquivos)
...
## Opções de grupo de arquivos de dados de linha e FILESTREAM  
 **Nome**  
...
## Opções de grupo de arquivos de dados com otimização de memória  
 **Nome**  
