...
description: Saiba como usar parâmetros para trocar dados entre procedimentos armazenados e funções e o aplicativo ou a ferramenta que chamou o procedimento armazenado ou a função.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
