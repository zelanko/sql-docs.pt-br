...
|[SP: iniciando a classe de evento](../event-classes/sp-starting-event-class.md), [SP: concluído a classe de evento](../event-classes/sp-completed-event-class.md)|Usado para monitorar a execução de procedimentos armazenados [!INCLUDE[tsql](../../../includes/tsql-md.md)].|  
