...
|[CEILING &#40;expressão SSIS&#41;](ceiling-ssis-expression.md)|Retorna o menor inteiro que é maior que ou igual a uma expressão numérica.|  
...
|[ENERGIA &#40;expressão SSIS&#41;](power-ssis-expression.md)|Retorna o resultado da elevação de uma expressão numérica a uma potência.|  
...
|[ENTRADA &#40;expressão SSIS&#41;](sign-ssis-expression.md)|Retorna o sinal positivo (+), negativo (-) ou zero (0) de uma expressão numérica.|  
|[QUADRADO &#40;expressão SSIS&#41;](square-ssis-expression.md)|Retorna o quadrado de uma expressão numérica.|  
...
|[ESQUERDA &#40;expressão SSIS&#41;](left-ssis-expression.md)|Retorna o número especificado de caracteres da parte mais à esquerda da expressão character especificada.|  
|[INFERIOR &#40;expressão SSIS&#41;](lower-ssis-expression.md)|Retorna uma expressão character depois de converter caracteres maiúsculos em minúsculos.|  
...
|[SUBSTITUIR &#40;expressão SSIS&#41;](replace-ssis-expression.md)|Retorna uma expressão de caractere depois de substituir uma cadeia na expressão por uma cadeia diferente ou vazia.|  
|[REPLICAR &#40;expressão SSIS&#41;](replicate-ssis-expression.md)|Retorna uma expressão character, replicada um número especificado de vezes.|  
|[INVERTER &#40;expressão SSIS&#41;](reverse-ssis-expression.md)|Retorna uma expressão character na ordem inversa.|  
|[DIREITA &#40;expressão SSIS&#41;](right-ssis-expression.md)|Retorna o número especificado de caracteres da parte mais à direita da expressão character especificada.|  
...
|[Subcadeia de caracteres &#40;expressão SSIS&#41;](substring-ssis-expression.md)|Retorna uma parte de uma expressão de caractere.|  
...
|[SUPERIOR &#40;expressão SSIS&#41;](upper-ssis-expression.md)|Retorna uma expressão de caractere depois de converter caracteres minúsculos em maiúsculos.|  
  
 O avaliador de expressão fornce as seguintes funções de data e hora.  
  
|Função|Description|  
|--------------|-----------------|  
|[DATEADD &#40;expressão SSIS&#41;](dateadd-ssis-expression.md)|Retorna um novo valor DT_DBTIMESTAMP adicionando um intervalo de data ou hora a uma data especificada.|  
|[DATEDIFF &#40;expressão SSIS&#41;](datediff-ssis-expression.md)|Retorna o número de limites de data e hora entre duas datas especificadas.|  
|[DATEPART &#40;expressão SSIS&#41;](datepart-ssis-expression.md)|Retorna um inteiro que representa uma parte de uma data.|  
|[DIA &#40;expressão SSIS&#41;](day-ssis-expression.md)|Retorna um inteiro que representa o dia da data especificada.|  
|[GETDATE &#40;expressão SSIS&#41;](getdate-ssis-expression.md)|Retorna a data atual do sistema.|  
|[GETUTCDATE &#40;expressão SSIS&#41;](getutcdate-ssis-expression.md)|Retorna a data atual do sistema na hora UTC (Universal Time Coordinate ou Greenwich Mean Time).|  
|[MÊS &#40;expressão SSIS&#41;](month-ssis-expression.md)|Retorna um inteiro que representa o mês da data especificada.|  
|[ANO &#40;expressão SSIS&#41;](year-ssis-expression.md)|Retorna um inteiro que representa o ano da data especificada.|  
...
|[NULO &#40;expressão SSIS&#41;](null-ssis-expression.md)|Retorna um valor nulo de um tipo de dados solicitado.|  
