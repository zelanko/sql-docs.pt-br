...
description: Use gráficos de linha para representar grandes quantidades de dados que ocorrem durante um período de tempo no Construtor de Relatórios.
ms.date: 03/03/2017
