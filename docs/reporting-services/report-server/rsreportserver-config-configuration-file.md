...
-   [Configuração geral de extensões da interface do usuário de entrega](#bkmk_ui)  
...
-   [Extensões (arquivo RSReportServer.config) no modo nativo](#bkmk_extensions)  
    ...
    -   [Configuração geral de extensões de entrega](#bkmk_extensionsgeneral)  
        ...
        -   [Configurações de extensão da entrega de compartilhamento de arquivos](#bkmk_fileshare_extension)  
  
        -   [Configurações de extensão de email do servidor de relatório](#bkmk_email_extension)  
    ...
    -   [Configuração de geração de modelos](#bkmk_model)  
...
-   [Arquivo de configuração padrão para o servidor de relatório modo do SharePoint](#bkmk_sharepointdefaultfile)  
 ...
 **URLReservations** define o acesso HTTP ao serviço Web Servidor de Relatórios e ao Gerenciador de Relatórios para a instância atual. Os URLs são reservados e armazenados em HTTP.SYS quando você configura o servidor de relatório.  
