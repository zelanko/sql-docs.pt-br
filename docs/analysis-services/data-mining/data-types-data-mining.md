...
helpviewer_keywords: 
  ...
  - "colunas [mineração de dados], tipos de dados"
  - "mineração de dados [Analysis Services], tipos de dados"
...
## Especificando um tipo de dados  
