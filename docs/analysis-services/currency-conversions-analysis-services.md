...
ms.topic: "article"
helpviewer_keywords: 
  - "várias conversões de moeda"
  - "dados monetários [SQL Server]"
  - "moeda [Analysis Services]"
  - "convertendo moeda"
  - "conversões de moeda um para muitos [Analysis Services]"
  - "conversões de moeda muitos para muitos [Analysis Services]"
  - "conversões de moedas muitos para um [Analysis Services]"
...
## Terminologia de conversão de moedas  
...
## Definindo várias conversões de moedas  
...
### Identificando conversões de moedas  
