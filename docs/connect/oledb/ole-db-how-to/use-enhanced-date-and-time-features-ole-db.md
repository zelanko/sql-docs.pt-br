---
title: Usar recursos avançados de data e hora (Driver do OLE DB)
description: Saiba como usar os recursos de data/hora, data, hora, datetime2 e datetimeoffset para executar comandos e recuperar os resultados do conjunto de linhas no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
