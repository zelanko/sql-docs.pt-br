...
# <a name="perspectivemeasure-data-type-assl"></a>Tipo de dados PerspectiveMeasure (ASSL)
  Define um tipo de dados primitivo que representa informações sobre uma medida em um [PerspectiveMeasureGroup](../../../analysis-services/scripting/data-type/perspectivemeasuregroup-data-type-assl.md) elemento.  
