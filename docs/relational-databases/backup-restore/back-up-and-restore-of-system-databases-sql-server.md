...
ms.topic: "article"
helpviewer_keywords: 
  - "bancos de dados do sistema [SQL Server], fazendo backup e restauração"
  - "restaurando bancos de dados do sistema [SQL Server]"
  - "fazendo backup [SQL Server], bancos de dados do sistema"
  - "backups de bancos de dados [SQL Server], bancos de dados do sistema"
  - "servidores [SQL Server], backup"
