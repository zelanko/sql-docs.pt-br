...
description: Use este artigo de referência para entender os comandos SQL na ferramenta azdata, especificamente os comandos bdc spark statement.
author: MikeRayMSFT
ms.author: mikeray
