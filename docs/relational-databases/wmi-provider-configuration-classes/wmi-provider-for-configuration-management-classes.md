---
title: Provedor WMI para classes de gerenciamento de configuração
description: Descubra e implemente a funcionalidade que o Instrumentação de Gerenciamento do Windows fornece. Escolha essas classes para Configuration Manager.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
