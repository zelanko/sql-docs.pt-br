...
helpviewer_keywords: 
  ...
  - "estruturas de mineração [Analysis Services], processando"
...
-   Criando uma consulta DMX (Data Mining Extensions) no modelo e detalhando a estrutura. Para obter mais informações, consulte [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
-   Criando uma consulta DMX nos casos da estrutura. Para obter mais informações, consulte [SELECT FROM &#60;structure&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md).  
