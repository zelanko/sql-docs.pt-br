...
|**Hidden**|Falso|Especifica se a tabela é ocultada das listas de campo de cliente de relatório.|  
...
###  <a name="bkmk_config_prop"></a>Para definir as configurações de propriedade da tabela  
