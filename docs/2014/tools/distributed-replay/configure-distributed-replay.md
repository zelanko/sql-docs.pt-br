...
# <a name="configure-distributed-replay"></a>Configure Distributed Replay
  Os [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] detalhes de configuração de Distributed Replay são especificados em arquivos XML no controlador de Distributed Replay, clientes e onde a ferramenta de administração está instalada. Esses arquivos incluem o seguinte:  
  
-   [Arquivo de configuração do controlador](#DReplayController)  
  
-   [Arquivo de configuração do cliente](#DReplayClient)  
...
##  <a name="DReplayClient"></a>Arquivo de configuração do cliente: DReplayClient. config  
...
##  <a name="PreprocessConfig"></a>Arquivo de configuração de pré-processamento: DReplay. exe. pré-processar. config  
...
|Tempo ocioso máximo|`<MaxIdleTime>`|Arredonda o tempo ocioso para um número absoluto (em segundos).|Um inteiro que é >=-1<br /><br /> 
  `-1` indica que não houve alteração do valor original no arquivo de rastreamento original.<br /><br /> 
  `0` indica que há alguma atividade ocorrendo em um determinado momento.|Não. Por padrão, o valor é `-1`.|  
