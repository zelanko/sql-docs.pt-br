...
|Recurso|Colunas computadas|**Aplica-se a:** [!INCLUDE[ssSQL14-md](../../includes/sssql14-md.md)] e [!INCLUDE[ssSQL15-md](../../includes/sssql15-md.md)]<br/>As colunas computadas não têm suporte para tabelas com otimização de memória. Remova as colunas computadas da instrução **CREATE TABLE** .<br/><br/>[!INCLUDE[ssSDSFull_md](../../includes/ssSDSFull-md.md)] e o SQL Server começando pelo [!INCLUDE[sssqlv14-md](../../includes/sssqlv14-md.md)] são compatíveis com colunas computadas em tabelas com otimização de memória e índices.|  
...
|Operação|alteração de esquema|Tabelas com otimização de memória e procedimentos armazenados compilados nativamente não dão suporte a algumas alterações de esquema:<br/> [!INCLUDE[ssSDSFull_md](../../includes/ssSDSFull-md.md)] e SQL Server começando pelo [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)]: as operações ALTER TABLE, ALTER PROCEDURE e sp_rename são compatíveis. Não há suporte para outras alterações de esquema, por exemplo, adição de propriedades estendidas.<br/><br/>[!INCLUDE[ssSQL15-md](../../includes/sssql15-md.md)]: as operações ALTER TABLE e ALTER PROCEDURE são compatíveis. Não há suporte para outras alterações de esquema, incluindo sp_rename.<br/><br/>[!INCLUDE[ssSQL14-md](../../includes/sssql14-md.md)]: alterações de esquema não são compatíveis. Para alterar a definição de uma tabela com otimização de memória ou um procedimento armazenado compilado nativamente, primeiro remova o objeto e, em seguida, recrie-o com a definição desejada.| 
...
|Recurso|CASE|**Aplica-se ao:** [!INCLUDE[ssSQL14-md](../../includes/sssql14-md.md)] e ao SQL Server começando pelo [!INCLUDE[ssSQL15-md](../../includes/sssql15-md.md)]<br/>**Não** há suporte para expressões CASE em procedimentos armazenados compilados nativamente. Crie consultas para cada caso. Para obter mais informações,veja [Implementando uma expressão CASE em um procedimento armazenado compilado de modo nativo](../../relational-databases/in-memory-oltp/implementing-a-case-expression-in-a-natively-compiled-stored-procedure.md).<br/><br/>[!INCLUDE[ssSDSFull_md](../../includes/ssSDSFull-md.md)] e o SQL Server começando pelo [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] são compatíveis com expressões CASE.|  
...
|Operador|APPLY|**Aplica-se ao:** [!INCLUDE[ssSQL14-md](../../includes/sssql14-md.md)] e ao SQL Server começando pelo [!INCLUDE[ssSQL15-md](../../includes/sssql15-md.md)]<br/>Não há suporte para esse operador. Remova **APPLY** do procedimento armazenado compilado de modo nativo.<br/><br/>[!INCLUDE[ssSDSFull_md](../../includes/ssSDSFull-md.md)] e o SQL Server começando pelo [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] são compatíveis com o operador APPLY em módulos compilados nativamente.|  
...
|Opção|WITH TIES|**Aplica-se a:** [!INCLUDE[ssSDS14_md](../../includes/sssql14-md.md)] e [!INCLUDE[ssSQL15-md](../../includes/sssql15-md.md)]<br/>Essa opção não tem suporte com cláusulas **TOP** . Remova **WITH TIES** da consulta no procedimento armazenado compilado de modo nativo.<br/><br/>[!INCLUDE[ssSDSFull_md](../../includes/ssSDSFull-md.md)] e o SQL Server começando pelo [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] são compatíveis com a opção **TOP WITH TIES**.|  
