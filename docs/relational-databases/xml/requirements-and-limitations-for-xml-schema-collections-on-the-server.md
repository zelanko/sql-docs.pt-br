...
ms.topic: "article"
helpviewer_keywords: 
  - "identificadores [coleções de esquema XML]"
  - "coleções do esquema XML [SQL Server], limitações"
  - "grupos de substituição [XML no SQL Server]"
  - "coleções do esquema XML [SQL Server], diretrizes"
  - "validação incerta"
  - "aspectos de enumeração [XML no SQL Server]"
  - "precisão decimal [XML no SQL Server]"
  - "valores repetidos de coleção de esquema XML "
  - "coleções do esquema [SQL Server], limitações"
  - "fusos horários [XML no SQL Server]"
  - "decimais de precisão [XML no SQL Server]"
  - "coleções do esquema [SQL Server], diretrizes"
...
|[Tipo xs:QName](../../relational-databases/xml/the-xs-qname-type.md)|Descreve a limitação relativa ao tipo xs:QName.|  
...
|[Coleções de esquema XML grandes e condições de memória insuficiente](../../relational-databases/xml/large-xml-schema-collections-and-out-of-memory-conditions.md)|Fornece soluções para a condição de memória insuficiente que às vezes acontece com grandes coleções de esquema.|  
