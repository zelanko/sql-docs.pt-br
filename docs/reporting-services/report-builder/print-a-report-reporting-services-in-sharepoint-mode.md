...
description: Se um servidor de relatório for executado no modo do SharePoint, você poderá imprimir um relatório de um aplicativo Web do SharePoint de um site, um navegador ou um aplicativo de destino do SharePoint.
ms.date: 05/14/2019
