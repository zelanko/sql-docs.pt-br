...
description: Saiba como reduzir um banco de dados por meio do Objeto no SQL Server usando o SQL Server Management Studio ou Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
