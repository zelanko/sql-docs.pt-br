...
---
# Solucionar problemas de assinaturas e entrega do Reporting Services
...
em que a \<mensagem de erro> é substituída pelas informações de mensagem de erro adicionais retornadas do CDO (Collaboration Data Objects).  
