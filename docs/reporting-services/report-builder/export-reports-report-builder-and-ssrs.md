...
-   **Use os dados do relatório como feeds de dados em aplicativos.** Por exemplo, você pode gerar feeds de dados compatíveis com Atom Power Pivot ou Power BI pode consumir e, em seguida, trabalhar com os dados no Power Pivot ou Power BI. Para obter mais informações, consulte [gerar Feeds de dados de um relatório](../../reporting-services/report-builder/generate-data-feeds-from-a-report-report-builder-and-ssrs.md)  
...
3.  Na barra de ferramentas do Visualizador de Relatórios, clique na seta suspensa **Exportar** .  
     ...
     ![Portal de web Reporting Services exportação](../../reporting-services/report-builder/media/ssrsportal-export.png "portal de web do Reporting Services exportação")  
