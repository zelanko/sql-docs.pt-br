...
ms.topic: "article"
helpviewer_keywords: 
  - "desempenho do servidor [SQL Server], objetos para monitoramento"
  - "monitoramento do banco de dados [SQL Server], objetos para monitoramento"
  - "gráficos [SQL Server]"
  - "Monitor do Sistema [SQL Server], contadores"
  - "contadores [SQL Server], listados"
  - "objetos [SQL Server], monitoramento do desempenho"
  - "objetos [SQL Server], Monitor do Sistema Windows"
  - "contadores de desempenho [SQL Server], sobre contadores de desempenho"
  - "Monitor do Sistema [SQL Server], objetos"
  - "contadores de desempenho [SQL Server]"
  - "contadores [SQL Server], sobre contadores de desempenho"
  - "ajuste do bancos de dados [SQL Server], objetos para monitoramento"
  - "desempenho do banco de dados [SQL Server], objetos para monitoramento"
  - "SQL Server, objetos"
  - "monitoramento do desempenho [SQL Server], objetos para monitoramento"
  - "Monitor do Sistema Windows [SQL Server], objetos"
  - "Monitor do Sistema Windows [SQL Server], contadores"
  - "contadores [SQL Server]"
  - "contadores de desempenho [SQL Server], listados"
