...
---
# Definir o tipo de dados de uma coluna (SSAS tabular)
...
### Para alterar o tipo de dados ou o formato de exibição de uma coluna  
...
## Considerações sobre quando alterar os tipos de dados  
...
### Entendendo tipos de dados determinados automaticamente  
...
### Noções básicas sobre a conversão de dados  
