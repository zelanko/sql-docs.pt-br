---
title: Novidades no SQL Server 2016 | Microsoft Docs
ms.custom:
- SQL2016_New_Updated
ms.date: 12/15/2016
...
---
# <a name="what39s-new-in-sql-server-2016"></a>Novidades no SQL Server 2016
 O[!INCLUDE[ssSQL15_md](../includes/sssql15-md.md)] é o maior passo rumo à inovação no histórico de dados da plataforma Microsoft. Obtenha informações em tempo real em seus dados transacionais e analíticos com uma plataforma de banco de dados escalonável com tudo internamente, desde o desempenho em memória incomparável, inovações de segurança e alta disponibilidade até análise avançada que torna os aplicativos críticos inteligentes.
 
 Este tópico resume os links que levam a informações sobre novidades do nível de componente do [!INCLUDE[ssCurrent_md](../includes/sscurrent-md.md)] .   
 
  ![SQL Server 2016](../sql-server/media/sql-server-2016.png) 
 
[Leia a folha de dados de edições do SQL Server 2016](http://download.microsoft.com/download/8/A/2/8A2BC8C5-BBA0-4A9C-90BC-AC957D3454D9/SQL_Server_2016_Editions_datasheet.pdf)
...
[![Máquina Virtual pequena do Azure](../analysis-services/media/azure-virtual-machine-small.png)](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1standardwindowsserver2016/) Tem uma conta do Azure?  Em seguida, acesse **[aqui](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1standardwindowsserver2016/)** para criar uma Máquina Virtual com o SQL Server 2016 SP1 já está instalado.  
 ...
 ## <a name="whats-new-in-sql-server"></a>O que há de novo no SQL Server?
Links para tópicos individuais:
 
 - [Instalação do SQL Server](../database-engine/install-windows/installation-for-sql-server-2016.md)   
  
 - [Mecanismo do Analysis Services (SSAS)](../analysis-services/what-s-new-in-analysis-services.md)  
  
 - [Mecanismo de Banco de Dados](../database-engine/configure-windows/what-s-new-in-sql-server-2016-database-engine.md)
 ...
 - [Serviços de Integração](../integration-services/what-s-new-in-integration-services-in-sql-server-2016.md)    
