...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Contém informações sobre as especificações de auditoria do servidor em uma auditoria do SQL Server de uma instância de servidor. Para obter mais informações sobre auditoria do SQL Server, consulte [auditoria do SQL Server &#40; mecanismo de banco de dados &#41;](../../relational-databases/security/auditing/sql-server-audit-database-engine.md).  
