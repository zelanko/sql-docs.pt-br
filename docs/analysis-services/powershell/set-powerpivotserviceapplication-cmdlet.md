...
---
# Cmdlet Set-PowerPivotServiceApplication
...
## Description  
 ...
 Para verificar suas alterações, execute o seguinte cmdlet: Get-PowerPivotServiceApplication -Identity \<GUID> | format-list.  
