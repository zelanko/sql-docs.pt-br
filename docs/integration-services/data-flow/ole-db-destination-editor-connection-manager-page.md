...
### Modo de acesso aos dados = Tabela ou exibição – carregamento rápido  
...
### Modo de acesso aos dados = Variável do nome da tabela ou do nome de exibição – carregamento rápido  
 **Nome da variável**  
 Selecione a variável que contém o nome da tabela ou da exibição.  
