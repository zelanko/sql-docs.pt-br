...
|[getXAConnection (Java, Java)](../../../connect/jdbc/reference/getxaconnection-method-java-lang-string-java-lang-string.md)|Tenta estabelecer uma conexão de banco de dados física usando o nome de usuário e senha determinados.|  
