---
title: Executando consultas SQL (SQLXML)
description: Saiba como executar consultas SQL usando classes gerenciadas SQLXML.
ms.date: 03/14/2017
ms.prod: sql
