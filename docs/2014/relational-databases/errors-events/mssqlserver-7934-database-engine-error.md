...
|Texto da mensagem|Erro de tabela: O diretório de Filestream F_ID da ID da ID de objeto O_ID, ID de índice I_ID, ID de partição PN_ID não foi encontrado.|  
