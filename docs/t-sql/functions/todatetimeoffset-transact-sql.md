...
### <a name="d-changing-the-time-zone-offset-of-the-current-date-and-time"></a>D. Alterando o deslocamento de fuso horário da data e da hora atuais  
 O exemplo seguinte altera o deslocamento de fuso horário da data e da hora atuais para o fuso horário `-07:00`.  
...
### <a name="e-changing-the-time-zone-offset-in-minutes"></a>E. Alterando o deslocamento de fuso horário em minutos  
 O exemplo seguinte altera o fuso horário atual para `-120` minutos.  
...
### <a name="f-adding-a-13-hour-time-zone-offset"></a>F. Adicionando um deslocamento de fuso horário de 13 horas  
 O exemplo seguinte adiciona um deslocamento de fuso horário de 13 horas a uma data e hora.  
