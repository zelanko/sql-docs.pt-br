...
helpviewer_keywords: 
  ...
  - "processando objetos [Integration Services]"
...
## Configuração da tarefa Processamento do Analysis Services  
...
-   [Editor da Tarefa Processamento do Analysis Services &#40;Página Analysis Services&#41;](../../integration-services/control-flow/analysis-services-processing-task-editor-analysis-services-page.md)  
...
## Configuração programática da tarefa Processamento do Analysis Services  
