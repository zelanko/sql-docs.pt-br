...
`[ @loginame = ] 'login'` É o nome do usuário do Windows ou grupo do qual revogar o acesso. *login* deve incluir o nome de domínio, por exemplo **[ADVWKS\sylvester1]**. *login* está **sysname**, sem padrão.  
