...
|**pre_creation_cmd**|**tinyint**|Especifica o que o sistema deve fazer se detectar um objeto existente com o mesmo nome no Assinante, ao aplicar o instantâneo para esse artigo:<br /><br /> **0** = nada.<br /><br /> **1** = excluir tabela de destino.<br /><br /> **2** = tabela de destino de soltar.<br /><br /> **3** = destino truncar a tabela.|  
