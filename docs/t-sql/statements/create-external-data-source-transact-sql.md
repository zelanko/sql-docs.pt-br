...
Cria uma fonte de dados externa para consultas do PolyBase ou do Banco de Dados Elástico. Fontes de dados externas são usadas para estabelecer a conectividade e dar suporte a quatro casos de uso principal:
...
> [!NOTE]  
> O PolyBase é compatível com o SQL Server (2016 ou superior), o SQL Data Warehouse do Azure e o Parallel Data Warehouse. As [consultas elásticas][intro_eq] são compatíveis apenas com o Banco de Dados SQL do Azure v12 ou posterior.
...
Especifica o nome da fonte de dados definido pelo usuário. O nome precisa ser exclusivo no banco de dados no SQL Server, no BD SQL (Banco de Dados SQL) e no SQL DW (SQL Data Warehouse). O nome precisa ser exclusivo no servidor no PDW (Parallel Data Warehouse).
...
- Use HADOOP quando a fonte de dados externa for Hortonworks, Cloudera, Armazenamento de Blobs do Azure, ADLS Gen 1 ou ADLS Gen 2.
...
Para obter um exemplo de como usar `TYPE` = `HADOOP` para carregar dados do Armazenamento de Blobs do Azure, veja [Criar fonte de dados externa para referenciar o armazenamento de blobs do Azure](#e-create-external-data-source-to-reference-azure-blob-storage).
...
Para obter um exemplo que mostra como criar uma fonte de dados externa em que `TYPE` = `SHARD_MAP_MANAGER`, veja [Criar uma fonte de dados externa do gerenciador de mapa de fragmentos](#f-create-a-shard-map-manager-external-data-source)

## <a name="permissions"></a>Permissões

Requer permissão CONTROL no banco de dados em SQL Server, Parallel Data Warehouse, Banco de Dados SQL e SQL Data Warehouse.
...
## <a name="examples-sql-server-2016-and-parallel-data-warehouse"></a>Exemplos: SQL Server (2016+) e Parallel Data Warehouse
...
## <a name="examples-sql-server-2016-sql-data-warehouse-and-parallel-data-warehouse"></a>Exemplos: SQL Server (2016+), SQL Data Warehouse e Parallel Data Warehouse
...
## <a name="examples-sql-database"></a>Exemplos: Banco de Dados SQL

### <a name="f-create-a-shard-map-manager-external-data-source"></a>F. Criar uma fonte de dados externa do gerenciador de mapa de fragmentos
...
### <a name="g-create-an-rdbms-external-data-source"></a>G. Criar uma fonte de dados externa do RDBMS
...
## <a name="examples-sql-data-warehouse"></a>Exemplos: SQL Data Warehouse

### <a name="h-create-external-data-source-to-reference-azure-data-lake-store-gen-1"></a>H. Criar uma fonte de dados externa para referenciar o Azure Data Lake Storage Gen 1
...
### <a name="i-create-external-data-source-to-reference-azure-data-lake-store-adls-gen-2"></a>I. Criar uma fonte de dados externa para referenciar o ADLS (Azure Data Lake Storage) Gen 2
