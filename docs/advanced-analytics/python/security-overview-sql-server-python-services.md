---
title: Visão geral de segurança para Python no aprendizado de máquina do SQL Server | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "31202128"
---
# <a name="security-overview-for-python-in-sql-server-machine-learning"></a>Visão geral de segurança para Python no aprendizado de máquina do SQL Server
