...
ms.topic: "article"
helpviewer_keywords: 
  - "Instalação [SQL Server], software"
  - "software [o SQL Server]"
  - "Instalando o SQL Server, software"
  - "sistemas operacionais [SQL Server], requisitos do SQL Server"
  - "Instalação [SQL Server], suporte em qualquer idioma"
  - "sistemas operacionais [SQL Server], suporte em qualquer idioma"
  - "conexões de rede [SQL Server], requisitos"
  - "espaço em disco [SQL Server], instalações do SQL Server"
  - "WOW [SQL Server]"
  - "Instalação [SQL Server], hardware"
  - "dependências [SQL Server], instalações do SQL Server"
  - "requisitos de hardware de cluster [SQL Server]"
  - "pontos de extremidade [SQL Server], instalações do SQL Server"
  - "Internet [SQL Server], instalações do SQL Server"
  - "hardware [SQL Server]"
  - "Windows on Windows [SQL Server]"
  - "instalando o SQL Server, hardware"
  - "Verificador de Configuração da Instalação"
  - "SCC [SQL Server]"
  - "sistemas operacionais [SQL Server]"
  - "espaço [SQL Server], instalações do SQL Server"
  - "verificador de configuração do sistema"
  - "instalando o SQL Server, suporte em qualquer idioma"
  - "Internet [SQL Server]"
  - "espaço [SQL Server]"
  - "suporte a sistemas estendidos [SQL Server]"
  - "edição de 64 bits [SQL Server]"
  - "clustering de failover [SQL Server]"
  - "clustering de failover [SQL Server], requisitos de hardware"
  - "edição de 32 bits [SQL Server]"
  - "localidades [SQL Server], instalações do SQL Server"
  - "suporte entre idiomas"
  - "espaço em disco [SQL Server]"
  - "versões localizadas do SQL Server"
...
-    Criar uma Máquina Virtual com o [**SQL Server 2016**](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016rtmenterprisewindowsserver2012r2/?wt.mc_id=sqL16_vm) já instalado.  
...
-   [Requisitos de Hardware e Software](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#hwswr)  
  
-   [Requisitos de processador, de memória e do sistema operacional](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#pmosr)  
  
-   [Suporte em qualquer idioma](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#CrossLanguageSupport)  
  
-   [Requisitos de espaço em disco rígido](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#HardDiskSpace)  
  
-   [Tipos de armazenamento de arquivos de dados](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes)  
  
-   [Instalando o SQL Server em um controlador de domínio](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#DC_support)  
  
##  <a name="a-namehwswra-hardware-and-software-requirements"></a><a name="hwswr"></a> Requisitos de Hardware e Software  
...
|Disco rígido|O [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] requer no mínimo 6 GB de espaço disponível no disco rígido.<br/><br/> Os requisitos de espaço em disco variam de acordo com os componentes do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] instalados. Para obter mais informações, consulte [Requisitos de espaço em disco rígido](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#HardDiskSpace) posteriormente neste tópico. Para obter mais informações sobre tipos de armazenamento de arquivos de dados com suporte, consulte [Tipos de armazenamento para arquivos de dados](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes).|  
...
##  <a name="a-namepmosra-processor-memory-and-operating-system-requirements"></a><a name="pmosr"></a> Requisitos de processador, de memória e do sistema operacional  
...
-   [Edições Principais do SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#TOP_Principal)  
  
-   [Edições de Amplitude do SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#TOP_Breadth)  
...
### <a name="features-supported-on-32bit-client-operating-systems"></a>Recursos com suporte nos sistemas operacionais cliente de 32 bits  
...
###  <a name="a-nametopprincipala-principal-editions-of-includesscurrenttokensscurrentmdmd"></a><a name="TOP_Principal"></a> Principais edições do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
###  <a name="a-nametopbreadtha-breadth-editions-of-includesscurrenttokensscurrentmdmd"></a><a name="TOP_Breadth"></a> Edições de amplitude do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
##  <a name="a-namecrosslanguagesupporta-crosslanguage-support"></a><a name="CrossLanguageSupport"></a> Suporte em qualquer idioma  
...
##  <a name="a-nameharddiskspacea-hard-disk-space-requirements"></a><a name="HardDiskSpace"></a> Requisitos de espaço em disco rígido  
...
|Suplemento [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] para produtos do SharePoint|325 MB|  
...
##  <a name="a-namestoragetypesa-storage-types-for-data-files"></a><a name="StorageTypes"></a> Tipos de armazenamento de arquivos de dados  
...
-   Compartilhamento de arquivos SMB  
    ...
    > [!NOTE]  
    >  O armazenamento SMB não tem suporte para arquivos de dados do [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] em instalações autônomas ou clusterizadas. Em vez disso, use o armazenamento anexado direto ou a rede de área de armazenamento.  
...
##  <a name="a-namedcsupporta-installing-includessnoversiontokenssnoversionmdmd-on-a-domain-controller"></a><a name="DC_support"></a> Instalando o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] em um Controlador de domínio  
 Por motivos de segurança, é recomendável não instalar o [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] em um controlador de domínio. A Instalação do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] não bloqueará a instalação em um computador que seja um controlador de domínio, mas as seguintes limitações se aplicam:  
