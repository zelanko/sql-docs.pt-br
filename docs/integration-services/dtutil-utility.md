...
-   Abra a janela Prompt de Comando, mude para o diretório que contém a versão de 64 bits do utilitário *(\<drive>* :\Arquivos de Programas\Microsoft SQL Server\130\DTS\Binn) e execute o utilitário nesse local.  
