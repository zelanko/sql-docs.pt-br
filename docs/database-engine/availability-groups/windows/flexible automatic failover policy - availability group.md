...
ms.topic: "article"
helpviewer_keywords: 
  - "Grupos de disponibilidade [SQL Server], política de failover flexível"
...
|Cinco|Em qualquer condição de falha qualificada. Especifica que um failover automático é iniciado em qualquer condição de falha qualificada, incluindo:<br /><br /> Esgotamento dos threads de trabalho do SQL Engine.<br /><br /> Detecção de um deadlock insolúvel.<br /><br /> <br /><br /> Este é o nível mais restritivo.|5|**OnAnyQualifiedFailureConditions**|  
