...
description: Saiba mais sobre os benefícios e requisitos da Proteção Estendida para Autenticação para o Mecanismo de Banco de Dados do SQL Server. Veja como habilitá-la e configurá-la.
