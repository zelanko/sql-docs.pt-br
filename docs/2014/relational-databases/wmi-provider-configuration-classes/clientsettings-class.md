...
ms.locfileid: "36012857"
---
# <a name="clientsettings-class"></a>Classe ClientSettings
  O [classe ClientSettings](clientsettings-class.md) representa o [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] configurações no cliente.  
