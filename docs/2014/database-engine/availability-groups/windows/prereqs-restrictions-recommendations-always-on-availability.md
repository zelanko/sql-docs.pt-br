...
-   [Windows 2008 R2 Failover Clustering multissite](https://kiruba4u.blogspot.com/2012/03/failover-clustering-in-windows-server.html)  
...
-   **Réplicas de disponibilidade devem ser hospedadas por nós diferentes de um cluster WSFC:**  Para um determinado grupo de disponibilidade, réplicas de disponibilidade devem ser hospedadas por instâncias de servidor executadas em nós diferentes do mesmo cluster WSFC. A única exceção é que, embora tenha sido migrado para outro cluster WSFC, um grupo de disponibilidade pode temporariamente abranger dois clusters.  
