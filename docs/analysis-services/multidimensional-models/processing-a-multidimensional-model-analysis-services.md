...
ms.topic: "article"
helpviewer_keywords: 
  - "modo online [Analysis Services]"
  - "objetos de processamento [Analysis Services]"
  - "partições [Analysis Services], processando"
  - "trabalhos [Analysis Services]"
  - "objetos [Analysis Services], processando"
  - "reprocessando objetos"
  - "análise de impacto [Analysis Services]"
  - "dimensões [Analysis Services], processando"
  - "modo projeto [Analysis Services]"
  - "cubos [Analysis Services], processando"
