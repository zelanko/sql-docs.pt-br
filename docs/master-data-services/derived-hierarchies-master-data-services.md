...
description: Saiba como criar uma hierarquia derivada para realçar qualquer uma das relações de atributo baseadas em domínio existentes em um modelo de Master Data Services.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
