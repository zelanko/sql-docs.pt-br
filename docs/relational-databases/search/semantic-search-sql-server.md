...
helpviewer_keywords: 
  ...
  - "pesquisa semântica [SQL Server], visão geral"
  - "pesquisa semântica estatística [SQL Server]"
  - "pesquisa semântica estatística [SQL Server], visão geral"
