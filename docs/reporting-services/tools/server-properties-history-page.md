...
description: Saiba como usar a página Histórico do Reporting Services no SQL Server Management Studio para definir um valor padrão para o número de cópias do histórico de relatórios a serem retidas.
ms.date: 06/10/2016
