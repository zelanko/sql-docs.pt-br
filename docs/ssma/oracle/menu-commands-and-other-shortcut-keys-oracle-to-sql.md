...
description: Saiba mais sobre os atalhos de teclado para acessar comandos de menu e outras teclas de atalho usadas em várias caixas de diálogo do aplicativo SSMA para Oracle.
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|Exiba a caixa de diálogo conectar ou reconectar ao Oracle.|ALT + F + T|  
...
|Acesse o submenu gerenciamento de backup Oracle.|ALT + S + B|  
|Caixa de diálogo Exibir adicionar tabelas ao backup para Oracle.|ALT + S + B + B|  
|Exibir as tabelas de restauração do backup para a caixa de diálogo Oracle.|ALT + S + B + R|  
|Exiba a caixa de diálogo gerenciar conteúdo de backup para Oracle.|ALT + S + B + C|  
...
|PARA FAZER ISSO|IMPRESSÃO|  
|--------------|---------|  
|Exibir sobre o SSMA para a caixa de diálogo do Oracle.|ALT + H + A|  
...
[Teclas de atalho&#40;Oracle para SQL&#41;](../../ssma/oracle/shortcut-keys-oracle-to-sql.md)  
