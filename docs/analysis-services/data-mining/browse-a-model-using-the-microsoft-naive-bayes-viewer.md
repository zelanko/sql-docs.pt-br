---
title: "Procurar um modelo usando o Visualizador do Microsoft Naive Bayes | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "discriminação [Analysis Services]"
  - "naive bayes model [Analysis Services]"
  - "classificadores Bayesianos"
  - "conteúdo do modelo de mineração, exibindo"
  - "modelagem com previsão [Analysis Services]"
  - "Visualizador de Naive Bayes [Analysis Services]"
  - "mineração de dados [Analysis Services], modelagem com previsão"
  - "Visualizador do Microsoft Naive Bayes"
  - "histograma [Analysis Services]"
  - "modelos de mineração [Analysis Services], modelagem com previsão"
