...
ms.openlocfilehash: 833b32a0224f6dd6445279d9e2ff45e113cfffb9
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Fornece propriedades para exibir eventos em determinado [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] arquivo de log.  
