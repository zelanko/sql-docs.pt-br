...
## <a name="see-also"></a>Consulte também  
 ...
 [Fazer backup de Log de transações quando o banco de dados está danificado &#40;do SQL Server&#41;](../backup-restore/back-up-the-transaction-log-when-the-database-is-damaged-sql-server.md)   
