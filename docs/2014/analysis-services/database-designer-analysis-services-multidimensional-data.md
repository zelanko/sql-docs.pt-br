...
# <a name="database-designer-analysis-services---multidimensional-data"></a>Designer de Banco de Dados (Analysis Services - Dados Multidimensionais)
  Use o designer de banco [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] de dados no para alterar as propriedades de e examinar os [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] avisos gerados por um banco de dados.  
