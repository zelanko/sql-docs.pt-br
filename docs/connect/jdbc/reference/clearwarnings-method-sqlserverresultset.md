...
ms.openlocfilehash: 80372a48cef6adc44ca6640f03e209d1d7d03a42
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Limpa todos os avisos relatados sobre isso [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) objeto.  
  
> [!NOTE]  
>  Este método não está implementado atualmente pelo [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)]. Se chamado, ele retornará nulo.  
