...
# Processar banco de dados, tabela ou parti&#231;&#227;o (Analysis Services)
  As tarefas deste tópico descrevem como processar um modelo de banco de dados de tabela, uma tabela ou partições manualmente usando a caixa de diálogo **Processar \<objeto>** no [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
