...
Sempre que um bloco PL/SQL com operador de comparação como `=` ou `IN` é encontrado com operandos do tipo Collection ou Record, o SSMA gera uma mensagem de erro.
