...
description: Saiba como usar as Propriedades Armazenadas (página Geral) para exibir informações somente leitura sobre um procedimento armazenado.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
