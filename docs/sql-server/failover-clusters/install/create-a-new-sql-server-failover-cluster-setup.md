...
description: Este artigo descreve como usar o programa de instalação para instalar ou atualizar um cluster de failover do SQL Server ou adicionar um nó a um cluster existente.
