---
title: "Documentação técnica do SQL Server 2016 | Microsoft Docs"
ms.date: 03/24/2017
...
Para obter as notas de versão mais recentes, veja [Notas de versão do SQL Server vNext](../sql-server/sql-server-vnext-release-notes.md)

Para obter as últimas informações sobre as novidades, veja [Novidades no SQL Server vNext](../sql-server/what-s-new-in-sql-server-vnext.md)
...
+ [Apresentando o SQL Server 2016](https://www.microsoft.com/en-us/server-cloud/products/sql-server/default.aspx?WT.srch=1&WT.mc_id=SEM_%5B_uniqid%5D&utm_source=Bing&utm_medium=CPC&utm_term=SQL%20Server%202016&utm_campaign=Data_Management)  
