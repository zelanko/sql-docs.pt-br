...
description: Saiba como usar o modo AUTO com a cláusula FOR XML para retornar os resultados da consulta como elementos XML aninhados.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
