...
helpviewer_keywords: 
  ...
  - "representação [Reporting Services]"
  - "representação do usuário [Reporting Services]"
  - "Autenticação do Windows [Reporting Services]"
  - "fontes de dados [Reporting Services], segurança"
  - "connection strings [Reporting Services]"
  - "processamento de relatório autônomo [Reporting Services]"
  - "relatórios [Reporting Services], segurança"
  - "fontes de dados remotas [Reporting Services]"
  - "credenciais [Reporting Services]"
  - "autenticação [Reporting Services]"
  - "fontes de dados externas [Reporting Services]"
  - "credenciais solicitadas [Reporting Services]"
  - "várias conexões"
  - "stored credentials [Reporting Services]"
  - "segurança [Reporting Services], fontes de dados"
  - "segurança integrada do Windows [Reporting Services]"
...
## Quando as credenciais são usadas no Construtor de Relatórios  
...
-   As credenciais da fonte de dados inseridas na página [Caixa de diálogo Propriedades da Fonte de Dados, Credenciais &#40;Construtor de Relatórios&#41;](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20Credentials%20\(Report%20Builder\).md) de uma fonte de dados inserida.  
...
## Logon de nome de usuário e senha  
...
##  <a name="DataSourceConfigurationConnections"></a> Configuração de fonte de dados e conexões de rede  
