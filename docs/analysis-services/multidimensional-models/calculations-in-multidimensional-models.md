...
ms.topic: "article"
helpviewer_keywords: 
  - "cálculos [Analysis Services], criando"
  - "excluindo cálculos"
  - "cálculos [Analysis Services], scripts"
  - "Designer de Cubo"
  - "modificando scripts"
  - "removendo cálculos"
  - "cálculos [Analysis Services], excluindo"
  - "scripts [Analysis Services], cálculos"
  - "cubos [Analysis Services], cálculos"
  - "ordens de resolução [Analysis Services]"
...
---
# C&#225;lculos em modelos multidimensionais
...
## Alterando a ordem de resolução  
