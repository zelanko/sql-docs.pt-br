...
ms.topic: "article"
helpviewer_keywords: 
  - "verificando instalações de servidor de relatório"
  - "verificando instalações do servidor de relatório"
  - "Designer de relatórios [Reporting Services], verificando instalações"
  - "instalando o Reporting Services, verificando instalações"
  - "Gerenciador de Relatórios [Reporting Services], verificando instalações"
  - "servidores de relatório [Reporting Services], verificando instalações"
  - "Configuração [Reporting Services], verificando instalações"
...
---
# Verificar uma instala&#231;&#227;o do Reporting Services
...
### Para verificar o serviço Reporting Services  
...
2.  Verifique se o **Serviço SQL Server Reporting Services** está instalado e no estado **Executando** .  
     ...
     Se você não vir o serviço do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] na lista, verifique se o serviço está instalado. Para obter mais informações, veja [Instalar o Primeiro Servidor de Relatório no Modo do SharePoint](http://msdn.microsoft.com/pt-br/b29d0f45-0068-4c84-bd7e-5b8a9cd1b538).  
  
### Para verificar o aplicativo de serviço  
...
### Para verificar os Recursos da Coleção de Sites  
...
### Para verificar tipos de conteúdo do servidor de relatório  
...
### Para verificar se você pode iniciar o Construtor de Relatórios  
...
2.  Salve o relatório em uma biblioteca de documentos e execute o relatório da biblioteca. Para obter mais informações sobre como criar relatórios com o Construtor de Relatórios, veja [Iniciar o Construtor de Relatórios](http://msdn.microsoft.com/pt-br/8c8c7d2e-b315-418d-bf65-90e7685e4259).  
...
### Para verificar se o servidor de relatório está instalado e em execução  
...
### Para verificar se o [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] está instalado e em execução  
...
2.  Use o [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] para criar uma nova pasta ou carregar um arquivo a fim de testar se as condições são devolvidas para o banco de dados do servidor de relatório. Se essas operações obtiverem êxito, a conexão estará funcional.  
     ...
     Para obter mais informações, veja [Portal da Web &#40;SSRS Modo Nativo&#41;](http://msdn.microsoft.com/pt-br/7349e626-6ed5-4d21-b05f-cf042ad9ad70).  
  
### Para verificar se o Designer de Relatórios está instalado e em execução  
