...
helpviewer_keywords: 
  ...
  - "conexão confiável"
  - "Assistente de Instalação do SQL Server, página Modo de Autenticação"
  - "escolher modo de autenticação"
  - "autenticação [SQL Server], escolhendo um modo"
  - "Autenticação do Windows [SQL Server]"
  - "autenticação de modo misto"
  - "modo de autenticação mista"
  - "Modo de autenticação do SQL"
