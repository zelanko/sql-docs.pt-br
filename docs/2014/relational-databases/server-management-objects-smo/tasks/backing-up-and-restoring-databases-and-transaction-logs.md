...
## <a name="running-database-integrity-checks-in-visual-basic"></a>Executando verificações da integridade do banco de dados no Visual Basic  
 O [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] fornece verificação da integridade dos dados. Este exemplo de código executa uma verificação do tipo de consistência no banco de dados especificado. Nesse exemplo, <xref:Microsoft.SqlServer.Management.Smo.Database.CheckTables%2A> é usado, mas <xref:Microsoft.SqlServer.Management.Smo.Database.CheckAllocations%2A>, <xref:Microsoft.SqlServer.Management.Smo.Database.CheckCatalog%2A> ou <xref:Microsoft.SqlServer.Management.Smo.Database.CheckIdentityValues%2A> pode ser usado da mesma forma.  
...
## <a name="running-database-integrity-checks-in-visual-c"></a>Executando verificações da integridade do banco de dados no Visual C#  
 O [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] fornece verificação da integridade dos dados. Este exemplo de código executa uma verificação do tipo de consistência no banco de dados especificado. Nesse exemplo, <xref:Microsoft.SqlServer.Management.Smo.Database.CheckTables%2A> é usado, mas <xref:Microsoft.SqlServer.Management.Smo.Database.CheckAllocations%2A>, <xref:Microsoft.SqlServer.Management.Smo.Database.CheckCatalog%2A> ou <xref:Microsoft.SqlServer.Management.Smo.Database.CheckIdentityValues%2A> pode ser usado da mesma forma.  
...
## <a name="running-database-integrity-checks-in-powershell"></a>Executando verificações da integridade do banco de dados no PowerShell  
 O [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] fornece verificação da integridade dos dados. Este exemplo de código executa uma verificação do tipo de consistência no banco de dados especificado. Nesse exemplo, <xref:Microsoft.SqlServer.Management.Smo.Database.CheckTables%2A> é usado, mas <xref:Microsoft.SqlServer.Management.Smo.Database.CheckAllocations%2A>, <xref:Microsoft.SqlServer.Management.Smo.Database.CheckCatalog%2A> ou <xref:Microsoft.SqlServer.Management.Smo.Database.CheckIdentityValues%2A> pode ser usado da mesma forma.  
