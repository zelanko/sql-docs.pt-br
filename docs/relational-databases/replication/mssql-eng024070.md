...
## Explicação  
 ...
 "Executado como usuário: \< Conta_de_usuário>. Subsistema de instantâneos de replicação de replicação: agente \< Nome_do_agente> falhou. Executado como usuário: \< Conta_de_usuário>. O cliente não possui o privilégio exigido. A etapa falhou. [SQLSTATE 42000] (Erro 14151). A etapa falhou."  
