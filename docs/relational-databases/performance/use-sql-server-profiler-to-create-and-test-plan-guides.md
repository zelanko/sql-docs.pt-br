...
description: Use o SQL Server Profiler para capturar o texto de consulta exato para uso no argumento statement_text do procedimento armazenado sp_create_plan_guide no SQL Server.
