---
title: Grupos de disponibilidade AlwaysOn catálogo exibições (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "33177682"
---
# <a name="always-on-availability-groups-catalog-views-transact-sql"></a>Exibições do catálogo (Transact-SQL) de grupos de disponibilidade AlwaysOn
...
> [!NOTE]  
>  Para obter informações sobre bancos de dados de disponibilidade unidas, consulte o **replica_id** e **group_database_id** colunas em [sys. Databases (Transact-SQL);](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Sempre em exibições de gerenciamento dinâmico de grupos de disponibilidade e funções (Transact-SQL)](../system-dynamic-management-views/always-on-availability-groups-dynamic-management-views-functions.md)  
