---
title: 'TM: Classe de evento de Completed Save Tran | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "63061258"
---
# <a name="tm-save-tran-completed-event-class"></a>TM: Classe de evento Save Tran Completed
  TM: Save Tran Completed a classe de evento indica que uma solicitação SAVE TRANSACTION foi concluída. A solicitação foi enviada do cliente pela interface de gerenciamento de transações.  
  
## <a name="tm-save-tran-completed-event-class-data-columns"></a>TM: Salvar Tran concluída colunas de dados de classe de evento  
