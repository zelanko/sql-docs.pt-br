...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Restaura um arquivo de backup (. abf) do banco de dados Multidimensional ou Tabular para uma instância do Analysis Services.  
