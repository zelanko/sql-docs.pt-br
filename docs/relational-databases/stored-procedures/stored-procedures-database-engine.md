...
description: Saiba como um procedimento armazenado no SQL Server é um grupo de uma ou mais instruções do Transact-SQL ou uma referência a um método Common Language Runtime do .NET Framework.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
