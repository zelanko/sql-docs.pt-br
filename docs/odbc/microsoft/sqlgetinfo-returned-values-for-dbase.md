---
title: SQLGetInfo Valores retornados para dBASE | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (O qualificador é devolvido em caso misto para que o Windows NT possa localizar o diretório.)|  
