...
-   **E**  
     ***n*** , **C*n * * *, **S*n * **, ou **1!d * n***  — o estado do ambiente, conexão, instrução ou descritor se move para o estado especificado.  
