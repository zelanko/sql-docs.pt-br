...
ms.locfileid: "62867330"
---
# <a name="audit-add-role-event-class"></a>Classe de evento Audit Add Role
  A classe de evento **Audit Add role** ocorre quando uma função de banco de dados é adicionada ou removida de um banco de dados. Esta classe de evento é usada pelos procedimentos armazenados **sp_addrole** e **sp_droprole**.  
  
 Essa classe de evento pode ser removida de uma versão [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]futura do. É recomendável que, em vez disso, você use a classe de evento **Audit Database Principal Management** .  
...
|**EventClass**|**int**|Tipo de evento = 111.|27|Não|  
...
|**RoleName**|**nvarchar**|Nome da função de banco de dados que está sendo adicionada ou removida.|38|Sim|  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [&#41;&#40;Transact-SQL de sp_addrole](/sql/relational-databases/system-stored-procedures/sp-addrole-transact-sql)   
 [&#41;&#40;Transact-SQL de sp_droprole](/sql/relational-databases/system-stored-procedures/sp-droprole-transact-sql)   
