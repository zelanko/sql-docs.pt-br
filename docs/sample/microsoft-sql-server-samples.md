...
Esta galeria contém bancos de dados de exemplo e outros exemplos de produtos do Microsoft SQL incluindo SQL Server e banco de dados do SQL Azure.   
...
O [documentação WWI](https://msdn.microsoft.com/library/mt734199(v=sql.1).aspx) está no MSDN.   
