---
title: Catálogo de objeto (ADO MD) | Microsoft Docs
ms.prod: sql
...
-   Identificar o **catálogo** com o [nome](../../../ado/reference/ado-md-api/name-property-ado-md.md) propriedade.  
  
-   Percorrer os cubos em um catálogo usando o [CubeDefs](../../../ado/reference/ado-md-api/cubedefs-collection-ado-md.md) coleção.  
