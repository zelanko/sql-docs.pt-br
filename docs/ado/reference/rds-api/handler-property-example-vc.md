---
title: Exemplo da propriedade manipulador (VC + +) | Microsoft Docs
ms.prod: sql
...
```  
 ...
 Seu código é semelhante ao seguinte. O comando atribuído ao [SQL](../../../ado/reference/rds-api/sql-property.md) propriedade corresponderá a ***AuthorById*** identificador e recuperar uma linha para o autor Michael O'Leary. Embora o [conectar](../../../ado/reference/rds-api/connect-property-rds.md) propriedade em seu código especifica a fonte de dados Northwind, essa fonte de dados será substituída pelo Msdfmap.ini *conectar* seção. O **DataControl** objeto [registros](../../../ado/reference/rds-api/recordset-sourcerecordset-properties-rds.md) propriedade é atribuída para um desconectado [Recordset](../../../ado/reference/ado-api/recordset-object-ado.md) objeto somente como uma conveniência de codificação.  
