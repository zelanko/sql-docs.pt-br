---
title: "Acesso ao servi&#231;o Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "visualizando pacotes durante a execução"
  - "exibindo pacotes durante a execução"
  - "segurança [Integration Services], executando pacotes"
  - "pacotes [Integration Services], segurança"
  - "pacotes em execução atualmente"
