---
title: 'TM: Classe de evento Save Tran Completed | Microsoft Docs'
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "62706761"
---
# <a name="tm-save-tran-completed-event-class"></a>TM: Classe de evento Save Tran Completed
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  A classe de evento TM: Save Tran Completed indica que uma solicitação SAVE TRANSACTION foi concluída. A solicitação foi enviada do cliente pela interface de gerenciamento de transações.  
  
## <a name="tm-save-tran-completed-event-class-data-columns"></a>TM: Colunas de dados da classe de evento TM: Save Tran Completed  
