...
description: No SQL Server Enterprise Edition, em alguns casos, você pode restaurar dados por arquivo, página ou restauração por etapas enquanto um banco de dados permanece online.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
