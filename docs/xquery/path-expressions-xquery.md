...
-   A primeira etapa recupera os \<ProductDescription> filhos do nó do elemento da raiz do documento.  
  
-   A segunda etapa recupera os \<Summary> filhos do nó de elemento para cada \<ProductDescription> nó de elemento recuperado que, por sua vez, se torna o nó de contexto.  
