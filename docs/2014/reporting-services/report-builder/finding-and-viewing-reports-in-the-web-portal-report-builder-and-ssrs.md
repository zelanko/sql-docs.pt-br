...
## <a name="navigating-the-folder-hierarchy-in-report-manager"></a>Navegando na hierarquia de pasta no Gerenciador de Relatórios  
 ...
 ![Faixa de opções e navegação no Gerenciador de Relatórios](../media/rs-reportmanager-ribbon.gif "Faixa de opções e navegação no Gerenciador de Relatórios")  
