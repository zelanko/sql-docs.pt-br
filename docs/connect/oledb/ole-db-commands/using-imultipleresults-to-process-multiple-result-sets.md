...
description: Saiba como os consumidores usam a interface IMultipleResults para processar os resultados retornados pela execução de comandos do Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
