---
title: "Criar um backup completo de banco de dados (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/25/2016"
...
helpviewer_keywords: 
  ...
  - "fazendo backup de bancos de dados [SQL Server], SQL Server Management Studio"
  - "backups [SQL Server], criando"
  - "backups de bancos de dados [SQL Server], SQL Server Management Studio"
...
-   Para ter uma visão geral e aprofundar-se nos conceitos e tarefas de backup, consulte [Visão geral de backup &#40;SQL Server&#41;](../../relational-databases/backup-restore/backup-overview-sql-server.md) antes de prosseguir.  
...
1.  Execute a instrução BACKUP DATABASE para criar o backup do banco de dados completo, especificando:  
    ...
    |Opção|Descrição|  
    |------------|-----------------|  
    |*Banco de Dados*|É o banco de dados do qual fazer backup.|  
