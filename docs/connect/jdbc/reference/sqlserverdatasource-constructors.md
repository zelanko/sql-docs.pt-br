...
ms.locfileid: "67971446"
---
# <a name="sqlserverdatasource-constructors"></a>Construtores SQLServerDataSource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Para obter mais informações sobre os construtores SQLServerDataSource, consulte [membros do SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-members.md).  
