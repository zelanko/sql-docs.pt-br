---
title: "Designer de Modelos Tabulares (SSAS) | Microsoft Docs"
ms.date: "03/14/2017"
 ...
 **Importar do servidor (tabular)**  
 ...
 Os modelos mais antigos têm níveis de compatibilidade mais antigos. Você pode atualizar para 1200 alterando a propriedade do Nível de Compatibilidade depois de importar a definição de modelo.  
...
### Janela de exibição de código  
 Você pode exibir o código por trás de um arquivo Model.bim clicando com o botão direito do mouse para selecionar **Exibir Código** no arquivo do Gerenciador de Soluções. Para modelos tabulares no nível de compatibilidade 1200, a definição de modelo é expressa em JSON.  
...
### Gerenciador de Modelos de Tabela
  Primeiramente disponível na versão de agosto de 2016 (14.0.60812.0) do [SQL Server Data Tools](https://msdn.microsoft.com/mt186501), o Gerenciador de Modelos de Tabela o ajuda a procurar objetos de metadados em modelos de tabela 1200.
