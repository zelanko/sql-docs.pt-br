---
title: "Procurar um modelo usando a Exibi&#231;&#227;o de &#193;rvore da Microsoft | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Visualizador de árvores [Analysis Services]"
  ...
  - "Legenda de mineração [Analysis Services]"
  - "atributos discretos [Analysis Services]"
  - "Algoritmo das Árvores de Decisão da Microsoft [Analysis Services]"
  - "algoritmos de árvore de decisão [Analysis Services]"
  - "Visualizador de árvores da Microsoft"
...
#### Opções adicionais de exibição da Árvore de Decisão  
...
## Consulte também  
 ...
 [Visualizadores do Modelo de Mineração &#40;Designer do Modelo de Mineração de Dados&#41;](../Topic/Mining%20Model%20Viewers%20\(Data%20Mining%20Model%20Designer\).md)   
