...
ms.topic: "article"
helpviewer_keywords: 
  - "processo de preparo (Master Data Services), sobre o processo de preparo"
  - "importando dados [Master Data Services]"
  - "processo de preparo [Master Data Services]"
...
## Desativando e excluindo membros (MDS)  
...
## Movendo membros de hierarquia explícita (MDS)  
...
## Tabelas de preparo e procedimentos armazenados (MDS)  
...
## Registrando transações em log (MDS)  
