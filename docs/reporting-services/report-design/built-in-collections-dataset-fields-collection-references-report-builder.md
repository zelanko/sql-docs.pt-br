---
title: Referências de coleções de campos do conjunto de dados (Construtor de Relatórios) | Microsoft Docs
description: Crie um conjunto de dados para exibição de valores individuais ou resumidos no painel Dados do Relatório do Construtor de Relatórios.
ms.date: 03/01/2017
