---
title: Caixa de diálogo de informações do distribuidor de replicação do SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="distributor-information-dialog-box"></a>Caixa de diálogo de informações do distribuidor 
Este tópico fornece informações sobre o **distribuidor** caixa de diálogo 
