...
ms.locfileid: "38057410"
---
# <a name="performance-best-practices-and-configuration-guidelines-for-sql-server-2017-on-linux"></a>Práticas recomendadas de desempenho e diretrizes de configuração do SQL Server 2017 no Linux
