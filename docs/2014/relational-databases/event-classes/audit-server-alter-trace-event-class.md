...
ms.locfileid: "63012518"
---
# <a name="audit-server-alter-trace-event-class"></a>Classe de evento Audit Server Alter Trace
  A classe de evento **Audit Server ALTER TRACE** ocorre para todas as instruções que verificam a permissão ALTER TRACE. As instruções que verificam ALTER TRACE incluem aquelas usadas para criar ou configurar um rastreamento ou para definir um filtro em um rastreamento.  
