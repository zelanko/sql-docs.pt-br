 ...
 *query_string*  
 A consulta que você deseja analisar. *QUERY_STRING* pode ser uma cadeia de caracteres [CONTAINS](../../t-sql/queries/contains-transact-sql.md) suporte à sintaxe. Por exemplo, é possível incluir formas flexionadas, uma dicionário de sinônimo e operadores lógicos.  
