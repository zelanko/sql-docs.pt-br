...
O SQL Server vNext CTP 2.0 Reporting Services não está disponível para versão prévia. Instale a versão atual, [SQL Server 2017 Reporting Services](install-windows/install-reporting-services.md). 
::: moniker-end
...
Você pode criar KPIs contextuais para a pasta em que você está diretamente no [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] . Ao criar KPIs, você pode escolher campos de conjunto de dados e resumir esses valores. Você também pode selecionar o conteúdo relacionado a drill-through para obter mais detalhes.
 ...
 Para obter mais informações, consulte [Trabalhando com KPIs no portal da Web](http://msdn.microsoft.com/a28cf500-6d47-4268-a248-04837e7a09eb)
...
[Recursos do Reporting Services com suporte nas edições do SQL Server 2016](http://msdn.microsoft.com/39f03d2d-6e48-4b34-a9d3-07f86313b937)   
