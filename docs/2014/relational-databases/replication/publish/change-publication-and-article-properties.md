...
|Habilitar ou desabilitar [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssVersion2000](../../../includes/ssversion2000-md.md)] a otimização de partição.|**sp_changemergepublication**|**keep_partition_changes**|Reinicialize as assinaturas.|  
