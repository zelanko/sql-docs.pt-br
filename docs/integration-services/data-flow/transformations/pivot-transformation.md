...
helpviewer_keywords: 
  ...
  - "Propriedade PivotUsage"
  - "conjuntos de dados [Integration Services], dados normalizados"
  - "conjunto de dados menos normalizados [Integration Services]"
...
## Configuração da Transformação Dinâmica  
