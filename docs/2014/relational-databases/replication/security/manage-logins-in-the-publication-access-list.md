...
1.  Na página **lista de acesso à publicação** da caixa de diálogo **Propriedades da publicação – \<Publication> ** , use os botões **Adicionar**, **remover**e **remover todos** para adicionar e remover logons e grupos da PAL. Não remova o **distributor_admin** da PAL. Essa conta é usada para replicação.  
