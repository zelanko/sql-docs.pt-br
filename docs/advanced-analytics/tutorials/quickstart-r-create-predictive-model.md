...
ms.locfileid: "54046722"
---
# <a name="quickstart-create-a-predictive-model-using-r-in-sql-server"></a>Guia de início rápido: Criar um modelo de previsão usando R no SQL Server
...
> [Guia de início rápido: Prever e plotar com base no modelo](quickstart-r-predict-from-model.md)