...
description: Este artigo fornece uma breve explicação dos vários downloads e pacotes autônomos que a Microsoft fornece para agregar valor para SQL Server.
ms.prod: sql
...
Este artigo fornece uma breve explicação dos vários downloads e pacotes autônomos que a Microsoft fornece para agregar valor para SQL Server.
...
| [Estrutura de Aplicativo da Camada de Dados do SQL Server](https://www.microsoft.com/en-us/download/details.aspx?id=56508) | A estrutura de DAC (Aplicativo da Camada de Dados) do SQL Server é um componente que se baseia no .NET Framework, que fornece serviços de ciclo de vida de aplicativo para o desenvolvimento e o gerenciamento de banco de dados. |
...
| [Integration Services Feature Pack para SQL Server mais recentes](https://www.microsoft.com/download/details.aspx?id=100303) | Esses pacotes autônomos fornecem valor adicional para os Integration Services de Microsoft SQL Server mais recentes. |
