...
-   **Para atualizar um banco de dados SQL Server:**  
  
     [Usando operações de desanexação e anexação](#SSMSProcedure)  
  
-   **Acompanhamento:**  [depois de atualizar um banco de dados SQL Server](#FollowUp)  
...
1.  Desanexe o banco de dados. Para obter mais informações, consulte [desanexar um banco de dados](detach-a-database.md).  
...
3.  Anexe os arquivos copiados à instância do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Para saber mais, veja [Anexar um banco de dados](attach-a-database.md).  
