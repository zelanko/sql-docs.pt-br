---
title: Coleção de propriedades, métodos e eventos de grupos | Microsoft Docs
ms.prod: sql
...
## <a name="methods"></a>Métodos  
 [(Grupos) do método append](../../../ado/reference/adox-api/append-method-adox-groups.md)  
