...
description: Referência de API para a função PDOStatement::debugDumpParams no Driver do Microsoft PDO_SQLSRV para PHP para SQL Server.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
