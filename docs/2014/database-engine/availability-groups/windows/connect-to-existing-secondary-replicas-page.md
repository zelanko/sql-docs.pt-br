---
title: Conecte-se à página réplicas secundárias existentes (Assistente para adicionar réplica e adicionar Assistente de bancos de dados) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36010285"
---
# <a name="connect-to-existing-secondary-replicas-page-add-replica-wizard-and-add-databases-wizard"></a>Conecte-se à página réplicas secundárias existentes (Assistente para adicionar réplica e adicionar Assistente de bancos de dados)
