...
ms.topic: "article"
helpviewer_keywords: 
  - "Classe de evento Audit Schema Object Access"
...
---
# Classe de evento Audit Schema Object Access
  A classe de evento **Audit Schema Object Access** ocorre quando uma permissão de objeto (como SELECT) é usada.  
  
## Colunas de dados da classe de evento Audit Schema Object Access   
