...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
 ...
 Atualiza o valor da coluna especificada para o [DateTimeOffset classe](../../../connect/jdbc/reference/datetimeoffset-class.md) valor, considerando um nome de coluna.  
