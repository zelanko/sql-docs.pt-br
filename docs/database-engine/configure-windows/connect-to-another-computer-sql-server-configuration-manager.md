---
title: "Conectar-se a um outro computador (SQL Server Configuration Manager) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "conexões [SQL Server], outros computadores"
...
manager: "jhubbard"
---
# Conectar-se a um outro computador (SQL Server Configuration Manager)
...
#### Para se conectar a outro computador com o Windows Computer Management  
...
#### Para salvar um link no SQL Server Configuration Manager para outro computador  
