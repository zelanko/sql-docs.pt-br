...
1.  Navegue até [ http://localhost/mds ](http://localhost/mds) iniciar **Master Data Manager**. Substitua a URL se você tiver configurado o aplicativo Web com um nome diferente ou em outro site.  
...
3.  Se você não vir o **Adicionar modelo** page, passe o mouse sobre **gerenciar** na barra de menus, clique em **modelos**e, em seguida, clique em **Adicionar modelo (+)** barra de ferramentas botão para criar um modelo.  
  
     ![Gerenciar - Menu modelos](../../2014/tutorials/media/et-creatingsuppliersmodelusingmdm-02.jpg "gerenciar - Menu modelos")  
  
     ![Adicionar um botão de barra de ferramentas do modelo](../../2014/tutorials/media/et-creatingsuppliersmodelusingmdm-03.jpg "adicionar um botão de barra de ferramentas do modelo")  
  
4.  Digite **fornecedores** para **nome do modelo**.  
  
5.  Limpar **criar entidade com o mesmo nome do modelo** opção. Você criará uma entidade posteriormente usando o **suplemento do MDS para Excel**.  
