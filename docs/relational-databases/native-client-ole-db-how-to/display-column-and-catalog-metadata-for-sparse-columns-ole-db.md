---
description: SQL Server Native Client Exibir metadados de coluna e catálogo para colunas esparsas (OLE DB)
title: Metadados para colunas esparsas (OLE DB)
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.openlocfilehash: a146da3c942abc48fee059bde09e260ac9945aa6
ms.sourcegitcommit: 1a544cf4dd2720b124c3697d1e62ae7741db757c
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 12/14/2020
ms.locfileid: "97469467"
---
# <a name="sql-server-native-client-display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a>SQL Server Native Client Exibir metadados de coluna e catálogo para colunas esparsas (OLE DB)
