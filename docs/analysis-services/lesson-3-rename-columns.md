...
## Pré-requisitos  
Este tópico faz parte de um tutorial de modelo de tabela, que deve ser concluído na ordem. Antes de executar as tarefas desta lição, você deverá ter concluído a lição anterior: [Lição 2: Adicionar dados](../analysis-services/lesson-2-add-data.md).  
...
2.  Clique duas vezes no nome de coluna **CustomerKey**, digite **ID do Cliente** e pressione ENTER.  
...
## Próxima etapa  
Para continuar este tutorial, vá para a próxima lição: [Lição 4: Marcar como Tabela de Data](../analysis-services/lesson-4-mark-as-date-table.md).  
