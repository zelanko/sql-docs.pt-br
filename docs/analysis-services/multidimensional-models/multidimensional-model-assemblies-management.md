...
ms.topic: "article"
helpviewer_keywords: 
  - "permissões [Analysis Services], assemblies"
  - "chamando funções definidas pelo usuário"
  - "representação do usuário [Analysis Services]"
  - "representação [Analysis Services]"
  - "Extensões DMX [Analysis Services], assemblies"
  - "MDX [Analysis Services], assemblies"
  - "funções definidas pelo usuário [Analysis Services]"
  - "objetos do Analysis Services, assemblies"
  - "assemblies [Analysis Services]"
  - "domínios de aplicativo [Analysis Services]"
