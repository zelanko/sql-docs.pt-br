---
title: Recursos de suporte para os Drivers da Microsoft para PHP para SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
[Driver do PHP da Microsoft para código-fonte do SQL Server no Github](https://github.com/Microsoft/msphpsql)  
  
## <a name="sql-servertransact-sql-support-resources"></a>Recursos de suporte do SQL Server/Transact-SQL  
Documentação do SQL Server e Transact-SQL pode ser encontrada em [documentação do SQL Server](../../sql-server/sql-server-technical-documentation.md).  
...
Para obter as notícias mais recentes do IIS, visite [página inicial do IIS](https://www.iis.net/).  
  
Para obter suporte ponto a ponto, visite o [fóruns do IIS](https://forums.iis.net/).  
...
Para perguntas de suporte relacionadas para o [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)], você pode contatar [Microsoft Support](https://support.microsoft.com/contactus/), ou solicite no [página do Github do projeto](https://github.com/Microsoft/msphpsql/issues).  
