...
description: Durante a criação de um relatório paginado do Reporting Services, você pode visualizar o relatório para verificar se ele mostra o que você deseja.
ms.date: 01/09/2017
