...
Antes de usar o driver, instale o Gerenciador de driver unixODBC. Para obter mais informações, consulte [instalando o Gerenciador de Driver](../../../connect/odbc/linux-mac/installing-the-driver-manager.md).
