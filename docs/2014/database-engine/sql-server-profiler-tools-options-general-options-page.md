 ...
 **Iniciar o rastreamento imediatamente após estabelecer a conexão**  
 Começa a rastrear usando o modelo padrão assim que uma conexão é estabelecida.  
  
 **Atualizar definição de rastreamento quando a versão do provedor for alterada**  
 ...
 **Número padrão de threads de reprodução**  
