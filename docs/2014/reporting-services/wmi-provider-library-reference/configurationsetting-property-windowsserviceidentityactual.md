...
ms.locfileid: "66097413"
---
# <a name="windowsserviceidentityactual-property-wmi-msreportserver_configurationsetting"></a>Propriedade WindowsServiceIdentityActual (WMI MSReportServer_ConfigurationSetting)
