...
|AlwaysUseDefaultCodePage|Booliano|Um valor que indica se deve usar o valor de `DefaultCodePage` propriedade para cada coluna, ou para tentar derivar a página de código da localidade de cada coluna. O valor padrão dessa propriedade é `False`.|  
