...
##  <a name="HowWorks"></a> Como a replicação transacional funciona  
 ...
 ![Componentes e fluxo de dados da replicação transacional](../media/trnsact.gif "Componentes e fluxo de dados da replicação transacional")  
