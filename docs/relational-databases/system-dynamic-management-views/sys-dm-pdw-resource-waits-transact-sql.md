...
|object_type|**nvarchar (255)**|Tipo de objeto que é afetado pela espera.|Valores possíveis:<br /><br /> **OBJETO**<br /><br /> **BANCO**<br /><br /> **SISTEMA**<br /><br /> **ESQUEMA**<br /><br /> **APLICATIVO**|  
...
|request_time|**horário**|Hora em que o bloqueio ou o recurso foi solicitado.||  
|acquire_time|**horário**|Hora em que o bloqueio ou o recurso foi adquirido.||  
|state|**nvarchar (50)**|Estado do estado de espera.|[!INCLUDE[ssInfoNA](../../includes/ssinfona-md.md)]|  
|prioridade|**inteiro**|Prioridade do item em espera.|[!INCLUDE[ssInfoNA](../../includes/ssinfona-md.md)]|  
|concurrency_slots_used|**inteiro**|Interna|Consulte o [monitorar as esperas de recursos](#monitor-resource-waits) abaixo|  
