...
description: Saiba mais sobre os guias de plano, que permitem otimizar o desempenho de consultas sem alterar diretamente o texto da consulta no SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
```  
Como outro exemplo, considere a seguinte instrução SQL enviada usando [sp_executesql](../../relational-databases/system-stored-procedures/sp-executesql-transact-sql.md).
