...
4.  Na caixa de diálogo **Propriedades de \<***instancename***> do SQL Server**, na guia **Serviço** da caixa **Propriedades**, defina o valor de **Modo Inicial** como **Manual**.  
