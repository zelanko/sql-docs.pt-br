---
title: "Definir propriedades de processamento de relat&#243;rios | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "processamento do relatório [Reporting Services], propriedades de execução"
  - "instantâneos [Reporting Services], executando relatórios de"
  - "relatórios em cache [Reporting Services]"
  - "instantâneos de relatório [Reporting Services], executando relatórios de"
  - "instantâneos de execução de relatório [Reporting Services]"
