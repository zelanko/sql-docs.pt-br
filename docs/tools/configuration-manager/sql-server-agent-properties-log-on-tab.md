...
description: Saiba mais sobre a guia Fazer Logon da caixa de diálogo Propriedades do SQL Server Agent. Confira como usar essa guia para especificar uma conta e iniciar ou parar o serviço.
