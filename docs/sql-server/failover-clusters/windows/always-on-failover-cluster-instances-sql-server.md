...
helpviewer_keywords: 
  ...
  - "alta disponibilidade [SQL Server], clustering de failover"
  - "servidores virtuais [SQL Server] sobre servidores virtuais"
  - "clusters [SQL Server]"
  - "servidores [SQL Server], clustering de failover"
  - "grupos de recursos [SQL Server]"
  - "disponibilidade [SQL Server]"
  - "clustering de failover [SQL Server]"
  - "AlwaysOn [SQL Server] consulte clustering de failover [SQL Server]"
...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
 ...
 Uma FCI pode aproveitar os [Grupos de Disponibilidade AlwaysOn](../../../database-engine/availability-groups/windows/always-on-availability-groups-sql-server.md) para fornecer recuperação remota de desastres no nível do banco de dados. Para obter mais informações, veja [Clustering de failover e Grupos de Disponibilidade AlwaysOn &#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/failover-clustering-and-always-on-availability-groups-sql-server.md).  
...
|------------------------|-----------|  
|Descreve o mecanismo de detecção de falha e a política de failover flexível.|[Política de failover para instâncias de cluster de failover](../../../sql-server/failover-clusters/windows/failover-policy-for-failover-cluster-instances.md)|  
