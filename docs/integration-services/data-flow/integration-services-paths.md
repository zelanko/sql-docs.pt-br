...
helpviewer_keywords: 
  - "caminhos [Integration Services], sobre os caminhos"
  - "fluxo de dados [Integration Services], caminhos"
  - "caminhos [Integration Services]"
  - "destinos [Integration Services], caminhos"
  - "fontes [Integration Services], caminhos"
...
-   [Editor de Caminho do Fluxo de Dados &#40;Página Geral&#41;](../Topic/Data%20Flow%20Path%20Editor%20\(General%20Page\).md)  
  
-   [Editor de Caminho do Fluxo de Dados &#40;página Metadados&#41;](../Topic/Data%20Flow%20Path%20Editor%20\(Metadata%20Page\).md)  
  
-   [Editor de Caminho do Fluxo de Dados &#40;Página Visualizadores de Dados&#41;](../Topic/Data%20Flow%20Path%20Editor%20\(Data%20Viewers%20Page\).md)  
  
 Para obter mais informações sobre as propriedades que podem ser definidas programaticamente, consulte [Path Properties](../Topic/Path%20Properties.md).  
  
## Tarefas relacionadas  
  
-   [Exibir metadados do caminho no Editor de Caminho do Fluxo de Dados](../Topic/View%20Path%20Metadata%20in%20the%20Data%20Flow%20Path%20Editor.md)  
