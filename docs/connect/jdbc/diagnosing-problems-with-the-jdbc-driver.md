---
title: Diagnosticando problemas com o JDBC Driver
description: Saiba como diagnosticar e solucionar problemas, como o tratamento de erro e a verificação da versão e do rastreamento do driver.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
