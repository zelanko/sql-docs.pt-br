...
ms.locfileid: "54046723"
---
# <a name="quickstart-using-r-functions"></a>Guia de início rápido: Usando funções de R
...
> [Guia de início rápido: Criar um modelo de previsão](quickstart-r-create-predictive-model.md)
