 ...
 **Conectar relatórios relacionados**  
 ...
 **Variar apresentação de relatório**  
...
##  <a name="UserInterface"></a>Painel de parâmetros  
...
1.  **Painel de parâmetros** A barra de ferramentas do Visualizador de relatórios exibe um prompt e um valor padrão para cada parâmetro. O layout do parâmetro na barra de ferramentas é formatado automaticamente. A ordem é determinada pela ordem dos parâmetros exibidos no painel de Dados do Relatório.  
...
5.  **Mostrar ou ocultar identificador de área de parâmetro** Na barra de ferramentas do Visualizador de relatórios, clique nessa seta para mostrar ou ocultar o painel de parâmetros.  
  
6.  **Botão parâmetros** Na visualização Construtor de Relatórios, na faixa de faixas, clique no botão **parâmetros** para mostrar ou ocultar o painel de parâmetros.  
...
##  <a name="bkmk_Create_Parameters"></a>Criando parâmetros  
...
-   Crie um parâmetro manualmente a partir do painel de Dados do Relatório.  
  ...
  > **OBSERVAÇÃO:** Como os parâmetros são gerenciados independentemente no servidor, a republicação de um relatório principal com novas configurações de parâmetros não substituirá as configurações de parâmetros existentes no relatório.  
...
-   **Propriedades do parâmetro de relatório.** Altere os valores de parâmetros de relatório diretamente no servidor de relatório, de modo independente da definição de relatório.  
...
-   **Conjuntos de valores compartilhados em cache.** Para criar um plano de cache para um conjunto de dados compartilhado, cada parâmetro deve ter um valor padrão. Para obter mais informações, consulte [Armazenando relatórios em cache &#40;SSRS&#41;](../report-server/caching-reports-ssrs.md).  
...
##  <a name="bkmk_Parameters_Subscription"></a>Parâmetros de uma assinatura  
...
##  <a name="bkmk_Related_Topics"></a> Conteúdo relacionado  
 [Configurando parâmetros de relatório do SSRS (teste)](https://www.trenovision.com/quiz/sql-server-reporting-services-ssrs-quiz/)  
