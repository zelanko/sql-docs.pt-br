...
Você pode usar diversas variáveis de ambiente diferentes para configurar o SQL Server de 2019 CTP 2.0 no Linux. Essas variáveis são usadas em dois cenários:
