...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Server Alter Trace** ocorre em todas as instruções que verificam a permissão ALTER TRACE. As instruções que verificam ALTER TRACE incluem aquelas usadas para criar ou configurar um rastreamento ou para definir um filtro em um rastreamento.  
