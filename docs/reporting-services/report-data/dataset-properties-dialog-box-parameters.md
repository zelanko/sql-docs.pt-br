...
description: Saiba como usar a propriedade Parâmetros na caixa de diálogo Propriedades do Conjunto de Dados para adicionar, alterar e excluir parâmetros de consulta.
ms.date: 03/01/2017
