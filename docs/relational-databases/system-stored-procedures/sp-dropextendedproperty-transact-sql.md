...
## <a name="remarks"></a>Comentários  
 ...
 Dado um *property_name*válido, se todos os tipos de objeto e nomes forem nulos e uma propriedade existir no banco de dados atual, essa propriedade será excluída. Veja o exemplo B a seguir, após este tópico.  
