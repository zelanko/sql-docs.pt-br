...
---
# Criar uma consulta de conte&#250;do em um modelo de minera&#231;&#227;o
...
6.  Na linha `SELECT`*\<lista de seleção, lista de expr, \*>*, digite os nomes das colunas no conjunto de linhas de esquema de conteúdo do modelo de mineração.  
