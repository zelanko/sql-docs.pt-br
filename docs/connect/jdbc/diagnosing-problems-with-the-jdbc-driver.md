---
title: Diagnosticar problemas com o Driver JDBC | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32828843"
---
# <a name="diagnosing-problems-with-the-jdbc-driver"></a>Diagnosticando problemas com o JDBC Driver
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  Não importa se um aplicativo é bem planejado e desenvolvido, problemas ocorrerão inevitavelmente. Quando isso ocorrer, é importante ter algumas técnicas para diagnosticar os problemas. Ao usar o [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)], alguns problemas comuns que podem ocorrer são não ter a versão correta do driver ou não ser capaz de se conectar a um banco de dados.  
...
|Tópico|Description|  
|-----------|-----------------|  
|[Tratando erros](../../connect/jdbc/handling-errors.md)|Descreve como manipular erros que são retornados de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].|  
