...
|Agendamento|<xref:ReportService2010.ReportingService2010.ListSchedules%2A>|<xref:ReportService2010.ReportingService2010.CreateSchedule%2A>|  
...
##  <a name="troubleshooting"></a><a name="bkmk_troubleshoot"></a>Solução  
