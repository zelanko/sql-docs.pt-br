...
ms.openlocfilehash: 038491088438b768c0667fbde0416c151a3ca5a9
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento TM: Rollback Tran Startingindica que uma solicitação de ROLLBACK TRANSACTION está iniciando. O cliente envia a solicitação pela interface de administração de transações. A coluna EventSubClass indica se uma transação nova será iniciada depois que a transação atual for revertida.  
