...
Este tópico faz parte de um tutorial de modelo de tabela, que deve ser concluído na ordem. Antes de executar as tarefas nesta lição, você deve ter concluído a lição anterior: [Lição 10: Criar partições](lesson-10-create-partitions.md).  
...
Vá para a próxima lição: [Lição 12: Analisar no Excel](lesson-12-analyze-in-excel.md).
