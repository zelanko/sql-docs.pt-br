...
description: Saiba como usar as opções da caixa de diálogo Cancelar Trabalhos do Servidor de Relatório para exibir ou cancelar relatórios em andamento.
ms.date: 03/01/2017
