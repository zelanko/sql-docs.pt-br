...
1.  Um *auxiliada por computador* processo que analisa os dados de origem em relação ao conhecimento da base de conhecimento e propõe alterações de limpeza de dados. Os dados processados são categorizados (sugerido, novo, inválido, corrigido) pelo DQS e exibidos para o usuário para processamento adicional.  
  
2.  Um *interativo* Limpeza de processo que permite que o administrador de dados aprovar, rejeitar ou modificar os dados propostos pelo processo de limpeza de dados auxiliada por computador.  
...
|Descreve como abrir, desbloquear, renomear e excluir um projeto de qualidade de dados.|[Abrir, desbloquear, renomear e excluir um projeto de qualidade de dados](https://msdn.microsoft.com/library/hh510417.aspx)|  
