...
description: No SQL Server, uma restauração somente recuperação recupera um banco de dados sem restaurar um backup, normalmente como a última etapa ao restaurar uma sequência de backups.
