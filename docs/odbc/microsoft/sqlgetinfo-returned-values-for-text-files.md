---
title: SQLGetInfo Valores retornados para arquivos de texto | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_DBMS_NAME|"TEXTO"|  
|SQL_DBMS_VER|ISAM: Texto<br /><br /> Versão: 1.0<br /><br /> Formato do número da versão: 01.00.0000|  
|SQL_DDL_INDEX|0|  
