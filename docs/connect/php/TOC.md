...
# [Microsoft PHP Driver para SQL Server](microsoft-php-driver-for-sql-server.md)
...
## [Carregando o driver](loading-the-php-sql-driver.md)
...
### [Driver do PHP para o suporte do SQL Server para LocalDB](php-driver-for-sql-server-support-for-localdb.md)
### [Driver do PHP para o suporte do SQL Server para alta disponibilidade e recuperação de desastre](php-driver-for-sql-server-support-for-high-availability-disaster-recovery.md)
