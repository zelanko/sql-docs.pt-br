...
## <a name="arguments"></a>Argumentos  
 [  **@oldest_date=** ] **'**_mais antigo\_data_**'**  
 É a data mais antiga mantida nas tabelas de histórico de backup e restauração. *oldest_date* está **datetime**, sem padrão.  
