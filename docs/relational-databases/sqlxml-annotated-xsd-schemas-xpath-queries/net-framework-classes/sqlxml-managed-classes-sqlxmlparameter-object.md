...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]O objeto SqlXmlParameter dá suporte a essas propriedades:  
 ...
 Valor  
 O valor do parâmetro. Para obter um exemplo de funcionamento, consulte [executar consultas de SQL &#40; Gerenciadas do SQLXML Classes &#41; ](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/net-framework-classes/executing-sql-queries-sqlxml-managed-classes.md).  
