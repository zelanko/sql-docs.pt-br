...
helpviewer_keywords: 
  ...
  - "transformação SCD"
  - "atualizando dimensões de alteração lenta"
...
## Saídas de transformação Dimensão de Alteração Lenta  
...
## Otimizando o desempenho da transformação Dimensão de Alteração Lenta  
...
## Solucionando problemas da transformação Dimensão de Alteração Lenta  
...
## Configurando a transformação Dimensão de Alteração Lenta  
...
## Configurando saídas da transformação Dimensão de Alteração Lenta  
