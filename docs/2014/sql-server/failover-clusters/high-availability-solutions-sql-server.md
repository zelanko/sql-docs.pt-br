...
##  <a name="TermsAndDefinitions"></a>Visão geral de soluções de alta disponibilidade SQL Server  
 ...
 [!INCLUDE[ssHADR](../../includes/sshadr-md.md)]  
  ...
  [!INCLUDE[ssHADR](../../includes/sshadr-md.md)] é uma solução de alta disponibilidade no nível empresarial e recuperação de desastre introduzida no [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] para permitir que você maximize a disponibilidade para um ou mais bancos de dados de usuário. 
...
##  <a name="RecommendedSolutions"></a>Soluções recomendadas para usar o SQL Server para proteger dados  
