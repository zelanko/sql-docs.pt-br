---
title: "Configurar um servidor para escuta em uma porta TCP espec&#237;fica (SQL Server Configuration Manager) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  - "porta fixa"
  - "portas estáticas"
  - "portas [SQL Server], atribuindo números"
  - "atribuindo números de porta"
  - "portas dinâmicas [SQL Server]"
...
> [!TIP]  
>  Ao selecionar um número da porta, consulte [http://www.iana.org/assignments/port-numbers](http://www.iana.org/assignments/port-numbers) para obter uma lista de números de portas atribuídas a aplicativos específicos. Selecione um número de porta não atribuído. Para obter mais informações, consulte [O intervalo de porta dinâmica para TCP/IP mudou no Windows Vista e no Windows Server 2008](http://support.microsoft.com/kb/929851).  
...
1.  No SQL Server Configuration Manager, no painel do console, expanda **Configuração de Rede do SQL Server**, expanda **Protocolos para \<nome da instância>** e clique duas vezes em **TCP/IP**.  
...
4.  Na área da caixa **Propriedades de***IP* **n** , na caixa **Porta TCP** , digite o número da porta em que esse endereço IP deve escutar e clique em **OK**.  
  
5.  No painel de console, clique em **Serviços do SQL Server**.  
  
6.  No painel de detalhes, clique com o botão direito do mouse em **SQL Server (**\<nome instância>**)** e clique em **Reiniciar** para parar e reiniciar o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
