...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Uma instância de **MultiPolygon** é uma coleção de zero ou mais instâncias de **Polygon**.  
