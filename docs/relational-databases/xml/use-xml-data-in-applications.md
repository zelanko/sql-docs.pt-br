...
helpviewer_keywords: 
  ...
  - "XML [SQL Server], ADO"
  - "colunas [XML no SQL Server], ADO.NET"
  - "ADO [XML no SQL Server]"
  - "colunas [XML no SQL Server], SQL Server Native Client"
  - "tipo de dados xml [SQL Server], ADO"
  - "SQLNCLI, XML"
  - "tipo de dados XML [SQL Server], SQL Server Native Client"
  - "SQL Server Native Client, XML"
  - "ADO.NET [XML no SQL Server]"
  - "XML [SQL Server], ADO.NET"
  - "colunas [XML no SQL Server], ADO"
  - "tipo de dados xml [SQL Server], ADO.NET"
