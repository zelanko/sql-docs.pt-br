---
title: SQLTransact (Driver do Paradox) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "63249863"
---
# <a name="sqltransact-paradox-driver"></a>SQLTransact (Driver do Paradox)
> [!NOTE]  
>  Este tópico fornece informações específicas de Driver do Paradox. Para obter informações gerais sobre essa função, consulte o tópico apropriado sob [referência da API ODBC](../../odbc/reference/syntax/odbc-api-reference.md).  
 ...
 Essa função dá suporte a ativa, mas não SQL_ROLLBACK.
