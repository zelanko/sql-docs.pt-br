...
description: Leia uma visão geral de como você pode estender a funcionalidade de entrega no Reporting Services implementando uma extensão de entrega personalizada.
ms.date: 03/16/2017
