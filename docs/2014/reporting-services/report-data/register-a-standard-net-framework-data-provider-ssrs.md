...
2.  Abra arquivo rssrvpolicy. config. Você pode abrir o arquivo de configuração [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] com o ou um editor de texto simples, como o bloco de notas.  
