---
description: 'ISSAsynchStatus:: GetStatus (provedor de OLE DB de cliente nativo)'
title: 'ISSAsynchStatus:: GetStatus (provedor de OLE DB de cliente nativo) | Microsoft Docs'
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "88490805"
---
# <a name="issasynchstatusgetstatus-native-client-ole-db-provider"></a>ISSAsynchStatus:: GetStatus (provedor de OLE DB de cliente nativo)
