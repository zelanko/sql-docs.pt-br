...
## <a name="see-also"></a>Consulte também  
 ...
 [Namespaces SMO](../../relational-databases/server-management-objects-smo/smo-object-model-namespaces.md)   
