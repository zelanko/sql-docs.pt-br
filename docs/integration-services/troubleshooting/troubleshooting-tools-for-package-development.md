---
title: "Solucionando problemas de ferramentas para desenvolvimento de pacotes | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Pacotes do SQL Server Integration Services, solução de problemas"
  - "Pacotes SSIS, solução de problemas"
  - "Integration Services, solução de problemas"
  - "erros [Integration Services], solução de problemas"
  - "pacotes [Integration Services], solução de problemas"
...
||  
|-|  
|![Ícone do Integration Services (pequeno)](../../integration-services/troubleshooting/media/dts-16.png "Ícone do Integration Services (pequeno)")  **Mantenha-se atualizado com o Integration Services**<br /> Para obter os downloads, artigos, exemplos e vídeos mais recentes da Microsoft, assim como soluções selecionadas pela comunidade, visite a página do [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] no MSDN:<br /><br /> -   [Visite a página do Integration Services no MSDN](http://go.microsoft.com/fwlink/?LinkId=136655)<br /><br /> Para receber uma notificação automática dessas atualizações, assine os RSS feeds disponíveis na página.|  
