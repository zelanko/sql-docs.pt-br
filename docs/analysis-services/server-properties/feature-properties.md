...
ms.topic: "reference"
helpviewer_keywords: 
  - "propriedade SQMSupportEnabled"
  - "propriedade ComUdfEnabled"
  - "propriedade LinkToOtherInstanceEnabled"
  - "propriedade ManagedCodeEnabled"
  - "propriedade ConnStringEncryptionEnabled"
  - "propriedade LinkFromOtherInstanceEnabled"
  - "propriedade LinkInsideInstanceEnabled"
  - "propriedade UseCachedPageAllocators"
