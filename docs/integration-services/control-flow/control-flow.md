...
ms.topic: "article"
helpviewer_keywords: 
  - "fluxo de controle [Integration Services], elementos"
  - "elementos de fluxo de controle do SSIS"
  - "elementos de fluxo de controle do SQL Server Integration Services"
...
## Implementação do fluxo de controle  
 ...
 ![Captura de tela do designer de fluxo de controle com pacote](../../integration-services/control-flow/media/samplecontrolflow.gif "Captura de tela do designer de fluxo de controle com pacote")  
...
-   Adicionar tarefas que oferecem suporte ao fluxo de dados, preparar dados, executar fluxo de trabalho e funções de business intelligence e implementar script.  
     ...
     [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] inclui uma variedade de tarefas que você pode usar para criar um fluxo de controle que atenda às necessidades de negócios do pacote. Se o pacote tiver que trabalhar com dados, o fluxo de controle deve incluir, no mínimo, uma tarefa de fluxo de dados. Por exemplo, um pacote pode ter que extrair dados, agregar valores de dados e, então, gravar os resultados em uma fonte de dados.  Para obter mais informações, consulte [Tarefas do Integration Services](../../integration-services/control-flow/integration-services-tasks.md) e [Adicionar ou excluir uma tarefa ou um contêiner em um fluxo de controle](../../integration-services/control-flow/add-or-delete-a-task-or-a-container-in-a-control-flow.md).  
