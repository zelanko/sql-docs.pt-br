---
description: Procedimentos armazenados do SQL Server Agent (Transact-SQL)
title: SQL Server Agent procedimentos armazenados (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88446665"
---
# <a name="sql-server-agent-stored-procedures-transact-sql"></a>Procedimentos armazenados do SQL Server Agent (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] suporta os seguintes procedimentos armazenados de sistema que são usados pelo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent para gerenciar atividades controladas por eventos e agendadas.  
