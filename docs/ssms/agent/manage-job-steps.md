...
Para obter mais informações sobre o MDX, consulte [Conceitos básicos da instrução MDX](/analysis-services/multidimensional-models/mdx/mdx-query-fundamentals-analysis-services?viewFallbackFrom=sql-server-ver15).  
