...
|SQL_C_FLOAT<br /><br /> SQL_C_DOUBLE|Dados estão dentro do intervalo do tipo de dados ao qual o número é convertido [a]<br /><br /> Data está fora do intervalo do tipo de dados ao qual o número é convertido [a]|Data<br /><br /> Indefinido|Tamanho do tipo de dados C<br /><br /> Indefinido|n/d<br /><br /> 22003|  
