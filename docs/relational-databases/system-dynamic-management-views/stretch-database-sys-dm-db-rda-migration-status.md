...
description: Saiba como o sys. dm_db_rda_migration_status contém uma linha para cada lote de dados migrados de cada tabela habilitada para Stretch na instância local do SQL Server.
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
ms.reviewer: ''
