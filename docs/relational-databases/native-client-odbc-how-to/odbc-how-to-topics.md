---
description: Tópicos de instruções sobre ODBC
...
-   [Tópicos de instrução sobre a configuração do driver ODBC do SQL Server](./configuring-the-sql-server-odbc-driver-add-a-data-source.md)  
  
-   [Alocar identificadores e conectar-se ao SQL Server &#40;ODBC&#41;](../../relational-databases/native-client-odbc-how-to/allocate-handles-and-connect-to-sql-server-odbc.md)  
...
-   [Tópicos de instruções sobre o processamento de resultados &#40;ODBC&#41;](./processing-results-process-results.md)  
...
-   [Usar o Microsoft Coordenador de Transações Distribuídas &#40;ODBC&#41;](../../relational-databases/native-client-odbc-how-to/use-microsoft-distributed-transaction-coordinator-odbc.md)  
  
-   [Tópicos de instruções sobre como executar procedimentos armazenados &#40;&#41;ODBC ](./running-stored-procedures-call-stored-procedures.md)  
  
-   [Tópicos de instruções sobre como gerenciar colunas de texto e imagem &#40;ODBC&#41;]()  
...
-   [Processar erros de ODBC &#40;&#41;ODBC ](../../relational-databases/native-client-odbc-how-to/process-odbc-errors-odbc.md)  
