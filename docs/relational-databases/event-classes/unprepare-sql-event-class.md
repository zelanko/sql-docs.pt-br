...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento Unprepare SQL indica que SqlClient, ODBC, OLE DB ou DB-Library cancelou a preparação (excluiu) de uma ou mais instruções [!INCLUDE[tsql](../../includes/tsql-md.md)] preparadas.  
