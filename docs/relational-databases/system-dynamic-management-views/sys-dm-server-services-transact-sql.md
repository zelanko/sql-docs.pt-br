...
|-----------------|---------------|-----------------|  
|servicename|**nvarchar(256)**|Nome do serviço SQL Server, Texto Completo ou SQL Server Agent. Não pode ser nulo.|  
...
|instant_file_initialization_enabled|**nvarchar(1)**|**Aplica-se a: [!INCLUDE[sssql11](../../includes/sssql11-md.md)] SP4 e começando com [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP1**.<br /><br />Especifica se a inicialização instantânea de arquivo está habilitada para o serviço de mecanismo de banco de dados do SQL Server. Essa propriedade não se aplica a serviços (exemplo: SQL Server Agent) que não sejam de serviço do mecanismo de banco de dados do SQL Server. permite valor nulo.<br /><br />Y = inicialização instantânea de arquivo está habilitada para o serviço.<br /><br />N = inicialização instantânea de arquivo está desabilitada para o serviço.|  
