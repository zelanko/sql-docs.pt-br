...
helpviewer_keywords: 
  - "dados truncados"
  - "erros de conversão de dados [Integration Services]"
  ...
  - "fluxo de dados [Integration Services], erros"
  - "expressões [Integration Services], erros"
...
## Use saídas de erro para capturar erros de nível de linha  
...
## Erros são falhas ou truncamentos  
...
## Selecione uma opção de tratamento de erro  
