...
helpviewer_keywords: 
  ...
  - "conjuntos de dados [Integration Services], dividindo"
...
### Para dividir um conjunto de dados condicionalmente  
...
10. Para configurar uma saída de erro, clique em **Configurar Saída de Erro**. Para obter mais informações, consulte [Configurar uma saída de erro em um componente de fluxo de dados](../../../integration-services/troubleshooting/configure-an-error-output-in-a-data-flow-component.md).  
