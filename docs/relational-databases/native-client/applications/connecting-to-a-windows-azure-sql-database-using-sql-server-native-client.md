...
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]
  ...
  Para obter um exemplo que mostra como se conectar a um [!INCLUDE[ssSDSfull](../../../includes/sssdsfull-md.md)] usando [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client, consulte [desenvolvimento: tópicos de instruções (Windows Azure SQL Database)](https://msdn.microsoft.com/library/ee621787.aspx).  
