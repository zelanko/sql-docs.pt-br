...
### <a name="active-directory-managed-service-identity-msi-authentication"></a>Autenticação da _Identidade de Serviço Gerenciada_ (MSI) do Active Directory
