...
4.  Revise as propriedades de chave e de configuração de erro de chave nula, mas não faça nenhuma alteração.  
    ...
    ![Coleção de propriedades ErrorConfiguration](../media/l4-productdimensionerrorconfig-1.gif "coleção de propriedades ErrorConfiguration")  
...
6.  Expanda **Componentes**e expanda o membro não rotulado do nível **Nome do Modelo** .  
    ...
    ![Componentes de assembly usados para criar outros componentes](../media/l4-productdimensionerrorconfig-2.gif "componentes usados para criar outros componentes do Assembly")  
...
4.  Clique na consulta SELECT DISTINCT e em **Exibir Detalhes**.  
    ...
    ![Cláusula SELECT DISTINCT que mostra a cláusula WHERE](../media/l4-productnametraceline-1.gif "cláusula SELECT DISTINCT que mostra a cláusula WHERE")  
...
4.  Expanda o membro **Componentes do Assembly** do nível **Categoria** e expanda o membro **Componentes do Assembly** do nível **Subcategoria** .  
    ...
    ![Nível nome do produto mostrando componentes do assembly](../media/l4-assemblycomponents-1.gif "nível nome do produto mostrando componentes de assembly")  
