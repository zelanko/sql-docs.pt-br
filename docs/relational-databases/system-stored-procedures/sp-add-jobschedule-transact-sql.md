...
|**16** (mensal)|No dia *frequency_interval* do mês.|  
 ...
 *frequency_relative_interval* indica a ocorrência do intervalo. Por exemplo, se *frequency_relative_interval* for definido como **2**, *frequency_type* for definido como **32**e *frequency_interval* for definido como **3**, o trabalho agendado ocorrerá na segunda terça-feira de cada mês.  
...
## <a name="remarks"></a>Comentários  
 As agendas de trabalho podem ser gerenciadas independentemente dos trabalhos. Para adicionar um agendamento a um trabalho, use **sp_add_schedule** para criar o agendamento e **sp_attach_schedule** para anexar a agenda a um trabalho.  
