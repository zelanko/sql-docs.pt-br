...
description: Saiba mais sobre o FILESTREAM, um recurso do SQL Server que armazena dados no sistema de arquivos. Leia sobre como ele armazena e protege os dados e fornece acesso a eles.
ms.custom: ''
ms.date: 01/11/2018
ms.prod: sql
