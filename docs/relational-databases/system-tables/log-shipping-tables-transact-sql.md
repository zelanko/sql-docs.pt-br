---
title: Tabelas (Transact-SQL) de envio de log | Microsoft Docs
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
...
ms.author: sstein
manager: craigg
ms.openlocfilehash: 519aa612896631918b4466966e6d9f1207c4761c
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Os tópicos a seguir descrevem as tabelas do sistema que armazenam informações usadas pelas operações de envio de logs.  
