...
|Nome|Descrição|  
|----------|-----------------|  
|[addBatch](../../../connect/jdbc/reference/addbatch-method-sqlserverpreparedstatement.md)|(Herdado de SQLServerPreparedStatement.) Adiciona um conjunto de parâmetros para o lote de comandos do objeto CallableStatement.|  
...
|[getMoreResults](../../../connect/jdbc/reference/getmoreresults-method-sqlserverstatement.md)|(Herdado de SQLServerStatement.) Move para o próximo resultado desse objeto CallableStatement.|  
