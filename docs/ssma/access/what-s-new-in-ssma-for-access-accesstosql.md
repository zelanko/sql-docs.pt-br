...
A versão de v 8.2 do SSMA para Access é aprimorada com correções direcionadas são projetadas para melhorar as métricas de qualidade e a conversão.
...
A versão 8.1 do SSMA para Access é aprimorada com correções direcionadas são projetadas para melhorar as métricas de qualidade e a conversão.
...
A versão v 8.0 do SSMA para Access é aprimorada com correções direcionadas projetadas para melhorar a qualidade e a conversão de métricas. Esta versão também oferece os seguintes recursos novos:
...
A versão de v7.10 do SSMA para Access é aprimorada com correções direcionadas projetadas para fornecer segurança adicional e proteções de privacidade para atender às mudanças nos requisitos de globais.
...
A versão de v7.6 do SSMA para Access é aprimorada com correções direcionadas que melhoram as métricas de qualidade e a conversão e com suporte para SQL Server 2017 (visualização pública). Suporte para SQL Server 2017 no Windows e Linux está em visualização pública e não deve ser usado para migrações de produção.

## <a name="ssma-v75"></a>SSMA v7.5

A versão de v 7.5 do SSMA para Access é aprimorada com várias melhorias para garantir que a maior acessibilidade para pessoas com deficiências.
...
A versão de preview de março de 2016 do SSMA para Access adiciona suporte para a migração para o SQL Server 2016.  
...
A versão de julho de 2011 do SSMA para Access adiciona aprimorado relatórios de erros durante a migração de dados.  
