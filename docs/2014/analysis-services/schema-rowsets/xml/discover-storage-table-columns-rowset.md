...
|`CUBE_NAME`|`DBTYPE_WSTR`|Sim|Especifica o cubo ou modelo que contém as tabelas.<br /><br /> O `DISCOVER_STORAGE_TABLES` linhas pode ser restringido usando esta coluna.|  
