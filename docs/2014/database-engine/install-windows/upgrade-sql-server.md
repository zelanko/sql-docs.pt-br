...
## <a name="see-also"></a>Consulte Também  
 ...
 [SQL Server 2012 Analisador de Práticas Recomendadas](https://www.microsoft.com/download/details.aspx?id=29302)   
 [SQL Server 2008 R2 Analisador de Práticas Recomendadas](https://www.microsoft.com/download/details.aspx?id=436)   
