...
description: Saiba como reproduzir um evento de rastreamento por vez no SQL Server Profiler passo a passo em um arquivo ou tabela de rastreamento de repetição.
ms.prod: sql
