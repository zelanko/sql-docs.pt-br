---
title: "Alterar a conta de inicializa&#231;&#227;o de servi&#231;o do SQL Server (SQL Server Configuration Manager) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/06/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "serviços do SQL Server, alterações em conta de inicialização"
  - "contas de inicialização [SQL Server]"
  - "alterando as contas de inicialização de serviços"
...
---
# Alterar a conta de inicializa&#231;&#227;o de servi&#231;o do SQL Server (SQL Server Configuration Manager)
...
#### Para alterar a conta de inicialização do serviço do SQL Server  
...
4.  Na caixa de diálogo **Propriedades do \<***nomedainstância***> do SQL Server**, clique na guia **Logon** e selecione um tipo de conta para **Fazer logon como**.  
