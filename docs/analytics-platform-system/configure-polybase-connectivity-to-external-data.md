...
5. Reinicie a região PDW. Para fazer isso, use a ferramenta Gerenciador de configuração. Consulte [iniciar o Configuration Manager &#40; Analytics Platform System &#41; ](launch-the-configuration-manager.md).
