...
```  
 ...
 Além disso, você deve criar um diretório virtual para o banco de dados tempdb-e um nome virtual `template` de modelo do tipo chamado "template".  
