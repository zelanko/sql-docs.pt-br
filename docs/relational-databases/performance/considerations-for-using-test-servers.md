...
description: Saiba como usar um servidor de teste para ajustar um banco de dados em um servidor de produção. Esse é um benefício importante do Orientador de Otimização do Mecanismo de Banco de Dados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
