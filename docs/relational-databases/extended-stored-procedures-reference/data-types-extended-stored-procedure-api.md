...
description: Saiba como os tipos de dados de API de procedimento armazenado estendido podem ser expandidos incluindo o arquivo de cabeçalho SRV. h em seu programa.
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
