...
ms.topic: "article"
helpviewer_keywords: 
  - "arquitetura de servidor [Analysis Services]"
...
>  O DSO foi substituído. Você não deve usar o DSO para desenvolver soluções.  
 ...
 ![Diagrama da arquitetura de sistema do Analysis Services](../../analysis-services/data-mining/media/analysisservicessystemarchitecture.gif "Diagrama da arquitetura de sistema do Analysis Services")  
