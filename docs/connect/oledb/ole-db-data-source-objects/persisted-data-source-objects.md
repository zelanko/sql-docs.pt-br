---
title: Objetos de fonte de dados persistidos (driver do OLE DB)
description: Saiba mais sobre o suporte do Driver do OLE DB para SQL Server a objetos de fonte de dados persistentes com a interface IPersistFile nesses exemplos.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
