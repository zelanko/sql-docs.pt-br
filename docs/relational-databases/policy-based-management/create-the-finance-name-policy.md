...
manager: "jhubbard"
---
# Criar a pol&#237;tica Nome Financeiro
...
### Para criar a política Nome Financeiro  
...
7.  Na caixa **Expressão**, complete a expressão incluindo **@Name = 'Finance'** e clique em **OK** para fechar a página de condição.  
...
### Para criar a categoria da política Finanças  
...
[Assinar e verificar a política Nome Financeiro](../../relational-databases/policy-based-management/subscribe-to-and-check-the-finance-name-policy.md)  
