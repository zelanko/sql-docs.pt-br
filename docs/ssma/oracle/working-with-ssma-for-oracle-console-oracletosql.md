...
|[Criar os arquivos de Conexão do servidor &#40; OracleToSQL &#41;](../../ssma/oracle/creating-the-server-connection-files-oracletosql.md)|Explica como criar um arquivo de conexão de servidor.|  
