...
description: Em um modelo de recuperação simples ou bulk-logged, o log mínimo de operações de importação em massa reduz a possibilidade de uma operação preencher o espaço de log.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
