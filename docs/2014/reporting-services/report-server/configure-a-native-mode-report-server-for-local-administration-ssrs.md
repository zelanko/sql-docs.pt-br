...
-   [Visão geral das alterações de configuração](#bkmk_configuraiton_overview)  
  
-   [Para configurar o servidor de relatório local e a administração do Report Manager](#bkmk_configure_local_server)  
  
-   [Para configurar o SQL Server Management Studio (SSMS) para a administração do servidor de relatório local](#bkmk_configure_ssms)  
...
##  <a name="bkmk_configuraiton_overview"></a>Visão geral das alterações de configuração  
...
##  <a name="bkmk_configure_local_server"></a>Para configurar o servidor de relatório local e a administração do Report Manager  
...
###  <a name="bkmk_site_settings"></a>Configurações de site confiáveis no navegador  
...
###  <a name="bkmk_configure_folder_settings"></a>Report Manager configurações de pasta  
...
###  <a name="bkmk_configure_site_settings"></a>Report Manager configurações do site  
...
2.  Clique em **Configurações de Site** no canto superior da Página Inicial.  
    ...
    > [!TIP]  
    >  **Observação:** Se você não vir a opção **configurações de site** , feche e reabra o navegador e navegue até o Gerenciador de relatórios com privilégios administrativos.  
...
##  <a name="bkmk_configure_ssms"></a>Para configurar o SQL Server Management Studio (SSMS) para a administração do servidor de relatório local  
 ...
 **Para configurar [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] ** Propriedades de função e atribuições de função para que você não [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] precise iniciar com permissões elevadas a cada vez:  
...
##  <a name="bkmk_configure_ssdt"></a>Para configurar o BI de SQL Server Data Tools (SSDT) para publicar em um servidor de relatório local  
 ...
 **Para executar com permissões elevadas toda vez que você abrir o SSDT:**  
 ...
 **Para configurar [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] as atribuições de função, você não precisa iniciar o SSDT com permissões elevadas a cada vez:**  
