...
|Nome simbólico|P3_HEKATON_PROC_IMP|  
|Texto da mensagem|O '*feature*' *construct* ainda não foi implementado com procedimentos armazenados compilados nativamente.|  
