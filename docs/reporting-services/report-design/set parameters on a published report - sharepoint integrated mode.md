...
ms.topic: "article"
helpviewer_keywords: 
  - "integração com o SharePoint [Reporting Services], gerenciamento de conteúdo"
  - "parâmetros de relatório [Reporting Services]"
...
manager: "erikre"
---
# Definir par&#226;metros em um relat&#243;rio publicado (Reporting Services no modo integrado do SharePoint)
...
### Para executar um relatório com parâmetros  
...
### Para definir propriedades de parâmetros  
