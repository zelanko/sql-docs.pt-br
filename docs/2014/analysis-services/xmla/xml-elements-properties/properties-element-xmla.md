...
ms.locfileid: "36007581"
---
# <a name="properties-element-xmla"></a>Elemento Properties (XMLA)
  Contém o XML para propriedades de análise (XMLA) usadas pelo [Discover](../xml-elements-methods-discover.md) e [Execute](../xml-elements-methods-execute.md) métodos.  
...
|Relação|Elemento|  
|------------------|-------------|  
|Elementos pai|[Descobrir](../xml-elements-methods-discover.md), [executar](../xml-elements-methods-execute.md)|  
