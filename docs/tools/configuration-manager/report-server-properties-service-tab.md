---
title: Propriedades do servidor de relatório (guia Serviço)
description: Saiba mais sobre as opções na guia Serviço na caixa de diálogo Propriedades do servidor de relatório, como o caminho binário, o nome do host e o modo de início.
