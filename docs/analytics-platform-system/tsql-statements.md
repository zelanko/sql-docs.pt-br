...
description: Instruções T-SQL para analíticos Platform System (APS) SQL Server Parallel Data Warehouse (PDW).
author: mzaman1
manager: craigg
ms.prod: sql
...
* [REMOVER A FONTE DE DADOS EXTERNA](../t-sql/statements/drop-external-data-source-transact-sql.md)
...
* [REMOVER O PROCEDIMENTO](../t-sql/statements/drop-procedure-transact-sql.md)
* [REMOVER ESTATÍSTICAS](../t-sql/statements/drop-statistics-transact-sql.md)
* [DROP TABLE](../t-sql/statements/drop-table-transact-sql.md)
* [REMOVER O ESQUEMA](../t-sql/statements/drop-schema-transact-sql.md)
* [REMOVER A EXIBIÇÃO](../t-sql/statements/drop-view-transact-sql.md)
...
* Permissões: [GRANT](../t-sql/statements/grant-transact-sql.md), [DENY](../t-sql/statements/deny-transact-sql.md), [REVOGAR](../t-sql/statements/revoke-transact-sql.md)
...
* [ALTER LOGON](../t-sql/statements/alter-login-transact-sql.md)
...
* [REMOVA A CHAVE DE CRIPTOGRAFIA DE BANCO DE DADOS](../t-sql/statements/drop-database-encryption-key-transact-sql.md)
* [DESCARTAR O LOGON](../t-sql/statements/drop-login-transact-sql.md)
* [REMOVA A CHAVE MESTRA](../t-sql/statements/drop-master-key-transact-sql.md)
...
Para obter informações de referência, consulte [elementos de linguagem T-SQL](tsql-language-elements.md) e [exibições do sistema do T-SQL](tsql-system-views.md).
