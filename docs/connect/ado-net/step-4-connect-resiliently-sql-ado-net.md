---
title: 'Etapa 4: Conectar-se de forma resiliente ao SQL com ADO.NET'
description: Saiba como usar a lógica de repetição para aprimorar a resiliência da conexão com um Banco de Dados SQL usando o ADO.NET.
ms.custom: ''
ms.date: 08/15/2019
ms.prod: sql
