...
|**128**|Executar quando o computador estiver ocioso (sem suporte no [Azure SQL instância gerenciada](/azure/sql-database/sql-database-managed-instance-transact-sql-information#sql-server-agent)) |  
