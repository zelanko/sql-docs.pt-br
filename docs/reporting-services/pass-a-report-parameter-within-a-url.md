...
description: Saiba como transmitir parâmetros de relatório diretamente para o mecanismo de processamento de relatório, incluindo-os em uma URL de relatório.
ms.date: 03/01/2017
