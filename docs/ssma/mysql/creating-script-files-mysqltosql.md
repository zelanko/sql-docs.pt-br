...
7.  **Parar operação:** Durante a operação mid, se o usuário quiser interromper a operação, a tecla de atalho **' CTRL + C'** poderá ser usada. O console do SSMA para MySQL aguardará a conclusão da operação e encerrará a execução do console.  
...
Os parâmetros de conexão do servidor podem ser definidos no arquivo de script ou no arquivo de conexão do servidor. Veja a seção [criando os arquivos de conexão do servidor &#40;MySQLToSQL&#41;](../../ssma/mysql/creating-the-server-connection-files-mysqltosql.md) para obter mais detalhes.  
...
A lista completa de comandos de script pode ser encontrada na [execução do console do SSMA &#40;MySQLToSQL&#41;](../../ssma/mysql/executing-the-ssma-console-mysqltosql.md)  
  
## <a name="script-file-validation"></a>Validação de arquivo de script  
O usuário pode facilmente validar seu arquivo de script em relação ao arquivo de definição de esquema **"2ssconsolescriptschema. xsd"** disponível na pasta "esquemas".  
  
## <a name="next-step"></a>Próxima etapa  
A próxima etapa na operação do console é [criar arquivos de valor de variável &#40;MySQLToSQL&#41;](../../ssma/mysql/creating-variable-value-files-mysqltosql.md).  
