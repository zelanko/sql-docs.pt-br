---
title: Data-hora em versões SQL (ODBC)
ms.custom: ''
ms.date: 12/18/2019
ms.prod: sql
...
## <a name="down-level-client-behavior"></a>Comportamento do cliente de versão anterior  
 ...
 Os metadados de declaração retornados por SQLDescribeCol, SQLDescribeParam, SQGetDescField e SQLColAttribute retornarão metadados consistentes com o tipo de nível baixo em todos os aspectos, incluindo o nome do tipo. Um exemplo de um tipo de nível baixo é **nvarchar**.  
...
||Time(7)|SQL_C_TIME|Falha - tempo inválido literal.|OK (1)|  
|||SQL_C_TYPE_TIMESTAMP|Falha - tempo inválido literal.|OK (1)|  
||Data2(3)|SQL_C_TYPE_TIMESTAMP|OK|OK (1)|  
||Data2(7)|SQL_C_TYPE_TIMESTAMP|OK|Valor será arredondado para 1/300º segundo por conversão de cliente.|  
