...
##  <a name="to-open-service-application-management-pages"></a><a name="bkmk_openpages"></a>Para abrir páginas de gerenciamento de aplicativos de serviço
...
##  <a name="system-settings-page"></a><a name="bkmk_systemsettings"></a>Página Configurações do sistema
...
###  <a name="report-settings"></a><a name="bkmk_report_settings_section"></a>Configurações de relatório
...
###  <a name="session-settings"></a><a name="bkmk_session_settings_section"></a>Configurações de sessão
...
###  <a name="system-settings-for-logging"></a><a name="bkmk_logging_settings_section"></a>Configurações do sistema para registro em log
...
###  <a name="security-settings"></a><a name="bkmk_security_settings_section"></a>Configurações de segurança
...
###  <a name="client-settings"></a><a name="bkmk_client_settings_section"></a>Configurações do cliente
...
##  <a name="manage-jobs"></a><a name="bkmk_managejobs"></a>Gerenciar trabalhos
 ...
 ![gerenciar trabalhos em execução](media/ssrs-manage-jobs.gif "gerenciar trabalhos em execução")

##  <a name="key-management"></a><a name="bkmk_keymgt"></a>Gerenciamento de chaves
...
##  <a name="execution-account"></a><a name="bkmk_executionaccount"></a>Conta de execução
 ...
 **Conta** Insira uma conta de usuário de domínio do Windows. Use este formato: * \<>\\ de domínio<conta\>de usuário*.

 **Senha** Digite a senha.

 **Confirmar senha** Redigite a senha.

##  <a name="e-mail-settings"></a><a name="bkmk_email"></a>Configurações de email
...
##  <a name="provision-subscriptions-and-alerts"></a><a name="bkmk_provisionsubscriptions"></a>Provisionar assinaturas e alertas
