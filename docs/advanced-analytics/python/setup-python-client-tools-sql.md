---
title: Configurar as ferramentas de cliente do Python para uso com o SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 03/13/2018
...
---
# <a name="set-up-python-client-tools-for-use-with-sql-server"></a>Configurar o Python ferramentas de cliente para uso com o SQL Server 
