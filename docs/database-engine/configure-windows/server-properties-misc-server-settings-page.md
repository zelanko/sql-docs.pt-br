...
description: Familiarize-se com as configurações do servidor no SQL Server. Saiba mais sobre as opções que controlam o idioma padrão para novos usuários, tempos limite de consulta e outros comportamentos.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
