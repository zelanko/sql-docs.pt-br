---
title: "Limitar o tamanho de arquivos e tabelas de rastreamento | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "rastreamentos [SQL Server], tamanho do arquivo"
  - "tamanho [SQL Server], tabelas"
  - "opção de substituição de arquivo [SQL Server]"
  - "tamanho [SQL Server], arquivos"
