...
Para obter ajuda detalhada sobre a sintaxe de cada função, use a Ajuda de R. Os detalhes também estão disponíveis na [Referência do ScaleR](/r-server/r-reference/revoscaler/revoscaler).
