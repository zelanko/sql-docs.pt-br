...
## Configurar uma pesquisa de texto completo em duas etapas
...
## Configurar uma pesquisa de texto completo com um assistente 
...
### Escolher um catálogo de texto completo   
