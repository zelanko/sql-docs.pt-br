...
1. [Compatibilidade com versões anteriores do Analysis Services (SQL 2017)](analysis-services-backward-compatibility-sql2017.md)
2. [Segurança em nível de objeto](tabular-models/object-level-security.md)
