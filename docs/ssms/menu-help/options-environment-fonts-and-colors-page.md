---
description: Opções (página Ambiente – Fontes e Cores)
...
[Codificação de cores nos editores de códigos](../scripting/color-coding-in-query-editors.md)