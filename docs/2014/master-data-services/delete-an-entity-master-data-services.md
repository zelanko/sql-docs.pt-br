...
4.  Selecione a linha correspondente à entidade que você deseja excluir.  
  
5.  Clique em **excluir entidade selecionada**.  
  
6.  Na caixa de diálogo de confirmação, clique em **OK**.  
  
7.  Na caixa de diálogo de confirmação adicional, clique em **OK**.  
  
## <a name="see-also"></a>Consulte também  
 [Entidades &#40;Master Data Services&#41;](../../2014/master-data-services/entities-master-data-services.md)   
 [Criar uma entidade &#40;Master Data Services&#41;](../../2014/master-data-services/create-an-entity-master-data-services.md)  
