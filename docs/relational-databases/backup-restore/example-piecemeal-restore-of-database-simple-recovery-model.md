...
description: Este exemplo mostra uma restauração por etapas no SQL Server de um banco de dados para um novo computador usando o modelo de recuperação simples.
