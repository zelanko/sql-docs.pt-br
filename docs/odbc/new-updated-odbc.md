---
title: Atualizado - ODBC para documentos do SQL Server | Microsoft Docs
description: "Exibir fragmentos de conteúdo atualizado recentemente alterada na documentação de, para ODBC (conectividade aberta de banco de dados) para o Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
ms.author: genemi
ms.workload: odbc
ms.openlocfilehash: 9ec50fe74ccc50401e39477db57a4d8b1d10835f
ms.sourcegitcommit: 7f8aebc72e7d0c8cff3990865c9f1316996a67d5
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 11/20/2017
---
# <a name="new-and-recently-updated-odbc-for-sql-server"></a>Novos e atualizados recentemente: ODBC para SQL Server
...
- *Área de assunto:* &nbsp; **ODBC (conectividade aberta de banco de dados) para o SQL Server**.
