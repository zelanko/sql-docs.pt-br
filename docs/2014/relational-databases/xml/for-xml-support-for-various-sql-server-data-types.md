...
|Tópico|Description|  
|-----------|-----------------|  
|[Suporte a FOR XML para o tipo de dados xml](for-xml-support-for-the-xml-data-type.md)|Descreve como o FOR XML funciona com o tipo de dados **xml** .|  
...
|[Suporte de FOR XML para o tipo de dados timestamp](for-xml-support-for-the-timestamp-data-type.md)|Descreve como o FOR XML funciona com o tipo de dados **timestamp** .|  
