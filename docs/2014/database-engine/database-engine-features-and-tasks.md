...
# <a name="database-engine-features-and-tasks"></a>Recursos e tarefas do Mecanismo de Banco de Dados
  Encontre informações que sejam necessárias para criar [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] bancos de dados por qualquer designer, desenvolvedor, analista ou administrador.  
