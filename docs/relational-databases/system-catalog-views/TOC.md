# [Visão geral](catalog-views-transact-sql.md)

# [Consultando o catálogo de sistema do SQL Server perguntas Frequentes](querying-the-sql-server-system-catalog-faq.md)  
# [Esquemas - schemas](schemas-catalog-views-sys-schemas.md)  
# [Mensagens (para erros) - sys. messages](messages-for-errors-catalog-views-sys-messages.md)  
# [Extended Properties - extended_properties](extended-properties-catalog-views-sys-extended-properties.md)  

# Controle de alterações
## [change_tracking_databases](change-tracking-catalog-views-sys-change-tracking-databases.md)  
## [change_tracking_tables](change-tracking-catalog-views-sys-change-tracking-tables.md)  

# Espelhamento de Banco de Dados
## [Testemunha de espelhamento - banco de dados database_mirroring_witnesses](database-mirroring-witness-catalog-views-sys-database-mirroring-witnesses.md)  
...
# [Bancos de dados e arquivos](databases-and-files-catalog-views-transact-sql.md)  
...
## [soap_endpoints](sys-soap-endpoints-transact-sql.md)  
## [sys. tcp_endpoints](sys-tcp-endpoints-transact-sql.md)  

# [Eventos estendidos](extended-events-catalog-views-transact-sql.md)  
## [sys.database_event_session_targets (banco de dados do SQL Azure)](sys-database-event-session-targets-azure-sql-database.md)  
## [sys.database_event_session_fields (banco de dados do SQL Azure)](sys-database-event-session-fields-azure-sql-database.md)  
## [sys.database_event_session_events (banco de dados do SQL Azure)](sys-database-event-session-events-azure-sql-database.md)  
## [sys.database_event_session_actions (banco de dados do SQL Azure)](sys-database-event-session-actions-azure-sql-database.md)  
## [sys.database_event_sessions (banco de dados do SQL Azure)](sys-database-event-sessions-azure-sql-database.md)  
## [server_event_sessions](sys-server-event-sessions-transact-sql.md)  
## [server_event_session_actions](sys-server-event-session-actions-transact-sql.md)  
...
## [fulltext_indexes](sys-fulltext-indexes-transact-sql.md)  
...
## [sys](sys-servers-transact-sql.md)  

# [Objeto](object-catalog-views-transact-sql.md)  
## [all_columns](sys-all-columns-transact-sql.md)  
## [all_objects](sys-all-objects-transact-sql.md)  
## [all_parameters](sys-all-parameters-transact-sql.md)  
## [sys.all_sql_modules](sys-all-sql-modules-transact-sql.md)  
## [all_views](sys-all-views-transact-sql.md)  
## [sys.allocation_units](sys-allocation-units-transact-sql.md)  
## [assembly_modules](sys-assembly-modules-transact-sql.md)  
...
## [Events](sys-events-transact-sql.md)  
## [event_notifications](sys-event-notifications-transact-sql.md)  
...
## [function_order_columns](sys-function-order-columns-transact-sql.md)  
## [sys. hash_indexes](sys-hash-indexes-transact-sql.md)  
## [. identity_columns](sys-identity-columns-transact-sql.md)  
...
## [server_assembly_modules](sys-server-assembly-modules-transact-sql.md)  
## [server_events](sys-server-events-transact-sql.md)  
...
## [server_triggers](sys-server-triggers-transact-sql.md)  
...
## [stats_columns](sys-stats-columns-transact-sql.md)  
## [synonyms](sys-synonyms-transact-sql.md)  
## [sys.system_columns](sys-system-columns-transact-sql.md)  
## [system_objects](sys-system-objects-transact-sql.md)  
...
## [trigger_events](sys-trigger-events-transact-sql.md)  
...
## [partition_parameters](sys-partition-parameters-transact-sql.md)  
## [sys.partition_range_values](sys-partition-range-values-transact-sql.md)  

# [Exibições de gerenciamento baseado em políticas](policy-based-management-views-transact-sql.md)  
...
# [Tipos escalares](scalar-types-catalog-views-transact-sql.md)  
## [sys.assembly_types](sys-assembly-types-transact-sql.md)  
## [Types](sys-types-transact-sql.md)  
...
## [Certificates](sys-certificates-transact-sql.md)  
...
## [Credentials](sys-credentials-transact-sql.md)  
...
## [server_permissions](sys-server-permissions-transact-sql.md)  
## [sys. server_principals](sys-server-principals-transact-sql.md)  
## [server_role_members](sys-server-role-members-transact-sql.md)  
...
## [conversation_endpoints](sys-conversation-endpoints-transact-sql.md)  
## [conversation_groups](sys-conversation-groups-transact-sql.md)  
...
## [service_queues](sys-service-queues-transact-sql.md)  
## [sys](sys-services-transact-sql.md)  
## [sys. transmission_queue](sys-transmission-queue-transact-sql.md)  

# [Configuração do servidor](server-wide-configuration-catalog-views-transact-sql.md)  
## [sys.configurations](sys-configurations-transact-sql.md)  
## [time_zone_info](sys-time-zone-info-transact-sql.md)  
...
## [trace_event_bindings](sys-trace-event-bindings-transact-sql.md)  
## [trace_subclass_values](sys-trace-subclass-values-transact-sql.md)  

# [Dados espaciais](spatial-data-catalog-views.md)  
## [spatial_index_tessellations](sys-spatial-index-tessellations-transact-sql.md)  
## [spatial_indexes](sys-spatial-indexes-transact-sql.md)  
...
# [Esquemas XML (sistema de tipo XML)](xml-schemas-xml-type-system-catalog-views-transact-sql.md)  
