---
description: Exemplo das propriedades OriginalValue e subdependvalue (VC + +)
title: Exemplo das propriedades OriginalValue e subdependvalue (VC + +) | Microsoft Docs
ms.prod: sql
