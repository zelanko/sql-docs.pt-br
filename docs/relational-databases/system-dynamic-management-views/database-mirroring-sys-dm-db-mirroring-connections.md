...
ms.locfileid: "68090948"
---
# <a name="database-mirroring---sysdmdbmirroringconnections"></a>-O espelhamento de banco de dados sys.dm_db_mirroring_connections
...
|**peer_certificate_id**|**int**|A ID de objeto de local do certificado usado pela instância remota para autenticação. O proprietário deste certificado deve ter permissões de CONNECT no ponto de extremidade de espelhamento de banco de dados.|  
|**encryption_algorithm**|**smallint**|Algoritmo de criptografia usado para esta conexão. É NULLABLE. Valores possíveis:<br /><br /> **Valor:** 0<br /><br /> **Descrição:** Nenhum<br /><br /> **Opção de DDL:** Desabilitado<br /><br /> **Valor:** 1<br /><br /> **Descrição:** RC4<br /><br /> **Opção de DDL:** {necessárias &#124; algoritmo RC4 obrigatório}<br /><br /> **Valor:** 2<br /><br /> **Descrição:** AES<br /><br /> **Opção de DDL:** Algoritmo AES obrigatório<br /><br /> **Valor:** 3<br /><br /> **Descrição:** None, RC4<br /><br /> **Opção de DDL:** {com suporte &#124; algoritmo RC4 com suporte}<br /><br /> **Valor:** 4<br /><br /> **Descrição:** none, AES<br /><br /> **Opção de DDL:** Algoritmo RC4 com suporte<br /><br /> **Valor:** 5<br /><br /> **Descrição:** RC4, AES<br /><br /> **Opção de DDL:** Algoritmo AES RC4 obrigatório<br /><br /> **Valor:** 6<br /><br /> **Descrição:** AES, RC4<br /><br /> **Opção de DDL:** Necessário algoritmo AES RC4<br /><br /> **Valor:** 7<br /><br /> **Descrição:** NONE, RC4, AES<br /><br /> **Opção de DDL:** Suporte para o algoritmo RC4 AES<br /><br /> **Valor:** 8<br /><br /> **Descrição:** NONE, AES, RC4<br /><br /> **Opção de DDL:** Algoritmo AES RC4 com suporte<br /><br /> **Observação:** O algoritmo RC4 tem suporte somente para compatibilidade com versões anteriores. O novo material só pode ser criptografado por meio do algoritmo RC4 ou RC4_128 quando o banco de dados está no nível de compatibilidade 90 ou 100. (Não recomendável.) Use um algoritmo mais recente; por exemplo, um dos algoritmos AES. No [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versões posteriores, o material criptografado usando RC4 ou RC4_128 pode ser descriptografado em qualquer nível de compatibilidade.|  
|**encryption_algorithm_desc**|**nvarchar(60)**|Representação textual do algoritmo de criptografia. É NULLABLE. Valores possíveis:<br /><br /> **Descrição:** Nenhum<br /><br /> **Opção de DDL:** Desabilitado<br /><br /> **Descrição:** RC4<br /><br /> **Opção de DDL:** {necessárias &#124; algoritmo RC4 obrigatório}<br /><br /> **Descrição:** AES<br /><br /> **Opção de DDL:** Algoritmo AES obrigatório<br /><br /> **Descrição:** NONE, RC4<br /><br /> **Opção de DDL:** {com suporte &#124; suporte para o algoritmo RC4}<br /><br /> **Descrição:** NONE, AES<br /><br /> **Opção de DDL:** Com suporte do algoritmo RC4<br /><br /> **Descrição:** RC4, AES<br /><br /> **Opção de DDL:** Algoritmo RC4 obrigatório AES<br /><br /> **Descrição:** AES, RC4<br /><br /> **Opção de DDL:** Necessário algoritmo AES RC4<br /><br /> **Descrição:** NONE, RC4, AES<br /><br /> **Opção de DDL:** Suporte para o algoritmo RC4 AES<br /><br /> **Descrição:** NONE, AES, RC4<br /><br /> **Opção de DDL:** Com suporte do algoritmo AES RC4|  
...
## <a name="physical-joins"></a>Junções físicas  
 ![JOIN para sys.join_dm_db_mirroring_connections](../../relational-databases/system-dynamic-management-views/media/join-dm-db-mirroring-connections.gif "join para sys.join_dm_db_mirroring_connections")  
