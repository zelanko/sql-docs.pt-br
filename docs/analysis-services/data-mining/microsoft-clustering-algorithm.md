...
ms.topic: "article"
helpviewer_keywords: 
  - "algoritmos de segmentação [Analysis Services]"
  - "vizinho mais próximo [Mineração de Dados]"
  - "clustering [Mineração de Dados]"
  - "clusters [Analysis Services]"
  - "relações [Analysis Services], grupos"
  - "algoritmos [mineração de dados]"
  - "algoritmos de classificação [Analysis Services]"
  - "conjuntos de dados [Analysis Services]"
  - "algoritmos de clustering [Analysis Services]"
...
# Algoritmo Microsoft Clustering
  O algoritmo [!INCLUDE[msCoName](../../includes/msconame-md.md)] Clustering é um algoritmo de *segmentação* ou *clustering* que itera em casos em um conjunto de dados para agrupá-los em clusters que contêm características semelhantes. Esses agrupamentos são úteis para explorar dados, identificando anomalias nos dados e criar previsões.  
 ...
 ![Padrão clusterizado de tendências de comutador](../../analysis-services/data-mining/media/clustering-example.gif "Padrão clusterizado de tendências de comutador")  
...
## Como o algoritmo funciona  
 ...
 ![Dispersão de casos em um conjunto de dados](../../analysis-services/data-mining/media/clustering-plot.png "Dispersão de casos em um conjunto de dados")  
