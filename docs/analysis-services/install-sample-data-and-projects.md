...
## <a name="step-1-install-prerequisites"></a>Etapa 1: Pré-requisitos de instalação 
...
-   SQL Server Analysis Services (SSAS) 
    ...
    O Analysis Services está disponível apenas nestas edições: Evaluation, Enterprise, Business Intelligence, Standard. Não há suporte para modelos multidimensionais no Azure Analysis Services.
...
## <a name="step-2-download-and-install-developer-and-management-tools"></a>Etapa 2: Baixar e instalar o desenvolvedor e ferramentas de gerenciamento
SQL Server Data Tools (SSDT) para o Visual Studio é baixado e instalado separadamente de outros recursos do SQL Server. Os designers e os modelos de projeto usados para criar relatórios e modelos de BI são incluídos no SSDT para Visual Studio 2015 ou como [pacotes do Nuget](https://marketplace.visualstudio.com/items?itemName=ProBITools.MicrosoftAnalysisServicesModelingProjects) para 2017 do Visual Studio.  
...
## <a name="step-3-install-databases"></a>Etapa 3: Bancos de dados de instalação  
Um modelo multidimensional do Analysis Services usa dados transacionais que você importa de um RDBMS. Para os fins deste tutorial, você pode usar o banco de dados relacional como sua fonte de dados.  
  
-   **AdventureWorksDW2012 ou posterior** – este é um data warehouse relacional que é executado em uma instância do mecanismo de banco de dados. Ele fornece os dados originais usados por bancos de dados do Analysis Services e projetos que você criar e implantar ao longo do tutorial. O tutorial presume que você está usando AdventureWorksDW2012, no entanto, em versões posteriores funcionar.
...
## <a name="step-5-install-projects"></a>Etapa 5: Projetos de instalação  
...
1.  Baixe o [adventure-works-multidimensional-tutorial-projects.zip](https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks-analysis-services) da Adventure Works para a página de exemplos do Analysis Services no GitHub.  
    ...
    Os projetos de tutorial funcionam para [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] e posterior.  
...
6.  Implante a solução para verificar se as permissões de banco de dados e informações de localização de servidor são a instalação corretamente.  
