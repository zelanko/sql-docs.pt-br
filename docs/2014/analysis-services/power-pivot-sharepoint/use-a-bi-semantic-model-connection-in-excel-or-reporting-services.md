...
##  <a name="connect-from-excel"></a><a name="bkmk_connect"></a> Conecte do Excel  
...
##  <a name="connect-from-reporting-services-in-sharepoint"></a><a name="bkmk_use"></a> Conectar do Reporting Services no SharePoint  
