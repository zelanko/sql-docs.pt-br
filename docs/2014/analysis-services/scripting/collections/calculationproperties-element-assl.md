...
ms.locfileid: "48113536"
---
# <a name="calculationproperties-element-assl"></a>Elemento CalculationProperties (ASSL)
  Contém a coleção de [CalculationProperty](../objects/calculationproperty-element-assl.md) elementos associados a um [MdxScript](../objects/mdxscript-element-assl.md) elemento.  
...
|Elementos filho|[CalculationProperty](../objects/calculationproperty-element-assl.md)|  
