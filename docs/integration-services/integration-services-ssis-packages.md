...
ms.topic: "article"
helpviewer_keywords: 
  - "Pacotes do SQL Server Integration Services, sobre pacotes"
  - "pacotes [Integration Services], sobre pacotes"
  - "pacotes do SSIS, sobre pacotes"
  - "pacotes do SSIS"
  - "pacotes do SQL Server Integration Services"
  - "contêineres [Integration Services], pacotes"
  - "pacotes [Integration Services]"
  - "Pacotes do Integration Services, sobre pacotes"
...
-   [Assistente de Importação e Exportação do SQL Server](SQL%20Server%20Import%20and%20Export%20Wizard.md)  
