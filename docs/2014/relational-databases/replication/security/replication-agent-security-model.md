...
|Distribution Agent para assinaturas push|**\<\<\<Publicador>-PublicationDatabase>-publicação>-Subscriber>\<-inteiro>1 \<** <sup></sup>|  
|Distribution Agent para assinaturas pull|**\<\<\<\<Publicador>-PublicationDatabase>-publicação>-Subscriber>-SubscriptionDatabase>\<-GUID>2 \<** <sup></sup>|  
