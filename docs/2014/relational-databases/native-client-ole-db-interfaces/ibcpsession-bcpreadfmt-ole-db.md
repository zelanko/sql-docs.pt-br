...
## <a name="remarks"></a>Remarks  
 ...
 O `BCP_OPTION_DELAYREADFMT` valor o *eOption* parâmetro [ibcpsession:: Bcpcontrol](ibcpsession-bcpcontrol-ole-db.md) modifica o comportamento de ibcpsession:: Bcpreadfmt.  
