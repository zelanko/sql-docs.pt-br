...
2.  Adicione uma referência a `Microsoft.SqlServer.ManagedDTS` e adicione um `Imports` ou `using` instrução ao arquivo de código para o **Runtime** namespace.  
