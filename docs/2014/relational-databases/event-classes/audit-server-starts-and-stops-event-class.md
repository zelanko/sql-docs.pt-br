...
# <a name="audit-server-starts-and-stops-event-class"></a>Classe de evento Audit Server Starts and Stops
  A classe de evento **Audit Server Starts and** stops [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ocorre quando o estado do serviço é modificado.  
