...
|**Network**|Os valores válidos são **dbnmpntw** (pipes nomeados) e **dbmssocn** (TCP/IP).<br /><br /> Erro ao especificar um valor para o **rede** palavra-chave e um protocolo de prefixo no **Server** palavra-chave.|  
