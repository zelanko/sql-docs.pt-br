...
description: Saiba mais sobre o objeto Buffer Manager, que fornece contadores para monitorar a memória de páginas, contadores para monitorar a E/S física e extensões do pool de buffers.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
