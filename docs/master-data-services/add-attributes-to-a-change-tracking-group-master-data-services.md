...
ms.topic: "article"
helpviewer_keywords: 
  - "grupos de controle de alterações [Master Data Services]"
  - "atributos [Master Data Services], grupos de controle de alterações"
  - "grupos de controle de alterações [Master Data Services], adicionando atributos"
...
-   Os atributos devem existir para que possam ser adicionados ao grupo de controle de alterações. Para obter mais informações, consulte [Criar um atributo de texto &#40;Master Data Services&#41;](../master-data-services/create-a-text-attribute-master-data-services.md).  
  
### Para adicionar atributos a um grupo de controle de alterações  
