---
description: Suporte de streaming para parâmetros de saída de BLOB no SQL Server Native Client
title: Suporte de streaming para parâmetros de saída de BLOB (provedor de OLE DB de cliente nativo)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.openlocfilehash: 2655eb720298d356d9a9707a316c155e271fbb31
ms.sourcegitcommit: 1a544cf4dd2720b124c3697d1e62ae7741db757c
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 12/14/2020
ms.locfileid: "97439927"
---
# <a name="streaming-support-for-blob-output-parameters-in-sql-server-native-client"></a>Suporte de streaming para parâmetros de saída de BLOB no SQL Server Native Client
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 Você pode ser bloqueado em parâmetros de saída em IMultipleResults::GetResult, recebendo o valor de retorno DB_E_OBJECTOPEN. O chamador deve verificar se há parâmetros BLOB pendentes e lê-los completamente ou liberá-los.  
