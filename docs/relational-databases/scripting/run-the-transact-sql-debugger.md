...
ms.topic: "article"
helpviewer_keywords: 
  - "Depurador Transact-SQL, requisito de sysadmin"
  - "Depurador Transact-SQL, versões com suporte"
  - "Editor de Consultas [Mecanismo de Banco de Dados], menu de atalho"
  - "depuração [SQL Server], depurador T-SQL"
  - "Depurador Transact-SQL, o menu de atalho do Editor de Consultas"
  - "Depurador Transact-SQL, parando"
  - "Depurador Transact-SQL, menu Depurar"
  - "depurando [SQL Server]"
  - "Depurador Transact-SQL, barra de tarefas Depurar"
  - "Depurador Transact-SQL, atalhos de teclado"
  - "Depurador Transact-SQL, iniciando"
