...
ms.openlocfilehash: 2e4b031190f32ec3811f0541c0cc62b044240bad
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Cria um identificador de objeto para a conexão física que isso [SQLServerPooledConnection](../../../connect/jdbc/reference/sqlserverpooledconnection-class.md) objeto representa.  
