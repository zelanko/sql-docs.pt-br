...
Para obter informações detalhadas sobre o Conjunto de Campos Padrão, consulte [Configurar o conjunto de campos padrão para relatórios do Power View &#40;SSAS Tabular&#41;](../analysis-services/tabular-models/configure-default-field-set-for-power-view-reports-ssas-tabular.md) nos Manuais Online do SQL Server.  
...
Para obter informações detalhadas sobre as propriedades de Comportamento de Tabela, consulte [Configurar propriedades de Comportamento de Tabela de relatórios do Power View &#40;SSAS Tabular&#41;](../analysis-services/tabular-models/configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md) nos Manuais Online do SQL Server.  
...
Como você alterou o modelo, deverá reimplantá-lo. Basicamente, você repetirá as tarefas realizadas na [Lição 14: Implantar](../analysis-services/lesson-14-deploy.md).  
