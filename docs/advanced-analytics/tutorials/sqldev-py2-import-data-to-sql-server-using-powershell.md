...
2. O script solicita as seguintes informações:
    ...
    - Se você não fornecer o nome de usuário e senha, a identidade do Windows é usada para entrar no SQL Server.
