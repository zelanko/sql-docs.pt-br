...
1.  Alterne para o Designer do cubo do Tutorial do [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] e mude para a guia **Traduções**.  
    ...
    ![Na guia traduções do idioma padrão](../media/l9-translations-5.gif "na guia traduções do idioma padrão")  
...
5.  Na barra de ferramentas, selecione **Espanhol (Espanha)** na lista **Idioma** .  
    ...
    ![Painel de metadados Repopulated](../media/l9-translations-6.gif "Repopulated painel de metadados")  
...
9. No painel de metadados, clique com o botão direito do mouse em **Mes del Ano** e selecione **Adicionar à Consulta**.  
    ...
    ![Nomes de meses em espanhol no painel de dados](../media/l9-translations-7.gif "nomes de meses em espanhol no painel de dados")  
...
[Suporte a tradução no Analysis Services](../translation-support-in-analysis-services.md)  
