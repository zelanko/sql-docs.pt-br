---
title: Arquivo de texto de largura fixa | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81286316"
---
# <a name="fixed-width-text-file"></a>Arquivo de texto de largura fixa
Quando o driver texto é usado, a última coluna de um arquivo de texto de largura fixa pode ter comprimento variável.
