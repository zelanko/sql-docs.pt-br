...
ms.locfileid: "84293740"
---
# <a name="mapping-source-and-target-databases-accesstosql"></a>Mapeando bancos de dados de origem e de destino (AccessToSQL)
Ao se conectar ao [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ou SQL Azure, você precisa especificar um banco de dados de destino para migração. Se você tiver vários bancos de dados do Access, você poderá mapeá-los para vários [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] bancos de dados (ou esquemas) ou para vários esquemas no banco de dados SQL Azure conectado.  
...
O SSMA permite mapear cada banco de dados do Access para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ou SQL Azure banco de dados e esquema. O procedimento a seguir descreve como personalizar o mapeamento por banco de dados.  
...
Se você personalizar o mapeamento entre um banco de dados do Access e um [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] banco de dados do ou do SQL Azure e o esquema, poderá reverter o mapeamento de volta para o banco de dados que você especificou quando se conectou ao [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ou SQL Azure.  
