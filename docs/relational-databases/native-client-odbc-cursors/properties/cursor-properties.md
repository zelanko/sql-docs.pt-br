---
description: Propriedades do cursor
...
-   [Tamanho do conjunto de linhas de cursor](../../../relational-databases/native-client-odbc-cursors/properties/cursor-rowset-size.md)  
