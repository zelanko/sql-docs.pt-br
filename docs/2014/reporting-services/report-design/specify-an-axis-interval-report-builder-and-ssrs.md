...
2.  Em **opções de eixo**, defina `Interval` para **1**. Cada rótulo do grupo de categorias é exibido. Para mostrar cada rótulo de outro grupo de categorias no eixo x, digite **2**.  
...
2.  Em **opções de eixo**, defina `Interval` para **automática**. O gráfico exibirá o número ideal de rótulos de categorias que podem se ajustar ao longo do eixo.  
