...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Indica se os atributos em RelationshipEnd estão no lado "um" ou o lado "muitos" de uma relação.  
