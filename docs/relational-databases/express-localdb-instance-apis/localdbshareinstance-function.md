...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Compartilha a instância especificada do SQL Server Express LocalDB com outros usuários do computador, usando o nome compartilhado especificado.  
