...
description: Os UDTs, escritos em idiomas .NET Framework CLR, permitem que um banco de dados SQL Server armazene objetos e estruturas de dados personalizadas. Em ADO.NET, um provedor expõe UDTs.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
