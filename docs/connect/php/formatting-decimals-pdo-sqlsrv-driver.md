---
title: Formatar cadeia de caracteres decimais e valores monetários (driver PDO_SQLSRV)
description: Saiba como usar os atributos PDO::SQLSRV_ATTR_FORMAT_DECIMALS e SQLSRV_ATTR_DECIMAL_PLACES para formatar valores decimais e monetários ao usar o Driver PDO_SQLSRV
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
