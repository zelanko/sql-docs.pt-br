...
ms.topic: "article"
helpviewer_keywords: 
  - "recriando chaves de criptografia"
  - "chaves de criptografia [Reporting Services]"
  - "excluindo chaves de criptografia"
  - "chaves simétricas [Reporting Services]"
  - "removendo chaves de criptografia"
  - "redefinindo chaves de criptografia"
...
manager: "erikre"
---
# Excluir e recriar chaves de criptografia (Gerenciador de configura&#231;&#245;es do SSRS)
...
## Recriando chaves de criptografia  
 ...
 Você pode usar a ferramenta Configuração do Reporting Services ou o utilitário **rskeymgmt** para redefinir a chave simétrica e os dados criptografados. Para obter mais informações sobre como a chave simétrica é criada, consulte [Inicializar um servidor de relatório &#40;SSRS Configuration Manager&#41;](../../reporting-services/install-windows/initialize-a-report-server-ssrs-configuration-manager.md).  
  
### Como recriar chaves de criptografia (ferramenta Configuração do Reporting Services)  
...
### Como recriar chaves de criptografia (rskeymgmt)  
...
## Excluindo conteúdo criptografado inutilizável  
...
### Como excluir chaves de criptografia (ferramenta Configuração do Reporting Services)  
...
### Como excluir chaves de criptografia (rskeymmgt)  
...
### Como especificar novamente valores criptografados  
