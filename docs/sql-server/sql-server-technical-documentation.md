...
+ Para exibir a documentação do SQL Server offline, consulte [Visualizador da ajuda e conteúdo offline para o SQL Server](../release-notes/sql-server-help-installation.md).
