...
description: Saiba mais sobre os tipos de assinaturas na Replicação do SQL Server, como escolher o tipo de que você precisa e como criar uma assinatura.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
