---
description: 'Conexão (Visual C++ índice de sintaxe com #import)'
title: 'Conexão (Visual C++ índice de sintaxe com #import) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "88974857"
---
# <a name="connection-visual-c-syntax-index-with-import"></a>Conexão (Visual C++ índice de sintaxe com #import)
