...
|**incremento**|**sql_variant não NULL**|O valor usado para incrementar o objeto de sequência depois de cada valor gerado.|  
...
|**escala**|**tinyint não NULL**|A escala máxima do tipo de dados. A escala é retornada junto com a precisão para dar metadados completos aos usuários. A escala é sempre 0 para objetos de sequência porque apenas tipos inteiros são permitidos.|  
