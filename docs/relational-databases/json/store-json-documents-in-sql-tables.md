...
description: Este artigo descreve por que e como armazenar e indexar documentos JSON no SQL Server ou no Banco de Dados SQL e como otimizar consultas nos documentos JSON.
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
