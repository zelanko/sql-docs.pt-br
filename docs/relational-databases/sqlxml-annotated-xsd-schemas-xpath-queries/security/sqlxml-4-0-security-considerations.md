---
title: "Considerações sobre o SQLXML 4.0 segurança | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
ms.openlocfilehash: 311d5a3ff6cd5c23a3225985944facb0dbde0027
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Esta seção fornece informações sobre considerações relacionadas à segurança do [!INCLUDE[msCoName](../../../includes/msconame-md.md)] SQLXML.  
  
## <a name="in-this-section"></a>Nesta seção  
 [Principais considerações de segurança do SQLXML](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/security/core-sqlxml-security-considerations.md)  
 ...
 [Considerações de segurança de carregamento em massa &#40; SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/security/bulk-load-security-considerations-sqlxml-4-0.md)  
