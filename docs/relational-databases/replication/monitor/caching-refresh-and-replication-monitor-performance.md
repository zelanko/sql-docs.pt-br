...
helpviewer_keywords: 
  ...
  - "cache [SQL Server], replicação"
  - "Replication Monitor, cache"
  - "atualizando dados"
  - "Replication Monitor, atualizando"
...
-   Todas as janelas podem ser atualizadas manualmente pressionando F5 ou clicando duas vezes um nó na árvore do Replication Monitor e clicando em **atualizar**. Atualizações manuais forçam uma atualização do cache.  
