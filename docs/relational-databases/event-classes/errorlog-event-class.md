...
ms.openlocfilehash: 078a6a02b344323df2786b97ab38f541cc465369
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento ErrorLog indica que foram registradas mensagens no log de erros do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
