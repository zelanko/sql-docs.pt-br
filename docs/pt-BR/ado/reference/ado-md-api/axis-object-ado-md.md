---
title: O objeto de eixo (ADO MD) | Microsoft Docs
ms.prod: sql
...
-   Iterar por cada posição ao longo de um **eixo** usando o [posições](../../../ado/reference/ado-md-api/positions-collection-ado-md.md) coleção.  
  
-   Obter o número de dimensões no **eixo** com o [DimensionCount](../../../ado/reference/ado-md-api/dimensioncount-property-ado-md.md) propriedade.  
  
-   Obter atributos específicos do provedor do **eixo** com ADO padrão [propriedades](../../../ado/reference/ado-api/properties-collection-ado.md) coleção.  
