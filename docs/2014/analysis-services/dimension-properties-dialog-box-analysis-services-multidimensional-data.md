...
|**Modo de processamento**|Selecione o modo de processamento a ser usado para a dimensão. Para obter mais informações sobre os valores para essa propriedade, consulte <xref:Microsoft.AnalysisServices.Dimension.ProcessingMode%2A>.|  
|**Estado**|Exibe o estado do processamento da dimensão. Para obter mais informações sobre os valores para essa propriedade, consulte <xref:Microsoft.AnalysisServices.ProcessableMajorObject.State%2A>.|  
|**Último processamento**|Exibe a data e a hora do último processamento da dimensão.|  
|**Modo de armazenamento atual**|Exibe o modo de armazenamento atual para a dimensão. Para obter mais informações sobre os valores para essa propriedade, consulte <xref:Microsoft.AnalysisServices.Dimension.CurrentStorageMode%2A>.|  
