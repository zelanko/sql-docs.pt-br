...
|Nome do controle|DESCRIÇÃO|  
|------------------|-----------------|  
|**Nome de usuário**|Especifique uma conta de usuário de domínio para ser o administrador do sistema do [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]. Para todos [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] os aplicativos da Web associados a esse banco de dados, esse usuário pode atualizar todos os modelos e todos eles em todas as áreas funcionais. Para obter mais informações, veja [Administradores &#40;Master Data Services&#41;](administrators-master-data-services.md).|  
