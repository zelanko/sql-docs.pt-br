---
description: Gerenciar um serviço CDC
 ...
 **Criar uma nova instância CDC para o serviço selecionado**  
 ...
 Clique em **New Oracle CDC Instance** no painel direito para criar uma nova instância para esse serviço. O assistente New Instance abre para criar a instância. Para obter mais informações sobre o assistente para nova instância, consulte [Use the New Instance Wizard](../../integration-services/change-data-capture/use-the-new-instance-wizard.md).  
