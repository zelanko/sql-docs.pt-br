...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, instalação"
  - "SSIS, instalação"
  - "Instalação do Integration Services, sobre a instalação do Integration Services"
  - "SQL Server Integration Services, instalação"
  - "Instalação [Integration Services], sobre a instalação do Integration Services"
  - "instalando o Integration Services"
  - "Instalação [Integration Services]"
...
## Preparando para instalar o Integration Services    
...
## Selecionando uma configuração do Integration Services    
...
>     
>  Para obter instruções sobre como conceder permissões, consulte [Grant Permissions to Integration Services Service](../../integration-services/service/grant-permissions-to-integration-services-service.md).    
...
## Compreendendo o serviço Integration Services    
