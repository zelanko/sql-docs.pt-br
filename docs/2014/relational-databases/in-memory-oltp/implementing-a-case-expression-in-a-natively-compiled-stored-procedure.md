...
# <a name="implementing-a-case-statement"></a>Implementando uma instrução CASE
 ...
 Os exemplos usam uma variável de tabela para criar um único conjunto de resultados, que só é adequado ao processar um número limitado de linhas, pois ele envolve a criação de uma cópia adicional das linhas de dados.  
