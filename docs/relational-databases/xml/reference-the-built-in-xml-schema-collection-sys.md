...
description: Saiba como fazer referência ao sys interno da coleção de esquemas XML que é predefinido para cada banco de dados que você cria.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
