...
|Autenticação: Quem é você?|Autorização: O que você pode fazer?|Criptografia: Armazenando dados secretos|Segurança de Conexão: Restringir e proteger|Auditoria do: Acesso de gravação|  
|----------------------------------|-------------------------------------|-------------------------------------|---------------------------------------------------|--------------------------------|  
