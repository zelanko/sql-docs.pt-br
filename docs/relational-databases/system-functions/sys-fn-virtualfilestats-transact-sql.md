...
|**Carimbo de hora**|**bigint**|Carimbo de data/hora do banco de dados do qual os dados foram obtidos. **int** nas versões anteriores [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)]. |  
