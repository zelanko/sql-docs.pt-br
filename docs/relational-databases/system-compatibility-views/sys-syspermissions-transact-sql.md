...
|**usuário autorizado**|**smallint**|ID do usuário, grupo ou função afetada pela permissão.|  
|**concessor**|**smallint**|ID do usuário, grupo ou função que concedeu ou negou a permissão.|  
