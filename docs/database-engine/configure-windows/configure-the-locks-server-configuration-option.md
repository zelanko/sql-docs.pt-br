...
description: Saiba mais sobre a opção locks. Veja como usá-la para limitar a quantidade de memória que o Mecanismo de Banco de Dados do SQL Server usa para bloqueios.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
