...
description: Saiba mais sobre o tipo de conexão do SQL Server e a inclusão de dados de um banco de dados do SQL Server em seu relatório.
ms.date: 08/17/2018
