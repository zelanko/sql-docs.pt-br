...
## <a name="return-value"></a>Valor retornado  
 Uma **String** que contém a lista de funções do sistema.  
  
## <a name="exceptions"></a>Exceções  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentários  
 Esse método getSystemFunctions é especificado pelo método getSystemFunctions na interface java.sql.DatabaseMetaData.  
