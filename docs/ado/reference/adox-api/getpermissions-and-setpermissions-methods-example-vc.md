---
description: Exemplo dos métodos GetPermissions e SetPermissions (VC++)
title: Exemplo dos métodos getPermissions e SetPermissions (VC + +) | Microsoft Docs
ms.prod: sql
