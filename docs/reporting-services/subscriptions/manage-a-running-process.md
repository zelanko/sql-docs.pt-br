...
description: Saiba como gerenciar um processo em execução, como um trabalho do usuário ou do sistema. É possível exibir, cancelar ou gerenciar um trabalho programaticamente.
ms.date: 03/20/2017
