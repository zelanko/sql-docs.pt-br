...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento ExistingConnection indica as propriedades de conexões de usuário existentes quando o rastreamento foi iniciado. O servidor gera um evento ExistingConnection por conexão de usuário existente.  
