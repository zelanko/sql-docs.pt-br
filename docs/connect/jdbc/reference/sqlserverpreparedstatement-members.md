...
|[getMoreResults](../../../connect/jdbc/reference/getmoreresults-method-sqlserverstatement.md)|(Herdado de SQLServerStatement.) Move para o próximo resultado desse objeto de instrução.|  
