...
-   [!INCLUDE[ssSQL15](../../includes/sssqlv14-md.md)]Atualização cumulativa 1 e posterior. Consulte- [SQL Server atualizações cumulativas 2017](https://aka.ms/sql2017cu).
