---
title: "Filtros cruzados bidirecionais para modelos de tabela no Analysis Services para SQL Server 2016 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
---
# Filtros cruzados bidirecionais para modelos de tabela no Analysis Services para SQL Server 2016
 ...
 No SSDT, a mecânica de configuração de um filtro cruzado ocorre através da opção de Direção do filtro, na caixa de diálogo Relações da tabela. Este recurso está disponível apenas para modelos de tabela criados no nível de compatibilidade 1200, no [SQL Server Data Tools (SSDT) para Visual Studio 2015](http://go.microsoft.com/fwlink/p/?LinkID=627574).  
...
4.  Verifique se o nível de compatibilidade do modelo está definido como **SQL Server 2016 RTM (1200)**.  
...
### Revisar as relações de tabela padrão  
...
## Consulte também  
 ...
 [Um exemplo prático de como tratar relações de muitos para muitos simples em modelos de tabela do Power Pivot e do SSAS](http://social.technet.microsoft.com/wiki/contents/articles/22202.a-practical-example-of-how-to-handle-simple-many-to-many-relationships-in-power-pivotssas-tabular-models.aspx)   
