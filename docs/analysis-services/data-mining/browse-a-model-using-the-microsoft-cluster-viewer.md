...
helpviewer_keywords: 
  ...
  - "nomes [Analysis Services], clusters"
  - "Visualizador de cluster da Microsoft"
  - "conteúdo do modelo de mineração, exibindo"
  - "comparando clusters"
  - "exibindo clusters"
  - "exibindo clusters"
  - "mineração de dados [Analysis Services], clusters"
  - "Visualizador de cluster [Analysis Services]"
  - "modelos de mineração [Analysis Services], clusters"
