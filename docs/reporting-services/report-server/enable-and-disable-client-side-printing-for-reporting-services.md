...
description: Saiba como habilitar ou desabilitar a impressão do lado do cliente para relatórios do Reporting Services exibidos em um navegador. A impressão do lado do cliente usa PDF e é habilitada por padrão.
ms.date: 05/30/2017
