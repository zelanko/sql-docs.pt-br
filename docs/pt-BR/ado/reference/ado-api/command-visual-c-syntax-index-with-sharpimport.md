---
title: 'Comando (Visual C++ sintaxe índice com #import) | Microsoft Docs'
ms.prod: sql
...
---
# <a name="command-visual-c-syntax-index-with-import"></a>Comando (Visual C++ sintaxe índice com #import)
