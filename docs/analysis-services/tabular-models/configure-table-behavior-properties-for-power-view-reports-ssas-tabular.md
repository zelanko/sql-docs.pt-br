...
### Estão faltando uma ou mais linhas nas tabelas  
 ...
 ![O grupo padrão consolida 2 em 1](../../analysis-services/tabular-models/media/ssas-jonyang-norowid.gif "O grupo padrão consolida 2 em 1")  
 ...
 ![Dados de linha contendo duplicatas baseadas na ID da linha](../../analysis-services/tabular-models/media/ssas-jonyang.gif "Dados de linha contendo duplicatas baseadas na ID da linha")  
 ...
 **Antes: agrupamento padrão com base em campos em um gráfico**  
 ...
 ![Gráfico baseado em agrupamento padrão em nível de campo](../../analysis-services/tabular-models/media/ssas-rptprop-chartfieldgroup.gif "Gráfico baseado em agrupamento padrão em nível de campo")  
  
 **Depois: agrupamento em identificador de linha (o identificador de linha torna-se o eixo)**  
  
 ![Gráfico baseado em agrupamento de IDs de linha](../../analysis-services/tabular-models/media/ssas-rptprop-chartrowid.gif "Gráfico baseado em agrupamento de IDs de linha")  
