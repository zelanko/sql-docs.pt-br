...
ms.topic: "article"
helpviewer_keywords: 
  - "cadeia de caracteres de conexão [Mecanismo de Banco de Dados]"
  - "portas [SQL Server], conectando a"
  - "TCP/IP [SQL Server], cadeias de conexão"
  - "cadeia de caracteres de conexão [Mecanismo de Banco de Dados], TCP/IP"
