...
|**0x1000**|Replica ordenação em nível de coluna.<br /><br /> **Observação:** Essa opção deve ser definida para Publicadores Oracle para habilitar comparações entre letras maiúsculas e minúsculas.|  
