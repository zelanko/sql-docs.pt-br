...
description: Examine as informações de visão geral e os links para informações adicionais sobre estratégias de backup e restauração para cada tipo de replicação do SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
