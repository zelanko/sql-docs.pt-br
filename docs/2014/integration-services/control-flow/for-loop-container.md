...
-   Uma expressão de iteração opcional que incrementa ou diminui o contador de loop.  
 ...
 ![Um contêiner do Loop For repete uma tarefa quatro vezes](../media/ssis-forloop.gif "Um contêiner do Loop For repete uma tarefa quatro vezes")  
