---
title: "Fazer backup e restaurar bancos de dados do SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "07/29/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "recuperação de desastres [SQL Server] consulte restaurando [SQL Server]"
  - "backups [SQL Server]"
  - "restaurando bancos de dados [SQL Server]"
  - "backup [SQL Server] consulte fazendo backup [SQL Server]"
  - "bancos de dados [SQL Server], restaurando"
  - "fazendo backup de bancos de dados [SQL Server]"
  - "restaurar [SQL Server] consulte restaurando [SQL Server]"
  - "recuperação de desastres [SQL Server] consulte fazendo backup [SQL Server]"
  - "fazendo backup [SQL Server]"
  - "Mecanismo de Banco de Dados [SQL Server], backups"
  - "bancos de dados [SQL Server], backups"
...
-   O backup dos bancos de dados do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], a execução de procedimentos de restauração de teste nos backups e o armazenamento de cópias de backups em um local externo seguro evita a perda de dados potencialmente catastrófica. **O backup é a única maneira de proteger seus dados.**
...
>  Para obter informações sobre restrições de simultaneidade durante o backup, consulte [Visão geral de backup &#40;SQL Server&#41;](../../relational-databases/backup-restore/backup-overview-sql-server.md).  
