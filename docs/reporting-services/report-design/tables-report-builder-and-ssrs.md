...
description: Exiba dados de detalhes ou dados agrupados usando um campo ou vários campos ou escrevendo sua expressão em um relatório paginado no Construtor de Relatórios.
ms.date: 03/07/2017
...
##  <a name="removing-or-hiding-detail-rows"></a><a name="RemovingHidingRows"></a> Removendo ou ocultando linhas detalhadas  
 ...
 ![Modo de exibição de Design, tabela com dois grupos, sem detalhes](../../reporting-services/report-design/media/rs-basictablegroupsdrilldownnodetailsdesign.gif "Modo de exibição de Design, tabela com dois grupos, sem detalhes")  
