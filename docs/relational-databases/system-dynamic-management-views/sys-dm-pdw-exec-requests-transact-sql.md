...
|session_id|**nvarchar(32)**|Id numérico exclusivo associado à sessão em que essa consulta foi executada. See [sys.dm_pdw_exec_sessions &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-exec-sessions-transact-sql.md).||  
