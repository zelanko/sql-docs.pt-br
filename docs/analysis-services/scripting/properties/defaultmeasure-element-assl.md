...
|Relação|Elemento|  
|------------------|-------------|  
|Elemento pai|[Cube](../../../analysis-services/scripting/objects/cube-element-assl.md), [Perspective](../../../analysis-services/scripting/objects/perspective-element-assl.md)|  
