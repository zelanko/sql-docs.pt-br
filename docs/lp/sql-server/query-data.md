...
layout: HubPage
hide_bc: true
title: SQL Server – consultar dados
description: Explore os recursos que tornam fácil consultar os dados no banco de dados do SQL Server.
ms.topic: hub-page
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: consultar dados</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cursores</h3>
                                                    <p> Permite o processamento de um conjunto de resultados uma linha por vez </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pesquisa de Texto Completo</h3>
                                                    <p>Os índices de texto completo incluem uma ou mais colunas com base em caractere em uma tabela e a pesquisa de texto completo permite que você os consulte.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Junções</h3>
                                                    <p>Explora as operações de classificação, interseção e união diferentes executadas pelo SQL Server ao usar junções. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Script</h3>
                                                    <p>Explora as várias linguagens de script compatíveis com o SQL Server, como o Powershell e o xQuery. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Subconsultas</h3>
                                                    <p> Uma subconsulta é uma consulta aninhada em uma instrução SELECT, INSERT, UPDATE ou DELETE, ou em subconsulta. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sinônimos</h3>
                                                    <p>Um objeto de banco de dados que fornece uma camada de abstração para proteger o aplicativo do cliente contra alterações no nome ou na localização de um objeto base. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Funções definidas pelo usuário</h3> 
                                                    <p>Rotinas que aceitam parâmetros, executam uma ação e retornam o resultado de uma ação como um valor. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Design de banco de dados</h3>
