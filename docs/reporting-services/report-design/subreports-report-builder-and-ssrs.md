---
title: Sub-relatórios (Construtor de Relatórios) | Microsoft Docs
description: Exiba um relatório dentro do outro. Exiba e armazene-os na mesma pasta do servidor no Construtor de Relatórios.
ms.date: 03/07/2017
