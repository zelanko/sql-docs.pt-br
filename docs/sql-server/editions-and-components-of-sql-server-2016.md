...
---
# <a name="editions-and-components-of-sql-server-2016"></a>Edições e componentes do SQL Server 2016
> Para obter detalhes dos recursos com suporte pelas edições diferentes do SQL Server 2016, consulte [Edições e Recursos com suporte para SQL Server 2016](../sql-server/editions-and-supported-features-for-sql-server-2016.md).
...
## <a name="includesscurrentincludessscurrent-mdmd-editions"></a>[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Edições  
