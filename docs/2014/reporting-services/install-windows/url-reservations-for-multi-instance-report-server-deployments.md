---
title: Reservas de URL para várias instâncias (Gerenciador de configuração do SSRS) de implantações de servidor de relatório | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
