...
description: Saiba como dados grandes podem ser associados ou recuperados usando a interface ISequentialStream no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="example"></a>Exemplo  
 ...
 A primeira listagem de código ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) cria uma tabela usada pela amostra.  
