---
title: "Contadores de desempenho para o objeto de desempenho do servi&#231;o do Windows MSRS 2011 e o Servi&#231;o Web MSRS 2011 (modo nativo) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
##  <a name="bkmk_powershell"></a> Use cmdlets do PowerShell para retornar listas  
 ![Conteúdo relacionado ao PowerShell](../../analysis-services/instances/install-windows/media/rs-powershellicon.png "Conteúdo relacionado ao PowerShell")O script do Windows PowerShell a seguir retorna os conjuntos de contador onde o CounterSetName começa com “msr”:  
