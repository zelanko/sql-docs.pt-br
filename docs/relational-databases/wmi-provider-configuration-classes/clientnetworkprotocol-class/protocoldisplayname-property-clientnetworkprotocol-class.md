---
description: Propriedade ProtocolDisplayName (classe ClientNetworkProtocol)
...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  Obtém o nome de exibição do protocolo de rede do cliente especificado por [Configurar protocolos de cliente](../../../database-engine/configure-windows/configure-client-protocols.md).  
