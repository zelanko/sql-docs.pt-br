---
title: "Editor de transformação de cache (página mapeamentos) | Microsoft Docs"
ms.custom: 
ms.date: 03/01/2017
...
>  Cada coluna de entrada deve ser mapeada para uma coluna de destino e os tipos de dados de coluna devem corresponder. Caso contrário, o Designer [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] exibirá uma mensagem de erro.  
 ...
 Para obter mais informações sobre a Transformação Cache, consulte [Cache Transform](../../../integration-services/data-flow/transformations/cache-transform.md).  
