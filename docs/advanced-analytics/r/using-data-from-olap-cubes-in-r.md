...
Para obter exemplos de como criar uma consulta MDX ou executar uma consulta MDX existente, confira [Como criar consultas MDX usando o R](../../advanced-analytics/r/how-to-create-mdx-queries-using-olapr.md).
