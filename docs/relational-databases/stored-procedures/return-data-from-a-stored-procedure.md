...
description: Saiba como retornar dados de um procedimento para um programa de chamada usando conjuntos de resultados, parâmetros de saída e códigos de retorno.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
