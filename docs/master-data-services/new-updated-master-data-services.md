---
title: Atualizado - Master Data Services para documentos do SQL Server | Microsoft Docs
description: "Trechos de código de exibição de conteúdo atualizado para alterados recentemente na documentação, para MDS Master Data Services () para o Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# <a name="new-and-recently-updated-master-data-services-for-sql-server"></a>Novos e atualizados recentemente: Master Data Services para SQL Server
...
- *Área de assunto:* &nbsp; **MDS Master Data Services () para o SQL Server**.
...
1. [Instalando o Master Data Services em um ambiente AlwaysOn](installing-mds-in-an-alwayson-group-environment/installing-mds-in-an-alwayson-group-environment.md)
