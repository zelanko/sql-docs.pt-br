...
helpviewer_keywords: 
  ...
  - "processamento de relatório [Reporting Services], armazenamento em cache"
  - "instâncias em cache [Reporting Services]"
  - "atualizando cache"
  - "relatórios em cache [Reporting Services]"
  - "pré-carregando o cache"
  - "relatórios inválidos em cache [Reporting Services]"
  - "desempenho [Reporting Services]"
  - "expiração [Reporting Services]"
  - "instantâneos [Reporting Services], armazenamento em cache"
...
## Consulte também  
 ...
 [Opções de atualização do cache &#40;Gerenciador de Relatórios&#41;](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)  
