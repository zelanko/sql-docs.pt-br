...
description: Um aplicativo ODBC pode executar instruções em uma instância de SQL Server inicializando um identificador de conexão e conectando-se a uma fonte de dados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
