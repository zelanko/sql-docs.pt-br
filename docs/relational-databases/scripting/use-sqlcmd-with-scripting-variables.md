...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "scripts [SQL Server], utilitário sqlcmd"
  - "variáveis [SQL Server], scripts"
  - "variáveis de script [SQL Server]"
  - "utilitário sqlcmd, scripts"
  - "comando setvar"
...
### D. Usando variáveis de ambiente em nível de usuário no sqlcmd  
