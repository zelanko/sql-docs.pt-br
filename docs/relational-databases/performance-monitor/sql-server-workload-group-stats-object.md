...
description: Saiba mais sobre o objeto SQLServer:Workload Group Stats, que contém contadores de desempenho que relatam as estatísticas do grupo de carga de trabalho do Resource Governor.
ms.custom: ''
ms.date: 12/04/2015
ms.prod: sql
