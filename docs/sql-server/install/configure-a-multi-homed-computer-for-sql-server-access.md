...
ms.topic: "article"
helpviewer_keywords: 
  - "portas [SQL Server], computador multihomed"
  - "configurando portas de computador multihomed [SQL Server]"
  - "sistemas de firewall [Mecanismo de Banco de Dados], computador multihomed"
...
---
# Configurar um computador multihomed para acesso ao SQL Server
...
#### Para determinar os endereços IP no computador.  
...
#### Para determinar os endereços IP e as portas usadas pelo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
