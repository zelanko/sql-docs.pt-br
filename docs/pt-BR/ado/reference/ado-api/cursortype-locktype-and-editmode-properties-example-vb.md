---
title: CursorType e LockType EditMode propriedades exemplo (VB) | Microsoft Docs
ms.prod: sql
...
---
# <a name="cursortype-locktype-and-editmode-properties-example-vb"></a>Exemplo de propriedades EditMode (VB), CursorType e LockType
