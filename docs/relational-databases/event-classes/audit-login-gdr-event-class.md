...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Login GDR** ocorre sempre que um direito de logon do [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows é adicionado ou removido. Essa classe de evento refere-se aos procedimentos armazenados **sp_grantlogin**, **sp_revokelogin**e **sp_denylogin** .  
