...
### <a name="calendars"></a>Calendários  
 ...
 Os aplicativos de business intelligence frequentemente requerem várias definições de calendário. Por exemplo, o departamento de recursos humanos pode monitorar os funcionários usando um *standard* um calendário de doze meses calendário gregoriano começando em 1º de janeiro e terminando em 31 de dezembro. No entanto, o mesmo departamento de recursos humanos pode monitorar despesas usando um *fiscal* calendário um calendário de doze meses que estabelece o ano fiscal usado pela organização.  
...
|Calendário fiscal|Um calendário fiscal de doze meses. Ao selecionar esse calendário, especifique o dia e o mês iniciais para o ano fiscal usado pela empresa.<br /><br /> Observação: Esse calendário só estará disponível se você usar o Assistente para dimensões para criar uma dimensão de tempo do servidor.|  
|Calendário de relatório (ou calendário comercial)|Um calendário de relatório de doze meses que inclui dois meses de quatro semanas e um mês de cinco semanas em um padrão repetitivo de três meses (trimestral). Quando você seleciona esse calendário, especifique o dia e mês iniciais e o padrão de três meses de 4-4-5, 4-5 – 4 ou 5 – 4 – 4 semanas, sendo que cada dígito representa o número de semanas do mês.<br /><br /> Observação: Esse calendário só estará disponível se você usar o Assistente para dimensões para criar uma dimensão de tempo do servidor.|  
