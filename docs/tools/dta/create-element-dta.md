...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contém informações sobre os índices, as estatísticas ou as estruturas de heap em uma configuração especificada pelo usuário.  
