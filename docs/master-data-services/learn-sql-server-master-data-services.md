...
description: Explore recursos e funcionalidades do SQL Server 2019 Master Data Services por meio de treinamento individualizado, vídeos, exemplos e certificação de SQL Server.
ms.custom: ''
ms.date: 02/14/2017
ms.prod: sql
ms.prod_service: mds
...
* [A Microsoft Adora Aprender sobre o Blog (Comunidade de Treinamento e Certificação)](https://microsoft.com/learning/community.aspx)  
