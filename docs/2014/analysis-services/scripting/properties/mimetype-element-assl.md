...
ms.locfileid: "37254798"
---
# <a name="mimetype-element-assl"></a>Elemento MimeType (ASSL)
  Contém o tipo de email extensões MIME (Multipurpose Internet), se aplicável, dos dados representados pelo [DataItem](../data-type/dataitem-data-type-assl.md) elemento.  
...
## <a name="see-also"></a>Consulte também  
 [Tipo de dados DataItem &#40;ASSL&#41;](../data-type/dataitem-data-type-assl.md)  
