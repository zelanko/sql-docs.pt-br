...
description: O Driver do OLE DB para SQL Server dá suporte a operações de bancos de dados assíncronas, o que permite que os métodos sejam executados sem bloqueio no thread de chamada.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
