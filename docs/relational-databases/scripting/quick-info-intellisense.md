...
ms.topic: "article"
helpviewer_keywords: 
  - "Opção de Informações Rápidas [IntelliSense]"
  - "declarações [IntelliSense]"
  - "IntelliSense [SQL Server], Informações Rápidas"
  - "declarações de identificador [IntelliSense]"
...
---
# Informa&#231;&#245;es r&#225;pidas (IntelliSense)
...
## Informações Rápidas do Transact-SQL  
