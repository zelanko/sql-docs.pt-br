...
ms.topic: "article"
helpviewer_keywords: 
  - "Expressões MDX [Analysis Services], sobre MDX"
  - "modelagem dimensional [MDX]"
  - "MDX [Analysis Services], sobre MDX"
  - "Expressões MDX [Analysis Services], modelagem dimensional"
  - "MDX [Analysis Services], modelagem dimensional"
...
## Atributos de chave  
 ...
 ![Modelo que exibe o atributo de granularidade](../../../analysis-services/multidimensional-models/mdx/media/ssas-keyconcepts-granularityattrib.png "Modelo que exibe o atributo de granularidade")  
...
## Escopo da consulta (Espaço de cubo)  
...
-   [A consulta básica de MDX &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/the-basic-mdx-query-mdx.md)  
