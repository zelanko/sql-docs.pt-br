...
|**Cumulativo**|Todas as coleções são exibidas, e o usuário pode adicionar e remover coleções.<br /><br /> Um usuário também pode adicionar e remover membros da coleção.|  
