...
Formate os resultados da consulta ou exporte os dados do SQL Server como JSON adicionando a cláusula **FOR JSON** a uma instrução **SELECT**. Use o **FOR JSON** cláusula para simplificar os aplicativos cliente ao delegar a formatação da saída JSON de aplicativos de cliente para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].
...
-   Use **FOR JSON PATH** para manter o controle completo sobre o formato da saída JSON. Você pode criar objetos wrapper e aninhar propriedades complexas.  
  
-   Use **FOR JSON AUTO** formatar a saída JSON automaticamente com base na estrutura da instrução SELECT.  
...
## <a name="maintain-control-over-json-output-with-for-json-path"></a>Manter controle sobre a saída JSON com FOR JSON PATH
...
## <a name="let-the-select-statement-control-json-output-with-for-json-auto"></a>Permitir que o controle de instrução SELECT saída JSON com FOR JSON AUTO
...
1.  O conjunto de resultados contém uma única coluna.
    ...
    -   Um conjunto de resultados grande divide a cadeia de caracteres JSON longa em várias linhas.
        ...
        -   Outros aplicativos cliente podem exigir o código para concatenar os resultados longos, combinando o conteúdo de várias linhas. Para obter um exemplo do código em um aplicativo c#, consulte [Use a saída JSON em um aplicativo cliente c#](https://docs.microsoft.com/en-us/sql/relational-databases/json/use-for-json-output-in-sql-server-and-in-client-apps-sql-server#use-for-json-output-in-a-c-client-app).
