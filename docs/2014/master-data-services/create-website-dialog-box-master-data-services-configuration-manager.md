...
## <a name="see-also"></a>Consulte também  
 [Página de configuração da Web &#40;gerente de configuração de serviços de dados master&#41;](../../2014/master-data-services/web-configuration-page-master-data-services-configuration-manager.md)   
 [Configure o banco de dados e o site para serviços de dados mestres](../../2014/master-data-services/set-up-the-database-and-website-for-master-data-services.md)   
 [Requisitos de aplicativos da Web &#40;serviços de dados mestres&#41;](install-windows/web-application-requirements-master-data-services.md)   
