...
# <a name="audit-database-principal-management-event-class"></a>Classe de evento Audit Database Principal Management
  A classe de evento **Audit Database principal Management** ocorre quando entidades de segurança, como usuários, são criadas, alteradas ou descartadas de um banco de dados.  
