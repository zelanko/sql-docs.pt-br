...
##  <a name="sharepoint-mode"></a><a name="bkmk_sharepoint_mode"></a>Modo do SharePoint  
...
##  <a name="managing-inactive-subscriptions"></a><a name="bkmk_manage_inactive"></a>Gerenciando assinaturas inativas  
