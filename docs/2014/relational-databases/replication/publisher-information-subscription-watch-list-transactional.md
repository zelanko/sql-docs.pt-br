---
title: Informações do publicador, inspeção de assinatura (publicação transacional, SQL Server 2005 e versões posterior) de lista | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
