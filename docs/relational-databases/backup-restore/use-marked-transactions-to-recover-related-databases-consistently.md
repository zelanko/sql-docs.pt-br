...
description: Ao fazer atualizações relacionadas em dois ou mais bancos de dados relacionados, use marcas de transação no SQL Server para recuperá-los para um ponto logicamente consistente.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
