---
title: "Use os limites de aviso e alertas em m&#233;tricas de desempenho de espelhamento (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "monitorando espelhamento de banco de dados [SQL Server]"
  - "limites [SQL Server]"
  - "espelhamento de banco de dados [SQL Server], gerenciando no SQL Server Management Studio"
  - "alertas [SQL Server], espelhamento de banco de dados"
  - "espelhamento de banco de dados [SQL Server], monitorando"
  - "avisos [espelhamento de banco de dados]"
