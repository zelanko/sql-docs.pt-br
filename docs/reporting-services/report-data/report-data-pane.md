...
description: Saiba como usar o painel Dados do Relatório para exibir os parâmetros, as fontes de dados, os conjuntos de dados, as coleções de campos e as imagens definidos atualmente no relatório.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: ''
