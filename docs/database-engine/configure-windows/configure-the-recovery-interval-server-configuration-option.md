...
description: Saiba mais sobre a opção recovery interval. Veja como seu valor afeta a frequência com que o SQL Server emite pontos de verificação automáticos em um banco de dados.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
