...
description: Saiba mais sobre o tipo de DBBINDING e membros de tipo relacionados aos aprimoramentos de data e hora do Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
