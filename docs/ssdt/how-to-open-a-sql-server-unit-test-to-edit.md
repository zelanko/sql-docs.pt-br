---
title: Como abrir um teste de unidade do SQL Server para edição | Microsoft Docs
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
...
ms.locfileid: "37093637"
---
# <a name="how-to-open-a-sql-server-unit-test-to-edit"></a>Como: Abrir um teste de unidade do SQL Server para edição
