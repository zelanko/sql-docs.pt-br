---
title: "Criptografia Sempre Criptografado | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "02/29/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Sempre Criptografado, sistema de criptografia"
...
---
# Criptografia Sempre Criptografado
...
```  
 ...
 No caso de criptografia determinística, o IV não é gerado aleatoriamente, mas, em vez disso, ele é derivado do valor de texto não criptografado usando o seguinte algoritmo:  
