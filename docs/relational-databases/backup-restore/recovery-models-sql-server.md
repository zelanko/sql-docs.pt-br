...
helpviewer_keywords: 
  ...
  - "modelo de recuperação com log de operações em massa [SQL Server]"
  - "recuperação [SQL Server], modelo de recuperação"
  - "restaurando logs de transações [SQL Server], modelos de recuperação"
  - "fazendo backup de bancos de dados [SQL Server], modelos de recuperação"
  - "modelos de recuperação [SQL Server], sobre"
  - "backups de logs de transações [SQL Server]"
  - "modelo de recuperação simples [SQL Server]"
  - "backups [SQL Server], modelos de recuperação"
  - "modelos de recuperação [SQL Server]"
  - "modelos de recuperação [SQL Server], gerenciamento de log de transações"
  - "restaurações de banco de dados [SQL Server], modelos de recuperação"
  - "restaurações de logs de transações [SQL Server]"
  - "logs [SQL Server], modelos de recuperação"
  - "restaurando bancos de dados [SQL Server], modelos de recuperação"
  - "modelo de recuperação completa [SQL Server]"
  - "fazendo backup de logs de transações [SQL Server], modelos de recuperação"
