...
`[ @plan_id = ] 'plan\_id'` Especifica a ID do plano de manutenção. *plan_id* está **uniqueidentifier**.  
  
`[ @db_name = ] 'database\_name'` Especifica o nome do banco de dados a serem excluídos do plano de manutenção. *database_name* é **sysname**.  
