...
description: Saiba como criar relatórios paginados básicos do SSRS (SQL Server Reporting Services), incluindo formas de se conectar a fontes de dados e adicionar gráficos a relatórios.
ms.date: 05/30/2017
