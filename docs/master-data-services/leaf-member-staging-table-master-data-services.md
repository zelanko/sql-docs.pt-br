...
description: Use a tabela de preparo de membros folha no banco de dados Master Data Services para criar, atualizar, desativar e excluir membros folha.
ms.custom: ''
ms.date: 04/01/2016
ms.prod: sql
ms.prod_service: mds
