...
# <a name="performing-bulk-copy-operations"></a>Executando operações de cópia em massa
 ...
 Para obter um aplicativo de exemplo que demonstra esse recurso, consulte [copiar dados em massa usando o IRowsetFastLoad &#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md).  
