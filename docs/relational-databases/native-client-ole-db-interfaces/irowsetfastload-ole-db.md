...
## <a name="see-also"></a>Consulte Também  
 ...
 [Enviar dados de BLOB para o SQL SERVER usando o IROWSETFASTLOAD e o ISEQUENTIALSTREAM &#40;OLE DB&#41;](../../relational-databases/native-client-ole-db-how-to/send-blob-data-to-sql-server-using-irowsetfastload-and-isequentialstream-ole-db.md)  
