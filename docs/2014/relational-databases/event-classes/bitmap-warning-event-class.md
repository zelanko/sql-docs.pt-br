...
|**LoginName**|`nvarchar`|Nome do logon do usuário (logon de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] segurança do ou as credenciais de logon do Windows na forma de *domínio \ nomedeusuário*).|11|Sim|  
