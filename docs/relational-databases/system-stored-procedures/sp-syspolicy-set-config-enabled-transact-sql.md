...
`[ @value = ] value` Determina se o gerenciamento baseado em políticas está habilitado. o *valor* é **sqlvariant**e pode ser um dos seguintes valores:  
