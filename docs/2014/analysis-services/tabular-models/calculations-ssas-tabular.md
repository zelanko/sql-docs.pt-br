...
|[Expressões de análise de dados &#40;DAX&#41; referência](/dax/data-analysis-expressions-dax-reference)|Esta seção fornece descrições detalhadas de sintaxe DAX, operadores e funções.|  
