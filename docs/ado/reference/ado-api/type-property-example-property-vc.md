---
title: Tipo de exemplo da propriedade (propriedade) (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35282735"
---
# <a name="type-property-example-property-vc"></a>Exemplo de propriedade de tipo (propriedade) (VC + +)
