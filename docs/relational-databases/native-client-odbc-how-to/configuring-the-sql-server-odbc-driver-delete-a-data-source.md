...
description: Saiba como excluir uma fonte de dados usando o Administrador ODBC, programaticamente, ou usando um arquivo, antes de usar aplicativos ODBC com o SQL Server 2005 ou posterior.
ms.custom: ''
ms.date: 08/01/2016
ms.prod: sql
