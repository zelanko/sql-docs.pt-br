...
ms.topic: "article"
helpviewer_keywords: 
  - "sintaxe de ElementPath"
  - "XML [Reporting Services], recuperação de dados"
...
---
# Sintaxe do caminho do elemento para dados de relat&#243;rio XML (SSRS)
...
|**Elemento**|O valor do subelemento nomeado. Por exemplo, Clientes {}/Cliente {}/Sobrenome recupera valores apenas para o elemento Sobrenome.|  
