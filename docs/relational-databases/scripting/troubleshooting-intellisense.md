...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Em certos casos, o funcionamento das opções do IntelliSense podem não ser o esperado.  
