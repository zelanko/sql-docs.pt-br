...
>[!NOTE]
>  Você precisa migrar o conteúdo do Datazen Server como painéis e KPIs para um servidor SQL Server [!INCLUDE[ssRSnoversion_md](../../includes/ssrsnoversion-md.md)]? Experimente o [Assistente de migração do SQL Server para Datazen](https://www.microsoft.com/download/details.aspx?id=53128). 
