...
|**sqlserver_start_time_ms_ticks**|**bigint**|Representa o **** número de ms_tick [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] quando foi iniciado pela última vez. Compare com a coluna ms_ticks atual. Não permite valor nulo.|  
