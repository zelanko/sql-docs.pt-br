...
description: Saiba como usar o modo de exibição de Design no Designer de Relatórios do Reporting Services para organizar os itens de relatório em um relatório.
ms.date: 05/31/2016
