...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Este procedimento descreve como alterar a maneira como os atributos são exibidos no Designer de dimensão.  
