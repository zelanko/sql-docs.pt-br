...
### <a name="commit-level-control---t-sql"></a>Controle de nível de confirmação-(T-SQL)
...
### <a name="sql-server-shutdown-and-restart"></a>Desligamento e reinicialização de SQL Server  
