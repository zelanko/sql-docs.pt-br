...
2.  Na caixa de diálogo **Seleção de Cubo**, clique em Vendas e em **OK**.  
    ...
    > [!TIP]  
    > Se não desejar criar a consulta MDX manualmente, clique no ícone ![Alternar para o modo de Design](../reporting-services/media/rsqdicon-designmode.png "Alternar para o modo de Design"), ative/desative o designer de consultas para o modo Consulta, cole o MDX concluído no designer de consultas e vá para a etapa 6 em [Para criar o conjunto de dados](#DSkip).  
...
#### Para criar o relatório principal  
...
2.  Na caixa de diálogo **Seleção de Cubo**, clique em Vendas e em **OK**.  
    ...
    > [!TIP]  
    > Se não desejar criar a consulta MDX manualmente, clique no ícone ![Alternar para o modo de Design](../reporting-services/media/rsqdicon-designmode.png "Alternar para o modo de Design"), ative/desative o designer de consultas para o modo Consulta, cole o MDX concluído no designer de consultas e vá para a etapa 5 em [Para criar o conjunto de dados](#MSkip).  
