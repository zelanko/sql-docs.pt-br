...
helpviewer_keywords: 
  ...
  - "SQL Server Reporting Services, atualizando"
...
##  <a name="bkmk_side_by_side"></a> Instalações lado a lado  
 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] O modo nativo pode ser instalado lado a lado com uma implantação de modo nativo do [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ou [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)].  
...
-   Examine os requisitos para determinar se o hardware e o software do computador podem dar suporte ao [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)]. Para obter mais informações, veja [Requisitos de hardware e software para a instalação do SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md).  
...
-   Faça backup da chave simétrica. Para saber mais, confira [Back Up and Restore Reporting Services Encryption Keys](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md).  
...
4.  A Instalação cria novas pastas para arquivos de programas do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. As pastas de programa de uma instalação do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] incluem a MSRS13.\<*instance name*>.  
...
-   [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint.  
    ...
    > [!TIP]  
    >  Use o cmdlet `Get-SPRSServiceApplicationServers` do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint para determinar os servidores no farm do SharePoint que estão executando o serviço compartilhado do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint e, portanto, requerem uma atualização.  
...
### [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] para [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 ...
 **Ambiente final:** [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], SharePoint 2013 ou SharePoint 2016.   
...
### [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] para [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
### [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] para [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
-   Execute a instalação do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] para atualizar o modo do SharePoint de cada “servidor de relatório”. O assistente de instalação do SQL Server instalará o Serviço [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] e criará um novo aplicativo de Serviço. 
...
-   Modo Nativo: veja [Fazer backup e restaurar as chaves de criptografia do Reporting Services](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md)  
