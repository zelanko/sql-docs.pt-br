...
3.  Na caixa de diálogo **Dependências do Objeto**_\<object name>_, selecione **Objetos que dependem do**  *\<<nome do objeto>* ou **Objetos dos quais o** _\<object name>_**depende**.  
