---
title: 'Lição 5: Adicionando configurações de pacote para o modelo de implantação do pacote | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
