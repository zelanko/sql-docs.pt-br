---
description: Exemplo da propriedade Name, métodos Columns and Tables Append (VC++)
title: Exemplo da propriedade Name, métodos e propriedades de colunas e tabelas (VC + +) | Microsoft Docs
ms.prod: sql
