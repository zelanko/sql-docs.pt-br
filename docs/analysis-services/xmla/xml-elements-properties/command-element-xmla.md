...
## <a name="remarks"></a>Remarks  
 O **comando** elemento é usado pelo **Execute** método para retransmitir comandos a uma fonte de dados. Embora o XML para especificação Analysis (XMLA) 1.1 oferece suporte a apenas o **instrução** de comando, o Analysis Services suporta muitos novos comandos XMLA. Para obter mais informações sobre o comando XMLA com suporte [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)], consulte [comandos &#40;XMLA&#41;](../../../analysis-services/xmla/xml-elements-commands/xml-elements-commands.md).  
