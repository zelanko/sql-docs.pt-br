...
|Tópico|Informações|  
|-----------|-----------------|  
|[Conectar a um Utilitário do SQL Server](../../relational-databases/manage/connect-to-a-sql-server-utility.md)|Descreve a exibição do painel do Utilitário do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] e os pontos de vista.|  
