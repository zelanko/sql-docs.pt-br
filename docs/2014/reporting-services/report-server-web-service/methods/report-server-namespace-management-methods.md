...
|<xref:ReportService2010.ReportingService2010.CreateCatalogItem%2A>|Adiciona um novo item a um banco de dados do servidor de relatório ou à biblioteca do SharePoint. Esse método aplica-se para o `Report`, `Model`, `Dataset`, `Component`, `Resource`, e `DataSource` tipos de item.|  
...
|<xref:ReportService2010.ReportingService2010.GetItemDefinition%2A>|Recupera a definição ou o conteúdo de um item. Esse método aplica-se para o `Report`, `Model`, `Dataset`, `Component`, `Resource`, e `DataSource` tipos de item.|  
...
|<xref:ReportService2010.ReportingService2010.SetItemDefinition%2A>|Configura a definição ou o conteúdo de um item especificado. Esse método aplica-se para o `Report`, `Model`, `Dataset`, `Component`, `Resource`, e `DataSource` tipos de item.|  
