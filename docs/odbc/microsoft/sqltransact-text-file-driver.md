---
description: SQLTransact (Driver de Arquivo de texto)
title: SQLTransact (driver de arquivo de texto) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88339655"
---
# <a name="sqltransact-text-file-driver"></a>SQLTransact (Driver de Arquivo de texto)
> [!NOTE]  
