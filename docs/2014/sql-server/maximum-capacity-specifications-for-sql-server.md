...
##  <a name="ssnoversion-utility-objects"></a>Objetos do Utilitário do <a name="Utility"></a> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
...
##  <a name="ssnoversion-data-tier-application-objects"></a>Objetos de aplicativo da camada de dados do <a name="DAC"></a> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
