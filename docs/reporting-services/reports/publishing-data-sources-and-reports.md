...
description: Saiba como publicar fontes de dados e relatórios para que pessoas com permissões para o servidor de relatório ou o site do SharePoint possam executar seu relatório.
ms.date: 03/07/2017
...
# <a name="publishing-data-sources-and-reports"></a>Publicando fontes de dados e relatórios
 ...
 Depois de projetar e testar seu relatório, talvez você queira compartilhá-lo com outros usuários. Para compartilhar seu relatório, você precisa publicá-lo ou *implantá-lo*em um servidor de relatório ou no site do SharePoint. Depois de publicado, os usuários que tiverem permissões de acesso no servidor de relatórios ou no site do SharePoint poderão executar seu relatório. Além disso, uma pessoa com permissões de administrador no servidor de relatórios pode criar assinaturas para seu relatório, permitindo que ele seja atualizado e enviado aos usuários regularmente.  
