...
description: Use regiões de dados do gráfico para ajudar os leitores de seus relatórios paginados a entender grandes volumes de dados agregados em um relance no Construtor de Relatórios.
ms.date: 03/07/2017
