...
3.  Inicie e pare o rastreamento quando necessário.  
     ...
     Mesmo após a interrupção do rastreamento, ele ainda existirá no servidor e deve ser iniciado novamente se tiver sido definido como AutoRestart=`true`.  
...
1.  Inicie a captura do log XMLA definindo o atributo de servidor CaptureXml como `true`.  
...
3.  Interrompa a captura do log XMLA redefinido CaptureXml como `false`.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [AMO outras Classes e métodos](amo-other-classes-and-methods.md)   
