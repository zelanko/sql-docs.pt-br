---
title: "Criar modelos (Aprofundamento da ci&#234;ncia de dados) | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "jhubbard"
---
# Criar modelos (Aprofundamento da ci&#234;ncia de dados)
...
Agora, você criará um modelo de regressão logística que indica se um cliente específico é um risco de fraude.  
  
Você usará a função *rxLogit*, incluída no pacote **RevoScaleR**, que dá suporte à conexão de modelos de regressão logística em contextos de computação remota.  
...
## Próxima etapa  
[Pontuar novos dados &#40;Aprofundamento da ciência de dados&#41;](../../advanced-analytics/r-services/score-new-data-data-science-deep-dive.md)  
