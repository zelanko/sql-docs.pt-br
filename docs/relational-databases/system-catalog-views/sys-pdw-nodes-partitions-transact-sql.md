...
### <a name="example-a-display-rows-in-each-partition-within-each-distribution"></a>Exemplo A: Exibir linhas em cada partição em cada distribuição 
