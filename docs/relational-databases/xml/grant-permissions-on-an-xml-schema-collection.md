...
description: Saiba como conceder permissões para criar uma coleção de esquema XML e também conceder permissões em um objeto da coleção de esquemas XML.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
