---
description: Suporte ao tipo de parâmetro OLE DB Table-Valued (provedor OLE DB de cliente nativo)
...
ms.locfileid: "97469267"
---
# <a name="ole-db-table-valued-parameter-type-support-native-client-ole-db-provider"></a>Suporte ao tipo de parâmetro OLE DB Table-Valued (provedor OLE DB de cliente nativo)
