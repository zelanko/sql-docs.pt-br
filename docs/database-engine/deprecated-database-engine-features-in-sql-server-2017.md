...
|Tipos de dados|Tipos de dados:<br /><br /> **text**<br /><br /> **ntext**<br /><br /> **image**|Use os tipos de dados **varchar(max)**, **nvarchar(max)** e **varbinary(max)**.|Tipos de dados: **text** **ntext** ou **image**|4|  
...
|Algoritmos de hash|Os algoritmos MD2, MD4, MD5, SHA e SHA1. Esses não devem ser usados.|Use SHA2_256 ou SHA2_512.|Algoritmo de hash preterido||  
...
|SQL Server Agent|Notificação**net send** <br /><br /> Notificação por pager|Notificação por email<br /><br /> Notificação por email |None|None|  
|[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]|Integração com o Gerenciador de Soluções do [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]||None|None|  
...
|Tabelas do sistema|sys.numbered_procedures<br /><br /> sys.numbered_procedure_parameters|None|numbered_procedures<br /><br /> numbered_procedure_parameters|148<br /><br /> 149|  
...
|Textpointers|WRITETEXT<br /><br /> UPDATETEXT<br /><br /> READTEXT|None|UPDATETEXT ou WRITETEXT<br /><br /> READTEXT|115<br /><br /> 114|  
...
|[!INCLUDE[tsql](../includes/tsql-md.md)]|Instruções [!INCLUDE[tsql](../includes/tsql-md.md)] que não terminam com um ponto-e-vírgula.|Instruções [!INCLUDE[tsql](../includes/tsql-md.md)] que terminam com um ponto-e-vírgula ( ; ).|None|None|  
