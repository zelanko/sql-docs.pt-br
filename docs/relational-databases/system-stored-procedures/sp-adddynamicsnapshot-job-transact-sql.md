...
|-----------------|---------------|-----------------|  
|**sessão**|**int**|Identifica o trabalho de instantâneo de dados filtrado na tabela do sistema [MSdynamicsnapshotjobs](../../relational-databases/system-tables/msdynamicsnapshotjobs-transact-sql.md) .|  
