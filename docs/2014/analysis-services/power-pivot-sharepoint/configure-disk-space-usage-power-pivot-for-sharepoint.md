...
4.  Em uso do disco, na configuração **excluir bancos de dados em cache nas últimas ' n ' horas** , especifique os critérios usados pela última vez para esvaziar o cache quando o espaço em disco estiver no limite máximo.  
