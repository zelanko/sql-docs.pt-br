...
Para saber como agendar a execução de pacotes no Azure, consulte [Agendar a execução de um pacote do SSIS no Azure](ssis-azure-schedule-packages.md).