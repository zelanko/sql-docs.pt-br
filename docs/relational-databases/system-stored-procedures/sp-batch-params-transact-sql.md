...
|**MUITO**|**int**|Tamanho da transferência dos dados. Esse valor será NULL.|  
...
|**SQL_DATETIME_SUB**|**smallint**|O subcódigo **DateTime** ou o **intervalo** ISO se o valor de **SQL_DATA_TYPE** for SQL_DATETIME ou SQL_INTERVAL. Para tipos de dados diferentes de **DateTime** e o **intervalo**ISO, essa coluna é nula. Esse valor será NULL.|  
