---
description: Método setBigDecimal (SQLServerCallableStatement)
...
## <a name="remarks"></a>Comentários  
 Esse método setBigDecimal é especificado pelo método setBigDecimal na interface do java.sql.CallableStatement.  
