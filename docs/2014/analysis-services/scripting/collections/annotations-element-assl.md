...
ms.locfileid: "36115724"
---
# <a name="annotations-element-assl"></a>Elemento Annotations (ASSL)
  Contém a coleção de [anotação](../objects/annotation-element-assl.md) elementos associados ao elemento pai.  
...
|Elementos filho|[Anotação](../objects/annotation-element-assl.md)|  
