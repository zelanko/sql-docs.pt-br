...
Escreva consultas de texto completo usando os predicados de texto completo **CONTAINS** e **FREETEXT** e as funções com valor de conjunto de linhas **CONTAINSTABLE** e **FREETEXTTABLE** com a instrução **SELECT**. Este artigo fornece exemplos de cada predicado e função e ajuda você a escolher o melhor a ser usado.
