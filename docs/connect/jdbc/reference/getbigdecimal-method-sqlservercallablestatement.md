...
|[getBigDecimal (Java)](../../../connect/jdbc/reference/getbigdecimal-method-java-lang-string.md)|Recupera o valor do parâmetro designado como java.math.BigDecimal com precisão total, considerando o nome do parâmetro.|  
|[getBigDecimal (Java, int)](../../../connect/jdbc/reference/getbigdecimal-method-java-lang-string-int.md)|(Substituído) Recupera o valor do parâmetro designado como um java.math.BigDecimal, considerando a escala e o nome do parâmetro.|  
