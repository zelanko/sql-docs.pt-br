...
description: Saiba como exibir uma lista de bancos de dados em uma instância do SQL Server usando o SQL Server Management Studio ou Transact-SQL.
ms.date: 03/14/2017
ms.prod: sql
