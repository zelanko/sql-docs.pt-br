...
description: Conheça as opções usadas para ver ou modificar uma agenda compartilhada na página do Reporting Services no SQL Server Management Studio.
ms.date: 06/11/2016
