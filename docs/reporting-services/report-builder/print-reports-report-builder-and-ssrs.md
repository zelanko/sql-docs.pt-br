...
description: Você pode ver e imprimir um relatório do portal da Web ou de um aplicativo que usa para exibi-lo. O computador cliente executa o processamento da impressão sob demanda.
ms.date: 05/24/2018
