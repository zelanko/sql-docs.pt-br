...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Add Member to DB Role** ocorre sempre que um logon é adicionado ou removido de uma função de banco de dados. Essa classe de evento é usada com os procedimentos armazenados **sp_addrolemember**, **sp_changegroup**e **sp_droprolemember** .  
  
## <a name="audit-add-member-to-db-role-event-class-data-columns"></a>Colunas de dados da classe de evento Audit Add Member to DB Role  
