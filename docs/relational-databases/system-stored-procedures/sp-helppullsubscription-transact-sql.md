...
|**guid de assinatura**|**binário (16)**|Identificador global para a versão da assinatura na publicação.|  
|**subid**|**binário (16)**|Identificador global para uma assinatura anônima.|  
