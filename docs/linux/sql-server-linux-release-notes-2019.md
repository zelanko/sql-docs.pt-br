...
- [Instalar o pacote do PolyBase](../relational-databases/polybase/polybase-linux-setup.md)
- [Habilitar o SQL Server Agent](sql-server-linux-setup-sql-agent.md)

## <a id="CTP31"></a> CTP 3.1 (junho de 2019)

As seções a seguir fornecem os locais de pacote e problemas conhecidos para o CTP 3.1 versão. Para saber mais sobre os novos recursos para Linux no SQL Server 2019, consulte o [o que há de novo no SQL Server 2019](../sql-server/what-s-new-in-sql-server-ver15.md).
...
As seções a seguir fornecem os locais de pacote e problemas conhecidos para o CTP 3.0 versão. Para saber mais sobre os novos recursos para Linux no SQL Server 2019, consulte o [o que há de novo no SQL Server 2019](../sql-server/what-s-new-in-sql-server-ver15.md).
...
As seções a seguir fornecem os locais de pacote e problemas conhecidos para o CTP 2.5 versão. Para saber mais sobre os novos recursos para Linux no SQL Server 2019, consulte o [o que há de novo no SQL Server 2019](../sql-server/what-s-new-in-sql-server-ver15.md).
...
As seções a seguir fornecem os locais de pacote e problemas conhecidos para o CTP 2.2 de versão. Para saber mais sobre os novos recursos para Linux no SQL Server 2019, consulte o [o que há de novo no SQL Server 2019](../sql-server/what-s-new-in-sql-server-ver15.md).
