...
description: Antes de iniciar uma reprodução distribuída com o SQL Server Distributed Replay, é necessário preparar os dados de rastreamento de entrada iniciando o estágio de pré-processamento.
ms.prod: sql
