...
description: Saiba como usar o depurador Transact-SQL para controlar quais instruções Transact-SQL são executadas em uma janela do Editor de Consultas do Mecanismo de Banco de Dados.
ms.prod: sql
ms.technology: ssms
ms.topic: conceptual
helpviewer_keywords:
