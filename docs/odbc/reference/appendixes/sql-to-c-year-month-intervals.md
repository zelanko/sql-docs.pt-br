---
title: 'SQL to c: ano-mês | Microsoft Docs'
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
_C_BINARY|Comprimento de bytes de dados < = *BufferLength*<br /><br /> Comprimento de bytes de dados > *BufferLength*|data<br /><br /> Indefinido|Comprimento dos dados em bytes<br /><br /> Indefinido|n/d<br /><br /> 22003|  
