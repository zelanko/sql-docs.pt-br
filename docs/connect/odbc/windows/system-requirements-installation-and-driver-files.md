...
|---------------|-----------------|  
|msodbcsql17.dll or <br> msodbcsql13.dll ou <br> msodbcsql11.dll|O arquivo de biblioteca de vínculo dinâmico (DLL) que contém toda a funcionalidade do driver. Esse arquivo é instalado em % SYSTEMROOT%\System32.|  
