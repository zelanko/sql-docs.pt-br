...
#### <a name="nullprocessing-option-set-to-preserve-is-no-longer-supported-for-distinct-count-measures"></a>A opção NullProcessing definida como Preservar não é suportada para medidas de contagem distintas  
 Anteriores ao [!INCLUDE[ssSQL11](../includes/sssql11-md.md)], era possível definir [elemento NullProcessing &#40;ASSL&#41; ](scripting/properties/nullprocessing-element-assl.md) para `Preserve` para medidas de contagem distintas.  Infelizmente, essa prática geralmente produziu resultados inválidos e às vezes até mesmo travou o trabalho de processamento. Como resultado, essa configuração não é válida em [!INCLUDE[ssSQL11](../includes/sssql11-md.md)]. Tentar usá-lo fará com que o erro de validação a seguir ocorra: "Erros no gerenciador de metadados. Preservar não é um valor NullProcessing válido para o \<measurename > medida de contagem distinta. "  
