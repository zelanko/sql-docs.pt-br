...
layout: HubPage
hide_bc: true
title: Gerenciar, monitorar, ajustar o SQL Server
description: Descubra os recursos que ajudam você a gerenciar, monitorar e ajustar o SQL Server.
ms.topic: hub-page
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: gerenciar, monitorar e ajustar</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gerenciamento de ciclo de vida do banco de dados</h3>
                                                    <p>Uma abordagem abrangente para gerenciar o esquema de banco de dados, os dados e os metadados de um aplicativo de banco de dados</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Um recurso do SQL Server que facilita a compactação de dados para que eles ocupem menos espaço nos discos. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Database Mail</h3>
                                                    <p>Uma solução empresarial para envio de mensagens de email do mecanismo de banco de dados do SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gerenciamento baseado em política</h3>
                                                    <p>Um sistema baseado em política para gerenciar uma ou mais instâncias do SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Configure planos automatizados para gerenciar seu SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Um recurso do SQL Server que executa tarefas administrativas agendadas. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eventos estendidos</h3>
                                                    <p>Um sistema geral de manipulação de eventos para sistemas SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>Um utilitário de uso geral que coleta logs e dados do SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>Crie, gerencie, analise e substitua rastreamentos feitos de atividade do SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Um novo recurso do SQL 2017 que detecta automaticamente possíveis problemas de desempenho. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Estimativa de cardinalidade</h3>
                                                    <p>Estima quantas linhas serão retornadas por uma consulta e é usada para a criação do plano de execução.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Índices</h3>
                                                    <p>Uma estrutura em disco associada a uma tabela ou exibição que acelera a recuperação de dados.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>OLTP na memória</h3>
                                                    <p>Uma opção de otimização de desempenho que deixa tabelas inteiras na memória.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Partições</h3>
                                                    <p>Permite que os dados sejam distribuídos em unidades, como grupos de arquivos. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Guias de plano</h3>
                                                    <p>Um recurso do SQL Server que permite a entrada manual de um plano de execução para uma consulta específica.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Administrador de recursos</h3>
                                                    <p>Especifica limites nas quantidades de CPU, E/S e memória que as solicitações de aplicativos podem usar. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Estatísticas</h3>
                                                    <p>Informa ao mecanismo do SQL Server como dados são distribuídos e usados para a criação de planos de execução.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
