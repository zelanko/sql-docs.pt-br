...
ms.locfileid: "32836781"
---
# <a name="getminorversion-method-sqlserverdriver"></a>Método getMinorVersion (SQLServerDriver)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Retorna o número da versão secundária do [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)].  
...
## <a name="return-value"></a>Valor de retorno  
 Um **int** que contém o número de versão secundária do driver JDBC.  
