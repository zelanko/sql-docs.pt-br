---
title: "Power Pivot tipo de Conexão (SSRS) | Microsoft Docs"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="connection-string"></a>Cadeia de Conexão  
 A cadeia de caracteres de conexão é a URL para [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] pasta de trabalho publicada no SharePoint no [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] galeria ou outra biblioteca, por exemplo, `http://contoso-srv/subsite/PowerPivotLibrary/ContosoSales.xlsx`.  
