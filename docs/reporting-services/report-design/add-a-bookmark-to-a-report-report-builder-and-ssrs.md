...
description: Saiba como adicionar indicadores a um relatório para fornecer um sumário personalizado ou para fornecer links de navegação interna personalizados no Construtor de Relatórios.
ms.date: 03/01/2017
