...
## <a name="tools-you-can-use"></a><a name="tools"></a> Ferramentas que você pode usar
...
## <a name="specify-excel-as-your-data-source"></a><a name="specify-excel"></a>Especifique o Excel como a fonte de dados
