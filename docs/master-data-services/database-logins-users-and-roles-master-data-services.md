...
ms.topic: "article"
helpviewer_keywords: 
  - "segurança [Master Data Services], funções de banco de dados"
  - "banco de dados [Master Data Services], usuários"
  - "segurança [Master Data Services], usuários do banco de dados"
  - "banco de dados [Master Data Services], funções"
  - "banco de dados [Master Data Services], logons"
  - "segurança [Master Data Services], logons do banco de dados"
...
---
# Logons, usu&#225;rios e fun&#231;&#245;es de banco de dados (Master Data Services)
...
## Usuários de banco de dados do Master Data Services  
...
## Função de banco de dados do Master Data Services  
