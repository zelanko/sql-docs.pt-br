...
ms.locfileid: "38020694"
---
# <a name="quickstart-run-the-sql-server-2017-container-image-with-docker"></a>Guia de início rápido: Executar a imagem de contêiner do SQL Server 2017 com o Docker
