---
title: Atualizado - MDX para documentos do SQL Server | Microsoft Docs
description: "Trechos de código de exibição de conteúdo atualizado para alterados recentemente na documentação, para MDX (Multidimensional Expressions) para o Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
ms.openlocfilehash: a2786da1d36671d0cd1c1b35ff64a0cef5e4fd15
ms.sourcegitcommit: 9fbe5403e902eb996bab0b1285cdade281c1cb16
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 11/27/2017
---
# <a name="new-and-recently-updated-multidimensional-expressions-mdx-for-sql-server"></a>Novos e atualizados recentemente: expressões multidimensionais (MDX para o SQL Server)
...
- *Área de assunto:* &nbsp; **MDX (Multidimensional Expressions) para SQL Server**.
