...
## <a name="arguments"></a>Argumentos  
 [  **@spid1 =** ] **'***sessão ID1***'**  
 É um [!INCLUDE[ssDE](../../includes/ssde-md.md)] número de ID de sessão do **DM exec_sessions** para as quais o usuário deseja informações de bloqueio. *sessão ID1* está **int** com um valor padrão de NULL. Execute **sp_who** para obter informações sobre a sessão do processo. Se *sessão ID1* não for especificado, são exibidas informações sobre todos os bloqueios.  
  
 [  **@spid2 =** ] **'***sessão ID2***'**  
 É outra [!INCLUDE[ssDE](../../includes/ssde-md.md)] número de ID de sessão do **DM exec_sessions** que pode ter um bloqueio ao mesmo tempo em que *sessão ID1* e sobre o qual o usuário deseja informações. *sessão ID2* está **int** com um valor padrão de NULL.  
