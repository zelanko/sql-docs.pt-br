...
description: Saiba mais sobre células em uma tabela ou matriz que também contêm uma caixa de texto, que você pode formatar da mesma maneira que as caixas de texto autônomas no Construtor de Relatórios.
ms.date: 03/14/2017
