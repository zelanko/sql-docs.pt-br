...
ms.locfileid: "43816382"
---
# <a name="modify-a-sql-server-agent-master-job"></a>Modificar um trabalho mestre do SQL Server Agent
  Os tópicos a seguir descrevem como modificar um trabalho mestre do [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
