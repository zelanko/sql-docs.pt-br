...
Este link leva você até a página de download do codeplex que tem os bancos de dados de exemplo AdventureWorks.  
  
[Exemplo de código de AMO para criar modelos de tabela programaticamente](http://go.microsoft.com/fwlink/?linkID=221036)  
Este link leva você até uma página de download do Codeplex que tem o exemplo AMO.  
