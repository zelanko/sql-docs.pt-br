...
|**Class**|**int**|Identifica a classe de objeto que está sendo auditado.|  
...
## <a name="permissions"></a>Permissões  
 Entidades de segurança com o **ALTER ANY DATABASE AUDIT** ou **VIEW DEFINITION** permissões, o **dbo** e membros do **db_owners** função de banco de dados fixa têm acesso a esta exibição do catálogo. Além disso, a entidade de segurança não deve ser negada **VIEW DEFINITION** permissão.  
