---
title: "Edições e recursos com suporte do SQL Server | Microsoft Docs"
ms.custom:
- SQL2016_New_Updated
ms.date: 05/24/2017
...
---
# <a name="editions-and-supported-features-of-sql-server"></a>Edições e recursos com suporte do SQL Server
