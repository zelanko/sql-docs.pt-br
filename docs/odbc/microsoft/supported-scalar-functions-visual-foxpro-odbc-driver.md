...
ms.locfileid: "62633191"
---
# <a name="supported-scalar-functions-visual-foxpro-odbc-driver"></a>Funções escalares compatíveis (Driver ODBC do Visual FoxPro)
O Driver de ODBC do Visual FoxPro dá suporte a três tipos de funções escalares conforme definido na gramática SQL ODBC: cadeia de caracteres, numéricos e funções de data e hora.  
