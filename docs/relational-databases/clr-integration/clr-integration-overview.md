...
description: Microsoft SQL Server Hospedagem de CLR é chamada de integração CLR. A criação em código gerenciado pode melhorar o desempenho. O SQL Server usa CAS para ajudar a proteger o código gerenciado.
ms.custom: ''
ms.date: 04/19/2017
ms.prod: sql
ms.reviewer: ''
