---
title: Propriedades, métodos e eventos da coleção Indexes | Microsoft Docs
ms.prod: sql
...
## <a name="methods"></a>Métodos  
 [Método Append (índices)](../../../ado/reference/adox-api/append-method-adox-indexes.md)  
