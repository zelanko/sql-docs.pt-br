...
description: Este guia de monitoramento do dispositivo descreve as ferramentas e tarefas de monitoramento de dispositivo de sistema de plataforma de análise.
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31538666"
---
# <a name="appliance-monitoring-for-analytics-platform-system"></a>Monitoramento de dispositivo para Analytics Platform System
Este guia de monitoramento do dispositivo descreve as ferramentas e tarefas de monitoramento de dispositivo de sistema de plataforma de análise.  
...
|Monitoramento de pulsação.|[Enviar comentários de telemetria à Microsoft &#40;do SQL Server PDW&#41;](send-telemetry-feedback-to-microsoft-sql-server-pdw.md)|  
|Controlar os alertas do dispositivo.|[Controlar o dispositivo alertas &#40;Analytics Platform System&#41;](track-appliance-alerts.md)|  
