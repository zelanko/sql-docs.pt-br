...
# <a name="reporting-services-tools"></a>Ferramentas do Reporting Services
 ...
 Para localizar uma ferramenta imediatamente, consulte [Tutorial: Como localizar e iniciar o Reporting Services ferramentas &#40;SSRS&#41;](tutorial-how-to-locate-and-start-reporting-services-tools-ssrs.md).  
