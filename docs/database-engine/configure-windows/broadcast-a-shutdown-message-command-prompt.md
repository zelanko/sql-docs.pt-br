...
helpviewer_keywords: 
  - "SQL Server, parando"
  - "instâncias nomeadas [SQL Server], difundindo mensagens de desligamento"
  - "difusão de mensagem de desligamento"
  - "difundindo uma mensagem de desligamento"
  - "prompt de comando [SQL Server], difundindo mensagens de desligamento"
  - "instâncias padrão [SQL Server], difundindo mensagens de desligamento"
...
---
# Difundir uma mensagem de desligamento (prompt de comando)
...
#### Para difundir uma mensagem de desligamento  
