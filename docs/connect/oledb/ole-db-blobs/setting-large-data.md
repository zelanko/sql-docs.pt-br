---
title: Como definir dados grandes (Driver do OLE DB)
description: Saiba como usar o Driver do OLE DB para SQL Server para definir dados de BLOB transmitindo um ponteiro a um objeto de armazenamento de consumidor.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
