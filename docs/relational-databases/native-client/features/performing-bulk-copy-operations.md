...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 Para obter um aplicativo de exemplo que demonstra esse recurso, consulte [copiar dados em massa usando o IRowsetFastLoad &#40;OLE DB&#41;](../../../relational-databases/native-client-ole-db-how-to/bulk-copy-data-using-irowsetfastload-ole-db.md).  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Otimizando o desempenho de importação em massa](https://msdn.microsoft.com/library/ms190421\(SQL.105\).aspx)  
