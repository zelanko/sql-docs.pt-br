...
|**sessão**|**int**|A identificação do objeto da tabela à qual essa coluna pertence ou do procedimento armazenado ao qual esse parâmetro está associado.|  
...
|**muito**|**smallint**|Comprimento máximo do armazenamento físico de **Sys**. **tipos**.|  
...
|**cosenhor**|**smallint**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**autoval**|**varbinary (8000)**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**desvio**|**smallint**|Deslocamento da linha na qual essa coluna aparece.|  
