---
title: "Controle de altera&#231;&#245;es de dados (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/08/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "captura de dados de alteração [SQL Server], comparado ao controle de alterações"
  - "controle de alterações versus captura de dados de alterações"
  - "captura de dados de alteração [SQL Server], comportamentos de tipo de dados"
  - "Serviços de sincronização para ADO.NET"
  - "controle de alterações [SQL Server], Serviços de Sincronização para ADO.NET"
  - "controle de alterações [SQL Server]"
  - "captura de dados de alteração [SQL Server], segurança"
  - "captura de dados de alteração [SQL Server], outros recursos do SQL Server e"
...
|Recurso|Change Data Capture|Controle de alterações|  
|-------------|-------------------------|---------------------|  
...
-   Se um banco de dados for restaurado para outro servidor, por padrão a captura de dados de alteração será desabilitada, e todos os metadados relacionados serão excluídos.  
     ...
     Para manter a captura de dados de alterações, use a opção **KEEP_CDC** ao restaurar o banco de dados. Para obter mais informações sobre essa opção, consulte [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md).  
...
##  <a name="Tracking"></a> Controle de alterações  
 ...
 ![Ilustração conceitual do rastreamento de alteração](../../relational-databases/track-changes/media/cdcart2.gif "Ilustração conceitual do rastreamento de alteração")  
...
## Consulte também  
 ...
 [Exibições de gerenciamento dinâmico relacionadas à captura de dados de alterações &#40;Transact-SQL&#41;](../Topic/Change%20Data%20Capture%20Related%20Dynamic%20Management%20Views%20\(Transact-SQL\).md)  
