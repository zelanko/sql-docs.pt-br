...
```  
 ...
 Para habilitar [!INCLUDE[ssSB](../../includes/sssb-md.md)] em um banco de dados, use a opção ENABLE_BROKER SET o [ALTER DATABASE](/sql/t-sql/statements/alter-database-transact-sql) instrução.  
