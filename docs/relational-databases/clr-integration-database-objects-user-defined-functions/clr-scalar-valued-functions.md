...
description: Uma função de valor escalar retorna um único valor. No SQL Server integração CLR, você pode gravar funções de valor escalar definidas pelo usuário em código gerenciado.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
