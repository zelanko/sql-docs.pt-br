...
|**stream_id**|**[uniqueidentifier] rowguidcol**||Um valor retornado pela `NEWID()` função.|Uma ID exclusiva para os dados FILESTREAM.|Não aplicável.|  
