...
## <a name="cursor-conversion"></a>Conversão de cursores  
 Às vezes, o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] pode escolher implementar um tipo de cursor diferente do que foi solicitado, circunstância conhecida como conversão implícita de cursor (ou degradação de cursor). Para saber mais sobre a conversão implícita de cursor, consulte o tópico "Usando conversões de cursor implícitas" nos Manuais Online do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
  
 Com [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)], quando você atualiza os dados por meio de resultados ResultSet.TYPE_SCROLL_SENSITIVE e ResultSet.CONCUR_UPDATABLE definido, uma exceção é lançada com a mensagem "o cursor é READ ONLY". Essa exceção ocorre porque o [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] fez uma conversão implícita de cursor para esse conjunto de resultados e não retornou o cursor atualizável que foi solicitado.  
