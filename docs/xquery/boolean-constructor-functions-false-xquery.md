...
ms.locfileid: "33076545"
---
# <a name="boolean-constructor-functions---false-xquery"></a>Funções do construtor Boolianas - false (XQuery)
...
### <a name="a-using-the-false-xquery-boolean-function"></a>A. Usando a função booliana false() XQuery  
 Para obter um exemplo de funcionamento, consulte [true função &#40;XQuery&#41;](../xquery/boolean-constructor-functions-true-xquery.md).  
