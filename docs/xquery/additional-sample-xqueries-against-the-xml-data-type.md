---
title: Mais exemplos XQueries em relação ao tipo de dados xml | Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.prod_service: sql
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  Os tópicos nesta seção fornecem exemplos adicionais que mostram como usar consultas XQuery em relação a **xml** tipo de dados:  
  
-   [Casos de Uso Gerais de XQuery](../xquery/general-xquery-use-cases.md)  
