...
|-------------|----------------------|  
|captura de dados de alterações|[Replicação, controle de alterações, Change Data Capture e grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](replicate-track-change-data-capture-always-on-availability.md)|  
|controle de alterações|[Replicação, controle de alterações, Change Data Capture e grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](replicate-track-change-data-capture-always-on-availability.md)|  
|Bancos de dados independentes|[Bancos de dados independentes com grupos de disponibilidade do AlwaysOn (SQL Server)](always-on-availability-groups-sql-server.md)|  
|Criptografia de banco de dados|[Criptografado bancos de dados com grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](encrypted-databases-with-always-on-availability-groups-sql-server.md)|  
|Instantâneos do banco de dados|[Instantâneos com grupos de disponibilidade do AlwaysOn do banco de dados &#40;do SQL Server&#41;](database-snapshots-with-always-on-availability-groups-sql-server.md)|  
|FILESTREAM e FileTable|[FILESTREAM e FileTable com grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](filestream-and-filetable-with-always-on-availability-groups-sql-server.md)|  
...
|Envio de logs|[Pré-requisitos para migrar de envio de logs para grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](prereqs-migrating-log-shipping-to-always-on-availability-groups.md)|  
|RBS (Armazenamento de Blob Remoto)|[Armazenamento de Blob remoto &#40;RBS&#41; e grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](remote-blob-store-rbs-and-always-on-availability-groups-sql-server.md)|  
|Replicação[configurar a replicação para grupos de disponibilidade do AlwaysOn (SQL Server)](configure-replication-for-always-on-availability-groups-sql-server.md)<br /><br /> [Mantendo um banco de dados de publicação AlwaysOn &#40;do SQL Server&#41;](maintaining-an-always-on-publication-database-sql-server.md)<br /><br /> [Replicação, controle de alterações, Change Data Capture e grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](replicate-track-change-data-capture-always-on-availability.md)<br /><br /> [Assinantes de replicação e grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](replication-subscribers-and-always-on-availability-groups-sql-server.md)|  
...
|Reporting Services|Utilize réplicas secundárias somente leitura como uma fonte de dados de relatório e reduza a carga em sua réplica de leitura/gravação primária.<br /><br /> [Reporting Services com grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](reporting-services-with-always-on-availability-groups-sql-server.md)|  
|Service Broker|[Service Broker com grupos de disponibilidade do AlwaysOn &#40;do SQL Server&#41;](service-broker-with-always-on-availability-groups-sql-server.md)|  
|SQL Server Agent||  
...
-   **Whitepapers:**  
     ...
     [Guia de migração: Migrando para grupos de disponibilidade do AlwaysOn de implantações anteriores que combinam espelhamento de banco de dados e envio de logs](http://msdn.microsoft.com/library/jj635217)  
