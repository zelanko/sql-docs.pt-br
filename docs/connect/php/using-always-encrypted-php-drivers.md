---
title: Usar o Always Encrypted com o PHP Drivers for SQL Server
description: Saiba como usar o Always Encrypted com os drivers PHP para SQL Server para proteger dados confidenciais em seu aplicativo.
ms.date: 12/12/2019
ms.prod: sql
