...
|/En[crypt] *{SQL &#124; FILE}; Path;ProtectionLevel[;password]*|(Opcional). Criptografa o pacote carregado com o nível de proteção e senha especificados e o salva no local especificado em *Path*. O *ProtectionLevel* determina se uma senha é necessária:<br />*SQL* – Caminho é o nome do pacote de destino.<br />*FILE* – Caminho é o caminho completamente qualificado e o nome de arquivo do pacote.<br />*DTS* – Não há suporte para esta opção atualmente.<br /><br /> Opções do*ProtectionLevel* :<br />Nível 0: Elimina as informações confidenciais.<br />Nível 1: Informações confidenciais são criptografadas usando as credenciais de usuário local.<br />Nível 2: Informações confidenciais são criptografadas usando a senha necessária.<br />Nível 3: Pacote é criptografado usando a senha necessária.<br />Nível 4: Pacote é criptografado usando as credenciais de usuário local.<br />Nível 5: o pacote usa criptografia de armazenamento do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .|  
