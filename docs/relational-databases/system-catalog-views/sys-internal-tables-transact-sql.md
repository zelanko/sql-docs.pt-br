...
## <a name="remarks"></a>Remarks  
 ...
 Você pode usar o [sp_spaceused](../../relational-databases/system-stored-procedures/sp-spaceused-transact-sql.md) procedimento de sistema para retornar dados de uso de espaço para tabelas internas. **sp_spaceused** relata espaço de tabela interna das seguintes maneiras:  
...
-   As páginas que são usadas pelas tabelas internas de índices XML, índices espaciais e índices de texto completo são incluídas no **index_size** coluna. Quando um nome de tabela ou exibição indexada for especificado, as páginas para os índices XML, índices espaciais e índices de texto completo para o objeto são incluídas nas colunas **reservado** e **index_size**.  
