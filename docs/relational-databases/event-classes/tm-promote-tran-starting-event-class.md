...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento TM: Promote Tran Starting indica que uma solicitação PROMOTE TRANSACTION está sendo iniciada. A solicitação é enviada do cliente pela interface de gerenciamento de transações.  
...
|EventClass|**int**|Tipo de evento = 183.|27|Não|  
