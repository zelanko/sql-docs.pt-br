...
## <a name="dimension-based-on-a-snowflake-schema-design"></a>Dimensão com base em Design de esquema floco de neve   
 ...
 ![Tabelas para a dimensão AdventureWorksAS Product](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimproduct.gif "Tabelas para a dimensão AdventureWorksAS Product")  
...
## <a name="snowflake-schema-versus-reference-relationship"></a>Esquema floco de neve versus relação de referência  
 ...
 ![Esquema lógico para dimensão referenciada de exemplo](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimindirect.gif "Esquema lógico para dimensão referenciada de exemplo")  
