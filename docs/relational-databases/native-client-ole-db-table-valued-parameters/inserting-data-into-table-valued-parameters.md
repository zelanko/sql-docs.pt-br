...
ms.locfileid: "97476017"
---
# <a name="inserting-data-into-table-valued-parameters-native-client-ole-db-provider"></a>Inserindo dados em parâmetros de Table-Valued (provedor de OLE DB de cliente nativo)
