...
ms.topic: "article"
helpviewer_keywords: 
  - "propriedades [Analysis Services], bancos de dados"
...
---
# Definir propriedades de banco de dados multidimensional (Analysis Services)
...
|ID do MasterDataSource|Usada com partições remotas. Para obter mais informações, consulte [Partições Remotas](../Topic/Remote%20Partitions.md).|  
  
## Consulte também  
 [Caixa de diálogo Propriedades do Banco de Dados &#40;SSAS – Multidimensional&#41;](../Topic/Database%20Properties%20Dialog%20Box%20\(SSAS%20-%20Multidimensional\).md)   
