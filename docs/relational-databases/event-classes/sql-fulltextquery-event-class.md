...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: SQL:FullTextQuery event class
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento SQL:FullTextQuery ocorre quando [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] executa uma consulta de texto completo. Inclua esta classe de evento em rastreamentos que estão monitorando problemas associados a catálogos de texto completos.  
