---
description: Propriedades personalizadas OLE DB
...
|CommandTimeOut|Integer|O número de segundos antes de um comando expirar. Um valor de 0 indica que nunca expirará. <br /><br /> Observação: <br> Essa propriedade só terá efeito quando o modo de acesso a dados for **comando SQL**. <br> Esta propriedade não está disponível no **Editor de Origem de OLE DB**, mas pode ser definida usando o **Editor Avançado**.|  
