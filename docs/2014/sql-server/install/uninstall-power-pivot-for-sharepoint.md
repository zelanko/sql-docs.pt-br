...
##  <a name="step-4-uninstall-the-powerpivot-for-sharepoint-add-in"></a><a name="bkmk_addin"></a>Etapa 4: desinstalar o suplemento de PowerPivot para SharePoint  
