...
description: Este artigo descreve como gerenciar certificados para proteger as comunicações entre SSIS Scale Out mestre e trabalhos do Scale Out.
ms.date: 12/19/2017
ms.prod: sql
