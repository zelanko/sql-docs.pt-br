...
## Fechando e ocultando componentes  
...
#### Para praticar a movimentação dos componentes  
...
[Exibir a Janela de Consulta](../../tools/sql-server-management-studio/display-the-query-window.md)  
