...
1.  Entre ao portal de gerenciamento do Windows Azure usando sua conta. Se você não tiver uma conta do Windows Azure, [visite a avaliação gratuita de 3 meses do Windows Azure](http://go.microsoft.com/fwlink/?LinkId=271927).  
