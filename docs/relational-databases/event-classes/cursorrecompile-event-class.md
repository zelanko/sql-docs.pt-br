...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **CursorRecompile** descreve os eventos de recompilação do cursor que ocorrem nos cursores da API (interface de programação de aplicativo). Os eventos de recompilação do cursor ocorrem quando o [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] recompila um cursor Transact-SQL devido a uma alteração no esquema.  
