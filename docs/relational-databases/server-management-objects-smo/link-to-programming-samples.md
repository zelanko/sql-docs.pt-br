...
---
# <a name="available-programming-samples"></a>Exemplos de programação disponíveis
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../../includes/appliesto-ss-asdb-asdw-xxx-md.md)]

  A seguinte tabela lista o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Management Objects (SMO) disponíveis de exemplos de programação de [!INCLUDE[ssSampPathEng](../../includes/sssamppatheng-md.md)]programmability\smo. directory. Esses exemplos estão disponíveis no [!INCLUDE[csprcs](../../includes/csprcs-md.md)] e [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET.  
...
|CreateSPs|Demonstra como criar um **selecione** procedimento armazenado para cada tabela no banco de dados selecionado.|  
