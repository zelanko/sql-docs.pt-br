...
-   Lançada no [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], uma nova família de agrupamentos de SC (caracteres suplementares) pode ser usada com os tipos de dados `nchar`, `nvarchar` e `sql_variant`. Por exemplo: `Latin1_General_100_CI_AS_SC`ou, ao usar um agrupamento japonês, `Japanese_Bushu_Kakusu_100_CI_AS_SC`.  
...
|Tarefa|Tópico|  
|----------|-----------|  
|Descreve como definir ou alterar o agrupamento da instância de SQL Server.|[Definir ou alterar o agrupamento do servidor](set-or-change-the-server-collation.md)|  
...
|Descreve como definir ou alterar o agrupamento de uma coluna no banco de dados.|[Definir ou alterar o agrupamento de coluna](set-or-change-the-column-collation.md)|  
|Descreve como retornar informações de agrupamento ao servidor, banco de dados ou nível de coluna.|[Exiba informações de agrupamento](view-collation-information.md)|  
