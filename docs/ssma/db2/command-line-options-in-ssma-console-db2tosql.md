...
ms.openlocfilehash: 2ccd9278967b897bdf8e5200479c6d4100eec05c
...
Você não pode inserir qualquer outra opção ou senha como o parâmetro de linha de comando. Caso contrário, isso resulta em erro. Para obter mais informações, consulte o [gerenciar senhas](http://msdn.microsoft.com/en-us/56d546e3-8747-4169-aace-693302667e94) seção.  
