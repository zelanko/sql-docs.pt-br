...
|objtype|**nvarchar(16)**|Tipo de objeto. Abaixo estão os valores possíveis e suas descrições correspondentes.<br /><br /> Processo: Procedimento armazenado<br />Preparado: Instrução preparada<br />Ad hoc: Consulta Ad hoc. Refere-se ao [!INCLUDE[tsql](../../includes/tsql-md.md)] enviado como eventos de idioma usando **osql** ou **sqlcmd** em vez de como chamadas de procedimento remoto.<br />ReplProc: Replicação de procedimento de filtro<br />Gatilho: gatilho<br />Modo de exibição: modo de exibição<br />Padrão: padrão<br />UsrTab: Tabela de usuário<br />SysTab: Tabela do sistema<br />Verificação: Restrição de verificação<br />Regra: regra|  
