...
ms.topic: "article"
helpviewer_keywords: 
  - "pacote [Integration Services], eventos"
  - "eventos [Integration Services], pacote"
...
---
# Eventos registrados em log por um pacote do Integration Services
...
## Mensagens sobre o status do pacote  
...
## Mensagens associadas ao log de pacote  
...
### Mensagens sobre os estágios da execução do pacote.  
...
### Mensagens sobre eventos que ocorrem  
...
## Tarefas relacionadas  
 Para obter informações sobre como exibir entradas de log em tempo real, consulte [Exibir entradas de log na janela Eventos de Log](../../integration-services/performance/view-log-entries-in-the-log-events-window.md).  
  
## Consulte também  
 [Eventos registrados em log pelo serviço Integration Services Service](../../integration-services/service/events-logged-by-the-integration-services-service.md)  
