...
# <a name="relationaldatasource-data-type-assl"></a>Tipo de dados RelationalDataSource (ASSL)
  Define um tipo de dados derivado que representa um [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) elemento com base em uma fonte de dados relacional.  
