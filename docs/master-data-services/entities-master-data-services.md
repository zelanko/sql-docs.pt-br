---
title: Entidades
description: As entidades são objetos contidos em modelos de Master Data Services. Cada entidade contém membros, que são as linhas de dados mestre que você gerencia.
ms.custom: ''
ms.date: 04/01/2016
ms.prod: sql
ms.prod_service: mds
