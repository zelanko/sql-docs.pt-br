...
|**-x**|Desabilita os seguintes recursos de monitoramento:<br /><br /> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] contadores de monitoramento de desempenho<br /><br /> Manutenção da hora da CPU e as estatísticas de taxa de acertos de cache<br /><br /> Coleta de informações para o comando DBCC SQLPERF<br /><br /> Coleta de informações por algumas exibições de gerenciamento dinâmico<br /><br /> Muitos pontos de evento dos eventos estendidos<br /><br /> <br /><br /> ** \* Aviso \* \* ** Quando você usa a opção **-x** Startup, as informações disponíveis para diagnosticar problemas de desempenho e funcionais com [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o são muito reduzidas.|  
