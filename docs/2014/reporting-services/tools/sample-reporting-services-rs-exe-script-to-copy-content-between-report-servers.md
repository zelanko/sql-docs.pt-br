---
title: Exemplo Reporting Services rs.exe Script para migrar conteúdo entre servidores de relatório | Microsoft Docs
ms.custom: ''
ms.date: 07/27/2015
...
-   [!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)]  
 ...
 O script pode ser usado para copiar o conteúdo entre servidores de relatório do mesmo modo ou de modos diferentes. Por exemplo, você pode executar o script para copiar conteúdo de um [!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)] servidor de relatório de modo nativo para um [!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)] servidor de relatório do modo do SharePoint. Você pode executar o script de qualquer servidor no qual o RS.exe esteja instalado. Por exemplo, na implantação a seguir, você pode:  
...
-   SOURCE_URL e TARGET_URL devem ser URLs do servidor de relatório válido que apontam para a origem e destino [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] servidor de relatório. No modo nativo, uma URL de servidor de relatório é semelhante à seguinte:  
