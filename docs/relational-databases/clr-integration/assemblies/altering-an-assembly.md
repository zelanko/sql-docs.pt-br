...
description: Use ALTER ASSEMBLY para atualizar assemblies registrados no SQL Server. Você também pode alterar o conjunto de permissões e adicionar o código-fonte ou outros arquivos para um assembly.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
