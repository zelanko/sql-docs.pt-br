...
Antes de usar Hadoop com o SQL Server PDW, peça ao administrador do dispositivo para instalar o Java Runtime Environment para SQL Server PDW. Para obter instruções, consulte [configurar conectividade do PolyBase para dados externos &#40; Analytics Platform System &#41; ](configure-polybase-connectivity-to-external-data.md) nas operações de dispositivo guia.  
