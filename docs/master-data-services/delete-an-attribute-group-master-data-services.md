---
description: Excluir um grupo de atributos (Master Data Services)
...
5.  Na página **Gerenciar Grupos de Atributos** , selecione o tipo de membro na lista suspensa **Tipos de Membro** para expandir **Folha**, **Consolidado**ou **Coleção**, dependendo do tipo de grupo que você deseja excluir.  
