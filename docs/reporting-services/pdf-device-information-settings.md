...
|**EmbedFonts**|Indica se as fontes devem ser inseridas no arquivo PDF, que é maior em tamanho, mas as fontes de relatório serão renderizadas corretamente para todos os clientes. Um valor de **nenhum** desabilita A inserção de fonte.|  
