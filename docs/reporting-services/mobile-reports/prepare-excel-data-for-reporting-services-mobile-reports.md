...
---
# Preparar dados do Excel para relat&#243;rios m&#243;veis do Reporting Services
...
## Local do arquivo e atualização de dados do Excel  
...
>**Observação**: o [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)] não atualiza automaticamente os dados do Excel. Você poderá atualizar os dados por meio do comando **atualizar** do [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)], mas somente se o arquivo não tiver sido movido.  
