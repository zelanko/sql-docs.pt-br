...
> [!NOTE]  
>  Chamá-lo partir [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] ou [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], use o nome **DM pdw_nodes_db_partition_stats**. O partition_id no DM pdw_nodes_db_partition_stats difere de partition_id na exibição do catálogo sys. Partitions SQL Data Warehouse do Azure.
  
|Nome da coluna|Tipo de dados|Descrição|  
|-----------------|---------------|-----------------|  
|**partition_id**|**bigint**|ID da partição. É exclusiva em um banco de dados. Isso é o mesmo valor que o **partition_id** na **sys. Partitions** exibição, exceto para o Azure SQL Data Warehouse do catálogo.|  
