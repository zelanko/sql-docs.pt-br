...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Lock:Cancel** indica que a aquisição de um bloqueio em um recurso foi cancelada; por exemplo, devido ao cancelamento de uma consulta.  
