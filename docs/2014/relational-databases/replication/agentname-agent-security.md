...
-   Para assinaturas push, a conexão local é a conexão com o distribuidor, portanto esse campo sempre exibirá: **Representar '\<domínio >\\< Login\>'** ou **Impersonate '\<computador >\\< Login\>'** para envio por push assinaturas.  
...
-   Para assinaturas push, a conexão local é a conexão com o publicador e distribuidor, portanto esse campo sempre exibirá: **Representar '\<domínio >\\< Login\>'** ou **Impersonate '\<computador >\\< Login\>'** para envio por push assinaturas.  
...
-   Para assinaturas pull, a conexão local é a conexão com o assinante, portanto esse campo sempre exibirá: **Representar '\<domínio >\\< Login\>'** ou **Impersonate '\<computador >\\< Login\>'** para envio por push assinaturas.  
