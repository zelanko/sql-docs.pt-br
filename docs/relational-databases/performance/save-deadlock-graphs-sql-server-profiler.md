...
ms.topic: "article"
helpviewer_keywords: 
  - "deadlocks [SQL Server], salvando gráficos de deadlock"
  - "gráficos [SQL Server]"
  - "salvando gráficos de deadlock"
...
---
# Salvar gr&#225;ficos de deadlock (SQL Server Profiler)
...
### Para salvar eventos de gráfico de deadlock separadamente  
