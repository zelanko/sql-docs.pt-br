...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Uma **GeometryCollection** é uma coleção de zero ou mais instâncias de **geometry** ou de **geography**. Uma **GeometryCollection** pode estar vazia.  
