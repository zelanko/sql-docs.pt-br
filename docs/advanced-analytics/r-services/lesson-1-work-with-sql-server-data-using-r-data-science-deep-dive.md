---
title: "Li&#231;&#227;o 1: Trabalhar com dados do SQL Server usando o R (Aprofundamento da ci&#234;ncia de dados) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "09/30/2016"
...
---
# Li&#231;&#227;o 1: Trabalhar com dados do SQL Server usando o R (Aprofundamento da ci&#234;ncia de dados)
...
> [!NOTE]  
> Se você só estiver lendo dados, a conta que executa os scripts do R exigirá somente as permissões SELECT (função **db_datareader**) no banco de dados especificado. No entanto, neste tutorial, você precisará de privilégios de administrador DDL para preparar o banco de dados e criar tabelas para salvar os resultados da pontuação.  
...
## Consulte também  
[Aprofundamento da ciência de dados](http://msdn.microsoft.com/library/mt637368(SQL.130).aspx)  
