---
description: Exemplo de código ADO de propriedades NumericScale e Precision (VB)
title: Exemplo de código ADO de propriedades NumericScale e Precision (VB) | Microsoft Docs
ms.prod: sql
