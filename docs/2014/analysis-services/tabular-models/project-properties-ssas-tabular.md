...
-   [Para definir as configurações de propriedade de opções de implantação e servidor de implantação](#bkmk_conf_proj_settings)  
...
###  <a name="bkmk_conf_proj_settings"></a> Para definir as configurações de propriedade de opções de implantação e servidor de implantação  
