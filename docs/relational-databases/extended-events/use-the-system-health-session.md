...
description: A sessão de Eventos Estendidos system_health está incluída no SQL Server. Esta sessão coleta dados do sistema para solucionar problemas de desempenho para o Mecanismo de Banco de Dados.
ms.date: 11/27/2018
ms.prod: sql
