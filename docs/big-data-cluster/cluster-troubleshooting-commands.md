...
description: Este artigo fornece comandos úteis para monitorar e solucionar problemas de um cluster de Big Data do SQL Server 2019 (versão prévia).
