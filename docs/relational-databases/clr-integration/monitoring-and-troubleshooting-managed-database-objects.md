...
|evento|Descrição|  
|-----------|-----------------|  
|[Classe de evento Assembly Load](../event-classes/sql-server-event-class-reference.md)|Usado para monitorar solicitações de carregamento de assembly (com êxito e com falha).|  
