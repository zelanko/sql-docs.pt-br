...
description: Use a função RowNumber no Construtor de Relatórios para retornar uma contagem contínua do número de linhas para o escopo especificado.
ms.date: 03/07/2017
