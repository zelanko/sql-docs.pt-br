...
-   Para obter informações sobre configurações de GUI, consulte [configurações de projeto (GUI) (SSMA Common)](../sybase/project-settings-gui-sybasetosql.md).  
