...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: SQL:BatchCompleted event class
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento SQL:BatchCompleted indica que o lote [!INCLUDE[tsql](../../includes/tsql-md.md)] foi concluído.  
