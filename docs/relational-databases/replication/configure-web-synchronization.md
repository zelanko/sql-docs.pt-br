---
description: Configurar Sincronização da Web
...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]: [Configurar o IIS para sincronização da Web](./configure-iis-7-for-web-synchronization.md)  
