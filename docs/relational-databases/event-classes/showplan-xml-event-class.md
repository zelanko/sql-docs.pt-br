---
description: classe de evento Showplan XML
...
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
 ...
 Os documentos Showplan XML têm um esquema associado a eles. Esse esquema pode ser encontrado no [site da Microsoft](/previous-versions/aa720019(v=vs.71)) ou como parte da instalação do [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
