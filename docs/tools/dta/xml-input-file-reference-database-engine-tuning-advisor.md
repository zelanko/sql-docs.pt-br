...
description: Este artigo resume os elementos disponíveis para um arquivo de entrada XML que o Orientador de Otimização do Mecanismo de Banco de Dados usa para ajustar um banco de dados.
ms.prod: sql
