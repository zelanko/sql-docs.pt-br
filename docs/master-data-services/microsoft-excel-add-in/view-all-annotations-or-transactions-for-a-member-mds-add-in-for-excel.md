...
-   A entidade **Tipo de Log de Transações** deve ser **Membro** ou **Atributo**.  
...
2.  Clique com o botão direito do mouse no menu exibido e clique em **Exibir Transações** ou **Exibir Histórico**.  
