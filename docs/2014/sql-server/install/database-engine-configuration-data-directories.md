...
## <a name="see-also"></a>Consulte Também  
 [Locais de arquivo para instâncias padrão e nomeadas de SQL Server](../../../2014/sql-server/install/file-locations-for-default-and-named-instances-of-sql-server.md)   
