...
description: Descubra como criar um banco de dados no SQL Server 2019 usando o SQL Server Management Studio ou o Transact-SQL. Veja as recomendações para o procedimento.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
