...
description: Saiba mais sobre os métodos padrão do OLE DB que dão suporte a parâmetros com valor de tabela no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
