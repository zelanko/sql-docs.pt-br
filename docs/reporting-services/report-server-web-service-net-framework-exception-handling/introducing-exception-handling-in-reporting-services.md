...
description: Saiba como tratar exceções geradas pelo serviço Web Servidor de Relatórios para que você possa retornar informações úteis para os usuários quando ocorrerem erros.
ms.date: 03/14/2017
