...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento PreConnect:Completed indica quando a execução de um gatilho LOGON ou da função de classificação do Resource Governor é concluída.  
