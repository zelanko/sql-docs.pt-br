---
description: Suporte ao tipo de parâmetro OLE DB Table-Valued no SQL Server Native Client (métodos)
title: Tipo de parâmetro de Table-Valued OLE DB (métodos)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97484938"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-methods"></a>Suporte ao tipo de parâmetro OLE DB Table-Valued no SQL Server Native Client (métodos)
