---
title: UpdateBatch e exemplo dos métodos CancelBatch (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35282665"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vb"></a>Exemplo de métodos de CancelBatch (VB) e UpdateBatch
