...
|------------------------|-----------------|  
|[Fonte](source-element-xmla.md), [Destino](../xml-elements-properties/target-element-xmla.md)|1-1: elemento obrigatório que ocorre apenas uma única vez.|  
