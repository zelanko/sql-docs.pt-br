...
## <a name="fact-dimension-relationships"></a>Relações de dimensão de fato  
 ...
 As ![colunas na tabela de fatos podem dar suporte a dimensões] As (https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-factdim.gif "colunas na tabela de fatos podem dar suporte a dimensões")  
