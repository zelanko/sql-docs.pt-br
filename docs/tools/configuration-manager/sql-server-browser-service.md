...
description: Saiba como usar o SQL Server Browser, um serviço que escuta solicitações para recursos do SQL Server e fornece informações sobre as instâncias do SQL Server instaladas.
