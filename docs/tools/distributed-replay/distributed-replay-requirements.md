...
-   [!INCLUDE[ssSQL15](../../includes/sssqlv14-md.md)]  Atualização cumulativa 1 e posterior. Consulte - [atualizações cumulativas do SQL Server 2017](https://aka.ms/sql2017cu).
