...
ms.topic: "article"
helpviewer_keywords: 
  - "guia, arquitetura de gerenciamento de memória"
...
### <a name="providing-the-maximum-amount-of-memory-to-includessnoversiontokenssnoversionmdmd"></a>Fornecendo a quantidade máxima de memória para o [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]
...
<sup>4</sup> O [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Standard Edition oferece suporte a até 128 GB. O [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Enterprise Edition oferece suporte a, no máximo, o limite do sistema operacional.  
...
## <a name="memory-used-by-includessnoversiontokenssnoversionmdmd-objects-specifications"></a>Memória usada por especificações de objetos do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]
...
* Conexão do usuário: aproximadamente (3* *tamanho_do_pacote_de_rede + 94 KB)    
