...
# <a name="client-architecture-requirements-for-analysis-services-development"></a>Requisitos de arquitetura do cliente para o desenvolvimento do Analysis Services
 ...
 ![Arquitetura lógica do cliente para o Analysis Services](../../../analysis-services/dev-guide/media/as-clientarch9.gif "arquitetura lógica de cliente para o Analysis Services")  
 ...
 **HTTP** usada para conexões HTTP por meio do serviço de bomba de dados do SSAS ou por uma chamada para o componente do SharePoint PowerPivot Web Service (WS).  
  
 **INPROC** usada para conexões com o mecanismo no processo.  
  
 **CANAL** reservado para comunicações com o serviço de sistema do PowerPivot no farm do SharePoint.  
