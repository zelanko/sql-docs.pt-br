...
ms.openlocfilehash: 5fe17bb6adcf212e095780a7804ad190070d5b2a
...
|[updateBinaryStream (Java, Java.IO. InputStream)](../../../connect/jdbc/reference/updatebinarystream-method-java-lang-string-java-io-inputstream.md)|Atualiza a coluna designada com um valor de fluxo binário.|  
|[updateBinaryStream (Java, Java.IO. InputStream, int)](../../../connect/jdbc/reference/updatebinarystream-method-java-lang-string-java-io-inputstream-int.md)|Atualiza a coluna designada com um valor de fluxo binário que terá o número de bytes especificado.|  
|[updateBinaryStream (Java, Java.IO. InputStream, long)](../../../connect/jdbc/reference/updatebinarystream-method-java-lang-string-java-io-inputstream-long.md)|Atualiza a coluna designada com um valor de fluxo binário que terá o número de bytes especificado.|  
