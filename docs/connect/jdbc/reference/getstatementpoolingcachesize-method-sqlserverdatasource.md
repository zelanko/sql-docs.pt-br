...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Retorna o valor da propriedade de conexão **statementPoolingCacheSize** . Retorna o tamanho do cache de instruções preparado para esta conexão. ' 0 ' significa que o Caching não está habilitado.
