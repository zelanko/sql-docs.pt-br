...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Biblioteca que dá suporte à funcionalidade do SQL Server no Visual Studio.  
