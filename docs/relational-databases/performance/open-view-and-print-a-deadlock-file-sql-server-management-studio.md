...
ms.topic: "article"
helpviewer_keywords: 
  - "deadlocks [SQL Server], imprimindo arquivos"
  - "deadlocks [SQL Server], abrindo arquivos"
  - "abrindo arquivos de deadlock"
  - "imprimindo arquivos de deadlock"
...
---
# Abrir, exibir e imprimir um arquivo de deadlock (SQL Server Management Studio)
...
### Para abrir e exibir um arquivo de deadlock  
...
### Para imprimir um arquivo de deadlock  
