...
description: Descubra a função Level no Construtor de Relatórios. A função retorna o nível de profundidade atual em uma hierarquia recursiva.
ms.date: 03/07/2017
