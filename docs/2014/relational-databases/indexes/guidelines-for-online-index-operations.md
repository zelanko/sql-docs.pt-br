...
-   Os índices clusterizados devem ser criados, recriados ou descartados offline quando a tabela subjacente contiver os seguintes tipos de dados LOB `image`(objeto grande) `text`:, **ntext**e.  
