...
> - [Introdução à TDE (Transparent Data Encryption) no SQL Data Warehouse](/azure/synapse-analytics/sql-data-warehouse/sql-data-warehouse-encryption-tde-tsql)
