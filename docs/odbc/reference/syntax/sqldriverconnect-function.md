...
4.  Carrega o driver examinando a entrada do registro HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBCINST.INI\\<nome do driver \> \Driver \<Driver Name> , onde é especificado pela palavra-chave do **Driver** .  
