...
-   Propriedades, como `Name` e `Description`, que descrevem objetos.  
  
-   Tipos de dados, como `Binding` e `Permission`, que são usados para definir os elementos filho e as propriedades de outros objetos.  
  
    > [!NOTE]  
    >  Esta seção não abrange elementos de tipo de dados. Para obter mais informações, consulte, [Analysis Services Scripting Language tipos de dados XML &#40;ASSL&#41;](data-type/analysis-services-scripting-language-xml-data-types-assl.md).  
  
## <a name="in-this-section"></a>Nesta seção  
  
|Tópico|Description|  
|-----------|-----------------|  
|[Objetos &#40;ASSL&#41;](objects/objects-assl.md)|Contém a sintaxe e informações de uso para cada elemento que age como um objeto no esquema ASSL.|  
|[Coleções &#40;ASSL&#41;](collections/collections-assl.md)|Contém a sintaxe e informações de uso para cada elemento que age como uma coleção no esquema ASSL.|  
