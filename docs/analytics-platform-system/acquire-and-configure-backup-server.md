...
description: Este artigo descreve como configurar um sistema do Windows não seja de aplicação como um servidor de backup para uso com os recursos de backup e restauração no Analytics Platform System (APS) e o Parallel Data Warehouse (PDW).
author: mzaman1
manager: craigg
ms.prod: sql
...
Este artigo descreve como configurar um sistema do Windows não seja de aplicação como um servidor de backup para uso com os recursos de backup e restauração no Analytics Platform System (APS) e o Parallel Data Warehouse (PDW).  
