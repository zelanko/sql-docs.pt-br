---
title: "Iniciador do Daemon de Filtro de Texto Completo do SQL (guia Fazer Logon) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Iniciador do Daemon de Filtro de Texto Completo do SQL (guia Fazer Logon)
 ...
 Use o **logon** Guia do **Propriedades de iniciador do Daemon de filtro de texto completo SQL** caixa de diálogo para especificar a conta usada pelo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] serviço de texto completo, para alterar a senha de uma conta e para iniciar e parar o serviço. A alteração da senha de uma conta entra em vigor após o reinício do serviço.  
 ...
 **Serviço de Rede**  
 É recomendável que você não use a conta de serviço de rede para o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] serviços ou o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Serviços de agente. As contas de Usuário Local ou Usuário de Domínio são mais apropriadas para esses serviços.  
