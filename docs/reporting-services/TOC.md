# [Visão geral](create-deploy-and-manage-mobile-and-paginated-reports.md)
...
# Planejamento
## [Escolhendo Ferramentas de Microsoft Business Intelligence (BI) para análise e relatório](choosing-microsoft-business-intelligence-bi-tools-for-analysis-and-reporting.md)  
## [Suporte ao navegador para Reporting Services e Power View](browser-support-for-reporting-services-and-power-view.md)  
## [Planejar a implantação de relatório e design de relatório | O Reporting Services](plan-for-report-design-and-report-deployment-reporting-services.md)  
...
## [Trabalhando com conjuntos de dados compartilhados (portal da web)](work-with-shared-datasets-web-portal.md)  
...
# [Trabalhando com relatórios](../reporting-services/reports/reporting-services-reports-ssrs.md)
...
## [Gerenciador de usuários do SharePoint de alertas de dados](data-alert-manager-for-sharepoint-users.md)  
...
## [Serviço web servidor de relatório](../reporting-services/report-server-web-service/accessing-the-soap-api.md)
...
### [Configurações de informações de dispositivo da imagem](image-device-information-settings.md)  ### [configurações de informações do dispositivo MHTML](mhtml-device-information-settings.md)  
...
### [Lição 1: Criando um projeto do servidor de relatório](lesson-1-creating-a-report-server-project-reporting-services.md)
### [Lição 2: Especificando informações de Conexão](lesson-2-specifying-connection-information-reporting-services.md)
...
### [Lição 5: Formatando um relatório](lesson-5-formatting-a-report-reporting-services.md)  
### [Lição 6: Adicionando agrupamentos e totais](lesson-6-adding-grouping-and-totals-reporting-services.md)  
...
### [Lição 2: Definir uma Conexão de dados e a tabela de dados para o relatório pai](lesson-2-define-a-data-connection-and-data-table-for-parent-report.md)  
...
### [Lição 4: Definir uma Conexão de dados e a tabela de dados para o relatório filho](lesson-4-define-a-data-connection-and-data-table-for-child-report.md)  
...
### [Lição 7: Adicionar ação de detalhamento no relatório pai](lesson-7-add-drillthrough-action-on-parent-report.md)  
...
### [Tutorial: Criando um relatório de forma livre](tutorial-creating-a-free-form-report-report-builder.md)  
...
### [Tutorial: Criando relatórios principais e detalhamento](tutorial-creating-drillthrough-and-main-reports-report-builder.md)  
