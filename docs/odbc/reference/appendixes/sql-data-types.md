...
|SQL_LONGVARCHAR|LONG VARCHAR|Dados de caracteres de comprimento variável. O comprimento máximo é dependente da fonte de dados. 99|  
...
|SQL_WLONGVARCHAR|LONGWVARCHAR|Dados de caractere de comprimento variável Unicode. O comprimento máximo é dependente da fonte de dados|  
