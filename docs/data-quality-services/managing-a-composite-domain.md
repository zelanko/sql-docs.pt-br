---
title: "Gerenciando um dom&#237;nio composto | Microsoft Docs"
ms.custom: ""
ms.date: "07/31/2012"
...
---
# Gerenciando um dom&#237;nio composto
...
|||  
|-|-|  
|Crie uma representação semântica para um campo de dados que consiste em vários termos relacionados que não são analisados|[Create a Composite Domain](../data-quality-services/create-a-composite-domain.md)|  
|Quando você estiver mapeando dados complexos para um domínio composto, poderá analisar os dados com base no conhecimento, além de analisar um delimitador. O DQS tentará primeiro usar seu conhecimento sobre domínios únicos para determinar como as partes da cadeia de caracteres complexa pertencerão aos domínios únicos.|[Create a Composite Domain](../data-quality-services/create-a-composite-domain.md)|  
...
|Crie uma regra de domínio cruzado quando o valor de um domínio em um domínio composto afetar o valor de outro.|[Create a Cross-Domain Rule](../data-quality-services/create-a-cross-domain-rule.md)|  
|Identifique as combinações de valor para que o DQS possa relatar sua frequência.|[Use Value Relations in a Composite Domain](../data-quality-services/use-value-relations-in-a-composite-domain.md)|  
