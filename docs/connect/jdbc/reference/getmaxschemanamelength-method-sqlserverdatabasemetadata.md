---
description: Método getMaxSchemaNameLength (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>Comentários  
 Esse método getMaxSchemaNameLength é especificado pelo método getMaxSchemaNameLength na interface java.sql.DatabaseMetaData.  
