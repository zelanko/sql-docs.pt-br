---
title: A configuração de nó de cluster | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Nome da Instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]** – Use a lista suspensa para selecionar a instância de cluster de failover do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] a ser modificada.  
