...
# <a name="maximum-capacity-specifications-for-sql-server"></a>Especificações de capacidade máxima do SQL Server
 ...
 [Mecanismo de Banco de Dados objetos do SQL Server](#Engine)  
  
 [Objetos Utilitário do SQL Server](#Utility)  
  
 [SQL Server objetos de aplicativo da camada de dados](#DAC)  
  
 [Objetos Replicação do SQL Server](#Replication)  
  
##  <a name="Engine"></a>[!INCLUDE[ssDE](../includes/ssde-md.md)] Objetos do  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssDE](../includes/ssde-md.md)] objeto do|Tamanhos/números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] máximos (32 bits)|Tamanho máximo/números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64 bits)|  
|---------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
...
|Bytes por linha<br /><br /> Observação:<br />        
...
|
  [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Objeto do utilitário|Tamanhos/números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] máximos (32 bits)|Tamanho máximo/números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64 bits)|  
|----------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
...
|
  [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] DAC|Tamanhos/números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] máximos (32 bits)|Tamanho máximo/números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64 bits)|  
|------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
