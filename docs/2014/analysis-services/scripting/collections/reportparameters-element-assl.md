...
ms.locfileid: "37282102"
---
# <a name="reportparameters-element-assl"></a>Elemento ReportParameters (ASSL)
  Contém a coleção de [ReportParameter](../objects/reportparameter-element-assl.md) elementos para um [ReportAction](../data-type/action-data-type-assl.md) elemento.  
...
|Elementos filho|[ReportParameter](../objects/reportparameter-element-assl.md)|  
