...
description: Saiba mais sobre os Utilitários de Linha de Comando do SQL Server Reporting Services usados para administrar um servidor de relatório.
ms.date: 03/14/2017
