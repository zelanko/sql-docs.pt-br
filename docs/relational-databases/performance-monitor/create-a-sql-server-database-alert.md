...
description: Você pode usar o Monitor do Sistema para criar um alerta de banco de dados do SQL Server que é acionado quando um valor limite de um contador do Monitor do Sistema é alcançado.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
