---
description: STPointFromText (tipo de dados geography)
 ...
 *point_tagged_text*  
 É a representação WKT da instância de **geographyPoint** que você deseja retornar. *point_tagged_text* é uma expressão **nvarchar(max)**.  
