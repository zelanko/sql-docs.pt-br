---
title: Acesso à URL | Microsoft Docs
description: Saiba como o acesso à URL do servidor de relatório no SSRS (SQL Server Reporting Services) permite enviar comandos a um servidor de relatório por meio de uma solicitação de URL.
ms.date: 03/03/2017
