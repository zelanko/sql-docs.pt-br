...
**Selecionar tudo**  
Marque esta caixa de seleção para selecionar todos os bancos de dados na lista.  
  
**Desmarcar tudo**  
Marque esta caixa de seleção para cancelar a seleção de todos os bancos de dados na lista.  
