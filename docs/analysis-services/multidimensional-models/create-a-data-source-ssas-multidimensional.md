...
helpviewer_keywords: 
  ...
  - "fontes de dados [Analysis Services], criando"
  - "segurança [Analysis Services ], conexões da fonte de dados"
...
### Definindo informações de representação para objetos de mineração de dados  
