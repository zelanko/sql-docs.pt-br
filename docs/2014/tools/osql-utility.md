...
> [!IMPORTANT]  
>  Esse recurso será removido em uma versão futura do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. Evite usar esse recurso em novo trabalho de desenvolvimento e planeje modificar os aplicativos que utilizam o recurso atualmente. Use **sqlcmd** em vez disso. Para saber mais, confira [sqlcmd Utility](sqlcmd-utility.md).  
...
> [!NOTE]  
>  O utilitário **osql** não dá suporte a tipos de dados CLR definidos pelo usuário. Para processar esses tipos de dados, você deve usar o utilitário **sqlcmd** . Para saber mais, confira [sqlcmd Utility](sqlcmd-utility.md).  
...
## <a name="displaying-money-and-smallmoney-data-types"></a>Exibindo Tipos de Dados money e smallmoney  
 o **osql** exibe os `money` tipos de dados e `smallmoney` com duas casas decimais, embora [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] armazene o valor internamente com quatro casas decimais. Considere o exemplo:  
