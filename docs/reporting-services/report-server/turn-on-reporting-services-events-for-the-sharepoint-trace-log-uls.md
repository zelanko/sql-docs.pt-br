...
|Gerenciador de configuração do servidor de relatório|Entradas de exemplo:<br /><br /> Url interna de servidor de relatório MediumUsing http://localhost:80/ReportServer.<br /><br /> UnexpectedMissing ou configuração ExtendedProtectionLevel inválida|  
