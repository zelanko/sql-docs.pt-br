---
title: "Recuperar um banco de dados sem restaurar dados (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "restaurando [replicação do SQL Server], somente recuperação"
  - "cenário somente recuperação [Controles do Visualizador de]"
  - "restaurando bancos de dados [SQL Server], somente recuperação"
  - "recuperação [SQL Server], somente recuperação"
  - "recuperação do banco de dados [SQL Server]"
  - "restaurações de banco de dados [SQL Server], somente recuperação"
  - "recuperação [SQL Server], sem restaurar dados"
...
-   O banco de dados está em modo de espera e você quer atualizá-lo sem aplicar outro backup de log.  
 ...
 A sintaxe [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) para a restauração de um banco de dados somente recuperação é a seguinte:  
...
## Restauração de arquivo somente recuperação  
 ...
 A sintaxe [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) para a restauração de um arquivo somente recuperação é:  
