...
# <a name="aggregationdesignattribute-data-type-assl"></a>Tipo de dados AggregationDesignAttribute (ASSL)
  Define um tipo de dados primitivo que representa a associação entre um atributo e um [AggregationDesignDimension](../../../analysis-services/scripting/data-type/aggregationdesigndimension-data-type-assl.md) elemento.  
