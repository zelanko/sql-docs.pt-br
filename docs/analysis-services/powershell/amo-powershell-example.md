---
title: "Exemplo de AMO PowerShell | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Exemplo de AMO PowerShell
  Abaixo está um exemplo de script do PowerShell que chama os tipos de Objeto de Gerenciamento (AMO) do Analysis Services para criar um banco de dados de tabela (nível de compatibilidade 1200) com base em um banco de dados relacional do SQL Server.  
  
 Este exemplo é para fins de demonstração. Ele não chega a definir relações de tabela e não inclui a importação de dados.  Isso torna o script mais um trecho de código do que um código de leitura para execução. Para que seja executável, seriam necessárias outras funções auxiliares e mais comandos para preencher as lacunas.  
  
## Exemplo DatabaseGenerate.ps1  
...
## Consulte também  
 ...
 [Referência do Analysis Services PowerShell](../../analysis-services/powershell/analysis-services-powershell-reference.md)   
 [Objetos de Gerenciamento do Analysis Services &#40;AMO&#41;](../Topic/Analysis%20Services%20Management%20Objects%20\(AMO\).md)   
