...
|Evento|Description|  
|-----------|-----------------|  
|[Classe de evento Assembly Load](https://msdn.microsoft.com/library/cfb0b69d-4ce0-4067-a3df-d82775e57886)|Usado para monitorar solicitações de carregamento de assembly (com êxito e com falha).|  
