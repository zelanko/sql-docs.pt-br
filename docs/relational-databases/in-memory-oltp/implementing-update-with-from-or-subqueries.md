...
description: Saiba quais elementos de sintaxe que têm suporte na instrução UPDATE do Transact-SQL, em um módulo do T-SQL compilado nativamente.
ms.custom: ''
ms.date: 11/17/2016
ms.prod: sql
