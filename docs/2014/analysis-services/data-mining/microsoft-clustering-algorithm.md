...
# <a name="microsoft-clustering-algorithm"></a>Algoritmo Microsoft Clustering
 ...
 ![Padrão de tendências de comutador de cluster](../media/clustering-example.gif "padrão de tendências de comutador de Cluster")  
