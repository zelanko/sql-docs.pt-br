...
|mode|**nvarchar(16)**|O modo de dentro do tipo de execução.|Para operation_type = **BACKUP**<br />**DIFFERENTIAL**<br />**FULL**<br /><br /> Para operation_type = **carga**<br />**APPEND**<br />**RELOAD**<br />**UPSERT**<br /><br /> Para operation_type = **RESTAURAR**<br />**DATABASE**<br />**HEADER_ONLY**|  
...
|status|**nvarchar(16)**|Status da execução.|'CANCELLED','COMPLETED','FAILED','QUEUED','RUNNING'|  
