...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contém as informações de identificação do servidor no qual residem os bancos de dados que você deseja ajustar.  
