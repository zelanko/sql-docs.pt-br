...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: SP:CacheInsert event class
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento SP:CacheInsert indica que o procedimento armazenado foi inserido no cache de procedimento.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Classe de evento SP:CacheMiss](../../relational-databases/event-classes/sp-cachemiss-event-class.md)  
