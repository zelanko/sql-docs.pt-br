...
[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull_md.md)] fornece um ambiente rico para o gerenciamento e o desenvolvimento de consultas no [!INCLUDE[ssNoVersion](../includes/ssnoversion_md.md)].  
