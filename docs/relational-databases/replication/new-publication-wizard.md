...
---
# <a name="new-publication-wizard"></a>Assistente para Nova Publicação
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Esta seção fornece informações sobre as seguintes páginas do Assistente para Nova Publicação:  
...
-   [Banco de dados de publicação](../../relational-databases/replication/publication-database.md)  
  
-   [Tipo de Publicação](../../relational-databases/replication/publication-type.md)  
  
-   [Tipos de Assinantes](../../relational-databases/replication/subscriber-types.md)  
  
-   [Agent Security &#40;New Publication Wizard&#41; [Segurança do agente (Assistente para nova publicação)]](../../relational-databases/replication/agent-security-new-publication-wizard.md)  
  
-   [Artigos](../../relational-databases/replication/articles.md)  
  
-   [Problemas do Artigo](../../relational-databases/replication/article-issues.md)  
  
-   [Filtrar Linhas da Tabela](../../relational-databases/replication/filter-table-rows.md)  
  
-   [Adicionar ou Editar Filtro](../../relational-databases/replication/add-or-edit-filter.md)  
  
-   [Adicionar ou Editar Junção](../../relational-databases/replication/add-or-edit-join.md)  
  
-   [Gerar Filtros](../../relational-databases/replication/generate-filters.md)  
  
-   [Snapshot Agent &#40;New Publication Wizard&#41; [Agente de instantâneo (Assistente para nova publicação)]](../../relational-databases/replication/snapshot-agent-new-publication-wizard.md)  
