---
title: Especifique se uma operação de Backup ou restauração para ou continua depois de encontrar um erro (SQL Server) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
