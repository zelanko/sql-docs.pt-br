...
ms.locfileid: "62698972"
---
# <a name="audit-database-object-take-ownership-event-class"></a>Classe de evento Audit Database Object Take Ownership
  A classe de evento **Audit Database Object pega Ownership** ocorre quando ocorre uma alteração do proprietário de objetos dentro do escopo do banco de dados.  
