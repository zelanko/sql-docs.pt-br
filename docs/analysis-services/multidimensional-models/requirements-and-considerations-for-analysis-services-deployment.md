---
title: "Requisitos e considera&#231;&#245;es sobre a implanta&#231;&#227;o do Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "escalabilidade [Analysis Services]"
  - "espaço [Analysis Services]"
  - "implantações do Analysis Services, requisitos"
  - "implantando [Analysis Services], requisitos"
  - "espaço em disco [Analysis Services]"
  - "requisitos [Analysis Services]"
  - "processadores [Analysis Services]"
  - "requisitos de sistema [Analysis Services]"
  - "disponibilidade [Analysis Services]"
