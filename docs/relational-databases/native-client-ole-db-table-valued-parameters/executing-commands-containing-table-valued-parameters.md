---
description: Executando comandos de SQL Server Native Client contendo parâmetros Table-Valued
title: Comandos com parâmetros de Table-Valued
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "97419044"
---
# <a name="executing-sql-server-native-client-commands-containing-table-valued-parameters"></a>Executando comandos de SQL Server Native Client contendo parâmetros Table-Valued
