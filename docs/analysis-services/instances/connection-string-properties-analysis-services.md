---
title: "Propriedades de cadeia de conex&#227;o (Analysis Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
##  <a name="a-namebkmkcommona-connection-parameters-in-common-use"></a><a name="bkmk_common"></a> Parâmetros de conexão de uso comum  
...
##  <a name="a-namebkmkautha-authentication-and-security"></a><a name="bkmk_auth"></a> Autenticação e segurança  
...
##  <a name="a-namebkmkspeciala-special-purpose-parameters"></a><a name="bkmk_special"></a> Parâmetros para finalidades especiais  
...
##  <a name="a-namebkmkreserveda-reserved-for-future-use"></a><a name="bkmk_reserved"></a> Reservado para uso futuro  
...
##  <a name="a-namebkmkexamplesa-example-connection-strings"></a><a name="bkmk_examples"></a> Cadeias de conexão de exemplo  
...
##  <a name="a-namebkmksupportedstringsa-connection-string-formats-used-in-analysis-services"></a><a name="bkmk_supportedstrings"></a> Formatos de cadeia de conexão usados no Analysis Services  
 ...
 **Conexões de http(s) para pastas de trabalho do [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] (arquivos .xlsx, .xlsb ou .xlsm)**  
 ...
 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)], em que a URL é o caminho do SharePoint para uma pasta de trabalho do `Data Source=<URL>` publicada em uma biblioteca do SharePoint. Por exemplo, “Data Source=http://localhost/Shared Documents/Sales.xlsx”.  
...
##  <a name="a-namebkmkencrypta-encrypting-connection-strings"></a><a name="bkmk_encrypt"></a> Criptografando cadeias de conexão  
