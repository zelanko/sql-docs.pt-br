...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Conectando-se a um banco de dados SQL do Azure usando SQL Server Native Client](../../../relational-databases/native-client/applications/connecting-to-a-windows-azure-sql-database-using-sql-server-native-client.md)  
