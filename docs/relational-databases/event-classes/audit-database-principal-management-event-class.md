...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Database Principal Management** ocorre quando entidades, tais como usuários, são criadas, alteradas ou removidas de um banco de dados.  
