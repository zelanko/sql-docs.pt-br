...
### <a name="example-output-a-specified-schema-from-an-xml-schema-collection"></a>Exemplo: Um esquema especificado de uma coleção de esquemas XML de saída  
