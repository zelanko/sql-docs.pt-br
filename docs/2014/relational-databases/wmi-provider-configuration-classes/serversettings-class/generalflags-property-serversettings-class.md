...
## <a name="property-valuereturn-value"></a>Valor da propriedade/Valor do retorno  
 Uma matriz de objetos da [classe ServerSettingsGeneralFlag](../serversettingsgeneralflag-class/serversettingsgeneralflag-class.md) que especificam os sinalizadores gerais associados com a instância do [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
