...
![Captura de tela com a mensagem Estamos abrindo o Construtor de Relatórios.](../../reporting-services/report-builder/media/report-builder-get-report-builder.png) 
...
1.  No navegador da Web, digite a URL do servidor de relatório na barra de endereços. Por padrão, a URL é https://\<*servername*>/reports.  
