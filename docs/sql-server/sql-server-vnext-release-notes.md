...
---
# Notas de vers&#227;o do SQL Server vNext
...
- [Notas de versão do SQL Server Reporting Services](../reporting-services/notas-de-versão-de-reporting-services.md) são publicadas na seção Reporting Services.
