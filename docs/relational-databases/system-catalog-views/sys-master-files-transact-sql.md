...
|file_guid|**uniqueidentifier**|Identificador exclusivo do arquivo.<br /><br /> NULL = o banco de dados foi atualizado de uma [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] versão anterior do (válido para SQL Server 2005 e anterior).|  
