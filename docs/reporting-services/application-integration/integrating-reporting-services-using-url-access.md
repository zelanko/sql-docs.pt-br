---
title: "Integrar o Reporting Services usando o acesso à URL | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="in-this-section"></a>Nesta seção  
 [Usando o acesso à URL em um aplicativo Web](../../reporting-services/application-integration/integrating-reporting-services-using-url-access-web-application.md)  
