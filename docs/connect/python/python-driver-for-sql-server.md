...
![Download-DownArrow-Circled](../../ssdt/media/download.png)[Para instalar o driver SQL para Python](../sql-connection-libraries.md#anchor-20-drivers-relational-access)
