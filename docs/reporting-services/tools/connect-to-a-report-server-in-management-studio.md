...
3.  Na caixa de diálogo **Conectar-se ao Servidor** , digite uma URL de um site do SharePoint. O seguinte exemplo ilustra a sintaxe: `http://<web server>/sites/<site>`.  
