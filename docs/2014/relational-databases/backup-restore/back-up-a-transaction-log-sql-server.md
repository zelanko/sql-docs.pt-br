...
-   **Para fazer backup de um log de transações, usando:**  
    ...
    > [!NOTE]  
    >  Opcionalmente, é possível usar o [Assistente de Plano de Manutenção](../maintenance-plans/use-the-maintenance-plan-wizard.md) para criar backups.  
