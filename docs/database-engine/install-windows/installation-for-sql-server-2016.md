---
title: "Instala&#231;&#227;o do SQL Server 2016 | Microsoft Docs"
ms.custom: ""
ms.date: "04/13/2016"
...
helpviewer_keywords: 
  - "instalando o SQL Server, instalação inicial"
  - "instalação [SQL Server]"
  - "instalação inicial [SQL Server]"
...
-   Componentes de conectividade  
 ...
 A partir do SQL Server 2016, o SQL Server Management Tools não é mais instalado da árvore de recursos principal; para obter detalhes, veja [Instalar o SQL Server Management Tools com o SSMS](Install%20SQL%20Server%20Management%20Tools%20\(SSMS\).md)  
  
 Você pode instalar cada componente individualmente ou selecionar uma combinação dos componentes listados acima. Para escolher a melhor opção entre as edições e os componentes disponíveis no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], veja [Edições e componentes do SQL Server 2016](../../sql-server/editions-and-components-of-sql-server-2016.md) e [Recursos com suporte pelas edições do SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
...
-   Considerações sobre segurança.  
 ...
 [Referência da interface de usuário da instalação do SQL Server](../Topic/SQL%20Server%20Setup%20User%20Interface%20Reference.md)  
...
## Mais informações  
 [Instalar recursos de BI do SQL Server com o SharePoint &#40;Power Pivot e Reporting Services&#41;](../Topic/Install%20SQL%20Server%20BI%20Features%20with%20SharePoint%20\(Power%20Pivot%20and%20Reporting%20Services\).md)  
