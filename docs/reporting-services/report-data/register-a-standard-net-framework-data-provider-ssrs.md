...
4.  Adicione uma entrada para o provedor de dados do [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] .  
    ...
    |**Tipo**|Digite uma lista separada por vírgulas que inclui o namespace totalmente qualificado da classe que implementa o <xref:System.Data.IDbConnection> interface, seguido do nome do [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] assembly do provedor de dados (não incluindo a extensão de nome de arquivo. dll).|  
