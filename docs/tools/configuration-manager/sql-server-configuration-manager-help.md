...
description: Familiarize-se com o SQL Server Configuration Manager. Saiba como usá-lo para gerenciar serviços do SQL Server e configurar a conectividade de rede.
