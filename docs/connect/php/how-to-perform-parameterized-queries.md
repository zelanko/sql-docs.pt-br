---
title: 'Como fazer: Executar consultas parametrizadas'
description: Saiba como usar consultas parametrizadas em apenas algumas etapas usando os Drivers para PHP para SQL Server.
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
