...
description: Saiba como sys. remote_data_archive_tables contém uma linha para cada tabela remota que armazena dados de uma tabela local habilitada para Stretch.
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
