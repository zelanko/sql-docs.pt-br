---
title: Criar um relatório detalhado (RDLC) com parâmetros usando o ReportViewer (Tutorial SSRS) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="requirements"></a>Requisitos  
 Para usar este passo a passo, você deve ter acesso para o **AdventureWorks2008** banco de dados de exemplo. A consulta usada neste passo a passo também funcionará com **AdventureWorks2012** banco de dados. Para obter mais informações sobre como obter o **AdventureWorks2008** banco de dados de exemplo, consulte [passo a passo: Instalando o banco de dados AdventureWorks](http://msdn.microsoft.com/library/aa992075\(v=vs.100\).aspx) para Microsoft Visual Studio 2010.  
...
## <a name="tasks"></a>Tarefas  
 ...
 [Lição 2: Definir uma Conexão de dados e a tabela de dados para o relatório pai](../reporting-services/lesson-2-define-a-data-connection-and-data-table-for-parent-report.md)   
 ...
 [Lição 4: Definir uma Conexão de dados e a tabela de dados para o relatório filho](../reporting-services/lesson-4-define-a-data-connection-and-data-table-for-child-report.md)   
 ...
 [Lição 7: Adicionar ação de detalhamento no relatório pai](../reporting-services/lesson-7-add-drillthrough-action-on-parent-report.md)   
