...
# <a name="audit-login-change-password-event-class"></a>Classe de evento Audit Login Change Password
  A classe de evento **Audit login ALTER password** ocorre sempre que um usuário [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] altera sua senha de logon.  
