...
helpviewer_keywords: 
  ...
  - "conta de serviço [SQL Server], permissões do sistema de arquivos"
  - "permissões [SQL Server], sistema de arquivos"
...
6.  Na caixa Nomes de **grupo ou de usuário**, selecione o nome do SID por serviço e, na caixa **Permissões para** \<nome>, marque a caixa de seleção **Permitir** para **Controle total**.  
