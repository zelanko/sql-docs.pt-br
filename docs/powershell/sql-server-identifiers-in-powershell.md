...
description: Saiba mais sobre os caminhos usados pelos provedores do Windows PowerShell para expor hierarquias de dados e sobre a necessidade de codificar alguns caracteres sem suporte no PowerShell nesses caminhos.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
|Descreve como usar o caractere de escape do Windows PowerShell para caracteres sem suporte em caminhos do PowerShell.|[Escapar identificadores do SQL Server](escape-sql-server-identifiers.md)|  
