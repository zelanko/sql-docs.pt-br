---
title: Informações do fornecedor, assinatura Assista lista (publicação transacional, SQL Server 2005 e versões posterior) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
