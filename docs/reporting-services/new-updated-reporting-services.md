...
ms.component: ssrs
ms.date: 02/03/2018
ms.openlocfilehash: d836fbeb4ec7277ec533c8834c71a723961d7a67
...
1. [Como localizar a chave do produto (Product Key) para o SQL Server 2017 Reporting Services](install-windows/find-reporting-services-product-key-ssrs.md)
