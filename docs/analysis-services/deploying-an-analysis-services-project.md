---
title: "Implantando um projeto do Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
2.  No nó **Propriedades de Configuração** do painel esquerdo, clique em **Implantação**.  
    ...
    > [!NOTE]  
    > Caso queira implantar o projeto em uma instância nomeada do [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] no computador local ou em uma instância em um servidor remoto, altere a propriedade **Server** para o nome da instância apropriada, como \<*ServerName**>\\<**InstanceName**>*.  
...
[Navegando pelo cubo](../analysis-services/browsing-the-cube.md)  
