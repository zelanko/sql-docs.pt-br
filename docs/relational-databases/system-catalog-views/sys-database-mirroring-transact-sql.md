...
|**mirroring_end_of_log_lsn**|**numeric(25,0)**|O fim do log local que foi liberado para o disco. Isso é equivalente ao LSN intensificado do servidor espelho (consulte o **mirroring_failover_lsn** coluna).|  
