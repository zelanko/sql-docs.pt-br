...
-   Um grupo de medidas que representa as taxas de câmbio que serão usadas.  
 ...
 Para identificar uma dimensão como dimensão de moeda, defina o `Type` propriedade de dimensão para `Currency`.  
...
-   Para identificar um atributo como dimensão de moeda de destino, defina o `Type` propriedade do atributo `CurrencyDestination`.  
...
-   Um código de moeda da Organização de Padronização Internacional (ISO).  
     ...
     Para identificar um atributo como atributo de código ISO da moeda, defina o `Type` propriedade do atributo `CurrencyIsoCode`.  
