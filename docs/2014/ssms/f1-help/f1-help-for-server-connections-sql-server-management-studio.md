...
# <a name="f1-help-for-server-connections-sql-server-management-studio"></a>Ajuda F1 para conexões de servidor (SQL Server Management Studio)
 ...
 [Procurar servidores &#40;Local Servers&#41;](../../database-engine/browse-for-servers-local-servers.md)  
 ...
 [Conectar ao servidor &#40;página Propriedades da Conexão&#41; Mecanismo de Banco de Dados](connect-to-server-connection-properties-page-database-engine.md)  
 ...
 [Conectar ao servidor &#40;página Logon&#41; Mecanismo de Banco de Dados](connect-to-server-login-page-database-engine.md)  
