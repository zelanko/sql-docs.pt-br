...
# <a name="reporting-services-concepts-ssrs"></a>Conceitos do Reporting Services (SSRS)
  Este tópico fornece um breve resumo dos [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] conceitos.  
...
##  <a name="bkmk_ReportsandRelatedItemConcepts"></a>Relatórios e conceitos de itens relacionados  
 ...
 **Conjuntos de relatórios de relatório**  
...
## <a name="see-also"></a>Consulte Também  
 [Reporting Services recursos e tarefas &#40;SSRS&#41;](reporting-services-features-and-tasks-ssrs.md)   
