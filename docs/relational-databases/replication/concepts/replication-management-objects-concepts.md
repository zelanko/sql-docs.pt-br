...
-   Todas as informações de autenticação para estabelecer a conexão e fazer logon no servidor com êxito são fornecidas no objeto <xref:Microsoft.SqlServer.Management.Common.ServerConnection>.  
