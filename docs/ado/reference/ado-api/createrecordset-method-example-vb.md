...
Você pode criar um [registros](../../../ado/reference/ado-api/recordset-object-ado.md) do objeto e especifique as informações de coluna. Você pode inserir dados no **registros** objeto; os buffers de linhas subjacentes as inserções.  
 ...
 O exemplo de código a seguir mostra como definir um **registros** usando o [RDSServer.DataFactory](../../../ado/reference/rds-api/datafactory-object-rdsserver.md) objeto. Você também pode fazer isso com o [RDS. DataControl](../../../ado/reference/rds-api/datacontrol-object-rds.md) objeto.  
