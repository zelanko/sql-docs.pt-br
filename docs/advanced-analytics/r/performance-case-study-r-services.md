...
+ [Compreender NUMA](https://technet.microsoft.com/library/ms178144.aspx)
...
+ [Como criar um pool de recursos para o R](how-to-create-a-resource-pool-for-r.md)
