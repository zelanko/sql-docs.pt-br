---
title: "Adicionando conhecimento a uma base de dados de conhecimento | Microsoft Docs"
ms.custom: ""
ms.date: "06/04/2013"
...
-   Para obter mais informações na documentação, consulte [executar a descoberta de Conhecimento](../data-quality-services/perform-knowledge-discovery.md).  
  
-   Para obter um vídeo que demonstram como executar a descoberta de Conhecimento, clique em [aqui](http://msdn.microsoft.com/sqlserver/hh323825.aspx).  
...
-   Para obter mais informações na documentação, consulte [alterar valores de domínio](../data-quality-services/change-domain-values.md).  
  
-   Para obter um vídeo que demonstram como executar o gerenciamento de domínio, clique em [aqui](http://msdn.microsoft.com/sqlserver/hh323825.aspx). Observe que, nesse vídeo, você pode alterar os valores de domínio na página Gerenciando Valores de Domínio do assistente de Descoberta da Base de Dados de Conhecimento. Também é possível executar essas etapas na página Valores de Domínio da atividade Gerenciamento de Domínio.  
...
-   Para obter mais informações na documentação, consulte [importar valores de um arquivo do Excel em um domínio](../data-quality-services/import-values-from-an-excel-file-into-a-domain.md) ou [domínios de importação de um arquivo do Excel na descoberta de Conhecimento](../data-quality-services/import-domains-from-an-excel-file-in-knowledge-discovery.md).  
...
-   Para obter mais informações na documentação, consulte [importar valores de projeto de limpeza em um domínio](../data-quality-services/import-cleansing-project-values-into-a-domain.md).  
...
-   Para obter mais informações na documentação, consulte [usando a Base de dados de conhecimento do DQS padrão](../data-quality-services/using-the-dqs-default-knowledge-base.md).  
