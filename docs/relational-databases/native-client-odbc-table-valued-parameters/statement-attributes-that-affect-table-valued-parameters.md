---
description: Atributos de instruções que afetam parâmetros com valor de tabela
title: Atributos que afetam parâmetros de Table-Valued
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
|SQL_SOPT_SS_NAME_SCOPE|SQLUINTEGER|Para obter mais informações sobre SQL_SS_NAME_SCOPE, consulte [SQLSetStmtAttr](../../relational-databases/native-client-odbc-api/sqlsetstmtattr.md).|  
||||
