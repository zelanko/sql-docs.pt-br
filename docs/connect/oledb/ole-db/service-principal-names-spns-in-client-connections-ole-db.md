...
|Nome|Tipo|Uso|  
|----------|----------|-----------|  
|SSPROP_INIT_SERVERSPN|VT_BSTR, leitura/gravação|Especifica o SPN do servidor. O valor padrão é uma cadeia de caracteres vazia, o que faz com que o OLE DB Driver para SQL Server usar o padrão, gerado pelo provedor SPN.|  
|SSPROP_INIT_FAILOVERPARTNERSPN|VT_BSTR, leitura/gravação|Especifica o SPN para o parceiro de failover. O valor padrão é uma cadeia de caracteres vazia, o que faz com que o OLE DB Driver para SQL Server usar o padrão, gerado pelo provedor SPN.|  
