---
title: Rastreamento de acesso a dados com o driver ODBC no Linux e no macOS
description: Saiba como habilitar o rastreamento no Linux e no macOS com o Microsoft ODBC Driver for SQL Server para gerar um arquivo de log ao solucionar problemas de comportamento do aplicativo.
ms.custom: ''
ms.date: 09/01/2020
ms.prod: sql
