---
description: Propriedades, métodos e eventos do objeto DataControl (RDS)
title: Propriedades, métodos e eventos do objeto DataControl (RDS) | Microsoft Docs
ms.prod: sql
