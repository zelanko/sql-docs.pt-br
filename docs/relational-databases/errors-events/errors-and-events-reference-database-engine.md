...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Esta seção contém mensagens de erro do [!INCLUDE[ssDE](../../includes/ssde-md.md)] selecionadas que precisam de explicações detalhadas.  
