...
### [Propriedades do projeto](project-properties-ssas-tabular.md)  
### [Propriedades do modelo](model-properties-ssas-tabular.md)  
...
### [Importar dados usando uma consulta nativa](ssas-import-query.md)
...
### [Compatibilidade de fórmula do DAX no modo DirectQuery (SSAS 2016)](dax-formula-compatibility-in-directquery-mode-ssas-2016.md)  
...
### [Especifique Marcar como Tabela de Data para uso com inteligência de dados temporais](specify-mark-as-date-table-for-use-with-time-intelligence-ssas-tabular.md)  
...
## [Agrupamento e armazenamento de cadeia de caracteres em modelos tabulares](string-storage-and-collation-in-tabular-models.md)  

# [Implantar soluções de modelo tabular](tabular-model-solution-deployment-ssas-tabular.md)  
...
## [Conectar-se a um modelo de banco de dados tabular](connect-to-a-tabular-model-database-ssas.md)  
