...
description: Referência de Transact-SQL para a função STRING_SPLIT. Essa função com valor de tabela divide uma cadeia de caracteres em subcadeias de caracteres com base em um delimitador de caracteres.
ms.date: 11/28/2018
ms.prod: sql
