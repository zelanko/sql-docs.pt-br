...
## <a name="requirements-for-the-table-analysis-tools-for-excel"></a>Requisitos das Ferramentas de Análise de Tabela para Excel  
 ...
 Se você não conseguir ver o **analisar** de faixa de opções, tente clicar em uma tabela de dados pela primeira vez. O menu não será ativado até que uma tabela de dados seja selecionada.  
