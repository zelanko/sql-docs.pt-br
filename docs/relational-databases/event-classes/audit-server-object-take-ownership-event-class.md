...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Server Object Take Ownership** ocorre quando o proprietário é alterado para objetos no escopo do servidor.  
