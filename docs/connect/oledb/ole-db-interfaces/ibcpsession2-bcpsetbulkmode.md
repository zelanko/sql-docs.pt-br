...
description: Saiba como usar o método IBCPSession2::BCPSetBulkMode para criar uma cópia em massa de uma consulta ou de uma tabela no Driver do OLE DB para SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
