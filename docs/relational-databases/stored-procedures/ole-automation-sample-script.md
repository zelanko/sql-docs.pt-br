...
description: Saiba como usar um exemplo de um lote de instruções Transact-SQL que usa os procedimentos armazenados da Automação de OLE para criar e usar um objeto SQL-DMO SQLServer.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
