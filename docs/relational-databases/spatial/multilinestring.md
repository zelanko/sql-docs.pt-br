...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Uma **MultiLineString** é uma coleção de zero ou mais instâncias de **geometry** ou **geographyLineString**.  
