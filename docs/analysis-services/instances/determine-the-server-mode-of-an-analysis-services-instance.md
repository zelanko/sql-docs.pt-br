...
## <a name="server-icons-in-object-explorer"></a>Ícones de servidor no Pesquisador de Objetos  
 ...
 ![Ícones do Gerenciador para cada modo de servidor de objetos](../../analysis-services/instances/media/ssas-ssms-servermodes.gif "ícones do Pesquisador de objetos para cada modo de servidor")  
