...
5.  Expanda a dimensão **Sales Territory** e arraste a hierarquia **Sales Territories** definida pelo usuário para Rótulos de Linha.  
    ...
    ![Dimensão do cubo Sales Territory](../media/l5-granularity-2.gif "dimensão de cubo região de vendas")  
...
7.  Na lista Campos da Tabela Dinâmica, selecione a hierarquia **Sales Territories** definida pelo usuário e clique na seta para baixo à direita.  
    ...
    ![Hierarquia da região de vendas na lista de campos](../media/l5-granularity-1a.png "hierarquia região de vendas na lista de campos")  
...
8.  No filtro, clique na caixa de seleção Selecionar Tudo para desmarcar todas as seleções e escolha somente **América do Norte**.  
    ...
    ![Painel de filtro para a seleção de América do Norte](../media/l5-granularity-1b.png "painel de filtro para a seleção de América do Norte")  
...
11. Na Tabela Dinâmica, clique na seta para baixo ao lado de Rótulos de Linha. Desmarque todos os anos, com exceção de **FY 2008**.  
    ...
    ![Valores de vendas Amount Quota](../media/l5-granularity-3.png "cota do valor de valores de vendas")  
...
8.  Expanda **FY 2008**, **H1 FY 2008**e **Q1 FY 2008**.  
    ...
    ![Grupo de medidas cota vendas dimensionado corretamente](../media/l5-granularity-7.gif "grupo de medidas Sales Quota dimensionado corretamente")  
...
[Definir uma relação regular e as propriedades da relação regular](../multidimensional-models/define-a-regular-relationship-and-regular-relationship-properties.md)  
