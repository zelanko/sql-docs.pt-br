...
helpviewer_keywords: 
  ...
  - "tipos de dados de coluna [SQL Server]"
  - "tipos de dados [SQL Server], colunas"
...
---
# Modificar colunas (Mecanismo de Banco de Dados)
...
#### Para modificar o tipo de dados de uma coluna  
