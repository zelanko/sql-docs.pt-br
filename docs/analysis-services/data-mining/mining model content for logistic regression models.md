...
helpviewer_keywords: 
  ...
  - "Conteúdo do modelo de mineração, modelos de regressão logística"
...
## Entendendo a estrutura de um modelo de regressão logística  
 ...
 ![estrutura de conteúdo do modelo de regressão logística](../../analysis-services/data-mining/media/skt-modelcontentstructure-logregc.gif "estrutura de conteúdo do modelo de regressão logística")  
...
|Nó de saída|Um fragmento de XML contendo as mesmas informações que a coluna NODE_DESCRIPTION.|  
 ...
 NODE_DISTRIBUTION  
 Uma tabela aninhada que contém informações estatísticas para o nó. Para obter informações detalhadas sobre o conteúdo dessa tabela para cada tipo de nó, consulte a seção Entendendo a tabela NODE_DISTRIBUTION no [Mining Model Content para modelos de rede neural e &#40;Analysis Services – Data Mining&#41;](../../analysis-services/data-mining/mining-model-content-for-neural-network-models-analysis-services-data-mining.md).  
