...
|**database_state_desc**|**nvarchar(60)**|Descrição do **database_state** da réplica de disponibilidade.<br /><br /> ONLINE<br /><br /> RESTORING<br /><br /> RECOVERING<br /><br /> RECOVERY_PENDING<br /><br /> SUSPECT<br /><br /> EMERGENCY<br /><br /> OFFLINE<br /><br /> **Observação:** igual **state_desc** coluna em sys. Databases.|  
...
|**last_hardened_time**|**datetime**|Em um banco de dados secundário, tempo do identificador do bloco de log para o último LSN protegido (**last_hardened_lsn**). Em um banco de dados primário, reflete a hora que corresponde ao LSN de proteção mínimo.|  
