---
title: Propriedade Version (WMI MSReportServer_Instance) | Microsoft Docs
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---version"></a>Propriedades MSReportServer_Instance - versão
