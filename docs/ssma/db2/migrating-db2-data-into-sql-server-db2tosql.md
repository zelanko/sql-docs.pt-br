...
ms.locfileid: "38980608"
---
# <a name="migrating-db2-data-into-sql-server-db2tosql"></a>Migrar dados do DB2 para o SQL Server (DB2ToSQL)
Depois de ter sincronizado com êxito com objetos convertidos [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], você pode migrar dados do DB2 para [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].  
...
3.  Para migrar dados, podem surgir dois casos:  
    ...
    **Migração de dados do lado do servidor:**  
    ...
    -   Antes de executar a migração de dados no lado do servidor, verifique se:  
        ...
        1.  O SSMA para DB2 extensão Pack está instalado na instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].  
