...
# [Categoria de evento de auditoria de segurança (SQL Server Profiler)](security-audit-event-category-sql-server-profiler.md)
...
# [Classe de evento conexão de espelhamento de banco de dados](database-mirroring-connection-event-class.md)
...
# [Categoria de evento dos procedimentos armazenados](stored-procedures-event-category.md)
# [Categoria de evento de desempenho](performance-event-category.md)
...
# [Coluna de evento de rastreamento ObjectType](objecttype-trace-event-column.md)
...
# [Categoria de eventos Bloqueios](locks-event-category.md)
...
# [Categoria de eventos de erros e de avisos (Mecanismo de Banco de Dados)](errors-and-warnings-event-category-database-engine.md)
...
# [Referência de classe de evento do SQL Server](sql-server-event-class-reference.md)
# [Classe de evento RPC:Completed](rpc-completed-event-class.md)
# [Classe de evento OLEDB Errors](oledb-errors-event-class.md)
# [Classe de evento de plano de execução (Unencoded)](showplan-text-unencoded-event-class.md)
