...
## <a name="remarks"></a>Comentários  
 Tentativa de fazer uma conexão ad-hoc com **Ad Hoc Distributed Queries** não habilitada resulta em erro: Msg 7415, Level 16, estado 1, linha 1  
