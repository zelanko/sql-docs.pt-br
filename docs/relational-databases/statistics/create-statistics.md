...
description: Saiba como criar estatísticas de otimização de consulta nas colunas de uma tabela ou em uma exibição indexada no SQL Server usando o SQL Server Management Studio ou o Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
