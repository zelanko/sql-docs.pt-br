---
title: Gerenciado procedimentos armazenados de Backup (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "38046024"
---
# <a name="managed-backup-stored-procedures-transact-sql"></a>Procedimentos armazenados Backup gerenciados (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  Os seguintes procedimentos armazenados podem ser usados para configurar [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
