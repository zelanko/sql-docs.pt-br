...
```  
 ...
 A primeira linha de código referencia **Microsoft.SqlServer.Server** para acessar atributos e **System.Data.SqlClient** para acessar o namespace do ADO.NET. (Esse namespace contém **SqlClient**, o .NET Framework Data Provider para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].)  
...
> [!NOTE]  
>  Objetos de banco de dados do Visual C++ compilados com **/clr: pure** não têm suporte para execução em [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Por exemplo, entre esses objetos de banco de dados estão funções de valor escalar.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Visão geral de atributos personalizados da integração CLR](http://msdn.microsoft.com/library/ecf5c097-0972-48e2-a9c0-b695b7dd2820)   
