...
description: Saiba como criar um alias no SQL Server Configuration Manager para que você possa usar um nome alternativo ao se conectar a uma instância do SQL Server.
