...
ms.topic: "article"
helpviewer_keywords: 
  - "carga incremental [Integration Services], criando a função"
...
## Considerações de design para funções de captura de dados de alteração  
...
## Chamando um procedimento armazenado para criar a função com valor de tabela  
...
### Entendendo e usando o procedimento armazenado  
...
### Entendendo e usando os scripts criados pelo procedimento armazenado  
...
### Entendendo e usando as funções criadas pelo procedimento armazenado  
...
-   Se o parâmetro @start_time for nulo, as funções de invólucro usarão o valor LSN mais baixo na instância de captura do limite inferior da consulta.  
  
-   Se o parâmetro @end_time for nulo, as funções de invólucro usarão o valor LSN mais alto na instância de captura do limite superior da consulta.  
...
-   O filtro de linha. Para as funções de wrapper e as funções de captura de dados de alteração, o parâmetro *@row_filter_option* é o mesmo. Para obter mais informações, consulte [cdc.fn_cdc_get_all_changes_&#60;capture_instance&#62;  &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_all_changes_%3Ccapture_instance%3E%20%20\(Transact-SQL\).md) e [cdc.fn_cdc_get_net_changes_&#60;capture_instance&#62; &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_net_changes_%3Ccapture_instance%3E%20\(Transact-SQL\).md).  
...
## Escrevendo sua própria função do valor de tabela  
...
### Recuperando metadados adicionais com os dados de alteração  
...
|**\<colunas da tabela de origem capturadas>**|varia|As colunas restantes retornadas pela função são as colunas da tabela de origem que foram identificadas como colunas capturadas quando a instância de captura foi criada. Se nenhuma coluna tiver sido especificada originalmente na lista de colunas capturadas, todas as colunas da tabela de origem serão retornadas.|  
 ...
 Para obter mais informações, veja [cdc.fn_cdc_get_net_changes_&#60;capture_instance&#62; &#40;Transact-SQL&#41;](../Topic/cdc.fn_cdc_get_net_changes_%3Ccapture_instance%3E%20\(Transact-SQL\).md).  
