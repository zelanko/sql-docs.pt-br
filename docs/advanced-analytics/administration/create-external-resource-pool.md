---
title: Criar um pool de recursos para Python e R
description: Saiba como você pode criar e usar um pool de recursos para gerenciar cargas de trabalho de Python e R em SQL Server Serviços de Machine Learning.
ms.prod: sql
...
ms.locfileid: "71714320"
---
# <a name="create-a-resource-pool-for-sql-server-machine-learning-services"></a>Criar um pool de recursos para SQL Server Serviços de Machine Learning
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]

Saiba como você pode criar e usar um pool de recursos para gerenciar cargas de trabalho de Python e R em SQL Server Serviços de Machine Learning. 
...
##  <a name="review-the-status-of-existing-resource-pools"></a>Examinar o status dos pools de recursos existentes
...
+ [Gerenciar cargas de trabalho do Python e do R com o Resource Governor no SQL Server Serviços de Machine Learning](resource-governor.md)
