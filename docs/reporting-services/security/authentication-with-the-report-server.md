...
helpviewer_keywords: 
  ...
  - "conexões [Reporting Services], contas"
...
|Habilite o [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] para tratar o cenário de autenticação personalizada.|[Configurar o portal da Web para passar cookies de autenticação personalizados](http://msdn.microsoft.com/pt-br/91aeb053-149e-4562-ae4c-a688d0e1b2ba)|  
