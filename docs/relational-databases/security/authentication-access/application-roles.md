...
ms.topic: "article"
helpviewer_keywords: 
  - "funções de aplicativo [SQL Server], sobre as funções de aplicativo"
  - "entidades [SQL Server], funções de aplicativo"
  - "credenciais [SQL Server], funções"
  - "funções de aplicativo [SQL Server]"
  - "funções [SQL Server], aplicativo"
  - "permissões [SQL Server], funções"
  - "usuários [SQL Server], funções de aplicativo"
