...
## <a name="SQL14"></a>Alterações de comportamento em[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]  
...
## <a name="Denali"></a>Alterações de comportamento em[!INCLUDE[ssSQL11](../includes/sssql11-md.md)]  
