...
helpviewer_keywords: 
  - "caixa de diálogo Perfil de Agente"
 ...
 **Tipo**  
 O tipo de perfil: **usuário** (definido pelo usuário) ou **System** (predefinido).  
 ...
 **Delete (excluir)**  
 Selecione um perfil definido pelo usuário e, em seguida, clique em **Excluir** para excluir esse perfil. Perfis predefinidos não podem ser excluídos.  
  
 **Alterar Agentes Existente**  
 Selecione um perfil e, em seguida, clique em **Alterar agentes existentes** para especificar que todos os trabalhos existentes para um agente de um determinado tipo devem usar o perfil selecionado. Por exemplo, se você criou um número de assinaturas para uma publicação de mesclagem e quer alterar o perfil para especificar que um trabalho do Merge Agent para cada uma dessas assinaturas deve usar **Perfil do agente de vínculo lento**, selecione o perfil e clique em **Alterar Agentes Existentes**.  
