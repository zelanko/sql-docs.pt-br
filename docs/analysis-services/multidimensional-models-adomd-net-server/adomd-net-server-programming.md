...
|Tópico|Description|  
|-----------|-----------------|  
|[Funcionalidade de servidor do ADOMD.NET](../../analysis-services/multidimensional-models-adomd-net-server/adomd-net-server-functionality.md)|Descreve os usos para objetos de servidor do ADOMD.NET.|  
...
|[Funções definidas pelo usuário e procedimentos armazenados](../../analysis-services/multidimensional-models-adomd-net-server/user-defined-functions-and-stored-procedures.md)|Orienta você pelo processo de criação de uma função ou procedimento armazenado definido pelo usuário.|  
