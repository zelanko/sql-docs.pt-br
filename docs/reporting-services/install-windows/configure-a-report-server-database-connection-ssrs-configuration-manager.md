...
ms.topic: "article"
helpviewer_keywords: 
  - "conexões [Reporting Services], configurando"
  - "conexões [Reporting Services]"
  - "servidores de relatório [Reporting Services], conexões"
  - "banco de dados do servidor de relatório"
  - "bancos de dados [Reporting Services], conexões"
  - "segurança [Reporting Services], conexões de banco de dados"
...
-   Nome do banco de dados do servidor de relatório. Ao criar uma conexão pela primeira vez, é possível criar um novo banco de dados do servidor de relatório ou selecionar um banco de dados existente. Para obter mais informações, veja [Criar um banco de dados de servidor de relatório &#40;SSRS Configuration Manager&#41;](../../reporting-services/install-windows/create-a-report-server-database-ssrs-configuration-manager.md).  
