...
ms.topic: "article"
helpviewer_keywords: 
  - "Grupos de disponibilidade [SQL Server], cmdlets do PowerShell"
...
##  <a name="DeployManageARs"></a> Criando e gerenciando uma réplica de disponibilidade  
...
##  <a name="MonitorTblshtAGs"></a> Monitorando a integridade de grupos de disponibilidade  
