...
dev_langs: 
  - "XML"
helpviewer_keywords: 
  - "Orientador de Otimização do Mecanismo de Banco de Dados [SQL Server], arquivos de entrada XML"
  - "referência do arquivo de entrada [Orientador de Otimização do Mecanismo de Banco de Dados]"
  - "arquivos de entrada XML [Orientador de Otimização do Mecanismo de Banco de Dados]"
...
## Elementos de Carga de Trabalho  
