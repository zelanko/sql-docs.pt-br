...
|Tarefa|Referência|  
|-----------------|----------|  
|Habilite o acesso à rede com segurança para o recurso DTC clusterizado.|[Habilitar o acesso à rede com segurança para o MS DTC](https://technet.microsoft.com/library/cc753620(v=ws.10).aspx)|
