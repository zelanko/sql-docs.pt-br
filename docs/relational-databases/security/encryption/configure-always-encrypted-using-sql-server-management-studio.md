---
title: Configurar Always Encrypted usando SSMS
description: Descreve as tarefas usadas para configurar e gerenciar bancos de dados Always Encrypted com o SSMS (SQL Server Management Studio).
