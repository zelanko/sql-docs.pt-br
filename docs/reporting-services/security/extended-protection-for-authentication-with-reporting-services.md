...
-   A atualização de um servidor do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] para o [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] adiciona parâmetros de configuração com valores padrão para o arquivo **rsreportserver.config**. Se as configurações já estiverem presentes, a instalação do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] as preservará no arquivo **rsreportserver.config**.  
