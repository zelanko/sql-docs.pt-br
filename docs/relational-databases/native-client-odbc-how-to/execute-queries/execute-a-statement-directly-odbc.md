...
2.  Chame [SQLExecDirect](../../../odbc/reference/syntax/sqlexecdirect-function.md) para executar a instrução.  
  
3.  Se forem usados parâmetros de entrada de dados em execução, [SQLExecDirect](../../../odbc/reference/syntax/sqlexecdirect-function.md) retornará SQL_NEED_DATA. Envie os dados em partes useo [SQLParamData](../../../odbc/reference/syntax/sqlparamdata-function.md) e [SQLPutData](../../../relational-databases/native-client-odbc-api/sqlputdata.md).  
...
3.  Chame [SQLExecDirect](../../../odbc/reference/syntax/sqlexecdirect-function.md) para executar a instrução. O driver executa a instrução de maneira eficiente S vezes, sendo uma para cada conjunto de parâmetros.  
...
5.  Chame [SQLExecDirect](../../../odbc/reference/syntax/sqlexecdirect-function.md) para executar a instrução. O driver executa a instrução de maneira eficiente S vezes, sendo uma para cada conjunto de parâmetros.  
  
6.  Se forem usados parâmetros de entrada de dados em execução, [SQLExecDirect](../../../odbc/reference/syntax/sqlexecdirect-function.md) retornará SQL_NEED_DATA. Envie os dados em partes useo [SQLParamData](../../../odbc/reference/syntax/sqlparamdata-function.md) e [SQLPutData](../../../relational-databases/native-client-odbc-api/sqlputdata.md).  
  
 **Observação** As associações por coluna e por linha geralmente são mais usadas em conjunto com [SQLPrepare Function](../../../odbc/reference/syntax/sqlprepare-function.md) e [SQLExecute](../../../odbc/reference/syntax/sqlexecute-function.md) do que com [SQLExecDirect](../../../odbc/reference/syntax/sqlexecdirect-function.md).  
