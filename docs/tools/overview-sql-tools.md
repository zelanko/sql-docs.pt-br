...
Para gerenciar (consulta, monitor, etc.) o banco de dados que você precisa de uma ferramenta. Há várias ferramentas de banco de dados disponíveis. Enquanto os bancos de dados podem estar em execução na nuvem, no Windows ou em [Linux](../linux/sql-server-linux-overview.md), sua ferramenta não precisa ser executado na mesma plataforma de banco de dados. 
...
|[MSSQL-cli](mssql-cli.md)|MSSQL-cli é uma ferramenta de linha de comando interativa para consultar o SQL Server. **MSSQL-cli é executado no Windows, macOS e Linux**|
...
|[MSSQL-conf](../linux/sql-server-linux-configure-mssql-conf.md)|Use o mssql-conf para configurar o SQL Server em execução no Linux.|
...
|[MSSQL-scripter (visualização pública)](https://blogs.technet.microsoft.com/dataplatforminsider/2017/05/17/try-new-sql-server-command-line-tools-to-generate-t-sql-scripts-and-monitor-dynamic-management-views/)|Usado para gerar scripts de criar e inserir T-SQL para objetos de banco de dados do SQL Server, banco de dados SQL e Azure SQL Data Warehouse.|Consulte nosso [repositório GitHub](https://github.com/Microsoft/sql-xplat-cli) para download e informações de uso.| 
