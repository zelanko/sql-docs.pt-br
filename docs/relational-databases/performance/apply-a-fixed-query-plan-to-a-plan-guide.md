...
description: Saiba como aplicar um plano de consulta fixo a um guia de plano do tipo OBJECT ou SQL no SQL Server. O exemplo cria um guia de plano para uma instrução SQL ad hoc simples.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
ms.reviewer: ''
