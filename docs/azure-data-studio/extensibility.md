...
Você pode registrar informações usando dashboard.insights. Isso é semelhante ao [Tutorial: compilar um widget de visão personalizada](https://docs.microsoft.com/en-us/sql/sql-operations-studio/tutorial-build-custom-insight-sql-server)
