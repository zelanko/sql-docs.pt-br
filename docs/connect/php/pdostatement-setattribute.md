...
description: Referência de API para a função PDOStatement::setAttribute no Driver do Microsoft PDO_SQLSRV para PHP para SQL Server.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
|PDO::SQLSRV_ATTR_DATA_CLASSIFICATION|true ou false|Especifica se os metadados de classificação de dados devem ser recuperados ao chamar [PDOStatement::getColumnMeta](../../connect/php/pdostatement-getcolumnmeta.md). O padrão é falso.|
