---
title: "Ajuda de F1 do Gerenciador do Utilit&#225;rio | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
manager: "jhubbard"
---
# Ajuda de F1 do Gerenciador do Utilit&#225;rio
  ...
  ## Painel do Utilitário (Utilitário do SQL Server)
...
-   1 Ano, exibido em intervalos de 1 mês.  
 ...
 ## Detalhes do aplicativo da camada de dados implantado (Utilitário do SQL Server)
...
## Detalhes de instâncias gerenciadas (Utilitário do SQL Server)
...
## Administração do Utilitário (Utilitário do SQL Server)
...
-   Frequência de carregamento do conjunto de coleta: a cada 15 minutos.  
 ...
 O diretório do UMDW é configurável: \<Unidade do sistema>:\Arquivos de Programas\Microsoft SQL Server\MSSQL10_50.<Nome_do_UCP>\MSSQL\Data\\, em que a \<Unidade do sistema> normalmente é a unidade C:\. O arquivo de log, CMDW_\<GUID>_LOG, está localizado no mesmo diretório.  
