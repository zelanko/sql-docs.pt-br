...
description: Saiba como srv_pfield na API de procedimento armazenado estendido retorna informações sobre uma conexão de banco de dados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
