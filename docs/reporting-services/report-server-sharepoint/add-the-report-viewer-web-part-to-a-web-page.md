...
description: Você pode usar a web part do Visualizador de Relatórios para exibir relatórios executados no SQL Server Reporting Services no modo integrado do SharePoint.
ms.date: 10/05/2017
