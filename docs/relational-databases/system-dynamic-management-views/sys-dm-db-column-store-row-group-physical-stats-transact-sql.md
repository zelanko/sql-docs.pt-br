...
|-----------------|---------------|-----------------|  
|**object_id**|**inteiro**|ID da tabela subjacente.|  
|**index_id**|**inteiro**|ID deste índice columnstore na tabela *object_id* .|  
|**partition_number**|**inteiro**|ID da partição de tabela que contém *row_group_id*. Você pode usar o partition_number para adicionar esse DMV a sys.partitions.|  
|**row_group_id**|**inteiro**|ID deste grupo de linhas. Para tabelas particionadas, o valor é exclusivo na partição.<br /><br /> -1 para uma parte final da memória.|  
...
|**status**|**tinyint**|Número de ID associado *state_description*.<br /><br /> 0 = INVISIBLE<br /><br /> 1 = OPEN<br /><br /> 2 = CLOSED<br /><br /> 3 = COMPRESSED<br /><br /> 4 = MARCA PARA EXCLUSÃO<br /><br /> COMPACTado é o único Estado que se aplica a tabelas na memória.|  
...
### <a name="a-calculate-fragmentation-to-decide-when-to-reorganize-or-rebuild-a-columnstore-index"></a>R. Calcule a fragmentação para decidir quando reorganizar ou recriar um índice columnstore.  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Arquitetura de índice Columnstore](../../relational-databases/sql-server-index-design-guide.md#columnstore_index)         
