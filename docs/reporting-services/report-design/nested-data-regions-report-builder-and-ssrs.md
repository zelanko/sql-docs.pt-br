...
description: Descubra maneiras de aninhar uma região de dados dentro de outra região de dados no Construtor de Relatórios. Exibir resumos de dados em uma tabela ou matriz concisa.
ms.date: 03/07/2017
