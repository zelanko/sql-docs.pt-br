...
## <a name="arguments"></a>Argumentos  
 ...
 A contagem de repetição se a execução falhará. Ele entra em vigor somente se a execução estiver em expansão. Esse parâmetro é opcional. Ele é definido como 0, se não for especificado. O *contagem_de_novas_tentativas* é **int**.
