---
description: Recuperando informações de erro (provedor de OLE DB de cliente nativo)
title: Recuperando informações de erro (provedor de OLE DB de cliente nativo)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97473447"
---
# <a name="retrieving-error-information-native-client-ole-db-provider"></a>Recuperando informações de erro (provedor de OLE DB de cliente nativo)
