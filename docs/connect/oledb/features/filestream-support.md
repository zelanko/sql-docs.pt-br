...
description: O SQL Server dá suporte ao recurso FILESTREAM aprimorado, que permite armazenar e acessar grandes valores binários, seja pelo SQL Server ou pelo sistema de arquivos.
ms.custom: ''
ms.date: 09/13/2019
ms.prod: sql
