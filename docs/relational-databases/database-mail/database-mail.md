...
ms.topic: "article"
helpviewer_keywords: 
  - "arquitetura [SQL Server], Database Mail"
  - "Database Mail [SQL Server], arquitetura"
  - "Database Mail [SQL Server], componentes"
...
-   [Benefícios do uso do Database Mail](#Benefits)  
  
-   [Arquitetura do Database Mail](#VisualElement)  
  
-   [Introdução aos componentes do Database Mail](#ComponentsAndConcepts)  
 ...
 **Configurando o Agent para usar o Database Mail:**  
