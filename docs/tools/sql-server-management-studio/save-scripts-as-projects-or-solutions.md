...
## Utilizando projetos de script e soluções  
  
#### Para criar um projeto de script e uma solução  
...
[Resumo: Soluções e Projetos de Script](../../tools/sql-server-management-studio/summary-solutions-and-script-projects.md)  
