...
-   Os cursores estáticos são construídos em **temperaturas** quando o cursor é aberto. Eles sempre exibem o conjunto de resultados da forma como ele estava quando o cursor foi aberto. Eles nunca refletem alterações aos dados. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cursores estáticos são sempre somente leitura. Como um cursor de servidor estático é construído como uma tabela de trabalho em **tempdb,** o tamanho do conjunto de resultados do cursor não pode exceder o tamanho máximo da linha permitido por [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
