---
title: "Replica&#231;&#227;o, controle de altera&#231;&#245;es, Change Data Capture e grupos de disponibilidade AlwaysOn (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "controle de alterações [SQL Server], Grupos de Disponibilidade AlwaysOn"
  - "change data capture [SQL Server], Grupos de Disponibilidade AlwaysOn"
...
manager: "jhubbard"
---
# Replica&#231;&#227;o, controle de altera&#231;&#245;es, Change Data Capture e grupos de disponibilidade AlwaysOn (SQL Server)
...
-   [Visão geral de replicação em grupos de disponibilidade AlwaysOn](#Overview)  
  
    -   [Redirecionamento do publicador](#PublisherRedirect)  
  
    -   [Alterações nos agentes de replicação para dar suporte a grupos de disponibilidade AlwaysOn](#Changes)  
  
    -   [Procedimentos armazenados que dão suporte a AlwaysOn](#StoredProcs)  
  
    -   [Change Data Capture](#CDC)  
  
    -   [Controle de alterações](#CT)  
  
-   [Pré-requisitos, restrições e considerações do uso da replicação com grupos de disponibilidade AlwaysOn](#Prereqs)  
  
-   [Tarefas relacionadas](#RelatedTasks)  
  
##  <a name="Overview"></a> Visão geral de replicação em grupos de disponibilidade AlwaysOn  
...
###  <a name="PublisherRedirect"></a> Redirecionamento do publicador  
 ...
 Em um grupo de disponibilidade AlwaysOn, um banco de dados secundário não pode ser um publicador. Há suporte para a republicação apenas quando a replicação transacional é combinada com o [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)].  
...
-   **sp_validate_replicate_hosts_as_publishers**  
     ...
     Embora seja útil para os agentes garantir que a réplica primária atual possa funcionar como publicador de replicação em um banco de dados publicador, será necessário uma funcionalidade de validação mais genérica para estabelecer a validade de uma topologia de replicação inteira no banco de dados de disponibilidade AlwaysOn. O procedimento armazenado **sp_validate_replica_hosts_as_publishers** foi criado para atender a essa necessidade.  
