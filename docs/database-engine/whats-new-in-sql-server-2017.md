...
## <a name="sql-server-database-engine-rc1"></a>Mecanismo de Banco de Dados do SQL Server (RC1)  
...
## <a name="sql-server-database-engine-previous-ctps"></a>Mecanismo de Banco de Dados do SQL Server (CTPs anteriores)  
