...
ms.topic: "article"
helpviewer_keywords: 
  - "Acesso ao URL [Reporting Services]"
  - "links [Reporting Services], acesso à URL"
  - "acesso à URL [Reporting Services], sobre o acesso à URL"
  - "parâmetros [Reporting Services], acesso à URL"
  - "servidores de relatório [Reporting Services], acesso à URL"
  - "hiperlinks [Reporting Services]"
...
|Transmitir parâmetros de relatório a um relatório.|[Transmitir um parâmetro de relatório em uma URL](../reporting-services/pass-a-report-parameter-within-a-url.md)|  
...
## Consulte também  
 [Transmitir um parâmetro de relatório em uma URL](../reporting-services/pass-a-report-parameter-within-a-url.md)   
