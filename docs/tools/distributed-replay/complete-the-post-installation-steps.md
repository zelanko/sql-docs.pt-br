...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Depois de instalar o Distributed Replay, você deve modificar as contas de serviços de cliente e o controlador do Distributed Replay.  
