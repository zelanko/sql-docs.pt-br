...
### [Exemplo: especificando a diretiva ELEMENT e a codificação de entidade](example-specifying-the-element-directive-and-entity-encoding.md)  
...
### [Suporte a namespace no modo PATH](namespace-support-in-path-mode.md)  
