...
description: Descubra como fechar a janela de rastreamento no SQL Server Profiler que captura dados de evento. Saiba como fechá-lo durante o rastreamento ou após sua conclusão.
ms.prod: sql
