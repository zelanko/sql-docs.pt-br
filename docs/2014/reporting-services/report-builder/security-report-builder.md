...
-   **O servidor de relatório ou site do SharePoint onde você publica relatórios** Esses recursos são gerenciados pelo administrador do servidor de relatório ou pelo administrador do site do SharePoint.  
  
-   **Relatórios publicados e itens relacionados a relatórios** Itens relacionados a relatórios incluem fontes de dados inseridas e compartilhadas e suas credenciais, conjuntos de dados compartilhados, parâmetros, partes de relatório e modelos de relatório. Os recursos de segurança que se aplicam a estes itens são gerenciados pelo autor do relatório. Permissões suficientes devem ser concedidas para o autor do relatório, por meio do administrador de servidor de relatório ou do administrador de site do SharePoint, para publicar e compartilhar os itens.  
  
-   **Fontes de dados externas que são usadas por um relatório** Esses recursos são gerenciados pelo proprietário da fonte de dados externa.  
  
-   **Modelos de relatório baseados em fontes de dados externas** Esses recursos são gerenciados pelo designer de modelos.  
  
-   **Recursos de relatório interativo, como parâmetros** Esses recursos são gerenciados pelo autor do relatório.  
...
##  <a name="ReportServers"></a>Entendendo a segurança para servidores de relatório  
...
##  <a name="Reports"></a>Noções básicas sobre segurança para relatórios publicados e itens relacionados a relatórios  
...
##  <a name="Data"></a>Entendendo a segurança para dados de relatório e fontes de dados externas  
...
##  <a name="Models"></a>Entendendo modelos e filtros de segurança  
...
##  <a name="Interactive"></a>Entendendo a segurança para a criação de relatórios para recursos interativos  
