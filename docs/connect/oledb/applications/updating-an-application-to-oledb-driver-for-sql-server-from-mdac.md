...
-   OLE DB Driver para SQL Server não é compatível com odbcbcp.dll. Aplicativos devem ser recriados para vincular com msoledbsql.lib para usar o Driver do OLE DB para SQL Server.    
