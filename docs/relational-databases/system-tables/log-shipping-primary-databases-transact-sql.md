...
|**backup_job_id**|**uniqueidentifier**|A ID de trabalho do agente [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] associada ao trabalho de backup no servidor primário.|  
...
|**monitor_server_security_mode**|**bit**|O modo de segurança usado para conexão ao servidor monitor.<br /><br /> 1 = Autenticação do Windows.<br /><br /> 0 = autenticação [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
