...
8.  Na caixa de diálogo **Segurança do Agente de Distribuição**, clique no botão de reticências (**…**), insira \<*Machine_Name>***\repl_distribution** na caixa **Conta de processo**, insira a senha dessa conta, clique em **OK** e em **Avançar**.  
