---
title: Fonte do elemento (erro) (XMLA) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Contém o nome do componente que gerou o pai [erro](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md) elemento.  
