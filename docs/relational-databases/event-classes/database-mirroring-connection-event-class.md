...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] gera um evento **Database Mirroring Connection** para relatar o status de uma conexão de transporte gerenciada pelo Espelhamento de Banco de Dados.  
