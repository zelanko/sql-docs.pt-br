...
Para saber mais sobre como salvar os resultados do teste, reutilizá-los e compartilhá-los com sua equipe, confira [Como salvar e abrir Resultados de Teste no Visual Studio 2010](http://msdn.microsoft.com/library/ms404662(VS.100).aspx) ou [Como salvar e abrir Resultados de Teste no Visual Studio 2012](http://msdn.microsoft.com/library/ms404662.aspx).  
