---
title: Executar um rastreamento que foi pausado ou interrompido (SQL Server Profiler) | Microsoft Docs
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Este tópico descreve como iniciar um rastreamento novamente depois que ele foi pausado ou interrompido, usando [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
