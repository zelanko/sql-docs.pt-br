---
title: Interromper um rastreamento
titleSuffix: SQL Server Profiler
description: Descubra como interromper um rastreamento que está em execução no SQL Server Profiler, altere as propriedades que você deseja ajustar e salve os dados capturados.
ms.prod: sql
