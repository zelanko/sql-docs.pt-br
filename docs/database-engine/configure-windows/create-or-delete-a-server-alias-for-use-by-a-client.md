...
description: Descubra como criar e excluir um alias, um nome alternativo que você pode usar ao se conectar a uma instância do SQL Server. Saiba mais sobre os benefícios dos aliases.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
