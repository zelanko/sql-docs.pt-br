...
>[!NOTE]
> Como parte deste tópico, o cartaz é pequeno demais para ser lido. Baixe o pôster de permissões de mecanismo de banco de dados de [ https://aka.ms/sql-permissions-poster ](https://aka.ms/sql-permissions-poster).  
