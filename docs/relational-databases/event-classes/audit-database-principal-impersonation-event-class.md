...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: Audit Database Principal Impersonation event class
...
ms.openlocfilehash: 47e7ad55d8dc1ef59fd341d2d54f0a801035fcf1
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento **Audit Database Principal Impersonation** ocorre quando acontece uma representação no escopo do banco de dados, como EXECUTE AS \<*user*> ou SETUSER.  
