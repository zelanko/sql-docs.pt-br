...
#### <a name="redhat"></a>RedHat
- [RedHat 7. rpm pacotes (msodbcsql-*)](https://packages.microsoft.com/rhel/7/prod/)
- [6 RedHat. rpm pacotes (msodbcsql-*)](https://packages.microsoft.com/rhel/6.8/prod/)

#### <a name="suse"></a>SuSE
- [12 SuSE. rpm pacotes (msodbcsql-*)](https://packages.microsoft.com/sles/12/prod/)
- [11 SuSE. rpm pacotes (msodbcsql-*)](https://packages.microsoft.com/sles/11/prod/)
...
- [Ubuntu 16.10. DEB pacotes](https://packages.microsoft.com/ubuntu/16.10/prod/pool/main/m/msodbcsql/)
