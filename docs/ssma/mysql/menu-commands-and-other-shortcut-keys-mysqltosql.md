...
|Exibir o conectar-se ou reconectar-se a caixa de diálogo do MySQL.|ALT + F + T|  
...
|PARA FAZER ISSO|PRESSIONE|  
|--------------|---------|  
|Exibir sobre SSMA para MySQL caixa de diálogo.|ALT + H + A|  
...
[Teclas de atalho do &#40;MySQLToSQL&#41;](../../ssma/mysql/shortcut-keys-mysqltosql.md)  
