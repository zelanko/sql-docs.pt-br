...
description: Descubra como ocultar uma instância do Mecanismo de Banco de Dados do SQL Server. Os computadores cliente não podem usar o serviço de SQL Server Browser para localizar instâncias ocultas.
ms.custom: ''
ms.date: 08/19/2015
ms.prod: sql
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Como atribuir uma porta estática a uma instância nomeada do SQL Server – e evitar uma armadilha comum](https://deep.data.blog/2012/09/08/how-to-assign-a-static-port-to-a-sql-server-named-instance-and-avoid-a-common-pitfall/)  
