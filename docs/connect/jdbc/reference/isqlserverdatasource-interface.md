---
description: Interface ISQLServerDataSource
title: Interface ISQLServerDataSource | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88433498"
---
# <a name="isqlserverdatasource-interface"></a>Interface ISQLServerDataSource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Uma fábrica para criar conexões com a fonte de dados representadas pelo objeto. Essa interface foi adicionada ao [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] JDBC Driver 3.0.  
...
## <a name="remarks"></a>Comentários  
 Essa interface é implementada pela [Classe SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-class.md).  
