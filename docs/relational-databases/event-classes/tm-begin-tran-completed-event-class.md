...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] A classe de evento TM: Begin Tran Completed indica que uma solicitação BEGIN TRANSACTION foi concluída. A solicitação foi enviada do cliente pela interface de gerenciamento de transações.  
