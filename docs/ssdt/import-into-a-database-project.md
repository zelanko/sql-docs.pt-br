...
## <a name="import-source-database-or-data-tier-application-dacpac"></a><a name="bkmk_import_source_db"></a>Importar fonte: banco de dados ou aplicativo da camada de dados (*.dacpac)  
...
## <a name="import-source-script-sql"></a><a name="bkmk_import_source_script"></a>Importar fonte: script (*.sql)  
