---
title: 'Como: enviar dados como um Stream | Microsoft Docs'
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
O exemplo a seguir insere uma linha na tabela *Production.ProductReview* do banco de dados do AdventureWorks. Os comentários do cliente (*$comments*) são abertos como um fluxo com a função PHP [fopen](http://php.net/manual/en/function.fopen.php) e então transmitidos para o servidor após a execução da consulta.  
...
## <a name="example-sending-stream-data-using-sqlsrvsendstreamdata"></a>Exemplo: Enviar dados usando o Stream sqlsrv_send_stream_data
...
## <a name="example-sending-an-image-as-a-stream"></a>Exemplo: Envio de uma imagem como um Stream 
