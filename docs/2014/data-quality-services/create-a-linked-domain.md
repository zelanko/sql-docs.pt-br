...
##  <a name="create-a-linked-domain"></a><a name="Create"></a>Criar um domínio vinculado  
...
##  <a name="follow-up-after-creating-a-linked-domain"></a><a name="FollowUp"></a> Acompanhamento: após a criação de um domínio vinculado  
...
##  <a name="behavior-of-a-linked-domain"></a><a name="Behavior"></a> Comportamento de um domínio vinculado  
