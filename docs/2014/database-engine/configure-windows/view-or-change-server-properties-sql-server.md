...
4.  Na caixa de **diálogo \<***instancename***> propriedades de SQL Server ()** , altere as propriedades do servidor na guia **serviço** ou na guia **avançado** e clique em **OK**.  
