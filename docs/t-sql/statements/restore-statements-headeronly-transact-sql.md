...
|**Ordem de classificação**|**smallint**|Ordem de classificação do servidor. Esta coluna só é válida para backups de banco de dados. Fornecido para compatibilidade com versões anteriores.|  
...
|**Nível de compatibilidade**|**tinyint**|Configuração do nível de compatibilidade do banco de dados a partir do qual o backup foi criado.|  
...
|**contenção**|**tinyint** não NULL|**Aplica-se a**: do [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ao [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Indica o status de contenção do banco de dados.<br /><br /> 0 = a contenção do banco de dados está desativada<br /><br /> 1 = o banco de dados está em contenção parcial|  
