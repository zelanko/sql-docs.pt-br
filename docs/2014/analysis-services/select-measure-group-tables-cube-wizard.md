---
title: Tabelas de selecionar o grupo de medidas (Assistente para cubos) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Tabelas de grupos de medidas**  
 Selecione as tabelas que serão usadas para os grupos de medidas no cubo.  
