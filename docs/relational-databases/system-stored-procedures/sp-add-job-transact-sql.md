...
`[ @owner_login_name = ] 'login'`O nome do logon que possui o trabalho. *logon*é **sysname**, com um padrão de NULL, que é interpretado como o nome de logon atual. Somente os membros da função de servidor fixa **sysadmin** podem definir ou alterar o valor **@owner_login_name** de. Se os usuários que não forem membros da função **sysadmin** definida ou alterarem o valor **@owner_login_name** de, a execução desse procedimento armazenado falhará e um erro será retornado.  
...
`[ @notify_email_operator_name = ] 'email_name'`O nome de email da pessoa para a qual enviar email quando *email_level* é atingido. *email_name* é **sysname**, com um padrão de NULL.  
...
-   **SQLAgentOperatorRole**  
 ...
 Somente os membros da função de servidor fixa **sysadmin** podem definir ou alterar o valor **@owner_login_name** de. Se os usuários que não forem membros da função **sysadmin** definida ou alterarem o valor **@owner_login_name** de, a execução desse procedimento armazenado falhará e um erro será retornado.  
