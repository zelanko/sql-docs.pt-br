 ...
 **Nome**  
 Especifique o título a ser usado para esta instância de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Gerenciador de relatórios. Por padrão, o título é "[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]".  
