---
title: "Solucionando problemas do IntelliSense (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "opções indisponíveis [IntelliSense]"
  - "IntelliSense [SQL Server], solução de problemas"
  - "IntelliSense [SQL Server], opções indisponíveis"
  - "solucionando problemas [IntelliSense]"
...
manager: "jhubbard"
---
# Solucionando problemas do IntelliSense (SQL Server Management Studio)
