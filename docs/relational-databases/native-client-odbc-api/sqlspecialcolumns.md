---
title: Colunas Especiais SQL | Microsoft Docs
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
 ...
 **SQLSpecialColumns** dá suporte a UDTs grandes do CLR. Para obter mais informações, consulte [Grandes tipos definidos pelo usuário da CLR &#40;&#41;ODBC ](../../relational-databases/native-client/odbc/large-clr-user-defined-types-odbc.md).  
  
## <a name="see-also"></a>Consulte Também  
 [Função Colunas Especiais SQL](https://go.microsoft.com/fwlink/?LinkId=59371)   
