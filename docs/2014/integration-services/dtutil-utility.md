...
-   Abra uma janela de prompt de comando, altere para o diretório que contém a versão de 64 bits do *utilitário\<(unidade>*: \Program Files\Microsoft SQL Server\120\DTS\Binn) e, em seguida, execute o utilitário a partir desse local.  
  
-   No prompt de comando, execute o utilitário inserindo o caminho completo (*\<unidade>*: \Program Files\Microsoft SQL Server\120\DTS\Binn) na versão de 64 bits do utilitário.  
  
-   Altere permanentemente a ordem dos caminhos na variável de ambiente Path colocando o caminho de 64 bits (*\<unidade>*: \Program Files\Microsoft SQL Server\120\DTS\Binn) antes do caminho de 32 bits (*\<unidade>*: \ Arquivos de programas (x86) \Microsoft SQL Server\120\DTS\Binn) na variável.  
...
|/FR[ename] {*SQL* &#124; *DTS*} [;*ParentFolderPath; OldFolderName;NewFolderName]*|(Opcional). Renomeia uma pasta no [!INCLUDE[ssIS](../includes/ssis-md.md)] ou no [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. 
  *ParentFolderPath* é o local da pasta a ser renomeada. 
  *OldFolderName* é o nome atual da pasta e *NewFolderName* é o novo nome a ser definido para a pasta.|  
