...
SQL Server PDW inclui exibições do sistema abrangentes que permitem que você obtenha informações detalhadas sobre a integridade do dispositivo, o estado e o desempenho. Esta tabela fornece links para exibições do sistema que podem ser usadas para cada recurso de monitoramento.  
