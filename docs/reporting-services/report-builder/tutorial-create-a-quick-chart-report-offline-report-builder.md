...
---
# Tutorial: Criar um relat&#243;rio de gr&#225;fico r&#225;pido offline (Construtor de Relat&#243;rios)
...
### Usando dados XML para este tutorial  
 Você pode usar os dados XML que copiar deste tópico e colar no assistente. Não é necessário estar conectado a um servidor de relatório do [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] em modo nativo ou em modo integrado do SharePointm nem ter acesso a uma instância do [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
 [Criar o gráfico de pizza com dados XML](#CreatePieChartXML)  
  
### Usando uma consulta [!INCLUDE[tsql](../../includes/tsql-md.md)] contendo dados para este tutorial  
...
15. Arraste o campo **FullName** da caixa **Campos disponíveis** para a caixa **Categorias** \(ou clique duas vezes\- nela, para ir para a caixa **Categorias**\) e clique em **Avançar**.  
...
12. Arraste o campo **FullName** da caixa **Campos disponíveis** para a caixa **Categorias** \(ou clique duas vezes\- nela, para ir para a caixa **Categorias**\) e clique em **Avançar**.  
...
2. Com o título selecionado no painel Propriedades, altere **Cor** para **Preto** e **Fonte** para **12 pt**.
...
3.  Na caixa **Rotular dados**, digite **\#PERCENTUAL{P0}**.  
