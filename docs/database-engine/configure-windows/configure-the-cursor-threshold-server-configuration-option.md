...
description: Saiba mais sobre a opção cursor threshold. Veja como o valor dela determina se o SQL Server gera conjuntos de chaves de cursor de maneira assíncrona ou não e descubra como configurá-la.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
