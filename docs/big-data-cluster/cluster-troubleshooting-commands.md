...
description: Este artigo fornece comandos úteis para monitorar e solucionar problemas de um cluster de Big Data do SQL Server 2019.
...
| **gateway-svc-external** | Fornece acesso ao gateway do HDFS/Spark.<br/>(**EXTERNAL-IP** e o usuário `<AZDATA_USERNAME>`)<sup>1</sup>|
