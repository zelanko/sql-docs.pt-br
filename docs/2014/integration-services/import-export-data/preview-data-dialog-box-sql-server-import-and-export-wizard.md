...
# <a name="preview-data-dialog-box-sql-server-import-and-export-wizard"></a>Caixa de diálogo Visualizar Dados (Assistente de Importação e Exportação do SQL Server)
  Use a caixa de diálogo **Visualizar dados** para ver a consulta que [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o assistente de importação e exportação enviará para a fonte de dados. Você também pode usar esta caixa de diálogo para visualizar até 200 linhas de dados de exemplo.  
