...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], abrindo"
  - "utilitários de prompt de comando [SQL Server], sqlwb"
  - "utilitário sqlwb"
  - "Linha de comando do Management Studio"
