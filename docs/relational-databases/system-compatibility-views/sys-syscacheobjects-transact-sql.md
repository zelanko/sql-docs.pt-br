...
|**Estado**|**int**|Indica se o objeto de cache é um plano de cursor. Atualmente, apenas o bit menos significativo é usado.|  
|**últimotime**|**bigint**|Somente para compatibilidade com versões anteriores. Sempre retorna 0.|  
