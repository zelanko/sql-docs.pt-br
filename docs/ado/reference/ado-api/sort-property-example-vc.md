---
title: Classificar o exemplo da propriedade (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35281945"
---
# <a name="sort-property-example-vc"></a>Exemplo de propriedade de classificação (VC + +)
