 ...
 *opção*  
 É a configuração de opção atual durante esta sessão. *opção* pode ser qualquer um dos valores a seguir.  
...
|CONCAT_NULL_YIELDS_NULL|Controla se os resultados de concatenação são tratados como valores de cadeia de caracteres nula ou vazia.<br /><br /> 1 = ON<br /><br /> 0 = OFF|  
