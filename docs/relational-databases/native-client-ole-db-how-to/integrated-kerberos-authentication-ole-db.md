...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 Para obter mais informações sobre autenticação SPNs e Kerberos, consulte [Nome Principal de serviço &#40; SPN &#41; Suporte em conexões de cliente](../../relational-databases/native-client/features/service-principal-name-spn-support-in-client-connections.md).  
