...
|-------------|-----------------|  
|[Contas de elemento &#40;ASSL&#41;](accounts-element-assl.md)|Contém a coleção de tipos de conta que são definidos em um [banco de dados](../objects/database-element-assl.md) elemento.|  
...
|[Elemento AggregationInstances &#40;ASSL&#41;](aggregationinstances-element-assl.md)|Contém a coleção de instâncias de agregação que são definidos em um [partição](../objects/partition-element-assl.md) elemento.|  
...
|[Elemento assemblies &#40;ASSL&#41;](assemblies-element-assl.md)|Contém a coleção de [Assembly](../objects/assembly-element-assl.md) elementos associados a um [servidor](../objects/server-element-assl.md) elemento ou um [banco de dados](../objects/database-element-assl.md) elemento.|  
...
|[Atributos de elemento &#40;ASSL&#41;](attributes-element-assl.md)|Contém a coleção de atributos para a dimensão associada.|  
...
|[Cubos elemento &#40;ASSL&#41;](cubes-element-assl.md)|Contém a coleção de [cubo](../objects/cube-element-assl.md) elementos associados a um [banco de dados](../objects/database-element-assl.md) elemento.|  
...
|[Elemento de bancos de dados &#40;ASSL&#41;](databases-element-assl.md)|Contém a coleção de [banco de dados](../objects/database-element-assl.md) elementos associados a um [Server](../objects/server-element-assl.md) elemento.|  
...
|[Elemento DataSourcePermissions &#40;ASSL&#41;](datasourcepermissions-element-assl.md)|Contém a coleção de [DataSource](../objects/datasource-element-assl.md) elementos associados a um [banco de dados](../objects/database-element-assl.md) elemento.|  
...
|[Elemento de arquivos &#40;ASSL&#41;](files-element-assl.md)|Contém a coleção de [arquivo](../objects/file-element-assl.md) elementos que compõem um [ClrAssembly](../data-type/assembly-data-type-assl.md) elemento.|  
...
|[Níveis de elemento &#40;ASSL&#41;](levels-element-assl.md)|Contém a coleção de [nível](../objects/level-element-assl.md) elementos em uma [hierarquia](../objects/hierarchy-element-assl.md) elemento.|  
...
|[Mede o elemento &#40;ASSL&#41;](measures-element-assl.md)|Contém a coleção de [medidas](../objects/measure-element-assl.md) elementos associados ao elemento pai.|  
...
|[Elemento MiningStructures &#40;ASSL&#41;](miningstructures-element-assl.md)|Contém a coleção de [MiningStructure](../objects/miningstructure-element-assl.md) elementos em uma [banco de dados](../objects/database-element-assl.md) elemento.|  
|[Elemento ModelingFlags &#40;ASSL&#41;](modelingflags-element-assl.md)|Contém a coleção de [ModelingFlag](../objects/modelingflag-element-assl.md) elementos de uma coluna em uma [MiningStructure](../objects/miningstructure-element-assl.md) ou um [MiningModel](../objects/miningmodel-element-assl.md).|  
|[Elemento NamingTemplateTranslations &#40;ASSL&#41;](namingtemplatetranslations-element-assl.md)|Fornece uma coleção de traduções localizadas para o [NamingTemplate](../properties/namingtemplate-element-assl.md) elemento do pai [DimensionAttribute](../data-type/dimensionattribute-data-type-assl.md).|  
|[Partições de elemento &#40;ASSL&#41;](partitions-element-assl.md)|Contém a coleção de [partição](../objects/partition-element-assl.md) elementos usados por um [MeasureGroup](../objects/group-element-assl.md) elemento ou a coleção de ligações de partição que compõem uma fora de linha [MeasureGroupBinding](../data-type/measuregroupbinding-data-type-out-of-line-assl.md)elemento.|  
...
|[Elemento UnknownMemberTranslations &#40;ASSL&#41;](unknownmembertranslations-element-assl.md)|Contém a coleção de traduções da legenda do [UnknownMember](../properties/unknownmember-element-assl.md) elemento de uma dimensão.|  
