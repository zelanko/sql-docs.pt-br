...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Use a classe de evento TransactionLog para monitorar a atividade nos logs de transações em uma instância do [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)].  
