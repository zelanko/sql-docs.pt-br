...
ms.topic: "article"
helpviewer_keywords: 
  - "conteúdo do modelo de mineração, modelos de clustering de sequências"
...
## Entendendo a estrutura de um modelo de clustering de sequência  
 ...
 ![Estrutura do modelo de clustering de sequência](../../analysis-services/data-mining/media/modelcontent-seqclust.gif "Estrutura do modelo de clustering de sequência")  
...
#### Para exibir sequências relacionadas usando o visualizador de Clustering de Sequência  
...
#### Para exibir sequências relacionadas usando o visualizador do conteúdo do modelo genérico  
