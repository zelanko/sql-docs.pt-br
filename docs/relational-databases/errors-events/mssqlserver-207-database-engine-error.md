...
description: Um erro de consulta no SQL Server em relação a um nome de coluna inválido. Veja uma explicação do erro e as possíveis resoluções.
ms.custom: ''
ms.date: 04/04/2017
ms.prod: sql
ms.reviewer: ''
