...
ms.locfileid: "67989494"
---
# <a name="type_ss_server_cursor_forward_only-field-sqlserverresultset"></a>Campo TYPE_SS_SERVER_CURSOR_FORWARD_ONLY (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Usado para especificar um tipo de cursor somente de avanço rápido, somente leitura do [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
