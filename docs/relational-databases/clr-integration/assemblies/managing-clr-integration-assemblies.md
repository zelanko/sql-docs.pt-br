...
description: Você pode hospedar assemblies DLL gerenciados no SQL Server.  Você pode registrar, alterar e descartar assemblies e também gerenciar arquivos e permissões associados.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
