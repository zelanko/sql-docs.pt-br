...
1.  Abrir um novo projeto. A versão do projeto que você escolhe determina a versão do esquema RDL. No [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], há suporte para mais de uma versão de esquema. Para obter mais informações, veja [Implantação e suporte de versão no SQL Server Data Tools &#40;SSRS&#41;](../../reporting-services/tools/deployment-and-version-support-in-sql-server-data-tools-ssrs.md).  
