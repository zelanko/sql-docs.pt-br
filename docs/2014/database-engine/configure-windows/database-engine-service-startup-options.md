...
|Opções de inicialização padrão|Description|  
|-----------------------------|-----------------|  
...
|Outras opções de inicialização|Description|  
|---------------------------|-----------------|  
