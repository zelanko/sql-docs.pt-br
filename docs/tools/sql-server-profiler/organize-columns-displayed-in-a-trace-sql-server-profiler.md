...
description: Facilite a análise da saída de rastreamento do SQL Server Profiler agrupando e agregando eventos ao definir ou ver um rastreamento.
ms.prod: sql
