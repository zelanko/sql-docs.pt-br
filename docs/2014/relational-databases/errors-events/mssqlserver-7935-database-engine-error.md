...
|Texto da mensagem|Erro de tabela: Um diretório de Filestream que f_id da ID existe para uma coluna de ID de objeto O_ID, ID de índice I_ID, ID de partição PN_ID, mas essa coluna não existe na partição.|  
