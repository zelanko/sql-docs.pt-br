...
## <a name="dimension-based-on-a-star-schema-design"></a>Dimensão com base em Design de esquema em estrela  
 ...
 ![Esquema lógico para relação de dimensão de fatos](../../../2014/analysis-services/dev-guide/media/dimfactrelationship.gif "esquema lógico para relação de dimensão de fatos")  
...
## <a name="dimension-based-on-a-snowflake-schema-design"></a>Dimensão com base em Design de esquema floco de neve   
 ...
 ![Tabelas de dimensão AdventureWorksAS Product](../../../2014/analysis-services/dev-guide/media/dimproduct.gif "tabelas de dimensão AdventureWorksAS Product")  
