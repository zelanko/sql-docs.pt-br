...
ms.openlocfilehash: 2a19697668e824c8f2e3281c9dea22969facddb8
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Representa o [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)]. Essa classe inclui métodos para se conectar a um [!INCLUDE[ssNoVersion](../../../includes/ssnoversion_md.md)] banco de dados e para obter informações sobre o driver JDBC.  
