...
helpviewer_keywords: 
  - "reservas de URL"
  - "registro de URL"
  - "Serviço do Servidor de Relatório, reservas de URL"
...
---
# Sobre reservas e registro de URL (Gerenciador de configura&#231;&#245;es do SSRS)
...
##  <a name="URLlocalAdmin"></a> URLs para administração local  
 Você pode usar http://localhost/reportserver ou http://localhost/reports se tiver especificado um curinga forte ou fraco para a reserva de URL.  
