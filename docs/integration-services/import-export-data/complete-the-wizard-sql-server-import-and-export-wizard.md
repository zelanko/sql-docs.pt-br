---
title: "Conclua o Assistente (Assistente de exportação e importação do SQL Server) | Microsoft Docs"
ms.custom: 
ms.date: 03/16/2017
...
Depois de especificar se deseja executar a operação de cópia imediatamente e depois de salvar o pacote que o Assistente para criar, opcionalmente, o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] mostra Import and Export Wizard **concluir o assistente**. Nessa página, examine as opções feitas no assistente e, em seguida, clique em **Concluir** para iniciar a operação de cópia.
 
## <a name="screen-shot-of-the-complete-the-wizard-page"></a>Captura de tela da página Concluir o Assistente 
 A captura de tela a seguir mostra um exemplo simples do **concluir o assistente** página do assistente.  
  
 ![Página concluir o Assistente de Assistente de importação e exportação](../../integration-services/import-export-data/media/complete.png "página concluir o Assistente de Assistente de importação e exportação")  
  
## <a name="review-the-options-you-selected"></a>Examine as opções selecionadas  
 
Revise o resumo e verifique se as seguintes informações:  
