...
### <a name="i-cant-connect-to-the-computer-running-sql-server"></a>Não consigo me conectar ao computador que executa o SQL Server
...
### <a name="i-see-an-error-when-i-generate-an-analysis-report"></a>Vejo um erro ao gerar um relatório de análise
...
### <a name="the-report-is-generated-but-data-appears-to-be-missing"></a>O relatório é gerado, mas os dados parecem estar ausentes
