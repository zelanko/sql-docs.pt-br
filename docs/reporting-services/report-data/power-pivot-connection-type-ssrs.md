...
description: Use as informações fornecidas neste artigo sobre o tipo de conexão Power Pivot para aprender a criar uma fonte de dados.
ms.date: 03/01/2017
...
## <a name="see-also"></a>Consulte Também  
 [Interface do usuário do Designer de Consultas MDX do Analysis Services &#40;Construtor de Relatórios&#41;](/previous-versions/sql/)   
