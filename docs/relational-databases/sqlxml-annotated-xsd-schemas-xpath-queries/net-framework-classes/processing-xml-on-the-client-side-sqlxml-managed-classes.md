---
title: Processando XML no lado do cliente (SQLXML)
description: Saiba como processar o XML no lado do cliente usando a propriedade ClientSideXml do objeto SqlXmlCommand nas classes gerenciadas SQLXML.
ms.date: 03/14/2017
ms.prod: sql
