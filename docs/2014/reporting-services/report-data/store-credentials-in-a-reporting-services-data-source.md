...
7.  Digite um nome de usuário e uma senha.
    ...
    -   Se a conta for uma conta de usuário de domínio do Windows, especifique-a \<neste formato \\ : domínio\>>conta de<e, em seguida, selecione **usar as credenciais do Windows ao conectar-se à fonte de dados.**
