...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Esta seção contém a Ajuda F1 para as páginas **Indicadores** no [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
