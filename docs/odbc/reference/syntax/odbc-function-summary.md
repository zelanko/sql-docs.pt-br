...
||[SQLDriverConnect](../../../odbc/reference/syntax/sqldriverconnect-function.md)|ODBCODBC|Conecta-se a um driver específico por cadeia de conexão ou solicita que o Driver Manager e o driver exibam caixas de diálogo de conexão para o usuário.|  
||[SQLBrowseConnect](../../../odbc/reference/syntax/sqlbrowseconnect-function.md)|ODBCODBC|Retorna níveis sucessivos de atributos de conexão e valores de atributo válidos. Quando um valor tiver sido especificado para cada atributo de conexão, o se conectará à fonte de dados.|  
